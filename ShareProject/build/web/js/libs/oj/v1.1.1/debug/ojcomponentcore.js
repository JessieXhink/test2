...
oj.FocusUtils.containsFocus = function(element)
{
  ...
  //FIX BUG 21042073: if either elem is undefined, just return false
...
oj.DomUtils.isWithinViewport = function(element, checkBrowserViewport)
{
  ...
  {
    // 2px fudge factor for rounding errors
  ...
  var alignBox = element[0].getBoundingClientRect();

  // is the element visible in the browser viewport.
  if (checkBrowserViewport && !isVisible(alignBox, $(document.body).offset()))
    return false;
