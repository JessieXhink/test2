...
DvtLegend.prototype.__registerObject = function(peer) {
  if (peer.getDisplayables()[0] instanceof DvtButton)
    ...
    // peer is navigable if associated with legend item using datatip or hideShow is enabled
    var hideAndShow = this.getOptions()['hideAndShowBehavior'];
    if (peer.getDatatip() != null || (hideAndShow != 'none' && hideAndShow != 'off'))
...
/**
 * Returns whether or not the legend has naivigable peers
 * @return {boolean}
 */
...
DvtLegendObjPeer.prototype.getAriaLabel = function() {
  ...
  if (this.getData()['shortDesc'] != null) {
