...
define(["ojs/ojcore", "jquery", "hammerjs", "ojs/ojjquery-hammer", "ojs/ojcomponentcore", "ojs/ojvalidation", "ojs/ojpopup"], function($oj$$4$$, $$$$4$$, $Hammer$$1$$) {
  ...
  close:"mouseout"}}, "default":{position:"launcher-wrapper", $events$:{open:"focusin"}}};
  ...
  $oj$$4$$.$PopupMessagingStrategy$.prototype.$_popupOpenCallback$ = function $$oj$$4$$$$PopupMessagingStrategy$$$$_popupOpenCallback$$($event$$36$$) {
    var $target$$75$$ = $$$$4$$($event$$36$$.target), $self$$38$$ = this;
    window.setTimeout(function() {
      $oj$$4$$.Components.$isComponentInitialized$($target$$75$$) ? $target$$75$$.ojPopup("option", "autoDismiss", "focusLoss") : delete $self$$38$$.$$messagingContentRoot$;
    }, 10);
  };
  $oj$$4$$.$PopupMessagingStrategy$.prototype.$_popupCloseCallback$ = function $$oj$$4$$$$PopupMessagingStrategy$$$$_popupCloseCallback$$($event$$37_target$$76$$) {
    $event$$37_target$$76$$ = $$$$4$$($event$$37_target$$76$$.target);
    $oj$$4$$.Components.$isComponentInitialized$($event$$37_target$$76$$) && ($event$$37_target$$76$$.ojPopup("option", "autoDismiss", "none"), $event$$37_target$$76$$.ojPopup("option", "open", null), $event$$37_target$$76$$.ojPopup("option", "close", null));
    delete this.$$messagingContentRoot$;
    $event$$37_target$$76$$.children().remove();
  };
  ...
  $oj$$4$$.$PopupMessagingStrategyUtils$.$buildHintHtml$ = function $$oj$$4$$$$PopupMessagingStrategyUtils$$$buildHintHtml$$($document$$4$$, $selector$$16$$, $hintText$$, $htmlAllowed$$, $formControlSelectors$$) {
    var $jTitleDom$$;
    $hintText$$ && ($jTitleDom$$ = $$$$4$$($document$$4$$.createElement("div")), $jTitleDom$$.addClass($formControlSelectors$$ + (" " + $selector$$16$$)), $jTitleDom$$.append($oj$$4$$.$PopupMessagingStrategyUtils$.$_getTextDom$($document$$4$$, $hintText$$, $htmlAllowed$$)));
  ...
  $oj$$4$$.$PopupMessagingStrategyUtils$.$_getTextDom$ = function $$oj$$4$$$$PopupMessagingStrategyUtils$$$_getTextDom$$($document$$8$$, $value$$76$$, $htmlAllowed$$1$$) {
    var $textDom$$ = null;
    $oj$$4$$.$StringUtils$.$isString$($value$$76$$) && ($htmlAllowed$$1$$ && $oj$$4$$.$DomUtils$.$isHTMLContent$($value$$76$$) ? $textDom$$ = $oj$$4$$.$DomUtils$.$cleanHtml$($value$$76$$.substring(6, $value$$76$$.length - 7)) : ($textDom$$ = $document$$8$$.createElement("span"), $textDom$$.textContent = $value$$76$$));
    return $textDom$$;
  };
  ...
  $oj$$4$$.$__registerWidget$("oj.editableValue", $$$$4$$.oj.baseComponent, {widgetEventPrefix:"oj", options:{disabled:!1, displayOptions:void 0, help:{definition:null, source:null}, messagesCustom:void 0, messagesHidden:void 0, messagesShown:void 0, required:void 0, title:void 0, validators:void 0, value:void 0}, getNodeBySubId:function($locator$$4$$) {
    ...
    var $msgs$$ = this.options.messagesHidden, $msg$$4$$, $mutated$$ = !1, $i$$96$$, $clonedMsgs$$ = [];
    for ($i$$96$$ = 0;$i$$96$$ < $msgs$$.length;$i$$96$$++) {
      $mutated$$ = !0, $msg$$4$$ = $msgs$$[$i$$96$$], $msg$$4$$ instanceof $oj$$4$$.$ComponentMessage$ && $msg$$4$$.$_forceDisplayToShown$(), $clonedMsgs$$.push($msg$$4$$.clone());
    }
    ...
    $$$$4$$.each(["required", "title"], function($index$$86$$, $value$$77$$) {
      $value$$77$$ in $savedAttributes$$1$$ && $node$$16$$.removeAttr($value$$77$$);
    });
  ...
  }, $_SaveAttributes$:function($element$$31$$) {
    this.$_SaveAllAttributes$($element$$31$$);
  }, $_RestoreAttributes$:function($element$$32$$) {
    this.$_RestoreAllAttributes$($element$$32$$);
    ...
    return!0;
  }, _setOption:function($name$$71$$, $value$$78$$, $flags$$10$$) {
    var $retVal$$4_skipSetOption$$;
    $retVal$$4_skipSetOption$$ = !1;
    if ("string" === typeof $name$$71$$ && void 0 !== $value$$78$$) {
      switch($name$$71$$) {
        case "messagesHidden":
    ...
    if (!this.$_allValidators$) {
      var $allValidators$$ = [], $validatorsOption$$ = this.options.validators, $vOptions_valType_validator$$, $isValidatorInstance$$ = !0, $implicitValidatorMap_vType$$ = this.$_GetImplicitValidators$(), $implicitValidators_normalizedValidators$$ = [], $len$$5_vTypeStr$$, $i$$97_keys$$6$$;
      $i$$97_keys$$6$$ = Object.keys($implicitValidatorMap_vType$$);
      $len$$5_vTypeStr$$ = $i$$97_keys$$6$$.length;
      if (0 < $len$$5_vTypeStr$$) {
        for (var $idx$$1$$ = 0;$idx$$1$$ < $len$$5_vTypeStr$$;$idx$$1$$++) {
          $vOptions_valType_validator$$ = $i$$97_keys$$6$$[$idx$$1$$], $implicitValidators_normalizedValidators$$.push($implicitValidatorMap_vType$$[$vOptions_valType_validator$$]);
        }
        $allValidators$$ = $allValidators$$.concat($implicitValidators_normalizedValidators$$);
      }
      if ($validatorsOption$$) {
        $implicitValidators_normalizedValidators$$ = [];
        for ($i$$97_keys$$6$$ = 0;$i$$97_keys$$6$$ < $validatorsOption$$.length;$i$$97_keys$$6$$++) {
          $vOptions_valType_validator$$ = $validatorsOption$$[$i$$97_keys$$6$$], "object" === typeof $vOptions_valType_validator$$ ? ($vOptions_valType_validator$$.validate && "function" === typeof $vOptions_valType_validator$$.validate || ($isValidatorInstance$$ = !1), $isValidatorInstance$$ || ($len$$5_vTypeStr$$ = $vOptions_valType_validator$$.type) && "string" === typeof $len$$5_vTypeStr$$ && (($implicitValidatorMap_vType$$ = $oj$$4$$.$Validation$.$validatorFactory$($len$$5_vTypeStr$$)) ? ($vOptions_valType_validator$$ = 
  ...
  }, $_HandleChangeEvent$:function($event$$38$$) {
    var $submittedValue$$ = this.$_GetDisplayValue$();
    this.$_SetValue$($submittedValue$$, $event$$38$$);
  }, $_Refresh$:function($labelHelpIconWrapper_name$$72$$, $helpDef_value$$80$$, $forceDisplayValueRefresh_helpSource$$) {
    switch($labelHelpIconWrapper_name$$72$$) {
      case "converter":
        $helpDef_value$$80$$ = this.options.value;
        this.$_refreshComponentDisplayValue$($helpDef_value$$80$$, $forceDisplayValueRefresh_helpSource$$);
        break;
      case "disabled":
        this.$_refreshTheming$("disabled", this.options.disabled);
        break;
      case "help":
        $helpDef_value$$80$$ = this.options.help.definition;
        ...
        this.$$label$ && (this.$$label$._ojLabel("option", "describedById", $labelHelpIconWrapper_name$$72$$), this.$$label$._ojLabel("option", "help", {definition:$helpDef_value$$80$$, source:$forceDisplayValueRefresh_helpSource$$}));
        break;
      case "required":
        this.$_refreshTheming$("required", this.$_IsRequired$());
        this.$_RefreshAriaRequired$($helpDef_value$$80$$);
        this.$$label$ && ($labelHelpIconWrapper_name$$72$$ = this.$_getAriaDescribedByIconWrapperId$(), this.$$label$._ojLabel("option", {describedById:$labelHelpIconWrapper_name$$72$$, ariaRequiredUnsupported:this.$_AriaRequiredUnsupported$()}), this.$$label$._ojLabel("option", "required", $helpDef_value$$80$$));
        break;
      case "value":
        this.$_refreshComponentDisplayValue$($helpDef_value$$80$$, $forceDisplayValueRefresh_helpSource$$);
    }
  }, $_RefreshAriaRequired$:function($value$$81$$) {
    var $contentNode$$ = this.$_GetContentElement$();
    $value$$81$$ && $contentNode$$ ? $contentNode$$.attr("aria-required", $value$$81$$) : $contentNode$$.removeAttr("aria-required");
  ...
  }, $_SetPlaceholder$:function($value$$82$$) {
    this.$_GetContentElement$().attr("placeholder", $value$$82$$);
  }, $_SetPlaceholderOption$:function($value$$83$$) {
    this.options.placeholder = $value$$83$$;
  }, $_HasPlaceholderSet$:function() {
    return this.options.placeholder;
  }, $_ClearPlaceholder$:function() {
    this.$_SetPlaceholderOption$("");
    this.$_SetPlaceholder$("");
  }, $_SetValue$:function($newValue_parsed$$, $event$$39$$, $options$$125$$) {
    var $doValueChangeCheck$$ = $options$$125$$ && "boolean" === typeof $options$$125$$.$doValueChangeCheck$ ? $options$$125$$.$doValueChangeCheck$ : !0;
    ...
    if ($doValueChangeCheck$$ && $newValue_parsed$$ === this.$_oj_lastElementValue$) {
      ...
      if ($newValue_parsed$$ = this.$_Validate$($newValue_parsed$$, $event$$39$$, $options$$125$$), void 0 !== $newValue_parsed$$ && this.isValid()) {
        return this.$_updateValueOption$($newValue_parsed$$, $event$$39$$, $options$$125$$ && $options$$125$$.$validationContext$), !0;
      }
    }
    return!1;
  }, $_Validate$:function($newValue$$1$$, $event$$40$$, $doNotClearMessages$$1_options$$126$$) {
    var $mode$$11$$ = $doNotClearMessages$$1_options$$126$$ && $doNotClearMessages$$1_options$$126$$.$validationMode$ ? $doNotClearMessages$$1_options$$126$$.$validationMode$ : this.$_VALIDATION_MODE$.$FULL$, $context$$36$$ = $doNotClearMessages$$1_options$$126$$ && $doNotClearMessages$$1_options$$126$$.$validationContext$ ? $doNotClearMessages$$1_options$$126$$.$validationContext$ : this.$_VALIDATION_CONTEXT$.$USER_ACTION$;
    $doNotClearMessages$$1_options$$126$$ = $doNotClearMessages$$1_options$$126$$ && $doNotClearMessages$$1_options$$126$$.$doNotClearMessages$ || !1;
    if (void 0 === $newValue$$1$$) {
      $oj$$4$$.$Logger$.warn("Attempt to set a value of undefined");
    } else {
      if (this.$_CanSetValue$()) {
        $doNotClearMessages$$1_options$$126$$ || this.$_clearAllMessages$($event$$40$$);
        this.$_setLastSubmittedValue$($newValue$$1$$);
        try {
          return this.$_runNormalValidation$($newValue$$1$$, $mode$$11$$, $context$$36$$, $event$$40$$);
        } catch ($e$$30$$) {
        }
      } else {
    ...
    return "";
  }, $_MESSAGING_CONTENT_UPDATE_TYPE$:{$ALL$:1, $VALIDITY_STATE$:2, $CONVERTER_HINT$:3, $VALIDATOR_HINTS$:4, $TITLE$:5}, $_OPTION_TO_CSS_MAPPING$:{disabled:"oj-disabled", required:"oj-required"}, $_clearAllMessages$:function($event$$41$$, $doNotSetOption$$) {
    $doNotSetOption$$ ? (this.options.messagesHidden = [], this.options.messagesShown = [], this.options.messagesCustom = []) : (this.$_clearMessages$("messagesHidden", $event$$41$$), this.$_clearMessages$("messagesShown", $event$$41$$), this.$_clearMessages$("messagesCustom", $event$$41$$));
    ...
    for (var $i$$98$$ = $beforeLen$$ - 1;0 <= $i$$98$$;$i$$98$$--) {
      $msg$$5$$ = $shownMsgs$$[$i$$98$$], $msg$$5$$ instanceof $oj$$4$$.$ComponentMessage$ && $shownMsgs$$.splice($i$$98$$, 1);
    }
    $shownMsgs$$.length !== $beforeLen$$ && this.$_setMessagesOption$("messagesShown", $shownMsgs$$, null, !0);
  }, $_setMessagesOption$:function($key$$35$$, $value$$84$$, $event$$42$$, $changed$$1$$) {
    var $flags$$11$$ = {}, $bothEmpty$$ = 0 === $value$$84$$.length && 0 === this.options[$key$$35$$].length;
    if ($changed$$1$$ || !$bothEmpty$$) {
      $flags$$11$$._context = {originalEvent:$event$$42$$, $writeback$:!0, $internalSet$:!0}, $flags$$11$$.changed = $changed$$1$$ || !$bothEmpty$$, this.$_resetValid$(), this.option($key$$35$$, $value$$84$$, $flags$$11$$), this.$_updateMessagingContent$();
    }
  }, $_clearMessages$:function($option$$7$$, $event$$43$$) {
    this.$_setMessagesOption$($option$$7$$, [], $event$$43$$);
  }, $_cloneMessagesBeforeSet$:function($value$$85$$) {
    var $msg$$6_val$$20$$, $msgsClone$$ = [], $i$$99$$;
    if ($value$$85$$ && 0 < $value$$85$$.length) {
      for ($i$$99$$ = 0;$i$$99$$ < $value$$85$$.length;$i$$99$$++) {
        $msg$$6_val$$20$$ = $value$$85$$[$i$$99$$], $msg$$6_val$$20$$ instanceof $oj$$4$$.$Message$ ? $msgsClone$$.push($msg$$6_val$$20$$.clone()) : ($msg$$6_val$$20$$ = new $oj$$4$$.$Message$($msg$$6_val$$20$$.summary, $msg$$6_val$$20$$.detail, $msg$$6_val$$20$$.severity), $msg$$6_val$$20$$ = Object.freeze ? Object.freeze($msg$$6_val$$20$$) : $msg$$6_val$$20$$, $msgsClone$$.push($msg$$6_val$$20$$));
      }
    }
    return $msgsClone$$;
    ...
    for (var $shown$$ = this.options.messagesShown, $msg$$7$$, $compMsgs$$, $i$$100$$ = 0;$i$$100$$ < $shown$$.length;$i$$100$$++) {
      $msg$$7$$ = $shown$$[$i$$100$$], $msg$$7$$ instanceof $oj$$4$$.$ComponentMessage$ && $msg$$7$$.$_isMessageAddedByComponent$() && ($compMsgs$$ = $compMsgs$$ || [], $compMsgs$$.push($msg$$7$$));
    }
  ...
  }, $_messagesCustomOptionChanged$:function($flags$$12$$) {
    var $customMsgs$$ = this.options.messagesCustom, $shownMsgs$$1$$ = [], $msg$$8$$, $i$$101$$, $previousShown$$ = this.options.messagesShown, $context$$37$$ = $flags$$12$$ ? $flags$$12$$._context : null;
    for ($i$$101$$ = 0;$i$$101$$ < $previousShown$$.length;$i$$101$$++) {
      $msg$$8$$ = $previousShown$$[$i$$101$$], $msg$$8$$ instanceof $oj$$4$$.$ComponentMessage$ && $msg$$8$$.$_isMessageAddedByComponent$() && $shownMsgs$$1$$.push($msg$$8$$);
    }
    for ($i$$101$$ = 0;$i$$101$$ < $customMsgs$$.length;$i$$101$$++) {
      $shownMsgs$$1$$.push($customMsgs$$[$i$$101$$]);
    }
    this.$_setMessagesOption$("messagesShown", $shownMsgs$$1$$, $context$$37$$ ? $context$$37$$.originalEvent : null, $flags$$12$$ && $flags$$12$$.changed);
  }, $_placeholderOptionChanged$:function($flags$$13_refreshMessagingOptions$$) {
    $flags$$13_refreshMessagingOptions$$ = ($flags$$13_refreshMessagingOptions$$ && $flags$$13_refreshMessagingOptions$$._context || {}).$internalMessagingSet$ ? !1 : !0;
    this.$_SetPlaceholder$(this.options.placeholder);
    $flags$$13_refreshMessagingOptions$$ ? (this.$_customPlaceholderSet$ = !0, this.$_GetConverter$() && this.$_initComponentMessaging$()) : this.$_customPlaceholderSet$ = !1;
  }, $_setLastModelValue$:function($value$$87$$) {
    this.$_oj_lastModelValue$ = $value$$87$$;
  }, $_setLastSubmittedValue$:function($value$$88$$) {
    this.$_oj_lastElementValue$ = $value$$88$$;
  ...
  }, $_updateMessagesOption$:function($option$$8$$, $newMsgs$$, $event$$44$$) {
    var $len$$6$$, $i$$102$$, $msgs$$1$$;
    if ("object" === typeof $newMsgs$$ && Array.isArray($newMsgs$$)) {
      for ($msgs$$1$$ = this.options[$option$$8$$], $len$$6$$ = $newMsgs$$.length, $i$$102$$ = 0;$i$$102$$ < $len$$6$$;$i$$102$$++) {
        $msgs$$1$$.push($newMsgs$$[$i$$102$$]);
      }
    }
    this.$_setMessagesOption$($option$$8$$, $msgs$$1$$, $event$$44$$, !0);
  }, $_updateMessagingContent$:function() {
    this.$_getComponentMessaging$().update(this.$_getMessagingContent$());
  }, $_updateValueOption$:function($newValue$$2$$, $event$$45$$, $validationContext$$) {
    var $context$$39$$ = {};
    $event$$45$$ && ($context$$39$$.originalEvent = $event$$45$$);
    switch($validationContext$$) {
      ...
      case this.$_VALIDATION_CONTEXT$.$VALIDATORS_OPTION_CHANGE$:
        $context$$39$$.$writeback$ = !0, $context$$39$$.$doNotClearMessages$ = !0;
    }
    this.option({value:$newValue$$2$$}, {_context:$context$$39$$});
    ...
    return $valid$$5$$;
  }, $_formatValue$:function($value$$89$$) {
    var $formattedValue$$ = $value$$89$$, $converter$$ = this.$_GetConverter$();
    $converter$$ && "object" === typeof $converter$$ && ($converter$$.format && "function" === typeof $converter$$.format ? $formattedValue$$ = $converter$$.format($value$$89$$) : $oj$$4$$.$Logger$.$level$ > $oj$$4$$.$Logger$.$LEVEL_WARN$ && $oj$$4$$.$Logger$.info("converter does not support the format method."));
    ...
    for ($i$$103$$ = 0;$i$$103$$ < $allValidators$$1$$.length;$i$$103$$++) {
      $vHint_validator$$1$$ = $allValidators$$1$$[$i$$103$$], "object" === typeof $vHint_validator$$1$$ && $vHint_validator$$1$$.getHint && "function" === typeof $vHint_validator$$1$$.getHint && ($vHint_validator$$1$$ = $vHint_validator$$1$$.getHint()) && $validatorHints$$.push($vHint_validator$$1$$);
    }
    ...
    $$$$4$$.each($previousMsgs$$, function($i$$104$$, $pMsg$$) {
    ...
    return $parsedValue$$;
  }, $_addValidationError$:function($e$$31$$, $msgs$$4$$) {
    var $detail$$9_ojmessage$$, $summary$$6$$, $severity$$8$$;
    $e$$31$$ instanceof $oj$$4$$.$ConverterError$ || $e$$31$$ instanceof $oj$$4$$.$ValidatorError$ ? ($detail$$9_ojmessage$$ = $e$$31$$.$getMessage$(), $oj$$4$$.$Assert$.$assertPrototype$($detail$$9_ojmessage$$, $oj$$4$$.$Message$), $severity$$8$$ = $detail$$9_ojmessage$$.severity, $summary$$6$$ = $detail$$9_ojmessage$$.summary, $detail$$9_ojmessage$$ = $detail$$9_ojmessage$$.detail) : ($severity$$8$$ = $oj$$4$$.$Message$.$SEVERITY_LEVEL$.ERROR, $summary$$6$$ = $oj$$4$$.$Translations$.$getTranslatedString$("oj-message.error"), 
    $detail$$9_ojmessage$$ = $e$$31$$.message || $oj$$4$$.$Translations$.$getTranslatedString$("oj-converter.detail"));
    $msgs$$4$$.push({summary:$summary$$6$$, detail:$detail$$9_ojmessage$$, severity:$severity$$8$$});
  }, $_processValidationErrors$:function($e$$32_msg$$10$$, $context$$40_i$$105$$, $display$$) {
    var $options$$127$$ = {}, $componentMsgs$$ = [], $msgs$$5$$ = $e$$32_msg$$10$$.$_messages$ || [];
    $options$$127$$.context = $context$$40_i$$105$$ || 0;
    $options$$127$$.display = $display$$ || $oj$$4$$.$ComponentMessage$.$DISPLAY$.$SHOWN$;
    0 === $msgs$$5$$.length && this.$_addValidationError$($e$$32_msg$$10$$, $msgs$$5$$);
    for ($context$$40_i$$105$$ = 0;$context$$40_i$$105$$ < $msgs$$5$$.length;$context$$40_i$$105$$++) {
      $e$$32_msg$$10$$ = $msgs$$5$$[$context$$40_i$$105$$], $componentMsgs$$.push(this.$_createComponentMessage$($e$$32_msg$$10$$.summary, $e$$32_msg$$10$$.detail, $e$$32_msg$$10$$.severity, $options$$127$$));
    }
    return $componentMsgs$$ || null;
  }, $_createComponentMessage$:function($cMsg_summary$$7$$, $detail$$10$$, $severity$$9$$, $options$$128$$) {
    $cMsg_summary$$7$$ = new $oj$$4$$.$ComponentMessage$($cMsg_summary$$7$$, $detail$$10$$, $severity$$9$$, $options$$128$$);
    return $cMsg_summary$$7$$ = Object.seal ? Object.seal($cMsg_summary$$7$$) : $cMsg_summary$$7$$;
  }, $_refreshComponentDisplayValue$:function($value$$90$$, $fullRefresh$$1$$) {
    var $modelValue$$ = $value$$90$$ || this.options.value, $lastModelValue$$;
    $lastModelValue$$ = this.$_oj_lastModelValue$;
    ($fullRefresh$$1$$ || $modelValue$$ !== $lastModelValue$$) && this.$_updateElementDisplayValue$($modelValue$$);
  }, $_refreshTheming$:function($option$$9$$, $value$$91$$) {
    -1 !== Object.keys(this.$_OPTION_TO_CSS_MAPPING$).indexOf($option$$9$$) && this.widget().toggleClass(this.$_OPTION_TO_CSS_MAPPING$[$option$$9$$], !!$value$$91$$);
  ...
  }, $_runNormalValidation$:function($newMsgs$$2_value$$92$$, $mode$$12$$, $context$$42$$, $event$$46$$) {
    var $newValue$$4$$ = $newMsgs$$2_value$$92$$;
    try {
      $mode$$12$$ === this.$_VALIDATION_MODE$.$FULL$ && ($newValue$$4$$ = this.$_parseValue$($newMsgs$$2_value$$92$$)), this.$_validateValue$($newValue$$4$$, $mode$$12$$ === this.$_VALIDATION_MODE$.$REQUIRED_VALIDATOR_ONLY$);
    } catch ($ve$$1$$) {
      throw $newMsgs$$2_value$$92$$ = this.$_processValidationErrors$($ve$$1$$, $context$$42$$), this.$_updateMessagesOption$("messagesShown", $newMsgs$$2_value$$92$$, $event$$46$$), $ve$$1$$;
    }
    return $newValue$$4$$;
  ...
  }, $_updateElementDisplayValue$:function($modelValue$$1$$, $event$$47$$) {
    var $displayValue$$1$$, $newMsgs$$3$$;
    this.$_setLastModelValue$($modelValue$$1$$);
    $displayValue$$1$$ = $modelValue$$1$$;
    try {
      $displayValue$$1$$ = this.$_formatValue$($modelValue$$1$$);
    } catch ($e$$33$$) {
      $newMsgs$$3$$ = this.$_processValidationErrors$($e$$33$$), this.$_updateMessagesOption$("messagesShown", $newMsgs$$3$$, $event$$47$$);
    }
    this.$_SetDisplayValue$($displayValue$$1$$);
    this.$_setLastSubmittedValue$(this.$_GetDisplayValue$());
  }, $_updateValue$:function($options$$129$$) {
    var $newValue$$5$$;
    $newValue$$5$$ = this.$_Validate$(this.$_GetDisplayValue$(), null, $options$$129$$);
    void 0 === $newValue$$5$$ || !this.isValid() && this.$_hasInvalidComponentMessagesShowing$() || this.$_updateValueOption$($newValue$$5$$, null, $options$$129$$.$validationContext$);
  }, $_validateValue$:function($value$$93$$, $requiredOnly$$) {
    var $allValidators$$3_ve$$2$$ = this.$_GetAllValidators$(), $validator$$2$$, $i$$106$$, $valMsgs$$ = [];
    if (this.$_IsRequired$()) {
      $validator$$2$$ = this.$_getImplicitRequiredValidator$();
      try {
        $validator$$2$$.validate($oj$$4$$.$StringUtils$.trim($value$$93$$));
      } catch ($e$$34$$) {
        this.$_addValidationError$($e$$34$$, $valMsgs$$);
      }
    }
    if (!$requiredOnly$$) {
      for ($i$$106$$ = 0;$i$$106$$ < $allValidators$$3_ve$$2$$.length;$i$$106$$++) {
        if ($validator$$2$$ = $allValidators$$3_ve$$2$$[$i$$106$$], "object" === typeof $validator$$2$$) {
          if ($validator$$2$$.validate && "function" === typeof $validator$$2$$.validate) {
            try {
              $validator$$2$$.validate($value$$93$$);
            } catch ($e$$35$$) {
  ...
  (function() {
    $oj$$4$$.$__registerWidget$("oj._ojLabel", $$$$4$$.oj.baseComponent, {version:"1.0.0", defaultElement:"\x3clabel\x3e", widgetEventPrefix:"oj", options:{ariaRequiredUnsupported:!1, describedById:null, help:{definition:null, source:null}, required:!1, rootAttributes:null}, $_BUNDLE_KEY$:{$_TOOLTIP_HELP$:"tooltipHelp", $_TOOLTIP_REQUIRED$:"tooltipRequired"}, widget:function() {
      ...
      this.$_drawOnCreate$();
    }, $_SaveAttributes$:function($element$$33$$) {
      this.$_savedClasses$ = $element$$33$$.attr("class");
      ...
      var $ariaRequiredUnsupported$$2_options$$130$$ = this.options, $requiredOpt$$ = $ariaRequiredUnsupported$$2_options$$130$$.required, $ariaRequiredUnsupported$$2_options$$130$$ = $ariaRequiredUnsupported$$2_options$$130$$.ariaRequiredUnsupported, $needsDescribedBySpan$$ = this.$_needsDescribedBySpan$(), $describedByDom$$ = null;
      ...
      $requiredOpt$$ && ($ariaRequiredUnsupported$$2_options$$130$$ ? $describedByDom$$.append(this.$_createRequiredIconDomElement$()) : this.element.before(this.$_createRequiredIconDomElement$()));
    }, $_createHelpIfNeeded$:function($describedByDom$$1$$) {
      var $options$$131$$ = this.options, $helpDef$$3$$ = $options$$131$$.help.definition;
      if ($options$$131$$.help.source || $helpDef$$3$$) {
      ...
      if (this.$_needsDescribedBySpan$() && null == $options$$132$$.describedById) {
      ...
      if ($arrayOfClasses_classes$$ && ($arrayOfClasses_classes$$ = $arrayOfClasses_classes$$.split(/\s+/), null != $arrayOfClasses_classes$$)) {
        ...
        for (var $i$$107$$ = 0;$i$$107$$ < $numClasses$$;$i$$107$$++) {
          var $className$$4$$ = $arrayOfClasses_classes$$[$i$$107$$];
      ...
      var $inputLabelClass$$, $rootDomNode$$;
      this.options.rootAttributes && ($inputLabelClass$$ = this.options.rootAttributes["class"]);
      $rootDomNode$$ = $$$$4$$("\x3cdiv class\x3d'oj-label oj-component'\x3e\x3cdiv class\x3d'oj-label-group'\x3e\x3c/div\x3e\x3c/div\x3e", this.document[0]);
      null !== $inputLabelClass$$ && $rootDomNode$$.addClass($inputLabelClass$$);
      return $rootDomNode$$;
    }, $_createRequiredIconDomElement$:function() {
      var $requiredTooltip$$ = this.$getTranslatedString$(this.$_BUNDLE_KEY$.$_TOOLTIP_REQUIRED$), $requiredDom$$ = $$$$4$$("\x3cspan class\x3d'oj-label-required-icon oj-component-icon' role\x3d'img'\x3e\x3c/span\x3e", this.document[0]);
      $requiredDom$$.attr("title", $requiredTooltip$$);
      return $requiredDom$$;
    }, $_createHelpIconAnchorDomElement$:function($helpDef$$4$$, $source$$8$$) {
      var $helpIconAnchor$$;
      this.$_needsHelpIcon$() && ($helpIconAnchor$$ = $$$$4$$("\x3ca tabindex\x3d'0' target\x3d'_blank' class\x3d'oj-label-help-icon-anchor oj-label-help-icon oj-component-icon oj-clickable-icon-nocontext'\x3e\x3c/a\x3e", this.document[0]), $source$$8$$ && $helpIconAnchor$$.attr("href", $source$$8$$), $helpDef$$4$$ ? $helpIconAnchor$$.attr("title", $helpDef$$4$$) : $helpIconAnchor$$.attr("title", this.$getTranslatedString$(this.$_BUNDLE_KEY$.$_TOOLTIP_HELP$)));
      return $helpIconAnchor$$;
    }, $_attachHelpDefToIconAnchor$:function() {
      var $helpDef$$5_helpDefText_position$$2$$;
      $helpDef$$5_helpDefText_position$$2$$ = this.options.help.definition;
      var $helpIcon$$, $helpDefPopupDiv$$;
      $helpIcon$$ = this.widget().find(".oj-label-help-icon-anchor");
      if (0 != $helpIcon$$.length) {
        $helpDef$$5_helpDefText_position$$2$$ = $helpDef$$5_helpDefText_position$$2$$ ? $helpDef$$5_helpDefText_position$$2$$ : this.$getTranslatedString$(this.$_BUNDLE_KEY$.$_TOOLTIP_HELP$);
        this.$_helpDefPopupDivId$ ? ($helpDefPopupDiv$$ = $$$$4$$("#" + this.$_helpDefPopupDivId$)) && $helpDefPopupDiv$$.text($helpDef$$5_helpDefText_position$$2$$) : ($helpDefPopupDiv$$ = $$$$4$$("\x3cdiv style\x3d'display:none'\x3e\x3c/div\x3e"), $helpDefPopupDiv$$.uniqueId(), this.$_helpDefPopupDivId$ = $helpDefPopupDiv$$.prop("id"), $helpDefPopupDiv$$.text($helpDef$$5_helpDefText_position$$2$$), $$$$4$$("body").append($helpDefPopupDiv$$));
        ...
        var $self$$39$$ = this;
        this.$_openPopupForHelpDefCallbackListener$ || (this.$_openPopupForHelpDefCallbackListener$ = function $this$$_openPopupForHelpDefCallbackListener$$($event$$49$$) {
          $self$$39$$.$_handleOpenPopupForHelpDef$($event$$49$$, $helpDefPopupDiv$$, $helpIcon$$, !1);
        });
        ...
        $helpDef$$5_helpDefText_position$$2$$ = {my:"start bottom", at:"end top", collision:"flipcenter", of:$helpIcon$$};
        $helpDefPopupDiv$$.ojPopup({position:$helpDef$$5_helpDefText_position$$2$$});
      }
    }, $_handleOpenPopupForHelpDef$:function($event$$50$$, $helpDefPopupDiv$$1$$, $helpIcon$$1$$, $inMouseDown$$1$$) {
      if ("mousedown" === $event$$50$$.type) {
        $inMouseDown$$1$$ = !0;
      } else {
        if ("focusin" === $event$$50$$.type && $inMouseDown$$1$$) {
          $inMouseDown$$1$$ = !1;
        } else {
          if (this.$_bTouchSupported$) {
            if ("press" === $event$$50$$.type) {
              var $widget$$2$$ = this.widget();
              $widget$$2$$.on("click" + this.$_touchEatClickNamespace$, this.$_eatClickOnHelpIconListener$);
              var $self$$40$$ = this;
              $helpDefPopupDiv$$1$$.on("ojclose", function() {
                $widget$$2$$.off($self$$40$$.$_touchEatClickNamespace$);
                $self$$40$$.$_eatClickOnHelpIconListener$ = null;
              });
            } else {
      ...
      var $element$$35$$ = this.element, $helpDef$$6$$ = this.options.help.definition, $title$$8$$;
      $helpDef$$6$$ && ($element$$35$$.addClass("oj-label-help-def"), ($title$$8$$ = $element$$35$$.attr("title")) ? $element$$35$$.attr("title", $title$$8$$ + " " + $helpDef$$6$$) : $element$$35$$.attr("title", $helpDef$$6$$));
      ...
      if (null != this.$_helpDefPopupDivId$) {
        if ($helpDefPopupDiv$$2$$ = $$$$4$$("#" + this.$_helpDefPopupDivId$)) {
      ...
      this.$_needsHelpIcon$() && $describedByDom$$2$$.prepend(this.$_createHelpIconAnchorDomElement$($helpDef$$7$$, $helpSource$$4$$));
    }, $_needsDescribedBySpan$:function() {
      var $options$$133$$ = this.options;
      return this.$_needsHelpIcon$() || $options$$133$$.ariaRequiredUnsupported && $options$$133$$.required;
    }, $_needsHelpIcon$:function() {
      var $options$$134$$ = this.options;
      return $options$$134$$.help.source || $options$$134$$.help.definition;
      ...
      $describedBySpan$$1$$ = this.$uiLabel$.find("#" + this.options.describedById);
      null != $helpIcon$$3_needsHelpIcon$$ && 0 === $describedBySpan$$1$$.length ? $describedBySpan$$1$$ = this.$_createDescribedBySpan$() : null == $helpIcon$$3_needsHelpIcon$$ && 0 < $describedBySpan$$1$$.length && 0 === $describedBySpan$$1$$.children().size() && $describedBySpan$$1$$.remove();
      ...
      this.options.required ? (this.$_checkDescribedByIdOption$(), 0 === $describedBySpan$$2_requiredDom$$1$$.length ? this.options.ariaRequiredUnsupported ? ($describedBySpan$$2_requiredDom$$1$$ = this.$uiLabel$.find($describedById$$1_requiredTooltip$$1$$), 0 === $describedBySpan$$2_requiredDom$$1$$.length && ($describedBySpan$$2_requiredDom$$1$$ = this.$_createDescribedBySpan$()), $describedBySpan$$2_requiredDom$$1$$.append(this.$_createRequiredIconDomElement$())) : this.element.before(this.$_createRequiredIconDomElement$()) : 
      ($describedById$$1_requiredTooltip$$1$$ = this.$getTranslatedString$(this.$_BUNDLE_KEY$.$_TOOLTIP_REQUIRED$), $describedBySpan$$2_requiredDom$$1$$.attr("title", $describedById$$1_requiredTooltip$$1$$))) : ($describedBySpan$$2_requiredDom$$1$$.remove(), $describedBySpan$$2_requiredDom$$1$$ = this.$uiLabel$.find($describedById$$1_requiredTooltip$$1$$), 0 < $describedBySpan$$2_requiredDom$$1$$.length && 0 === $describedBySpan$$2_requiredDom$$1$$.children().size() && $describedBySpan$$2_requiredDom$$1$$.remove());
      ...
      $node$$18$$ || ($locator$$5_subId$$ = $locator$$5_subId$$.subId, "oj-label-help-icon" === $locator$$5_subId$$ && ($node$$18$$ = this.widget().find(".oj-label-help-icon")[0]), "oj-label-help-icon-anchor" === $locator$$5_subId$$ && ($node$$18$$ = this.widget().find(".oj-label-help-icon-anchor")[0]), "oj-label-required-icon" === $locator$$5_subId$$ && ($node$$18$$ = this.widget().find(".oj-label-required-icon")[0]));
      return $node$$18$$ || null;
    }, _destroy:function() {
  ...
  $oj$$4$$.$EditableValueUtils$.$initializeOptionsFromDom$ = function $$oj$$4$$$$EditableValueUtils$$$initializeOptionsFromDom$$($props$$5$$, $constructorOptions$$6$$, $comp$$1$$, $postprocessCallback$$) {
    for (var $initializedOptions$$ = {}, $i$$108$$ = 0;$i$$108$$ < $props$$5$$.length;$i$$108$$++) {
      var $finalValue_prop$$53$$, $attribute$$3_result$$6$$;
      $finalValue_prop$$53$$ = $props$$5$$[$i$$108$$];
  ...
  $oj$$4$$.$EditableValueUtils$.$validateValueForOption$ = function $$oj$$4$$$$EditableValueUtils$$$validateValueForOption$$($option$$11$$, $value$$95$$) {
    var $error$$16$$ = !1;
    switch($option$$11$$) {
      case "required":
        null !== $value$$95$$ && "boolean" !== typeof $value$$95$$ && ($error$$16$$ = !0);
        break;
      case "readOnly":
      ;
      case "disabled":
    ...
    if ($error$$16$$) {
      throw "Option '" + $option$$11$$ + "' has invalid value set: " + $value$$95$$;
    }
  };
