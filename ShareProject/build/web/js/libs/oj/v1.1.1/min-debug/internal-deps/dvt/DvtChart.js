...
define(['./DvtToolkit', './DvtAxis', './DvtLegend', './DvtOverview'], function(dvt) {
  ...
  var D = dvt;
  D.$DvtSelectableWedge$$ = function $$DvtSelectableWedge$$$($cmds$$inline_2410_context$$49$$, $cx$$6$$, $cy$$7$$, $rx$$1$$, $ry$$1$$, $sa$$1$$, $ae$$1$$, $gap$$14$$, $ir$$2$$, $id$$31$$) {
  this.Init($cmds$$inline_2410_context$$49$$, D.$JSCompiler_alias_NULL$$, $id$$31$$);
  this.$_cx$ = $cx$$6$$;
  this.$_cy$ = $cy$$7$$;
  this.$_rx$ = $rx$$1$$;
  this.$_ry$ = $ry$$1$$;
  ...
  this.$_gap$ = $gap$$14$$;
  this.$_ir$ = $ir$$2$$;
  $cmds$$inline_2410_context$$49$$ = (0,D.$JSCompiler_StaticMethods__makeWedgePath$$)(this, 0);
  this.$setCmds$($cmds$$inline_2410_context$$49$$)
};
D.$DvtObj$$.$createSubclass$(D.$DvtSelectableWedge$$, D.$DvtPath$$, "DvtSelectableWedge");
D.$DvtSelectableWedge$$.prototype.Init = function $$DvtSelectableWedge$$$$Init$($context$$50$$, $cmds$$8$$, $id$$32$$) {
  D.$DvtSelectableWedge$$.$superclass$.Init.call(this, $context$$50$$, $cmds$$8$$, $id$$32$$)
};
D.$JSCompiler_StaticMethods__makeWedgePath$$ = function $$JSCompiler_StaticMethods__makeWedgePath$$$($JSCompiler_StaticMethods__makeWedgePath$self$$, $inset$$2$$) {
  ...
  2 - $pathCommands$$1_startAngleRads$$, $arcPointY_distanceToStartPoint$$ = 0 < $angleExtentRads$$ ? window.Math.abs($dataItemGaps_innerPointY$$ / window.Math.sin($angleExtentRads$$ / 2)) : 0;
  $arcPointY_distanceToStartPoint$$ > 0.5 * $rx$$3$$ && ($arcPointY_distanceToStartPoint$$ = 0.5 * $rx$$3$$);
  var $innerPointX_startPointX$$ = $JSCompiler_StaticMethods__makeWedgePath$self$$.$_cx$ + window.Math.cos($arcPointX_centerLineAngle$$) * $arcPointY_distanceToStartPoint$$, $innerPoint2X_startPointY$$ = $JSCompiler_StaticMethods__makeWedgePath$self$$.$_cy$ + window.Math.sin($arcPointX_centerLineAngle$$) * $arcPointY_distanceToStartPoint$$, $arcPointX_centerLineAngle$$ = $JSCompiler_StaticMethods__makeWedgePath$self$$.$_cx$ + window.Math.cos(-$arcPoint2Y_gapAngle$$ - $pathCommands$$1_startAngleRads$$) * 
  $rx$$3$$, $arcPointY_distanceToStartPoint$$ = $JSCompiler_StaticMethods__makeWedgePath$self$$.$_cy$ + window.Math.sin(-$arcPoint2Y_gapAngle$$ - $pathCommands$$1_startAngleRads$$) * $ry$$3$$, $arcPoint2X$$ = $JSCompiler_StaticMethods__makeWedgePath$self$$.$_cx$ + window.Math.cos(-$pathCommands$$1_startAngleRads$$ - $angleExtentRads$$ + $arcPoint2Y_gapAngle$$) * $rx$$3$$, $arcPoint2Y_gapAngle$$ = $JSCompiler_StaticMethods__makeWedgePath$self$$.$_cy$ + window.Math.sin(-$pathCommands$$1_startAngleRads$$ - 
  $angleExtentRads$$ + $arcPoint2Y_gapAngle$$) * $ry$$3$$;
  if(0 < $ir$$4$$) {
    ...
    360 == $JSCompiler_StaticMethods__makeWedgePath$self$$.$_ae$ ? ($pathCommands$$1_startAngleRads$$ = D.$DvtPathUtils$$.moveTo($arcPoint2X$$, $arcPoint2Y_gapAngle$$), $pathCommands$$1_startAngleRads$$ += D.$DvtPathUtils$$.arcTo($rx$$3$$, $ry$$3$$, $angleExtentRads$$, 1, $arcPointX_centerLineAngle$$, $arcPointY_distanceToStartPoint$$)) : ($pathCommands$$1_startAngleRads$$ = D.$DvtPathUtils$$.moveTo($innerPointX_startPointX$$, $innerPoint2X_startPointY$$), $pathCommands$$1_startAngleRads$$ += D.$DvtPathUtils$$.lineTo($arcPoint2X$$, 
    $arcPoint2Y_gapAngle$$), $pathCommands$$1_startAngleRads$$ += D.$DvtPathUtils$$.arcTo($rx$$3$$, $ry$$3$$, $angleExtentRads$$, 1, $arcPointX_centerLineAngle$$, $arcPointY_distanceToStartPoint$$), $pathCommands$$1_startAngleRads$$ += D.$DvtPathUtils$$.lineTo($innerPointX_startPointX$$, $innerPoint2X_startPointY$$))
  }
...
D.$DvtSelectableRectangularPolygon$$ = function $$DvtSelectableRectangularPolygon$$$($context$$48$$, $arPoints$$1$$, $id$$30$$) {
  ...
  this.Init($context$$48$$, [this.$_x1$, this.$_y1$, this.$_x2$, this.$_y1$, this.$_x2$, this.$_y2$, this.$_x1$, this.$_y2$], $id$$30$$)
};
...
D.$DvtChartAxis$$ = function $$DvtChartAxis$$$($context$$42$$, $callback$$42$$, $callbackObj$$6$$) {
  this.Init($context$$42$$, $callback$$42$$, $callbackObj$$6$$)
};
D.$DvtObj$$.$createSubclass$(D.$DvtChartAxis$$, D.$DvtAxis$$, "DvtChartAxis");
D.$JSCompiler_StaticMethods_axisToPlotArea$$ = function $$JSCompiler_StaticMethods_axisToPlotArea$$$($JSCompiler_StaticMethods_axisToPlotArea$self$$, $coord$$20$$) {
  if("tangential" == $JSCompiler_StaticMethods_axisToPlotArea$self$$.$getOptions$().position) {
    return $coord$$20$$
  }
  if($coord$$20$$ == D.$JSCompiler_alias_NULL$$) {
    return D.$JSCompiler_alias_NULL$$
  }
  var $ret$$6$$ = $coord$$20$$ - (0,D.$JSCompiler_StaticMethods_getLeftOverflow$$)($JSCompiler_StaticMethods_axisToPlotArea$self$$);
  return window.Math.round(10 * $ret$$6$$) / 10
};
D.$JSCompiler_StaticMethods_plotAreaToAxis$$ = function $$JSCompiler_StaticMethods_plotAreaToAxis$$$($JSCompiler_StaticMethods_plotAreaToAxis$self$$, $coord$$21$$) {
  ...
  var $ret$$7$$ = $coord$$21$$ + (0,D.$JSCompiler_StaticMethods_getLeftOverflow$$)($JSCompiler_StaticMethods_plotAreaToAxis$self$$);
...
D.$JSCompiler_prototypeAlias$$.$getValueAt$ = function $$JSCompiler_prototypeAlias$$$$getValueAt$$($coord$$22$$) {
  return this.$Info$.$getValueAt$((0,D.$JSCompiler_StaticMethods_plotAreaToAxis$$)(this, $coord$$22$$))
};
...
D.$JSCompiler_prototypeAlias$$.$getBoundedValueAt$ = function $$JSCompiler_prototypeAlias$$$$getBoundedValueAt$$($coord$$23$$) {
  return this.$Info$.$getBoundedValueAt$((0,D.$JSCompiler_StaticMethods_plotAreaToAxis$$)(this, $coord$$23$$))
};
...
D.$JSCompiler_prototypeAlias$$.$getUnboundedValueAt$ = function $$JSCompiler_prototypeAlias$$$$getUnboundedValueAt$$($coord$$24$$) {
  return this.$Info$.$getUnboundedValueAt$((0,D.$JSCompiler_StaticMethods_plotAreaToAxis$$)(this, $coord$$24$$))
};
...
D.$JSCompiler_StaticMethods_getUnboundedLinearValueAt$$ = function $$JSCompiler_StaticMethods_getUnboundedLinearValueAt$$$($JSCompiler_StaticMethods_getUnboundedLinearValueAt$self$$, $coord$$25$$) {
  return $JSCompiler_StaticMethods_getUnboundedLinearValueAt$self$$.$Info$.$actualToLinear$($JSCompiler_StaticMethods_getUnboundedLinearValueAt$self$$.$getUnboundedValueAt$($coord$$25$$))
};
...
D.$JSCompiler_prototypeAlias$$.$setAnimationParams$ = function $$JSCompiler_prototypeAlias$$$$setAnimationParams$$($params$$15$$, $indicator$$2$$) {
  ...
  if($indicator$$2$$) {
    var $indicatorPosition_x$$inline_2265$$, $widthCoord$$inline_2264_y$$inline_2266$$ = (this.$_x1$ + this.$_x2$) / 2, $lengthCoord$$inline_2268_midLength$$inline_2267$$ = this.$_bStacked$ ? (this.$_endCoord$ + this.$_baselineCoord$) / 2 : this.$_endCoord$ >= this.$_baselineCoord$ ? this.$_endCoord$ + 8 : this.$_endCoord$ - 8;
    $indicatorPosition_x$$inline_2265$$ = this.$_bHoriz$ ? $lengthCoord$$inline_2268_midLength$$inline_2267$$ : $widthCoord$$inline_2264_y$$inline_2266$$;
    $widthCoord$$inline_2264_y$$inline_2266$$ = this.$_bHoriz$ ? $widthCoord$$inline_2264_y$$inline_2266$$ : $lengthCoord$$inline_2268_midLength$$inline_2267$$;
    $indicatorPosition_x$$inline_2265$$ = new D.$DvtPoint$$($indicatorPosition_x$$inline_2265$$, $widthCoord$$inline_2264_y$$inline_2266$$);
    (0,D.$JSCompiler_StaticMethods_setTranslate$$)($indicator$$2$$, $indicatorPosition_x$$inline_2265$$.x, $indicatorPosition_x$$inline_2265$$.y);
...
D.$JSCompiler_prototypeAlias$$.$_setBarCoords$ = function $$JSCompiler_prototypeAlias$$$$_setBarCoords$$($baselineCoord$$4_gapSize$$2$$, $barWidth$$2_endCoord$$1$$, $bStartsAtBaseline_x1$$8$$, $x2$$6$$, $bAdjustForGaps$$) {
  ...
  -$baselineCoord$$4_gapSize$$2$$), 5 <= $barWidth$$2_endCoord$$1$$ && (1 == (0,D.$DvtAgent$getDevicePixelRatio$$)() && 15 < $barWidth$$2_endCoord$$1$$ ? ((0,D.$DvtAgent$isPlatformGecko$$)() || (0,D.$JSCompiler_StaticMethods_setPixelHinting$$)(this), this.$_x1$ = window.Math.round(this.$_x1$), this.$_x2$ = window.Math.round(this.$_x2$), this.$_origX1$ = this.$_x1$, this.$_origX2$ = this.$_x2$, this.$_x2$ -= $baselineCoord$$4_gapSize$$2$$) : (this.$_x1$ += $baselineCoord$$4_gapSize$$2$$ / 2, this.$_x2$ -= 
  $baselineCoord$$4_gapSize$$2$$ / 2)));
...
D.$JSCompiler_prototypeAlias$$.$getBoundingBox$ = function $$JSCompiler_prototypeAlias$$$$getBoundingBox$$() {
  var $x$$78$$ = window.Math.min(this.$_x2$, this.$_x1$), $y$$58$$ = window.Math.min(this.$_endCoord$, this.$_baselineCoord$), $w$$7$$ = window.Math.abs(this.$_x2$ - this.$_x1$), $h$$5$$ = window.Math.abs(this.$_endCoord$ - this.$_baselineCoord$);
  return this.$_bHoriz$ ? new D.$DvtRectangle$$($y$$58$$, $x$$78$$, $h$$5$$, $w$$7$$) : new D.$DvtRectangle$$($x$$78$$, $y$$58$$, $w$$7$$, $h$$5$$)
};
...
D.$DvtChartLineArea$$.prototype.$setCoords$ = function $$DvtChartLineArea$$$$$setCoords$$($arCoord$$1$$, $arBaseCoord$$1$$) {
  ...
  for(var $indicator$$inline_2272_indicatorObj$$inline_2271$$, $pos$$inline_2273_y$$inline_2274$$, $coord$$inline_2275$$, $i$$inline_2276$$ = 0;$i$$inline_2276$$ < this.$_arCoord$.length;$i$$inline_2276$$++) {
    if($coord$$inline_2275$$ = this.$_arCoord$[$i$$inline_2276$$], ($indicator$$inline_2272_indicatorObj$$inline_2271$$ = this.$_indicatorMap$[$coord$$inline_2275$$.$groupIndex$]) && $indicator$$inline_2272_indicatorObj$$inline_2271$$.$indicator$) {
      $pos$$inline_2273_y$$inline_2274$$ = ((0,D.$JSCompiler_StaticMethods_isUpstep$$)($coord$$inline_2275$$, this.$_baseline$) ? $coord$$inline_2275$$.$y2$ : $coord$$inline_2275$$.$y1$) + 8 * ($indicator$$inline_2272_indicatorObj$$inline_2271$$.direction == D.$DvtDCChartUtils$$.$DIR_UP$ ? -1 : 1), $pos$$inline_2273_y$$inline_2274$$ = D.$DvtPlotAreaRenderer$$.$convertAxisCoord$(this.$_chart$, new D.$DvtPoint$$($coord$$inline_2275$$.x, $pos$$inline_2273_y$$inline_2274$$), this.$_availSpace$), $indicator$$inline_2272_indicatorObj$$inline_2271$$ = 
      $indicator$$inline_2272_indicatorObj$$inline_2271$$.$indicator$, (0,D.$JSCompiler_StaticMethods_setTranslate$$)($indicator$$inline_2272_indicatorObj$$inline_2271$$, $pos$$inline_2273_y$$inline_2274$$.x, $pos$$inline_2273_y$$inline_2274$$.y), $indicator$$inline_2272_indicatorObj$$inline_2271$$.$setAlpha$(1), $indicator$$inline_2272_indicatorObj$$inline_2271$$.getParent().$addChild$($indicator$$inline_2272_indicatorObj$$inline_2271$$)
    }
  }
};
D.$DvtChartLineArea$$.prototype.$isArea$ = (0,D.$JSCompiler_get$$)("$_bArea$");
D.$JSCompiler_StaticMethods__getPointArrays$$ = function $$JSCompiler_StaticMethods__getPointArrays$$$($JSCompiler_StaticMethods__getPointArrays$self_lastPoints$$, $coords$$16_coords$$inline_2278$$, $type$$81$$) {
  var $pointsArrays$$1$$ = [], $points$$9$$ = [];
  $pointsArrays$$1$$.push($points$$9$$);
  for(var $isPolar$$3_pointCoords$$inline_2279$$ = [], $i$$inline_2280_isCentered$$ = 0;$i$$inline_2280_isCentered$$ < $coords$$16_coords$$inline_2278$$.length;$i$$inline_2280_isCentered$$++) {
    if(!$coords$$16_coords$$inline_2278$$[$i$$inline_2280_isCentered$$].$filtered$) {
      if($coords$$16_coords$$inline_2278$$[$i$$inline_2280_isCentered$$].x == D.$JSCompiler_alias_NULL$$) {
        $isPolar$$3_pointCoords$$inline_2279$$.push(D.$JSCompiler_alias_NULL$$)
      }else {
        if($isPolar$$3_pointCoords$$inline_2279$$.push(new D.$DvtPoint$$($coords$$16_coords$$inline_2278$$[$i$$inline_2280_isCentered$$].x, $coords$$16_coords$$inline_2278$$[$i$$inline_2280_isCentered$$].$y1$)), $coords$$16_coords$$inline_2278$$[$i$$inline_2280_isCentered$$].$y1$ != $coords$$16_coords$$inline_2278$$[$i$$inline_2280_isCentered$$].$y2$) {
          var $isParallel_p2$$inline_2281$$ = new D.$DvtPoint$$($coords$$16_coords$$inline_2278$$[$i$$inline_2280_isCentered$$].x, $coords$$16_coords$$inline_2278$$[$i$$inline_2280_isCentered$$].$y2$);
          $isParallel_p2$$inline_2281$$.$_isY2$ = D.$JSCompiler_alias_TRUE$$;
          $isPolar$$3_pointCoords$$inline_2279$$.push($isParallel_p2$$inline_2281$$)
        }
      }
    }
  }
  $coords$$16_coords$$inline_2278$$ = $isPolar$$3_pointCoords$$inline_2279$$;
  var $isPolar$$3_pointCoords$$inline_2279$$ = D.$DvtChartTypeUtils$$.$isPolar$($JSCompiler_StaticMethods__getPointArrays$self_lastPoints$$.$_chart$), $isParallel_p2$$inline_2281$$ = ($i$$inline_2280_isCentered$$ = "centeredStepped" == $type$$81$$ || "centeredSegmented" == $type$$81$$) || "stepped" == $type$$81$$ || "segmented" == $type$$81$$, $groupWidth$$ = D.$DvtChartStyleUtils$$.$getGroupWidth$($JSCompiler_StaticMethods__getPointArrays$self_lastPoints$$.$_chart$), $dir$$22$$ = (0,D.$DvtAgent$isRightToLeft$$)($JSCompiler_StaticMethods__getPointArrays$self_lastPoints$$.$getCtx$()) && 
  D.$DvtChartTypeUtils$$.$isVertical$($JSCompiler_StaticMethods__getPointArrays$self_lastPoints$$.$_chart$) ? -1 : 1, $lastCoord$$;
  $isPolar$$3_pointCoords$$inline_2279$$ && ($lastCoord$$ = $coords$$16_coords$$inline_2278$$[$coords$$16_coords$$inline_2278$$.length - 1]);
  for(var $coord$$26_finalXCoord$$, $xCoord$$7$$, $isY2$$, $inBump$$ = D.$JSCompiler_alias_FALSE$$, $i$$164$$ = 0;$i$$164$$ < $coords$$16_coords$$inline_2278$$.length;$i$$164$$++) {
    if($coords$$16_coords$$inline_2278$$[$i$$164$$] == D.$JSCompiler_alias_NULL$$) {
      D.$DvtChartAxisUtils$$.$isMixedFrequency$($JSCompiler_StaticMethods__getPointArrays$self_lastPoints$$.$_chart$) || ($isParallel_p2$$inline_2281$$ && (!$isPolar$$3_pointCoords$$inline_2279$$ && $lastCoord$$ && !$isY2$$) && ($coord$$26_finalXCoord$$ = $i$$inline_2280_isCentered$$ ? $lastCoord$$.x + 0.5 * $groupWidth$$ * $dir$$22$$ : $lastCoord$$.x + $groupWidth$$ * $dir$$22$$, (0,D.$JSCompiler_StaticMethods__pushCoord$$)($JSCompiler_StaticMethods__getPointArrays$self_lastPoints$$, $points$$9$$, 
      $coord$$26_finalXCoord$$, $lastCoord$$.y)), $points$$9$$ = [], $pointsArrays$$1$$.push($points$$9$$), $lastCoord$$ = D.$JSCompiler_alias_NULL$$)
    }else {
      $coord$$26_finalXCoord$$ = $coords$$16_coords$$inline_2278$$[$i$$164$$];
      $isY2$$ = $coords$$16_coords$$inline_2278$$[$i$$164$$].$_isY2$;
      $xCoord$$7$$ = $i$$inline_2280_isCentered$$ ? $coord$$26_finalXCoord$$.x - $groupWidth$$ / 2 * $dir$$22$$ : $coord$$26_finalXCoord$$.x;
      $isY2$$ && ($inBump$$ && $isParallel_p2$$inline_2281$$ && ($xCoord$$7$$ += $groupWidth$$ * $dir$$22$$), $inBump$$ = !$inBump$$);
      "curved" == $type$$81$$ && $isY2$$ && $points$$9$$.push(D.$JSCompiler_alias_NULL$$, D.$JSCompiler_alias_NULL$$);
      $lastCoord$$ && $isParallel_p2$$inline_2281$$ && (0,D.$JSCompiler_StaticMethods__pushCoord$$)($JSCompiler_StaticMethods__getPointArrays$self_lastPoints$$, $points$$9$$, $xCoord$$7$$, $lastCoord$$.y);
      ...
      (0,D.$JSCompiler_StaticMethods__pushCoord$$)($JSCompiler_StaticMethods__getPointArrays$self_lastPoints$$, $points$$9$$, $xCoord$$7$$, $coord$$26_finalXCoord$$.y);
      $lastCoord$$ = $coord$$26_finalXCoord$$
    }
  }
  $isParallel_p2$$inline_2281$$ && (!$isPolar$$3_pointCoords$$inline_2279$$ && $lastCoord$$ && !$isY2$$) && ($coord$$26_finalXCoord$$ = $i$$inline_2280_isCentered$$ ? $lastCoord$$.x + 0.5 * $groupWidth$$ * $dir$$22$$ : $lastCoord$$.x + $groupWidth$$ * $dir$$22$$, (0,D.$JSCompiler_StaticMethods__pushCoord$$)($JSCompiler_StaticMethods__getPointArrays$self_lastPoints$$, $points$$9$$, $coord$$26_finalXCoord$$, $lastCoord$$.y));
  $isPolar$$3_pointCoords$$inline_2279$$ && 1 < $pointsArrays$$1$$.length && ($JSCompiler_StaticMethods__getPointArrays$self_lastPoints$$ = $pointsArrays$$1$$.pop(), $pointsArrays$$1$$[0] = $JSCompiler_StaticMethods__getPointArrays$self_lastPoints$$.concat($pointsArrays$$1$$[0]));
  return $pointsArrays$$1$$
};
D.$JSCompiler_StaticMethods__pushCoord$$ = function $$JSCompiler_StaticMethods__pushCoord$$$($JSCompiler_StaticMethods__pushCoord$self_coord$$27$$, $pointArray$$, $x$$80$$, $y$$59$$) {
  $JSCompiler_StaticMethods__pushCoord$self_coord$$27$$ = D.$DvtPlotAreaRenderer$$.$convertAxisCoord$($JSCompiler_StaticMethods__pushCoord$self_coord$$27$$.$_chart$, new D.$DvtPoint$$($x$$80$$, $y$$59$$), $JSCompiler_StaticMethods__pushCoord$self_coord$$27$$.$_availSpace$);
  $pointArray$$.push(window.Math.round(10 * $JSCompiler_StaticMethods__pushCoord$self_coord$$27$$.x) / 10, window.Math.round(10 * $JSCompiler_StaticMethods__pushCoord$self_coord$$27$$.y) / 10)
};
      ...
      for(var $groups$$ = (0,D.$DvtChartLineArea$_coordsToGroups$$)($coords$$19$$), $idx$$3$$ = $coords$$19$$.length, $dummyCoord_group$$15_groupIdx$$, $g$$3_i$$171$$ = $otherCoords_otherGroups$$.length - 1;0 <= $g$$3_i$$171$$;$g$$3_i$$171$$--) {
        if($dummyCoord_group$$15_groupIdx$$ = $otherCoords_otherGroups$$[$g$$3_i$$171$$], $dummyCoord_group$$15_groupIdx$$ = $groups$$.indexOf($dummyCoord_group$$15_groupIdx$$), -1 == $dummyCoord_group$$15_groupIdx$$) {
          if(0 == $idx$$3$$) {
            ...
            var $startCoord$$inline_2283_startCoord$$inline_2287$$ = $dummyCoord_group$$15_groupIdx$$, $endCoord$$inline_2284$$ = $coords$$19$$[0];
            (0,D.$JSCompiler_StaticMethods_isUpstep$$)($startCoord$$inline_2283_startCoord$$inline_2287$$, $baseline$$6_params$$18$$) ? $endCoord$$inline_2284$$.$y1$ = $endCoord$$inline_2284$$.$y2$ : $startCoord$$inline_2283_startCoord$$inline_2287$$.$y2$ = $startCoord$$inline_2283_startCoord$$inline_2287$$.$y1$
          }else {
            $dummyCoord_group$$15_groupIdx$$ = $coords$$19$$[$idx$$3$$ - 1].$clone$(), $coords$$19$$[$idx$$3$$ - 1] = $coords$$19$$[$idx$$3$$ - 1].$clone$(), $startCoord$$inline_2283_startCoord$$inline_2287$$ = $coords$$19$$[$idx$$3$$ - 1], (0,D.$JSCompiler_StaticMethods_isUpstep$$)($startCoord$$inline_2283_startCoord$$inline_2287$$, $baseline$$6_params$$18$$) ? $dummyCoord_group$$15_groupIdx$$.$y1$ = $dummyCoord_group$$15_groupIdx$$.$y2$ : $startCoord$$inline_2283_startCoord$$inline_2287$$.$y2$ = 
            $startCoord$$inline_2283_startCoord$$inline_2287$$.$y1$
          }
...
D.$DvtChartLineArea$_removeAreaEdge$$ = function $$DvtChartLineArea$_removeAreaEdge$$$($arCoord$$3$$, $index$$133$$, $baseline$$8$$) {
  var $coord$$29$$ = $arCoord$$3$$[$index$$133$$].$clone$();
  (0,D.$JSCompiler_StaticMethods_isUpstep$$)($coord$$29$$, $baseline$$8$$) ? $coord$$29$$.$y1$ = $coord$$29$$.$y2$ : $coord$$29$$.$y2$ = $coord$$29$$.$y1$;
  $arCoord$$3$$[$index$$133$$] = $coord$$29$$
};
D.$DvtChartLineMarker$$ = function $$DvtChartLineMarker$$$($context$$44$$, $type$$82$$, $cx$$4$$, $cy$$5$$, $size$$17$$, $bOptimizeStroke$$2$$) {
  this.Init($context$$44$$, $type$$82$$, D.$JSCompiler_alias_NULL$$, $cx$$4$$, $cy$$5$$, $size$$17$$, $size$$17$$);
...
D.$JSCompiler_prototypeAlias$$.$render$ = function $$JSCompiler_prototypeAlias$$$$render$$($options$$55$$, $width$$40$$, $glassPane$$inline_2295_height$$43$$) {
  $options$$55$$.style = {overviewBackgroundColor:"rgba(0,0,0,0)", windowBackgroundColor:"rgba(0,0,0,0)", windowBorderTopColor:"#333333", windowBorderRightColor:"#333333", windowBorderBottomColor:"#333333", windowBorderLeftColor:"#333333", leftFilterPanelColor:"rgba(5,65,135,0.1)", rightFilterPanelColor:"rgba(5,65,135,0.1)", handleBackgroundImage:$options$$55$$.chart._resources.overviewGrippy, handleWidth:3, handleHeight:15, handleFillColor:"rgba(0,0,0,0)"};
  $options$$55$$.animationOnClick = "off";
  var $options$$inline_2292$$ = $options$$55$$.chart;
  this.$_chartContainer$ = new D.$DvtContainer$$(this.$getCtx$());
  this.$addChild$(this.$_chartContainer$);
  $options$$inline_2292$$ = D.$DvtJSONUtils$$.$merge$({zoomAndScroll:"off", legend:{rendered:"off"}, xAxis:{viewportMin:D.$JSCompiler_alias_NULL$$, viewportMax:D.$JSCompiler_alias_NULL$$, viewportStartGroup:D.$JSCompiler_alias_NULL$$, viewportEndGroup:D.$JSCompiler_alias_NULL$$, axisLine:{rendered:"off"}, maxSize:0.5, title:D.$JSCompiler_alias_NULL$$}, yAxis:{rendered:"off"}, y2Axis:{rendered:"off"}, splitDualY:"off", title:{text:D.$JSCompiler_alias_NULL$$}, subtitle:{text:D.$JSCompiler_alias_NULL$$}, 
  footnote:{text:D.$JSCompiler_alias_NULL$$}, titleSeparator:{rendered:"off"}, styleDefaults:{animationIndicators:"none"}, layout:{outerGapWidth:0, outerGapHeight:0}, _isOverview:D.$JSCompiler_alias_TRUE$$}, $options$$inline_2292$$);
  D.$DvtChartAxisUtils$$.$hasGroupAxis$(this.$_parentChart$) && ($options$$inline_2292$$.xAxis.tickLabel.rendered = "off");
  D.$DvtChartTypeUtils$$.$isStock$(this.$_parentChart$) && ($options$$inline_2292$$.series && $options$$inline_2292$$.series[0]) && ($options$$inline_2292$$.series = [$options$$inline_2292$$.series[0]], $options$$inline_2292$$.series[0].type = "lineWithArea");
  ...
  this.$_chart$.$render$($options$$inline_2292$$, $width$$40$$, $glassPane$$inline_2295_height$$43$$);
  $glassPane$$inline_2295_height$$43$$ = new D.$DvtRect$$(this.$getCtx$(), 0, 0, $width$$40$$, $glassPane$$inline_2295_height$$43$$);
  (0,D.$JSCompiler_StaticMethods_setInvisibleFill$$)($glassPane$$inline_2295_height$$43$$);
  this.$_chartContainer$.$addChild$($glassPane$$inline_2295_height$$43$$);
  (0,D.$JSCompiler_StaticMethods_setKeyboardHandler$$)(this.$_chart$.$__getEventManager$(), D.$JSCompiler_alias_NULL$$);
  D.$DvtChartOverview$$.$superclass$.$render$.call(this, $options$$55$$, $width$$40$$, this.$_chart$.$_plotAreaSpace$.$h$)
};
...
D.$DvtChartPolarBar$$ = function $$DvtChartPolarBar$$$($chart$$105$$, $axisCoord$$2$$, $baselineCoord$$6$$, $endCoord$$4$$, $x1$$12$$, $x2$$10$$, $availSpace$$74$$) {
  ...
  this.$_setBarCoords$($baselineCoord$$6$$, $endCoord$$4$$, $x1$$12$$, $x2$$10$$, D.$JSCompiler_alias_TRUE$$)
};
...
D.$JSCompiler_prototypeAlias$$.$setAnimationParams$ = function $$JSCompiler_prototypeAlias$$$$setAnimationParams$$($params$$20$$) {
  this.$_setBarCoords$($params$$20$$[0], $params$$20$$[1], $params$$20$$[2], $params$$20$$[3], D.$JSCompiler_alias_FALSE$$)
};
...
D.$JSCompiler_prototypeAlias$$.$_setBarCoords$ = function $$JSCompiler_prototypeAlias$$$$_setBarCoords$$($baselineCoord$$7$$, $endCoord$$5$$, $x1$$13$$, $x2$$11$$, $bAdjustForGaps$$1_inner1_ir_maxY$$) {
  var $cmds$$inline_2306_cx$$5_minX$$ = this.$_availSpace$.x + this.$_availSpace$.$w$ / 2, $cy$$6_maxX$$ = this.$_availSpace$.y + this.$_availSpace$.$h$ / 2, $minY_r$$3$$ = window.Math.max($endCoord$$5$$, $baselineCoord$$7$$);
  $bAdjustForGaps$$1_inner1_ir_maxY$$ = 4 <= window.Math.abs($endCoord$$5$$ - $baselineCoord$$7$$) && this.$_axisCoord$ != $baselineCoord$$7$$ && $bAdjustForGaps$$1_inner1_ir_maxY$$ ? window.Math.min($endCoord$$5$$, $baselineCoord$$7$$) + this.$_dataItemGaps$ : window.Math.min($endCoord$$5$$, $baselineCoord$$7$$);
  var $inner2_sa$$inline_2302$$ = 360 - D.$DvtMath$$.$radsToDegrees$(window.Math.max($x1$$13$$, $x2$$11$$)) + 90, $ae$$inline_2303_outer1$$ = D.$DvtMath$$.$radsToDegrees$(window.Math.abs($x2$$11$$ - $x1$$13$$)), $gap$$inline_2304_outer2$$ = this.$_dataItemGaps$;
  this.$_cx$ = $cmds$$inline_2306_cx$$5_minX$$;
  this.$_cy$ = $cy$$6_maxX$$;
  this.$_ry$ = this.$_rx$ = $minY_r$$3$$;
  this.$_sa$ = $inner2_sa$$inline_2302$$;
  this.$_ae$ = $ae$$inline_2303_outer1$$;
  this.$_gap$ = $gap$$inline_2304_outer2$$;
  this.$_ir$ = $bAdjustForGaps$$1_inner1_ir_maxY$$;
  $cmds$$inline_2306_cx$$5_minX$$ = (0,D.$JSCompiler_StaticMethods__makeWedgePath$$)(this, 0);
  this.$setCmds$($cmds$$inline_2306_cx$$5_minX$$);
  $bAdjustForGaps$$1_inner1_ir_maxY$$ = D.$DvtPlotAreaRenderer$$.$polarToCartesian$($baselineCoord$$7$$, $x1$$13$$, this.$_availSpace$);
  $inner2_sa$$inline_2302$$ = D.$DvtPlotAreaRenderer$$.$polarToCartesian$($baselineCoord$$7$$, $x2$$11$$, this.$_availSpace$);
  $ae$$inline_2303_outer1$$ = D.$DvtPlotAreaRenderer$$.$polarToCartesian$($endCoord$$5$$, $x1$$13$$, this.$_availSpace$);
  $gap$$inline_2304_outer2$$ = D.$DvtPlotAreaRenderer$$.$polarToCartesian$($endCoord$$5$$, $x2$$11$$, this.$_availSpace$);
  $cmds$$inline_2306_cx$$5_minX$$ = window.Math.min($bAdjustForGaps$$1_inner1_ir_maxY$$.x, $inner2_sa$$inline_2302$$.x, $ae$$inline_2303_outer1$$.x, $gap$$inline_2304_outer2$$.x);
  $cy$$6_maxX$$ = window.Math.max($bAdjustForGaps$$1_inner1_ir_maxY$$.x, $inner2_sa$$inline_2302$$.x, $ae$$inline_2303_outer1$$.x, $gap$$inline_2304_outer2$$.x);
  $minY_r$$3$$ = window.Math.min($bAdjustForGaps$$1_inner1_ir_maxY$$.y, $inner2_sa$$inline_2302$$.y, $ae$$inline_2303_outer1$$.y, $gap$$inline_2304_outer2$$.y);
  $bAdjustForGaps$$1_inner1_ir_maxY$$ = window.Math.max($bAdjustForGaps$$1_inner1_ir_maxY$$.y, $inner2_sa$$inline_2302$$.y, $ae$$inline_2303_outer1$$.y, $gap$$inline_2304_outer2$$.y);
  this.$_bbox$ = new D.$DvtRectangle$$($cmds$$inline_2306_cx$$5_minX$$, $minY_r$$3$$, $cy$$6_maxX$$ - $cmds$$inline_2306_cx$$5_minX$$, $bAdjustForGaps$$1_inner1_ir_maxY$$ - $minY_r$$3$$);
...
D.$DvtDataCursor$$ = function $$DvtDataCursor$$$($context$$46$$, $options$$56$$, $bHoriz$$6$$) {
  this.Init($context$$46$$, $options$$56$$, $bHoriz$$6$$)
};
D.$DvtObj$$.$createSubclass$(D.$DvtDataCursor$$, D.$DvtContainer$$, "DvtDataCursor");
D.$DvtDataCursor$$.prototype.Init = function $$DvtDataCursor$$$$Init$($context$$47_lineWidth$$3_middleCircle$$, $markerSize$$3_options$$57$$, $bHoriz$$7_lineColor$$1$$) {
  D.$DvtDataCursor$$.$superclass$.Init.call(this, $context$$47_lineWidth$$3_middleCircle$$);
  this.$_bHoriz$ = $bHoriz$$7_lineColor$$1$$;
  this.$_options$ = $markerSize$$3_options$$57$$;
  this.$setMouseEnabled$(D.$JSCompiler_alias_FALSE$$);
  this.$setVisible$(D.$JSCompiler_alias_FALSE$$);
  $context$$47_lineWidth$$3_middleCircle$$ = $markerSize$$3_options$$57$$.lineWidth;
  $bHoriz$$7_lineColor$$1$$ = $markerSize$$3_options$$57$$.lineColor;
  var $lineStyle$$1_outerCircle$$ = (0,D.$DvtStroke$convertTypeString$$)($markerSize$$3_options$$57$$.lineStyle), $stroke$$16$$ = new D.$DvtSolidStroke$$($bHoriz$$7_lineColor$$1$$, 1, $context$$47_lineWidth$$3_middleCircle$$);
  ...
  "off" != $markerSize$$3_options$$57$$.markerDisplayed && (this.$_marker$ = new D.$DvtContainer$$(this.$_context$), this.$_marker$.$setMouseEnabled$(D.$JSCompiler_alias_FALSE$$), this.$addChild$(this.$_marker$), $markerSize$$3_options$$57$$ = $markerSize$$3_options$$57$$.markerSize, $lineStyle$$1_outerCircle$$ = new D.$DvtSimpleMarker$$(this.$_context$, "circle", D.$JSCompiler_alias_NULL$$, 0, 0, $markerSize$$3_options$$57$$ + 4 * $context$$47_lineWidth$$3_middleCircle$$, $markerSize$$3_options$$57$$ + 
  4 * $context$$47_lineWidth$$3_middleCircle$$), $lineStyle$$1_outerCircle$$.$setSolidFill$($bHoriz$$7_lineColor$$1$$), this.$_marker$.$addChild$($lineStyle$$1_outerCircle$$), $context$$47_lineWidth$$3_middleCircle$$ = new D.$DvtSimpleMarker$$(this.$_context$, "circle", D.$JSCompiler_alias_NULL$$, 0, 0, $markerSize$$3_options$$57$$ + 2 * $context$$47_lineWidth$$3_middleCircle$$, $markerSize$$3_options$$57$$ + 2 * $context$$47_lineWidth$$3_middleCircle$$), $context$$47_lineWidth$$3_middleCircle$$.$setSolidFill$("white"), 
  this.$_marker$.$addChild$($context$$47_lineWidth$$3_middleCircle$$), this.$_markerInnerCircle$ = new D.$DvtSimpleMarker$$(this.$_context$, "circle", D.$JSCompiler_alias_NULL$$, 0, 0, $markerSize$$3_options$$57$$, $markerSize$$3_options$$57$$), this.$_marker$.$addChild$(this.$_markerInnerCircle$))
};
D.$DvtDataCursor$$.prototype.$render$ = function $$DvtDataCursor$$$$$render$$($markerColor_plotAreaBounds$$9$$, $dataX$$, $dataY$$, $lineCoord$$2$$, $markerSizeOuter_text$$45$$, $dataColor$$9$$) {
  var $bHoriz$$8$$ = this.$isHorizontal$(), $bRtl$$ = (0,D.$DvtAgent$isRightToLeft$$)(this.$getCtx$()), $tooltipBounds$$;
  if($markerSizeOuter_text$$45$$ != D.$JSCompiler_alias_NULL$$ && "" != $markerSizeOuter_text$$45$$) {
    var $stagePageCoords$$ = (0,D.$JSCompiler_StaticMethods_getStageAbsolutePosition$$)(this.$getCtx$()), $tooltipManager$$1$$ = this.$getCtx$().$getTooltipManager$("_dvtDataCursor");
    $tooltipManager$$1$$.$showDatatip$($dataX$$ + $stagePageCoords$$.x, $dataY$$ + $stagePageCoords$$.y, $markerSizeOuter_text$$45$$, $dataColor$$9$$, D.$JSCompiler_alias_FALSE$$);
    $tooltipBounds$$ = (0,D.$JSCompiler_StaticMethods_getTooltipBounds$$)($tooltipManager$$1$$);
    $markerSizeOuter_text$$45$$ = this.$_options$.markerSize + 4 * this.$_options$.lineWidth;
    var $tooltipX$$, $tooltipY$$;
    $bHoriz$$8$$ ? ($tooltipX$$ = $bRtl$$ ? $markerColor_plotAreaBounds$$9$$.x - 0.75 * $tooltipBounds$$.$w$ : $markerColor_plotAreaBounds$$9$$.x + $markerColor_plotAreaBounds$$9$$.$w$ - $tooltipBounds$$.$w$ / 4, $tooltipY$$ = $lineCoord$$2$$ - $tooltipBounds$$.$h$ / 2, !$bRtl$$ && $tooltipX$$ - $dataX$$ < $markerSizeOuter_text$$45$$ ? $tooltipX$$ = $dataX$$ + $markerSizeOuter_text$$45$$ : $bRtl$$ && $dataX$$ - ($tooltipX$$ + $tooltipBounds$$.$w$) < $markerSizeOuter_text$$45$$ && ($tooltipX$$ = $dataX$$ - 
    $markerSizeOuter_text$$45$$ - $tooltipBounds$$.$w$)) : ($tooltipX$$ = $lineCoord$$2$$ - $tooltipBounds$$.$w$ / 2, $tooltipY$$ = $markerColor_plotAreaBounds$$9$$.y - 0.75 * $tooltipBounds$$.$h$, $dataY$$ - ($tooltipY$$ + $tooltipBounds$$.$h$) < $markerSizeOuter_text$$45$$ && ($tooltipY$$ = $dataY$$ - $markerSizeOuter_text$$45$$ - $tooltipBounds$$.$h$));
    (0,D.$JSCompiler_StaticMethods_positionTip$$)($tooltipManager$$1$$, $tooltipX$$ + $stagePageCoords$$.x, $tooltipY$$ + $stagePageCoords$$.y);
    $tooltipBounds$$ = (0,D.$JSCompiler_StaticMethods_getTooltipBounds$$)($tooltipManager$$1$$);
    $tooltipBounds$$.x -= $stagePageCoords$$.x;
    $tooltipBounds$$.y -= $stagePageCoords$$.y
  }
  $bHoriz$$8$$ ? (this.$_cursorLine$.$setTranslateY$($lineCoord$$2$$), $bRtl$$ ? (this.$_cursorLine$.$setX1$($tooltipBounds$$ ? $tooltipBounds$$.x + $tooltipBounds$$.$w$ - 1 : $markerColor_plotAreaBounds$$9$$.x), this.$_cursorLine$.$setX2$($markerColor_plotAreaBounds$$9$$.x + $markerColor_plotAreaBounds$$9$$.$w$)) : (this.$_cursorLine$.$setX1$($markerColor_plotAreaBounds$$9$$.x), this.$_cursorLine$.$setX2$($tooltipBounds$$ ? $tooltipBounds$$.x + 1 : $markerColor_plotAreaBounds$$9$$.x + $markerColor_plotAreaBounds$$9$$.$w$))) : 
  (this.$_cursorLine$.$setTranslateX$($lineCoord$$2$$), this.$_cursorLine$.$setY1$($tooltipBounds$$ ? $tooltipBounds$$.y + $tooltipBounds$$.$h$ - 1 : $markerColor_plotAreaBounds$$9$$.y), this.$_cursorLine$.$setY2$($markerColor_plotAreaBounds$$9$$.y + $markerColor_plotAreaBounds$$9$$.$h$));
  this.$_marker$ && ((0,D.$JSCompiler_StaticMethods_setTranslate$$)(this.$_marker$, $dataX$$, $dataY$$), $markerColor_plotAreaBounds$$9$$ = this.$_options$.markerColor, this.$_markerInnerCircle$.$setSolidFill$($markerColor_plotAreaBounds$$9$$ ? $markerColor_plotAreaBounds$$9$$ : $dataColor$$9$$), (0,D.$DvtAgent$workaroundFirefoxRepaint$$)(this.$_marker$))
};
...
D.$DvtFunnelSlice$$.prototype.Init = function $$DvtFunnelSlice$$$$Init$($bbox$$inline_2332_chart$$107_cmd$$inline_2331_options$$58_padding$$inline_2329$$, $JSCompiler_inline_result$$372_hoverColor$$inline_2314_seriesIndex$$37_sliceBounds$$inline_2320_sliceFill$$inline_2310$$, $barBounds$$inline_2321_cmds$$6_labelColor$$inline_2333_numDrawnSeries$$2$$, $funnelWidth$$1_innerColor$$inline_2315_label$$inline_2323_labelString$$inline_2322_sliceBorder$$inline_2311$$, $funnelHeight$$1_isPatternBg$$inline_2324_outerColor$$inline_2316_sliceBorderWidth$$inline_2312$$, 
$backgroundFill$$inline_2313_labelStyleArray$$inline_2325_shapeForSelection$$inline_2317_sliceBounds$$inline_2309_startPercent$$1_style$$inline_2326$$, $textDim$$inline_2327_valuePercent$$1$$, $fillPercent$$1_pos$$inline_2328$$, $displacement$$inline_2330_gap$$13$$) {
  D.$DvtFunnelSlice$$.$superclass$.Init.call(this, $bbox$$inline_2332_chart$$107_cmd$$inline_2331_options$$58_padding$$inline_2329$$.$getCtx$());
  this.$_chart$ = $bbox$$inline_2332_chart$$107_cmd$$inline_2331_options$$58_padding$$inline_2329$$;
  $bbox$$inline_2332_chart$$107_cmd$$inline_2331_options$$58_padding$$inline_2329$$ = $bbox$$inline_2332_chart$$107_cmd$$inline_2331_options$$58_padding$$inline_2329$$.$getOptions$();
  this.$_seriesIndex$ = $JSCompiler_inline_result$$372_hoverColor$$inline_2314_seriesIndex$$37_sliceBounds$$inline_2320_sliceFill$$inline_2310$$;
  this.$_numDrawnSeries$ = $barBounds$$inline_2321_cmds$$6_labelColor$$inline_2333_numDrawnSeries$$2$$;
  this.$_funnelWidth$ = $funnelWidth$$1_innerColor$$inline_2315_label$$inline_2323_labelString$$inline_2322_sliceBorder$$inline_2311$$;
  this.$_funnelHeight$ = $funnelHeight$$1_isPatternBg$$inline_2324_outerColor$$inline_2316_sliceBorderWidth$$inline_2312$$;
  this.$_startPercent$ = $backgroundFill$$inline_2313_labelStyleArray$$inline_2325_shapeForSelection$$inline_2317_sliceBounds$$inline_2309_startPercent$$1_style$$inline_2326$$;
  this.$_valuePercent$ = $textDim$$inline_2327_valuePercent$$1$$;
  this.$_fillPercent$ = $fillPercent$$1_pos$$inline_2328$$;
  this.$_3dRatio$ = "on" == $bbox$$inline_2332_chart$$107_cmd$$inline_2331_options$$58_padding$$inline_2329$$.styleDefaults.threeDEffect ? 1 : 0;
  this.$_gap$ = $displacement$$inline_2330_gap$$13$$;
  $barBounds$$inline_2321_cmds$$6_labelColor$$inline_2333_numDrawnSeries$$2$$ = (0,D.$JSCompiler_StaticMethods__getPath$$)(this);
  this.$_dataColor$ = D.$DvtChartStyleUtils$$.$getColor$(this.$_chart$, this.$_seriesIndex$, 0);
  this.$_backgroundColor$ = $bbox$$inline_2332_chart$$107_cmd$$inline_2331_options$$58_padding$$inline_2329$$.styleDefaults.backgroundColor;
  this.$_backgroundColor$ || (this.$_backgroundColor$ = D.$DvtFunnelSlice$_BACKGROUND_COLOR$$);
  this.$setCmds$($barBounds$$inline_2321_cmds$$6_labelColor$$inline_2333_numDrawnSeries$$2$$.slice);
  $barBounds$$inline_2321_cmds$$6_labelColor$$inline_2333_numDrawnSeries$$2$$.bar && (this.$_bar$ = new D.$DvtPath$$(this.$getCtx$(), $barBounds$$inline_2321_cmds$$6_labelColor$$inline_2333_numDrawnSeries$$2$$.bar), this.$addChild$(this.$_bar$), this.$_bar$.$setMouseEnabled$(D.$JSCompiler_alias_FALSE$$));
  $backgroundFill$$inline_2313_labelStyleArray$$inline_2325_shapeForSelection$$inline_2317_sliceBounds$$inline_2309_startPercent$$1_style$$inline_2326$$ = $barBounds$$inline_2321_cmds$$6_labelColor$$inline_2333_numDrawnSeries$$2$$.sliceBounds;
  $JSCompiler_inline_result$$372_hoverColor$$inline_2314_seriesIndex$$37_sliceBounds$$inline_2320_sliceFill$$inline_2310$$ = D.$DvtChartSeriesEffectUtils$$.$getFunnelSliceFill$(this.$_chart$, this.$_seriesIndex$, this.$_dataColor$, $backgroundFill$$inline_2313_labelStyleArray$$inline_2325_shapeForSelection$$inline_2317_sliceBounds$$inline_2309_startPercent$$1_style$$inline_2326$$);
  $funnelWidth$$1_innerColor$$inline_2315_label$$inline_2323_labelString$$inline_2322_sliceBorder$$inline_2311$$ = D.$DvtChartStyleUtils$$.$getBorderColor$(this.$_chart$, this.$_seriesIndex$, 0);
  $funnelWidth$$1_innerColor$$inline_2315_label$$inline_2323_labelString$$inline_2322_sliceBorder$$inline_2311$$ == D.$JSCompiler_alias_NULL$$ && 0 < this.$_3dRatio$ && ($funnelWidth$$1_innerColor$$inline_2315_label$$inline_2323_labelString$$inline_2322_sliceBorder$$inline_2311$$ = "#FFFFFF");
  $funnelHeight$$1_isPatternBg$$inline_2324_outerColor$$inline_2316_sliceBorderWidth$$inline_2312$$ = D.$DvtChartStyleUtils$$.$getBorderWidth$(this.$_chart$, this.$_seriesIndex$, 0);
  $backgroundFill$$inline_2313_labelStyleArray$$inline_2325_shapeForSelection$$inline_2317_sliceBounds$$inline_2309_startPercent$$1_style$$inline_2326$$ = D.$DvtChartSeriesEffectUtils$$.$getFunnelSliceFill$(this.$_chart$, this.$_seriesIndex$, this.$_backgroundColor$, $backgroundFill$$inline_2313_labelStyleArray$$inline_2325_shapeForSelection$$inline_2317_sliceBounds$$inline_2309_startPercent$$1_style$$inline_2326$$, D.$JSCompiler_alias_TRUE$$);
  this.$_bar$ ? (this.$setFill$($backgroundFill$$inline_2313_labelStyleArray$$inline_2325_shapeForSelection$$inline_2317_sliceBounds$$inline_2309_startPercent$$1_style$$inline_2326$$), this.$_bar$.$setFill$($JSCompiler_inline_result$$372_hoverColor$$inline_2314_seriesIndex$$37_sliceBounds$$inline_2320_sliceFill$$inline_2310$$)) : this.$setFill$($JSCompiler_inline_result$$372_hoverColor$$inline_2314_seriesIndex$$37_sliceBounds$$inline_2320_sliceFill$$inline_2310$$);
  $funnelWidth$$1_innerColor$$inline_2315_label$$inline_2323_labelString$$inline_2322_sliceBorder$$inline_2311$$ && this.$setSolidStroke$($funnelWidth$$1_innerColor$$inline_2315_label$$inline_2323_labelString$$inline_2322_sliceBorder$$inline_2311$$, D.$JSCompiler_alias_NULL$$, $funnelHeight$$1_isPatternBg$$inline_2324_outerColor$$inline_2316_sliceBorderWidth$$inline_2312$$);
  this.$OriginalStroke$ = this.$getStroke$();
  this.$_chart$.$isSelectionSupported$() && ($JSCompiler_inline_result$$372_hoverColor$$inline_2314_seriesIndex$$37_sliceBounds$$inline_2320_sliceFill$$inline_2310$$ = D.$DvtSelectionEffectUtils$$.$getHoverBorderColor$(this.$_dataColor$), $funnelWidth$$1_innerColor$$inline_2315_label$$inline_2323_labelString$$inline_2322_sliceBorder$$inline_2311$$ = D.$DvtChartStyleUtils$$.$getSelectedInnerColor$(this.$_chart$), $funnelHeight$$1_isPatternBg$$inline_2324_outerColor$$inline_2316_sliceBorderWidth$$inline_2312$$ = 
  D.$DvtChartStyleUtils$$.$getSelectedOuterColor$(this.$_chart$) ? D.$DvtChartStyleUtils$$.$getSelectedOuterColor$(this.$_chart$) : this.$_dataColor$, $backgroundFill$$inline_2313_labelStyleArray$$inline_2325_shapeForSelection$$inline_2317_sliceBounds$$inline_2309_startPercent$$1_style$$inline_2326$$ = this.$_bar$ != D.$JSCompiler_alias_NULL$$ ? this.$_bar$ : this, $backgroundFill$$inline_2313_labelStyleArray$$inline_2325_shapeForSelection$$inline_2317_sliceBounds$$inline_2309_startPercent$$1_style$$inline_2326$$.$setHoverStroke$(new D.$DvtSolidStroke$$($JSCompiler_inline_result$$372_hoverColor$$inline_2314_seriesIndex$$37_sliceBounds$$inline_2320_sliceFill$$inline_2310$$, 
  1, 2)), $backgroundFill$$inline_2313_labelStyleArray$$inline_2325_shapeForSelection$$inline_2317_sliceBounds$$inline_2309_startPercent$$1_style$$inline_2326$$.$setSelectedStroke$(new D.$DvtSolidStroke$$($funnelWidth$$1_innerColor$$inline_2315_label$$inline_2323_labelString$$inline_2322_sliceBorder$$inline_2311$$, 1, 1.5), new D.$DvtSolidStroke$$($funnelHeight$$1_isPatternBg$$inline_2324_outerColor$$inline_2316_sliceBorderWidth$$inline_2312$$, 1, 4.5)), $backgroundFill$$inline_2313_labelStyleArray$$inline_2325_shapeForSelection$$inline_2317_sliceBounds$$inline_2309_startPercent$$1_style$$inline_2326$$.$setSelectedHoverStroke$(new D.$DvtSolidStroke$$($funnelWidth$$1_innerColor$$inline_2315_label$$inline_2323_labelString$$inline_2322_sliceBorder$$inline_2311$$, 
  1, 1.5), new D.$DvtSolidStroke$$($JSCompiler_inline_result$$372_hoverColor$$inline_2314_seriesIndex$$37_sliceBounds$$inline_2320_sliceFill$$inline_2310$$, 1, 4.5)), this.setCursor("pointer"));
  a: {
    $JSCompiler_inline_result$$372_hoverColor$$inline_2314_seriesIndex$$37_sliceBounds$$inline_2320_sliceFill$$inline_2310$$ = $barBounds$$inline_2321_cmds$$6_labelColor$$inline_2333_numDrawnSeries$$2$$.sliceBounds;
    $barBounds$$inline_2321_cmds$$6_labelColor$$inline_2333_numDrawnSeries$$2$$ = $barBounds$$inline_2321_cmds$$6_labelColor$$inline_2333_numDrawnSeries$$2$$.barBounds;
    ($funnelWidth$$1_innerColor$$inline_2315_label$$inline_2323_labelString$$inline_2322_sliceBorder$$inline_2311$$ = D.$DvtChartDataUtils$$.$getDataLabel$(this.$_chart$, this.$_seriesIndex$, 0)) || ($funnelWidth$$1_innerColor$$inline_2315_label$$inline_2323_labelString$$inline_2322_sliceBorder$$inline_2311$$ = D.$DvtChartDataUtils$$.$getSeriesLabel$(this.$_chart$, this.$_seriesIndex$));
    if($funnelWidth$$1_innerColor$$inline_2315_label$$inline_2323_labelString$$inline_2322_sliceBorder$$inline_2311$$ && "none" != D.$DvtChartStyleUtils$$.$getDataLabelPosition$(this.$_chart$, this.$_seriesIndex$, 0) && ($funnelWidth$$1_innerColor$$inline_2315_label$$inline_2323_labelString$$inline_2322_sliceBorder$$inline_2311$$ = new D.$DvtOutputText$$(this.$getCtx$(), $funnelWidth$$1_innerColor$$inline_2315_label$$inline_2323_labelString$$inline_2322_sliceBorder$$inline_2311$$, 0, 0), $funnelHeight$$1_isPatternBg$$inline_2324_outerColor$$inline_2316_sliceBorderWidth$$inline_2312$$ = 
    D.$DvtChartStyleUtils$$.$getPattern$(this.$_chart$, this.$_seriesIndex$, 0) != D.$JSCompiler_alias_NULL$$, $backgroundFill$$inline_2313_labelStyleArray$$inline_2325_shapeForSelection$$inline_2317_sliceBounds$$inline_2309_startPercent$$1_style$$inline_2326$$ = [this.$_chart$.$getOptions$().styleDefaults.dataLabelStyle, this.$_chart$.$getOptions$().styleDefaults.sliceLabelStyle, new D.$DvtCSSStyle$$(D.$DvtChartDataUtils$$.$getDataItem$(this.$_chart$, this.$_seriesIndex$, 0).labelStyle)], $backgroundFill$$inline_2313_labelStyleArray$$inline_2325_shapeForSelection$$inline_2317_sliceBounds$$inline_2309_startPercent$$1_style$$inline_2326$$ = 
    (0,D.$DvtCSSStyle$mergeStyles$$)($backgroundFill$$inline_2313_labelStyleArray$$inline_2325_shapeForSelection$$inline_2317_sliceBounds$$inline_2309_startPercent$$1_style$$inline_2326$$), $funnelWidth$$1_innerColor$$inline_2315_label$$inline_2323_labelString$$inline_2322_sliceBorder$$inline_2311$$.$setCSSStyle$($backgroundFill$$inline_2313_labelStyleArray$$inline_2325_shapeForSelection$$inline_2317_sliceBounds$$inline_2309_startPercent$$1_style$$inline_2326$$), D.$DvtTextUtils$$.$fitText$($funnelWidth$$1_innerColor$$inline_2315_label$$inline_2323_labelString$$inline_2322_sliceBorder$$inline_2311$$, 
    $JSCompiler_inline_result$$372_hoverColor$$inline_2314_seriesIndex$$37_sliceBounds$$inline_2320_sliceFill$$inline_2310$$.$h$ - 10, $JSCompiler_inline_result$$372_hoverColor$$inline_2314_seriesIndex$$37_sliceBounds$$inline_2320_sliceFill$$inline_2310$$.$w$, this, 3))) {
      $textDim$$inline_2327_valuePercent$$1$$ = $funnelWidth$$1_innerColor$$inline_2315_label$$inline_2323_labelString$$inline_2322_sliceBorder$$inline_2311$$.$measureDimensions$();
      $fillPercent$$1_pos$$inline_2328$$ = (0,D.$JSCompiler_StaticMethods__getLabelPosition$$)(this, $JSCompiler_inline_result$$372_hoverColor$$inline_2314_seriesIndex$$37_sliceBounds$$inline_2320_sliceFill$$inline_2310$$);
      $funnelHeight$$1_isPatternBg$$inline_2324_outerColor$$inline_2316_sliceBorderWidth$$inline_2312$$ && ($bbox$$inline_2332_chart$$107_cmd$$inline_2331_options$$58_padding$$inline_2329$$ = 0.15 * $textDim$$inline_2327_valuePercent$$1$$.$h$, $displacement$$inline_2330_gap$$13$$ = (0,D.$DvtAgent$isRightToLeft$$)(this.$getCtx$()) ? 0.5 : -0.5, $bbox$$inline_2332_chart$$107_cmd$$inline_2331_options$$58_padding$$inline_2329$$ = D.$DvtPathUtils$$.$roundedRectangle$($textDim$$inline_2327_valuePercent$$1$$.x - 
      $bbox$$inline_2332_chart$$107_cmd$$inline_2331_options$$58_padding$$inline_2329$$, $textDim$$inline_2327_valuePercent$$1$$.y, $textDim$$inline_2327_valuePercent$$1$$.$w$ + 2 * $bbox$$inline_2332_chart$$107_cmd$$inline_2331_options$$58_padding$$inline_2329$$, $textDim$$inline_2327_valuePercent$$1$$.$h$, 2, 2, 2, 2), $bbox$$inline_2332_chart$$107_cmd$$inline_2331_options$$58_padding$$inline_2329$$ = new D.$DvtPath$$(this.$getCtx$(), $bbox$$inline_2332_chart$$107_cmd$$inline_2331_options$$58_padding$$inline_2329$$), 
      $bbox$$inline_2332_chart$$107_cmd$$inline_2331_options$$58_padding$$inline_2329$$.$setSolidFill$("#FFFFFF", 0.9), $fillPercent$$1_pos$$inline_2328$$.translate($displacement$$inline_2330_gap$$13$$ * $textDim$$inline_2327_valuePercent$$1$$.$h$, -$displacement$$inline_2330_gap$$13$$ * $textDim$$inline_2327_valuePercent$$1$$.$w$), $bbox$$inline_2332_chart$$107_cmd$$inline_2331_options$$58_padding$$inline_2329$$.$setMatrix$($fillPercent$$1_pos$$inline_2328$$), this.$addChild$($bbox$$inline_2332_chart$$107_cmd$$inline_2331_options$$58_padding$$inline_2329$$));
      $barBounds$$inline_2321_cmds$$6_labelColor$$inline_2333_numDrawnSeries$$2$$ = $funnelHeight$$1_isPatternBg$$inline_2324_outerColor$$inline_2316_sliceBorderWidth$$inline_2312$$ ? "#0000000" : (0,D.$JSCompiler_StaticMethods_containsPoint$$)($barBounds$$inline_2321_cmds$$6_labelColor$$inline_2333_numDrawnSeries$$2$$, $JSCompiler_inline_result$$372_hoverColor$$inline_2314_seriesIndex$$37_sliceBounds$$inline_2320_sliceFill$$inline_2310$$.x, $JSCompiler_inline_result$$372_hoverColor$$inline_2314_seriesIndex$$37_sliceBounds$$inline_2320_sliceFill$$inline_2310$$.y + 
      ($JSCompiler_inline_result$$372_hoverColor$$inline_2314_seriesIndex$$37_sliceBounds$$inline_2320_sliceFill$$inline_2310$$.$h$ - $textDim$$inline_2327_valuePercent$$1$$.$w$) / 2) ? D.$DvtColorUtils$$.$getContrastingTextColor$(this.$_dataColor$) : D.$DvtColorUtils$$.$getContrastingTextColor$(this.$_backgroundColor$);
      (!$backgroundFill$$inline_2313_labelStyleArray$$inline_2325_shapeForSelection$$inline_2317_sliceBounds$$inline_2309_startPercent$$1_style$$inline_2326$$.$getStyle$("color") || D.$DvtAgent$_highContrast$$ === D.$JSCompiler_alias_TRUE$$) && $funnelWidth$$1_innerColor$$inline_2315_label$$inline_2323_labelString$$inline_2322_sliceBorder$$inline_2311$$.$setCSSStyle$($backgroundFill$$inline_2313_labelStyleArray$$inline_2325_shapeForSelection$$inline_2317_sliceBounds$$inline_2309_startPercent$$1_style$$inline_2326$$.$setStyle$("color", 
      $barBounds$$inline_2321_cmds$$6_labelColor$$inline_2333_numDrawnSeries$$2$$));
      $funnelWidth$$1_innerColor$$inline_2315_label$$inline_2323_labelString$$inline_2322_sliceBorder$$inline_2311$$.$setMatrix$((0,D.$JSCompiler_StaticMethods__getLabelPosition$$)(this, $JSCompiler_inline_result$$372_hoverColor$$inline_2314_seriesIndex$$37_sliceBounds$$inline_2320_sliceFill$$inline_2310$$));
      $funnelWidth$$1_innerColor$$inline_2315_label$$inline_2323_labelString$$inline_2322_sliceBorder$$inline_2311$$.$alignCenter$();
      $funnelWidth$$1_innerColor$$inline_2315_label$$inline_2323_labelString$$inline_2322_sliceBorder$$inline_2311$$.$alignMiddle$();
      $JSCompiler_inline_result$$372_hoverColor$$inline_2314_seriesIndex$$37_sliceBounds$$inline_2320_sliceFill$$inline_2310$$ = $funnelWidth$$1_innerColor$$inline_2315_label$$inline_2323_labelString$$inline_2322_sliceBorder$$inline_2311$$;
      break a
    }
    $JSCompiler_inline_result$$372_hoverColor$$inline_2314_seriesIndex$$37_sliceBounds$$inline_2320_sliceFill$$inline_2310$$ = D.$JSCompiler_alias_VOID$$
  }
  this.$_label$ = $JSCompiler_inline_result$$372_hoverColor$$inline_2314_seriesIndex$$37_sliceBounds$$inline_2320_sliceFill$$inline_2310$$;
...
D.$DvtPieChart$$ = function $$DvtPieChart$$$($chart$$108$$, $availSpace$$75$$, $callback$$43$$, $callbackObj$$7$$) {
  this.Init($chart$$108$$, $availSpace$$75$$, $callback$$43$$, $callbackObj$$7$$)
};
...
D.$DvtPieChart$$.prototype.Init = function $$DvtPieChart$$$$Init$($chart$$109$$, $availSpace$$76$$) {
  ...
  for(var $labelPosition$$1_slices$$inline_2336$$ = this.$getLabelPosition$(), $numSeries_otherSlice$$inline_2342_seriesIndices$$inline_2338$$ = D.$DvtChartDataUtils$$.$getSeriesCount$($chart$$109$$), $otherValue$$inline_2340_seriesIndex$$38$$ = 0;$otherValue$$inline_2340_seriesIndex$$38$$ < $numSeries_otherSlice$$inline_2342_seriesIndices$$inline_2338$$;$otherValue$$inline_2340_seriesIndex$$38$$++) {
    var $data$$26_i$$inline_2341$$ = D.$DvtChartDataUtils$$.$getDataItem$($chart$$109$$, $otherValue$$inline_2340_seriesIndex$$38$$, 0);
    if($data$$26_i$$inline_2341$$ && ("center" == $labelPosition$$1_slices$$inline_2336$$ || "none" == $labelPosition$$1_slices$$inline_2336$$) && "outsideSlice" == $data$$26_i$$inline_2341$$.labelPosition) {
      $labelPosition$$1_slices$$inline_2336$$ = "outsideSlice"
    }
  }
  ...
  this.$_radiusY$ = this.$_radiusX$ = window.Math.floor(window.Math.min($availSpace$$76$$.$w$, $availSpace$$76$$.$h$) * ("center" == $labelPosition$$1_slices$$inline_2336$$ || "none" == $labelPosition$$1_slices$$inline_2336$$ ? 0.45 : 0.38));
  this.$_depth$ = 0;
  ...
  for(var $labelPosition$$1_slices$$inline_2336$$ = [], $seriesIndex$$inline_2339_slice$$inline_2337$$, $numSeries_otherSlice$$inline_2342_seriesIndices$$inline_2338$$ = D.$DvtPieChartUtils$$.$getRenderedSeriesIndices$(this.$chart$), $otherValue$$inline_2340_seriesIndex$$38$$ = D.$DvtPieChartUtils$$.$getOtherValue$(this.$chart$), $data$$26_i$$inline_2341$$ = 0;$data$$26_i$$inline_2341$$ < $numSeries_otherSlice$$inline_2342_seriesIndices$$inline_2338$$.length;$data$$26_i$$inline_2341$$++) {
    $seriesIndex$$inline_2339_slice$$inline_2337$$ = $numSeries_otherSlice$$inline_2342_seriesIndices$$inline_2338$$[$data$$26_i$$inline_2341$$], D.$DvtChartStyleUtils$$.$isDataItemRendered$(this.$chart$, $seriesIndex$$inline_2339_slice$$inline_2337$$) && ($seriesIndex$$inline_2339_slice$$inline_2337$$ = new D.$DvtPieSlice$$(this, $seriesIndex$$inline_2339_slice$$inline_2337$$), 0 >= $seriesIndex$$inline_2339_slice$$inline_2337$$.getValue() || $labelPosition$$1_slices$$inline_2336$$.push($seriesIndex$$inline_2339_slice$$inline_2337$$))
  }
  0 < $otherValue$$inline_2340_seriesIndex$$38$$ && ($numSeries_otherSlice$$inline_2342_seriesIndices$$inline_2338$$ = new D.$DvtPieSlice$$(this), "ascending" == this.$chart$.$getOptions$().sorting ? $labelPosition$$1_slices$$inline_2336$$.unshift($numSeries_otherSlice$$inline_2342_seriesIndices$$inline_2338$$) : $labelPosition$$1_slices$$inline_2336$$.push($numSeries_otherSlice$$inline_2342_seriesIndices$$inline_2338$$));
  (0,D.$DvtAgent$isRightToLeft$$)(this.$getCtx$()) && $labelPosition$$1_slices$$inline_2336$$.reverse();
  this.$_slices$ = $labelPosition$$1_slices$$inline_2336$$;
...
D.$DvtPieChart$$.prototype.$render$ = function $$DvtPieChart$$$$$render$$() {
  ...
  var $i$$177_i$$inline_2372_slices$$inline_2344$$ = this.$_slices$, $anchorOffset$$inline_2345_angle$$inline_2348_grAngle$$inline_2361_lastSliceIndexToProcess$$inline_2382_rotateIdx$$inline_2375_topFill$$inline_2359$$ = this.$_anchorOffset$, $JSCompiler_StaticMethods_preRender$self$$inline_2355_i$$inline_2346_zOrderedSlices$$inline_2371$$, $color$$inline_2357_nSlices$$inline_2373_sideFill$$inline_2367_slice$$inline_2347$$, $angleStart$$inline_2376_arc$$inline_2349_percentage$$inline_2351_rotatedSlices$$inline_2380_style$$inline_2362_value$$inline_2353$$ = 
  0, $angleExtent$$inline_2377_crustFill$$inline_2368_fillType$$inline_2356_nSlices$$inline_2350_slice$$inline_2374_sliceSpanEnd$$inline_2378_useGradientFill$$inline_2365$$ = $i$$177_i$$inline_2372_slices$$inline_2344$$ ? $i$$177_i$$inline_2372_slices$$inline_2344$$.length : 0;
  360 < $anchorOffset$$inline_2345_angle$$inline_2348_grAngle$$inline_2361_lastSliceIndexToProcess$$inline_2382_rotateIdx$$inline_2375_topFill$$inline_2359$$ && ($anchorOffset$$inline_2345_angle$$inline_2348_grAngle$$inline_2361_lastSliceIndexToProcess$$inline_2382_rotateIdx$$inline_2375_topFill$$inline_2359$$ -= 360);
  0 > $anchorOffset$$inline_2345_angle$$inline_2348_grAngle$$inline_2361_lastSliceIndexToProcess$$inline_2382_rotateIdx$$inline_2375_topFill$$inline_2359$$ && ($anchorOffset$$inline_2345_angle$$inline_2348_grAngle$$inline_2361_lastSliceIndexToProcess$$inline_2382_rotateIdx$$inline_2375_topFill$$inline_2359$$ += 360);
  var $accumAngle$$inline_2381_dataTotal$$inline_2352_lateralFill$$inline_2366_pattern$$inline_2358_skin$$inline_2360_slices$$inline_2370$$ = $angleStart$$inline_2376_arc$$inline_2349_percentage$$inline_2351_rotatedSlices$$inline_2380_style$$inline_2362_value$$inline_2353$$ = 0;
  0 < $angleExtent$$inline_2377_crustFill$$inline_2368_fillType$$inline_2356_nSlices$$inline_2350_slice$$inline_2374_sliceSpanEnd$$inline_2378_useGradientFill$$inline_2365$$ && ($accumAngle$$inline_2381_dataTotal$$inline_2352_lateralFill$$inline_2366_pattern$$inline_2358_skin$$inline_2360_slices$$inline_2370$$ = $i$$177_i$$inline_2372_slices$$inline_2344$$[0].$_pieChart$.$getTotalValue$());
  for($JSCompiler_StaticMethods_preRender$self$$inline_2355_i$$inline_2346_zOrderedSlices$$inline_2371$$ = 0;$JSCompiler_StaticMethods_preRender$self$$inline_2355_i$$inline_2346_zOrderedSlices$$inline_2371$$ < $angleExtent$$inline_2377_crustFill$$inline_2368_fillType$$inline_2356_nSlices$$inline_2350_slice$$inline_2374_sliceSpanEnd$$inline_2378_useGradientFill$$inline_2365$$;$JSCompiler_StaticMethods_preRender$self$$inline_2355_i$$inline_2346_zOrderedSlices$$inline_2371$$++) {
    $color$$inline_2357_nSlices$$inline_2373_sideFill$$inline_2367_slice$$inline_2347$$ = $i$$177_i$$inline_2372_slices$$inline_2344$$[$JSCompiler_StaticMethods_preRender$self$$inline_2355_i$$inline_2346_zOrderedSlices$$inline_2371$$], $angleStart$$inline_2376_arc$$inline_2349_percentage$$inline_2351_rotatedSlices$$inline_2380_style$$inline_2362_value$$inline_2353$$ = $color$$inline_2357_nSlices$$inline_2373_sideFill$$inline_2367_slice$$inline_2347$$.getValue(), $angleStart$$inline_2376_arc$$inline_2349_percentage$$inline_2351_rotatedSlices$$inline_2380_style$$inline_2362_value$$inline_2353$$ = 
    0 == $accumAngle$$inline_2381_dataTotal$$inline_2352_lateralFill$$inline_2366_pattern$$inline_2358_skin$$inline_2360_slices$$inline_2370$$ ? 0 : 100 * (window.Math.abs($angleStart$$inline_2376_arc$$inline_2349_percentage$$inline_2351_rotatedSlices$$inline_2380_style$$inline_2362_value$$inline_2353$$) / $accumAngle$$inline_2381_dataTotal$$inline_2352_lateralFill$$inline_2366_pattern$$inline_2358_skin$$inline_2360_slices$$inline_2370$$), $angleStart$$inline_2376_arc$$inline_2349_percentage$$inline_2351_rotatedSlices$$inline_2380_style$$inline_2362_value$$inline_2353$$ *= 
    3.6, $anchorOffset$$inline_2345_angle$$inline_2348_grAngle$$inline_2361_lastSliceIndexToProcess$$inline_2382_rotateIdx$$inline_2375_topFill$$inline_2359$$ -= $angleStart$$inline_2376_arc$$inline_2349_percentage$$inline_2351_rotatedSlices$$inline_2380_style$$inline_2362_value$$inline_2353$$, 0 > $anchorOffset$$inline_2345_angle$$inline_2348_grAngle$$inline_2361_lastSliceIndexToProcess$$inline_2382_rotateIdx$$inline_2375_topFill$$inline_2359$$ && ($anchorOffset$$inline_2345_angle$$inline_2348_grAngle$$inline_2361_lastSliceIndexToProcess$$inline_2382_rotateIdx$$inline_2375_topFill$$inline_2359$$ += 
    360), $color$$inline_2357_nSlices$$inline_2373_sideFill$$inline_2367_slice$$inline_2347$$.$setAngleStart$($anchorOffset$$inline_2345_angle$$inline_2348_grAngle$$inline_2361_lastSliceIndexToProcess$$inline_2382_rotateIdx$$inline_2375_topFill$$inline_2359$$), $color$$inline_2357_nSlices$$inline_2373_sideFill$$inline_2367_slice$$inline_2347$$.$setAngleExtent$($angleStart$$inline_2376_arc$$inline_2349_percentage$$inline_2351_rotatedSlices$$inline_2380_style$$inline_2362_value$$inline_2353$$), $anchorOffset$$inline_2345_angle$$inline_2348_grAngle$$inline_2361_lastSliceIndexToProcess$$inline_2382_rotateIdx$$inline_2375_topFill$$inline_2359$$ = 
    $color$$inline_2357_nSlices$$inline_2373_sideFill$$inline_2367_slice$$inline_2347$$.$getAngleStart$()
  }
  for($i$$177_i$$inline_2372_slices$$inline_2344$$ = 0;$i$$177_i$$inline_2372_slices$$inline_2344$$ < this.$_slices$.length;$i$$177_i$$inline_2372_slices$$inline_2344$$++) {
    $JSCompiler_StaticMethods_preRender$self$$inline_2355_i$$inline_2346_zOrderedSlices$$inline_2371$$ = this.$_slices$[$i$$177_i$$inline_2372_slices$$inline_2344$$];
    $angleExtent$$inline_2377_crustFill$$inline_2368_fillType$$inline_2356_nSlices$$inline_2350_slice$$inline_2374_sliceSpanEnd$$inline_2378_useGradientFill$$inline_2365$$ = $JSCompiler_StaticMethods_preRender$self$$inline_2355_i$$inline_2346_zOrderedSlices$$inline_2371$$.$_bFillerSlice$ ? "color" : D.$DvtChartStyleUtils$$.$getSeriesEffect$($JSCompiler_StaticMethods_preRender$self$$inline_2355_i$$inline_2346_zOrderedSlices$$inline_2371$$.$_chart$);
    $color$$inline_2357_nSlices$$inline_2373_sideFill$$inline_2367_slice$$inline_2347$$ = $JSCompiler_StaticMethods_preRender$self$$inline_2355_i$$inline_2346_zOrderedSlices$$inline_2371$$.$getFillColor$();
    $accumAngle$$inline_2381_dataTotal$$inline_2352_lateralFill$$inline_2366_pattern$$inline_2358_skin$$inline_2360_slices$$inline_2370$$ = $JSCompiler_StaticMethods_preRender$self$$inline_2355_i$$inline_2346_zOrderedSlices$$inline_2371$$.$getFillPattern$();
    $anchorOffset$$inline_2345_angle$$inline_2348_grAngle$$inline_2361_lastSliceIndexToProcess$$inline_2382_rotateIdx$$inline_2375_topFill$$inline_2359$$ = D.$JSCompiler_alias_VOID$$;
    if("pattern" == $angleExtent$$inline_2377_crustFill$$inline_2368_fillType$$inline_2356_nSlices$$inline_2350_slice$$inline_2374_sliceSpanEnd$$inline_2378_useGradientFill$$inline_2365$$ || $accumAngle$$inline_2381_dataTotal$$inline_2352_lateralFill$$inline_2366_pattern$$inline_2358_skin$$inline_2360_slices$$inline_2370$$ != D.$JSCompiler_alias_NULL$$) {
      $anchorOffset$$inline_2345_angle$$inline_2348_grAngle$$inline_2361_lastSliceIndexToProcess$$inline_2382_rotateIdx$$inline_2375_topFill$$inline_2359$$ = new D.$DvtPatternFill$$($accumAngle$$inline_2381_dataTotal$$inline_2352_lateralFill$$inline_2366_pattern$$inline_2358_skin$$inline_2360_slices$$inline_2370$$, $color$$inline_2357_nSlices$$inline_2373_sideFill$$inline_2367_slice$$inline_2347$$), $angleExtent$$inline_2377_crustFill$$inline_2368_fillType$$inline_2356_nSlices$$inline_2350_slice$$inline_2374_sliceSpanEnd$$inline_2378_useGradientFill$$inline_2365$$ = 
      "pattern"
    }else {
      if("gradient" == $angleExtent$$inline_2377_crustFill$$inline_2368_fillType$$inline_2356_nSlices$$inline_2350_slice$$inline_2374_sliceSpanEnd$$inline_2378_useGradientFill$$inline_2365$$) {
        var $accumAngle$$inline_2381_dataTotal$$inline_2352_lateralFill$$inline_2366_pattern$$inline_2358_skin$$inline_2360_slices$$inline_2370$$ = $JSCompiler_StaticMethods_preRender$self$$inline_2355_i$$inline_2346_zOrderedSlices$$inline_2371$$.$_pieChart$.$getSkin$(), $anchorOffset$$inline_2345_angle$$inline_2348_grAngle$$inline_2361_lastSliceIndexToProcess$$inline_2382_rotateIdx$$inline_2375_topFill$$inline_2359$$ = "skyros" == $accumAngle$$inline_2381_dataTotal$$inline_2352_lateralFill$$inline_2366_pattern$$inline_2358_skin$$inline_2360_slices$$inline_2370$$ ? 
        297 : 270, $angleStart$$inline_2376_arc$$inline_2349_percentage$$inline_2351_rotatedSlices$$inline_2380_style$$inline_2362_value$$inline_2353$$ = !(0,D.$JSCompiler_StaticMethods_is3D$$)($JSCompiler_StaticMethods_preRender$self$$inline_2355_i$$inline_2346_zOrderedSlices$$inline_2371$$.$_pieChart$) ? "2D" : "3D", $arColors$$inline_2363$$ = D.$DvtPieRenderUtils$$.$getGradientColors$(D.$DvtColorUtils$$.$getRGB$($color$$inline_2357_nSlices$$inline_2373_sideFill$$inline_2367_slice$$inline_2347$$), 
        $angleStart$$inline_2376_arc$$inline_2349_percentage$$inline_2351_rotatedSlices$$inline_2380_style$$inline_2362_value$$inline_2353$$, $accumAngle$$inline_2381_dataTotal$$inline_2352_lateralFill$$inline_2366_pattern$$inline_2358_skin$$inline_2360_slices$$inline_2370$$), $arAlphas$$inline_2364$$ = D.$DvtPieRenderUtils$$.$getGradientAlphas$(D.$DvtColorUtils$$.$getAlpha$($color$$inline_2357_nSlices$$inline_2373_sideFill$$inline_2367_slice$$inline_2347$$), $angleStart$$inline_2376_arc$$inline_2349_percentage$$inline_2351_rotatedSlices$$inline_2380_style$$inline_2362_value$$inline_2353$$), 
        $anchorOffset$$inline_2345_angle$$inline_2348_grAngle$$inline_2361_lastSliceIndexToProcess$$inline_2382_rotateIdx$$inline_2375_topFill$$inline_2359$$ = new D.$DvtLinearGradientFill$$($anchorOffset$$inline_2345_angle$$inline_2348_grAngle$$inline_2361_lastSliceIndexToProcess$$inline_2382_rotateIdx$$inline_2375_topFill$$inline_2359$$, $arColors$$inline_2363$$, $arAlphas$$inline_2364$$, D.$DvtPieRenderUtils$$.$getGradientRatios$($angleStart$$inline_2376_arc$$inline_2349_percentage$$inline_2351_rotatedSlices$$inline_2380_style$$inline_2362_value$$inline_2353$$, 
        $accumAngle$$inline_2381_dataTotal$$inline_2352_lateralFill$$inline_2366_pattern$$inline_2358_skin$$inline_2360_slices$$inline_2370$$), [window.Math.floor($JSCompiler_StaticMethods_preRender$self$$inline_2355_i$$inline_2346_zOrderedSlices$$inline_2371$$.$_centerX$ - $JSCompiler_StaticMethods_preRender$self$$inline_2355_i$$inline_2346_zOrderedSlices$$inline_2371$$.$_radiusX$), window.Math.floor($JSCompiler_StaticMethods_preRender$self$$inline_2355_i$$inline_2346_zOrderedSlices$$inline_2371$$.$_centerY$ - 
        $JSCompiler_StaticMethods_preRender$self$$inline_2355_i$$inline_2346_zOrderedSlices$$inline_2371$$.$_radiusY$), window.Math.ceil(2 * $JSCompiler_StaticMethods_preRender$self$$inline_2355_i$$inline_2346_zOrderedSlices$$inline_2371$$.$_radiusX$), window.Math.ceil(2 * $JSCompiler_StaticMethods_preRender$self$$inline_2355_i$$inline_2346_zOrderedSlices$$inline_2371$$.$_radiusY$)])
      }else {
        $anchorOffset$$inline_2345_angle$$inline_2348_grAngle$$inline_2361_lastSliceIndexToProcess$$inline_2382_rotateIdx$$inline_2375_topFill$$inline_2359$$ = new D.$DvtSolidFill$$($color$$inline_2357_nSlices$$inline_2373_sideFill$$inline_2367_slice$$inline_2347$$)
      }
    }
    $JSCompiler_StaticMethods_preRender$self$$inline_2355_i$$inline_2346_zOrderedSlices$$inline_2371$$.$_topSurface$ = D.$DvtPieRenderUtils$$.$createTopSurface$($JSCompiler_StaticMethods_preRender$self$$inline_2355_i$$inline_2346_zOrderedSlices$$inline_2371$$, $anchorOffset$$inline_2345_angle$$inline_2348_grAngle$$inline_2361_lastSliceIndexToProcess$$inline_2382_rotateIdx$$inline_2375_topFill$$inline_2359$$);
    if(0 < $JSCompiler_StaticMethods_preRender$self$$inline_2355_i$$inline_2346_zOrderedSlices$$inline_2371$$.$_depth$ || $JSCompiler_StaticMethods_preRender$self$$inline_2355_i$$inline_2346_zOrderedSlices$$inline_2371$$.$_radiusX$ != $JSCompiler_StaticMethods_preRender$self$$inline_2355_i$$inline_2346_zOrderedSlices$$inline_2371$$.$_radiusY$) {
      $angleExtent$$inline_2377_crustFill$$inline_2368_fillType$$inline_2356_nSlices$$inline_2350_slice$$inline_2374_sliceSpanEnd$$inline_2378_useGradientFill$$inline_2365$$ = "gradient" == $angleExtent$$inline_2377_crustFill$$inline_2368_fillType$$inline_2356_nSlices$$inline_2350_slice$$inline_2374_sliceSpanEnd$$inline_2378_useGradientFill$$inline_2365$$, $accumAngle$$inline_2381_dataTotal$$inline_2352_lateralFill$$inline_2366_pattern$$inline_2358_skin$$inline_2360_slices$$inline_2370$$ = new D.$DvtSolidFill$$(D.$DvtColorUtils$$.$getDarker$($color$$inline_2357_nSlices$$inline_2373_sideFill$$inline_2367_slice$$inline_2347$$, 
      0.6)), $color$$inline_2357_nSlices$$inline_2373_sideFill$$inline_2367_slice$$inline_2347$$ = $angleExtent$$inline_2377_crustFill$$inline_2368_fillType$$inline_2356_nSlices$$inline_2350_slice$$inline_2374_sliceSpanEnd$$inline_2378_useGradientFill$$inline_2365$$ ? D.$DvtPieRenderUtils$$.$generateLateralGradientFill$($JSCompiler_StaticMethods_preRender$self$$inline_2355_i$$inline_2346_zOrderedSlices$$inline_2371$$, D.$DvtPieRenderUtils$$.$SIDE$) : $accumAngle$$inline_2381_dataTotal$$inline_2352_lateralFill$$inline_2366_pattern$$inline_2358_skin$$inline_2360_slices$$inline_2370$$, 
      $angleExtent$$inline_2377_crustFill$$inline_2368_fillType$$inline_2356_nSlices$$inline_2350_slice$$inline_2374_sliceSpanEnd$$inline_2378_useGradientFill$$inline_2365$$ = $angleExtent$$inline_2377_crustFill$$inline_2368_fillType$$inline_2356_nSlices$$inline_2350_slice$$inline_2374_sliceSpanEnd$$inline_2378_useGradientFill$$inline_2365$$ ? D.$DvtPieRenderUtils$$.$generateLateralGradientFill$($JSCompiler_StaticMethods_preRender$self$$inline_2355_i$$inline_2346_zOrderedSlices$$inline_2371$$, D.$DvtPieRenderUtils$$.$CRUST$) : 
      $accumAngle$$inline_2381_dataTotal$$inline_2352_lateralFill$$inline_2366_pattern$$inline_2358_skin$$inline_2360_slices$$inline_2370$$, $JSCompiler_StaticMethods_preRender$self$$inline_2355_i$$inline_2346_zOrderedSlices$$inline_2371$$.$_leftSurface$ = D.$DvtPieRenderUtils$$.$createLateralSurface$($JSCompiler_StaticMethods_preRender$self$$inline_2355_i$$inline_2346_zOrderedSlices$$inline_2371$$, D.$DvtPieRenderUtils$$.$SURFACE_LEFT$, $color$$inline_2357_nSlices$$inline_2373_sideFill$$inline_2367_slice$$inline_2347$$), 
      $JSCompiler_StaticMethods_preRender$self$$inline_2355_i$$inline_2346_zOrderedSlices$$inline_2371$$.$_rightSurface$ = D.$DvtPieRenderUtils$$.$createLateralSurface$($JSCompiler_StaticMethods_preRender$self$$inline_2355_i$$inline_2346_zOrderedSlices$$inline_2371$$, D.$DvtPieRenderUtils$$.$SURFACE_RIGHT$, $color$$inline_2357_nSlices$$inline_2373_sideFill$$inline_2367_slice$$inline_2347$$), $JSCompiler_StaticMethods_preRender$self$$inline_2355_i$$inline_2346_zOrderedSlices$$inline_2371$$.$_crustSurface$ = 
      D.$DvtPieRenderUtils$$.$createLateralSurface$($JSCompiler_StaticMethods_preRender$self$$inline_2355_i$$inline_2346_zOrderedSlices$$inline_2371$$, D.$DvtPieRenderUtils$$.$SURFACE_CRUST$, $angleExtent$$inline_2377_crustFill$$inline_2368_fillType$$inline_2356_nSlices$$inline_2350_slice$$inline_2374_sliceSpanEnd$$inline_2378_useGradientFill$$inline_2365$$)
    }
  }
  $accumAngle$$inline_2381_dataTotal$$inline_2352_lateralFill$$inline_2366_pattern$$inline_2358_skin$$inline_2360_slices$$inline_2370$$ = this.$_slices$;
  $JSCompiler_StaticMethods_preRender$self$$inline_2355_i$$inline_2346_zOrderedSlices$$inline_2371$$ = [];
  $color$$inline_2357_nSlices$$inline_2373_sideFill$$inline_2367_slice$$inline_2347$$ = $accumAngle$$inline_2381_dataTotal$$inline_2352_lateralFill$$inline_2366_pattern$$inline_2358_skin$$inline_2360_slices$$inline_2370$$ ? $accumAngle$$inline_2381_dataTotal$$inline_2352_lateralFill$$inline_2366_pattern$$inline_2358_skin$$inline_2360_slices$$inline_2370$$.length : 0;
  for(var $anchorOffset$$inline_2345_angle$$inline_2348_grAngle$$inline_2361_lastSliceIndexToProcess$$inline_2382_rotateIdx$$inline_2375_topFill$$inline_2359$$ = -1, $accumAngleThreshold$$inline_2383_sliceSpanBeforeNoon$$inline_2379$$, $i$$177_i$$inline_2372_slices$$inline_2344$$ = 0;$i$$177_i$$inline_2372_slices$$inline_2344$$ < $color$$inline_2357_nSlices$$inline_2373_sideFill$$inline_2367_slice$$inline_2347$$;$i$$177_i$$inline_2372_slices$$inline_2344$$++) {
    if($angleExtent$$inline_2377_crustFill$$inline_2368_fillType$$inline_2356_nSlices$$inline_2350_slice$$inline_2374_sliceSpanEnd$$inline_2378_useGradientFill$$inline_2365$$ = $accumAngle$$inline_2381_dataTotal$$inline_2352_lateralFill$$inline_2366_pattern$$inline_2358_skin$$inline_2360_slices$$inline_2370$$[$i$$177_i$$inline_2372_slices$$inline_2344$$], $angleStart$$inline_2376_arc$$inline_2349_percentage$$inline_2351_rotatedSlices$$inline_2380_style$$inline_2362_value$$inline_2353$$ = $angleExtent$$inline_2377_crustFill$$inline_2368_fillType$$inline_2356_nSlices$$inline_2350_slice$$inline_2374_sliceSpanEnd$$inline_2378_useGradientFill$$inline_2365$$.$getAngleStart$(), 
    $angleExtent$$inline_2377_crustFill$$inline_2368_fillType$$inline_2356_nSlices$$inline_2350_slice$$inline_2374_sliceSpanEnd$$inline_2378_useGradientFill$$inline_2365$$ = $angleExtent$$inline_2377_crustFill$$inline_2368_fillType$$inline_2356_nSlices$$inline_2350_slice$$inline_2374_sliceSpanEnd$$inline_2378_useGradientFill$$inline_2365$$.$getAngleExtent$(), $angleExtent$$inline_2377_crustFill$$inline_2368_fillType$$inline_2356_nSlices$$inline_2350_slice$$inline_2374_sliceSpanEnd$$inline_2378_useGradientFill$$inline_2365$$ = 
    $angleStart$$inline_2376_arc$$inline_2349_percentage$$inline_2351_rotatedSlices$$inline_2380_style$$inline_2362_value$$inline_2353$$ + $angleExtent$$inline_2377_crustFill$$inline_2368_fillType$$inline_2356_nSlices$$inline_2350_slice$$inline_2374_sliceSpanEnd$$inline_2378_useGradientFill$$inline_2365$$, 360 < $angleExtent$$inline_2377_crustFill$$inline_2368_fillType$$inline_2356_nSlices$$inline_2350_slice$$inline_2374_sliceSpanEnd$$inline_2378_useGradientFill$$inline_2365$$ && ($angleExtent$$inline_2377_crustFill$$inline_2368_fillType$$inline_2356_nSlices$$inline_2350_slice$$inline_2374_sliceSpanEnd$$inline_2378_useGradientFill$$inline_2365$$ -= 
    360), 0 > $angleExtent$$inline_2377_crustFill$$inline_2368_fillType$$inline_2356_nSlices$$inline_2350_slice$$inline_2374_sliceSpanEnd$$inline_2378_useGradientFill$$inline_2365$$ && ($angleExtent$$inline_2377_crustFill$$inline_2368_fillType$$inline_2356_nSlices$$inline_2350_slice$$inline_2374_sliceSpanEnd$$inline_2378_useGradientFill$$inline_2365$$ += 360), 90 == $angleExtent$$inline_2377_crustFill$$inline_2368_fillType$$inline_2356_nSlices$$inline_2350_slice$$inline_2374_sliceSpanEnd$$inline_2378_useGradientFill$$inline_2365$$ || 
    90 > $angleStart$$inline_2376_arc$$inline_2349_percentage$$inline_2351_rotatedSlices$$inline_2380_style$$inline_2362_value$$inline_2353$$ && 90 < $angleExtent$$inline_2377_crustFill$$inline_2368_fillType$$inline_2356_nSlices$$inline_2350_slice$$inline_2374_sliceSpanEnd$$inline_2378_useGradientFill$$inline_2365$$) {
      $anchorOffset$$inline_2345_angle$$inline_2348_grAngle$$inline_2361_lastSliceIndexToProcess$$inline_2382_rotateIdx$$inline_2375_topFill$$inline_2359$$ = $i$$177_i$$inline_2372_slices$$inline_2344$$;
      $accumAngleThreshold$$inline_2383_sliceSpanBeforeNoon$$inline_2379$$ = $angleExtent$$inline_2377_crustFill$$inline_2368_fillType$$inline_2356_nSlices$$inline_2350_slice$$inline_2374_sliceSpanEnd$$inline_2378_useGradientFill$$inline_2365$$ - 90;
      break
    }
  }
  $angleStart$$inline_2376_arc$$inline_2349_percentage$$inline_2351_rotatedSlices$$inline_2380_style$$inline_2362_value$$inline_2353$$ = [];
  for($i$$177_i$$inline_2372_slices$$inline_2344$$ = $anchorOffset$$inline_2345_angle$$inline_2348_grAngle$$inline_2361_lastSliceIndexToProcess$$inline_2382_rotateIdx$$inline_2375_topFill$$inline_2359$$;$i$$177_i$$inline_2372_slices$$inline_2344$$ < $color$$inline_2357_nSlices$$inline_2373_sideFill$$inline_2367_slice$$inline_2347$$;$i$$177_i$$inline_2372_slices$$inline_2344$$++) {
    $angleStart$$inline_2376_arc$$inline_2349_percentage$$inline_2351_rotatedSlices$$inline_2380_style$$inline_2362_value$$inline_2353$$.push($accumAngle$$inline_2381_dataTotal$$inline_2352_lateralFill$$inline_2366_pattern$$inline_2358_skin$$inline_2360_slices$$inline_2370$$[$i$$177_i$$inline_2372_slices$$inline_2344$$])
  }
  for($i$$177_i$$inline_2372_slices$$inline_2344$$ = 0;$i$$177_i$$inline_2372_slices$$inline_2344$$ < $anchorOffset$$inline_2345_angle$$inline_2348_grAngle$$inline_2361_lastSliceIndexToProcess$$inline_2382_rotateIdx$$inline_2375_topFill$$inline_2359$$;$i$$177_i$$inline_2372_slices$$inline_2344$$++) {
    $angleStart$$inline_2376_arc$$inline_2349_percentage$$inline_2351_rotatedSlices$$inline_2380_style$$inline_2362_value$$inline_2353$$.push($accumAngle$$inline_2381_dataTotal$$inline_2352_lateralFill$$inline_2366_pattern$$inline_2358_skin$$inline_2360_slices$$inline_2370$$[$i$$177_i$$inline_2372_slices$$inline_2344$$])
  }
  $anchorOffset$$inline_2345_angle$$inline_2348_grAngle$$inline_2361_lastSliceIndexToProcess$$inline_2382_rotateIdx$$inline_2375_topFill$$inline_2359$$ = $accumAngle$$inline_2381_dataTotal$$inline_2352_lateralFill$$inline_2366_pattern$$inline_2358_skin$$inline_2360_slices$$inline_2370$$ = 0;
  $accumAngleThreshold$$inline_2383_sliceSpanBeforeNoon$$inline_2379$$ = 180 + $accumAngleThreshold$$inline_2383_sliceSpanBeforeNoon$$inline_2379$$;
  for($i$$177_i$$inline_2372_slices$$inline_2344$$ = 0;$i$$177_i$$inline_2372_slices$$inline_2344$$ < $color$$inline_2357_nSlices$$inline_2373_sideFill$$inline_2367_slice$$inline_2347$$;$i$$177_i$$inline_2372_slices$$inline_2344$$++) {
    if($angleExtent$$inline_2377_crustFill$$inline_2368_fillType$$inline_2356_nSlices$$inline_2350_slice$$inline_2374_sliceSpanEnd$$inline_2378_useGradientFill$$inline_2365$$ = $angleStart$$inline_2376_arc$$inline_2349_percentage$$inline_2351_rotatedSlices$$inline_2380_style$$inline_2362_value$$inline_2353$$[$i$$177_i$$inline_2372_slices$$inline_2344$$]) {
      if($accumAngle$$inline_2381_dataTotal$$inline_2352_lateralFill$$inline_2366_pattern$$inline_2358_skin$$inline_2360_slices$$inline_2370$$ + $angleExtent$$inline_2377_crustFill$$inline_2368_fillType$$inline_2356_nSlices$$inline_2350_slice$$inline_2374_sliceSpanEnd$$inline_2378_useGradientFill$$inline_2365$$.$getAngleExtent$() > $accumAngleThreshold$$inline_2383_sliceSpanBeforeNoon$$inline_2379$$) {
        $anchorOffset$$inline_2345_angle$$inline_2348_grAngle$$inline_2361_lastSliceIndexToProcess$$inline_2382_rotateIdx$$inline_2375_topFill$$inline_2359$$ = $i$$177_i$$inline_2372_slices$$inline_2344$$;
        break
      }
      $JSCompiler_StaticMethods_preRender$self$$inline_2355_i$$inline_2346_zOrderedSlices$$inline_2371$$.push($angleExtent$$inline_2377_crustFill$$inline_2368_fillType$$inline_2356_nSlices$$inline_2350_slice$$inline_2374_sliceSpanEnd$$inline_2378_useGradientFill$$inline_2365$$);
      $accumAngle$$inline_2381_dataTotal$$inline_2352_lateralFill$$inline_2366_pattern$$inline_2358_skin$$inline_2360_slices$$inline_2370$$ += $angleExtent$$inline_2377_crustFill$$inline_2368_fillType$$inline_2356_nSlices$$inline_2350_slice$$inline_2374_sliceSpanEnd$$inline_2378_useGradientFill$$inline_2365$$.$getAngleExtent$()
    }
  }
  for($i$$177_i$$inline_2372_slices$$inline_2344$$ = $color$$inline_2357_nSlices$$inline_2373_sideFill$$inline_2367_slice$$inline_2347$$ - 1;$i$$177_i$$inline_2372_slices$$inline_2344$$ >= $anchorOffset$$inline_2345_angle$$inline_2348_grAngle$$inline_2361_lastSliceIndexToProcess$$inline_2382_rotateIdx$$inline_2375_topFill$$inline_2359$$;$i$$177_i$$inline_2372_slices$$inline_2344$$--) {
    ($angleExtent$$inline_2377_crustFill$$inline_2368_fillType$$inline_2356_nSlices$$inline_2350_slice$$inline_2374_sliceSpanEnd$$inline_2378_useGradientFill$$inline_2365$$ = $angleStart$$inline_2376_arc$$inline_2349_percentage$$inline_2351_rotatedSlices$$inline_2380_style$$inline_2362_value$$inline_2353$$[$i$$177_i$$inline_2372_slices$$inline_2344$$]) && $JSCompiler_StaticMethods_preRender$self$$inline_2355_i$$inline_2346_zOrderedSlices$$inline_2371$$.push($angleExtent$$inline_2377_crustFill$$inline_2368_fillType$$inline_2356_nSlices$$inline_2350_slice$$inline_2374_sliceSpanEnd$$inline_2378_useGradientFill$$inline_2365$$)
  }
  D.$DvtPieLabelUtils$$.$createPieCenterLabel$(this);
  this.$_duringDisplayAnim$ || D.$DvtPieLabelUtils$$.$layoutLabelsAndFeelers$(this);
  for($i$$177_i$$inline_2372_slices$$inline_2344$$ = 0;$i$$177_i$$inline_2372_slices$$inline_2344$$ < $JSCompiler_StaticMethods_preRender$self$$inline_2355_i$$inline_2346_zOrderedSlices$$inline_2371$$.length;$i$$177_i$$inline_2372_slices$$inline_2344$$++) {
    $JSCompiler_StaticMethods_preRender$self$$inline_2355_i$$inline_2346_zOrderedSlices$$inline_2371$$[$i$$177_i$$inline_2372_slices$$inline_2344$$].$render$(this.$_duringDisplayAnim$)
  }
...
D.$JSCompiler_prototypeAlias$$.$getDisplayAnimation$ = function $$JSCompiler_prototypeAlias$$$$getDisplayAnimation$$() {
  ...
  for(var $anim_handler$$29$$ = new D.$DvtDataAnimationHandler$$(this.$getCtx$(), this), $ar$$4_labelAnim_renderAnim_slice$$inline_2387$$ = [], $fillerAnim_i$$181_value$$inline_2386$$ = 0;$fillerAnim_i$$181_value$$inline_2386$$ < this.$_slices$.length;$fillerAnim_i$$181_value$$inline_2386$$++) {
    $ar$$4_labelAnim_renderAnim_slice$$inline_2387$$ = $ar$$4_labelAnim_renderAnim_slice$$inline_2387$$.concat((0,D.$JSCompiler_StaticMethods_getLabelAndFeeler$$)(this.$_slices$[$fillerAnim_i$$181_value$$inline_2386$$]))
  }
  $ar$$4_labelAnim_renderAnim_slice$$inline_2387$$ = new D.$DvtAnimFadeIn$$(this.$_context$, $ar$$4_labelAnim_renderAnim_slice$$inline_2387$$, this.$getAnimationDuration$());
  $anim_handler$$29$$.add($ar$$4_labelAnim_renderAnim_slice$$inline_2387$$, 0);
  $fillerAnim_i$$181_value$$inline_2386$$ = this.$getTotalValue$();
  $ar$$4_labelAnim_renderAnim_slice$$inline_2387$$ = new D.$DvtPieSlice$$(this);
  $ar$$4_labelAnim_renderAnim_slice$$inline_2387$$.$_value$ = $fillerAnim_i$$181_value$$inline_2386$$;
  $ar$$4_labelAnim_renderAnim_slice$$inline_2387$$.$_bFillerSlice$ = D.$JSCompiler_alias_TRUE$$;
  $ar$$4_labelAnim_renderAnim_slice$$inline_2387$$.$_centerX$ = this.$getCenter$().x;
  $ar$$4_labelAnim_renderAnim_slice$$inline_2387$$.$_centerY$ = this.$getCenter$().y;
  $ar$$4_labelAnim_renderAnim_slice$$inline_2387$$.$_fillColor$ = "rgba(255,255,255,0)";
  $ar$$4_labelAnim_renderAnim_slice$$inline_2387$$.$_strokeColor$ = "rgba(255,255,255,0)";
  $ar$$4_labelAnim_renderAnim_slice$$inline_2387$$.$_id$ = new D.$DvtChartDataItem$$(D.$JSCompiler_alias_NULL$$, D.$JSCompiler_alias_NULL$$, D.$JSCompiler_alias_NULL$$);
  this.$_slices$.push($ar$$4_labelAnim_renderAnim_slice$$inline_2387$$);
  $fillerAnim_i$$181_value$$inline_2386$$ = new D.$DvtCustomAnimation$$(this.$getCtx$(), $ar$$4_labelAnim_renderAnim_slice$$inline_2387$$, this.$getAnimationDuration$());
  (0,D.$JSCompiler_StaticMethods_addProp$$)($fillerAnim_i$$181_value$$inline_2386$$.$_animator$, "typeNumberArray", $ar$$4_labelAnim_renderAnim_slice$$inline_2387$$, $ar$$4_labelAnim_renderAnim_slice$$inline_2387$$.$GetAnimationParams$, $ar$$4_labelAnim_renderAnim_slice$$inline_2387$$.$SetAnimationParams$, (0,D.$JSCompiler_StaticMethods_getDeletedAnimationParams$$)($ar$$4_labelAnim_renderAnim_slice$$inline_2387$$));
  $fillerAnim_i$$181_value$$inline_2386$$.$setOnEnd$($ar$$4_labelAnim_renderAnim_slice$$inline_2387$$.$_removeDeletedSlice$, $ar$$4_labelAnim_renderAnim_slice$$inline_2387$$);
  $anim_handler$$29$$.add($fillerAnim_i$$181_value$$inline_2386$$, 0);
  for($fillerAnim_i$$181_value$$inline_2386$$ = 0;$fillerAnim_i$$181_value$$inline_2386$$ < this.$_slices$.length - 1;$fillerAnim_i$$181_value$$inline_2386$$++) {
    this.$_slices$[$fillerAnim_i$$181_value$$inline_2386$$].$animateInsert$($anim_handler$$29$$)
  }
  $ar$$4_labelAnim_renderAnim_slice$$inline_2387$$ = new D.$DvtCustomAnimation$$(this.$getCtx$(), this, this.$getAnimationDuration$());
  (0,D.$JSCompiler_StaticMethods_addProp$$)($ar$$4_labelAnim_renderAnim_slice$$inline_2387$$.$_animator$, "typeNumberArray", this, this.$_getAnimationParams$, this.$_setAnimationParams$, this.$_getAnimationParams$());
  $anim_handler$$29$$.add($ar$$4_labelAnim_renderAnim_slice$$inline_2387$$, 0);
  this.$_setAnimationParams$();
  $anim_handler$$29$$ = $anim_handler$$29$$.$getAnimation$(D.$JSCompiler_alias_TRUE$$);
  $anim_handler$$29$$.$setOnEnd$(this.$_restoreLabelPosition$, this);
...
D.$DvtPieSlice$$.prototype.Init = function $$DvtPieSlice$$$$Init$($pieChart$$2$$, $seriesIndex$$42$$) {
  ...
  var $dataItem$$11_options$$59$$ = this.$_chart$.$getOptions$();
  $seriesIndex$$42$$ != D.$JSCompiler_alias_NULL$$ ? ($dataItem$$11_options$$59$$ = D.$DvtChartDataUtils$$.$getDataItem$(this.$_chart$, $seriesIndex$$42$$, 0), this.$_value$ = D.$DvtChartDataUtils$$.getValue(this.$_chart$, $seriesIndex$$42$$, 0), this.$_explode$ = D.$DvtPieChartUtils$$.$getSliceExplode$(this.$_chart$, $seriesIndex$$42$$), this.$_fillColor$ = D.$DvtChartStyleUtils$$.$getColor$(this.$_chart$, $seriesIndex$$42$$), this.$_fillPattern$ = D.$DvtChartStyleUtils$$.$getPattern$(this.$_chart$, 
  $seriesIndex$$42$$, 0), this.$_strokeColor$ = D.$DvtChartStyleUtils$$.$getBorderColor$(this.$_chart$, $seriesIndex$$42$$), this.$_borderWidth$ = D.$DvtChartStyleUtils$$.$getBorderWidth$(this.$_chart$, $seriesIndex$$42$$), this.$_customLabel$ = $dataItem$$11_options$$59$$.label, this.$_seriesLabel$ = D.$DvtChartDataUtils$$.$getSeries$(this.$_chart$, $seriesIndex$$42$$), this.$_action$ = $dataItem$$11_options$$59$$.action, this.$_drillable$ = D.$DvtChartEventUtils$$.$isDataItemDrillable$(this.$_chart$, 
  $seriesIndex$$42$$, 0), this.$_showPopupBehaviors$ = this.$_chart$.$getShowPopupBehaviors$($dataItem$$11_options$$59$$._id), this.$_id$ = D.$DvtPieChartUtils$$.$getSliceId$(this.$_chart$, $seriesIndex$$42$$), this.$_seriesIndex$ = $seriesIndex$$42$$, this.$_categories$ = $dataItem$$11_options$$59$$.categories ? $dataItem$$11_options$$59$$.categories : D.$DvtChartDataUtils$$.$getSeriesItem$(this.$_chart$, $seriesIndex$$42$$).categories) : (this.$_value$ = D.$DvtPieChartUtils$$.$getOtherValue$(this.$_chart$), 
  this.$_explode$ = 0, this.$_fillColor$ = $dataItem$$11_options$$59$$.styleDefaults.otherColor, this.$_fillPattern$ = D.$JSCompiler_alias_NULL$$, this.$_strokeColor$ = $dataItem$$11_options$$59$$.styleDefaults.borderColor, this.$_borderWidth$ = $dataItem$$11_options$$59$$.styleDefaults.borderWidth, this.$_customLabel$ = D.$JSCompiler_alias_NULL$$, this.$_seriesLabel$ = (0,D.$DvtBundle$getTranslatedString$$)("DvtChartBundle", "LABEL_OTHER", D.$JSCompiler_alias_NULL$$), this.$_action$ = D.$JSCompiler_alias_NULL$$, 
...
D.$DvtPieSlice$$.prototype.$render$ = function $$DvtPieSlice$$$$$render$$($displayable$$9_duringDisplayAnim_feelerRad$$inline_2398_sliceDisplayables$$) {
  var $i$$183_topSurface$$inline_2389$$ = this.$_topSurface$, $leftSurface$$inline_2390_len$$3$$ = this.$_leftSurface$, $rightSurface$$inline_2391_shapeArray$$ = this.$_rightSurface$, $crustSurface$$inline_2392_shapeCount$$ = this.$_crustSurface$, $angleStart$$inline_2393_j$$32$$ = this.$_angleStart$, $angleExtent$$inline_2394$$ = this.$_angleExtent$, $feelerHoriz$$inline_2399_sortedSurfaces$$inline_2395$$ = [];
  $leftSurface$$inline_2390_len$$3$$ && ($rightSurface$$inline_2391_shapeArray$$ && $crustSurface$$inline_2392_shapeCount$$) && (270 >= $angleStart$$inline_2393_j$$32$$ && 270 < $angleStart$$inline_2393_j$$32$$ + $angleExtent$$inline_2394$$ ? ($feelerHoriz$$inline_2399_sortedSurfaces$$inline_2395$$.push($leftSurface$$inline_2390_len$$3$$), $feelerHoriz$$inline_2399_sortedSurfaces$$inline_2395$$.push($rightSurface$$inline_2391_shapeArray$$), $feelerHoriz$$inline_2399_sortedSurfaces$$inline_2395$$.push($crustSurface$$inline_2392_shapeCount$$)) : 
  270 < $angleStart$$inline_2393_j$$32$$ || 90 >= $angleStart$$inline_2393_j$$32$$ + $angleExtent$$inline_2394$$ ? ($feelerHoriz$$inline_2399_sortedSurfaces$$inline_2395$$.push($leftSurface$$inline_2390_len$$3$$), $feelerHoriz$$inline_2399_sortedSurfaces$$inline_2395$$.push($crustSurface$$inline_2392_shapeCount$$), $feelerHoriz$$inline_2399_sortedSurfaces$$inline_2395$$.push($rightSurface$$inline_2391_shapeArray$$)) : ($feelerHoriz$$inline_2399_sortedSurfaces$$inline_2395$$.push($rightSurface$$inline_2391_shapeArray$$), 
  $feelerHoriz$$inline_2399_sortedSurfaces$$inline_2395$$.push($crustSurface$$inline_2392_shapeCount$$), $feelerHoriz$$inline_2399_sortedSurfaces$$inline_2395$$.push($leftSurface$$inline_2390_len$$3$$)));
  $feelerHoriz$$inline_2399_sortedSurfaces$$inline_2395$$.push($i$$183_topSurface$$inline_2389$$);
  $leftSurface$$inline_2390_len$$3$$ = $feelerHoriz$$inline_2399_sortedSurfaces$$inline_2395$$.length;
  for($i$$183_topSurface$$inline_2389$$ = 0;$i$$183_topSurface$$inline_2389$$ < $leftSurface$$inline_2390_len$$3$$;$i$$183_topSurface$$inline_2389$$++) {
    $rightSurface$$inline_2391_shapeArray$$ = $feelerHoriz$$inline_2399_sortedSurfaces$$inline_2395$$[$i$$183_topSurface$$inline_2389$$];
    $crustSurface$$inline_2392_shapeCount$$ = $rightSurface$$inline_2391_shapeArray$$.length;
    for($angleStart$$inline_2393_j$$32$$ = 0;$angleStart$$inline_2393_j$$32$$ < $crustSurface$$inline_2392_shapeCount$$;$angleStart$$inline_2393_j$$32$$++) {
      this.$_pieChart$.$_shapesContainer$.$addChild$($rightSurface$$inline_2391_shapeArray$$[$angleStart$$inline_2393_j$$32$$]), $rightSurface$$inline_2391_shapeArray$$[$angleStart$$inline_2393_j$$32$$].$render$ && $rightSurface$$inline_2391_shapeArray$$[$angleStart$$inline_2393_j$$32$$].$render$()
    }
  }
  this.$_sliceLabel$ && (this.$_pieChart$.$addChild$(this.$_sliceLabel$), D.$DvtPieRenderUtils$$.$associate$(this, [this.$_sliceLabel$]), $displayable$$9_duringDisplayAnim_feelerRad$$inline_2398_sliceDisplayables$$ ? (this.$_pieChart$.$addChild$(this.$_feelerRad$), this.$_pieChart$.$addChild$(this.$_feelerHoriz$)) : this.$_hasFeeler$ && ($displayable$$9_duringDisplayAnim_feelerRad$$inline_2398_sliceDisplayables$$ = (0,D.$JSCompiler_StaticMethods__feelerFromPts$$)(this, this.$_outsideFeelerStart$, 
  this.$_outsideFeelerMid$), $feelerHoriz$$inline_2399_sortedSurfaces$$inline_2395$$ = (0,D.$JSCompiler_StaticMethods__feelerFromPts$$)(this, this.$_outsideFeelerMid$, this.$_outsideFeelerEnd$), this.$_feelerRad$ = $displayable$$9_duringDisplayAnim_feelerRad$$inline_2398_sliceDisplayables$$, this.$_feelerHoriz$ = $feelerHoriz$$inline_2399_sortedSurfaces$$inline_2395$$));
  (0,D.$JSCompiler_StaticMethods__explodeSlice$$)(this);
  if(this.$_action$ || this.$_drillable$) {
    $displayable$$9_duringDisplayAnim_feelerRad$$inline_2398_sliceDisplayables$$ = this.$getDisplayables$();
    for($i$$183_topSurface$$inline_2389$$ = 0;$i$$183_topSurface$$inline_2389$$ < $displayable$$9_duringDisplayAnim_feelerRad$$inline_2398_sliceDisplayables$$.length;$i$$183_topSurface$$inline_2389$$++) {
      $displayable$$9_duringDisplayAnim_feelerRad$$inline_2398_sliceDisplayables$$[$i$$183_topSurface$$inline_2389$$].setCursor("pointer")
    }
  }
  if($displayable$$9_duringDisplayAnim_feelerRad$$inline_2398_sliceDisplayables$$ = (0,D.$JSCompiler_StaticMethods_getTopDisplayable$$)(this)) {
    $displayable$$9_duringDisplayAnim_feelerRad$$inline_2398_sliceDisplayables$$.$setAriaRole$("img"), this.$_updateAriaLabel$()
  }
};
...
D.$JSCompiler_prototypeAlias$$.contains = function $$JSCompiler_prototypeAlias$$$contains$($x$$82$$, $y$$61$$) {
  for(var $ir$$1$$ = this.$_pieChart$.$getInnerRadius$(), $angle$$8_c$$4_containsAngle$$ = this.$_pieChart$.$getCenter$(), $cos_distance$$1$$ = ($x$$82$$ - $angle$$8_c$$4_containsAngle$$.x) / this.$_radiusX$, $sin$$ = ($y$$61$$ - $angle$$8_c$$4_containsAngle$$.y) / this.$_radiusY$, $angle$$8_c$$4_containsAngle$$ = -window.Math.atan2($sin$$, $cos_distance$$1$$) * (180 / window.Math.PI);$angle$$8_c$$4_containsAngle$$ < this.$_angleStart$;) {
...
D.$JSCompiler_prototypeAlias$$.$_removeDeletedSlice$ = function $$JSCompiler_prototypeAlias$$$$_removeDeletedSlice$$() {
  var $slices$$3$$ = this.$_pieChart$.$_slices$, $index$$134$$ = D.$DvtArrayUtils$$.$getIndex$($slices$$3$$, this);
  0 <= $index$$134$$ && $slices$$3$$.splice($index$$134$$, 1)
};
...
D.$JSCompiler_prototypeAlias$$.$getAriaLabel$ = function $$JSCompiler_prototypeAlias$$$$getAriaLabel$$() {
  ...
  var $percentageLabel_states$$1$$ = (0,D.$DvtBundle$getTranslatedString$$)("DvtChartBundle", "LABEL_PERCENTAGE", D.$JSCompiler_alias_NULL$$), $percentage$$1$$ = D.$DvtPieLabelUtils$$.$generateSliceLabelString$(this, "percent");
  $shortDesc$$2$$ += "; " + (0,D.$DvtBundle$getTranslatedString$$)("DvtUtilBundle", "COLON_SEP_LIST", [$percentageLabel_states$$1$$, $percentage$$1$$]);
  $percentageLabel_states$$1$$ = [];
  this.$isSelectable$() && $percentageLabel_states$$1$$.push((0,D.$DvtBundle$getTranslatedString$$)("DvtUtilBundle", this.$isSelected$() ? "STATE_SELECTED" : "STATE_UNSELECTED"));
  return(0,D.$DvtDisplayable$generateAriaLabel$$)($shortDesc$$2$$, $percentageLabel_states$$1$$)
};
...
D.$JSCompiler_prototypeAlias$$.$getNextNavigable$ = function $$JSCompiler_prototypeAlias$$$$getNextNavigable$$($event$$146$$) {
  if($event$$146$$.type == D.$DvtMouseEvent$CLICK$$ || 32 == $event$$146$$.keyCode && $event$$146$$.ctrlKey) {
    return this
  }
  var $slices$$4$$ = this.$_pieChart$.$_slices$, $idx$$4$$ = $slices$$4$$.indexOf(this), $next$$1$$ = D.$JSCompiler_alias_NULL$$;
  39 == $event$$146$$.keyCode ? $next$$1$$ = $idx$$4$$ < $slices$$4$$.length - 1 ? $slices$$4$$[$idx$$4$$ + 1] : $slices$$4$$[0] : 37 == $event$$146$$.keyCode && ($next$$1$$ = 0 == $idx$$4$$ ? $slices$$4$$[$slices$$4$$.length - 1] : $slices$$4$$[$idx$$4$$ - 1]);
  return $next$$1$$
};
...
D.$DvtChart$$ = function $$DvtChart$$$($context$$26$$, $callback$$38$$, $callbackObj$$2$$) {
  this.Init($context$$26$$, $callback$$38$$, $callbackObj$$2$$)
};
(0,D.$goog$exportPath_$$)("DvtChart", D.$DvtChart$$);
D.$DvtObj$$.$createSubclass$(D.$DvtChart$$, D.$DvtBaseComponent$$, "DvtChart");
D.$DvtChart$newInstance$$ = function $$DvtChart$newInstance$$$($context$$27$$, $callback$$39$$, $callbackObj$$3$$) {
  return new D.$DvtChart$$($context$$27$$, $callback$$39$$, $callbackObj$$3$$)
};
...
D.$DvtChart$$.prototype.Init = function $$DvtChart$$$$Init$($context$$28$$, $callback$$40$$, $callbackObj$$4$$) {
  D.$DvtChart$$.$superclass$.Init.call(this, $context$$28$$, $callback$$40$$, $callbackObj$$4$$);
...
D.$DvtChart$$.prototype.$getValuesAt$ = function $$DvtChart$$$$$getValuesAt$$($x$$70$$, $y$$50$$) {
  var $paBounds_r$$1$$ = this.$_plotAreaSpace$, $relX_theta$$ = $x$$70$$ - $paBounds_r$$1$$.x, $relY$$ = $y$$50$$ - $paBounds_r$$1$$.y, $isPolar$$ = D.$DvtChartTypeUtils$$.$isPolar$(this), $isHoriz$$2$$ = D.$DvtChartTypeUtils$$.$isHorizontal$(this);
...
D.$DvtChart$$.prototype.$processEvent$ = function $$DvtChart$$$$$processEvent$$($event$$108$$, $source$$9$$) {
  var $actionDone$$inline_1802_event$$inline_1808_eventType$$inline_1805_oldItems_subtype_type$$62$$ = $event$$108$$.$getType$();
  if($actionDone$$inline_1802_event$$inline_1808_eventType$$inline_1805_oldItems_subtype_type$$62$$ == D.$DvtCategoryHideShowEvent$$.$TYPE_HIDE$ || $actionDone$$inline_1802_event$$inline_1808_eventType$$inline_1805_oldItems_subtype_type$$62$$ == D.$DvtCategoryHideShowEvent$$.$TYPE_SHOW$) {
    this.filter($event$$108$$.$_category$, $actionDone$$inline_1802_event$$inline_1808_eventType$$inline_1805_oldItems_subtype_type$$62$$ == D.$DvtCategoryHideShowEvent$$.$TYPE_HIDE$ ? "out" : "in")
  }else {
    if("categoryRollOver" == $actionDone$$inline_1802_event$$inline_1808_eventType$$inline_1805_oldItems_subtype_type$$62$$ || "categoryRollOut" == $actionDone$$inline_1802_event$$inline_1808_eventType$$inline_1805_oldItems_subtype_type$$62$$) {
      this != $source$$9$$ && this.$highlight$($event$$108$$.categories), this.$legend$ && this.$legend$ != $source$$9$$ && this.$legend$.$processEvent$($event$$108$$, $source$$9$$)
    }else {
      if("selection" == $actionDone$$inline_1802_event$$inline_1808_eventType$$inline_1805_oldItems_subtype_type$$62$$) {
        $event$$108$$ = this.$_processSelectionEvent$($event$$108$$)
      }else {
        if("dvtPanZoom" == $actionDone$$inline_1802_event$$inline_1808_eventType$$inline_1805_oldItems_subtype_type$$62$$) {
          var $bounds$$inline_1804_event$$inline_1800_newSet_options$$28_selection$$inline_1809$$ = $event$$108$$, $actionStart$$inline_1803_addedSet_subtype$$inline_1801$$ = $bounds$$inline_1804_event$$inline_1800_newSet_options$$28_selection$$inline_1809$$.$getSubtype$(), $actionDone$$inline_1802_event$$inline_1808_eventType$$inline_1805_oldItems_subtype_type$$62$$ = "dvtPanEndEvent" == $actionStart$$inline_1803_addedSet_subtype$$inline_1801$$ || "dvtZoomEvent" == $actionStart$$inline_1803_addedSet_subtype$$inline_1801$$ || 
          "dvtPinchEndEvent" == $actionStart$$inline_1803_addedSet_subtype$$inline_1801$$, $actionStart$$inline_1803_addedSet_subtype$$inline_1801$$ = "dvtPanStartEvent" == $actionStart$$inline_1803_addedSet_subtype$$inline_1801$$ || "dvtPinchStartEvent" == $actionStart$$inline_1803_addedSet_subtype$$inline_1801$$;
          (0,D.$DvtAgent$isTouchDevice$$)() && ($actionStart$$inline_1803_addedSet_subtype$$inline_1801$$ && this.$_panZoomTarget$ != this.$_plotArea$) && (this.$_container$.removeChild(this.$_panZoomTarget$), this.$_panZoomTarget$ = this.$_plotArea$);
          D.$DvtChartEventUtils$$.$isLiveScroll$(this) ? ($bounds$$inline_1804_event$$inline_1800_newSet_options$$28_selection$$inline_1809$$ = D.$DvtChartEventUtils$$.$getAxisBoundsByDelta$(this, $bounds$$inline_1804_event$$inline_1800_newSet_options$$28_selection$$inline_1809$$.$dxMin$, $bounds$$inline_1804_event$$inline_1800_newSet_options$$28_selection$$inline_1809$$.$dxMax$, $bounds$$inline_1804_event$$inline_1800_newSet_options$$28_selection$$inline_1809$$.$dyMin$, $bounds$$inline_1804_event$$inline_1800_newSet_options$$28_selection$$inline_1809$$.$dyMax$), 
          $actionStart$$inline_1803_addedSet_subtype$$inline_1801$$ || ((0,D.$JSCompiler_StaticMethods__setViewport$$)(this, $bounds$$inline_1804_event$$inline_1800_newSet_options$$28_selection$$inline_1809$$, $actionDone$$inline_1802_event$$inline_1808_eventType$$inline_1805_oldItems_subtype_type$$62$$), (0,D.$JSCompiler_StaticMethods__setScrollbarViewport$$)(this, $bounds$$inline_1804_event$$inline_1800_newSet_options$$28_selection$$inline_1809$$))) : ($bounds$$inline_1804_event$$inline_1800_newSet_options$$28_selection$$inline_1809$$ = 
          D.$DvtChartEventUtils$$.$getAxisBoundsByDelta$(this, $bounds$$inline_1804_event$$inline_1800_newSet_options$$28_selection$$inline_1809$$.$dxMinTotal$, $bounds$$inline_1804_event$$inline_1800_newSet_options$$28_selection$$inline_1809$$.$dxMaxTotal$, $bounds$$inline_1804_event$$inline_1800_newSet_options$$28_selection$$inline_1809$$.$dyMinTotal$, $bounds$$inline_1804_event$$inline_1800_newSet_options$$28_selection$$inline_1809$$.$dyMaxTotal$), (0,D.$JSCompiler_StaticMethods__setScrollbarViewport$$)(this, 
          $bounds$$inline_1804_event$$inline_1800_newSet_options$$28_selection$$inline_1809$$), $actionDone$$inline_1802_event$$inline_1808_eventType$$inline_1805_oldItems_subtype_type$$62$$ && (0,D.$JSCompiler_StaticMethods__setViewport$$)(this, $bounds$$inline_1804_event$$inline_1800_newSet_options$$28_selection$$inline_1809$$, $actionDone$$inline_1802_event$$inline_1808_eventType$$inline_1805_oldItems_subtype_type$$62$$));
          $actionDone$$inline_1802_event$$inline_1808_eventType$$inline_1805_oldItems_subtype_type$$62$$ && (D.$DvtChartRenderer$$.$_setEventHandlers$(this), this.$_panZoomTarget$ != this.$_plotArea$ && (this.$_container$.removeChild(this.$_panZoomTarget$), this.$_panZoomTarget$ = D.$JSCompiler_alias_NULL$$));
          $actionDone$$inline_1802_event$$inline_1808_eventType$$inline_1805_oldItems_subtype_type$$62$$ = $actionDone$$inline_1802_event$$inline_1808_eventType$$inline_1805_oldItems_subtype_type$$62$$ ? "viewportChange" : "viewportChangeInput";
          $event$$108$$ = D.$DvtChartTypeUtils$$.$isBLAC$(this) ? new D.$DvtChartViewportChangeEvent$$($actionDone$$inline_1802_event$$inline_1808_eventType$$inline_1805_oldItems_subtype_type$$62$$, $bounds$$inline_1804_event$$inline_1800_newSet_options$$28_selection$$inline_1809$$.$xMin$, $bounds$$inline_1804_event$$inline_1800_newSet_options$$28_selection$$inline_1809$$.$xMax$, $bounds$$inline_1804_event$$inline_1800_newSet_options$$28_selection$$inline_1809$$.$startGroup$, $bounds$$inline_1804_event$$inline_1800_newSet_options$$28_selection$$inline_1809$$.$endGroup$, 
          D.$JSCompiler_alias_NULL$$, D.$JSCompiler_alias_NULL$$) : new D.$DvtChartViewportChangeEvent$$($actionDone$$inline_1802_event$$inline_1808_eventType$$inline_1805_oldItems_subtype_type$$62$$, $bounds$$inline_1804_event$$inline_1800_newSet_options$$28_selection$$inline_1809$$.$xMin$, $bounds$$inline_1804_event$$inline_1800_newSet_options$$28_selection$$inline_1809$$.$xMax$, D.$JSCompiler_alias_NULL$$, D.$JSCompiler_alias_NULL$$, $bounds$$inline_1804_event$$inline_1800_newSet_options$$28_selection$$inline_1809$$.$yMin$, 
          $bounds$$inline_1804_event$$inline_1800_newSet_options$$28_selection$$inline_1809$$.$yMax$)
        }else {
          if("dvtMarquee" == $actionDone$$inline_1802_event$$inline_1808_eventType$$inline_1805_oldItems_subtype_type$$62$$) {
            $event$$108$$ = (0,D.$JSCompiler_StaticMethods__processMarqueeEvent$$)(this, $event$$108$$)
          }else {
            if("overview" == $actionDone$$inline_1802_event$$inline_1808_eventType$$inline_1805_oldItems_subtype_type$$62$$) {
              $actionDone$$inline_1802_event$$inline_1808_eventType$$inline_1805_oldItems_subtype_type$$62$$ = $event$$108$$.$getSubType$();
              if("dropCallback" == $actionDone$$inline_1802_event$$inline_1808_eventType$$inline_1805_oldItems_subtype_type$$62$$) {
                return
              }
              $event$$108$$ = (0,D.$JSCompiler_StaticMethods__processScrollbarEvent$$)(this, $event$$108$$.$getParamValue$("newStartTime"), $event$$108$$.$getParamValue$("newEndTime"), "scrollTime" == $actionDone$$inline_1802_event$$inline_1808_eventType$$inline_1805_oldItems_subtype_type$$62$$ || "scrollEnd" == $actionDone$$inline_1802_event$$inline_1808_eventType$$inline_1805_oldItems_subtype_type$$62$$ || "rangeChange" == $actionDone$$inline_1802_event$$inline_1808_eventType$$inline_1805_oldItems_subtype_type$$62$$, 
              $source$$9$$)
            }else {
              "dvtSimpleScrollbar" == $actionDone$$inline_1802_event$$inline_1808_eventType$$inline_1805_oldItems_subtype_type$$62$$ ? $event$$108$$ = (0,D.$JSCompiler_StaticMethods__processScrollbarEvent$$)(this, $event$$108$$.$_newMin$, $event$$108$$.$_newMax$, "dvtEndEvent" == $event$$108$$.$getSubtype$(), $source$$9$$) : "showPopup" == $actionDone$$inline_1802_event$$inline_1808_eventType$$inline_1805_oldItems_subtype_type$$62$$ ? ($actionDone$$inline_1802_event$$inline_1808_eventType$$inline_1805_oldItems_subtype_type$$62$$ = 
              $event$$108$$, "mouseHover" != $actionDone$$inline_1802_event$$inline_1808_eventType$$inline_1805_oldItems_subtype_type$$62$$.triggerType && (this.$isSelectionSupported$() && 0 < this.$getSelectionHandler$().$_selection$.length) && ($bounds$$inline_1804_event$$inline_1800_newSet_options$$28_selection$$inline_1809$$ = D.$DvtChartEventUtils$$.$processIds$(this, (0,D.$JSCompiler_StaticMethods_getSelectedIds$$)(this.$getSelectionHandler$())), $actionDone$$inline_1802_event$$inline_1808_eventType$$inline_1805_oldItems_subtype_type$$62$$ = 
              new D.$DvtShowPopupEvent$$($actionDone$$inline_1802_event$$inline_1808_eventType$$inline_1805_oldItems_subtype_type$$62$$.$_showPopupBehavior$, $actionDone$$inline_1802_event$$inline_1808_eventType$$inline_1805_oldItems_subtype_type$$62$$.$_launcherBounds$, $actionDone$$inline_1802_event$$inline_1808_eventType$$inline_1805_oldItems_subtype_type$$62$$.$_launcherId$), (0,D.$JSCompiler_StaticMethods_addParam$$)($actionDone$$inline_1802_event$$inline_1808_eventType$$inline_1805_oldItems_subtype_type$$62$$, 
              "clientRowKey", $bounds$$inline_1804_event$$inline_1800_newSet_options$$28_selection$$inline_1809$$)), $event$$108$$ = $actionDone$$inline_1802_event$$inline_1808_eventType$$inline_1805_oldItems_subtype_type$$62$$) : $event$$108$$ instanceof D.$DvtComponentUIEvent$$ && ($event$$108$$ = (0,D.$JSCompiler_StaticMethods__processComponentUIEvent$$)(this, $event$$108$$, $source$$9$$))
            }
          }
        }
      }
  ...
  if($event$$108$$ instanceof D.$DvtChartSelectionEvent$$) {
    var $bounds$$inline_1804_event$$inline_1800_newSet_options$$28_selection$$inline_1809$$ = this.$getOptions$(), $actionDone$$inline_1802_event$$inline_1808_eventType$$inline_1805_oldItems_subtype_type$$62$$ = $bounds$$inline_1804_event$$inline_1800_newSet_options$$28_selection$$inline_1809$$.selection, $newItems_removedSet$$ = D.$DvtChartDataUtils$$.$getCurrentSelection$(this);
    "selectionInput" != $event$$108$$.$getType$() && ($bounds$$inline_1804_event$$inline_1800_newSet_options$$28_selection$$inline_1809$$.selection = $newItems_removedSet$$);
    var $actionDone$$inline_1802_event$$inline_1808_eventType$$inline_1805_oldItems_subtype_type$$62$$ = $actionDone$$inline_1802_event$$inline_1808_eventType$$inline_1805_oldItems_subtype_type$$62$$ ? $actionDone$$inline_1802_event$$inline_1808_eventType$$inline_1805_oldItems_subtype_type$$62$$ : [], $newItems_removedSet$$ = $newItems_removedSet$$ ? $newItems_removedSet$$ : [], $newIndex$$2_oldIndex$$, $oldItemId_oldSet$$ = {};
    for($newIndex$$2_oldIndex$$ = 0;$newIndex$$2_oldIndex$$ < $actionDone$$inline_1802_event$$inline_1808_eventType$$inline_1805_oldItems_subtype_type$$62$$.length;$newIndex$$2_oldIndex$$++) {
      $oldItemId_oldSet$$[$actionDone$$inline_1802_event$$inline_1808_eventType$$inline_1805_oldItems_subtype_type$$62$$[$newIndex$$2_oldIndex$$].id] = D.$JSCompiler_alias_TRUE$$
    }
    $bounds$$inline_1804_event$$inline_1800_newSet_options$$28_selection$$inline_1809$$ = {};
    for($newIndex$$2_oldIndex$$ = 0;$newIndex$$2_oldIndex$$ < $newItems_removedSet$$.length;$newIndex$$2_oldIndex$$++) {
      $bounds$$inline_1804_event$$inline_1800_newSet_options$$28_selection$$inline_1809$$[$newItems_removedSet$$[$newIndex$$2_oldIndex$$].id] = D.$JSCompiler_alias_TRUE$$
    }
    $actionStart$$inline_1803_addedSet_subtype$$inline_1801$$ = {};
    for($newIndex$$2_oldIndex$$ = 0;$newIndex$$2_oldIndex$$ < $newItems_removedSet$$.length;$newIndex$$2_oldIndex$$++) {
      var $newItemId$$ = $newItems_removedSet$$[$newIndex$$2_oldIndex$$].id;
      $oldItemId_oldSet$$[$newItemId$$] || ($actionStart$$inline_1803_addedSet_subtype$$inline_1801$$[$newItemId$$] = D.$JSCompiler_alias_TRUE$$)
    }
    $newItems_removedSet$$ = {};
    for($newIndex$$2_oldIndex$$ = 0;$newIndex$$2_oldIndex$$ < $actionDone$$inline_1802_event$$inline_1808_eventType$$inline_1805_oldItems_subtype_type$$62$$.length;$newIndex$$2_oldIndex$$++) {
      $oldItemId_oldSet$$ = $actionDone$$inline_1802_event$$inline_1808_eventType$$inline_1805_oldItems_subtype_type$$62$$[$newIndex$$2_oldIndex$$].id, $bounds$$inline_1804_event$$inline_1800_newSet_options$$28_selection$$inline_1809$$[$oldItemId_oldSet$$] || ($newItems_removedSet$$[$oldItemId_oldSet$$] = D.$JSCompiler_alias_TRUE$$)
    }
    $event$$108$$.addedSet = $actionStart$$inline_1803_addedSet_subtype$$inline_1801$$;
    $event$$108$$.removedSet = $newItems_removedSet$$
  }
  $event$$108$$ && this.$__dispatchEvent$($event$$108$$)
};
D.$DvtChart$$.prototype.$_processSelectionEvent$ = function $$DvtChart$$$$$_processSelectionEvent$$($event$$109_selection$$12$$) {
  $event$$109_selection$$12$$ = D.$DvtChartEventUtils$$.$processIds$(this, $event$$109_selection$$12$$.getSelection());
  (0,D.$JSCompiler_StaticMethods__updateOverviewSelection$$)(this);
  return new D.$DvtChartSelectionEvent$$($event$$109_selection$$12$$, "selection")
};
D.$JSCompiler_StaticMethods__processMarqueeEvent$$ = function $$JSCompiler_StaticMethods__processMarqueeEvent$$$($JSCompiler_StaticMethods__processMarqueeEvent$self$$, $event$$111$$) {
  var $subtype$$2$$ = $event$$111$$.$getSubtype$(), $bounds$$5_em_selectionEvent_selectionHandler$$ = $JSCompiler_StaticMethods__processMarqueeEvent$self$$.$EventManager$;
  D.$DvtChartEventUtils$$.$adjustBounds$($event$$111$$);
  if("select" == $bounds$$5_em_selectionEvent_selectionHandler$$.$_dragMode$) {
    ...
    if("dvtMarqueeStartEvent" == $subtype$$2$$) {
      $JSCompiler_StaticMethods__processMarqueeEvent$self$$.$_initSelection$ = $event$$111$$.ctrlKey ? (0,D.$JSCompiler_StaticMethods_getSelectedIds$$)($bounds$$5_em_selectionEvent_selectionHandler$$) : []
    }else {
      var $selection$$13_targets$$ = D.$DvtChartEventUtils$$.$getBoundedObjects$($JSCompiler_StaticMethods__processMarqueeEvent$self$$, $event$$111$$);
      ...
      for(var $target$$inline_1814$$, $i$$inline_1815$$ = 0;$i$$inline_1815$$ < $selection$$13_targets$$.length;$i$$inline_1815$$++) {
        $target$$inline_1814$$ = $selection$$13_targets$$[$i$$inline_1815$$], (!$target$$inline_1814$$ || !$target$$inline_1814$$.$isUnrelatedToSelection$) && (0,D.$JSCompiler_StaticMethods__addToSelection$$)($bounds$$5_em_selectionEvent_selectionHandler$$, $target$$inline_1814$$, D.$JSCompiler_alias_TRUE$$)
      }
    }
    $selection$$13_targets$$ = D.$DvtChartEventUtils$$.$getSelectedObjects$($JSCompiler_StaticMethods__processMarqueeEvent$self$$, $event$$111$$, $bounds$$5_em_selectionEvent_selectionHandler$$);
    $bounds$$5_em_selectionEvent_selectionHandler$$ = D.$DvtChartEventUtils$$.$getAxisBounds$($JSCompiler_StaticMethods__processMarqueeEvent$self$$, $event$$111$$, D.$JSCompiler_alias_FALSE$$);
  ...
  if("zoom" == $bounds$$5_em_selectionEvent_selectionHandler$$.$_dragMode$) {
    ...
    $bounds$$5_em_selectionEvent_selectionHandler$$ = D.$DvtChartEventUtils$$.$getAxisBounds$($JSCompiler_StaticMethods__processMarqueeEvent$self$$, $event$$111$$, D.$JSCompiler_alias_TRUE$$);
...
D.$JSCompiler_StaticMethods__processScrollbarEvent$$ = function $$JSCompiler_StaticMethods__processScrollbarEvent$$$($JSCompiler_StaticMethods__processScrollbarEvent$self_startEndGroup$$, $start$$24$$, $end$$10$$, $actionDone$$2_eventType$$7$$, $source$$10$$) {
  var $axis$$61$$ = $source$$10$$ == $JSCompiler_StaticMethods__processScrollbarEvent$self_startEndGroup$$.$yScrollbar$ ? $JSCompiler_StaticMethods__processScrollbarEvent$self_startEndGroup$$.$yAxis$ : $JSCompiler_StaticMethods__processScrollbarEvent$self_startEndGroup$$.$xAxis$;
  $start$$24$$ = $axis$$61$$.$linearToActual$($start$$24$$);
  $end$$10$$ = $axis$$61$$.$linearToActual$($end$$10$$);
...
D.$JSCompiler_StaticMethods__processComponentUIEvent$$ = function $$JSCompiler_StaticMethods__processComponentUIEvent$$$($JSCompiler_StaticMethods__processComponentUIEvent$self$$, $event$$113$$, $source$$11$$) {
  var $params$$7$$ = $event$$113$$.params, $chartObjType$$ = $params$$7$$.type;
  return $source$$11$$ === $JSCompiler_StaticMethods__processComponentUIEvent$self$$.$legend$ ? ($chartObjType$$ == D.$DvtLegendConstants$$.$LEGEND_ITEM$ ? $chartObjType$$ = D.$DvtChartConstants$$.$LEGEND_ITEM$ : $chartObjType$$ == D.$DvtLegendConstants$$.$TITLE$ ? $chartObjType$$ = D.$DvtChartConstants$$.$LEGEND_TITLE$ : $chartObjType$$ == D.$DvtLegendConstants$$.$BACKGROUND$ && ($chartObjType$$ = D.$DvtChartConstants$$.$LEGEND$), new D.$DvtComponentUIEvent$$($event$$113$$.$getType$(), (0,D.$DvtChartEventManager$getUIEventParams$$)($chartObjType$$, 
  D.$JSCompiler_alias_NULL$$, $params$$7$$.id))) : $source$$11$$ === $JSCompiler_StaticMethods__processComponentUIEvent$self$$.$xAxis$ ? ($chartObjType$$ == D.$DvtAxisConstants$$.$TICK_LABEL$ ? $chartObjType$$ = D.$DvtChartConstants$$.$X_AXIS_LABEL$ : $chartObjType$$ == D.$DvtAxisConstants$$.$TITLE$ && ($chartObjType$$ = D.$DvtChartConstants$$.$X_AXIS_TITLE$), new D.$DvtComponentUIEvent$$($event$$113$$.$getType$(), (0,D.$DvtChartEventManager$getUIEventParams$$)($chartObjType$$, $params$$7$$.id))) : 
  $source$$11$$ === $JSCompiler_StaticMethods__processComponentUIEvent$self$$.$yAxis$ ? ($chartObjType$$ == D.$DvtAxisConstants$$.$TICK_LABEL$ ? $chartObjType$$ = D.$DvtChartConstants$$.$Y_AXIS_LABEL$ : $chartObjType$$ == D.$DvtAxisConstants$$.$TITLE$ && ($chartObjType$$ = D.$DvtChartConstants$$.$Y_AXIS_TITLE$), new D.$DvtComponentUIEvent$$($event$$113$$.$getType$(), (0,D.$DvtChartEventManager$getUIEventParams$$)($chartObjType$$, $params$$7$$.id))) : $source$$11$$ === $JSCompiler_StaticMethods__processComponentUIEvent$self$$.$y2Axis$ ? 
  ($chartObjType$$ == D.$DvtAxisConstants$$.$TICK_LABEL$ ? $chartObjType$$ = D.$DvtChartConstants$$.$Y2_AXIS_LABEL$ : $chartObjType$$ == D.$DvtAxisConstants$$.$TITLE$ && ($chartObjType$$ = D.$DvtChartConstants$$.$Y2_AXIS_TITLE$), new D.$DvtComponentUIEvent$$($event$$113$$.$getType$(), (0,D.$DvtChartEventManager$getUIEventParams$$)($chartObjType$$, $params$$7$$.id))) : $event$$113$$
};
...
D.$DvtChart$$.prototype.$processActiveDataChanges$ = function $$DvtChart$$$$$processActiveDataChanges$$($changes$$) {
  for(var $optionsOld$$ = D.$DvtJSONUtils$$.$clone$(this.$Options$), $optionsNew$$ = this.$Options$, $changeIndex$$ = 0;$changeIndex$$ < $changes$$.length;$changeIndex$$++) {
    var $entry$$inline_2096_entry$$inline_9800_entry$$inline_9807$$ = $changes$$[$changeIndex$$], $data$$inline_9801_data$$inline_9808_type$$inline_2097$$ = $entry$$inline_2096_entry$$inline_9800_entry$$inline_9807$$.type;
    if("u" == $data$$inline_9801_data$$inline_9808_type$$inline_2097$$) {
      for(var $data$$inline_9801_data$$inline_9808_type$$inline_2097$$ = $entry$$inline_2096_entry$$inline_9800_entry$$inline_9807$$.data, $i$$inline_9802_i$$inline_9809$$ = 0;$i$$inline_9802_i$$inline_9809$$ < $data$$inline_9801_data$$inline_9808_type$$inline_2097$$.length;$i$$inline_9802_i$$inline_9809$$++) {
        var $dataItemInfo$$inline_9803_insertedGroup$$inline_9811_items$$inline_9818$$ = (0,D.$JSCompiler_StaticMethods__findDataItemById$$)(this, $entry$$inline_2096_entry$$inline_9800_entry$$inline_9807$$.id, $data$$inline_9801_data$$inline_9808_type$$inline_2097$$[$i$$inline_9802_i$$inline_9809$$]._id);
        if($dataItemInfo$$inline_9803_insertedGroup$$inline_9811_items$$inline_9818$$) {
          for(var $key$$inline_9804$$ in $data$$inline_9801_data$$inline_9808_type$$inline_2097$$[$i$$inline_9802_i$$inline_9809$$]) {
            "_id" != $key$$inline_9804$$ && ($dataItemInfo$$inline_9803_insertedGroup$$inline_9811_items$$inline_9818$$.item[$key$$inline_9804$$] = $data$$inline_9801_data$$inline_9808_type$$inline_2097$$[$i$$inline_9802_i$$inline_9809$$][$key$$inline_9804$$])
          }
        }
      }
    }else {
      if("ia" == $data$$inline_9801_data$$inline_9808_type$$inline_2097$$ || "ib" == $data$$inline_9801_data$$inline_9808_type$$inline_2097$$) {
        $data$$inline_9801_data$$inline_9808_type$$inline_2097$$ = $entry$$inline_2096_entry$$inline_9800_entry$$inline_9807$$.data;
        for($i$$inline_9802_i$$inline_9809$$ = 0;$i$$inline_9802_i$$inline_9809$$ < $data$$inline_9801_data$$inline_9808_type$$inline_2097$$.length;$i$$inline_9802_i$$inline_9809$$++) {
          this.$Cache$ = {};
          var $insertId$$inline_9810$$ = $entry$$inline_2096_entry$$inline_9800_entry$$inline_9807$$.insertId, $dataItemInfo$$inline_9803_insertedGroup$$inline_9811_items$$inline_9818$$ = $data$$inline_9801_data$$inline_9808_type$$inline_2097$$[$i$$inline_9802_i$$inline_9809$$].group, $insertedSeries$$inline_9812_seriesItems$$inline_9817$$ = $data$$inline_9801_data$$inline_9808_type$$inline_2097$$[$i$$inline_9802_i$$inline_9809$$].series, $seriesCount$$inline_9813$$ = D.$DvtChartDataUtils$$.$getSeriesCount$(this), 
          $groupCount$$inline_9814_seriesIndex$$inline_9820$$ = D.$DvtChartDataUtils$$.$getGroupCount$(this), $insertedSeriesIndex$$inline_9815$$ = D.$DvtChartDataUtils$$.$getSeriesIndex$(this, $insertedSeries$$inline_9812_seriesItems$$inline_9817$$), $dataItemInfo$$inline_9819_insertedGroupIndex$$inline_9816$$ = D.$DvtChartDataUtils$$.$getGroupIndex$(this, $dataItemInfo$$inline_9803_insertedGroup$$inline_9811_items$$inline_9818$$);
          if(0 <= $insertedSeriesIndex$$inline_9815$$ && 0 <= $dataItemInfo$$inline_9819_insertedGroupIndex$$inline_9816$$) {
            $insertedSeries$$inline_9812_seriesItems$$inline_9817$$ = D.$DvtChartDataUtils$$.$getSeriesItem$(this, $insertedSeriesIndex$$inline_9815$$).items, $insertedSeries$$inline_9812_seriesItems$$inline_9817$$[$dataItemInfo$$inline_9819_insertedGroupIndex$$inline_9816$$] = {id:$entry$$inline_2096_entry$$inline_9800_entry$$inline_9807$$.id}, (0,D.$DvtChart$_copyActiveDataProperties$$)($data$$inline_9801_data$$inline_9808_type$$inline_2097$$[$i$$inline_9802_i$$inline_9809$$], $insertedSeries$$inline_9812_seriesItems$$inline_9817$$[$dataItemInfo$$inline_9819_insertedGroupIndex$$inline_9816$$])
          }else {
            if(0 <= $dataItemInfo$$inline_9819_insertedGroupIndex$$inline_9816$$) {
              $dataItemInfo$$inline_9803_insertedGroup$$inline_9811_items$$inline_9818$$ = (0,window.Array)($groupCount$$inline_9814_seriesIndex$$inline_9820$$), $dataItemInfo$$inline_9803_insertedGroup$$inline_9811_items$$inline_9818$$[$dataItemInfo$$inline_9819_insertedGroupIndex$$inline_9816$$] = {id:$entry$$inline_2096_entry$$inline_9800_entry$$inline_9807$$.id}, (0,D.$DvtChart$_copyActiveDataProperties$$)($data$$inline_9801_data$$inline_9808_type$$inline_2097$$[$i$$inline_9802_i$$inline_9809$$], 
              $dataItemInfo$$inline_9803_insertedGroup$$inline_9811_items$$inline_9818$$[$dataItemInfo$$inline_9819_insertedGroupIndex$$inline_9816$$]), this.$Options$.series.push({name:$insertedSeries$$inline_9812_seriesItems$$inline_9817$$, items:$dataItemInfo$$inline_9803_insertedGroup$$inline_9811_items$$inline_9818$$})
            }else {
              $dataItemInfo$$inline_9819_insertedGroupIndex$$inline_9816$$ = ($dataItemInfo$$inline_9819_insertedGroupIndex$$inline_9816$$ = (0,D.$JSCompiler_StaticMethods__findDataItemById$$)(this, $insertId$$inline_9810$$)) ? "ia" == $entry$$inline_2096_entry$$inline_9800_entry$$inline_9807$$.type ? $dataItemInfo$$inline_9819_insertedGroupIndex$$inline_9816$$.$groupIndex$ + 1 : $dataItemInfo$$inline_9819_insertedGroupIndex$$inline_9816$$.$groupIndex$ : 0;
              0 > $insertedSeriesIndex$$inline_9815$$ && (this.$Options$.series.push({name:$insertedSeries$$inline_9812_seriesItems$$inline_9817$$, items:(0,window.Array)($groupCount$$inline_9814_seriesIndex$$inline_9820$$)}), $insertedSeriesIndex$$inline_9815$$ = $seriesCount$$inline_9813$$, $seriesCount$$inline_9813$$++);
              for($groupCount$$inline_9814_seriesIndex$$inline_9820$$ = 0;$groupCount$$inline_9814_seriesIndex$$inline_9820$$ < $seriesCount$$inline_9813$$;$groupCount$$inline_9814_seriesIndex$$inline_9820$$++) {
                $insertedSeries$$inline_9812_seriesItems$$inline_9817$$ = D.$DvtChartDataUtils$$.$getSeriesItem$(this, $groupCount$$inline_9814_seriesIndex$$inline_9820$$).items, $insertedSeries$$inline_9812_seriesItems$$inline_9817$$.splice($dataItemInfo$$inline_9819_insertedGroupIndex$$inline_9816$$, 0, {id:$entry$$inline_2096_entry$$inline_9800_entry$$inline_9807$$.id}), $groupCount$$inline_9814_seriesIndex$$inline_9820$$ == $insertedSeriesIndex$$inline_9815$$ && (0,D.$DvtChart$_copyActiveDataProperties$$)($data$$inline_9801_data$$inline_9808_type$$inline_2097$$[$i$$inline_9802_i$$inline_9809$$], 
                $insertedSeries$$inline_9812_seriesItems$$inline_9817$$[$dataItemInfo$$inline_9819_insertedGroupIndex$$inline_9816$$])
              }
              this.$Options$.groups.splice($dataItemInfo$$inline_9819_insertedGroupIndex$$inline_9816$$, 0, $dataItemInfo$$inline_9803_insertedGroup$$inline_9811_items$$inline_9818$$)
            }
          }
        }
      }else {
        "d" == $data$$inline_9801_data$$inline_9808_type$$inline_2097$$ && (0,D.$JSCompiler_StaticMethods__processActiveDataDelete$$)(this, $entry$$inline_2096_entry$$inline_9800_entry$$inline_9807$$)
      }
    }
  }
...
D.$JSCompiler_StaticMethods__findDataItemById$$ = function $$JSCompiler_StaticMethods__findDataItemById$$$($JSCompiler_StaticMethods__findDataItemById$self$$, $id$$28$$, $stampId$$2$$) {
  if($id$$28$$ == D.$JSCompiler_alias_NULL$$) {
    return D.$JSCompiler_alias_NULL$$
  }
  for(var $seriesCount$$4$$ = D.$DvtChartDataUtils$$.$getSeriesCount$($JSCompiler_StaticMethods__findDataItemById$self$$), $groupCount$$3$$ = D.$DvtChartDataUtils$$.$getGroupCount$($JSCompiler_StaticMethods__findDataItemById$self$$), $seriesIndex$$15$$ = 0;$seriesIndex$$15$$ < $seriesCount$$4$$;$seriesIndex$$15$$++) {
    for(var $groupIndex$$10$$ = 0;$groupIndex$$10$$ < $groupCount$$3$$;$groupIndex$$10$$++) {
      ...
      if($dataItem$$4$$ != D.$JSCompiler_alias_NULL$$ && $dataItem$$4$$.id === $id$$28$$ && ($stampId$$2$$ == D.$JSCompiler_alias_NULL$$ || $stampId$$2$$ === $dataItem$$4$$._id)) {
...
D.$DvtChartAutomation$$.prototype.$GetSubIdForDomElement$ = function $$DvtChartAutomation$$$$$GetSubIdForDomElement$$($JSCompiler_inline_result$$145_displayable$$2_itemIndex_logicalObj$$2_refObjIndex_subId$$inline_1818$$) {
  var $axisSubId_axisType_legendItem$$inline_1820_legendOptions$$inline_1819_seriesIndex$$1$$ = D.$JSCompiler_alias_NULL$$;
  if($JSCompiler_inline_result$$145_displayable$$2_itemIndex_logicalObj$$2_refObjIndex_subId$$inline_1818$$.$isDescendantOf$(this.$_xAxis$)) {
    return $axisSubId_axisType_legendItem$$inline_1820_legendOptions$$inline_1819_seriesIndex$$1$$ = this.$_xAxisAutomation$.$GetSubIdForDomElement$($JSCompiler_inline_result$$145_displayable$$2_itemIndex_logicalObj$$2_refObjIndex_subId$$inline_1818$$), (0,D.$JSCompiler_StaticMethods__convertAxisSubIdToChartSubId$$)($axisSubId_axisType_legendItem$$inline_1820_legendOptions$$inline_1819_seriesIndex$$1$$, "xAxis")
  }
  if($JSCompiler_inline_result$$145_displayable$$2_itemIndex_logicalObj$$2_refObjIndex_subId$$inline_1818$$.$isDescendantOf$(this.$_yAxis$)) {
    return $axisSubId_axisType_legendItem$$inline_1820_legendOptions$$inline_1819_seriesIndex$$1$$ = this.$_yAxisAutomation$.$GetSubIdForDomElement$($JSCompiler_inline_result$$145_displayable$$2_itemIndex_logicalObj$$2_refObjIndex_subId$$inline_1818$$), (0,D.$JSCompiler_StaticMethods__convertAxisSubIdToChartSubId$$)($axisSubId_axisType_legendItem$$inline_1820_legendOptions$$inline_1819_seriesIndex$$1$$, "yAxis")
  }
  if($JSCompiler_inline_result$$145_displayable$$2_itemIndex_logicalObj$$2_refObjIndex_subId$$inline_1818$$.$isDescendantOf$(this.$_y2Axis$)) {
    return $axisSubId_axisType_legendItem$$inline_1820_legendOptions$$inline_1819_seriesIndex$$1$$ = this.$_y2AxisAutomation$.$GetSubIdForDomElement$($JSCompiler_inline_result$$145_displayable$$2_itemIndex_logicalObj$$2_refObjIndex_subId$$inline_1818$$), (0,D.$JSCompiler_StaticMethods__convertAxisSubIdToChartSubId$$)($axisSubId_axisType_legendItem$$inline_1820_legendOptions$$inline_1819_seriesIndex$$1$$, "y2Axis")
  }
  if($JSCompiler_inline_result$$145_displayable$$2_itemIndex_logicalObj$$2_refObjIndex_subId$$inline_1818$$.$isDescendantOf$(this.$_legend$)) {
    a: {
      if($JSCompiler_inline_result$$145_displayable$$2_itemIndex_logicalObj$$2_refObjIndex_subId$$inline_1818$$ = this.$_legendAutomation$.$GetSubIdForDomElement$($JSCompiler_inline_result$$145_displayable$$2_itemIndex_logicalObj$$2_refObjIndex_subId$$inline_1818$$), $axisSubId_axisType_legendItem$$inline_1820_legendOptions$$inline_1819_seriesIndex$$1$$ = this.$_legend$.$getOptions$(), $axisSubId_axisType_legendItem$$inline_1820_legendOptions$$inline_1819_seriesIndex$$1$$ = (0,D.$JSCompiler_StaticMethods_getLegendItem$$)(this.$_legendAutomation$, 
      $axisSubId_axisType_legendItem$$inline_1820_legendOptions$$inline_1819_seriesIndex$$1$$, $JSCompiler_inline_result$$145_displayable$$2_itemIndex_logicalObj$$2_refObjIndex_subId$$inline_1818$$)) {
        for(var $s$$inline_1821$$ = 0;$s$$inline_1821$$ < this.$_options$.series.length;$s$$inline_1821$$++) {
          if(this.$_options$.series[$s$$inline_1821$$].name == $axisSubId_axisType_legendItem$$inline_1820_legendOptions$$inline_1819_seriesIndex$$1$$.text) {
            $JSCompiler_inline_result$$145_displayable$$2_itemIndex_logicalObj$$2_refObjIndex_subId$$inline_1818$$ = "series[" + $s$$inline_1821$$ + "]";
            break a
          }
        }
        $JSCompiler_inline_result$$145_displayable$$2_itemIndex_logicalObj$$2_refObjIndex_subId$$inline_1818$$ = "legend:" + $JSCompiler_inline_result$$145_displayable$$2_itemIndex_logicalObj$$2_refObjIndex_subId$$inline_1818$$
      }else {
        $JSCompiler_inline_result$$145_displayable$$2_itemIndex_logicalObj$$2_refObjIndex_subId$$inline_1818$$ = D.$JSCompiler_alias_NULL$$
      }
    }
    return $JSCompiler_inline_result$$145_displayable$$2_itemIndex_logicalObj$$2_refObjIndex_subId$$inline_1818$$
  }
  if(($JSCompiler_inline_result$$145_displayable$$2_itemIndex_logicalObj$$2_refObjIndex_subId$$inline_1818$$ = this.$_chart$.$__getEventManager$().$GetLogicalObject$($JSCompiler_inline_result$$145_displayable$$2_itemIndex_logicalObj$$2_refObjIndex_subId$$inline_1818$$)) && "pie" == this.$_options$.type) {
    return"dataItem[" + $JSCompiler_inline_result$$145_displayable$$2_itemIndex_logicalObj$$2_refObjIndex_subId$$inline_1818$$.$getSeriesIndex$() + "]"
  }
  if($JSCompiler_inline_result$$145_displayable$$2_itemIndex_logicalObj$$2_refObjIndex_subId$$inline_1818$$ instanceof D.$DvtChartObjPeer$$) {
    $axisSubId_axisType_legendItem$$inline_1820_legendOptions$$inline_1819_seriesIndex$$1$$ = $JSCompiler_inline_result$$145_displayable$$2_itemIndex_logicalObj$$2_refObjIndex_subId$$inline_1818$$.$getSeriesIndex$();
    $JSCompiler_inline_result$$145_displayable$$2_itemIndex_logicalObj$$2_refObjIndex_subId$$inline_1818$$ = $JSCompiler_inline_result$$145_displayable$$2_itemIndex_logicalObj$$2_refObjIndex_subId$$inline_1818$$.$getGroupIndex$();
    if($axisSubId_axisType_legendItem$$inline_1820_legendOptions$$inline_1819_seriesIndex$$1$$ != D.$JSCompiler_alias_NULL$$ && 0 <= $JSCompiler_inline_result$$145_displayable$$2_itemIndex_logicalObj$$2_refObjIndex_subId$$inline_1818$$ && "funnel" != this.$_options$.type) {
      return"dataItem[" + $axisSubId_axisType_legendItem$$inline_1820_legendOptions$$inline_1819_seriesIndex$$1$$ + "][" + $JSCompiler_inline_result$$145_displayable$$2_itemIndex_logicalObj$$2_refObjIndex_subId$$inline_1818$$ + "]"
    }
    if($axisSubId_axisType_legendItem$$inline_1820_legendOptions$$inline_1819_seriesIndex$$1$$ != D.$JSCompiler_alias_NULL$$ && $JSCompiler_inline_result$$145_displayable$$2_itemIndex_logicalObj$$2_refObjIndex_subId$$inline_1818$$ == D.$DvtFunnelRenderer$$.$_GROUP_INDEX$ && "funnel" == this.$_options$.type) {
      return"dataItem[" + $axisSubId_axisType_legendItem$$inline_1820_legendOptions$$inline_1819_seriesIndex$$1$$ + "]"
    }
    if($axisSubId_axisType_legendItem$$inline_1820_legendOptions$$inline_1819_seriesIndex$$1$$ != D.$JSCompiler_alias_NULL$$ && ($JSCompiler_inline_result$$145_displayable$$2_itemIndex_logicalObj$$2_refObjIndex_subId$$inline_1818$$ == D.$JSCompiler_alias_NULL$$ || 0 > $JSCompiler_inline_result$$145_displayable$$2_itemIndex_logicalObj$$2_refObjIndex_subId$$inline_1818$$)) {
      return"series[" + $axisSubId_axisType_legendItem$$inline_1820_legendOptions$$inline_1819_seriesIndex$$1$$ + "]"
    }
  }else {
    if($JSCompiler_inline_result$$145_displayable$$2_itemIndex_logicalObj$$2_refObjIndex_subId$$inline_1818$$ instanceof D.$DvtRefObjPeer$$) {
      return $axisSubId_axisType_legendItem$$inline_1820_legendOptions$$inline_1819_seriesIndex$$1$$ = $JSCompiler_inline_result$$145_displayable$$2_itemIndex_logicalObj$$2_refObjIndex_subId$$inline_1818$$.$_axisType$, $JSCompiler_inline_result$$145_displayable$$2_itemIndex_logicalObj$$2_refObjIndex_subId$$inline_1818$$ = $JSCompiler_inline_result$$145_displayable$$2_itemIndex_logicalObj$$2_refObjIndex_subId$$inline_1818$$.$getIndex$(), $axisSubId_axisType_legendItem$$inline_1820_legendOptions$$inline_1819_seriesIndex$$1$$ && 
      0 <= $JSCompiler_inline_result$$145_displayable$$2_itemIndex_logicalObj$$2_refObjIndex_subId$$inline_1818$$ ? $axisSubId_axisType_legendItem$$inline_1820_legendOptions$$inline_1819_seriesIndex$$1$$ + ":referenceObject[" + $JSCompiler_inline_result$$145_displayable$$2_itemIndex_logicalObj$$2_refObjIndex_subId$$inline_1818$$ + "]" : D.$JSCompiler_alias_NULL$$
    }
  }
  return D.$JSCompiler_alias_NULL$$
};
...
D.$DvtChartAutomation$$.prototype.$getDomElementForSubId$ = function $$DvtChartAutomation$$$$$getDomElementForSubId$$($itemIndex$$inline_1835_legendOptions$$inline_1826_subId$$4$$) {
  if("tooltip" == $itemIndex$$inline_1835_legendOptions$$inline_1826_subId$$4$$) {
    var $openParen1_seriesIndex$$2_seriesIndex$$inline_1825_tooltipElem$$ = (0,D.$JSCompiler_StaticMethods_getTooltipElem$$)(this.$_chart$.$getCtx$().$getTooltipManager$(D.$DvtChartTooltipUtils$$.$isDataCursorEnabled$(this.$_chart$) ? "_dvtDataCursor" : D.$JSCompiler_alias_NULL$$));
    return"hidden" == $openParen1_seriesIndex$$2_seriesIndex$$inline_1825_tooltipElem$$.style.visibility ? D.$JSCompiler_alias_NULL$$ : $openParen1_seriesIndex$$2_seriesIndex$$inline_1825_tooltipElem$$
  }
  var $openParen1_seriesIndex$$2_seriesIndex$$inline_1825_tooltipElem$$ = $itemIndex$$inline_1835_legendOptions$$inline_1826_subId$$4$$.indexOf("["), $closeParen1_peers$$inline_1836$$ = $itemIndex$$inline_1835_legendOptions$$inline_1826_subId$$4$$.indexOf("]"), $index$$inline_1829_logicalObj$$3_objType_openParen2_pieSlice_series$$inline_1838$$, $JSCompiler_StaticMethods_getRefObjPeers$self$$inline_9763_closeParen2_i$$inline_1831$$, $axisObjectType_colon_item$$inline_1839_refObjPeers$$inline_9764$$ = 
  $itemIndex$$inline_1835_legendOptions$$inline_1826_subId$$4$$.indexOf(":");
  if(0 < $openParen1_seriesIndex$$2_seriesIndex$$inline_1825_tooltipElem$$ && 0 < $closeParen1_peers$$inline_1836$$ || 0 < $axisObjectType_colon_item$$inline_1839_refObjPeers$$inline_9764$$) {
    $index$$inline_1829_logicalObj$$3_objType_openParen2_pieSlice_series$$inline_1838$$ = 0 > $axisObjectType_colon_item$$inline_1839_refObjPeers$$inline_9764$$ ? $itemIndex$$inline_1835_legendOptions$$inline_1826_subId$$4$$.substring(0, $openParen1_seriesIndex$$2_seriesIndex$$inline_1825_tooltipElem$$) : $itemIndex$$inline_1835_legendOptions$$inline_1826_subId$$4$$.substring(0, $axisObjectType_colon_item$$inline_1839_refObjPeers$$inline_9764$$);
    if("group" == $index$$inline_1829_logicalObj$$3_objType_openParen2_pieSlice_series$$inline_1838$$) {
      return this.$_xAxisAutomation$.$getDomElementForSubId$($itemIndex$$inline_1835_legendOptions$$inline_1826_subId$$4$$)
    }
    if("series" == $index$$inline_1829_logicalObj$$3_objType_openParen2_pieSlice_series$$inline_1838$$) {
      return $openParen1_seriesIndex$$2_seriesIndex$$inline_1825_tooltipElem$$ = $itemIndex$$inline_1835_legendOptions$$inline_1826_subId$$4$$.substring($itemIndex$$inline_1835_legendOptions$$inline_1826_subId$$4$$.indexOf("[") + 1, $itemIndex$$inline_1835_legendOptions$$inline_1826_subId$$4$$.indexOf("]")), $itemIndex$$inline_1835_legendOptions$$inline_1826_subId$$4$$ = this.$_legend$.$getOptions$(), $itemIndex$$inline_1835_legendOptions$$inline_1826_subId$$4$$ = "section" + (0,D.$JSCompiler_StaticMethods_getIndicesFromSeries$$)(this.$_legendAutomation$, 
      this.$_options$.series[$openParen1_seriesIndex$$2_seriesIndex$$inline_1825_tooltipElem$$], $itemIndex$$inline_1835_legendOptions$$inline_1826_subId$$4$$), this.$_legendAutomation$.$getDomElementForSubId$($itemIndex$$inline_1835_legendOptions$$inline_1826_subId$$4$$)
    }
    if("legend" == $itemIndex$$inline_1835_legendOptions$$inline_1826_subId$$4$$.substring(0, $axisObjectType_colon_item$$inline_1839_refObjPeers$$inline_9764$$)) {
      return $itemIndex$$inline_1835_legendOptions$$inline_1826_subId$$4$$ = $itemIndex$$inline_1835_legendOptions$$inline_1826_subId$$4$$.substring($axisObjectType_colon_item$$inline_1839_refObjPeers$$inline_9764$$ + 1), this.$_legendAutomation$.$getDomElementForSubId$($itemIndex$$inline_1835_legendOptions$$inline_1826_subId$$4$$)
    }
    $openParen1_seriesIndex$$2_seriesIndex$$inline_1825_tooltipElem$$ = $itemIndex$$inline_1835_legendOptions$$inline_1826_subId$$4$$.substring($openParen1_seriesIndex$$2_seriesIndex$$inline_1825_tooltipElem$$ + 1, $closeParen1_peers$$inline_1836$$);
    if("xAxis" == $index$$inline_1829_logicalObj$$3_objType_openParen2_pieSlice_series$$inline_1838$$ || "yAxis" == $index$$inline_1829_logicalObj$$3_objType_openParen2_pieSlice_series$$inline_1838$$ || "y2Axis" == $index$$inline_1829_logicalObj$$3_objType_openParen2_pieSlice_series$$inline_1838$$) {
      if($axisObjectType_colon_item$$inline_1839_refObjPeers$$inline_9764$$ = $itemIndex$$inline_1835_legendOptions$$inline_1826_subId$$4$$.substring($axisObjectType_colon_item$$inline_1839_refObjPeers$$inline_9764$$ + 1), "title" == $axisObjectType_colon_item$$inline_1839_refObjPeers$$inline_9764$$) {
        if("xAxis" == $index$$inline_1829_logicalObj$$3_objType_openParen2_pieSlice_series$$inline_1838$$) {
          return this.$_xAxisAutomation$.$getDomElementForSubId$($axisObjectType_colon_item$$inline_1839_refObjPeers$$inline_9764$$)
        }
        if("yAxis" == $index$$inline_1829_logicalObj$$3_objType_openParen2_pieSlice_series$$inline_1838$$) {
          return this.$_yAxisAutomation$.$getDomElementForSubId$($axisObjectType_colon_item$$inline_1839_refObjPeers$$inline_9764$$)
        }
        if("y2Axis" == $index$$inline_1829_logicalObj$$3_objType_openParen2_pieSlice_series$$inline_1838$$) {
          return this.$_y2AxisAutomation$.$getDomElementForSubId$($axisObjectType_colon_item$$inline_1839_refObjPeers$$inline_9764$$)
        }
      }else {
        if($index$$inline_1829_logicalObj$$3_objType_openParen2_pieSlice_series$$inline_1838$$ = $axisObjectType_colon_item$$inline_1839_refObjPeers$$inline_9764$$.indexOf("["), $JSCompiler_StaticMethods_getRefObjPeers$self$$inline_9763_closeParen2_i$$inline_1831$$ = $axisObjectType_colon_item$$inline_1839_refObjPeers$$inline_9764$$.indexOf("]"), "referenceObject" == $axisObjectType_colon_item$$inline_1839_refObjPeers$$inline_9764$$.substring(0, $index$$inline_1829_logicalObj$$3_objType_openParen2_pieSlice_series$$inline_1838$$)) {
          a: {
            $index$$inline_1829_logicalObj$$3_objType_openParen2_pieSlice_series$$inline_1838$$ = $axisObjectType_colon_item$$inline_1839_refObjPeers$$inline_9764$$.substring($index$$inline_1829_logicalObj$$3_objType_openParen2_pieSlice_series$$inline_1838$$ + 1, $JSCompiler_StaticMethods_getRefObjPeers$self$$inline_9763_closeParen2_i$$inline_1831$$);
            $JSCompiler_StaticMethods_getRefObjPeers$self$$inline_9763_closeParen2_i$$inline_1831$$ = this.$_chart$;
            for(var $axisObjectType_colon_item$$inline_1839_refObjPeers$$inline_9764$$ = [], $i$$inline_9765$$ = 0;$i$$inline_9765$$ < $JSCompiler_StaticMethods_getRefObjPeers$self$$inline_9763_closeParen2_i$$inline_1831$$.$Peers$.length;$i$$inline_9765$$++) {
              $JSCompiler_StaticMethods_getRefObjPeers$self$$inline_9763_closeParen2_i$$inline_1831$$.$Peers$[$i$$inline_9765$$] instanceof D.$DvtRefObjPeer$$ && $axisObjectType_colon_item$$inline_1839_refObjPeers$$inline_9764$$.push($JSCompiler_StaticMethods_getRefObjPeers$self$$inline_9763_closeParen2_i$$inline_1831$$.$Peers$[$i$$inline_9765$$])
            }
            for($JSCompiler_StaticMethods_getRefObjPeers$self$$inline_9763_closeParen2_i$$inline_1831$$ = 0;$JSCompiler_StaticMethods_getRefObjPeers$self$$inline_9763_closeParen2_i$$inline_1831$$ < $axisObjectType_colon_item$$inline_1839_refObjPeers$$inline_9764$$.length;$JSCompiler_StaticMethods_getRefObjPeers$self$$inline_9763_closeParen2_i$$inline_1831$$++) {
              if($index$$inline_1829_logicalObj$$3_objType_openParen2_pieSlice_series$$inline_1838$$ == $axisObjectType_colon_item$$inline_1839_refObjPeers$$inline_9764$$[$JSCompiler_StaticMethods_getRefObjPeers$self$$inline_9763_closeParen2_i$$inline_1831$$].$getIndex$()) {
                $index$$inline_1829_logicalObj$$3_objType_openParen2_pieSlice_series$$inline_1838$$ = $axisObjectType_colon_item$$inline_1839_refObjPeers$$inline_9764$$[$JSCompiler_StaticMethods_getRefObjPeers$self$$inline_9763_closeParen2_i$$inline_1831$$];
                break a
              }
            }
            $index$$inline_1829_logicalObj$$3_objType_openParen2_pieSlice_series$$inline_1838$$ = D.$JSCompiler_alias_NULL$$
          }
          if($index$$inline_1829_logicalObj$$3_objType_openParen2_pieSlice_series$$inline_1838$$) {
            return $index$$inline_1829_logicalObj$$3_objType_openParen2_pieSlice_series$$inline_1838$$.$getDisplayables$()[0].$getElem$()
          }
        }
      }
    }
    if("pie" == this.$_options$.type && ($index$$inline_1829_logicalObj$$3_objType_openParen2_pieSlice_series$$inline_1838$$ = 0 <= $openParen1_seriesIndex$$2_seriesIndex$$inline_1825_tooltipElem$$ && $openParen1_seriesIndex$$2_seriesIndex$$inline_1825_tooltipElem$$ < this.$_chart$.$pieChart$.$_slices$.length ? (0,D.$JSCompiler_StaticMethods_getTopDisplayable$$)(this.$_chart$.$pieChart$.$_slices$[$openParen1_seriesIndex$$2_seriesIndex$$inline_1825_tooltipElem$$]) : D.$JSCompiler_alias_NULL$$)) {
      return $index$$inline_1829_logicalObj$$3_objType_openParen2_pieSlice_series$$inline_1838$$.$getElem$()
    }
    if("funnel" == this.$_options$.type) {
      var $i$$inline_1837_itemIndex$$1$$ = D.$DvtFunnelRenderer$$.$_GROUP_INDEX$
    }else {
      $itemIndex$$inline_1835_legendOptions$$inline_1826_subId$$4$$ = $itemIndex$$inline_1835_legendOptions$$inline_1826_subId$$4$$.substring($closeParen1_peers$$inline_1836$$ + 1), $index$$inline_1829_logicalObj$$3_objType_openParen2_pieSlice_series$$inline_1838$$ = $itemIndex$$inline_1835_legendOptions$$inline_1826_subId$$4$$.indexOf("["), $JSCompiler_StaticMethods_getRefObjPeers$self$$inline_9763_closeParen2_i$$inline_1831$$ = $itemIndex$$inline_1835_legendOptions$$inline_1826_subId$$4$$.indexOf("]"), 
      0 <= $index$$inline_1829_logicalObj$$3_objType_openParen2_pieSlice_series$$inline_1838$$ && 0 <= $JSCompiler_StaticMethods_getRefObjPeers$self$$inline_9763_closeParen2_i$$inline_1831$$ && ($i$$inline_1837_itemIndex$$1$$ = $itemIndex$$inline_1835_legendOptions$$inline_1826_subId$$4$$.substring($index$$inline_1829_logicalObj$$3_objType_openParen2_pieSlice_series$$inline_1838$$ + 1, $JSCompiler_StaticMethods_getRefObjPeers$self$$inline_9763_closeParen2_i$$inline_1831$$))
    }
    a: {
      $itemIndex$$inline_1835_legendOptions$$inline_1826_subId$$4$$ = $i$$inline_1837_itemIndex$$1$$;
      $closeParen1_peers$$inline_1836$$ = (0,D.$JSCompiler_StaticMethods_getChartObjPeers$$)(this.$_chart$);
      for($i$$inline_1837_itemIndex$$1$$ = 0;$i$$inline_1837_itemIndex$$1$$ < $closeParen1_peers$$inline_1836$$.length;$i$$inline_1837_itemIndex$$1$$++) {
        if($index$$inline_1829_logicalObj$$3_objType_openParen2_pieSlice_series$$inline_1838$$ = $closeParen1_peers$$inline_1836$$[$i$$inline_1837_itemIndex$$1$$].$getSeriesIndex$(), $axisObjectType_colon_item$$inline_1839_refObjPeers$$inline_9764$$ = $closeParen1_peers$$inline_1836$$[$i$$inline_1837_itemIndex$$1$$].$getGroupIndex$(), $index$$inline_1829_logicalObj$$3_objType_openParen2_pieSlice_series$$inline_1838$$ == $openParen1_seriesIndex$$2_seriesIndex$$inline_1825_tooltipElem$$ && $axisObjectType_colon_item$$inline_1839_refObjPeers$$inline_9764$$ == 
        $itemIndex$$inline_1835_legendOptions$$inline_1826_subId$$4$$) {
          $index$$inline_1829_logicalObj$$3_objType_openParen2_pieSlice_series$$inline_1838$$ = $closeParen1_peers$$inline_1836$$[$i$$inline_1837_itemIndex$$1$$];
          break a
        }
      }
      $index$$inline_1829_logicalObj$$3_objType_openParen2_pieSlice_series$$inline_1838$$ = D.$JSCompiler_alias_NULL$$
...
D.$DvtChartAutomation$$.prototype.$_getAxis$ = function $$DvtChartAutomation$$$$$_getAxis$$($type$$63$$) {
  var $axis$$62$$ = "x" == $type$$63$$ ? this.$_xAxis$ : "y" == $type$$63$$ ? this.$_yAxis$ : this.$_y2Axis$;
  if($axis$$62$$) {
    var $axisSpace$$ = $axis$$62$$.$_bounds$, $stageCoord$$ = (0,D.$JSCompiler_StaticMethods_localToStage$$)($axis$$62$$, new D.$DvtPoint$$($axisSpace$$.x, $axisSpace$$.y)), $chart$$ = this.$_chart$;
    return{bounds:{x:$stageCoord$$.x, y:$stageCoord$$.y, width:$axisSpace$$.$w$, height:$axisSpace$$.$h$}, title:this.$_options$[$type$$63$$ + "Axis"].title, getPreferredSize:function($axisSpace$$, $stageCoord$$) {
      var $axisOptions_prefSize$$ = $axis$$62$$.$getOptions$(), $position$$8$$ = $axisOptions_prefSize$$.position, $tickLabelGap$$ = D.$DvtChartAxisUtils$$.$getTickLabelGapSize$($chart$$, $type$$63$$), $outerGap$$ = D.$DvtChartTypeUtils$$.$isStandaloneXAxis$($chart$$) || D.$DvtChartTypeUtils$$.$isStandaloneYAxis$($chart$$) || D.$DvtChartTypeUtils$$.$isStandaloneY2Axis$($chart$$) ? 2 : 0;
      "top" == $position$$8$$ || "bottom" == $position$$8$$ ? ($axisOptions_prefSize$$ = $axis$$62$$.$getPreferredSize$($axisOptions_prefSize$$, $axisSpace$$, $stageCoord$$ - $tickLabelGap$$ - $outerGap$$), $axisOptions_prefSize$$.$h$ = window.Math.ceil($axisOptions_prefSize$$.$h$ + $tickLabelGap$$ + $outerGap$$)) : ($axisOptions_prefSize$$ = $axis$$62$$.$getPreferredSize$($axisOptions_prefSize$$, $axisSpace$$ - $tickLabelGap$$ - $outerGap$$, $stageCoord$$), $axisOptions_prefSize$$.$w$ = window.Math.ceil($axisOptions_prefSize$$.$w$ + 
...
D.$DvtChartEventManager$getUIEventParams$$ = function $$DvtChartEventManager$getUIEventParams$$$($type$$64$$, $id$$26$$, $series$$5$$) {
  return{type:$type$$64$$, id:$id$$26$$, series:$series$$5$$, group:D.$JSCompiler_alias_VOID$$}
};
...
D.$JSCompiler_prototypeAlias$$.$getLogicalObject$ = function $$JSCompiler_prototypeAlias$$$$getLogicalObject$$($target$$55$$) {
  return this.$GetLogicalObject$($target$$55$$, D.$JSCompiler_alias_TRUE$$)
};
...
D.$JSCompiler_prototypeAlias$$ = D.$DvtChartEventManager$$.prototype;
D.$JSCompiler_prototypeAlias$$.$_onDragStart$ = function $$JSCompiler_prototypeAlias$$$$_onDragStart$$($event$$114$$) {
  return(0,D.$DvtAgent$isTouchDevice$$)() ? this.$_onTouchDragStart$($event$$114$$) : this.$_onMouseDragStart$($event$$114$$)
};
D.$JSCompiler_prototypeAlias$$.$_onDragMove$ = function $$JSCompiler_prototypeAlias$$$$_onDragMove$$($event$$115$$) {
  return(0,D.$DvtAgent$isTouchDevice$$)() ? this.$_onTouchDragMove$($event$$115$$) : this.$_onMouseDragMove$($event$$115$$)
};
D.$JSCompiler_prototypeAlias$$.$_onDragEnd$ = function $$JSCompiler_prototypeAlias$$$$_onDragEnd$$($event$$116$$) {
  return(0,D.$DvtAgent$isTouchDevice$$)() ? this.$_onTouchDragEnd$($event$$116$$) : this.$_onMouseDragEnd$($event$$116$$)
};
D.$JSCompiler_prototypeAlias$$.$_onMouseDragStart$ = function $$JSCompiler_prototypeAlias$$$$_onMouseDragStart$$($event$$117$$) {
  var $relPos$$1$$ = this.$_getRelativePosition$($event$$117$$.pageX, $event$$117$$.pageY), $dragHandler$$ = (0,D.$JSCompiler_StaticMethods__getDragHandler$$)(this, $relPos$$1$$), $chartEvent$$, $obj$$51$$ = this.$GetLogicalObject$((0,D.$JSCompiler_StaticMethods_GetCurrentTargetForEvent$$)($event$$117$$));
  if((!$obj$$51$$ || !$obj$$51$$.$isSelectable$ || !$obj$$51$$.$isSelectable$()) && 0 == $event$$117$$.button && $dragHandler$$) {
    ($chartEvent$$ = $dragHandler$$.$processDragStart$($relPos$$1$$, $event$$117$$.ctrlKey)) && this.$_callback$.call(this.$_callbackObj$, $chartEvent$$), this.$_chart$.setCursor($dragHandler$$.getCursor($relPos$$1$$)), (0,D.$JSCompiler_StaticMethods_setDragButtonsVisible$$)(this, D.$JSCompiler_alias_FALSE$$), this.$_chart$ != (this.$getCtx$().$_keyboardFocusArray$.length <= this.$getCtx$().$_keyboardFocusIndex$ ? D.$JSCompiler_alias_NULL$$ : this.$getCtx$().$_keyboardFocusArray$[this.$getCtx$().$_keyboardFocusIndex$]) && 
...
D.$JSCompiler_prototypeAlias$$.$_onMouseDragMove$ = function $$JSCompiler_prototypeAlias$$$$_onMouseDragMove$$($event$$118$$) {
  var $relPos$$2$$ = this.$_getRelativePosition$($event$$118$$.pageX, $event$$118$$.pageY), $dragHandler$$1$$ = (0,D.$JSCompiler_StaticMethods__getDragHandler$$)(this), $chartEvent$$1$$;
  if($dragHandler$$1$$ && ($chartEvent$$1$$ = $dragHandler$$1$$.$processDragMove$($relPos$$2$$, $event$$118$$.ctrlKey))) {
  ...
  $chartEvent$$1$$ && $event$$118$$.stopPropagation()
};
D.$JSCompiler_prototypeAlias$$.$_onMouseDragEnd$ = function $$JSCompiler_prototypeAlias$$$$_onMouseDragEnd$$($chartEvent$$2_event$$119$$) {
  var $relPos$$3$$ = this.$_getRelativePosition$($chartEvent$$2_event$$119$$.pageX, $chartEvent$$2_event$$119$$.pageY), $axisSpace$$1_dragHandler$$2$$ = (0,D.$JSCompiler_StaticMethods__getDragHandler$$)(this);
  if($axisSpace$$1_dragHandler$$2$$) {
    if($chartEvent$$2_event$$119$$ = $axisSpace$$1_dragHandler$$2$$.$processDragEnd$($relPos$$3$$, $chartEvent$$2_event$$119$$.ctrlKey)) {
      this.$_callback$.call(this.$_callbackObj$, $chartEvent$$2_event$$119$$), (0,D.$JSCompiler_StaticMethods_autoToggleZoomButton$$)(this)
    }
...
D.$JSCompiler_prototypeAlias$$.$OnMouseMove$ = function $$JSCompiler_prototypeAlias$$$$OnMouseMove$$($dragHandler$$3_event$$120$$) {
  D.$DvtChartEventManager$$.$superclass$.$OnMouseMove$.call(this, $dragHandler$$3_event$$120$$);
  var $relPos$$4$$ = this.$_getRelativePosition$($dragHandler$$3_event$$120$$.pageX, $dragHandler$$3_event$$120$$.pageY);
  this.$_dataCursorHandler$ && ((0,D.$JSCompiler_StaticMethods_GetCurrentTargetForEvent$$)($dragHandler$$3_event$$120$$) instanceof D.$DvtButton$$ ? (0,D.$JSCompiler_StaticMethods__removeDataCursor$$)(this.$_dataCursorHandler$, D.$JSCompiler_alias_VOID$$) : (0,D.$JSCompiler_StaticMethods_processMove$$)(this.$_dataCursorHandler$, $relPos$$4$$));
  ($dragHandler$$3_event$$120$$ = (0,D.$JSCompiler_StaticMethods__getDragHandler$$)(this, $relPos$$4$$)) ? this.$_chart$.setCursor($dragHandler$$3_event$$120$$.getCursor($relPos$$4$$)) : this.$_chart$.setCursor("inherit")
};
D.$JSCompiler_prototypeAlias$$.$OnMouseOut$ = function $$JSCompiler_prototypeAlias$$$$OnMouseOut$$($event$$121$$) {
  D.$DvtChartEventManager$$.$superclass$.$OnMouseOut$.call(this, $event$$121$$);
  var $relPos$$5$$ = this.$_getRelativePosition$($event$$121$$.pageX, $event$$121$$.pageY), $JSCompiler_StaticMethods_processOut$self$$inline_1975_axisSpace$$2$$ = this.$_chart$.$_axisSpace$;
  $JSCompiler_StaticMethods_processOut$self$$inline_1975_axisSpace$$2$$ && (0,D.$JSCompiler_StaticMethods_setDragButtonsVisible$$)(this, (0,D.$JSCompiler_StaticMethods_containsPoint$$)($JSCompiler_StaticMethods_processOut$self$$inline_1975_axisSpace$$2$$, $relPos$$5$$.x, $relPos$$5$$.y));
  this.$_dataCursorHandler$ && ($JSCompiler_StaticMethods_processOut$self$$inline_1975_axisSpace$$2$$ = this.$_dataCursorHandler$, (0,D.$JSCompiler_StaticMethods_containsPoint$$)($JSCompiler_StaticMethods_processOut$self$$inline_1975_axisSpace$$2$$.$_chart$.$_plotAreaSpace$, $relPos$$5$$.x, $relPos$$5$$.y) || (0,D.$JSCompiler_StaticMethods__removeDataCursor$$)($JSCompiler_StaticMethods_processOut$self$$inline_1975_axisSpace$$2$$, D.$JSCompiler_alias_VOID$$));
  this.$_stageAbsolutePosition$ = D.$JSCompiler_alias_NULL$$;
  this.$GetLogicalObject$($event$$121$$.target)
};
D.$JSCompiler_prototypeAlias$$.$OnMouseWheel$ = function $$JSCompiler_prototypeAlias$$$$OnMouseWheel$$($event$$122$$) {
  if(D.$DvtChartEventUtils$$.$isZoomable$(this.$_chart$)) {
    var $delta$$3_deltaXMin$$inline_1983$$ = $event$$122$$.wheelDelta != D.$JSCompiler_alias_NULL$$ ? $event$$122$$.wheelDelta : 0, $relPos$$6$$ = this.$_getRelativePosition$($event$$122$$.pageX, $event$$122$$.pageY);
    if(this.$_panZoomHandler$) {
      var $JSCompiler_StaticMethods_processMouseWheel$self$$inline_1979_deltaYMax$$inline_1986_panZoomEvent$$;
      $JSCompiler_StaticMethods_processMouseWheel$self$$inline_1979_deltaYMax$$inline_1986_panZoomEvent$$ = this.$_panZoomHandler$;
      var $delta$$inline_1981$$ = $delta$$3_deltaXMin$$inline_1983$$, $startPt$$inline_1982$$ = $JSCompiler_StaticMethods_processMouseWheel$self$$inline_1979_deltaYMax$$inline_1986_panZoomEvent$$.$_container$.$stageToLocal$($relPos$$6$$);
      if((0,D.$JSCompiler_StaticMethods_containsPoint$$)($JSCompiler_StaticMethods_processMouseWheel$self$$inline_1979_deltaYMax$$inline_1986_panZoomEvent$$.$_bounds$, $startPt$$inline_1982$$.x, $startPt$$inline_1982$$.y)) {
        var $delta$$inline_1981$$ = $delta$$inline_1981$$ * $JSCompiler_StaticMethods_processMouseWheel$self$$inline_1979_deltaYMax$$inline_1986_panZoomEvent$$.$_zoomRate$, $delta$$3_deltaXMin$$inline_1983$$ = $delta$$inline_1981$$ * ($startPt$$inline_1982$$.x - $JSCompiler_StaticMethods_processMouseWheel$self$$inline_1979_deltaYMax$$inline_1986_panZoomEvent$$.$_bounds$.x), $deltaXMax$$inline_1984$$ = -$delta$$inline_1981$$ * ($JSCompiler_StaticMethods_processMouseWheel$self$$inline_1979_deltaYMax$$inline_1986_panZoomEvent$$.$_bounds$.x + 
        $JSCompiler_StaticMethods_processMouseWheel$self$$inline_1979_deltaYMax$$inline_1986_panZoomEvent$$.$_bounds$.$w$ - $startPt$$inline_1982$$.x), $deltaYMin$$inline_1985$$ = $delta$$inline_1981$$ * ($startPt$$inline_1982$$.y - $JSCompiler_StaticMethods_processMouseWheel$self$$inline_1979_deltaYMax$$inline_1986_panZoomEvent$$.$_bounds$.y);
        $JSCompiler_StaticMethods_processMouseWheel$self$$inline_1979_deltaYMax$$inline_1986_panZoomEvent$$ = -$delta$$inline_1981$$ * ($JSCompiler_StaticMethods_processMouseWheel$self$$inline_1979_deltaYMax$$inline_1986_panZoomEvent$$.$_bounds$.y + $JSCompiler_StaticMethods_processMouseWheel$self$$inline_1979_deltaYMax$$inline_1986_panZoomEvent$$.$_bounds$.$h$ - $startPt$$inline_1982$$.y);
        $JSCompiler_StaticMethods_processMouseWheel$self$$inline_1979_deltaYMax$$inline_1986_panZoomEvent$$ = new D.$DvtPanZoomEvent$$("dvtZoomEvent", $delta$$3_deltaXMin$$inline_1983$$, $deltaXMax$$inline_1984$$, $deltaYMin$$inline_1985$$, $JSCompiler_StaticMethods_processMouseWheel$self$$inline_1979_deltaYMax$$inline_1986_panZoomEvent$$, $delta$$3_deltaXMin$$inline_1983$$, $deltaXMax$$inline_1984$$, $deltaYMin$$inline_1985$$, $JSCompiler_StaticMethods_processMouseWheel$self$$inline_1979_deltaYMax$$inline_1986_panZoomEvent$$)
      }else {
        $JSCompiler_StaticMethods_processMouseWheel$self$$inline_1979_deltaYMax$$inline_1986_panZoomEvent$$ = D.$JSCompiler_alias_NULL$$
      }
      $JSCompiler_StaticMethods_processMouseWheel$self$$inline_1979_deltaYMax$$inline_1986_panZoomEvent$$ && ($event$$122$$.preventDefault(), $event$$122$$.stopPropagation(), this.$_callback$.call(this.$_callbackObj$, $JSCompiler_StaticMethods_processMouseWheel$self$$inline_1979_deltaYMax$$inline_1986_panZoomEvent$$), this.$_dataCursorHandler$ && (0,D.$JSCompiler_StaticMethods_processMove$$)(this.$_dataCursorHandler$, $relPos$$6$$))
    }
  }
};
D.$JSCompiler_prototypeAlias$$.$OnClickInternal$ = function $$JSCompiler_prototypeAlias$$$$OnClickInternal$$($event$$123_pos$$5$$) {
  var $obj$$53$$ = this.$GetLogicalObject$($event$$123_pos$$5$$.target);
  $event$$123_pos$$5$$ = this.$_getRelativePosition$($event$$123_pos$$5$$.pageX, $event$$123_pos$$5$$.pageY);
  this.$SeriesFocusHandler$ && this.$SeriesFocusHandler$.$processSeriesFocus$($event$$123_pos$$5$$, $obj$$53$$);
  $obj$$53$$ && (this.$_processActionEvent$($obj$$53$$), (!$obj$$53$$.$isSelectable$ || !$obj$$53$$.$isSelectable$()) && (0,D.$JSCompiler_StaticMethods__processDrillEvent$$)(this, $obj$$53$$))
};
D.$JSCompiler_prototypeAlias$$.$OnDblClick$ = function $$JSCompiler_prototypeAlias$$$$OnDblClick$$($event$$124_obj$$54$$) {
  D.$DvtChartEventManager$$.$superclass$.$OnDblClick$.call(this, $event$$124_obj$$54$$);
  ($event$$124_obj$$54$$ = this.$GetLogicalObject$($event$$124_obj$$54$$.target)) && $event$$124_obj$$54$$.$isSelectable$ && $event$$124_obj$$54$$.$isSelectable$() && (0,D.$JSCompiler_StaticMethods__processDrillEvent$$)(this, $event$$124_obj$$54$$)
};
D.$JSCompiler_prototypeAlias$$.$HandleTouchHoverStartInternal$ = function $$JSCompiler_prototypeAlias$$$$HandleTouchHoverStartInternal$$($event$$125$$) {
  var $dlo$$ = this.$GetLogicalObject$($event$$125$$.target);
  (0,D.$JSCompiler_StaticMethods_setTooltipEnabled$$)(this.$TouchManager$, $event$$125$$.$touch$.identifier, this.$getTooltipsEnabled$($dlo$$));
  return D.$JSCompiler_alias_FALSE$$
};
D.$JSCompiler_prototypeAlias$$.$HandleTouchHoverMoveInternal$ = function $$JSCompiler_prototypeAlias$$$$HandleTouchHoverMoveInternal$$($event$$126$$) {
  var $dlo$$1$$ = this.$GetLogicalObject$($event$$126$$.target);
  (0,D.$JSCompiler_StaticMethods_setTooltipEnabled$$)(this.$TouchManager$, $event$$126$$.$touch$.identifier, this.$getTooltipsEnabled$($dlo$$1$$));
  return D.$JSCompiler_alias_FALSE$$
};
D.$JSCompiler_prototypeAlias$$.$HandleTouchHoverEndInternal$ = function $$JSCompiler_prototypeAlias$$$$HandleTouchHoverEndInternal$$($event$$127_obj$$55$$) {
  if($event$$127_obj$$55$$ = this.$GetLogicalObject$($event$$127_obj$$55$$.target)) {
    this.$_processActionEvent$($event$$127_obj$$55$$), (!$event$$127_obj$$55$$.$isSelectable$ || !$event$$127_obj$$55$$.$isSelectable$()) && (0,D.$JSCompiler_StaticMethods__processDrillEvent$$)(this, $event$$127_obj$$55$$)
  }
};
D.$JSCompiler_prototypeAlias$$.$HandleTouchClickInternal$ = function $$JSCompiler_prototypeAlias$$$$HandleTouchClickInternal$$($event$$128_obj$$56$$) {
  if($event$$128_obj$$56$$ = this.$GetLogicalObject$($event$$128_obj$$56$$.target)) {
    this.$_processActionEvent$($event$$128_obj$$56$$), (!$event$$128_obj$$56$$.$isSelectable$ || !$event$$128_obj$$56$$.$isSelectable$()) && (0,D.$JSCompiler_StaticMethods__processDrillEvent$$)(this, $event$$128_obj$$56$$)
  }
};
D.$JSCompiler_prototypeAlias$$.$OnComponentTouchDblClick$ = function $$JSCompiler_prototypeAlias$$$$OnComponentTouchDblClick$$($event$$129_obj$$57$$) {
  D.$DvtChartEventManager$$.$superclass$.$OnComponentTouchDblClick$.call(this, $event$$129_obj$$57$$);
  ($event$$129_obj$$57$$ = this.$GetLogicalObject$($event$$129_obj$$57$$.target)) && $event$$129_obj$$57$$.$isSelectable$ && $event$$129_obj$$57$$.$isSelectable$() && (0,D.$JSCompiler_StaticMethods__processDrillEvent$$)(this, $event$$129_obj$$57$$)
};
...
D.$JSCompiler_StaticMethods__processDrillEvent$$ = function $$JSCompiler_StaticMethods__processDrillEvent$$$($JSCompiler_StaticMethods__processDrillEvent$self$$, $obj$$59$$) {
  if($obj$$59$$ && $obj$$59$$.$isDrillable$ && $obj$$59$$.$isDrillable$()) {
    var $id$$27$$ = $obj$$59$$.getId();
    $obj$$59$$ instanceof D.$DvtChartObjPeer$$ ? $JSCompiler_StaticMethods__processDrillEvent$self$$.$FireEvent$(new D.$DvtDrillEvent$$($id$$27$$.getId ? $id$$27$$.getId() : $id$$27$$, $obj$$59$$.$getSeries$(), $obj$$59$$.$getGroup$())) : $obj$$59$$ instanceof D.$DvtPieSlice$$ && $JSCompiler_StaticMethods__processDrillEvent$self$$.$FireEvent$(new D.$DvtDrillEvent$$($id$$27$$.getId(), $id$$27$$.$getSeries$(), $id$$27$$.$getGroup$()))
  }
};
D.$JSCompiler_prototypeAlias$$ = D.$DvtChartEventManager$$.prototype;
D.$JSCompiler_prototypeAlias$$.$ProcessRolloverEvent$ = function $$JSCompiler_prototypeAlias$$$$ProcessRolloverEvent$$($event$$130_options$$31$$, $categories$$1_hoverBehaviorDelay_obj$$60$$, $bOver_rolloverEvent$$) {
  $event$$130_options$$31$$ = this.$_chart$.$getOptions$();
  if("dim" == D.$DvtChartEventUtils$$.$getHoverBehavior$(this.$_chart$)) {
    ...
    $event$$130_options$$31$$.highlightedCategories = $bOver_rolloverEvent$$ ? $categories$$1_hoverBehaviorDelay_obj$$60$$.slice() : D.$JSCompiler_alias_NULL$$;
    $bOver_rolloverEvent$$ = new D.$DvtCategoryRolloverEvent$$($bOver_rolloverEvent$$ ? "categoryRollOver" : "categoryRollOut", $event$$130_options$$31$$.highlightedCategories);
    ...
    this.$RolloverHandler$.$processEvent$($bOver_rolloverEvent$$, $objs$$, $categories$$1_hoverBehaviorDelay_obj$$60$$, "any" == $event$$130_options$$31$$.highlightMatch)
  }
};
D.$JSCompiler_prototypeAlias$$.$_onTouchDragStart$ = function $$JSCompiler_prototypeAlias$$$$_onTouchDragStart$$($event$$131$$) {
  var $relPos$$7_relPos2_touches$$2$$ = $event$$131$$.touches, $chartEvent$$3_relPos1$$, $dataCursorOn$$;
  if(1 == $relPos$$7_relPos2_touches$$2$$.length) {
    var $relPos$$7_relPos2_touches$$2$$ = this.$_getRelativePosition$($relPos$$7_relPos2_touches$$2$$[0].pageX, $relPos$$7_relPos2_touches$$2$$[0].pageY), $JSCompiler_StaticMethods_processPinchStart$self$$inline_1988_dragHandler$$4$$ = (0,D.$JSCompiler_StaticMethods__getDragHandler$$)(this);
    $JSCompiler_StaticMethods_processPinchStart$self$$inline_1988_dragHandler$$4$$ ? $chartEvent$$3_relPos1$$ = $JSCompiler_StaticMethods_processPinchStart$self$$inline_1988_dragHandler$$4$$.$processDragStart$($relPos$$7_relPos2_touches$$2$$, D.$JSCompiler_alias_TRUE$$) : this.$_dataCursorHandler$ && ((0,D.$JSCompiler_StaticMethods_processMove$$)(this.$_dataCursorHandler$, $relPos$$7_relPos2_touches$$2$$), $dataCursorOn$$ = D.$JSCompiler_alias_TRUE$$)
  }else {
    2 == $relPos$$7_relPos2_touches$$2$$.length && (this.$_panZoomHandler$ && D.$DvtChartEventUtils$$.$isZoomable$(this.$_chart$)) && (this.$endDrag$(), $chartEvent$$3_relPos1$$ = this.$_getRelativePosition$($relPos$$7_relPos2_touches$$2$$[0].pageX, $relPos$$7_relPos2_touches$$2$$[0].pageY), $relPos$$7_relPos2_touches$$2$$ = this.$_getRelativePosition$($relPos$$7_relPos2_touches$$2$$[1].pageX, $relPos$$7_relPos2_touches$$2$$[1].pageY), $JSCompiler_StaticMethods_processPinchStart$self$$inline_1988_dragHandler$$4$$ = 
    this.$_panZoomHandler$, $JSCompiler_StaticMethods_processPinchStart$self$$inline_1988_dragHandler$$4$$.$_pinchOn$ ? $chartEvent$$3_relPos1$$ = D.$JSCompiler_alias_NULL$$ : ($JSCompiler_StaticMethods_processPinchStart$self$$inline_1988_dragHandler$$4$$.$_origPt1$ = $JSCompiler_StaticMethods_processPinchStart$self$$inline_1988_dragHandler$$4$$.$_container$.$stageToLocal$($chartEvent$$3_relPos1$$), $JSCompiler_StaticMethods_processPinchStart$self$$inline_1988_dragHandler$$4$$.$_origPt2$ = $JSCompiler_StaticMethods_processPinchStart$self$$inline_1988_dragHandler$$4$$.$_container$.$stageToLocal$($relPos$$7_relPos2_touches$$2$$), 
    $JSCompiler_StaticMethods_processPinchStart$self$$inline_1988_dragHandler$$4$$.$_lastPt1$ = $JSCompiler_StaticMethods_processPinchStart$self$$inline_1988_dragHandler$$4$$.$_origPt1$, $JSCompiler_StaticMethods_processPinchStart$self$$inline_1988_dragHandler$$4$$.$_lastPt2$ = $JSCompiler_StaticMethods_processPinchStart$self$$inline_1988_dragHandler$$4$$.$_origPt2$, !(0,D.$JSCompiler_StaticMethods_containsPoint$$)($JSCompiler_StaticMethods_processPinchStart$self$$inline_1988_dragHandler$$4$$.$_bounds$, 
    $JSCompiler_StaticMethods_processPinchStart$self$$inline_1988_dragHandler$$4$$.$_origPt1$.x, $JSCompiler_StaticMethods_processPinchStart$self$$inline_1988_dragHandler$$4$$.$_origPt1$.y) || !(0,D.$JSCompiler_StaticMethods_containsPoint$$)($JSCompiler_StaticMethods_processPinchStart$self$$inline_1988_dragHandler$$4$$.$_bounds$, $JSCompiler_StaticMethods_processPinchStart$self$$inline_1988_dragHandler$$4$$.$_origPt2$.x, $JSCompiler_StaticMethods_processPinchStart$self$$inline_1988_dragHandler$$4$$.$_origPt2$.y) ? 
    $chartEvent$$3_relPos1$$ = D.$JSCompiler_alias_NULL$$ : ($JSCompiler_StaticMethods_processPinchStart$self$$inline_1988_dragHandler$$4$$.$_pinchOn$ = D.$JSCompiler_alias_TRUE$$, $chartEvent$$3_relPos1$$ = new D.$DvtPanZoomEvent$$("dvtPinchStartEvent", 0, 0, 0, 0, 0, 0, 0, 0))))
  }
  ...
  return $chartEvent$$3_relPos1$$ || $dataCursorOn$$ ? ($event$$131$$.preventDefault(), $event$$131$$.stopPropagation(), (0,D.$JSCompiler_StaticMethods_setDragButtonsVisible$$)(this, D.$JSCompiler_alias_FALSE$$), D.$JSCompiler_alias_TRUE$$) : D.$JSCompiler_alias_FALSE$$
};
D.$JSCompiler_prototypeAlias$$.$_onTouchDragMove$ = function $$JSCompiler_prototypeAlias$$$$_onTouchDragMove$$($event$$132$$) {
  var $dragHandler$$5_newPt2$$inline_1996_relPos2$$1_touches$$3$$ = $event$$132$$.touches, $JSCompiler_StaticMethods_processPinchMove$self$$inline_1992_chartEvent$$4$$, $dataCursorOn$$1$$;
  if(1 == $dragHandler$$5_newPt2$$inline_1996_relPos2$$1_touches$$3$$.length) {
    var $newPt1$$inline_1995_relPos$$8_relPos1$$1$$ = this.$_getRelativePosition$($dragHandler$$5_newPt2$$inline_1996_relPos2$$1_touches$$3$$[0].pageX, $dragHandler$$5_newPt2$$inline_1996_relPos2$$1_touches$$3$$[0].pageY);
    ($dragHandler$$5_newPt2$$inline_1996_relPos2$$1_touches$$3$$ = (0,D.$JSCompiler_StaticMethods__getDragHandler$$)(this)) ? $JSCompiler_StaticMethods_processPinchMove$self$$inline_1992_chartEvent$$4$$ = $dragHandler$$5_newPt2$$inline_1996_relPos2$$1_touches$$3$$.$processDragMove$($newPt1$$inline_1995_relPos$$8_relPos1$$1$$, D.$JSCompiler_alias_TRUE$$) : this.$_dataCursorHandler$ && ((0,D.$JSCompiler_StaticMethods_processMove$$)(this.$_dataCursorHandler$, $newPt1$$inline_1995_relPos$$8_relPos1$$1$$), 
    $dataCursorOn$$1$$ = D.$JSCompiler_alias_TRUE$$)
  }else {
    if(2 == $dragHandler$$5_newPt2$$inline_1996_relPos2$$1_touches$$3$$.length && this.$_panZoomHandler$ && D.$DvtChartEventUtils$$.$isZoomable$(this.$_chart$)) {
      if($newPt1$$inline_1995_relPos$$8_relPos1$$1$$ = this.$_getRelativePosition$($dragHandler$$5_newPt2$$inline_1996_relPos2$$1_touches$$3$$[0].pageX, $dragHandler$$5_newPt2$$inline_1996_relPos2$$1_touches$$3$$[0].pageY), $dragHandler$$5_newPt2$$inline_1996_relPos2$$1_touches$$3$$ = this.$_getRelativePosition$($dragHandler$$5_newPt2$$inline_1996_relPos2$$1_touches$$3$$[1].pageX, $dragHandler$$5_newPt2$$inline_1996_relPos2$$1_touches$$3$$[1].pageY), $JSCompiler_StaticMethods_processPinchMove$self$$inline_1992_chartEvent$$4$$ = 
      this.$_panZoomHandler$, $JSCompiler_StaticMethods_processPinchMove$self$$inline_1992_chartEvent$$4$$.$_pinchOn$) {
        var $newPt1$$inline_1995_relPos$$8_relPos1$$1$$ = $JSCompiler_StaticMethods_processPinchMove$self$$inline_1992_chartEvent$$4$$.$_container$.$stageToLocal$($newPt1$$inline_1995_relPos$$8_relPos1$$1$$), $dragHandler$$5_newPt2$$inline_1996_relPos2$$1_touches$$3$$ = $JSCompiler_StaticMethods_processPinchMove$self$$inline_1992_chartEvent$$4$$.$_container$.$stageToLocal$($dragHandler$$5_newPt2$$inline_1996_relPos2$$1_touches$$3$$), $deltas$$inline_1997$$ = (0,D.$JSCompiler_StaticMethods__computePinchDeltas$$)($JSCompiler_StaticMethods_processPinchMove$self$$inline_1992_chartEvent$$4$$, 
        $newPt1$$inline_1995_relPos$$8_relPos1$$1$$, $dragHandler$$5_newPt2$$inline_1996_relPos2$$1_touches$$3$$, $JSCompiler_StaticMethods_processPinchMove$self$$inline_1992_chartEvent$$4$$.$_lastPt1$, $JSCompiler_StaticMethods_processPinchMove$self$$inline_1992_chartEvent$$4$$.$_lastPt2$), $totalDeltas$$inline_1998$$ = (0,D.$JSCompiler_StaticMethods__computePinchDeltas$$)($JSCompiler_StaticMethods_processPinchMove$self$$inline_1992_chartEvent$$4$$, $newPt1$$inline_1995_relPos$$8_relPos1$$1$$, $dragHandler$$5_newPt2$$inline_1996_relPos2$$1_touches$$3$$, 
        $JSCompiler_StaticMethods_processPinchMove$self$$inline_1992_chartEvent$$4$$.$_origPt1$, $JSCompiler_StaticMethods_processPinchMove$self$$inline_1992_chartEvent$$4$$.$_origPt2$);
        $JSCompiler_StaticMethods_processPinchMove$self$$inline_1992_chartEvent$$4$$.$_lastPt1$ = $newPt1$$inline_1995_relPos$$8_relPos1$$1$$;
        $JSCompiler_StaticMethods_processPinchMove$self$$inline_1992_chartEvent$$4$$.$_lastPt2$ = $dragHandler$$5_newPt2$$inline_1996_relPos2$$1_touches$$3$$;
        $JSCompiler_StaticMethods_processPinchMove$self$$inline_1992_chartEvent$$4$$ = new D.$DvtPanZoomEvent$$("dvtPinchMoveEvent", $deltas$$inline_1997$$.$dxMin$, $deltas$$inline_1997$$.$dxMax$, $deltas$$inline_1997$$.$dyMin$, $deltas$$inline_1997$$.$dyMax$, $totalDeltas$$inline_1998$$.$dxMin$, $totalDeltas$$inline_1998$$.$dxMax$, $totalDeltas$$inline_1998$$.$dyMin$, $totalDeltas$$inline_1998$$.$dyMax$)
      }else {
        $JSCompiler_StaticMethods_processPinchMove$self$$inline_1992_chartEvent$$4$$ = D.$JSCompiler_alias_NULL$$
      }
    }
  }
  ($JSCompiler_StaticMethods_processPinchMove$self$$inline_1992_chartEvent$$4$$ || $dataCursorOn$$1$$) && $event$$132$$.preventDefault();
  $JSCompiler_StaticMethods_processPinchMove$self$$inline_1992_chartEvent$$4$$ && (this.$_callback$.call(this.$_callbackObj$, $JSCompiler_StaticMethods_processPinchMove$self$$inline_1992_chartEvent$$4$$), this.$getCtx$().$getTooltipManager$().$hideTooltip$())
};
D.$JSCompiler_prototypeAlias$$.$_onTouchDragEnd$ = function $$JSCompiler_prototypeAlias$$$$_onTouchDragEnd$$($event$$133$$) {
  var $chartEvent1$$ = this.$endDrag$(), $JSCompiler_StaticMethods_processPinchEnd$self$$inline_2000_chartEvent2$$;
  if(this.$_panZoomHandler$ && D.$DvtChartEventUtils$$.$isZoomable$(this.$_chart$)) {
    $JSCompiler_StaticMethods_processPinchEnd$self$$inline_2000_chartEvent2$$ = this.$_panZoomHandler$;
    if($JSCompiler_StaticMethods_processPinchEnd$self$$inline_2000_chartEvent2$$.$_pinchOn$) {
      $JSCompiler_StaticMethods_processPinchEnd$self$$inline_2000_chartEvent2$$.$_pinchOn$ = D.$JSCompiler_alias_FALSE$$;
      var $totalDeltas$$inline_2001$$ = (0,D.$JSCompiler_StaticMethods__computePinchDeltas$$)($JSCompiler_StaticMethods_processPinchEnd$self$$inline_2000_chartEvent2$$, $JSCompiler_StaticMethods_processPinchEnd$self$$inline_2000_chartEvent2$$.$_lastPt1$, $JSCompiler_StaticMethods_processPinchEnd$self$$inline_2000_chartEvent2$$.$_lastPt2$, $JSCompiler_StaticMethods_processPinchEnd$self$$inline_2000_chartEvent2$$.$_origPt1$, $JSCompiler_StaticMethods_processPinchEnd$self$$inline_2000_chartEvent2$$.$_origPt2$);
      $JSCompiler_StaticMethods_processPinchEnd$self$$inline_2000_chartEvent2$$.$_lastPt1$ = D.$JSCompiler_alias_NULL$$;
      $JSCompiler_StaticMethods_processPinchEnd$self$$inline_2000_chartEvent2$$.$_lastPt2$ = D.$JSCompiler_alias_NULL$$;
      $JSCompiler_StaticMethods_processPinchEnd$self$$inline_2000_chartEvent2$$ = new D.$DvtPanZoomEvent$$("dvtPinchEndEvent", 0, 0, 0, 0, $totalDeltas$$inline_2001$$.$dxMin$, $totalDeltas$$inline_2001$$.$dxMax$, $totalDeltas$$inline_2001$$.$dyMin$, $totalDeltas$$inline_2001$$.$dyMax$)
    }else {
      $JSCompiler_StaticMethods_processPinchEnd$self$$inline_2000_chartEvent2$$ = D.$JSCompiler_alias_NULL$$
    }
    $JSCompiler_StaticMethods_processPinchEnd$self$$inline_2000_chartEvent2$$ && this.$_callback$.call(this.$_callbackObj$, $JSCompiler_StaticMethods_processPinchEnd$self$$inline_2000_chartEvent2$$)
  }
  if($chartEvent1$$ || $JSCompiler_StaticMethods_processPinchEnd$self$$inline_2000_chartEvent2$$) {
    $event$$133$$.preventDefault(), this.$getCtx$().$getTooltipManager$().$hideTooltip$()
  }
  this.$_stageAbsolutePosition$ = D.$JSCompiler_alias_NULL$$;
...
D.$DvtChartEventManager$$.prototype.$cancelMarquee$ = function $$DvtChartEventManager$$$$$cancelMarquee$$($event$$134$$) {
  "zoom" == this.$_dragMode$ ? this.$_marqueeZoomHandler$.$cancelMarquee$() && $event$$134$$.preventDefault() : "select" == this.$_dragMode$ && this.$_marqueeSelectHandler$ && this.$_marqueeSelectHandler$.$cancelMarquee$() && this.$_chart$.$render$()
};
...
D.$JSCompiler_StaticMethods_setDragButtonsVisible$$ = function $$JSCompiler_StaticMethods_setDragButtonsVisible$$$($JSCompiler_StaticMethods_setDragButtonsVisible$self$$, $visible$$3$$) {
  if($visible$$3$$ && !$JSCompiler_StaticMethods_setDragButtonsVisible$self$$.$_dragButtonsVisible$) {
    var $JSCompiler_StaticMethods_hideDragButtons$self$$inline_2011_JSCompiler_StaticMethods_showDragButtons$self$$inline_2009$$ = $JSCompiler_StaticMethods_setDragButtonsVisible$self$$.$_chart$;
    $JSCompiler_StaticMethods_hideDragButtons$self$$inline_2011_JSCompiler_StaticMethods_showDragButtons$self$$inline_2009$$.$dragButtons$ && $JSCompiler_StaticMethods_hideDragButtons$self$$inline_2011_JSCompiler_StaticMethods_showDragButtons$self$$inline_2009$$.$dragButtons$.$setVisible$(D.$JSCompiler_alias_TRUE$$);
    $JSCompiler_StaticMethods_setDragButtonsVisible$self$$.$_dragButtonsVisible$ = D.$JSCompiler_alias_TRUE$$
  }else {
    !$visible$$3$$ && $JSCompiler_StaticMethods_setDragButtonsVisible$self$$.$_dragButtonsVisible$ && ($JSCompiler_StaticMethods_hideDragButtons$self$$inline_2011_JSCompiler_StaticMethods_showDragButtons$self$$inline_2009$$ = $JSCompiler_StaticMethods_setDragButtonsVisible$self$$.$_chart$, $JSCompiler_StaticMethods_hideDragButtons$self$$inline_2011_JSCompiler_StaticMethods_showDragButtons$self$$inline_2009$$.$dragButtons$ && $JSCompiler_StaticMethods_hideDragButtons$self$$inline_2011_JSCompiler_StaticMethods_showDragButtons$self$$inline_2009$$.$dragButtons$.$setVisible$(D.$JSCompiler_alias_FALSE$$), 
...
D.$JSCompiler_prototypeAlias$$.$isSelectionEvent$ = function $$JSCompiler_prototypeAlias$$$$isSelectionEvent$$($event$$138$$) {
  return this.$isNavigationEvent$($event$$138$$) && !$event$$138$$.ctrlKey
};
D.$JSCompiler_prototypeAlias$$.$isMultiSelectEvent$ = function $$JSCompiler_prototypeAlias$$$$isMultiSelectEvent$$($event$$139$$) {
  return 32 == $event$$139$$.keyCode && $event$$139$$.ctrlKey
};
D.$JSCompiler_prototypeAlias$$.$processKeyDown$ = function $$JSCompiler_prototypeAlias$$$$processKeyDown$$($event$$140$$) {
  var $currentNavigable_keyCode$$10_navigables$$1$$ = $event$$140$$.keyCode;
  if(9 == $currentNavigable_keyCode$$10_navigables$$1$$) {
    if($currentNavigable_keyCode$$10_navigables$$1$$ = this.$_eventManager$.$getFocus$()) {
      return(0,D.$DvtEventManager$consumeEvent$$)($event$$140$$), $currentNavigable_keyCode$$10_navigables$$1$$
    }
    $currentNavigable_keyCode$$10_navigables$$1$$ = D.$DvtChartEventUtils$$.$getKeyboardNavigables$(this.$_chart$);
    if(0 < $currentNavigable_keyCode$$10_navigables$$1$$.length) {
      return(0,D.$DvtEventManager$consumeEvent$$)($event$$140$$), this.$getDefaultNavigable$($currentNavigable_keyCode$$10_navigables$$1$$)
    }
  }else {
    27 == $currentNavigable_keyCode$$10_navigables$$1$$ ? this.$_eventManager$.$cancelMarquee$($event$$140$$) : 33 == $currentNavigable_keyCode$$10_navigables$$1$$ ? ($event$$140$$.ctrlKey || $event$$140$$.shiftKey || D.$DvtChartTypeUtils$$.$isBLAC$(this.$_chart$) ? this.$_eventManager$.$panBy$(-0.25, 0) : this.$_eventManager$.$panBy$(0, -0.25), (0,D.$DvtEventManager$consumeEvent$$)($event$$140$$)) : 34 == $currentNavigable_keyCode$$10_navigables$$1$$ ? ($event$$140$$.ctrlKey || $event$$140$$.shiftKey || 
    D.$DvtChartTypeUtils$$.$isBLAC$(this.$_chart$) ? this.$_eventManager$.$panBy$(0.25, 0) : this.$_eventManager$.$panBy$(0, 0.25), (0,D.$DvtEventManager$consumeEvent$$)($event$$140$$)) : (0,D.$DvtKeyboardEvent$isEquals$$)($event$$140$$) || (0,D.$DvtKeyboardEvent$isPlus$$)($event$$140$$) ? this.$_eventManager$.$zoomBy$(1.5) : ((0,D.$DvtKeyboardEvent$isMinus$$)($event$$140$$) || (0,D.$DvtKeyboardEvent$isUnderscore$$)($event$$140$$)) && this.$_eventManager$.$zoomBy$(1 / 1.5)
  }
  return D.$DvtChartKeyboardHandler$$.$superclass$.$processKeyDown$.call(this, $event$$140$$)
};
D.$JSCompiler_prototypeAlias$$.$getDefaultNavigable$ = function $$JSCompiler_prototypeAlias$$$$getDefaultNavigable$$($navigableItems$$) {
  ...
  for(var $isPie$$ = D.$DvtChartTypeUtils$$.$isPie$(this.$_chart$), $defaultNavigable$$, $defaultSeries$$, $defaultGroup$$, $navigable$$, $i$$132$$ = 0;$i$$132$$ < $navigableItems$$.length;$i$$132$$++) {
    $navigable$$ = $navigableItems$$[$i$$132$$], !$defaultNavigable$$ || $navigable$$.$getSeriesIndex$() < $defaultSeries$$ ? ($defaultNavigable$$ = $navigable$$, $defaultSeries$$ = $navigable$$.$getSeriesIndex$(), $isPie$$ || ($defaultGroup$$ = $navigable$$.$getGroupIndex$())) : !$isPie$$ && $navigable$$.$getGroupIndex$() < $defaultGroup$$ && ($defaultNavigable$$ = $navigable$$, $defaultSeries$$ = $navigable$$.$getSeriesIndex$(), $defaultGroup$$ = $navigable$$.$getGroupIndex$())
  }
...
D.$DvtChartObjPeer$$.prototype.Init = function $$DvtChartObjPeer$$$$Init$($chart$$9_i$$133_index$$128$$, $displayables$$1$$, $displayable$$5_seriesIndex$$8$$, $groupIndex$$4$$, $dataItem$$2_dataPos$$1_seriesItem$$) {
  this.$_chart$ = $chart$$9_i$$133_index$$128$$;
  ...
  0 <= $displayable$$5_seriesIndex$$8$$ && (this.$_series$ = D.$DvtChartDataUtils$$.$getSeries$($chart$$9_i$$133_index$$128$$, $displayable$$5_seriesIndex$$8$$));
  0 <= $groupIndex$$4$$ && (this.$_group$ = D.$DvtChartDataUtils$$.$getGroup$($chart$$9_i$$133_index$$128$$, $groupIndex$$4$$));
  if($dataItem$$2_dataPos$$1_seriesItem$$ = D.$DvtChartDataUtils$$.$getSeriesItem$($chart$$9_i$$133_index$$128$$, $displayable$$5_seriesIndex$$8$$)) {
    this.$_action$ = $dataItem$$2_dataPos$$1_seriesItem$$.action, this.$_drillable$ = D.$DvtChartEventUtils$$.$isSeriesDrillable$($chart$$9_i$$133_index$$128$$, $displayable$$5_seriesIndex$$8$$), this.$_stampId$ = $dataItem$$2_dataPos$$1_seriesItem$$._id
  }
  ...
  if($dataItem$$2_dataPos$$1_seriesItem$$ = D.$DvtChartDataUtils$$.$getDataItem$($chart$$9_i$$133_index$$128$$, $displayable$$5_seriesIndex$$8$$, $groupIndex$$4$$)) {
    $dataItem$$2_dataPos$$1_seriesItem$$.categories && (this.$_categories$ = this.$_categories$.concat($dataItem$$2_dataPos$$1_seriesItem$$.categories)), this.$_dataItemId$ = $dataItem$$2_dataPos$$1_seriesItem$$.id, this.$_action$ = $dataItem$$2_dataPos$$1_seriesItem$$.action, this.$_drillable$ = D.$DvtChartEventUtils$$.$isDataItemDrillable$($chart$$9_i$$133_index$$128$$, $displayable$$5_seriesIndex$$8$$, $groupIndex$$4$$), this.$_stampId$ = $dataItem$$2_dataPos$$1_seriesItem$$._id
  }
  if(this.$_action$ || this.$_drillable$) {
    for($chart$$9_i$$133_index$$128$$ = 0;$chart$$9_i$$133_index$$128$$ < this.$_displayables$.length;$chart$$9_i$$133_index$$128$$++) {
      this.$_displayables$[$chart$$9_i$$133_index$$128$$].setCursor("pointer")
    }
  }
  for($chart$$9_i$$133_index$$128$$ = 0;$chart$$9_i$$133_index$$128$$ < $displayables$$1$$.length;$chart$$9_i$$133_index$$128$$++) {
    $displayable$$5_seriesIndex$$8$$ = $displayables$$1$$[$chart$$9_i$$133_index$$128$$], $displayable$$5_seriesIndex$$8$$ instanceof D.$DvtChartLineArea$$ || $displayable$$5_seriesIndex$$8$$.$setAriaRole$("img"), this.$_updateAriaLabel$($displayables$$1$$[$chart$$9_i$$133_index$$128$$])
  }
};
...
D.$JSCompiler_prototypeAlias$$.$getAriaLabel$ = function $$JSCompiler_prototypeAlias$$$$getAriaLabel$$() {
  var $states$$ = [];
  this.$isSelectable$() && $states$$.push((0,D.$DvtBundle$getTranslation$$)(this.$_chart$.$getOptions$(), this.$isSelected$() ? "stateSelected" : "stateUnselected", "DvtUtilBundle", this.$isSelected$() ? "STATE_SELECTED" : "STATE_UNSELECTED"));
  var $shortDesc$$1$$ = D.$DvtChartTooltipUtils$$.$getDatatip$(this.$_chart$, this.$_seriesIndex$, this.$_groupIndex$, D.$JSCompiler_alias_FALSE$$);
  return(0,D.$DvtDisplayable$generateAriaLabel$$)($shortDesc$$1$$, $states$$)
};
...
D.$JSCompiler_prototypeAlias$$.$getNextNavigable$ = function $$JSCompiler_prototypeAlias$$$$getNextNavigable$$($chart$$inline_2016_event$$141$$) {
  var $chart$$11_keyCode$$11_seriesIndex$$inline_2018$$, $next_nextGroupIndex$$inline_2022_nextObj$$inline_2029$$;
  $chart$$11_keyCode$$11_seriesIndex$$inline_2018$$ = $chart$$inline_2016_event$$141$$.keyCode;
  if($chart$$inline_2016_event$$141$$.type == D.$DvtMouseEvent$CLICK$$ || 32 == $chart$$11_keyCode$$11_seriesIndex$$inline_2018$$ && $chart$$inline_2016_event$$141$$.ctrlKey) {
    return this
  }
  $chart$$11_keyCode$$11_seriesIndex$$inline_2018$$ = this.$_chart$;
  for(var $chartObjs_groupIndex$$inline_2019$$ = (0,D.$JSCompiler_StaticMethods_getChartObjPeers$$)($chart$$11_keyCode$$11_seriesIndex$$inline_2018$$), $currentValue$$inline_9777_keyCode$$inline_2015_navigables$$2_nextValue$$inline_9788$$ = [], $groupCount$$inline_2020_i$$137_nextSeriesIndex$$inline_9789_nextValue$$inline_9778$$ = 0;$groupCount$$inline_2020_i$$137_nextSeriesIndex$$inline_9789_nextValue$$inline_9778$$ < $chartObjs_groupIndex$$inline_2019$$.length;$groupCount$$inline_2020_i$$137_nextSeriesIndex$$inline_9789_nextValue$$inline_9778$$++) {
    $chartObjs_groupIndex$$inline_2019$$[$groupCount$$inline_2020_i$$137_nextSeriesIndex$$inline_9789_nextValue$$inline_9778$$].$isNavigable$() && $currentValue$$inline_9777_keyCode$$inline_2015_navigables$$2_nextValue$$inline_9788$$.push($chartObjs_groupIndex$$inline_2019$$[$groupCount$$inline_2020_i$$137_nextSeriesIndex$$inline_9789_nextValue$$inline_9778$$])
  }
  if(D.$DvtChartTypeUtils$$.$isScatterBubble$($chart$$11_keyCode$$11_seriesIndex$$inline_2018$$)) {
    $next_nextGroupIndex$$inline_2022_nextObj$$inline_2029$$ = (0,D.$DvtKeyboardHandler$getNextAdjacentNavigable$$)(this, $chart$$inline_2016_event$$141$$, $currentValue$$inline_9777_keyCode$$inline_2015_navigables$$2_nextValue$$inline_9788$$)
  }else {
    if(D.$DvtChartTypeUtils$$.$isLineArea$($chart$$11_keyCode$$11_seriesIndex$$inline_2018$$) || D.$DvtChartTypeUtils$$.$isStacked$($chart$$11_keyCode$$11_seriesIndex$$inline_2018$$) || D.$DvtChartTypeUtils$$.$isPolar$($chart$$11_keyCode$$11_seriesIndex$$inline_2018$$)) {
      $currentValue$$inline_9777_keyCode$$inline_2015_navigables$$2_nextValue$$inline_9788$$ = $chart$$inline_2016_event$$141$$.keyCode;
      $chart$$inline_2016_event$$141$$ = this.$_chart$;
      var $context$$inline_2017_isRTL$$inline_2025_itemValue$$inline_9781$$ = $chart$$inline_2016_event$$141$$.$getCtx$();
      $chart$$11_keyCode$$11_seriesIndex$$inline_2018$$ = this.$getSeriesIndex$();
      var $chartObjs_groupIndex$$inline_2019$$ = this.$getGroupIndex$(), $groupCount$$inline_2020_i$$137_nextSeriesIndex$$inline_9789_nextValue$$inline_9778$$ = D.$DvtChartDataUtils$$.$getGroupCount$($chart$$inline_2016_event$$141$$), $currentValue$$inline_9787_nextSeriesIndex$$inline_2021_seriesCount$$inline_9776$$, $i$$inline_9790_isHoriz$$inline_2023_nextSeriesIndex$$inline_9779_seriesCount$$inline_9786$$ = D.$DvtChartTypeUtils$$.$isHorizontal$($chart$$inline_2016_event$$141$$), $i$$inline_9780_isPolar$$inline_2024_itemValue$$inline_9791$$ = 
      D.$DvtChartTypeUtils$$.$isPolar$($chart$$inline_2016_event$$141$$), $context$$inline_2017_isRTL$$inline_2025_itemValue$$inline_9781$$ = (0,D.$DvtAgent$isRightToLeft$$)($context$$inline_2017_isRTL$$inline_2025_itemValue$$inline_9781$$), $isDown$$inline_2026$$ = $i$$inline_9790_isHoriz$$inline_2023_nextSeriesIndex$$inline_9779_seriesCount$$inline_9786$$ ? $context$$inline_2017_isRTL$$inline_2025_itemValue$$inline_9781$$ ? 39 == $currentValue$$inline_9777_keyCode$$inline_2015_navigables$$2_nextValue$$inline_9788$$ : 
      37 == $currentValue$$inline_9777_keyCode$$inline_2015_navigables$$2_nextValue$$inline_9788$$ : 40 == $currentValue$$inline_9777_keyCode$$inline_2015_navigables$$2_nextValue$$inline_9788$$, $isLeft$$inline_2027$$ = $i$$inline_9790_isHoriz$$inline_2023_nextSeriesIndex$$inline_9779_seriesCount$$inline_9786$$ ? 38 == $currentValue$$inline_9777_keyCode$$inline_2015_navigables$$2_nextValue$$inline_9788$$ : $context$$inline_2017_isRTL$$inline_2025_itemValue$$inline_9781$$ ? 39 == $currentValue$$inline_9777_keyCode$$inline_2015_navigables$$2_nextValue$$inline_9788$$ : 
      37 == $currentValue$$inline_9777_keyCode$$inline_2015_navigables$$2_nextValue$$inline_9788$$, $isRight$$inline_2028$$ = $i$$inline_9790_isHoriz$$inline_2023_nextSeriesIndex$$inline_9779_seriesCount$$inline_9786$$ ? 40 == $currentValue$$inline_9777_keyCode$$inline_2015_navigables$$2_nextValue$$inline_9788$$ : $context$$inline_2017_isRTL$$inline_2025_itemValue$$inline_9781$$ ? 37 == $currentValue$$inline_9777_keyCode$$inline_2015_navigables$$2_nextValue$$inline_9788$$ : 39 == $currentValue$$inline_9777_keyCode$$inline_2015_navigables$$2_nextValue$$inline_9788$$;
      if($i$$inline_9790_isHoriz$$inline_2023_nextSeriesIndex$$inline_9779_seriesCount$$inline_9786$$ ? $context$$inline_2017_isRTL$$inline_2025_itemValue$$inline_9781$$ ? 37 == $currentValue$$inline_9777_keyCode$$inline_2015_navigables$$2_nextValue$$inline_9788$$ : 39 == $currentValue$$inline_9777_keyCode$$inline_2015_navigables$$2_nextValue$$inline_9788$$ : 38 == $currentValue$$inline_9777_keyCode$$inline_2015_navigables$$2_nextValue$$inline_9788$$) {
        $next_nextGroupIndex$$inline_2022_nextObj$$inline_2029$$ = $chartObjs_groupIndex$$inline_2019$$;
        $currentValue$$inline_9787_nextSeriesIndex$$inline_2021_seriesCount$$inline_9776$$ = D.$DvtChartDataUtils$$.$getSeriesCount$($chart$$inline_2016_event$$141$$);
        $currentValue$$inline_9777_keyCode$$inline_2015_navigables$$2_nextValue$$inline_9788$$ = D.$DvtChartDataUtils$$.$getCumulativeValue$($chart$$inline_2016_event$$141$$, $chart$$11_keyCode$$11_seriesIndex$$inline_2018$$, $chartObjs_groupIndex$$inline_2019$$);
        $i$$inline_9790_isHoriz$$inline_2023_nextSeriesIndex$$inline_9779_seriesCount$$inline_9786$$ = $groupCount$$inline_2020_i$$137_nextSeriesIndex$$inline_9789_nextValue$$inline_9778$$ = D.$JSCompiler_alias_NULL$$;
        for($i$$inline_9780_isPolar$$inline_2024_itemValue$$inline_9791$$ = 0;$i$$inline_9780_isPolar$$inline_2024_itemValue$$inline_9791$$ < $currentValue$$inline_9787_nextSeriesIndex$$inline_2021_seriesCount$$inline_9776$$;$i$$inline_9780_isPolar$$inline_2024_itemValue$$inline_9791$$++) {
          if(D.$DvtChartStyleUtils$$.$isSeriesRendered$($chart$$inline_2016_event$$141$$, $i$$inline_9780_isPolar$$inline_2024_itemValue$$inline_9791$$) && ($context$$inline_2017_isRTL$$inline_2025_itemValue$$inline_9781$$ = D.$DvtChartDataUtils$$.$getCumulativeValue$($chart$$inline_2016_event$$141$$, $i$$inline_9780_isPolar$$inline_2024_itemValue$$inline_9791$$, $chartObjs_groupIndex$$inline_2019$$), $context$$inline_2017_isRTL$$inline_2025_itemValue$$inline_9781$$ > $currentValue$$inline_9777_keyCode$$inline_2015_navigables$$2_nextValue$$inline_9788$$ || 
          $context$$inline_2017_isRTL$$inline_2025_itemValue$$inline_9781$$ == $currentValue$$inline_9777_keyCode$$inline_2015_navigables$$2_nextValue$$inline_9788$$ && $i$$inline_9780_isPolar$$inline_2024_itemValue$$inline_9791$$ > $chart$$11_keyCode$$11_seriesIndex$$inline_2018$$)) {
            if($groupCount$$inline_2020_i$$137_nextSeriesIndex$$inline_9789_nextValue$$inline_9778$$ !== D.$JSCompiler_alias_NULL$$ && $context$$inline_2017_isRTL$$inline_2025_itemValue$$inline_9781$$ < $groupCount$$inline_2020_i$$137_nextSeriesIndex$$inline_9789_nextValue$$inline_9778$$ || $groupCount$$inline_2020_i$$137_nextSeriesIndex$$inline_9789_nextValue$$inline_9778$$ == D.$JSCompiler_alias_NULL$$) {
              $groupCount$$inline_2020_i$$137_nextSeriesIndex$$inline_9789_nextValue$$inline_9778$$ = $context$$inline_2017_isRTL$$inline_2025_itemValue$$inline_9781$$, $i$$inline_9790_isHoriz$$inline_2023_nextSeriesIndex$$inline_9779_seriesCount$$inline_9786$$ = $i$$inline_9780_isPolar$$inline_2024_itemValue$$inline_9791$$
            }
          }
        }
        $currentValue$$inline_9787_nextSeriesIndex$$inline_2021_seriesCount$$inline_9776$$ = $i$$inline_9790_isHoriz$$inline_2023_nextSeriesIndex$$inline_9779_seriesCount$$inline_9786$$
      }else {
        if($isDown$$inline_2026$$) {
          $next_nextGroupIndex$$inline_2022_nextObj$$inline_2029$$ = $chartObjs_groupIndex$$inline_2019$$;
          $i$$inline_9790_isHoriz$$inline_2023_nextSeriesIndex$$inline_9779_seriesCount$$inline_9786$$ = D.$DvtChartDataUtils$$.$getSeriesCount$($chart$$inline_2016_event$$141$$);
          $currentValue$$inline_9787_nextSeriesIndex$$inline_2021_seriesCount$$inline_9776$$ = D.$DvtChartDataUtils$$.$getCumulativeValue$($chart$$inline_2016_event$$141$$, $chart$$11_keyCode$$11_seriesIndex$$inline_2018$$, $chartObjs_groupIndex$$inline_2019$$);
          $groupCount$$inline_2020_i$$137_nextSeriesIndex$$inline_9789_nextValue$$inline_9778$$ = $currentValue$$inline_9777_keyCode$$inline_2015_navigables$$2_nextValue$$inline_9788$$ = D.$JSCompiler_alias_NULL$$;
          for($i$$inline_9790_isHoriz$$inline_2023_nextSeriesIndex$$inline_9779_seriesCount$$inline_9786$$ -= 1;0 <= $i$$inline_9790_isHoriz$$inline_2023_nextSeriesIndex$$inline_9779_seriesCount$$inline_9786$$;$i$$inline_9790_isHoriz$$inline_2023_nextSeriesIndex$$inline_9779_seriesCount$$inline_9786$$--) {
            if(D.$DvtChartStyleUtils$$.$isSeriesRendered$($chart$$inline_2016_event$$141$$, $i$$inline_9790_isHoriz$$inline_2023_nextSeriesIndex$$inline_9779_seriesCount$$inline_9786$$) && ($i$$inline_9780_isPolar$$inline_2024_itemValue$$inline_9791$$ = D.$DvtChartDataUtils$$.$getCumulativeValue$($chart$$inline_2016_event$$141$$, $i$$inline_9790_isHoriz$$inline_2023_nextSeriesIndex$$inline_9779_seriesCount$$inline_9786$$, $chartObjs_groupIndex$$inline_2019$$), $i$$inline_9780_isPolar$$inline_2024_itemValue$$inline_9791$$ < 
            $currentValue$$inline_9787_nextSeriesIndex$$inline_2021_seriesCount$$inline_9776$$ || $i$$inline_9780_isPolar$$inline_2024_itemValue$$inline_9791$$ == $currentValue$$inline_9787_nextSeriesIndex$$inline_2021_seriesCount$$inline_9776$$ && $i$$inline_9790_isHoriz$$inline_2023_nextSeriesIndex$$inline_9779_seriesCount$$inline_9786$$ < $chart$$11_keyCode$$11_seriesIndex$$inline_2018$$)) {
              if($currentValue$$inline_9777_keyCode$$inline_2015_navigables$$2_nextValue$$inline_9788$$ !== D.$JSCompiler_alias_NULL$$ && $i$$inline_9780_isPolar$$inline_2024_itemValue$$inline_9791$$ > $currentValue$$inline_9777_keyCode$$inline_2015_navigables$$2_nextValue$$inline_9788$$ || $currentValue$$inline_9777_keyCode$$inline_2015_navigables$$2_nextValue$$inline_9788$$ == D.$JSCompiler_alias_NULL$$) {
                $currentValue$$inline_9777_keyCode$$inline_2015_navigables$$2_nextValue$$inline_9788$$ = $i$$inline_9780_isPolar$$inline_2024_itemValue$$inline_9791$$, $groupCount$$inline_2020_i$$137_nextSeriesIndex$$inline_9789_nextValue$$inline_9778$$ = $i$$inline_9790_isHoriz$$inline_2023_nextSeriesIndex$$inline_9779_seriesCount$$inline_9786$$
              }
            }
          }
          $currentValue$$inline_9787_nextSeriesIndex$$inline_2021_seriesCount$$inline_9776$$ = $groupCount$$inline_2020_i$$137_nextSeriesIndex$$inline_9789_nextValue$$inline_9778$$
        }else {
          if($isRight$$inline_2028$$) {
            $currentValue$$inline_9787_nextSeriesIndex$$inline_2021_seriesCount$$inline_9776$$ = $chart$$11_keyCode$$11_seriesIndex$$inline_2018$$;
            $next_nextGroupIndex$$inline_2022_nextObj$$inline_2029$$ = $chartObjs_groupIndex$$inline_2019$$;
            do {
              $next_nextGroupIndex$$inline_2022_nextObj$$inline_2029$$++, $i$$inline_9780_isPolar$$inline_2024_itemValue$$inline_9791$$ && $next_nextGroupIndex$$inline_2022_nextObj$$inline_2029$$ >= $groupCount$$inline_2020_i$$137_nextSeriesIndex$$inline_9789_nextValue$$inline_9778$$ && ($next_nextGroupIndex$$inline_2022_nextObj$$inline_2029$$ = 0)
            }while((0,D.$JSCompiler_StaticMethods_getObject$$)($chart$$inline_2016_event$$141$$, $currentValue$$inline_9787_nextSeriesIndex$$inline_2021_seriesCount$$inline_9776$$, $next_nextGroupIndex$$inline_2022_nextObj$$inline_2029$$) == D.$JSCompiler_alias_NULL$$ && $next_nextGroupIndex$$inline_2022_nextObj$$inline_2029$$ < $groupCount$$inline_2020_i$$137_nextSeriesIndex$$inline_9789_nextValue$$inline_9778$$)
          }else {
            if($isLeft$$inline_2027$$) {
              $currentValue$$inline_9787_nextSeriesIndex$$inline_2021_seriesCount$$inline_9776$$ = $chart$$11_keyCode$$11_seriesIndex$$inline_2018$$;
              $next_nextGroupIndex$$inline_2022_nextObj$$inline_2029$$ = $chartObjs_groupIndex$$inline_2019$$;
              do {
                $next_nextGroupIndex$$inline_2022_nextObj$$inline_2029$$--, $i$$inline_9780_isPolar$$inline_2024_itemValue$$inline_9791$$ && 0 > $next_nextGroupIndex$$inline_2022_nextObj$$inline_2029$$ && ($next_nextGroupIndex$$inline_2022_nextObj$$inline_2029$$ = $groupCount$$inline_2020_i$$137_nextSeriesIndex$$inline_9789_nextValue$$inline_9778$$ - 1)
              }while((0,D.$JSCompiler_StaticMethods_getObject$$)($chart$$inline_2016_event$$141$$, $currentValue$$inline_9787_nextSeriesIndex$$inline_2021_seriesCount$$inline_9776$$, $next_nextGroupIndex$$inline_2022_nextObj$$inline_2029$$) == D.$JSCompiler_alias_NULL$$ && -1 < $next_nextGroupIndex$$inline_2022_nextObj$$inline_2029$$)
            }
          }
        }
      }
      $next_nextGroupIndex$$inline_2022_nextObj$$inline_2029$$ = ($next_nextGroupIndex$$inline_2022_nextObj$$inline_2029$$ = (0,D.$JSCompiler_StaticMethods_getObject$$)($chart$$inline_2016_event$$141$$, $currentValue$$inline_9787_nextSeriesIndex$$inline_2021_seriesCount$$inline_9776$$, $next_nextGroupIndex$$inline_2022_nextObj$$inline_2029$$)) && $next_nextGroupIndex$$inline_2022_nextObj$$inline_2029$$.$isNavigable$() ? $next_nextGroupIndex$$inline_2022_nextObj$$inline_2029$$ : this
    }else {
      D.$DvtChartTypeUtils$$.$isFunnel$($chart$$11_keyCode$$11_seriesIndex$$inline_2018$$) && (38 == $chart$$inline_2016_event$$141$$.keyCode || 40 == $chart$$inline_2016_event$$141$$.keyCode) ? ($chart$$inline_2016_event$$141$$.keyCode -= 1, $next_nextGroupIndex$$inline_2022_nextObj$$inline_2029$$ = (0,D.$DvtKeyboardHandler$getNextNavigable$$)(this, $chart$$inline_2016_event$$141$$, $currentValue$$inline_9777_keyCode$$inline_2015_navigables$$2_nextValue$$inline_9788$$)) : $next_nextGroupIndex$$inline_2022_nextObj$$inline_2029$$ = 
      (0,D.$DvtKeyboardHandler$getNextNavigable$$)(this, $chart$$inline_2016_event$$141$$, $currentValue$$inline_9777_keyCode$$inline_2015_navigables$$2_nextValue$$inline_9788$$, D.$JSCompiler_alias_TRUE$$)
    }
  }
  return $next_nextGroupIndex$$inline_2022_nextObj$$inline_2029$$
};
...
D.$JSCompiler_prototypeAlias$$.Init = function $$JSCompiler_prototypeAlias$$$Init$($chart$$18_i$$146$$, $displayables$$3$$, $refObj$$1$$, $displayable$$8_index$$130$$, $axisType$$3$$) {
  this.$_chart$ = $chart$$18_i$$146$$;
  this.$_displayables$ = $displayables$$3$$;
  this.$_refObj$ = $refObj$$1$$;
  this.$_index$ = $displayable$$8_index$$130$$;
  this.$_axisType$ = $axisType$$3$$;
  for($chart$$18_i$$146$$ = 0;$chart$$18_i$$146$$ < $displayables$$3$$.length;$chart$$18_i$$146$$++) {
    $displayable$$8_index$$130$$ = $displayables$$3$$[$chart$$18_i$$146$$], $displayable$$8_index$$130$$.$setAriaRole$("img"), $displayable$$8_index$$130$$.$setAriaProperty$("label", $refObj$$1$$.shortDesc)
  }
};
D.$JSCompiler_prototypeAlias$$.$getCategories$ = function $$JSCompiler_prototypeAlias$$$$getCategories$$() {
...
D.$DvtChartDataItem$$ = function $$DvtChartDataItem$$$($id$$24$$, $series$$3$$, $group$$10$$) {
  this.Init($id$$24$$, $series$$3$$, $group$$10$$)
};
...
D.$DvtChartDataItem$$.prototype.Init = function $$DvtChartDataItem$$$$Init$($id$$25$$, $series$$4$$, $group$$11$$) {
  this.$_id$ = $id$$25$$;
...
pieCenterLabel:{style:new D.$DvtCSSStyle$$("font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif;")}, dataLabelStyle:new D.$DvtCSSStyle$$("font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif;"), stockRisingColor:"#68C182", stockFallingColor:"#ED6647"}};
...
D.$JSCompiler_StaticMethods_processMove$$ = function $$JSCompiler_StaticMethods_processMove$$$($JSCompiler_StaticMethods_processMove$self$$, $pos$$6_y$$inline_2106$$, $bSuppressEvent_values$$inline_2116$$) {
  var $plotRect$$ = $JSCompiler_StaticMethods_processMove$self$$.$_chart$.$_plotAreaSpace$;
  if((0,D.$JSCompiler_StaticMethods_containsPoint$$)($plotRect$$, $pos$$6_y$$inline_2106$$.x, $pos$$6_y$$inline_2106$$.y)) {
    var $x$$inline_2105$$ = $pos$$6_y$$inline_2106$$.x;
    $pos$$6_y$$inline_2106$$ = $pos$$6_y$$inline_2106$$.y;
    if((0,D.$JSCompiler_StaticMethods_isOffscreen$$)($JSCompiler_StaticMethods_processMove$self$$.$_context$)) {
      (0,D.$JSCompiler_StaticMethods__removeDataCursor$$)($JSCompiler_StaticMethods_processMove$self$$, $bSuppressEvent_values$$inline_2116$$)
    }else {
      var $dataCursor$$inline_2108$$ = $JSCompiler_StaticMethods_processMove$self$$.$_dataCursor$, $closestFirstDirectionMatches$$inline_9830_closestLowerBound$$inline_9834_closestMatch$$inline_2109_i$$inline_9844_seriesColor$$inline_2114$$, $centerPoint$$inline_2110_horizontal$$inline_9825$$ = D.$DvtChartTypeUtils$$.$isHorizontal$($JSCompiler_StaticMethods_processMove$self$$.$_chart$), $closestMatch$$inline_9842_tooltipText$$inline_2113_useAllInGroup$$inline_9826$$ = D.$DvtChartTypeUtils$$.$isLineArea$($JSCompiler_StaticMethods_processMove$self$$.$_chart$), 
      $dcX$$inline_2111_lineCoord$$inline_2115_matches$$inline_9827_minDiff$$inline_9843$$ = $JSCompiler_StaticMethods_processMove$self$$.$_findMatches$(), $dcY$$inline_2112_matchesInBounds$$inline_9828_minDiff$$inline_9829$$;
      $dcY$$inline_2112_matchesInBounds$$inline_9828_minDiff$$inline_9829$$ = window.Infinity;
      $closestFirstDirectionMatches$$inline_9830_closestLowerBound$$inline_9834_closestMatch$$inline_2109_i$$inline_9844_seriesColor$$inline_2114$$ = [];
      for(var $closestHigherBound$$inline_9835_i$$inline_9831_match$$inline_9845$$ = 0;$closestHigherBound$$inline_9835_i$$inline_9831_match$$inline_9845$$ < $dcX$$inline_2111_lineCoord$$inline_2115_matches$$inline_9827_minDiff$$inline_9843$$.length;$closestHigherBound$$inline_9835_i$$inline_9831_match$$inline_9845$$++) {
        var $diffValue$$inline_9846_i$$inline_9837_matchObj$$inline_9832$$ = $dcX$$inline_2111_lineCoord$$inline_2115_matches$$inline_9827_minDiff$$inline_9843$$[$closestHigherBound$$inline_9835_i$$inline_9831_match$$inline_9845$$], $closestFirstDirectionMatch$$inline_9838_closestGroup$$inline_9836_diffValue$$inline_9833$$ = window.Math.abs((($centerPoint$$inline_2110_horizontal$$inline_9825$$ ? $diffValue$$inline_9846_i$$inline_9837_matchObj$$inline_9832$$.$matchRegion$.y : $diffValue$$inline_9846_i$$inline_9837_matchObj$$inline_9832$$.$matchRegion$.x) + 
        ($centerPoint$$inline_2110_horizontal$$inline_9825$$ ? $diffValue$$inline_9846_i$$inline_9837_matchObj$$inline_9832$$.$matchRegion$.y + $diffValue$$inline_9846_i$$inline_9837_matchObj$$inline_9832$$.$matchRegion$.$h$ : $diffValue$$inline_9846_i$$inline_9837_matchObj$$inline_9832$$.$matchRegion$.x + $diffValue$$inline_9846_i$$inline_9837_matchObj$$inline_9832$$.$matchRegion$.$w$)) / 2 - ($centerPoint$$inline_2110_horizontal$$inline_9825$$ ? $pos$$6_y$$inline_2106$$ : $x$$inline_2105$$));
        $closestFirstDirectionMatch$$inline_9838_closestGroup$$inline_9836_diffValue$$inline_9833$$ <= $dcY$$inline_2112_matchesInBounds$$inline_9828_minDiff$$inline_9829$$ && ($closestFirstDirectionMatch$$inline_9838_closestGroup$$inline_9836_diffValue$$inline_9833$$ < $dcY$$inline_2112_matchesInBounds$$inline_9828_minDiff$$inline_9829$$ && ($closestFirstDirectionMatches$$inline_9830_closestLowerBound$$inline_9834_closestMatch$$inline_2109_i$$inline_9844_seriesColor$$inline_2114$$ = []), $closestFirstDirectionMatches$$inline_9830_closestLowerBound$$inline_9834_closestMatch$$inline_2109_i$$inline_9844_seriesColor$$inline_2114$$.push($diffValue$$inline_9846_i$$inline_9837_matchObj$$inline_9832$$), 
        $dcY$$inline_2112_matchesInBounds$$inline_9828_minDiff$$inline_9829$$ = $closestFirstDirectionMatch$$inline_9838_closestGroup$$inline_9836_diffValue$$inline_9833$$)
      }
      $dcY$$inline_2112_matchesInBounds$$inline_9828_minDiff$$inline_9829$$ = $closestFirstDirectionMatches$$inline_9830_closestLowerBound$$inline_9834_closestMatch$$inline_2109_i$$inline_9844_seriesColor$$inline_2114$$;
      if(!D.$DvtChartTypeUtils$$.$isScatterBubble$($JSCompiler_StaticMethods_processMove$self$$.$_chart$)) {
        $closestFirstDirectionMatches$$inline_9830_closestLowerBound$$inline_9834_closestMatch$$inline_2109_i$$inline_9844_seriesColor$$inline_2114$$ = window.Infinity;
        $closestHigherBound$$inline_9835_i$$inline_9831_match$$inline_9845$$ = -window.Infinity;
        $closestFirstDirectionMatch$$inline_9838_closestGroup$$inline_9836_diffValue$$inline_9833$$ = D.$JSCompiler_alias_NULL$$;
        for($diffValue$$inline_9846_i$$inline_9837_matchObj$$inline_9832$$ = 0;$diffValue$$inline_9846_i$$inline_9837_matchObj$$inline_9832$$ < $dcY$$inline_2112_matchesInBounds$$inline_9828_minDiff$$inline_9829$$.length;$diffValue$$inline_9846_i$$inline_9837_matchObj$$inline_9832$$++) {
          $closestFirstDirectionMatch$$inline_9838_closestGroup$$inline_9836_diffValue$$inline_9833$$ = $dcY$$inline_2112_matchesInBounds$$inline_9828_minDiff$$inline_9829$$[$diffValue$$inline_9846_i$$inline_9837_matchObj$$inline_9832$$], $closestFirstDirectionMatches$$inline_9830_closestLowerBound$$inline_9834_closestMatch$$inline_2109_i$$inline_9844_seriesColor$$inline_2114$$ = window.Math.min($closestFirstDirectionMatches$$inline_9830_closestLowerBound$$inline_9834_closestMatch$$inline_2109_i$$inline_9844_seriesColor$$inline_2114$$, 
          $centerPoint$$inline_2110_horizontal$$inline_9825$$ ? $closestFirstDirectionMatch$$inline_9838_closestGroup$$inline_9836_diffValue$$inline_9833$$.$matchRegion$.y : $closestFirstDirectionMatch$$inline_9838_closestGroup$$inline_9836_diffValue$$inline_9833$$.$matchRegion$.x), $closestHigherBound$$inline_9835_i$$inline_9831_match$$inline_9845$$ = window.Math.max($closestHigherBound$$inline_9835_i$$inline_9831_match$$inline_9845$$, $centerPoint$$inline_2110_horizontal$$inline_9825$$ ? $closestFirstDirectionMatch$$inline_9838_closestGroup$$inline_9836_diffValue$$inline_9833$$.$matchRegion$.y + 
          $closestFirstDirectionMatch$$inline_9838_closestGroup$$inline_9836_diffValue$$inline_9833$$.$matchRegion$.$h$ : $closestFirstDirectionMatch$$inline_9838_closestGroup$$inline_9836_diffValue$$inline_9833$$.$matchRegion$.x + $closestFirstDirectionMatch$$inline_9838_closestGroup$$inline_9836_diffValue$$inline_9833$$.$matchRegion$.$w$), $closestFirstDirectionMatch$$inline_9838_closestGroup$$inline_9836_diffValue$$inline_9833$$ = $closestFirstDirectionMatch$$inline_9838_closestGroup$$inline_9836_diffValue$$inline_9833$$.$gidx$
        }
        for($diffValue$$inline_9846_i$$inline_9837_matchObj$$inline_9832$$ = 0;$diffValue$$inline_9846_i$$inline_9837_matchObj$$inline_9832$$ < $dcX$$inline_2111_lineCoord$$inline_2115_matches$$inline_9827_minDiff$$inline_9843$$.length;$diffValue$$inline_9846_i$$inline_9837_matchObj$$inline_9832$$++) {
          var $match$$inline_9839$$ = $dcX$$inline_2111_lineCoord$$inline_2115_matches$$inline_9827_minDiff$$inline_9843$$[$diffValue$$inline_9846_i$$inline_9837_matchObj$$inline_9832$$], $itemGroup$$inline_9840_midPoint$$inline_9841$$ = $match$$inline_9839$$.$gidx$;
          $closestMatch$$inline_9842_tooltipText$$inline_2113_useAllInGroup$$inline_9826$$ ? $closestFirstDirectionMatch$$inline_9838_closestGroup$$inline_9836_diffValue$$inline_9833$$ == $itemGroup$$inline_9840_midPoint$$inline_9841$$ && $dcY$$inline_2112_matchesInBounds$$inline_9828_minDiff$$inline_9829$$.push($match$$inline_9839$$) : ($itemGroup$$inline_9840_midPoint$$inline_9841$$ = (($centerPoint$$inline_2110_horizontal$$inline_9825$$ ? $match$$inline_9839$$.$matchRegion$.y : $match$$inline_9839$$.$matchRegion$.x) + 
          ($centerPoint$$inline_2110_horizontal$$inline_9825$$ ? $match$$inline_9839$$.$matchRegion$.y + $match$$inline_9839$$.$matchRegion$.$h$ : $match$$inline_9839$$.$matchRegion$.x + $match$$inline_9839$$.$matchRegion$.$w$)) / 2, $closestHigherBound$$inline_9835_i$$inline_9831_match$$inline_9845$$ >= $itemGroup$$inline_9840_midPoint$$inline_9841$$ && $closestFirstDirectionMatches$$inline_9830_closestLowerBound$$inline_9834_closestMatch$$inline_2109_i$$inline_9844_seriesColor$$inline_2114$$ <= 
          $itemGroup$$inline_9840_midPoint$$inline_9841$$ && $dcY$$inline_2112_matchesInBounds$$inline_9828_minDiff$$inline_9829$$.push($match$$inline_9839$$))
        }
      }
      $closestMatch$$inline_9842_tooltipText$$inline_2113_useAllInGroup$$inline_9826$$ = D.$JSCompiler_alias_NULL$$;
      $dcX$$inline_2111_lineCoord$$inline_2115_matches$$inline_9827_minDiff$$inline_9843$$ = window.Infinity;
      for($closestFirstDirectionMatches$$inline_9830_closestLowerBound$$inline_9834_closestMatch$$inline_2109_i$$inline_9844_seriesColor$$inline_2114$$ = 0;$closestFirstDirectionMatches$$inline_9830_closestLowerBound$$inline_9834_closestMatch$$inline_2109_i$$inline_9844_seriesColor$$inline_2114$$ < $dcY$$inline_2112_matchesInBounds$$inline_9828_minDiff$$inline_9829$$.length;$closestFirstDirectionMatches$$inline_9830_closestLowerBound$$inline_9834_closestMatch$$inline_2109_i$$inline_9844_seriesColor$$inline_2114$$++) {
        $closestHigherBound$$inline_9835_i$$inline_9831_match$$inline_9845$$ = $dcY$$inline_2112_matchesInBounds$$inline_9828_minDiff$$inline_9829$$[$closestFirstDirectionMatches$$inline_9830_closestLowerBound$$inline_9834_closestMatch$$inline_2109_i$$inline_9844_seriesColor$$inline_2114$$], $diffValue$$inline_9846_i$$inline_9837_matchObj$$inline_9832$$ = window.Math.abs((($centerPoint$$inline_2110_horizontal$$inline_9825$$ ? $closestHigherBound$$inline_9835_i$$inline_9831_match$$inline_9845$$.$matchRegion$.x : 
        $closestHigherBound$$inline_9835_i$$inline_9831_match$$inline_9845$$.$matchRegion$.y) + ($centerPoint$$inline_2110_horizontal$$inline_9825$$ ? $closestHigherBound$$inline_9835_i$$inline_9831_match$$inline_9845$$.$matchRegion$.x + $closestHigherBound$$inline_9835_i$$inline_9831_match$$inline_9845$$.$matchRegion$.$w$ : $closestHigherBound$$inline_9835_i$$inline_9831_match$$inline_9845$$.$matchRegion$.y + $closestHigherBound$$inline_9835_i$$inline_9831_match$$inline_9845$$.$matchRegion$.$h$)) / 
        2 - ($centerPoint$$inline_2110_horizontal$$inline_9825$$ ? $x$$inline_2105$$ : $pos$$6_y$$inline_2106$$)), $diffValue$$inline_9846_i$$inline_9837_matchObj$$inline_9832$$ < $dcX$$inline_2111_lineCoord$$inline_2115_matches$$inline_9827_minDiff$$inline_9843$$ && ($dcX$$inline_2111_lineCoord$$inline_2115_matches$$inline_9827_minDiff$$inline_9843$$ = $diffValue$$inline_9846_i$$inline_9837_matchObj$$inline_9832$$, $closestMatch$$inline_9842_tooltipText$$inline_2113_useAllInGroup$$inline_9826$$ = 
        $closestHigherBound$$inline_9835_i$$inline_9831_match$$inline_9845$$)
      }
      $closestFirstDirectionMatches$$inline_9830_closestLowerBound$$inline_9834_closestMatch$$inline_2109_i$$inline_9844_seriesColor$$inline_2114$$ = $closestMatch$$inline_9842_tooltipText$$inline_2113_useAllInGroup$$inline_9826$$;
      $closestFirstDirectionMatches$$inline_9830_closestLowerBound$$inline_9834_closestMatch$$inline_2109_i$$inline_9844_seriesColor$$inline_2114$$ == D.$JSCompiler_alias_NULL$$ ? (0,D.$JSCompiler_StaticMethods__removeDataCursor$$)($JSCompiler_StaticMethods_processMove$self$$, $bSuppressEvent_values$$inline_2116$$) : ($centerPoint$$inline_2110_horizontal$$inline_9825$$ = D.$DvtGeomUtils$$.$getCenterPoint$($closestFirstDirectionMatches$$inline_9830_closestLowerBound$$inline_9834_closestMatch$$inline_2109_i$$inline_9844_seriesColor$$inline_2114$$.$matchRegion$), 
      $dcX$$inline_2111_lineCoord$$inline_2115_matches$$inline_9827_minDiff$$inline_9843$$ = $x$$inline_2105$$, $dcY$$inline_2112_matchesInBounds$$inline_9828_minDiff$$inline_9829$$ = $pos$$6_y$$inline_2106$$, "SNAP" == ($dataCursor$$inline_2108$$.$_behavior$ ? $dataCursor$$inline_2108$$.$_behavior$ : "AUTO") && ($dataCursor$$inline_2108$$.$isHorizontal$() ? $dcY$$inline_2112_matchesInBounds$$inline_9828_minDiff$$inline_9829$$ = window.Math.min(window.Math.max($centerPoint$$inline_2110_horizontal$$inline_9825$$.y, 
      $plotRect$$.y), $plotRect$$.y + $plotRect$$.$h$) : $dcX$$inline_2111_lineCoord$$inline_2115_matches$$inline_9827_minDiff$$inline_9843$$ = window.Math.min(window.Math.max($centerPoint$$inline_2110_horizontal$$inline_9825$$.x, $plotRect$$.x), $plotRect$$.x + $plotRect$$.$w$)), $closestMatch$$inline_9842_tooltipText$$inline_2113_useAllInGroup$$inline_9826$$ = D.$DvtChartTooltipUtils$$.$getDatatip$($JSCompiler_StaticMethods_processMove$self$$.$_chart$, $closestFirstDirectionMatches$$inline_9830_closestLowerBound$$inline_9834_closestMatch$$inline_2109_i$$inline_9844_seriesColor$$inline_2114$$.$sidx$, 
      $closestFirstDirectionMatches$$inline_9830_closestLowerBound$$inline_9834_closestMatch$$inline_2109_i$$inline_9844_seriesColor$$inline_2114$$.$gidx$, (0,D.$DvtChartDefaults$isPostAltaSkin$$)($JSCompiler_StaticMethods_processMove$self$$.$_chart$)), ($closestMatch$$inline_9842_tooltipText$$inline_2113_useAllInGroup$$inline_9826$$ == D.$JSCompiler_alias_NULL$$ || "" == $closestMatch$$inline_9842_tooltipText$$inline_2113_useAllInGroup$$inline_9826$$) && "on" != $JSCompiler_StaticMethods_processMove$self$$.$_chart$.$getOptions$().dataCursor ? 
      $dataCursor$$inline_2108$$.$setVisible$(D.$JSCompiler_alias_FALSE$$) : ($dataCursor$$inline_2108$$.$setVisible$(D.$JSCompiler_alias_TRUE$$), $closestFirstDirectionMatches$$inline_9830_closestLowerBound$$inline_9834_closestMatch$$inline_2109_i$$inline_9844_seriesColor$$inline_2114$$ = D.$DvtChartTooltipUtils$$.$getDatatipColor$($JSCompiler_StaticMethods_processMove$self$$.$_chart$, $closestFirstDirectionMatches$$inline_9830_closestLowerBound$$inline_9834_closestMatch$$inline_2109_i$$inline_9844_seriesColor$$inline_2114$$.$sidx$, 
      $closestFirstDirectionMatches$$inline_9830_closestLowerBound$$inline_9834_closestMatch$$inline_2109_i$$inline_9844_seriesColor$$inline_2114$$.$gidx$), $dcX$$inline_2111_lineCoord$$inline_2115_matches$$inline_9827_minDiff$$inline_9843$$ = $dataCursor$$inline_2108$$.$isHorizontal$() ? $dcY$$inline_2112_matchesInBounds$$inline_9828_minDiff$$inline_9829$$ : $dcX$$inline_2111_lineCoord$$inline_2115_matches$$inline_9827_minDiff$$inline_9843$$, $dataCursor$$inline_2108$$.$render$($plotRect$$, $centerPoint$$inline_2110_horizontal$$inline_9825$$.x, 
      $centerPoint$$inline_2110_horizontal$$inline_9825$$.y, $dcX$$inline_2111_lineCoord$$inline_2115_matches$$inline_9827_minDiff$$inline_9843$$, $closestMatch$$inline_9842_tooltipText$$inline_2113_useAllInGroup$$inline_9826$$, $closestFirstDirectionMatches$$inline_9830_closestLowerBound$$inline_9834_closestMatch$$inline_2109_i$$inline_9844_seriesColor$$inline_2114$$), $JSCompiler_StaticMethods_processMove$self$$.$_dataCursorShown$ = D.$JSCompiler_alias_TRUE$$, $bSuppressEvent_values$$inline_2116$$ || 
      ($bSuppressEvent_values$$inline_2116$$ = $JSCompiler_StaticMethods_processMove$self$$.$_chart$.$getValuesAt$($x$$inline_2105$$, $pos$$6_y$$inline_2106$$), (0,D.$JSCompiler_StaticMethods_changeOption$$)($JSCompiler_StaticMethods_processMove$self$$.$_chart$, $bSuppressEvent_values$$inline_2116$$))))
    }
  }else {
    (0,D.$JSCompiler_StaticMethods__removeDataCursor$$)($JSCompiler_StaticMethods_processMove$self$$, $bSuppressEvent_values$$inline_2116$$)
  }
...
D.$DvtDataCursorHandler$$.prototype.$_findMatches$ = function $$DvtDataCursorHandler$$$$$_findMatches$$() {
  ...
  for(var $i$$144$$ = 0;$i$$144$$ < this.$_chart$.$_currentMarkers$.length;$i$$144$$++) {
    for(var $markers$$ = this.$_chart$.$_currentMarkers$[$i$$144$$], $numMarkers$$ = $markers$$.length, $idx$$2$$ = 0;$idx$$2$$ < $numMarkers$$;$idx$$2$$++) {
      var $item$$2_match$$2$$ = $markers$$[$idx$$2$$], $logicalObject$$1$$ = $eventManager$$6$$.$GetLogicalObject$($item$$2_match$$2$$), $dims$$5$$ = $item$$2_match$$2$$.$getDimensionsSelf$ ? $item$$2_match$$2$$.$getDimensionsSelf$($stage$$5$$) : $item$$2_match$$2$$.$getDimensions$($stage$$5$$), $item$$2_match$$2$$ = {$obj$:$item$$2_match$$2$$, $matchRegion$:$dims$$5$$, $gidx$:$logicalObject$$1$$.$getGroupIndex$(), $sidx$:$logicalObject$$1$$.$getSeriesIndex$(), $marker$:D.$JSCompiler_alias_NULL$$};
...
D.$DvtAnimOnDisplay$$.$_getAreaPlayable$ = function $$DvtAnimOnDisplay$$$$_getAreaPlayable$$($chart$$22_nodePlayable$$2$$, $shape$$27$$, $duration$$15_topAnim$$) {
  var $context$$31$$ = $chart$$22_nodePlayable$$2$$.$getCtx$(), $baselineCoord$$ = $shape$$27$$.$_baseline$, $baseAnim_baseParams$$;
  if($shape$$27$$.$isArea$()) {
    var $baseCoords$$ = $shape$$27$$.$_arBaseCoord$;
    $baseAnim_baseParams$$ = $shape$$27$$.$getBaseAnimationParams$();
    ...
    $shape$$27$$.$setBaseAnimationParams$($baseAnim_baseParams$$);
    $baseAnim_baseParams$$ = new D.$DvtCustomAnimation$$($context$$31$$, $shape$$27$$, $duration$$15_topAnim$$);
    (0,D.$JSCompiler_StaticMethods_addProp$$)($baseAnim_baseParams$$.$_animator$, "typeNumberArray", $shape$$27$$, $shape$$27$$.$getBaseAnimationParams$, $shape$$27$$.$setBaseAnimationParams$, $baseEndState_endState$$)
  }
  for(var $coords$$6$$ = $shape$$27$$.$_arCoord$, $params$$8$$ = $shape$$27$$.$getAnimationParams$(), $baseEndState_endState$$ = $params$$8$$.slice(0), $j$$27$$ = 0;$j$$27$$ < $params$$8$$.length;$j$$27$$++) {
    if(1 == $j$$27$$ % 4 || 2 == $j$$27$$ % 4) {
      $params$$8$$[$j$$27$$] = $baselineCoord$$
    }
  }
  $shape$$27$$.$setAnimationParams$($params$$8$$);
  $duration$$15_topAnim$$ = new D.$DvtCustomAnimation$$($context$$31$$, $shape$$27$$, $duration$$15_topAnim$$);
  (0,D.$JSCompiler_StaticMethods_addProp$$)($duration$$15_topAnim$$.$_animator$, "typeNumberArray", $shape$$27$$, $shape$$27$$.$getAnimationParams$, $shape$$27$$.$setAnimationParams$, $baseEndState_endState$$);
  ...
  $chart$$22_nodePlayable$$2$$.$setOnEnd$(function() {
    $shape$$27$$.$setCoords$($coords$$6$$, $baseCoords$$)
  });
...
D.$JSCompiler_prototypeAlias$$.$animateUpdate$ = function $$JSCompiler_prototypeAlias$$$$animateUpdate$$($handler$$16$$, $oldDC$$1$$) {
  ...
  if($i$$152_isArea$$) {
    var $JSCompiler_StaticMethods_addIndicator$self$$inline_2141_baseStartState_startState$$1$$ = $oldDC$$1$$.$_getBaseAnimationParams$(this.$_shape$), $baseEndState$$1_endState$$3_groupIndex$$inline_2142$$ = this.$_getBaseAnimationParams$($oldDC$$1$$.$_shape$);
    (0,D.$DvtDCChartLineArea$_matchGroupIndices$$)($JSCompiler_StaticMethods_addIndicator$self$$inline_2141_baseStartState_startState$$1$$, $baseEndState$$1_endState$$3_groupIndex$$inline_2142$$);
    D.$DvtArrayUtils$$.$equals$($JSCompiler_StaticMethods_addIndicator$self$$inline_2141_baseStartState_startState$$1$$, $baseEndState$$1_endState$$3_groupIndex$$inline_2142$$) || (this.$_setBaseAnimationParams$($JSCompiler_StaticMethods_addIndicator$self$$inline_2141_baseStartState_startState$$1$$), $baseAnim$$1$$ = new D.$DvtCustomAnimation$$(this.$_context$, this, this.$_updateDuration$), (0,D.$JSCompiler_StaticMethods_addProp$$)($baseAnim$$1$$.$_animator$, "typeNumberArray", this, this.$_getBaseAnimationParams$, 
    this.$_setBaseAnimationParams$, $baseEndState$$1_endState$$3_groupIndex$$inline_2142$$))
  }
  var $topAnim$$1$$, $JSCompiler_StaticMethods_addIndicator$self$$inline_2141_baseStartState_startState$$1$$ = $oldDC$$1$$.$_getAnimationParams$(this.$_shape$), $baseEndState$$1_endState$$3_groupIndex$$inline_2142$$ = this.$_getAnimationParams$($oldDC$$1$$.$_shape$);
  (0,D.$DvtDCChartLineArea$_matchGroupIndices$$)($JSCompiler_StaticMethods_addIndicator$self$$inline_2141_baseStartState_startState$$1$$, $baseEndState$$1_endState$$3_groupIndex$$inline_2142$$);
  D.$DvtArrayUtils$$.$equals$($JSCompiler_StaticMethods_addIndicator$self$$inline_2141_baseStartState_startState$$1$$, $baseEndState$$1_endState$$3_groupIndex$$inline_2142$$) || (this.$_setAnimationParams$($JSCompiler_StaticMethods_addIndicator$self$$inline_2141_baseStartState_startState$$1$$), $topAnim$$1$$ = new D.$DvtCustomAnimation$$(this.$_context$, this, this.$_updateDuration$), (0,D.$JSCompiler_StaticMethods_addProp$$)($topAnim$$1$$.$_animator$, "typeNumberArray", this, this.$_getAnimationParams$, 
  this.$_setAnimationParams$, $baseEndState$$1_endState$$3_groupIndex$$inline_2142$$));
  if("none" !== D.$DvtChartStyleUtils$$.$getAnimationIndicators$($newChart$$4$$) && !($i$$152_isArea$$ && "lineWithArea" == this.$_peer$.$getSeriesType$())) {
    for(var $direction$$12_direction$$inline_2143$$, $indicator_indicator$$inline_2144$$, $i$$152_isArea$$ = 0;$i$$152_isArea$$ < $newGIdcs$$.length;$i$$152_isArea$$++) {
      if($direction$$12_direction$$inline_2143$$ = D.$DvtDCChartUtils$$.$getDirection$($nodePlayable$$7_oldChart$$5$$, $oldSIdx$$1$$, $oldGIdcs$$[$i$$152_isArea$$], $newChart$$4$$, $newSIdx$$1$$, $newGIdcs$$[$i$$152_isArea$$]), $indicator_indicator$$inline_2144$$ = D.$DvtDCChartUtils$$.$makeIndicator$($nodePlayable$$7_oldChart$$5$$, $oldSIdx$$1$$, $oldGIdcs$$[$i$$152_isArea$$], $newChart$$4$$, $newSIdx$$1$$, $newGIdcs$$[$i$$152_isArea$$])) {
        $JSCompiler_StaticMethods_addIndicator$self$$inline_2141_baseStartState_startState$$1$$ = this.$_shape$, $baseEndState$$1_endState$$3_groupIndex$$inline_2142$$ = $newGIdcs$$[$i$$152_isArea$$], $indicator_indicator$$inline_2144$$.$setAlpha$(0), $JSCompiler_StaticMethods_addIndicator$self$$inline_2141_baseStartState_startState$$1$$.$_indicatorMap$[$baseEndState$$1_endState$$3_groupIndex$$inline_2142$$] = {direction:$direction$$12_direction$$inline_2143$$, $indicator$:$indicator_indicator$$inline_2144$$}
      }
    }
  }
...
D.$JSCompiler_prototypeAlias$$.$_onAnimationEnd$ = function $$JSCompiler_prototypeAlias$$$$_onAnimationEnd$$() {
  var $JSCompiler_StaticMethods_removeIndicators$self$$inline_2146$$ = this.$_shape$, $groupIndex$$inline_2147$$;
  for($groupIndex$$inline_2147$$ in $JSCompiler_StaticMethods_removeIndicators$self$$inline_2146$$.$_indicatorMap$) {
    var $indicator$$inline_2148$$ = $JSCompiler_StaticMethods_removeIndicators$self$$inline_2146$$.$_indicatorMap$[$groupIndex$$inline_2147$$].$indicator$;
    $indicator$$inline_2148$$ && $indicator$$inline_2148$$.getParent().removeChild($indicator$$inline_2148$$)
  }
  $JSCompiler_StaticMethods_removeIndicators$self$$inline_2146$$.$_indicatorMap$ = {};
...
D.$JSCompiler_prototypeAlias$$.$animateUpdate$ = function $$JSCompiler_prototypeAlias$$$$animateUpdate$$($handler$$19$$, $oldDC$$2$$) {
  ...
  if(!$endRect$$.$equals$($startRect$$)) {
    ...
    var $chart$$27_overlay$$ = this.$_peer$.$_chart$, $bRet$$inline_2152_oldSIdx$$inline_2153$$ = D.$JSCompiler_alias_FALSE$$;
    if($oldDC$$2$$) {
      var $bRet$$inline_2152_oldSIdx$$inline_2153$$ = $oldDC$$2$$.$_peer$.$getSeriesIndex$(), $oldGIdx$$inline_2154$$ = $oldDC$$2$$.$_peer$.$getGroupIndex$(), $newSIdx$$inline_2155$$ = this.$_peer$.$getSeriesIndex$(), $newGIdx$$inline_2156$$ = this.$_peer$.$getGroupIndex$(), $oldData$$inline_2157$$ = $oldDC$$2$$.$_oldChart$.$getOptions$(), $newData$$inline_2158$$ = this.$_peer$.$_chart$.$getOptions$(), $oldY$$inline_2159$$ = $oldData$$inline_2157$$.series[$bRet$$inline_2152_oldSIdx$$inline_2153$$].items[$oldGIdx$$inline_2154$$].y, 
      $oldZ$$inline_2160$$ = $oldData$$inline_2157$$.series[$bRet$$inline_2152_oldSIdx$$inline_2153$$].items[$oldGIdx$$inline_2154$$].z, $newY$$inline_2161$$ = $newData$$inline_2158$$.series[$newSIdx$$inline_2155$$].items[$newGIdx$$inline_2156$$].y, $newZ$$inline_2162$$ = $newData$$inline_2158$$.series[$newSIdx$$inline_2155$$].items[$newGIdx$$inline_2156$$].z, $bRet$$inline_2152_oldSIdx$$inline_2153$$ = $newData$$inline_2158$$.series[$newSIdx$$inline_2155$$].items[$newGIdx$$inline_2156$$].x !== $oldData$$inline_2157$$.series[$bRet$$inline_2152_oldSIdx$$inline_2153$$].items[$oldGIdx$$inline_2154$$].x || 
      $newY$$inline_2161$$ !== $oldY$$inline_2159$$ || $newZ$$inline_2162$$ !== $oldZ$$inline_2160$$
    }
    $bRet$$inline_2152_oldSIdx$$inline_2153$$ && ("none" != D.$DvtChartStyleUtils$$.$getAnimationIndicators$($chart$$27_overlay$$) && D.$DvtChartTypeUtils$$.$isScatterBubble$($chart$$27_overlay$$)) && ($chart$$27_overlay$$ = $oldDC$$2$$.$_shape$, $chart$$27_overlay$$.$setSolidFill$("#FFFF2B", 0.9), $chart$$27_overlay$$.$setCenterDimensions$($startRect$$), this.$_peer$.$_chart$.$getPlotArea$().$addChild$($chart$$27_overlay$$), (0,D.$JSCompiler_StaticMethods_addProp$$)($nodePlayable$$10$$.$_animator$, 
...
D.$DvtDCChartUtils$$.$_drawIndicator$ = function $$DvtDCChartUtils$$$$_drawIndicator$$($context$$33_ret$$3$$, $bDown$$1_ptrCmds$$, $bHoriz$$2$$, $fc$$2$$) {
  $bDown$$1_ptrCmds$$ = $bHoriz$$2$$ ? ((0,D.$DvtAgent$isRightToLeft$$)($context$$33_ret$$3$$) ? !$bDown$$1_ptrCmds$$ : $bDown$$1_ptrCmds$$) ? "M3.5,-5L3.5,5L-3.5,0L3.5,-5" : "M-3.5,-5L-3.5,5L3.5,0L-3.5,-5" : $bDown$$1_ptrCmds$$ ? "M-5,-3.5L5,-3.5L0,3.5L-5,-3.5Z" : "M-5,3.5L5,3.5L0,-3.5L-5,3.5Z";
...
D.$DvtChartAxisUtils$$.$getTimeAxisType$ = function $$DvtChartAxisUtils$$$$getTimeAxisType$$($chart$$116$$) {
  var $timeAxisType$$ = $chart$$116$$.$getOptions$().timeAxisType;
  return $timeAxisType$$ && "auto" != $timeAxisType$$ && D.$DvtChartTypeUtils$$.$isBLAC$($chart$$116$$) && !D.$DvtChartTypeUtils$$.$isPolar$($chart$$116$$) ? $timeAxisType$$ : D.$DvtChartTypeUtils$$.$isStock$($chart$$116$$) ? "skipGaps" : "disabled"
};
...
D.$DvtChartAxisUtils$$.$getTickLabelFontSize$ = function $$DvtChartAxisUtils$$$$getTickLabelFontSize$$($chart$$126$$, $type$$89$$) {
  var $options$$61$$ = $chart$$126$$.$getOptions$(), $tickLabelStyle$$ = $options$$61$$[$type$$89$$ + "Axis"].tickLabel.style;
  $tickLabelStyle$$ instanceof D.$DvtCSSStyle$$ || ($tickLabelStyle$$ = new D.$DvtCSSStyle$$($tickLabelStyle$$));
  (0,D.$JSCompiler_StaticMethods_mergeUnder$$)($tickLabelStyle$$, (0,D.$DvtAxis$getDefaults$$)($options$$61$$.skin).tickLabel.style);
...
D.$DvtChartAxisUtils$$.$getTickLabelGapSize$ = function $$DvtChartAxisUtils$$$$getTickLabelGapSize$$($chart$$127$$, $type$$90$$) {
  ...
  var $gapHeight$$1_options$$62$$ = $chart$$127$$.$getOptions$(), $isHoriz$$10$$ = D.$DvtChartTypeUtils$$.$isHorizontal$($chart$$127$$), $scalingFactor$$1$$ = D.$DvtChartAxisUtils$$.$getGapScalingFactor$($chart$$127$$, $type$$90$$), $gapWidth$$1$$ = window.Math.ceil($gapHeight$$1_options$$62$$.layout.tickLabelGapWidth * $scalingFactor$$1$$), $gapHeight$$1_options$$62$$ = window.Math.ceil($gapHeight$$1_options$$62$$.layout.tickLabelGapHeight * $scalingFactor$$1$$);
  return"x" == $type$$90$$ ? $isHoriz$$10$$ ? $gapWidth$$1$$ : $gapHeight$$1_options$$62$$ : $isHoriz$$10$$ ? $gapHeight$$1_options$$62$$ : $gapWidth$$1$$
};
...
D.$DvtChartAxisUtils$$.$getXAxisViewportMinMax$ = function $$DvtChartAxisUtils$$$$getXAxisViewportMinMax$$($chart$$130$$, $useGlobal$$) {
  var $options$$63$$ = $chart$$130$$.$getOptions$().xAxis, $isGroupAxis$$ = D.$DvtChartAxisUtils$$.$hasGroupAxis$($chart$$130$$), $groupOffset$$ = D.$DvtChartAxisUtils$$.$getAxisOffset$($chart$$130$$);
  if($useGlobal$$) {
    var $globalMinMax$$ = D.$DvtChartAxisUtils$$.$getXAxisGlobalMinMax$($chart$$130$$)
  }
  var $min$$2$$ = D.$JSCompiler_alias_NULL$$;
  $options$$63$$.viewportMin != D.$JSCompiler_alias_NULL$$ ? $min$$2$$ = $options$$63$$.viewportMin : $options$$63$$.viewportStartGroup != D.$JSCompiler_alias_NULL$$ ? $min$$2$$ = $isGroupAxis$$ ? D.$DvtChartDataUtils$$.$getGroupIndex$($chart$$130$$, $options$$63$$.viewportStartGroup) - $groupOffset$$ : $options$$63$$.viewportStartGroup : $useGlobal$$ && ($min$$2$$ = $globalMinMax$$.min);
  var $max$$2$$ = D.$JSCompiler_alias_NULL$$;
  $options$$63$$.viewportMax != D.$JSCompiler_alias_NULL$$ ? $max$$2$$ = $options$$63$$.viewportMax : $options$$63$$.viewportEndGroup != D.$JSCompiler_alias_NULL$$ ? $max$$2$$ = $isGroupAxis$$ ? D.$DvtChartDataUtils$$.$getGroupIndex$($chart$$130$$, $options$$63$$.viewportEndGroup) + $groupOffset$$ : $options$$63$$.viewportEndGroup : $useGlobal$$ && ($max$$2$$ = $globalMinMax$$.max);
...
D.$DvtChartAxisUtils$$.$getXAxisGlobalMinMax$ = function $$DvtChartAxisUtils$$$$getXAxisGlobalMinMax$$($chart$$131$$) {
  var $options$$64$$ = $chart$$131$$.$getOptions$().xAxis, $isGroupAxis$$1$$ = D.$DvtChartAxisUtils$$.$hasGroupAxis$($chart$$131$$), $groupOffset$$1$$ = D.$DvtChartAxisUtils$$.$getAxisOffset$($chart$$131$$);
  if(!$isGroupAxis$$1$$) {
    var $minMax$$1$$ = D.$DvtChartDataUtils$$.$getMinMaxValue$($chart$$131$$, "x")
  }
  var $min$$3$$ = D.$JSCompiler_alias_NULL$$, $min$$3$$ = $options$$64$$.min != D.$JSCompiler_alias_NULL$$ ? $options$$64$$.min : $isGroupAxis$$1$$ ? 0 - $groupOffset$$1$$ : $minMax$$1$$.min, $max$$3$$ = D.$JSCompiler_alias_NULL$$, $max$$3$$ = $options$$64$$.max != D.$JSCompiler_alias_NULL$$ ? $options$$64$$.max : $isGroupAxis$$1$$ ? D.$DvtChartDataUtils$$.$getGroupCount$($chart$$131$$) - 1 + $groupOffset$$1$$ : $minMax$$1$$.max;
...
D.$DvtChartAxisUtils$$.$applyInitialZooming$ = function $$DvtChartAxisUtils$$$$applyInitialZooming$$($chart$$132$$, $availSpace$$77$$) {
  var $options$$65$$ = $chart$$132$$.$getOptions$(), $axisOptions$$13$$ = $options$$65$$.xAxis, $axisWidth_globalMin_initialZooming$$ = $options$$65$$.initialZooming;
  if(D.$DvtChartTypeUtils$$.$isBLAC$($chart$$132$$) && !("off" == $options$$65$$.zoomAndScroll || "none" == $axisWidth_globalMin_initialZooming$$)) {
    $options$$65$$._initialZoomed && ("last" == $axisWidth_globalMin_initialZooming$$ ? $axisOptions$$13$$.viewportMin = D.$JSCompiler_alias_NULL$$ : $axisOptions$$13$$.viewportMax = D.$JSCompiler_alias_NULL$$);
...
D.$DvtChartAxisUtils$$.$getGroupWidthRatios$ = function $$DvtChartAxisUtils$$$$getGroupWidthRatios$$($barWidthSum_chart$$133$$) {
  ...
  var $options$$66$$ = $barWidthSum_chart$$133$$.$getOptions$(), $barGapRatio_groupWidths$$ = D.$DvtChartStyleUtils$$.$getBarGapRatio$($barWidthSum_chart$$133$$);
  if(1 <= $barGapRatio_groupWidths$$) {
    return $options$$66$$._averageGroupZ = window.Infinity, D.$JSCompiler_alias_NULL$$
  }
  $options$$66$$._averageGroupZ = 0;
  ...
  $barWidthSum_chart$$133$$ = $barWidths$$.reduce(function($barWidthSum_chart$$133$$, $options$$66$$) {
    return $barWidthSum_chart$$133$$ + $options$$66$$
  });
  ...
  $options$$66$$._averageGroupZ = ($barWidthSum_chart$$133$$ + $gapWidthSum$$) / $numGroups$$6$$;
...
D.$DvtChartDataUtils$$.$hasData$ = function $$DvtChartDataUtils$$$$hasData$$($chart$$134$$) {
  var $options$$67_seriesCount$$12$$ = $chart$$134$$.$getOptions$();
  if(!$options$$67_seriesCount$$12$$ || !$options$$67_seriesCount$$12$$.series || 1 > $options$$67_seriesCount$$12$$.series.length) {
    return D.$JSCompiler_alias_FALSE$$
  }
  for(var $options$$67_seriesCount$$12$$ = D.$DvtChartDataUtils$$.$getSeriesCount$($chart$$134$$), $i$$191$$ = 0;$i$$191$$ < $options$$67_seriesCount$$12$$;$i$$191$$++) {
...
D.$DvtChartDataUtils$$.$hasInvalidTimeData$ = function $$DvtChartDataUtils$$$$hasInvalidTimeData$$($chart$$136$$) {
  ...
  var $groupIndex$$24_options$$68$$ = $chart$$136$$.$getOptions$(), $groupCount$$5$$ = D.$DvtChartDataUtils$$.$getGroupCount$($chart$$136$$);
  if(!$groupIndex$$24_options$$68$$ || (!$groupIndex$$24_options$$68$$.series || 1 > $groupIndex$$24_options$$68$$.series.length) || 1 > $groupCount$$5$$) {
    return D.$JSCompiler_alias_TRUE$$
  }
  ...
  if(D.$DvtChartAxisUtils$$.$isMixedFrequency$($chart$$136$$)) {
    for($groupItem$$1_seriesIndex$$43$$ = 0;$groupItem$$1_seriesIndex$$43$$ < $seriesCount$$13$$;$groupItem$$1_seriesIndex$$43$$++) {
      for($groupIndex$$24_options$$68$$ = 0;$groupIndex$$24_options$$68$$ < $groupCount$$5$$;$groupIndex$$24_options$$68$$++) {
        var $dataItem$$12$$ = D.$DvtChartDataUtils$$.$getDataItem$($chart$$136$$, $groupItem$$1_seriesIndex$$43$$, $groupIndex$$24_options$$68$$);
    ...
    if(D.$DvtChartAxisUtils$$.$hasTimeAxis$($chart$$136$$)) {
      for($groupIndex$$24_options$$68$$ = 0;$groupIndex$$24_options$$68$$ < $groupCount$$5$$;$groupIndex$$24_options$$68$$++) {
        if($groupItem$$1_seriesIndex$$43$$ = D.$DvtChartDataUtils$$.$getGroup$($chart$$136$$, $groupIndex$$24_options$$68$$), $groupItem$$1_seriesIndex$$43$$ == D.$JSCompiler_alias_NULL$$ || (0,window.isNaN)($groupItem$$1_seriesIndex$$43$$)) {
          return D.$JSCompiler_alias_TRUE$$
        }
      }
    }
...
D.$DvtChartDataUtils$$.$processDataObject$ = function $$DvtChartDataUtils$$$$processDataObject$$($chart$$138$$) {
  if(D.$DvtChartDataUtils$$.$hasData$($chart$$138$$)) {
    var $options$$69_refObjs$$1$$ = $chart$$138$$.$getOptions$();
    D.$DvtChartTypeUtils$$.$isValidType$($chart$$138$$) || ($options$$69_refObjs$$1$$.type = "bar");
    var $isStock_total$$2_volumeItem$$ = D.$DvtChartTypeUtils$$.$isStock$($chart$$138$$);
    $isStock_total$$2_volumeItem$$ && ($options$$69_refObjs$$1$$._hasVolume = D.$JSCompiler_alias_FALSE$$, 1 < D.$DvtChartDataUtils$$.$getSeriesCount$($chart$$138$$) && ($options$$69_refObjs$$1$$.series = $options$$69_refObjs$$1$$.series.slice(0, 1)));
    for(var $groups$$2_maxGroups$$ = 0, $arSeriesStyle_value$$100$$ = $chart$$138$$.$SeriesStyleArray$, $groupItems_seriesCount$$14$$ = D.$DvtChartDataUtils$$.$getSeriesCount$($chart$$138$$), $i$$193_volumeSeries$$ = 0;$i$$193_volumeSeries$$ < $groupItems_seriesCount$$14$$;$i$$193_volumeSeries$$++) {
      ...
      if(D.$DvtChartTypeUtils$$.$isFunnel$($chart$$138$$) || $isStock_total$$2_volumeItem$$) {
        $group$$16_item$$3_seriesItem$$4_seriesItems$$4_sorting$$.displayInLegend = "off"
      }
      ...
      if($group$$16_item$$3_seriesItem$$4_seriesItems$$4_sorting$$ && $group$$16_item$$3_seriesItem$$4_seriesItems$$4_sorting$$.items) {
        ...
        for($groupCount$$6_itemIndex$$5_j$$33_series$$7$$ = 0;$groupCount$$6_itemIndex$$5_j$$33_series$$7$$ < $hiddenCategories$$1_items$$4$$.length;$groupCount$$6_itemIndex$$5_j$$33_series$$7$$++) {
          ...
          $options$$69_refObjs$$1$$._hasVolume = D.$JSCompiler_alias_TRUE$$)))
        }
      }
    }
    if($isStock_total$$2_volumeItem$$ && D.$DvtChartDataUtils$$.$hasVolumeSeries$($chart$$138$$) && !D.$DvtChartTypeUtils$$.$isOverview$($chart$$138$$)) {
      ...
      $options$$69_refObjs$$1$$.series.push($i$$193_volumeSeries$$)
    }
    $options$$69_refObjs$$1$$ = D.$DvtChartRefObjUtils$$.$getRefObjs$($chart$$138$$);
    for($i$$193_volumeSeries$$ = 0;$i$$193_volumeSeries$$ < $options$$69_refObjs$$1$$.length;$i$$193_volumeSeries$$++) {
      if($hiddenCategories$$1_items$$4$$ = $options$$69_refObjs$$1$$[$i$$193_volumeSeries$$].items) {
        for($groupCount$$6_itemIndex$$5_j$$33_series$$7$$ = 0;$groupCount$$6_itemIndex$$5_j$$33_series$$7$$ < $hiddenCategories$$1_items$$4$$.length;$groupCount$$6_itemIndex$$5_j$$33_series$$7$$++) {
    ...
    $options$$69_refObjs$$1$$ = $chart$$138$$.$getOptions$();
    $options$$69_refObjs$$1$$.groups || ($options$$69_refObjs$$1$$.groups = []);
    ...
    for($i$$193_volumeSeries$$ = 0;$i$$193_volumeSeries$$ < $groups$$2_maxGroups$$ - $groupCount$$6_itemIndex$$5_j$$33_series$$7$$;$i$$193_volumeSeries$$++) {
      $group$$16_item$$3_seriesItem$$4_seriesItems$$4_sorting$$ = (0,D.$DvtBundle$getTranslation$$)($options$$69_refObjs$$1$$, "labelDefaultGroupName", "DvtChartBundle", "DEFAULT_GROUP_NAME", $options$$69_refObjs$$1$$.groups.length + 1), $options$$69_refObjs$$1$$.groups.push($group$$16_item$$3_seriesItem$$4_seriesItems$$4_sorting$$)
    }
    $chart$$138$$.$Cache$.groupsArray = D.$JSCompiler_alias_NULL$$;
    D.$DvtChartDataUtils$$.$_processTimeAxis$($chart$$138$$);
    $group$$16_item$$3_seriesItem$$4_seriesItems$$4_sorting$$ = $options$$69_refObjs$$1$$.sorting;
    ...
    if(D.$DvtChartTypeUtils$$.$isBLAC$($chart$$138$$) && D.$DvtChartAxisUtils$$.$hasGroupAxis$($chart$$138$$) && "off" != $group$$16_item$$3_seriesItem$$4_seriesItems$$4_sorting$$ && 1 == D.$DvtChartDataUtils$$.$getNumLevels$($chart$$138$$)) {
      for(var $groups$$2_maxGroups$$ = D.$DvtChartDataUtils$$.$getGroups$($chart$$138$$), $totalsMap$$ = {}, $groupCount$$6_itemIndex$$5_j$$33_series$$7$$ = 0;$groupCount$$6_itemIndex$$5_j$$33_series$$7$$ < $groups$$2_maxGroups$$.length;$groupCount$$6_itemIndex$$5_j$$33_series$$7$$++) {
        ...
        $totalsMap$$[$groups$$2_maxGroups$$[$groupCount$$6_itemIndex$$5_j$$33_series$$7$$]] = {index:$groupCount$$6_itemIndex$$5_j$$33_series$$7$$, total:$isStock_total$$2_volumeItem$$, group:$options$$69_refObjs$$1$$.groups[$groupCount$$6_itemIndex$$5_j$$33_series$$7$$]}
      }
      "ascending" == $group$$16_item$$3_seriesItem$$4_seriesItems$$4_sorting$$ ? $groups$$2_maxGroups$$.sort(function($chart$$138$$, $options$$69_refObjs$$1$$) {
        return $totalsMap$$[$chart$$138$$].total - $totalsMap$$[$options$$69_refObjs$$1$$].total
      }) : $groups$$2_maxGroups$$.sort(function($chart$$138$$, $options$$69_refObjs$$1$$) {
        return $totalsMap$$[$options$$69_refObjs$$1$$].total - $totalsMap$$[$chart$$138$$].total
      });
      for($i$$193_volumeSeries$$ = 0;$i$$193_volumeSeries$$ < $groupItems_seriesCount$$14$$;$i$$193_volumeSeries$$++) {
        ...
        $options$$69_refObjs$$1$$.series[$i$$193_volumeSeries$$].items = $group$$16_item$$3_seriesItem$$4_seriesItems$$4_sorting$$
      }
      ...
      $options$$69_refObjs$$1$$.groups = $groupItems_seriesCount$$14$$;
      $chart$$138$$.$Cache$ = {}
    }
    D.$DvtChartDataUtils$$.$_sanitizeAxis$($options$$69_refObjs$$1$$.xAxis);
    D.$DvtChartDataUtils$$.$_sanitizeAxis$($options$$69_refObjs$$1$$.yAxis);
    D.$DvtChartDataUtils$$.$_sanitizeAxis$($options$$69_refObjs$$1$$.y2Axis)
  }
};
...
D.$DvtChartDataUtils$$.$_processTimeAxis$ = function $$DvtChartDataUtils$$$$_processTimeAxis$$($chart$$139_refObjs$$2$$) {
  var $context$$52$$ = $chart$$139_refObjs$$2$$.$getCtx$(), $i$$194_options$$70_xOptions$$ = $chart$$139_refObjs$$2$$.$getOptions$(), $group$$17_seriesIndex$$45$$, $groupIndex$$25_items$$5$$, $seriesCount$$15$$ = D.$DvtChartDataUtils$$.$getSeriesCount$($chart$$139_refObjs$$2$$), $groupCount$$7_j$$34$$ = D.$DvtChartDataUtils$$.$getGroupCount$($chart$$139_refObjs$$2$$);
  if(D.$DvtChartAxisUtils$$.$isMixedFrequency$($chart$$139_refObjs$$2$$)) {
    ...
    if(D.$DvtChartAxisUtils$$.$hasTimeAxis$($chart$$139_refObjs$$2$$)) {
      for($groupIndex$$25_items$$5$$ = 0;$groupIndex$$25_items$$5$$ < $groupCount$$7_j$$34$$;$groupIndex$$25_items$$5$$++) {
        $group$$17_seriesIndex$$45$$ = D.$DvtChartDataUtils$$.$getGroup$($chart$$139_refObjs$$2$$, $groupIndex$$25_items$$5$$), $group$$17_seriesIndex$$45$$ != D.$JSCompiler_alias_NULL$$ && ($i$$194_options$$70_xOptions$$.groups[$groupIndex$$25_items$$5$$] = D.$DvtChartDataUtils$$.$_sanitizeDateTime$($context$$52$$, $group$$17_seriesIndex$$45$$))
      }
      $chart$$139_refObjs$$2$$.$Cache$.groupsArray = D.$JSCompiler_alias_NULL$$
    }
  }
  if(D.$DvtChartAxisUtils$$.$hasTimeAxis$($chart$$139_refObjs$$2$$)) {
    $i$$194_options$$70_xOptions$$ = $i$$194_options$$70_xOptions$$.xAxis;
    $i$$194_options$$70_xOptions$$.dataMin != D.$JSCompiler_alias_NULL$$ && ($i$$194_options$$70_xOptions$$.dataMin = D.$DvtChartDataUtils$$.$_sanitizeDateTime$($context$$52$$, $i$$194_options$$70_xOptions$$.dataMin));
    $i$$194_options$$70_xOptions$$.dataMax != D.$JSCompiler_alias_NULL$$ && ($i$$194_options$$70_xOptions$$.dataMax = D.$DvtChartDataUtils$$.$_sanitizeDateTime$($context$$52$$, $i$$194_options$$70_xOptions$$.dataMax));
    $i$$194_options$$70_xOptions$$.min != D.$JSCompiler_alias_NULL$$ && ($i$$194_options$$70_xOptions$$.min = D.$DvtChartDataUtils$$.$_sanitizeDateTime$($context$$52$$, $i$$194_options$$70_xOptions$$.min));
    $i$$194_options$$70_xOptions$$.max != D.$JSCompiler_alias_NULL$$ && ($i$$194_options$$70_xOptions$$.max = D.$DvtChartDataUtils$$.$_sanitizeDateTime$($context$$52$$, $i$$194_options$$70_xOptions$$.max));
    $i$$194_options$$70_xOptions$$.viewportMin != D.$JSCompiler_alias_NULL$$ && ($i$$194_options$$70_xOptions$$.viewportMin = D.$DvtChartDataUtils$$.$_sanitizeDateTime$($context$$52$$, $i$$194_options$$70_xOptions$$.viewportMin));
    $i$$194_options$$70_xOptions$$.viewportMax != D.$JSCompiler_alias_NULL$$ && ($i$$194_options$$70_xOptions$$.viewportMax = D.$DvtChartDataUtils$$.$_sanitizeDateTime$($context$$52$$, $i$$194_options$$70_xOptions$$.viewportMax));
    $i$$194_options$$70_xOptions$$.viewportStartGroup != D.$JSCompiler_alias_NULL$$ && ($i$$194_options$$70_xOptions$$.viewportStartGroup = D.$DvtChartDataUtils$$.$_sanitizeDateTime$($context$$52$$, $i$$194_options$$70_xOptions$$.viewportStartGroup));
    $i$$194_options$$70_xOptions$$.viewportEndGroup != D.$JSCompiler_alias_NULL$$ && ($i$$194_options$$70_xOptions$$.viewportEndGroup = D.$DvtChartDataUtils$$.$_sanitizeDateTime$($context$$52$$, $i$$194_options$$70_xOptions$$.viewportEndGroup));
    $chart$$139_refObjs$$2$$ = D.$DvtChartRefObjUtils$$.$getRefObjs$($chart$$139_refObjs$$2$$);
    for($i$$194_options$$70_xOptions$$ = 0;$i$$194_options$$70_xOptions$$ < $chart$$139_refObjs$$2$$.length;$i$$194_options$$70_xOptions$$++) {
      if($groupIndex$$25_items$$5$$ = $chart$$139_refObjs$$2$$[$i$$194_options$$70_xOptions$$].items) {
...
D.$DvtChartDataUtils$$.$getSeriesItem$ = function $$DvtChartDataUtils$$$$getSeriesItem$$($chart$$146$$, $seriesIndex$$50$$) {
  ...
  var $options$$71$$ = $chart$$146$$.$getOptions$();
  if($options$$71$$.series && $options$$71$$.series.length > $seriesIndex$$50$$) {
    return $options$$71$$.series[$seriesIndex$$50$$]
  }
};
...
D.$DvtChartDataUtils$$.$_getGroupsArray$ = function $$DvtChartDataUtils$$$$_getGroupsArray$$($chart$$153$$) {
  var $i$$196_options$$72$$ = $chart$$153$$.$getOptions$(), $groupsArray$$1$$ = $chart$$153$$.$Cache$.groupsArray;
  if(!$groupsArray$$1$$) {
    $groupsArray$$1$$ = [];
    $i$$196_options$$72$$.groups && ($groupsArray$$1$$ = D.$DvtChartDataUtils$$.$_getNestedGroups$($i$$196_options$$72$$.groups, $groupsArray$$1$$));
    for($i$$196_options$$72$$ = 0;$i$$196_options$$72$$ < $groupsArray$$1$$.length;$i$$196_options$$72$$++) {
      1 == $groupsArray$$1$$[$i$$196_options$$72$$].id.length && ($groupsArray$$1$$[$i$$196_options$$72$$].id = $groupsArray$$1$$[$i$$196_options$$72$$].id[0], $groupsArray$$1$$[$i$$196_options$$72$$].name = $groupsArray$$1$$[$i$$196_options$$72$$].name[0])
    }
...
D.$DvtChartDataUtils$$.$isRefObjInViewport$ = function $$DvtChartDataUtils$$$$isRefObjInViewport$$($chart$$165$$, $items$$6_nextVal$$, $index$$135$$) {
  var $xVal$$3$$ = D.$DvtChartRefObjUtils$$.$getXValue$($chart$$165$$, $items$$6_nextVal$$, $index$$135$$), $isRefObjInViewport_previousVal$$ = (0,D.$JSCompiler_StaticMethods_getFromCachedMap2D$$)($chart$$165$$, "isRefObjInViewport", $xVal$$3$$);
  $isRefObjInViewport_previousVal$$ == D.$JSCompiler_alias_NULL$$ && ($isRefObjInViewport_previousVal$$ = D.$DvtChartRefObjUtils$$.$getXValue$($chart$$165$$, $items$$6_nextVal$$, $index$$135$$ - 1), $items$$6_nextVal$$ = D.$DvtChartRefObjUtils$$.$getXValue$($chart$$165$$, $items$$6_nextVal$$, $index$$135$$ + 1), $isRefObjInViewport_previousVal$$ = D.$DvtChartDataUtils$$.$isXValInViewport$($chart$$165$$, $xVal$$3$$) || D.$DvtChartDataUtils$$.$isXValInViewport$($chart$$165$$, $isRefObjInViewport_previousVal$$) || 
...
D.$DvtChartDataUtils$$.$_computeYAlongLine$ = function $$DvtChartDataUtils$$$$_computeYAlongLine$$($isLog$$, $x1$$17_y$$63$$, $y1$$11$$, $x2$$15$$, $y2$$9$$, $x$$84$$) {
  $isLog$$ && ($y1$$11$$ = D.$DvtMath$$.$log10$($y1$$11$$), $y2$$9$$ = D.$DvtMath$$.$log10$($y2$$9$$));
  $x1$$17_y$$63$$ = $y1$$11$$ + ($y2$$9$$ - $y1$$11$$) * ($x$$84$$ - $x1$$17_y$$63$$) / ($x2$$15$$ - $x1$$17_y$$63$$);
...
D.$DvtChartDataUtils$$.$_getViewportEdgeYValues$ = function $$DvtChartDataUtils$$$$_getViewportEdgeYValues$$($chart$$168$$, $seriesIndex$$62$$) {
  ...
  $prevY$$, $yMin$$3$$, $yMax$$3$$, $groupIndex$$39$$ = 0;$groupIndex$$39$$ < $seriesData$$.length;$groupIndex$$39$$++) {
    if($bIncludeHiddenSeries$$2$$ || D.$DvtChartStyleUtils$$.$isDataItemRendered$($chart$$168$$, $seriesIndex$$62$$, $groupIndex$$39$$)) {
      $x$$85$$ = D.$DvtChartDataUtils$$.$getXValue$($chart$$168$$, $seriesIndex$$62$$, $groupIndex$$39$$), $y$$64$$ = D.$DvtChartDataUtils$$.$getCumulativeValue$($chart$$168$$, $seriesIndex$$62$$, $groupIndex$$39$$, $bIncludeHiddenSeries$$2$$), $prevX$$ != D.$JSCompiler_alias_NULL$$ && ($min$$4$$ != D.$JSCompiler_alias_NULL$$ && ($min$$4$$ > $prevX$$ && $min$$4$$ < $x$$85$$) && ($yMin$$3$$ = D.$DvtChartDataUtils$$.$_computeYAlongLine$($isLog$$1$$, $prevX$$, $prevY$$, $x$$85$$, $y$$64$$, $min$$4$$)), 
      $max$$4_minMax$$3$$ != D.$JSCompiler_alias_NULL$$ && ($max$$4_minMax$$3$$ > $prevX$$ && $max$$4_minMax$$3$$ < $x$$85$$) && ($yMax$$3$$ = D.$DvtChartDataUtils$$.$_computeYAlongLine$($isLog$$1$$, $prevX$$, $prevY$$, $x$$85$$, $y$$64$$, $max$$4_minMax$$3$$))), $prevX$$ = $x$$85$$, $prevY$$ = $y$$64$$
    }
  }
...
D.$DvtChartDataUtils$$.$getMinMaxValue$ = function $$DvtChartDataUtils$$$$getMinMaxValue$$($chart$$169$$, $type$$94$$, $isDataOnly$$) {
  ...
  0;$seriesIndex$$63$$ < $seriesCount$$17$$;$seriesIndex$$63$$++) {
    ...
    if($bIncludeHiddenSeries$$3$$ || D.$DvtChartStyleUtils$$.$isSeriesRendered$($chart$$169$$, $seriesIndex$$63$$)) {
      var $isY2Series_low_radius$$4$$ = D.$DvtChartDataUtils$$.$isAssignedToY2$($chart$$169$$, $seriesIndex$$63$$);
      if(!($isYValue$$ && $isY2Value$$ != $isY2Series_low_radius$$4$$)) {
        ...
        if($i$$200_seriesData$$1$$) {
          for(var $groupIndex$$40_items$$7$$ = 0;$groupIndex$$40_items$$7$$ < $i$$200_seriesData$$1$$.length;$groupIndex$$40_items$$7$$++) {
            if($bIncludeHiddenSeries$$3$$ || D.$DvtChartStyleUtils$$.$isDataItemRendered$($chart$$169$$, $seriesIndex$$63$$, $groupIndex$$40_items$$7$$)) {
              "object" != typeof $i$$200_seriesData$$1$$[$groupIndex$$40_items$$7$$] && ($i$$200_seriesData$$1$$[$groupIndex$$40_items$$7$$] = {y:$i$$200_seriesData$$1$$[$groupIndex$$40_items$$7$$]});
              var $data$$28_edgeValues_hidden_high_seriesItem$$9$$ = $i$$200_seriesData$$1$$[$groupIndex$$40_items$$7$$], $value$$101$$;
              $isYValue$$ ? $isRange$$2_refObjects$$ || ($value$$101$$ = D.$DvtChartDataUtils$$.$getCumulativeValue$($chart$$169$$, $seriesIndex$$63$$, $groupIndex$$40_items$$7$$, $bIncludeHiddenSeries$$3$$)) : "x" == $type$$94$$ && D.$DvtChartAxisUtils$$.$hasTimeAxis$($chart$$169$$) && !D.$DvtChartAxisUtils$$.$isMixedFrequency$($chart$$169$$) ? ($value$$101$$ = D.$DvtChartDataUtils$$.$getGroupLabel$($chart$$169$$, $groupIndex$$40_items$$7$$), $data$$28_edgeValues_hidden_high_seriesItem$$9$$ != D.$JSCompiler_alias_NULL$$ && 
              ($data$$28_edgeValues_hidden_high_seriesItem$$9$$.x = $value$$101$$)) : $data$$28_edgeValues_hidden_high_seriesItem$$9$$ != D.$JSCompiler_alias_NULL$$ && ($value$$101$$ = $data$$28_edgeValues_hidden_high_seriesItem$$9$$[$type$$94$$]);
              if(!$limitToViewport$$ || D.$DvtChartDataUtils$$.$isXInViewport$($chart$$169$$, $seriesIndex$$63$$, $groupIndex$$40_items$$7$$)) {
                !$isRange$$2_refObjects$$ && !(0,window.isNaN)($value$$101$$) && ($isY2Series_low_radius$$4$$ = 0, D.$DvtChartTypeUtils$$.$isBubble$($chart$$169$$) && (!$isDataOnly$$ && 0 < $data$$28_edgeValues_hidden_high_seriesItem$$9$$.markerSize) && ($isYValue$$ ? $isY2Series_low_radius$$4$$ = $data$$28_edgeValues_hidden_high_seriesItem$$9$$._yAxisRadius : "x" == $type$$94$$ && ($isY2Series_low_radius$$4$$ = $data$$28_edgeValues_hidden_high_seriesItem$$9$$._xAxisRadius)), $maxValue$$4$$ = window.Math.max($maxValue$$4$$, 
                $isLog$$2_minMax$$4$$ ? $value$$101$$ * window.Math.pow(10, $isY2Series_low_radius$$4$$) : $value$$101$$ + $isY2Series_low_radius$$4$$), $minValue$$5$$ = window.Math.min($minValue$$5$$, $isLog$$2_minMax$$4$$ ? $value$$101$$ / window.Math.pow(10, $isY2Series_low_radius$$4$$) : $value$$101$$ - $isY2Series_low_radius$$4$$)), $isRange$$2_refObjects$$ && ($data$$28_edgeValues_hidden_high_seriesItem$$9$$ = D.$DvtChartDataUtils$$.$getHighValue$($chart$$169$$, $seriesIndex$$63$$, $groupIndex$$40_items$$7$$), 
                $isY2Series_low_radius$$4$$ = D.$DvtChartDataUtils$$.$getLowValue$($chart$$169$$, $seriesIndex$$63$$, $groupIndex$$40_items$$7$$), $maxValue$$4$$ = window.Math.max($maxValue$$4$$, $data$$28_edgeValues_hidden_high_seriesItem$$9$$, $isY2Series_low_radius$$4$$), $minValue$$5$$ = window.Math.min($minValue$$5$$, $data$$28_edgeValues_hidden_high_seriesItem$$9$$, $isY2Series_low_radius$$4$$))
              }
            }
          }
          ...
          if($isRange$$2_refObjects$$ != D.$JSCompiler_alias_NULL$$) {
            for($i$$200_seriesData$$1$$ = 0;$i$$200_seriesData$$1$$ < $isRange$$2_refObjects$$.length;$i$$200_seriesData$$1$$++) {
              var $j$$36_refObj$$6$$ = $isRange$$2_refObjects$$[$i$$200_seriesData$$1$$], $groupIndex$$40_items$$7$$ = $j$$36_refObj$$6$$.items, $data$$28_edgeValues_hidden_high_seriesItem$$9$$ = "withRescale" == D.$DvtChartEventUtils$$.$getHideAndShowBehavior$($chart$$169$$) && "hidden" == $j$$36_refObj$$6$$.visibility;
              if(!$data$$28_edgeValues_hidden_high_seriesItem$$9$$) {
                if($groupIndex$$40_items$$7$$ && !$data$$28_edgeValues_hidden_high_seriesItem$$9$$) {
                  for($j$$36_refObj$$6$$ = 0;$j$$36_refObj$$6$$ < $groupIndex$$40_items$$7$$.length;$j$$36_refObj$$6$$++) {
                    if(!($groupIndex$$40_items$$7$$[$j$$36_refObj$$6$$] == D.$JSCompiler_alias_NULL$$ || $limitToViewport$$ && !D.$DvtChartDataUtils$$.$isRefObjInViewport$($chart$$169$$, $groupIndex$$40_items$$7$$, $j$$36_refObj$$6$$))) {
                      var $isY2Series_low_radius$$4$$ = D.$DvtChartRefObjUtils$$.$getLowValue$($groupIndex$$40_items$$7$$[$j$$36_refObj$$6$$]), $data$$28_edgeValues_hidden_high_seriesItem$$9$$ = D.$DvtChartRefObjUtils$$.$getHighValue$($groupIndex$$40_items$$7$$[$j$$36_refObj$$6$$]), $val$$20$$ = (0,window.isNaN)($groupIndex$$40_items$$7$$[$j$$36_refObj$$6$$]) ? $groupIndex$$40_items$$7$$[$j$$36_refObj$$6$$].value : $groupIndex$$40_items$$7$$[$j$$36_refObj$$6$$];
                      $isY2Series_low_radius$$4$$ != D.$JSCompiler_alias_NULL$$ && (0,window.isFinite)($isY2Series_low_radius$$4$$) && ($minValue$$5$$ = window.Math.min($minValue$$5$$, $isY2Series_low_radius$$4$$), $maxValue$$4$$ = window.Math.max($maxValue$$4$$, $isY2Series_low_radius$$4$$));
                  ...
                  $isY2Series_low_radius$$4$$ = D.$DvtChartRefObjUtils$$.$getLowValue$($j$$36_refObj$$6$$), $data$$28_edgeValues_hidden_high_seriesItem$$9$$ = D.$DvtChartRefObjUtils$$.$getHighValue$($j$$36_refObj$$6$$), $val$$20$$ = $j$$36_refObj$$6$$.value, $isY2Series_low_radius$$4$$ != D.$JSCompiler_alias_NULL$$ && (0,window.isFinite)($isY2Series_low_radius$$4$$) && ($minValue$$5$$ = window.Math.min($minValue$$5$$, $isY2Series_low_radius$$4$$), $maxValue$$4$$ = window.Math.max($maxValue$$4$$, 
                  $isY2Series_low_radius$$4$$)), $data$$28_edgeValues_hidden_high_seriesItem$$9$$ != D.$JSCompiler_alias_NULL$$ && (0,window.isFinite)($data$$28_edgeValues_hidden_high_seriesItem$$9$$) && ($minValue$$5$$ = window.Math.min($minValue$$5$$, $data$$28_edgeValues_hidden_high_seriesItem$$9$$), $maxValue$$4$$ = window.Math.max($maxValue$$4$$, $data$$28_edgeValues_hidden_high_seriesItem$$9$$)), $val$$20$$ != D.$JSCompiler_alias_NULL$$ && (0,window.isFinite)($val$$20$$) && ($minValue$$5$$ = 
                  window.Math.min($minValue$$5$$, $val$$20$$), $maxValue$$4$$ = window.Math.max($maxValue$$4$$, $val$$20$$))
                }
              }
            }
          }
...
D.$DvtChartDataUtils$$.$getInitialSelection$ = function $$DvtChartDataUtils$$$$getInitialSelection$$($chart$$171_peers$$2$$) {
  ...
  for(var $i$$201$$ = 0;$i$$201$$ < $selection$$16$$.length;$i$$201$$++) {
    var $id$$33$$;
    "string" == typeof $selection$$16$$[$i$$201$$] ? ($id$$33$$ = $selection$$16$$[$i$$201$$], $selection$$16$$[$i$$201$$] = {id:$id$$33$$}) : $id$$33$$ = $selection$$16$$[$i$$201$$].id;
    if($id$$33$$ != D.$JSCompiler_alias_NULL$$ && (!$selection$$16$$[$i$$201$$].series || !$selection$$16$$[$i$$201$$].group)) {
      for(var $j$$37$$ = 0;$j$$37$$ < $chart$$171_peers$$2$$.length;$j$$37$$++) {
        var $peer$$17$$ = $chart$$171_peers$$2$$[$j$$37$$];
        if($id$$33$$ == $peer$$17$$.$_dataItemId$) {
...
D.$DvtChartDataUtils$$.$isDataSelected$ = function $$DvtChartDataUtils$$$$isDataSelected$$($chart$$174_selection$$18$$, $series$$10_seriesIndex$$65$$, $group$$22_groupIndex$$41$$) {
  var $id$$34$$ = D.$DvtChartDataUtils$$.$getDataItem$($chart$$174_selection$$18$$, $series$$10_seriesIndex$$65$$, $group$$22_groupIndex$$41$$).id;
  ...
  for(var $i$$203$$ = 0;$i$$203$$ < $chart$$174_selection$$18$$.length;$i$$203$$++) {
    if($id$$34$$ != D.$JSCompiler_alias_NULL$$ && ($id$$34$$ == $chart$$174_selection$$18$$[$i$$203$$] || $id$$34$$ == $chart$$174_selection$$18$$[$i$$203$$].id) || $series$$10_seriesIndex$$65$$ == $chart$$174_selection$$18$$[$i$$203$$].series && $group$$22_groupIndex$$41$$ == $chart$$174_selection$$18$$[$i$$203$$].group) {
      return D.$JSCompiler_alias_TRUE$$
    }
  }
  return D.$JSCompiler_alias_FALSE$$
};
D.$DvtChartDataUtils$$.$getDataLabel$ = function $$DvtChartDataUtils$$$$getDataLabel$$($chart$$175$$, $axis$$75_seriesIndex$$66_valueFormat$$, $dataItem$$21_groupIndex$$42_label$$28$$, $type$$95$$) {
  $dataItem$$21_groupIndex$$42_label$$28$$ = D.$DvtChartDataUtils$$.$getDataItem$($chart$$175$$, $axis$$75_seriesIndex$$66_valueFormat$$, $dataItem$$21_groupIndex$$42_label$$28$$);
  if(!$dataItem$$21_groupIndex$$42_label$$28$$) {
    return D.$JSCompiler_alias_NULL$$
  }
  $dataItem$$21_groupIndex$$42_label$$28$$ = $dataItem$$21_groupIndex$$42_label$$28$$.label;
  "low" == $type$$95$$ ? $dataItem$$21_groupIndex$$42_label$$28$$ = $dataItem$$21_groupIndex$$42_label$$28$$ instanceof window.Array ? $dataItem$$21_groupIndex$$42_label$$28$$[0] : $dataItem$$21_groupIndex$$42_label$$28$$ : "high" == $type$$95$$ && ($dataItem$$21_groupIndex$$42_label$$28$$ = $dataItem$$21_groupIndex$$42_label$$28$$ instanceof window.Array ? $dataItem$$21_groupIndex$$42_label$$28$$[1] : D.$JSCompiler_alias_NULL$$);
  if($dataItem$$21_groupIndex$$42_label$$28$$ != D.$JSCompiler_alias_NULL$$) {
    if("number" == typeof $dataItem$$21_groupIndex$$42_label$$28$$) {
      var $min$$5$$, $max$$5$$, $axisInfo$$13_majorIncrement$$;
      if($axis$$75_seriesIndex$$66_valueFormat$$ = D.$DvtChartDataUtils$$.$isAssignedToY2$($chart$$175$$, $axis$$75_seriesIndex$$66_valueFormat$$) && $chart$$175$$.$y2Axis$ ? $chart$$175$$.$y2Axis$ : $chart$$175$$.$yAxis$) {
        $axisInfo$$13_majorIncrement$$ = $axis$$75_seriesIndex$$66_valueFormat$$.$Info$, $min$$5$$ = $axisInfo$$13_majorIncrement$$.$GlobalMin$, $max$$5$$ = $axisInfo$$13_majorIncrement$$.$GlobalMax$, $axisInfo$$13_majorIncrement$$ = $axisInfo$$13_majorIncrement$$.$getMajorIncrement$()
      }
      $axis$$75_seriesIndex$$66_valueFormat$$ = D.$DvtChartTooltipUtils$$.$getValueFormat$($chart$$175$$, "label");
      return D.$DvtChartTooltipUtils$$.$formatValue$($chart$$175$$.$getCtx$(), $axis$$75_seriesIndex$$66_valueFormat$$, $dataItem$$21_groupIndex$$42_label$$28$$, $min$$5$$, $max$$5$$, $axisInfo$$13_majorIncrement$$)
    }
    return $dataItem$$21_groupIndex$$42_label$$28$$
  }
  return D.$JSCompiler_alias_NULL$$
};
...
D.$DvtChartDataUtils$$.$getStackCategories$ = function $$DvtChartDataUtils$$$$getStackCategories$$($chart$$177$$, $type$$96$$, $bIncludeHiddenSeries$$4$$) {
  for(var $yCategories$$ = [], $y2Categories$$ = [], $s$$12$$ = 0;$s$$12$$ < D.$DvtChartDataUtils$$.$getSeriesCount$($chart$$177$$);$s$$12$$++) {
    if(!($type$$96$$ && D.$DvtChartStyleUtils$$.$getSeriesType$($chart$$177$$, $s$$12$$) != $type$$96$$ && "candlestick" != D.$DvtChartStyleUtils$$.$getSeriesType$($chart$$177$$, $s$$12$$) || !D.$DvtChartStyleUtils$$.$isSeriesRendered$($chart$$177$$, $s$$12$$) && !$bIncludeHiddenSeries$$4$$)) {
      var $category$$5$$ = D.$DvtChartDataUtils$$.$getStackCategory$($chart$$177$$, $s$$12$$);
      D.$DvtChartDataUtils$$.$isAssignedToY2$($chart$$177$$, $s$$12$$) ? -1 == $y2Categories$$.indexOf($category$$5$$) && $y2Categories$$.push($category$$5$$) : -1 == $yCategories$$.indexOf($category$$5$$) && $yCategories$$.push($category$$5$$)
    }
  }
...
D.$DvtChartDataUtils$$.$getBarInfo$ = function $$DvtChartDataUtils$$$$getBarInfo$$($chart$$179_dataPos$$5$$, $barWidth$$6_seriesIndex$$68$$, $groupIndex$$44_stackWidth$$, $availSpace$$78$$) {
  var $bHoriz$$9_x1$$18$$ = D.$DvtChartTypeUtils$$.$isHorizontal$($chart$$179_dataPos$$5$$), $bStacked$$1_baseCoord$$1_highValue$$1$$ = D.$DvtChartTypeUtils$$.$isStacked$($chart$$179_dataPos$$5$$), $isRTL$$11_x2$$16$$ = (0,D.$DvtAgent$isRightToLeft$$)($chart$$179_dataPos$$5$$.$getCtx$()), $axisCoord$$3_xAxis$$3$$ = $chart$$179_dataPos$$5$$.$xAxis$, $bRange$$ = D.$DvtChartStyleUtils$$.$isRangeSeries$($chart$$179_dataPos$$5$$, $barWidth$$6_seriesIndex$$68$$), $itemOffset_offsetMap$$ = D.$DvtChartStyleUtils$$.$getBarCategoryOffsetMap$($chart$$179_dataPos$$5$$, 
  ...
  $bHoriz$$9_x1$$18$$ = $isRTL$$11_x2$$16$$ && !$bHoriz$$9_x1$$18$$ ? $xCoord$$8$$ - $itemOffset_offsetMap$$ - $barWidth$$6_seriesIndex$$68$$ : $xCoord$$8$$ + $itemOffset_offsetMap$$;
  $isRTL$$11_x2$$16$$ = $bHoriz$$9_x1$$18$$ + $barWidth$$6_seriesIndex$$68$$;
  if($lowValue$$1_yCoord$$4$$ == $bStacked$$1_baseCoord$$1_highValue$$1$$ && $xValue$$2_yAxis$$3$$.$getCoordAt$($totalYValue$$) === D.$JSCompiler_alias_NULL$$) {
    return D.$JSCompiler_alias_NULL$$
  }
  $chart$$179_dataPos$$5$$ = D.$DvtPlotAreaRenderer$$.$convertAxisCoord$($chart$$179_dataPos$$5$$, new D.$DvtPoint$$(($bHoriz$$9_x1$$18$$ + $isRTL$$11_x2$$16$$) / 2, $bRange$$ ? ($lowValue$$1_yCoord$$4$$ + $bStacked$$1_baseCoord$$1_highValue$$1$$) / 2 : $lowValue$$1_yCoord$$4$$), $availSpace$$78$$);
  return{$x1$:$bHoriz$$9_x1$$18$$, $x2$:$isRTL$$11_x2$$16$$, $axisCoord$:$axisCoord$$3_xAxis$$3$$, $baseCoord$:$bStacked$$1_baseCoord$$1_highValue$$1$$, $yCoord$:$lowValue$$1_yCoord$$4$$, $dataPos$:$chart$$179_dataPos$$5$$, $barWidth$:$barWidth$$6_seriesIndex$$68$$}
};
...
D.$DvtChartEventUtils$$.$setVisibility$ = function $$DvtChartEventUtils$$$$setVisibility$$($chart$$183_options$$73$$, $category$$8$$, $visibility$$2$$) {
  var $hiddenCategories$$2_i$$204_refObj$$7$$ = D.$DvtChartRefObjUtils$$.$getRefObj$($chart$$183_options$$73$$, $category$$8$$);
  if($hiddenCategories$$2_i$$204_refObj$$7$$ != D.$JSCompiler_alias_NULL$$) {
    $hiddenCategories$$2_i$$204_refObj$$7$$.visibility = $visibility$$2$$
  }else {
    var $hiddenCategories$$2_i$$204_refObj$$7$$ = D.$DvtChartStyleUtils$$.$getHiddenCategories$($chart$$183_options$$73$$), $dataSection_index$$136$$ = D.$DvtArrayUtils$$.$getIndex$($hiddenCategories$$2_i$$204_refObj$$7$$, $category$$8$$);
    "hidden" == $visibility$$2$$ && 0 > $dataSection_index$$136$$ ? $hiddenCategories$$2_i$$204_refObj$$7$$.push($category$$8$$) : "visible" == $visibility$$2$$ && 0 <= $dataSection_index$$136$$ && $hiddenCategories$$2_i$$204_refObj$$7$$.splice($dataSection_index$$136$$, 1);
    if(($chart$$183_options$$73$$ = $chart$$183_options$$73$$.$getOptions$()) && $chart$$183_options$$73$$.legend && $chart$$183_options$$73$$.legend.sections) {
      for($hiddenCategories$$2_i$$204_refObj$$7$$ = 0;$hiddenCategories$$2_i$$204_refObj$$7$$ < $chart$$183_options$$73$$.legend.sections.length;$hiddenCategories$$2_i$$204_refObj$$7$$++) {
        if(($dataSection_index$$136$$ = $chart$$183_options$$73$$.legend.sections[$hiddenCategories$$2_i$$204_refObj$$7$$]) && $dataSection_index$$136$$.items) {
          for(var $j$$38$$ = 0;$j$$38$$ < $dataSection_index$$136$$.items.length;$j$$38$$++) {
            $dataSection_index$$136$$.items[$j$$38$$].id == $category$$8$$ && ($dataSection_index$$136$$.items[$j$$38$$].categoryVisibility = $visibility$$2$$)
          }
        }
      }
    }
...
D.$DvtChartEventUtils$$.$adjustBounds$ = function $$DvtChartEventUtils$$$$adjustBounds$$($event$$147$$) {
  $event$$147$$.x != D.$JSCompiler_alias_NULL$$ && ($event$$147$$.x -= 1);
  $event$$147$$.$w$ != D.$JSCompiler_alias_NULL$$ && ($event$$147$$.$w$ += 2);
  $event$$147$$.y != D.$JSCompiler_alias_NULL$$ && ($event$$147$$.y -= 1);
  $event$$147$$.$h$ != D.$JSCompiler_alias_NULL$$ && ($event$$147$$.$h$ += 2)
};
D.$DvtChartEventUtils$$.$getSelectedObjects$ = function $$DvtChartEventUtils$$$$getSelectedObjects$$($chart$$189$$, $event$$148$$, $boundedObjects_selectionHandler$$2$$) {
  ...
  for($i$$206_seriesIdx$$1$$ = 0;$i$$206_seriesIdx$$1$$ < $dataPositions$$.length;$i$$206_seriesIdx$$1$$++) {
    if($dataPos$$7$$ = $dataPositions$$[$i$$206_seriesIdx$$1$$].$pos$) {
      $groupIdx$$1_withinY$$ = $event$$148$$.y == D.$JSCompiler_alias_NULL$$ || $dataPos$$7$$.y >= $event$$148$$.y && $dataPos$$7$$.y <= $event$$148$$.y + $event$$148$$.$h$, ($event$$148$$.x == D.$JSCompiler_alias_NULL$$ || $dataPos$$7$$.x >= $event$$148$$.x && $dataPos$$7$$.x <= $event$$148$$.x + $event$$148$$.$w$) && $groupIdx$$1_withinY$$ && $boundedObjects_selectionHandler$$2$$.push(new D.$DvtChartDataItem$$(D.$JSCompiler_alias_NULL$$, D.$DvtChartDataUtils$$.$getSeries$($chart$$189$$, $dataPositions$$[$i$$206_seriesIdx$$1$$].$seriesIndex$), 
...
D.$DvtChartEventUtils$$.$getBoundedObjects$ = function $$DvtChartEventUtils$$$$getBoundedObjects$$($chart$$190$$, $event$$149$$) {
  for(var $peers$$3$$ = (0,D.$JSCompiler_StaticMethods_getChartObjPeers$$)($chart$$190$$), $boundedPeers$$ = [], $i$$207$$ = 0;$i$$207$$ < $peers$$3$$.length;$i$$207$$++) {
    ...
    if($dataPos$$8$$) {
      var $dataPos$$8$$ = (0,D.$JSCompiler_StaticMethods_localToStage$$)($chart$$190$$.$getPlotArea$(), $dataPos$$8$$), $withinY$$1$$ = $event$$149$$.y == D.$JSCompiler_alias_NULL$$ || $dataPos$$8$$.y >= $event$$149$$.y && $dataPos$$8$$.y <= $event$$149$$.y + $event$$149$$.$h$;
      ($event$$149$$.x == D.$JSCompiler_alias_NULL$$ || $dataPos$$8$$.x >= $event$$149$$.x && $dataPos$$8$$.x <= $event$$149$$.x + $event$$149$$.$w$) && $withinY$$1$$ && $boundedPeers$$.push($peer$$18$$)
    }
  }
  return $boundedPeers$$
};
D.$DvtChartEventUtils$$.$getAxisBounds$ = function $$DvtChartEventUtils$$$$getAxisBounds$$($chart$$191$$, $coords$$22_event$$150$$, $limitExtent$$) {
  var $maxPt_plotArea$$2_yMinMax$$ = $chart$$191$$.$getPlotArea$(), $minPt_xMinMax$$ = $maxPt_plotArea$$2_yMinMax$$.$stageToLocal$(new D.$DvtPoint$$($coords$$22_event$$150$$.x, $coords$$22_event$$150$$.y)), $maxPt_plotArea$$2_yMinMax$$ = $maxPt_plotArea$$2_yMinMax$$.$stageToLocal$(new D.$DvtPoint$$($coords$$22_event$$150$$.x + $coords$$22_event$$150$$.$w$, $coords$$22_event$$150$$.y + $coords$$22_event$$150$$.$h$));
  $coords$$22_event$$150$$.x == D.$JSCompiler_alias_NULL$$ && ($minPt_xMinMax$$.x = D.$JSCompiler_alias_NULL$$, $maxPt_plotArea$$2_yMinMax$$.x = D.$JSCompiler_alias_NULL$$);
  $coords$$22_event$$150$$.y == D.$JSCompiler_alias_NULL$$ && ($minPt_xMinMax$$.y = D.$JSCompiler_alias_NULL$$, $maxPt_plotArea$$2_yMinMax$$.y = D.$JSCompiler_alias_NULL$$);
  $coords$$22_event$$150$$ = D.$DvtChartEventUtils$$.$_convertToAxisCoord$($chart$$191$$, $minPt_xMinMax$$.x, $maxPt_plotArea$$2_yMinMax$$.x, $minPt_xMinMax$$.y, $maxPt_plotArea$$2_yMinMax$$.y);
  var $minPt_xMinMax$$ = {}, $maxPt_plotArea$$2_yMinMax$$ = {}, $y2MinMax$$ = {}, $startEndGroup$$1$$ = {};
  $chart$$191$$.$xAxis$ && ($minPt_xMinMax$$ = D.$DvtChartEventUtils$$.$_getAxisMinMax$($chart$$191$$.$xAxis$, $coords$$22_event$$150$$.$xMin$, $coords$$22_event$$150$$.$xMax$, $limitExtent$$), $startEndGroup$$1$$ = D.$DvtChartEventUtils$$.$getAxisStartEndGroup$($chart$$191$$.$xAxis$, $minPt_xMinMax$$.min, $minPt_xMinMax$$.max));
  $chart$$191$$.$yAxis$ && ($maxPt_plotArea$$2_yMinMax$$ = D.$DvtChartEventUtils$$.$_getAxisMinMax$($chart$$191$$.$yAxis$, $coords$$22_event$$150$$.$yMin$, $coords$$22_event$$150$$.$yMax$, $limitExtent$$));
  $chart$$191$$.$y2Axis$ && ($y2MinMax$$ = D.$DvtChartEventUtils$$.$_getAxisMinMax$($chart$$191$$.$y2Axis$, $coords$$22_event$$150$$.$yMin$, $coords$$22_event$$150$$.$yMax$, $limitExtent$$));
...
D.$DvtChartEventUtils$$.$_getAxisMinMax$ = function $$DvtChartEventUtils$$$$_getAxisMinMax$$($axis$$76$$, $center$$1_min$$6_minCoord$$2$$, $max$$6_maxCoord$$2$$, $limitExtent$$1_minExtent$$) {
  if($center$$1_min$$6_minCoord$$2$$ == D.$JSCompiler_alias_NULL$$ || $max$$6_maxCoord$$2$$ == D.$JSCompiler_alias_NULL$$) {
    return{min:D.$JSCompiler_alias_NULL$$, max:D.$JSCompiler_alias_NULL$$}
  }
  $center$$1_min$$6_minCoord$$2$$ = (0,D.$JSCompiler_StaticMethods_getUnboundedLinearValueAt$$)($axis$$76$$, $center$$1_min$$6_minCoord$$2$$);
  $max$$6_maxCoord$$2$$ = (0,D.$JSCompiler_StaticMethods_getUnboundedLinearValueAt$$)($axis$$76$$, $max$$6_maxCoord$$2$$);
  return $limitExtent$$1_minExtent$$ ? ($limitExtent$$1_minExtent$$ = $axis$$76$$.$Info$.$getMinimumExtent$(), $max$$6_maxCoord$$2$$ - $center$$1_min$$6_minCoord$$2$$ < $limitExtent$$1_minExtent$$ && ($center$$1_min$$6_minCoord$$2$$ = ($max$$6_maxCoord$$2$$ + $center$$1_min$$6_minCoord$$2$$) / 2, $max$$6_maxCoord$$2$$ = $center$$1_min$$6_minCoord$$2$$ + $limitExtent$$1_minExtent$$ / 2, $center$$1_min$$6_minCoord$$2$$ -= $limitExtent$$1_minExtent$$ / 2), D.$DvtChartEventUtils$$.$_limitToGlobal$($axis$$76$$, 
  $center$$1_min$$6_minCoord$$2$$, $max$$6_maxCoord$$2$$)) : D.$DvtChartEventUtils$$.$_getActualMinMax$($axis$$76$$, $center$$1_min$$6_minCoord$$2$$, $max$$6_maxCoord$$2$$)
};
...
D.$DvtChartEventUtils$$.$_getAxisMinMaxByDelta$ = function $$DvtChartEventUtils$$$$_getAxisMinMaxByDelta$$($axis$$77$$, $minDelta$$, $maxDelta$$) {
  var $min$$7$$ = (0,D.$JSCompiler_StaticMethods_getLinearViewportMin$$)($axis$$77$$), $max$$7$$ = (0,D.$JSCompiler_StaticMethods_getLinearViewportMax$$)($axis$$77$$);
  if($maxDelta$$ == $minDelta$$ && (0,D.$JSCompiler_StaticMethods_isFullViewport$$)($axis$$77$$)) {
    return D.$DvtChartEventUtils$$.$_getActualMinMax$($axis$$77$$, $min$$7$$, $max$$7$$)
  }
  var $minDeltaVal$$ = (0,D.$JSCompiler_StaticMethods_getUnboundedLinearValueAt$$)($axis$$77$$, $minDelta$$) - (0,D.$JSCompiler_StaticMethods_getUnboundedLinearValueAt$$)($axis$$77$$, 0), $maxDeltaVal$$ = (0,D.$JSCompiler_StaticMethods_getUnboundedLinearValueAt$$)($axis$$77$$, $maxDelta$$) - (0,D.$JSCompiler_StaticMethods_getUnboundedLinearValueAt$$)($axis$$77$$, 0), $weight$$ = 1, $minExtent$$1$$ = $axis$$77$$.$Info$.$getMinimumExtent$();
  $minDelta$$ != $maxDelta$$ && $max$$7$$ + $maxDeltaVal$$ - ($min$$7$$ + $minDeltaVal$$) < $minExtent$$1$$ && ($weight$$ = ($max$$7$$ - $min$$7$$ - $minExtent$$1$$) / ($minDeltaVal$$ - $maxDeltaVal$$));
  return D.$DvtChartEventUtils$$.$_limitToGlobal$($axis$$77$$, $min$$7$$ + $minDeltaVal$$ * $weight$$, $max$$7$$ + $maxDeltaVal$$ * $weight$$)
};
D.$DvtChartEventUtils$$.$_convertToAxisCoord$ = function $$DvtChartEventUtils$$$$_convertToAxisCoord$$($chart$$193$$, $xMin$$3$$, $xMax$$3$$, $yMin$$4$$, $yMax$$4$$) {
  var $axisCoord$$4$$ = {}, $isRTL$$12$$ = (0,D.$DvtAgent$isRightToLeft$$)($chart$$193$$.$getCtx$());
  D.$DvtChartTypeUtils$$.$isHorizontal$($chart$$193$$) ? ($axisCoord$$4$$.$xMin$ = $yMin$$4$$, $axisCoord$$4$$.$xMax$ = $yMax$$4$$, $axisCoord$$4$$.$yMin$ = $isRTL$$12$$ ? $xMax$$3$$ : $xMin$$3$$, $axisCoord$$4$$.$yMax$ = $isRTL$$12$$ ? $xMin$$3$$ : $xMax$$3$$) : ($axisCoord$$4$$.$xMin$ = $isRTL$$12$$ ? $xMax$$3$$ : $xMin$$3$$, $axisCoord$$4$$.$xMax$ = $isRTL$$12$$ ? $xMin$$3$$ : $xMax$$3$$, $axisCoord$$4$$.$yMin$ = $yMax$$4$$, $axisCoord$$4$$.$yMax$ = $yMin$$4$$);
  return $axisCoord$$4$$
};
D.$DvtChartEventUtils$$.$_limitToGlobal$ = function $$DvtChartEventUtils$$$$_limitToGlobal$$($axis$$78$$, $min$$8$$, $max$$8$$) {
  var $globalMin$$1$$ = $axis$$78$$.$actualToLinear$($axis$$78$$.$Info$.$GlobalMin$), $globalMax$$1$$ = $axis$$78$$.$actualToLinear$($axis$$78$$.$Info$.$GlobalMax$);
  ...
  return D.$DvtChartEventUtils$$.$_getActualMinMax$($axis$$78$$, $min$$8$$, $max$$8$$)
};
D.$DvtChartEventUtils$$.$_getActualMinMax$ = function $$DvtChartEventUtils$$$$_getActualMinMax$$($axis$$79$$, $min$$9$$, $max$$9$$) {
  return{min:$axis$$79$$.$linearToActual$($min$$9$$), max:$axis$$79$$.$linearToActual$($max$$9$$)}
};
D.$DvtChartEventUtils$$.$getAxisStartEndGroup$ = function $$DvtChartEventUtils$$$$getAxisStartEndGroup$$($axis$$80_endGroup$$2$$, $min$$10_startGroup$$2_startIdx$$, $endIdx_max$$10$$) {
  return(0,D.$JSCompiler_StaticMethods_isGroupAxis$$)($axis$$80_endGroup$$2$$) && ($min$$10_startGroup$$2_startIdx$$ != D.$JSCompiler_alias_NULL$$ && $endIdx_max$$10$$ != D.$JSCompiler_alias_NULL$$) && ($min$$10_startGroup$$2_startIdx$$ = window.Math.ceil($min$$10_startGroup$$2_startIdx$$), $endIdx_max$$10$$ = window.Math.floor($endIdx_max$$10$$), $endIdx_max$$10$$ >= $min$$10_startGroup$$2_startIdx$$) ? ($min$$10_startGroup$$2_startIdx$$ = $axis$$80_endGroup$$2$$.$Info$.$getGroup$($min$$10_startGroup$$2_startIdx$$), 
  $axis$$80_endGroup$$2$$ = $axis$$80_endGroup$$2$$.$Info$.$getGroup$($endIdx_max$$10$$), {$startGroup$:$min$$10_startGroup$$2_startIdx$$, $endGroup$:$axis$$80_endGroup$$2$$}) : {$startGroup$:D.$JSCompiler_alias_NULL$$, $endGroup$:D.$JSCompiler_alias_NULL$$}
};
...
D.$DvtChartRefObjUtils$$.$getRefObjs$ = function $$DvtChartRefObjUtils$$$$getRefObjs$$($chart$$202_y2$$12$$) {
  var $x$$86$$ = D.$DvtChartRefObjUtils$$.$getAxisRefObjs$($chart$$202_y2$$12$$, "x"), $y$$65$$ = D.$DvtChartRefObjUtils$$.$getAxisRefObjs$($chart$$202_y2$$12$$, "y");
  $chart$$202_y2$$12$$ = D.$DvtChartRefObjUtils$$.$getAxisRefObjs$($chart$$202_y2$$12$$, "y2");
  return $x$$86$$.concat($y$$65$$, $chart$$202_y2$$12$$)
};
D.$DvtChartRefObjUtils$$.$getAxisRefObjs$ = function $$DvtChartRefObjUtils$$$$getAxisRefObjs$$($chart$$203$$, $axisType$$5$$) {
  var $options$$74$$ = $chart$$203$$.$getOptions$();
  return $options$$74$$ && $options$$74$$[$axisType$$5$$ + "Axis"] && $options$$74$$[$axisType$$5$$ + "Axis"].referenceObjects ? $options$$74$$[$axisType$$5$$ + "Axis"].referenceObjects : []
};
...
D.$DvtChartRefObjUtils$$.$getRefObj$ = function $$DvtChartRefObjUtils$$$$getRefObj$$($chart$$204$$, $id$$35$$) {
  for(var $refObjs$$3$$ = D.$DvtChartRefObjUtils$$.$getRefObjs$($chart$$204$$), $i$$210$$ = 0;$i$$210$$ < $refObjs$$3$$.length;$i$$210$$++) {
    if(D.$DvtChartRefObjUtils$$.getId($refObjs$$3$$[$i$$210$$]) == $id$$35$$) {
...
D.$DvtChartRefObjUtils$$.$getXValue$ = function $$DvtChartRefObjUtils$$$$getXValue$$($chart$$205$$, $items$$8$$, $index$$137$$) {
  return $items$$8$$[$index$$137$$] && !(0,window.isNaN)($items$$8$$[$index$$137$$].x) ? $items$$8$$[$index$$137$$].x : D.$DvtChartAxisUtils$$.$hasTimeAxis$($chart$$205$$) && !D.$DvtChartAxisUtils$$.$isMixedFrequency$($chart$$205$$) ? D.$DvtChartDataUtils$$.$getGroupLabel$($chart$$205$$, $index$$137$$) : $index$$137$$
};
D.$DvtChartSeriesEffectUtils$$ = {};
D.$DvtObj$$.$createSubclass$(D.$DvtChartSeriesEffectUtils$$, D.$DvtObj$$, "DvtChartSeriesEffectUtils");
D.$DvtChartSeriesEffectUtils$$.$getBarFill$ = function $$DvtChartSeriesEffectUtils$$$$getBarFill$$($chart$$206_colors$$, $pattern$$2_seriesIndex$$74$$, $groupIndex$$47_seriesEffect$$, $angle$$9_bHoriz$$10$$, $barWidth$$7$$) {
...
D.$DvtChartStyleUtils$$.$getSeriesType$ = function $$DvtChartStyleUtils$$$$getSeriesType$$($chart$$211$$, $seriesIndex$$78$$) {
  ...
  var $series$$12_seriesItem$$14_seriesType$$6_typeIndex$$ = D.$DvtChartDataUtils$$.$getSeriesItem$($chart$$211$$, $seriesIndex$$78$$), $series$$12_seriesItem$$14_seriesType$$6_typeIndex$$ = $series$$12_seriesItem$$14_seriesType$$6_typeIndex$$ ? $series$$12_seriesItem$$14_seriesType$$6_typeIndex$$.type : D.$JSCompiler_alias_NULL$$;
  !D.$DvtChartTypeUtils$$.$isStock$($chart$$211$$) && "candlestick" == $series$$12_seriesItem$$14_seriesType$$6_typeIndex$$ && ($series$$12_seriesItem$$14_seriesType$$6_typeIndex$$ = "auto");
  if(!$series$$12_seriesItem$$14_seriesType$$6_typeIndex$$ || "auto" == $series$$12_seriesItem$$14_seriesType$$6_typeIndex$$) {
    ...
    if(D.$DvtChartTypeUtils$$.$isCombo$($chart$$211$$)) {
      return $series$$12_seriesItem$$14_seriesType$$6_typeIndex$$ = D.$DvtChartDataUtils$$.$getSeries$($chart$$211$$, $seriesIndex$$78$$), $series$$12_seriesItem$$14_seriesType$$6_typeIndex$$ = D.$DvtChartDataUtils$$.$getSeriesStyleIndex$($chart$$211$$, $series$$12_seriesItem$$14_seriesType$$6_typeIndex$$) % D.$DvtChartStyleUtils$$.$_SERIES_TYPE_RAMP$.length, D.$DvtChartStyleUtils$$.$_SERIES_TYPE_RAMP$[$series$$12_seriesItem$$14_seriesType$$6_typeIndex$$]
    }
  }else {
    return $series$$12_seriesItem$$14_seriesType$$6_typeIndex$$
  }
};
D.$DvtChartStyleUtils$$.$isRangeSeries$ = function $$DvtChartStyleUtils$$$$isRangeSeries$$($chart$$212$$, $seriesIndex$$79$$) {
  var $isRange$$3_map$$inline_2439$$;
  $isRange$$3_map$$inline_2439$$ = $chart$$212$$.$Cache$.isRange;
  $isRange$$3_map$$inline_2439$$ || ($isRange$$3_map$$inline_2439$$ = {}, $chart$$212$$.$Cache$.isRange = $isRange$$3_map$$inline_2439$$);
  $isRange$$3_map$$inline_2439$$ = $isRange$$3_map$$inline_2439$$[$seriesIndex$$79$$];
  if($isRange$$3_map$$inline_2439$$ != D.$JSCompiler_alias_NULL$$) {
    return $isRange$$3_map$$inline_2439$$
  }
  $isRange$$3_map$$inline_2439$$ = D.$JSCompiler_alias_FALSE$$;
  var $g$$7_map$$inline_2445_seriesType$$7$$ = D.$DvtChartStyleUtils$$.$getSeriesType$($chart$$212$$, $seriesIndex$$79$$);
  if("bar" == $g$$7_map$$inline_2445_seriesType$$7$$ || "area" == $g$$7_map$$inline_2445_seriesType$$7$$) {
    for($g$$7_map$$inline_2445_seriesType$$7$$ = 0;$g$$7_map$$inline_2445_seriesType$$7$$ < D.$DvtChartDataUtils$$.$getGroupCount$($chart$$212$$);$g$$7_map$$inline_2445_seriesType$$7$$++) {
      if(D.$DvtChartDataUtils$$.$getLowValue$($chart$$212$$, $seriesIndex$$79$$, $g$$7_map$$inline_2445_seriesType$$7$$) != D.$JSCompiler_alias_NULL$$ || D.$DvtChartDataUtils$$.$getHighValue$($chart$$212$$, $seriesIndex$$79$$, $g$$7_map$$inline_2445_seriesType$$7$$) != D.$JSCompiler_alias_NULL$$) {
        $isRange$$3_map$$inline_2439$$ = D.$JSCompiler_alias_TRUE$$;
        break
      }
    }
  }
  $g$$7_map$$inline_2445_seriesType$$7$$ = $chart$$212$$.$Cache$.isRange;
  $g$$7_map$$inline_2445_seriesType$$7$$ || ($g$$7_map$$inline_2445_seriesType$$7$$ = {}, $chart$$212$$.$Cache$.isRange = $g$$7_map$$inline_2445_seriesType$$7$$);
  return $g$$7_map$$inline_2445_seriesType$$7$$[$seriesIndex$$79$$] = $isRange$$3_map$$inline_2439$$
};
...
D.$DvtChartStyleUtils$$.$getColor$ = function $$DvtChartStyleUtils$$$$getColor$$($chart$$214_colorIndex$$, $series$$13_seriesIndex$$80$$, $groupIndex$$49_options$$76_seriesItem$$15$$) {
  var $dataItem$$24_defaultColors$$ = D.$DvtChartDataUtils$$.$getDataItem$($chart$$214_colorIndex$$, $series$$13_seriesIndex$$80$$, $groupIndex$$49_options$$76_seriesItem$$15$$);
  ...
  if("candlestick" == D.$DvtChartStyleUtils$$.$getSeriesType$($chart$$214_colorIndex$$, $series$$13_seriesIndex$$80$$)) {
    return D.$DvtChartStyleUtils$$.$getStockItemColor$($chart$$214_colorIndex$$, $series$$13_seriesIndex$$80$$, $groupIndex$$49_options$$76_seriesItem$$15$$)
  }
  if(($groupIndex$$49_options$$76_seriesItem$$15$$ = D.$DvtChartDataUtils$$.$getSeriesItem$($chart$$214_colorIndex$$, $series$$13_seriesIndex$$80$$)) && $groupIndex$$49_options$$76_seriesItem$$15$$.color) {
    return $groupIndex$$49_options$$76_seriesItem$$15$$.color
  }
  $groupIndex$$49_options$$76_seriesItem$$15$$ = $chart$$214_colorIndex$$.$getOptions$();
  $dataItem$$24_defaultColors$$ = $groupIndex$$49_options$$76_seriesItem$$15$$.styleDefaults.colors;
  ...
  return $groupIndex$$49_options$$76_seriesItem$$15$$.styleDefaults.colors[$chart$$214_colorIndex$$]
};
D.$DvtChartStyleUtils$$.$getStockItemColor$ = function $$DvtChartStyleUtils$$$$getStockItemColor$$($chart$$215$$, $seriesIndex$$81$$, $groupIndex$$50$$) {
  var $options$$77$$ = $chart$$215$$.$getOptions$();
  return D.$DvtChartDataUtils$$.$isStockValueRising$($chart$$215$$, $seriesIndex$$81$$, $groupIndex$$50$$) ? $options$$77$$.styleDefaults.stockRisingColor : $options$$77$$.styleDefaults.stockFallingColor
};
D.$DvtChartStyleUtils$$.$getStockVolumeColor$ = function $$DvtChartStyleUtils$$$$getStockVolumeColor$$($chart$$216$$, $groupIndex$$51$$) {
  var $dataItem$$25_options$$78$$ = D.$DvtChartDataUtils$$.$getDataItem$($chart$$216$$, 0, $groupIndex$$51$$);
  if($dataItem$$25_options$$78$$ && $dataItem$$25_options$$78$$.color) {
    return $dataItem$$25_options$$78$$.color
  }
  $dataItem$$25_options$$78$$ = $chart$$216$$.$getOptions$();
  return $dataItem$$25_options$$78$$.styleDefaults.stockVolumeColor ? $dataItem$$25_options$$78$$.styleDefaults.stockVolumeColor : D.$DvtChartStyleUtils$$.$getStockItemColor$($chart$$216$$, 0, $groupIndex$$51$$)
};
...
D.$DvtChartStyleUtils$$.$getPattern$ = function $$DvtChartStyleUtils$$$$getPattern$$($bRtl$$1_chart$$218_patternIndex$$, $bRisingValue_series$$14_seriesIndex$$83$$, $groupIndex$$52_options$$80$$) {
  ...
  var $dataItem$$26_defaultPatterns_seriesItem$$16$$ = D.$DvtChartDataUtils$$.$getDataItem$($bRtl$$1_chart$$218_patternIndex$$, $bRisingValue_series$$14_seriesIndex$$83$$, $groupIndex$$52_options$$80$$);
  ...
  if("pattern" == D.$DvtChartStyleUtils$$.$getSeriesEffect$($bRtl$$1_chart$$218_patternIndex$$)) {
    if(D.$DvtChartTypeUtils$$.$isStock$ && "candlestick" == D.$DvtChartStyleUtils$$.$getSeriesType$($bRtl$$1_chart$$218_patternIndex$$, $bRisingValue_series$$14_seriesIndex$$83$$)) {
      return $bRisingValue_series$$14_seriesIndex$$83$$ = D.$DvtChartDataUtils$$.$isStockValueRising$($bRtl$$1_chart$$218_patternIndex$$, $bRisingValue_series$$14_seriesIndex$$83$$, $groupIndex$$52_options$$80$$), $bRtl$$1_chart$$218_patternIndex$$ = (0,D.$DvtAgent$isRightToLeft$$)($bRtl$$1_chart$$218_patternIndex$$.$getCtx$()), $bRisingValue_series$$14_seriesIndex$$83$$ ? $bRtl$$1_chart$$218_patternIndex$$ ? "smallDiagonalLeft" : "smallDiagonalRight" : $bRtl$$1_chart$$218_patternIndex$$ ? "smallDiagonalRight" : 
      "smallDiagonalLeft"
    }
    $groupIndex$$52_options$$80$$ = $bRtl$$1_chart$$218_patternIndex$$.$getOptions$();
    $dataItem$$26_defaultPatterns_seriesItem$$16$$ = $groupIndex$$52_options$$80$$.styleDefaults.patterns;
    ...
    return $groupIndex$$52_options$$80$$.styleDefaults.patterns[$bRtl$$1_chart$$218_patternIndex$$]
  }
  return D.$JSCompiler_alias_NULL$$
};
...
D.$DvtChartStyleUtils$$.$getMarkerShape$ = function $$DvtChartStyleUtils$$$$getMarkerShape$$($chart$$223_styleIndex$$3$$, $series$$15_seriesIndex$$88$$, $dataItem$$30_groupIndex$$57$$) {
  var $options$$83_shapeRamp$$ = $chart$$223_styleIndex$$3$$.$getOptions$(), $shape$$36$$ = $options$$83_shapeRamp$$.styleDefaults.markerShape, $seriesItem$$20$$ = D.$DvtChartDataUtils$$.$getSeriesItem$($chart$$223_styleIndex$$3$$, $series$$15_seriesIndex$$88$$);
  $seriesItem$$20$$ && $seriesItem$$20$$.markerShape && ($shape$$36$$ = $seriesItem$$20$$.markerShape);
  ($dataItem$$30_groupIndex$$57$$ = D.$DvtChartDataUtils$$.$getDataItem$($chart$$223_styleIndex$$3$$, $series$$15_seriesIndex$$88$$, $dataItem$$30_groupIndex$$57$$)) && $dataItem$$30_groupIndex$$57$$.markerShape && ($shape$$36$$ = $dataItem$$30_groupIndex$$57$$.markerShape);
  "auto" == $shape$$36$$ && ("bubble" == $chart$$223_styleIndex$$3$$.$getType$() || D.$DvtChartStyleUtils$$.$isRangeSeries$($chart$$223_styleIndex$$3$$, $series$$15_seriesIndex$$88$$) ? $shape$$36$$ = "circle" : ($series$$15_seriesIndex$$88$$ = D.$DvtChartDataUtils$$.$getSeries$($chart$$223_styleIndex$$3$$, $series$$15_seriesIndex$$88$$), $chart$$223_styleIndex$$3$$ = D.$DvtChartDataUtils$$.$getSeriesStyleIndex$($chart$$223_styleIndex$$3$$, $series$$15_seriesIndex$$88$$), $options$$83_shapeRamp$$ = 
  $options$$83_shapeRamp$$.styleDefaults.shapes, $shape$$36$$ = $options$$83_shapeRamp$$[$chart$$223_styleIndex$$3$$ % $options$$83_shapeRamp$$.length]));
  return $shape$$36$$
};
D.$DvtChartStyleUtils$$.$getMarkerSize$ = function $$DvtChartStyleUtils$$$$getMarkerSize$$($chart$$224$$, $seriesIndex$$89_seriesItem$$21$$, $dataItem$$31_groupIndex$$58_markerSize$$6$$) {
  ...
  var $options$$84$$ = $chart$$224$$.$getOptions$();
  $dataItem$$31_groupIndex$$58_markerSize$$6$$ = $dataItem$$31_groupIndex$$58_markerSize$$6$$ && (0,window.Number)($dataItem$$31_groupIndex$$58_markerSize$$6$$.markerSize) ? (0,window.Number)($dataItem$$31_groupIndex$$58_markerSize$$6$$.markerSize) : $seriesIndex$$89_seriesItem$$21$$ && (0,window.Number)($seriesIndex$$89_seriesItem$$21$$.markerSize) ? (0,window.Number)($seriesIndex$$89_seriesItem$$21$$.markerSize) : (0,window.Number)($options$$84$$.styleDefaults.markerSize);
...
D.$DvtChartStyleUtils$$.$getLineWidth$ = function $$DvtChartStyleUtils$$$$getLineWidth$$($chart$$226$$, $seriesIndex$$91$$) {
  var $lineWidth$$4_seriesItem$$23$$ = D.$DvtChartDataUtils$$.$getSeriesItem$($chart$$226$$, $seriesIndex$$91$$), $options$$85$$ = $chart$$226$$.$getOptions$(), $lineWidth$$4_seriesItem$$23$$ = $lineWidth$$4_seriesItem$$23$$ && $lineWidth$$4_seriesItem$$23$$.lineWidth ? $lineWidth$$4_seriesItem$$23$$.lineWidth : $options$$85$$.styleDefaults.lineWidth ? $options$$85$$.styleDefaults.lineWidth : "lineWithArea" == D.$DvtChartStyleUtils$$.$getSeriesType$($chart$$226$$, $seriesIndex$$91$$) ? 2 : 3;
...
D.$DvtChartStyleUtils$$.$getDataItemGaps$ = function $$DvtChartStyleUtils$$$$getDataItemGaps$$($chart$$235_dataItemGaps$$1$$) {
  var $options$$88_percentIndex$$ = $chart$$235_dataItemGaps$$1$$.$getOptions$();
  if(D.$DvtChartTypeUtils$$.$isFunnel$($chart$$235_dataItemGaps$$1$$) && "on" == $options$$88_percentIndex$$.styleDefaults.funnelSliceGaps) {
    return 1
  }
  if($options$$88_percentIndex$$.styleDefaults.sliceGaps != D.$JSCompiler_alias_NULL$$) {
    return $options$$88_percentIndex$$.styleDefaults.sliceGaps
  }
  $chart$$235_dataItemGaps$$1$$ = $options$$88_percentIndex$$.styleDefaults.dataItemGaps;
  "auto" == $chart$$235_dataItemGaps$$1$$ && ($chart$$235_dataItemGaps$$1$$ = "on" == $options$$88_percentIndex$$.styleDefaults.threeDEffect ? "0%" : "50%");
  $options$$88_percentIndex$$ = $chart$$235_dataItemGaps$$1$$ && $chart$$235_dataItemGaps$$1$$.indexOf ? $chart$$235_dataItemGaps$$1$$.indexOf("%") : -1;
  return 0 <= $options$$88_percentIndex$$ ? ($chart$$235_dataItemGaps$$1$$ = $chart$$235_dataItemGaps$$1$$.substring(0, $options$$88_percentIndex$$), $chart$$235_dataItemGaps$$1$$ / 100) : 0
};
...
D.$DvtChartStyleUtils$$.$getHiddenCategories$ = function $$DvtChartStyleUtils$$$$getHiddenCategories$$($chart$$245_options$$89$$) {
  $chart$$245_options$$89$$ = $chart$$245_options$$89$$.$getOptions$();
  $chart$$245_options$$89$$.hiddenCategories || ($chart$$245_options$$89$$.hiddenCategories = []);
  return $chart$$245_options$$89$$.hiddenCategories
};
D.$DvtChartStyleUtils$$.$getHighlightedCategories$ = function $$DvtChartStyleUtils$$$$getHighlightedCategories$$($chart$$246_options$$90$$) {
  $chart$$246_options$$90$$ = $chart$$246_options$$90$$.$getOptions$();
  $chart$$246_options$$90$$.highlightedCategories || ($chart$$246_options$$90$$.highlightedCategories = []);
  return $chart$$246_options$$90$$.highlightedCategories
};
...
D.$DvtChartStyleUtils$$.$isOverviewRendered$ = function $$DvtChartStyleUtils$$$$isOverviewRendered$$($chart$$253$$) {
  var $options$$91$$ = $chart$$253$$.$getOptions$();
  return D.$DvtChartTypeUtils$$.$isOverviewSupported$($chart$$253$$) && "off" != $options$$91$$.overview.rendered
};
...
D.$DvtChartStyleUtils$$.$getBackgroundColor$ = function $$DvtChartStyleUtils$$$$getBackgroundColor$$($chart$$255$$, $useDefault$$) {
  var $options$$93$$ = $chart$$255$$.$getOptions$();
  return $options$$93$$.plotArea.backgroundColor ? $options$$93$$.plotArea.backgroundColor : $useDefault$$ ? "#FFFFFF" : D.$JSCompiler_alias_NULL$$
};
...
D.$DvtChartTextUtils$$.$createText$ = function $$DvtChartTextUtils$$$$createText$$($eventManager$$8$$, $container$$67$$, $text$$46_textString$$6$$, $cssStyle$$25$$, $x$$87$$, $y$$66$$, $width$$44$$, $height$$46$$, $params$$25$$) {
  $text$$46_textString$$6$$ = new D.$DvtOutputText$$($container$$67$$.$getCtx$(), $text$$46_textString$$6$$, $x$$87$$, $y$$66$$);
...
D.$DvtChartTextUtils$$.$areTitlesRendered$ = function $$DvtChartTextUtils$$$$areTitlesRendered$$($chart$$259_options$$94$$) {
  $chart$$259_options$$94$$ = $chart$$259_options$$94$$.$getOptions$();
  return $chart$$259_options$$94$$.title.text || $chart$$259_options$$94$$.subtitle.text || $chart$$259_options$$94$$.footnote.text
};
...
D.$DvtChartTooltipUtils$$.$getDatatip$ = function $$DvtChartTooltipUtils$$$$getDatatip$$($chart$$261_dataContext$$, $seriesIndex$$101$$, $groupIndex$$68$$, $isTabular_tooltipManager$$2$$) {
  ...
  if($isTabular_tooltipManager$$2$$ && $datatip$$5_tooltipFunc$$) {
    ...
    $seriesIndex$$101$$, $groupIndex$$68$$), high:D.$DvtChartDataUtils$$.$getHighValue$($chart$$261_dataContext$$, $seriesIndex$$101$$, $groupIndex$$68$$), color:D.$DvtChartStyleUtils$$.$getColor$($chart$$261_dataContext$$, $seriesIndex$$101$$, $groupIndex$$68$$), open:$dataItem$$34$$.open, close:$dataItem$$34$$.close, volume:$dataItem$$34$$.volume}, (0,D.$JSCompiler_StaticMethods_getCustomTooltip$$)($isTabular_tooltipManager$$2$$, $datatip$$5_tooltipFunc$$, $chart$$261_dataContext$$)
  }
  if($dataItem$$34$$ && $dataItem$$34$$.shortDesc != D.$JSCompiler_alias_NULL$$) {
    return $dataItem$$34$$.shortDesc
  }
  $datatip$$5_tooltipFunc$$ = "";
  D.$DvtChartTypeUtils$$.$isStock$($chart$$261_dataContext$$) ? $datatip$$5_tooltipFunc$$ += D.$DvtChartTooltipUtils$$.$getStockDatatip$($chart$$261_dataContext$$, $groupIndex$$68$$, $isTabular_tooltipManager$$2$$) : ($datatip$$5_tooltipFunc$$ = D.$DvtChartTooltipUtils$$.$_addSeriesDatatip$($datatip$$5_tooltipFunc$$, $chart$$261_dataContext$$, $seriesIndex$$101$$, $isTabular_tooltipManager$$2$$), $datatip$$5_tooltipFunc$$ = D.$DvtChartTooltipUtils$$.$_addGroupDatatip$($datatip$$5_tooltipFunc$$, $chart$$261_dataContext$$, 
  $seriesIndex$$101$$, $groupIndex$$68$$, $isTabular_tooltipManager$$2$$), $datatip$$5_tooltipFunc$$ = D.$DvtChartTooltipUtils$$.$_addValueDatatip$($datatip$$5_tooltipFunc$$, $chart$$261_dataContext$$, $seriesIndex$$101$$, $groupIndex$$68$$, $isTabular_tooltipManager$$2$$));
  return D.$DvtChartTooltipUtils$$.$_processDatatip$($datatip$$5_tooltipFunc$$, $chart$$261_dataContext$$, $isTabular_tooltipManager$$2$$)
};
...
D.$DvtChartTooltipUtils$$.$_addGroupDatatip$ = function $$DvtChartTooltipUtils$$$$_addGroupDatatip$$($datatip$$10$$, $chart$$267$$, $defaultLabel_seriesIndex$$104_twoLabels$$inline_2453_value$$103$$, $groupIndex$$71_levelIndex$$1_numLevels$$3$$, $isTabular$$5$$) {
  var $JSCompiler_StaticMethods_formatLabel$self$$inline_2451_groupLabel_valueFormat$$1$$;
  D.$DvtChartAxisUtils$$.$hasTimeAxis$($chart$$267$$) ? ($JSCompiler_StaticMethods_formatLabel$self$$inline_2451_groupLabel_valueFormat$$1$$ = D.$DvtChartTooltipUtils$$.$getValueFormat$($chart$$267$$, "group"), $defaultLabel_seriesIndex$$104_twoLabels$$inline_2453_value$$103$$ = D.$DvtChartDataUtils$$.$getXValue$($chart$$267$$, $defaultLabel_seriesIndex$$104_twoLabels$$inline_2453_value$$103$$, $groupIndex$$71_levelIndex$$1_numLevels$$3$$), $JSCompiler_StaticMethods_formatLabel$self$$inline_2451_groupLabel_valueFormat$$1$$ = 
  D.$DvtChartTooltipUtils$$.$formatDateValue$($JSCompiler_StaticMethods_formatLabel$self$$inline_2451_groupLabel_valueFormat$$1$$, new window.Date($defaultLabel_seriesIndex$$104_twoLabels$$inline_2453_value$$103$$)), $JSCompiler_StaticMethods_formatLabel$self$$inline_2451_groupLabel_valueFormat$$1$$ == D.$JSCompiler_alias_NULL$$ && ($JSCompiler_StaticMethods_formatLabel$self$$inline_2451_groupLabel_valueFormat$$1$$ = $chart$$267$$.$xAxis$.$Info$, $defaultLabel_seriesIndex$$104_twoLabels$$inline_2453_value$$103$$ = 
  (0,D.$JSCompiler_StaticMethods__formatAxisLabel$$)($JSCompiler_StaticMethods_formatLabel$self$$inline_2451_groupLabel_valueFormat$$1$$, new window.Date($defaultLabel_seriesIndex$$104_twoLabels$$inline_2453_value$$103$$), D.$JSCompiler_alias_NULL$$, D.$JSCompiler_alias_TRUE$$), $JSCompiler_StaticMethods_formatLabel$self$$inline_2451_groupLabel_valueFormat$$1$$ = $defaultLabel_seriesIndex$$104_twoLabels$$inline_2453_value$$103$$[1] != D.$JSCompiler_alias_NULL$$ ? "YMD" == (0,D.$DvtTimeAxisInfo$_getDMYOrder$$)($JSCompiler_StaticMethods_formatLabel$self$$inline_2451_groupLabel_valueFormat$$1$$.$_locale$) || 
  24192E5 > $JSCompiler_StaticMethods_formatLabel$self$$inline_2451_groupLabel_valueFormat$$1$$.$_timeRange$ && 864E5 > $JSCompiler_StaticMethods_formatLabel$self$$inline_2451_groupLabel_valueFormat$$1$$.$_step$ ? $defaultLabel_seriesIndex$$104_twoLabels$$inline_2453_value$$103$$[1] + " " + $defaultLabel_seriesIndex$$104_twoLabels$$inline_2453_value$$103$$[0] : $defaultLabel_seriesIndex$$104_twoLabels$$inline_2453_value$$103$$[0] + " " + $defaultLabel_seriesIndex$$104_twoLabels$$inline_2453_value$$103$$[1] : 
  $defaultLabel_seriesIndex$$104_twoLabels$$inline_2453_value$$103$$[0])) : $JSCompiler_StaticMethods_formatLabel$self$$inline_2451_groupLabel_valueFormat$$1$$ = D.$DvtChartDataUtils$$.$getGroupLabel$($chart$$267$$, $groupIndex$$71_levelIndex$$1_numLevels$$3$$);
  $groupIndex$$71_levelIndex$$1_numLevels$$3$$ = D.$DvtChartDataUtils$$.$getNumLevels$($chart$$267$$);
  $defaultLabel_seriesIndex$$104_twoLabels$$inline_2453_value$$103$$ = "GROUP";
  if(1 == $groupIndex$$71_levelIndex$$1_numLevels$$3$$ || !D.$DvtArrayUtils$$.isArray($JSCompiler_StaticMethods_formatLabel$self$$inline_2451_groupLabel_valueFormat$$1$$)) {
    $datatip$$10$$ = D.$DvtChartTooltipUtils$$.$_addDatatipRow$($datatip$$10$$, $chart$$267$$, "group", $defaultLabel_seriesIndex$$104_twoLabels$$inline_2453_value$$103$$, $JSCompiler_StaticMethods_formatLabel$self$$inline_2451_groupLabel_valueFormat$$1$$, $isTabular$$5$$)
  }else {
    for($groupIndex$$71_levelIndex$$1_numLevels$$3$$ -= 1;0 <= $groupIndex$$71_levelIndex$$1_numLevels$$3$$;$groupIndex$$71_levelIndex$$1_numLevels$$3$$--) {
      $datatip$$10$$ = D.$DvtChartTooltipUtils$$.$_addDatatipRow$($datatip$$10$$, $chart$$267$$, "group", $defaultLabel_seriesIndex$$104_twoLabels$$inline_2453_value$$103$$, $JSCompiler_StaticMethods_formatLabel$self$$inline_2451_groupLabel_valueFormat$$1$$[$groupIndex$$71_levelIndex$$1_numLevels$$3$$], $isTabular$$5$$, $groupIndex$$71_levelIndex$$1_numLevels$$3$$), $JSCompiler_StaticMethods_formatLabel$self$$inline_2451_groupLabel_valueFormat$$1$$[$groupIndex$$71_levelIndex$$1_numLevels$$3$$] && 
      ($defaultLabel_seriesIndex$$104_twoLabels$$inline_2453_value$$103$$ = D.$JSCompiler_alias_NULL$$)
    }
  }
  return $datatip$$10$$
};
...
D.$DvtChartTooltipUtils$$.$_addDatatipRow$ = function $$DvtChartTooltipUtils$$$$_addDatatipRow$$($datatip$$12$$, $chart$$269_isRTL$$13$$, $type$$102$$, $defaultLabel$$1$$, $value$$104$$, $isTabular$$7$$, $index$$138$$) {
  if($value$$104$$ == D.$JSCompiler_alias_NULL$$ || "" === $value$$104$$) {
    return $datatip$$12$$
  }
  var $options$$95$$ = $chart$$269_isRTL$$13$$.$getOptions$().styleDefaults, $valueFormat$$2$$ = D.$DvtChartTooltipUtils$$.$getValueFormat$($chart$$269_isRTL$$13$$, $type$$102$$), $tooltipDisplay$$ = $valueFormat$$2$$.tooltipDisplay;
  if(!$tooltipDisplay$$ || "auto" == $tooltipDisplay$$) {
    if("series" == $type$$102$$ && "none" == $options$$95$$.seriesTooltipType || "group" == $type$$102$$ && ("none" == $options$$95$$.groupTooltipType || D.$DvtChartTypeUtils$$.$isPie$($chart$$269_isRTL$$13$$) || D.$DvtChartTypeUtils$$.$isFunnel$($chart$$269_isRTL$$13$$)) || "series" != $type$$102$$ && ("group" != $type$$102$$ && "label" != $type$$102$$) && "none" == $options$$95$$.valueTooltipType) {
      $tooltipDisplay$$ = "off"
    }
  }
  ...
  var $tooltipLabel$$;
  "string" === typeof $valueFormat$$2$$.tooltipLabel ? $tooltipLabel$$ = $valueFormat$$2$$.tooltipLabel : $valueFormat$$2$$.tooltipLabel && $index$$138$$ != D.$JSCompiler_alias_NULL$$ && ($tooltipLabel$$ = $valueFormat$$2$$.tooltipLabel[$index$$138$$]);
  $tooltipLabel$$ == D.$JSCompiler_alias_NULL$$ && ($tooltipLabel$$ = $defaultLabel$$1$$ == D.$JSCompiler_alias_NULL$$ ? "" : "GROUP" == $defaultLabel$$1$$ && D.$DvtChartAxisUtils$$.$hasTimeAxis$($chart$$269_isRTL$$13$$) ? (0,D.$DvtBundle$getTranslation$$)($chart$$269_isRTL$$13$$.$getOptions$(), "labelDate", "DvtChartBundle", "LABEL_GROUP") : (0,D.$DvtBundle$getTranslatedString$$)("DvtChartBundle", "LABEL_" + $defaultLabel$$1$$, ""));
  "series" != $type$$102$$ && "group" != $type$$102$$ && ($value$$104$$ = D.$DvtChartTooltipUtils$$.$formatValue$($chart$$269_isRTL$$13$$.$getCtx$(), $valueFormat$$2$$, $value$$104$$));
  if($isTabular$$7$$) {
    return $chart$$269_isRTL$$13$$ = (0,D.$DvtAgent$isRightToLeft$$)($chart$$269_isRTL$$13$$.$getCtx$()), $options$$95$$.tooltipLabelStyle.$setStyle$("text-align", $chart$$269_isRTL$$13$$ ? "left" : "right"), $options$$95$$.tooltipValueStyle.$setStyle$("text-align", $chart$$269_isRTL$$13$$ ? "right" : "left"), $datatip$$12$$ + "\x3ctr\x3e" + (0,D.$DvtHtmlTooltipManager$createStartTag$$)("td", $options$$95$$.tooltipLabelStyle) + $tooltipLabel$$ + "\x3c/td\x3e" + (0,D.$DvtHtmlTooltipManager$createStartTag$$)("td", 
    $options$$95$$.tooltipValueStyle) + $value$$104$$ + "\x3c/td\x3e\x3c/tr\x3e"
  }
...
D.$DvtChartTooltipUtils$$.$isDataCursorEnabled$ = function $$DvtChartTooltipUtils$$$$isDataCursorEnabled$$($chart$$271$$) {
  ...
  var $options$$96$$ = $chart$$271$$.$getOptions$();
  return"on" == $options$$96$$.dataCursor ? D.$JSCompiler_alias_TRUE$$ : "off" == $options$$96$$.dataCursor ? D.$JSCompiler_alias_FALSE$$ : (0,D.$DvtAgent$isTouchDevice$$)() && D.$DvtChartTypeUtils$$.$isLineArea$($chart$$271$$)
};
...
D.$DvtChartTypeUtils$$.$isStandalonePlotArea$ = function $$DvtChartTypeUtils$$$$isStandalonePlotArea$$($chart$$311$$) {
  var $options$$98$$ = $chart$$311$$.$getOptions$();
  return D.$DvtChartTextUtils$$.$areTitlesRendered$($chart$$311$$) || "off" != $options$$98$$.legend.rendered || D.$DvtChartAxisUtils$$.$isAxisRendered$($chart$$311$$, "x") || D.$DvtChartAxisUtils$$.$isAxisRendered$($chart$$311$$, "y") || D.$DvtChartAxisUtils$$.$isAxisRendered$($chart$$311$$, "y2") ? D.$JSCompiler_alias_FALSE$$ : D.$JSCompiler_alias_TRUE$$
};
D.$DvtChartTypeUtils$$.$isStandaloneXAxis$ = function $$DvtChartTypeUtils$$$$isStandaloneXAxis$$($chart$$312$$) {
  var $options$$99$$ = $chart$$312$$.$getOptions$();
  return D.$DvtChartTextUtils$$.$areTitlesRendered$($chart$$312$$) || "off" != $options$$99$$.legend.rendered || "off" != $options$$99$$.plotArea.rendered || D.$DvtChartAxisUtils$$.$isAxisRendered$($chart$$312$$, "y") || D.$DvtChartAxisUtils$$.$isAxisRendered$($chart$$312$$, "y2") ? D.$JSCompiler_alias_FALSE$$ : D.$JSCompiler_alias_TRUE$$
};
D.$DvtChartTypeUtils$$.$isStandaloneYAxis$ = function $$DvtChartTypeUtils$$$$isStandaloneYAxis$$($chart$$313$$) {
  var $options$$100$$ = $chart$$313$$.$getOptions$();
  return D.$DvtChartTextUtils$$.$areTitlesRendered$($chart$$313$$) || "off" != $options$$100$$.legend.rendered || D.$DvtChartAxisUtils$$.$isAxisRendered$($chart$$313$$, "x") || "off" != $options$$100$$.plotArea.rendered || D.$DvtChartAxisUtils$$.$isAxisRendered$($chart$$313$$, "y2") ? D.$JSCompiler_alias_FALSE$$ : D.$JSCompiler_alias_TRUE$$
};
D.$DvtChartTypeUtils$$.$isStandaloneY2Axis$ = function $$DvtChartTypeUtils$$$$isStandaloneY2Axis$$($chart$$314$$) {
  var $options$$101$$ = $chart$$314$$.$getOptions$();
  return D.$DvtChartTextUtils$$.$areTitlesRendered$($chart$$314$$) || "off" != $options$$101$$.legend.rendered || D.$DvtChartAxisUtils$$.$isAxisRendered$($chart$$314$$, "x") || D.$DvtChartAxisUtils$$.$isAxisRendered$($chart$$314$$, "y") || "off" != $options$$101$$.plotArea.rendered ? D.$JSCompiler_alias_FALSE$$ : D.$JSCompiler_alias_TRUE$$
};
  ...
  for(var $maxArea_maxMarkerSize_seriesCount$$18$$ = D.$DvtChartDataUtils$$.$getSeriesCount$($chart$$198$$), $seriesIndex$$72$$ = 0;$seriesIndex$$72$$ < $maxArea_maxMarkerSize_seriesCount$$18$$;$seriesIndex$$72$$++) {
    if(D.$DvtChartStyleUtils$$.$isSeriesRendered$($chart$$198$$, $seriesIndex$$72$$)) {
      for(var $seriesItem$$11$$ = D.$DvtChartDataUtils$$.$getSeriesItem$($chart$$198$$, $seriesIndex$$72$$), $numGroups$$7$$ = $seriesItem$$11$$.items ? $seriesItem$$11$$.items.length : 0, $j$$40$$ = 0;$j$$40$$ < $numGroups$$7$$;$j$$40$$++) {
        ...
        $dataItem$$22$$ && $dataItem$$22$$.z && (1 === $maxArea_maxMarkerSize_seriesCount$$18$$ && 1 === $numGroups$$7$$ ? ($dataItem$$22$$.markerSize = D.$DvtChartMarkerUtils$$.$_DEFAULT_MARKER_SIZE_PERCENT$ * window.Math.min($width$$42$$, $height$$44$$), $dataItem$$22$$._xAxisRadius = $isPolar$$5$$ ? 0 : 29, $dataItem$$22$$._yAxisRadius = 29) : ($dataItem$$22$$.markerSize = 2 * window.Math.sqrt(($minArea$$ + ($dataItem$$22$$.z - $minValue$$6$$) / $maxValue$$5_valueRange$$ * $areaRange_maxRadius_minMaxArea$$) / 
        window.Math.PI), $dataItem$$22$$._xAxisRadius = 0.5 * ($dataItem$$22$$.markerSize / $axisWidth$$1$$) * $minMax$$5_xAxisValueRange$$, $dataItem$$22$$._yAxisRadius = 0.5 * ($dataItem$$22$$.markerSize / $axisHeight$$) * $yAxisValueRange$$))
      }
    }
  }
};
...
D.$DvtPieChartUtils$$.$getSliceId$ = function $$DvtPieChartUtils$$$$getSliceId$$($chart$$315$$, $seriesIndex$$109$$) {
  var $dataItem$$36_id$$36$$ = D.$DvtChartDataUtils$$.$getDataItem$($chart$$315$$, $seriesIndex$$109$$, 0), $dataItem$$36_id$$36$$ = $dataItem$$36_id$$36$$ ? $dataItem$$36_id$$36$$.id : D.$JSCompiler_alias_NULL$$, $series$$16$$ = D.$DvtChartDataUtils$$.$getSeries$($chart$$315$$, $seriesIndex$$109$$), $group$$23$$ = D.$DvtChartDataUtils$$.$getGroup$($chart$$315$$, 0);
  return new D.$DvtChartDataItem$$($dataItem$$36_id$$36$$, $series$$16$$, $group$$23$$)
};
...
D.$DvtPieChartUtils$$.$_getSeriesIndicesArrays$ = function $$DvtPieChartUtils$$$$_getSeriesIndicesArrays$$($chart$$322$$) {
  for(var $renderedSeries$$ = [], $otherSeries$$2$$ = [], $seriesCount$$23$$ = D.$DvtChartDataUtils$$.$getSeriesCount$($chart$$322$$), $options$$102$$ = $chart$$322$$.$getOptions$(), $otherThreshold$$ = $options$$102$$.otherThreshold * D.$DvtPieChartUtils$$.$getTotalValue$($chart$$322$$), $seriesIndex$$112$$ = 0;$seriesIndex$$112$$ < $seriesCount$$23$$;$seriesIndex$$112$$++) {
  ...
  "ascending" == $options$$102$$.sorting ? $renderedSeries$$.sort(function($renderedSeries$$, $otherSeries$$2$$) {
    return D.$DvtChartDataUtils$$.getValue($chart$$322$$, $renderedSeries$$, 0) - D.$DvtChartDataUtils$$.getValue($chart$$322$$, $otherSeries$$2$$, 0)
  }) : ("on" == $options$$102$$.sorting || "descending" == $options$$102$$.sorting) && $renderedSeries$$.sort(function($renderedSeries$$, $otherSeries$$2$$) {
...
D.$DvtChartRenderer$$.$render$ = function $$DvtChartRenderer$$$$render$$($chart$$44$$, $container$$25$$, $availSpace$$29$$) {
  ...
  if(D.$DvtChartDataUtils$$.$hasInvalidData$($chart$$44$$)) {
    ...
    D.$DvtChartRenderer$$.$_adjustAvailSpace$($availSpace$$29$$);
    var $maxHeight$$inline_2167_space$$inline_2165$$ = $availSpace$$29$$.$clone$();
    $chart$$44$$.$_axisSpace$ = $maxHeight$$inline_2167_space$$inline_2165$$;
    var $maxWidth$$inline_2166_space$$inline_2170$$;
    D.$DvtChartAxisUtils$$.$isAxisRendered$($chart$$44$$, "x") ? ($maxWidth$$inline_2166_space$$inline_2170$$ = 0.8 * $maxHeight$$inline_2167_space$$inline_2165$$.$w$, $maxHeight$$inline_2167_space$$inline_2165$$ = $maxHeight$$inline_2167_space$$inline_2165$$.$h$ - 5 * D.$DvtChartAxisUtils$$.$getTickLabelFontSize$($chart$$44$$, "x")) : D.$DvtChartAxisUtils$$.$isAxisRendered$($chart$$44$$, "y") ? ($maxWidth$$inline_2166_space$$inline_2170$$ = $maxHeight$$inline_2167_space$$inline_2165$$.$w$, $maxHeight$$inline_2167_space$$inline_2165$$ = 
    $maxHeight$$inline_2167_space$$inline_2165$$.$h$ - D.$DvtChartAxisUtils$$.$getTickLabelFontSize$($chart$$44$$, "y")) : ($maxWidth$$inline_2166_space$$inline_2170$$ = $maxHeight$$inline_2167_space$$inline_2165$$.$w$, $maxHeight$$inline_2167_space$$inline_2165$$ = $maxHeight$$inline_2167_space$$inline_2165$$.$h$);
    $chart$$44$$.$_radius$ = window.Math.min($maxWidth$$inline_2166_space$$inline_2170$$, $maxHeight$$inline_2167_space$$inline_2165$$) / 2;
    ...
    $maxWidth$$inline_2166_space$$inline_2170$$ = $availSpace$$29$$.$clone$();
    $chart$$44$$.$_plotAreaSpace$ = $maxWidth$$inline_2166_space$$inline_2170$$;
...
D.$DvtChartRenderer$$.$_setEventHandlers$ = function $$DvtChartRenderer$$$$_setEventHandlers$$($chart$$45$$) {
  var $options$$38$$ = $chart$$45$$.$getOptions$(), $em$$1$$ = $chart$$45$$.$__getEventManager$();
  if(D.$DvtChartTypeUtils$$.$hasAxes$($chart$$45$$) && !D.$DvtChartTypeUtils$$.$isOverview$($chart$$45$$)) {
    var $chartBounds$$ = new D.$DvtRectangle$$(0, 0, $chart$$45$$.getWidth(), $chart$$45$$.getHeight()), $plotAreaBounds$$1$$ = $chart$$45$$.$_plotAreaSpace$, $axisBounds$$1_vertAxisBounds$$ = $chart$$45$$.$_axisSpace$, $horizAxisBounds$$ = new D.$DvtRectangle$$($plotAreaBounds$$1$$.x, $axisBounds$$1_vertAxisBounds$$.y, $plotAreaBounds$$1$$.$w$, $axisBounds$$1_vertAxisBounds$$.$h$), $axisBounds$$1_vertAxisBounds$$ = new D.$DvtRectangle$$($axisBounds$$1_vertAxisBounds$$.x, $plotAreaBounds$$1$$.y, 
    $axisBounds$$1_vertAxisBounds$$.$w$, $plotAreaBounds$$1$$.$h$), $marqueeFill$$ = new D.$DvtSolidFill$$($options$$38$$.styleDefaults.marqueeColor), $marqueeStroke$$ = new D.$DvtSolidStroke$$($options$$38$$.styleDefaults.marqueeBorderColor), $marqueeHandler_panZoomHandler_zoomRate$$;
    if(D.$DvtChartEventUtils$$.$isScrollable$($chart$$45$$)) {
      ...
      $marqueeHandler_panZoomHandler_zoomRate$$ = new D.$DvtPanZoomHandler$$($chart$$45$$, $plotAreaBounds$$1$$, $chartBounds$$, $marqueeHandler_panZoomHandler_zoomRate$$);
      var $panUpCursor$$inline_2173$$ = $options$$38$$._resources.panCursorUp, $panDownCursor$$inline_2174$$ = $options$$38$$._resources.panCursorDown;
      (0,D.$DvtAgent$isPlatformIE$$)() || ($panUpCursor$$inline_2173$$ && ($marqueeHandler_panZoomHandler_zoomRate$$.$_panUpCursor$ = "url(" + $panUpCursor$$inline_2173$$ + ") 8 8, auto"), $panDownCursor$$inline_2174$$ && ($marqueeHandler_panZoomHandler_zoomRate$$.$_panDownCursor$ = "url(" + $panDownCursor$$inline_2174$$ + ") 8 8, auto"));
      $em$$1$$.$_panZoomHandler$ = $marqueeHandler_panZoomHandler_zoomRate$$;
      D.$DvtChartEventUtils$$.$isZoomable$($chart$$45$$) && ($marqueeHandler_panZoomHandler_zoomRate$$ = D.$DvtChartTypeUtils$$.$isHorizontal$($chart$$45$$) ? new D.$DvtMarqueeHandler$$($chart$$45$$, $plotAreaBounds$$1$$, $chartBounds$$, $marqueeFill$$, $marqueeStroke$$, D.$JSCompiler_alias_FALSE$$, D.$JSCompiler_alias_TRUE$$, D.$JSCompiler_alias_NULL$$, $axisBounds$$1_vertAxisBounds$$) : D.$DvtChartTypeUtils$$.$isBLAC$($chart$$45$$) ? new D.$DvtMarqueeHandler$$($chart$$45$$, $plotAreaBounds$$1$$, 
      $chartBounds$$, $marqueeFill$$, $marqueeStroke$$, D.$JSCompiler_alias_TRUE$$, D.$JSCompiler_alias_FALSE$$, $horizAxisBounds$$, D.$JSCompiler_alias_NULL$$) : new D.$DvtMarqueeHandler$$($chart$$45$$, $plotAreaBounds$$1$$, $chartBounds$$, $marqueeFill$$, $marqueeStroke$$, D.$JSCompiler_alias_TRUE$$, D.$JSCompiler_alias_TRUE$$, $horizAxisBounds$$, $axisBounds$$1_vertAxisBounds$$), $em$$1$$.$_marqueeZoomHandler$ = $marqueeHandler_panZoomHandler_zoomRate$$)
    }
    "multiple" == $options$$38$$.selectionMode && ($marqueeHandler_panZoomHandler_zoomRate$$ = new D.$DvtMarqueeHandler$$($chart$$45$$, $plotAreaBounds$$1$$, $chartBounds$$, $marqueeFill$$, $marqueeStroke$$, D.$JSCompiler_alias_TRUE$$, D.$JSCompiler_alias_TRUE$$, $horizAxisBounds$$, $axisBounds$$1_vertAxisBounds$$), $em$$1$$.$_marqueeSelectHandler$ = $marqueeHandler_panZoomHandler_zoomRate$$)
  }
};
D.$DvtChartRenderer$$.$rerenderAxisAndPlotArea$ = function $$DvtChartRenderer$$$$rerenderAxisAndPlotArea$$($chart$$46$$, $container$$26$$) {
  if(!D.$DvtChartDataUtils$$.$hasInvalidData$($chart$$46$$)) {
    ...
    var $space$$inline_2188$$ = $availSpace$$30$$.$clone$();
    $chart$$46$$.$_plotAreaSpace$ = $space$$inline_2188$$;
...
D.$DvtChartRenderer$$.$_addOuterGaps$ = function $$DvtChartRenderer$$$$_addOuterGaps$$($chart$$48$$, $availSpace$$32$$) {
  var $options$$39$$ = $chart$$48$$.$getOptions$(), $gapWidth$$ = window.Math.ceil($options$$39$$.layout.outerGapWidth * (0,D.$JSCompiler_StaticMethods_getGapWidthRatio$$)($chart$$48$$)), $gapHeight$$ = (0,D.$DvtChartDefaults$getGapHeight$$)($chart$$48$$, $options$$39$$.layout.outerGapHeight);
  if("none" == $options$$39$$.styleDefaults.padding || D.$DvtChartTypeUtils$$.$isStandalonePlotArea$($chart$$48$$) || D.$DvtChartTypeUtils$$.$isStandaloneXAxis$($chart$$48$$) || D.$DvtChartTypeUtils$$.$isStandaloneYAxis$($chart$$48$$) || D.$DvtChartTypeUtils$$.$isStandaloneY2Axis$($chart$$48$$)) {
...
D.$DvtChartRenderer$$.$_renderTitles$ = function $$DvtChartRenderer$$$$_renderTitles$$($chart$$49$$, $container$$28_footnoteObj$$, $availSpace$$33$$) {
  var $options$$40$$ = $chart$$49$$.$getOptions$();
  if($options$$40$$.title.text) {
    var $alignFootnoteToPlotArea_lowerSepObj_titleGapBelow_titleObj$$ = D.$DvtChartTextUtils$$.$createText$($chart$$49$$.$__getEventManager$(), $container$$28_footnoteObj$$, $options$$40$$.title.text, $options$$40$$.title.style, $availSpace$$33$$.x, $availSpace$$33$$.y, $availSpace$$33$$.$w$, $availSpace$$33$$.$h$, (0,D.$DvtChartEventManager$getUIEventParams$$)(D.$DvtChartConstants$$.$TITLE$)), $footnoteAlign_titleHeight$$1_titleSepHeight_upperSepObj$$, $footnoteDims_titleDims$$, $titleAlign$$ = 
    $options$$40$$.title.hAlign != D.$JSCompiler_alias_NULL$$ ? $options$$40$$.title.hAlign : $options$$40$$.title.halign, $alignTitlesToPlotArea$$ = "plotArea" == $titleAlign$$.substring(0, 8);
    ...
    0, 0, 0));
    if($options$$40$$.subtitle.text) {
      var $subtitleObj$$ = new D.$DvtOutputText$$($chart$$49$$.$getCtx$(), $options$$40$$.subtitle.text, $availSpace$$33$$.x, $availSpace$$33$$.y);
      if($subtitleObj$$) {
        $subtitleObj$$.$setCSSStyle$($options$$40$$.subtitle.style);
        $container$$28_footnoteObj$$.$addChild$($subtitleObj$$);
        var $subtitleDims$$ = $subtitleObj$$.$measureDimensions$(), $titleSubtitleGap$$ = window.Math.ceil($options$$40$$.layout.titleSubtitleGapWidth * (0,D.$JSCompiler_StaticMethods_getGapWidthRatio$$)($chart$$49$$)), $titleSpace$$1$$ = $footnoteDims_titleDims$$.$w$ + $titleSubtitleGap$$ + $subtitleDims$$.$w$;
        $titleSpace$$1$$ > $availSpace$$33$$.$w$ || $alignTitlesToPlotArea$$ ? ($titleSubtitleGap$$ = (0,D.$DvtChartDefaults$getGapHeight$$)($chart$$49$$, $options$$40$$.layout.titleSubtitleGapHeight), $subtitleObj$$.$setY$($availSpace$$33$$.y + $footnoteAlign_titleHeight$$1_titleSepHeight_upperSepObj$$ + $titleSubtitleGap$$), D.$DvtTextUtils$$.$fitText$($subtitleObj$$, $availSpace$$33$$.$w$, $availSpace$$33$$.$h$, $container$$28_footnoteObj$$) && ($subtitleDims$$ = $subtitleObj$$.$measureDimensions$(), 
    ...
    $alignFootnoteToPlotArea_lowerSepObj_titleGapBelow_titleObj$$ = "on" == $options$$40$$.titleSeparator.rendered ? $options$$40$$.layout.titleSeparatorGap : $options$$40$$.layout.titlePlotAreaGap;
    ...
    "on" == $options$$40$$.titleSeparator.rendered && ($footnoteAlign_titleHeight$$1_titleSepHeight_upperSepObj$$ = new D.$DvtLine$$($chart$$49$$.$getCtx$(), $availSpace$$33$$.x, $availSpace$$33$$.y, $availSpace$$33$$.x + $availSpace$$33$$.$w$, $availSpace$$33$$.y), $alignFootnoteToPlotArea_lowerSepObj_titleGapBelow_titleObj$$ = new D.$DvtLine$$($chart$$49$$.$getCtx$(), $availSpace$$33$$.x, $availSpace$$33$$.y + 1, $availSpace$$33$$.x + $availSpace$$33$$.$w$, $availSpace$$33$$.y + 1), $footnoteAlign_titleHeight$$1_titleSepHeight_upperSepObj$$.$setSolidStroke$($options$$40$$.titleSeparator.upperColor), 
    $alignFootnoteToPlotArea_lowerSepObj_titleGapBelow_titleObj$$.$setSolidStroke$($options$$40$$.titleSeparator.lowerColor), $container$$28_footnoteObj$$.$addChild$($footnoteAlign_titleHeight$$1_titleSepHeight_upperSepObj$$), $container$$28_footnoteObj$$.$addChild$($alignFootnoteToPlotArea_lowerSepObj_titleGapBelow_titleObj$$), $footnoteAlign_titleHeight$$1_titleSepHeight_upperSepObj$$ = 2 + (0,D.$DvtChartDefaults$getGapHeight$$)($chart$$49$$, $options$$40$$.layout.titlePlotAreaGap), $availSpace$$33$$.y += 
  ...
  $options$$40$$.footnote.text && ($container$$28_footnoteObj$$ = D.$DvtChartTextUtils$$.$createText$($chart$$49$$.$__getEventManager$(), $container$$28_footnoteObj$$, $options$$40$$.footnote.text, $options$$40$$.footnote.style, $availSpace$$33$$.x, 0, $availSpace$$33$$.$w$, $availSpace$$33$$.$h$, (0,D.$DvtChartEventManager$getUIEventParams$$)(D.$DvtChartConstants$$.$FOOTNOTE$)), $footnoteAlign_titleHeight$$1_titleSepHeight_upperSepObj$$ = $options$$40$$.footnote.hAlign != D.$JSCompiler_alias_NULL$$ ? 
  $options$$40$$.footnote.hAlign : $options$$40$$.footnote.halign, $alignFootnoteToPlotArea_lowerSepObj_titleGapBelow_titleObj$$ = "plotArea" == $footnoteAlign_titleHeight$$1_titleSepHeight_upperSepObj$$.substring(0, 8), $container$$28_footnoteObj$$ && ($footnoteDims_titleDims$$ = $container$$28_footnoteObj$$.$getDimensions$(), $container$$28_footnoteObj$$.$setY$($availSpace$$33$$.y + $availSpace$$33$$.$h$ - $footnoteDims_titleDims$$.$h$), $availSpace$$33$$.$h$ -= $footnoteDims_titleDims$$.$h$ + 
  (0,D.$DvtChartDefaults$getGapHeight$$)($chart$$49$$, $options$$40$$.layout.footnoteGap), (0,D.$DvtLayoutUtils$align$$)($availSpace$$33$$, $footnoteAlign_titleHeight$$1_titleSepHeight_upperSepObj$$, $container$$28_footnoteObj$$, $footnoteDims_titleDims$$.$w$), $container$$28_footnoteObj$$.$setAriaProperty$("hidden", D.$JSCompiler_alias_NULL$$)), $alignFootnoteToPlotArea_lowerSepObj_titleGapBelow_titleObj$$ && ($chart$$49$$.$Cache$.footnote = $container$$28_footnoteObj$$))
};
D.$DvtChartRenderer$$.$_updateTitles$ = function $$DvtChartRenderer$$$$_updateTitles$$($chart$$50_footnoteObj$$1$$, $container$$29$$, $titleSpace$$2$$, $availSpace$$34_subtitleObj$$1$$) {
  var $options$$41_updateFootnote$$ = $chart$$50_footnoteObj$$1$$.$getOptions$(), $footnoteDims$$1_titleAlign$$1$$ = $options$$41_updateFootnote$$.title.hAlign != D.$JSCompiler_alias_NULL$$ ? $options$$41_updateFootnote$$.title.hAlign : $options$$41_updateFootnote$$.title.halign, $footnoteAlign$$1$$ = $options$$41_updateFootnote$$.footnote.hAlign != D.$JSCompiler_alias_NULL$$ ? $options$$41_updateFootnote$$.footnote.hAlign : $options$$41_updateFootnote$$.footnote.halign, $subtitleDims$$1_titleObj$$1_updateTitle$$ = 
  $options$$41_updateFootnote$$.title.text && "plotArea" == $footnoteDims$$1_titleAlign$$1$$.substring(0, 8), $options$$41_updateFootnote$$ = $options$$41_updateFootnote$$.footnote.text && "plotArea" == $footnoteAlign$$1$$.substring(0, 8);
  ...
  $options$$41_updateFootnote$$ && ($chart$$50_footnoteObj$$1$$ = $chart$$50_footnoteObj$$1$$.$Cache$.footnote, $footnoteDims$$1_titleAlign$$1$$ = $chart$$50_footnoteObj$$1$$.$getDimensions$(), D.$DvtChartRenderer$$.$_alignTextToPlotArea$($container$$29$$, $titleSpace$$2$$, $footnoteAlign$$1$$, $chart$$50_footnoteObj$$1$$, $footnoteDims$$1_titleAlign$$1$$.$w$))
};
...
D.$DvtChartRenderer$$.$renderEmptyText$ = function $$DvtChartRenderer$$$$renderEmptyText$$($chart$$52$$, $container$$32$$, $availSpace$$37$$) {
  var $options$$42$$ = $chart$$52$$.$getOptions$();
  if(D.$DvtChartDataUtils$$.$hasInvalidTimeData$($chart$$52$$) && D.$DvtChartDataUtils$$.$hasData$($chart$$52$$)) {
    var $emptyTextStr$$ = (0,D.$DvtBundle$getTranslation$$)($options$$42$$, "labelInvalidData", "DvtUtilBundle", "INVALID_DATA")
  }else {
    ($emptyTextStr$$ = $options$$42$$.emptyText) || ($emptyTextStr$$ = (0,D.$DvtBundle$getTranslation$$)($options$$42$$, "labelNoData", "DvtUtilBundle", "NO_DATA"))
  }
  D.$DvtTextUtils$$.$renderEmptyText$($container$$32$$, $emptyTextStr$$, new D.$DvtRectangle$$($availSpace$$37$$.x, $availSpace$$37$$.y, $availSpace$$37$$.$w$, $availSpace$$37$$.$h$), $chart$$52$$.$__getEventManager$(), $options$$42$$.title.style)
};
...
D.$DvtChartRenderer$$.$_renderScrollbars$ = function $$DvtChartRenderer$$$$_renderScrollbars$$($chart$$55$$, $horizScrollbarDim$$, $ovOptions_vertScrollbarDim$$) {
  var $options$$43$$ = $chart$$55$$.$getOptions$(), $sbOptions$$ = {color:$options$$43$$.styleDefaults._scrollbarHandleColor, backgroundColor:$options$$43$$.styleDefaults._scrollbarTrackColor}, $plotAreaDim$$ = $chart$$55$$.$_plotAreaSpace$;
  ...
  $chart$$55$$.$overview$ && ($ovOptions_vertScrollbarDim$$ = {startTime:$chart$$55$$.$xAxis$.$actualToLinear$($chart$$55$$.$xAxis$.$Info$.$GlobalMin$), endTime:$chart$$55$$.$xAxis$.$actualToLinear$($chart$$55$$.$xAxis$.$Info$.$GlobalMax$), viewportStartTime:(0,D.$JSCompiler_StaticMethods_getLinearViewportMin$$)($chart$$55$$.$xAxis$), viewportEndTime:(0,D.$JSCompiler_StaticMethods_getLinearViewportMax$$)($chart$$55$$.$xAxis$), minimumWindowSize:$chart$$55$$.$xAxis$.$Info$.$getMinimumExtent$(), chart:D.$DvtJSONUtils$$.$clone$($options$$43$$)}, 
  D.$DvtChartEventUtils$$.$isZoomable$($chart$$55$$) || ($ovOptions_vertScrollbarDim$$.featuresOff = "zoom"), $chart$$55$$.$overview$.$setTranslateX$($plotAreaDim$$.x), $chart$$55$$.$overview$.$render$($ovOptions_vertScrollbarDim$$, $plotAreaDim$$.$w$, $horizScrollbarDim$$.$h$), $chart$$55$$.$overview$.$setViewportRange$((0,D.$JSCompiler_StaticMethods_getLinearViewportMin$$)($chart$$55$$.$xAxis$), (0,D.$JSCompiler_StaticMethods_getLinearViewportMax$$)($chart$$55$$.$xAxis$)))
};
...
D.$DvtChartRenderer$$.$_renderDragButtons$ = function $$DvtChartRenderer$$$$_renderDragButtons$$($chart$$56$$) {
  var $options$$44$$ = $chart$$56$$.$getOptions$(), $em$$2$$ = $chart$$56$$.$__getEventManager$(), $dragMode$$1_isTouch$$ = $options$$44$$.dragMode;
  if("user" != $dragMode$$1_isTouch$$) {
    ...
    if(D.$DvtChartTypeUtils$$.$hasAxes$($chart$$56$$) && !D.$DvtChartTypeUtils$$.$isOverview$($chart$$56$$)) {
      ...
      var $resources$$3$$ = $options$$44$$._resources, $position$$12_tooltip$$5$$;
      if("multiple" == $options$$44$$.selectionMode && ($dragMode$$1_isTouch$$ || $isScrollable$$)) {
        $position$$12_tooltip$$5$$ = $isScrollable$$ && ($dragMode$$1_isTouch$$ || D.$DvtChartEventUtils$$.$isZoomable$($chart$$56$$)) ? "end" : "solo", $em$$2$$.$selectButton$ = D.$DvtChartRenderer$$.$_createDragButton$($chart$$56$$, $chart$$56$$.$dragButtons$, $resources$$3$$.selectUp, $resources$$3$$.selectDown, $em$$2$$.$onSelectButtonClick$, $em$$2$$, $position$$12_tooltip$$5$$), $position$$12_tooltip$$5$$ = (0,D.$DvtBundle$getTranslation$$)($options$$44$$, "tooltipSelect", "DvtChartBundle", 
      ...
      $position$$12_tooltip$$5$$ = (0,D.$DvtBundle$getTranslation$$)($options$$44$$, "tooltipZoom", "DvtChartBundle", "MARQUEE_ZOOM"), $em$$2$$.$associate$($em$$2$$.$zoomButton$, new D.$DvtSimpleObjPeer$$($position$$12_tooltip$$5$$))));
...
D.$DvtChartRenderer$$.$_createDragButtonBackground$ = function $$DvtChartRenderer$$$$_createDragButtonBackground$$($context$$34$$, $position$$13$$) {
  var $background_blcr_cmd$$1$$ = 2, $trcr$$ = 2, $isR2L$$3_pos$$8$$ = (0,D.$DvtAgent$isRightToLeft$$)($context$$34$$);
  "start" == $position$$13$$ ? $isR2L$$3_pos$$8$$ ? $background_blcr_cmd$$1$$ = 0 : $trcr$$ = 0 : "end" == $position$$13$$ && ($isR2L$$3_pos$$8$$ ? $trcr$$ = 0 : $background_blcr_cmd$$1$$ = 0);
  var $isR2L$$3_pos$$8$$ = -D.$DvtChartRenderer$$.$_BUTTON_PADDING$, $size$$15$$ = D.$DvtChartRenderer$$.$_BUTTON_SIZE$ + 2 * D.$DvtChartRenderer$$.$_BUTTON_PADDING$, $background_blcr_cmd$$1$$ = D.$DvtPathUtils$$.$roundedRectangle$($isR2L$$3_pos$$8$$, $isR2L$$3_pos$$8$$, $size$$15$$, $size$$15$$, $background_blcr_cmd$$1$$, $trcr$$, $trcr$$, $background_blcr_cmd$$1$$), $background_blcr_cmd$$1$$ = new D.$DvtPath$$($context$$34$$, $background_blcr_cmd$$1$$);
...
D.$DvtChartRenderer$$.$_createDragButton$ = function $$DvtChartRenderer$$$$_createDragButton$$($chart$$59_context$$35$$, $container$$36_isR2L$$4$$, $overDownState_upSrc$$, $button$$5_downSrc$$, $callback$$41_enabled$$inline_2212_hitPadding$$, $callbackObj$$5$$, $hitArea_position$$14$$) {
  ...
  $button$$5_downSrc$$ = new D.$DvtButton$$($chart$$59_context$$35$$, $upState$$2$$, $overState$$2$$, $downState$$2$$, D.$JSCompiler_alias_NULL$$, D.$JSCompiler_alias_NULL$$, $callback$$41_enabled$$inline_2212_hitPadding$$, $callbackObj$$5$$);
  if(!$button$$5_downSrc$$.$overDownState$ || $button$$5_downSrc$$.$overDownState$ == $overDownState_upSrc$$) {
    $callback$$41_enabled$$inline_2212_hitPadding$$ = D.$JSCompiler_alias_FALSE$$, $button$$5_downSrc$$.$overDownState$ && ($callback$$41_enabled$$inline_2212_hitPadding$$ = (0,D.$JSCompiler_StaticMethods__isButtonEnabled$$)($button$$5_downSrc$$.$overDownState$), $button$$5_downSrc$$.removeChild($button$$5_downSrc$$.$overDownState$)), $overDownState_upSrc$$ && $button$$5_downSrc$$.$addChild$($overDownState_upSrc$$), $button$$5_downSrc$$.$overDownState$ = $overDownState_upSrc$$, (0,D.$JSCompiler_StaticMethods__enableButton$$)($button$$5_downSrc$$.$overDownState$, 
    $callback$$41_enabled$$inline_2212_hitPadding$$)
  }
  ...
  (0,D.$DvtAgent$isTouchDevice$$)() && ($container$$36_isR2L$$4$$ = (0,D.$DvtAgent$isRightToLeft$$)($chart$$59_context$$35$$), $callback$$41_enabled$$inline_2212_hitPadding$$ = 2 * D.$DvtChartRenderer$$.$_BUTTON_PADDING$, $hitArea_position$$14$$ = "solo" == $hitArea_position$$14$$ ? new D.$DvtRect$$($chart$$59_context$$35$$, -$callback$$41_enabled$$inline_2212_hitPadding$$, -$callback$$41_enabled$$inline_2212_hitPadding$$, D.$DvtChartRenderer$$.$_BUTTON_SIZE$ + 2 * $callback$$41_enabled$$inline_2212_hitPadding$$, 
  D.$DvtChartRenderer$$.$_BUTTON_SIZE$ + 2 * $callback$$41_enabled$$inline_2212_hitPadding$$) : "start" == $hitArea_position$$14$$ && !$container$$36_isR2L$$4$$ || "end" == $hitArea_position$$14$$ && $container$$36_isR2L$$4$$ ? new D.$DvtRect$$($chart$$59_context$$35$$, -$callback$$41_enabled$$inline_2212_hitPadding$$, -$callback$$41_enabled$$inline_2212_hitPadding$$, D.$DvtChartRenderer$$.$_BUTTON_SIZE$ + 1.5 * $callback$$41_enabled$$inline_2212_hitPadding$$, D.$DvtChartRenderer$$.$_BUTTON_SIZE$ + 
  2 * $callback$$41_enabled$$inline_2212_hitPadding$$) : new D.$DvtRect$$($chart$$59_context$$35$$, -0.5 * $callback$$41_enabled$$inline_2212_hitPadding$$, -$callback$$41_enabled$$inline_2212_hitPadding$$, D.$DvtChartRenderer$$.$_BUTTON_SIZE$ + 1.5 * $callback$$41_enabled$$inline_2212_hitPadding$$, D.$DvtChartRenderer$$.$_BUTTON_SIZE$ + 2 * $callback$$41_enabled$$inline_2212_hitPadding$$), (0,D.$JSCompiler_StaticMethods_setInvisibleFill$$)($hitArea_position$$14$$), $button$$5_downSrc$$.$addChild$($hitArea_position$$14$$));
...
D.$DvtChartRenderer$$.$renderDataCursor$ = function $$DvtChartRenderer$$$$renderDataCursor$$($chart$$60$$) {
  var $dataCursor$$3$$ = D.$JSCompiler_alias_NULL$$, $options$$45$$ = $chart$$60$$.$getOptions$(), $eventManager$$7$$ = $chart$$60$$.$__getEventManager$();
  if(D.$DvtChartTooltipUtils$$.$isDataCursorEnabled$($chart$$60$$)) {
    var $dataCursor$$3$$ = new D.$DvtDataCursor$$($chart$$60$$.$getCtx$(), $options$$45$$.styleDefaults.dataCursor, D.$DvtChartTypeUtils$$.$isHorizontal$($chart$$60$$)), $behavior$$inline_2215_dataCursorHandler$$ = D.$DvtChartTooltipUtils$$.$getDataCursorBehavior$($chart$$60$$);
    $dataCursor$$3$$.$_behavior$ = $behavior$$inline_2215_dataCursorHandler$$;
    $chart$$60$$.$addChild$($dataCursor$$3$$);
    $behavior$$inline_2215_dataCursorHandler$$ = new D.$DvtDataCursorHandler$$($chart$$60$$, $dataCursor$$3$$);
    $eventManager$$7$$.$_dataCursorHandler$ = $behavior$$inline_2215_dataCursorHandler$$;
    $chart$$60$$.$positionDataCursor$($options$$45$$.dataCursorPosition)
  }else {
...
D.$DvtChartAxisRenderer$$.$_renderCartesian$ = function $$DvtChartAxisRenderer$$$$_renderCartesian$$($chart$$29$$, $container$$19_xInfo$$, $availSpace$$18$$) {
  ...
  if(($bAligned_options$$32$$ = !$isSplitDualY$$ && "on" == $bAligned_options$$32$$.y2Axis.alignTickMarks && $bAligned_options$$32$$.y2Axis.step == D.$JSCompiler_alias_NULL$$) && $yInfo$$ && $y2Info$$) {
  ...
  $yInfo$$.$dim$.$w$, $totalAvailSpace_yAvailSpace$$.$h$, 0, $totalAvailSpace_yAvailSpace$$.y) : $yInfo$$.axis.$render$($yInfo$$.options, $yInfo$$.$dim$.$w$, $availSpace$$18$$.$h$)), $bAligned_options$$32$$ && ($yInfo$$ && $y2Info$$) && D.$DvtChartAxisRenderer$$.$_alignYAxes$($yInfo$$, $y2Info$$), $y2Info$$ && ($isSplitDualY$$ ? $y2Info$$.axis.$render$($y2Info$$.options, $y2Info$$.$dim$.$w$, $maxSize_newWidth$$1_numGroups_splitterPosition_y2AvailSpace_yPosition$$.$h$, 0, $maxSize_newWidth$$1_numGroups_splitterPosition_y2AvailSpace_yPosition$$.y) : 
...
D.$DvtChartAxisRenderer$$.$_createXAxis$ = function $$DvtChartAxisRenderer$$$$_createXAxis$$($chart$$31_preferredSize$$, $container$$21$$, $availSpace$$20$$, $totalAvailSpace$$1$$) {
  var $axis$$63_isHoriz$$5_options$$33$$ = $chart$$31_preferredSize$$.$getOptions$(), $axisOffset_numGroups$$1_position$$9$$ = D.$DvtChartAxisUtils$$.$getXAxisPosition$($chart$$31_preferredSize$$), $axisOptions$$1$$ = D.$DvtJSONUtils$$.$clone$($axis$$63_isHoriz$$5_options$$33$$.xAxis);
  ...
  $axisOptions$$1$$.groupSeparators = $axis$$63_isHoriz$$5_options$$33$$.styleDefaults.groupSeparators;
  D.$DvtChartAxisRenderer$$.$_addCommonAxisAttributes$($axisOptions$$1$$, "x", $chart$$31_preferredSize$$);
  $axisOptions$$1$$.groups = $axis$$63_isHoriz$$5_options$$33$$.groups;
  ...
  $axisOptions$$1$$._locale = $axis$$63_isHoriz$$5_options$$33$$._locale;
  $axisOptions$$1$$.drilling = $axis$$63_isHoriz$$5_options$$33$$.drilling;
  var $axis$$63_isHoriz$$5_options$$33$$ = "top" == $axisOffset_numGroups$$1_position$$9$$ || "bottom" == $axisOffset_numGroups$$1_position$$9$$, $isGridShifted$$ = D.$DvtChartAxisUtils$$.$isGridShifted$($chart$$31_preferredSize$$);
  ...
  "y") && ($axisOptions$$1$$[($axis$$63_isHoriz$$5_options$$33$$ ? "start" : "end") + "GroupOffset"] += 0.04 * $axisOffset_numGroups$$1_position$$9$$), D.$DvtChartAxisUtils$$.$isAxisRendered$($chart$$31_preferredSize$$, "y2") && D.$DvtChartAxisUtils$$.$isTickLabelInside$($chart$$31_preferredSize$$, "y2") && ($axisOptions$$1$$[($axis$$63_isHoriz$$5_options$$33$$ ? "end" : "start") + "GroupOffset"] += 0.04 * $axisOffset_numGroups$$1_position$$9$$)));
  $axisOptions$$1$$.leftBuffer = $axis$$63_isHoriz$$5_options$$33$$ ? $availSpace$$20$$.x - $totalAvailSpace$$1$$.x : 0;
  $axisOptions$$1$$.rightBuffer = $axis$$63_isHoriz$$5_options$$33$$ ? $totalAvailSpace$$1$$.$w$ + $totalAvailSpace$$1$$.x - ($availSpace$$20$$.$w$ + $availSpace$$20$$.x) : 0;
  $axisOptions$$1$$._renderGridAtLabels = !$isGridShifted$$ || D.$DvtChartAxisUtils$$.$hasTimeAxis$($chart$$31_preferredSize$$);
  $axis$$63_isHoriz$$5_options$$33$$ = new D.$DvtChartAxis$$($chart$$31_preferredSize$$.$getCtx$(), $chart$$31_preferredSize$$.$processEvent$, $chart$$31_preferredSize$$);
  $container$$21$$.$addChild$($axis$$63_isHoriz$$5_options$$33$$);
  $chart$$31_preferredSize$$ = D.$DvtChartAxisRenderer$$.$_getPreferredSize$($chart$$31_preferredSize$$, $axis$$63_isHoriz$$5_options$$33$$, $chart$$31_preferredSize$$.$xAxis$, $axisOptions$$1$$, "x", $availSpace$$20$$, $totalAvailSpace$$1$$);
  return{axis:$axis$$63_isHoriz$$5_options$$33$$, options:$axisOptions$$1$$, $dim$:$chart$$31_preferredSize$$}
};
D.$DvtChartAxisRenderer$$.$_createYAxis$ = function $$DvtChartAxisRenderer$$$$_createYAxis$$($chart$$32_preferredSize$$1$$, $container$$22$$, $availSpace$$21$$, $totalAvailSpace$$2$$) {
  var $options$$34$$ = $chart$$32_preferredSize$$1$$.$getOptions$();
  if(D.$DvtChartTypeUtils$$.$hasY2DataOnly$($chart$$32_preferredSize$$1$$)) {
    return D.$JSCompiler_alias_NULL$$
  }
  var $axisOptions$$2$$ = D.$DvtJSONUtils$$.$clone$($options$$34$$.yAxis);
  ...
  var $axis$$64$$ = new D.$DvtChartAxis$$($chart$$32_preferredSize$$1$$.$getCtx$(), $chart$$32_preferredSize$$1$$.$processEvent$, $chart$$32_preferredSize$$1$$);
  $container$$22$$.$addChild$($axis$$64$$);
  $chart$$32_preferredSize$$1$$ = D.$DvtChartAxisRenderer$$.$_getPreferredSize$($chart$$32_preferredSize$$1$$, $axis$$64$$, $chart$$32_preferredSize$$1$$.$yAxis$, $axisOptions$$2$$, "y", $availSpace$$21$$, $totalAvailSpace$$2$$);
  $options$$34$$.yAxis.min = $axisOptions$$2$$.min;
  $options$$34$$.yAxis.max = $axisOptions$$2$$.max;
  return{axis:$axis$$64$$, options:$axisOptions$$2$$, $dim$:$chart$$32_preferredSize$$1$$}
};
D.$DvtChartAxisRenderer$$.$_createY2Axis$ = function $$DvtChartAxisRenderer$$$$_createY2Axis$$($chart$$33_preferredSize$$2$$, $container$$23$$, $availSpace$$22$$, $totalAvailSpace$$3$$) {
  var $options$$35$$ = $chart$$33_preferredSize$$2$$.$getOptions$();
  if(D.$DvtChartTypeUtils$$.$hasY2Data$($chart$$33_preferredSize$$2$$)) {
    var $axisOptions$$3$$ = D.$DvtJSONUtils$$.$clone$($options$$35$$.y2Axis);
    ...
    var $axis$$65$$ = new D.$DvtChartAxis$$($chart$$33_preferredSize$$2$$.$getCtx$(), $chart$$33_preferredSize$$2$$.$processEvent$, $chart$$33_preferredSize$$2$$);
    $container$$23$$.$addChild$($axis$$65$$);
    $chart$$33_preferredSize$$2$$ = D.$DvtChartAxisRenderer$$.$_getPreferredSize$($chart$$33_preferredSize$$2$$, $axis$$65$$, $chart$$33_preferredSize$$2$$.$y2Axis$, $axisOptions$$3$$, "y2", $availSpace$$22$$, $totalAvailSpace$$3$$);
    $options$$35$$.y2Axis.min = $axisOptions$$3$$.min;
    $options$$35$$.y2Axis.max = $axisOptions$$3$$.max;
    return{axis:$axis$$65$$, options:$axisOptions$$3$$, $dim$:$chart$$33_preferredSize$$2$$}
  }
};
D.$DvtChartAxisRenderer$$.$_addCommonAxisAttributes$ = function $$DvtChartAxisRenderer$$$$_addCommonAxisAttributes$$($axisOptions$$4$$, $dataValues_type$$72$$, $chart$$34$$) {
  var $options$$36$$ = $chart$$34$$.$getOptions$();
  $axisOptions$$4$$.skin = $options$$36$$.skin;
  ...
  $axisOptions$$4$$.zoomAndScroll = D.$DvtChartTypeUtils$$.$isPolar$($chart$$34$$) ? "off" : $options$$36$$.zoomAndScroll;
...
D.$DvtChartAxisRenderer$$.$_getPreferredSize$ = function $$DvtChartAxisRenderer$$$$_getPreferredSize$$($chart$$36$$, $axis$$66_isR2L$$2$$, $maxSize$$1_oldAxis$$, $axisOptions$$6$$, $gap$$9_type$$73$$, $availSpace$$23$$, $totalAvailSpace$$4$$) {
  ...
  if($chart$$36$$.$getOptions$()._duringAnimation) {
    return $isHoriz$$6$$ ? ($axis$$66_isR2L$$2$$ = (0,D.$DvtAgent$isRightToLeft$$)($chart$$36$$.$getCtx$()), $axisOptions$$6$$._startOverflow = $axis$$66_isR2L$$2$$ ? (0,D.$JSCompiler_StaticMethods_getRightOverflow$$)($maxSize$$1_oldAxis$$) : (0,D.$JSCompiler_StaticMethods_getLeftOverflow$$)($maxSize$$1_oldAxis$$), $axisOptions$$6$$._endOverflow = $axis$$66_isR2L$$2$$ ? (0,D.$JSCompiler_StaticMethods_getLeftOverflow$$)($maxSize$$1_oldAxis$$) : (0,D.$JSCompiler_StaticMethods_getRightOverflow$$)($maxSize$$1_oldAxis$$), 
  ...
  return $isHoriz$$6$$ ? $axis$$66_isR2L$$2$$.$getPreferredSize$($axisOptions$$6$$, $availSpace$$23$$.$w$, D.$DvtChartStyleUtils$$.$getSizeInPixels$($maxSize$$1_oldAxis$$, $totalAvailSpace$$4$$.$h$) - $gap$$9_type$$73$$) : $axis$$66_isR2L$$2$$.$getPreferredSize$($axisOptions$$6$$, D.$DvtChartStyleUtils$$.$getSizeInPixels$($maxSize$$1_oldAxis$$, $totalAvailSpace$$4$$.$w$) - $gap$$9_type$$73$$, $availSpace$$23$$.$h$)
};
...
D.$DvtChartAxisRenderer$$.$_positionAxis$ = function $$DvtChartAxisRenderer$$$$_positionAxis$$($availSpace$$25$$, $axisInfo$$10$$, $gap$$10$$) {
  $axisInfo$$10$$ && (0,D.$DvtLayoutUtils$position$$)($availSpace$$25$$, $axisInfo$$10$$.options.position, $axisInfo$$10$$.axis, $axisInfo$$10$$.$dim$.$w$, $axisInfo$$10$$.$dim$.$h$, $gap$$10$$)
};
...
D.$DvtChartLegendRenderer$$.$render$ = function $$DvtChartLegendRenderer$$$$render$$($chart$$39$$, $container$$24$$, $availSpace$$28_bounds$$8$$) {
  var $gap$$11_options$$37$$ = $chart$$39$$.$getOptions$(), $position$$11_shiftedPos$$ = $gap$$11_options$$37$$.legend.position;
  if("on" == $gap$$11_options$$37$$.legend.rendered) {
    var $legendOptions$$2$$ = D.$DvtJSONUtils$$.$clone$($gap$$11_options$$37$$.legend);
    delete $legendOptions$$2$$.position;
    $legendOptions$$2$$.skin = $gap$$11_options$$37$$.skin;
    $legendOptions$$2$$.hideAndShowBehavior = D.$DvtChartEventUtils$$.$getHideAndShowBehavior$($chart$$39$$);
    $legendOptions$$2$$.hoverBehavior = D.$DvtChartEventUtils$$.$getHoverBehavior$($chart$$39$$);
    $legendOptions$$2$$.hoverBehaviorDelay = D.$DvtChartStyleUtils$$.$getHoverBehaviorDelay$($chart$$39$$);
    $legendOptions$$2$$.hiddenCategories = D.$DvtChartStyleUtils$$.$getHiddenCategories$($chart$$39$$);
    $legendOptions$$2$$.highlightedCategories = D.$DvtChartStyleUtils$$.$getHighlightedCategories$($chart$$39$$);
    "auto" == $position$$11_shiftedPos$$ && ($position$$11_shiftedPos$$ = $availSpace$$28_bounds$$8$$.$w$ >= $availSpace$$28_bounds$$8$$.$h$ ? "end" : "bottom");
    var $isHoriz$$9$$ = "top" == $position$$11_shiftedPos$$ || "bottom" == $position$$11_shiftedPos$$;
    $legendOptions$$2$$.orientation = $isHoriz$$9$$ ? "horizontal" : "vertical";
    "start" == $position$$11_shiftedPos$$ && ($legendOptions$$2$$.halign = "end");
    if("start" == $position$$11_shiftedPos$$ || "end" == $position$$11_shiftedPos$$) {
      $legendOptions$$2$$.valign = "middle"
    }
    "top" == $position$$11_shiftedPos$$ && ($legendOptions$$2$$.valign = "bottom");
    if("top" == $position$$11_shiftedPos$$ || "bottom" == $position$$11_shiftedPos$$) {
      $legendOptions$$2$$.halign = "center"
    }
    D.$DvtChartLegendRenderer$$.$_addLegendData$($chart$$39$$, $legendOptions$$2$$);
    if(0 != $legendOptions$$2$$.sections.length) {
      ...
      var $actualSize_maxWidth$$4$$;
      if($legendOptions$$2$$.size != D.$JSCompiler_alias_NULL$$) {
        $actualSize_maxWidth$$4$$ = $isHoriz$$9$$ ? new D.$DvtDimension$$($availSpace$$28_bounds$$8$$.$w$, D.$DvtChartStyleUtils$$.$getSizeInPixels$($legendOptions$$2$$.size, $availSpace$$28_bounds$$8$$.$h$)) : new D.$DvtDimension$$(D.$DvtChartStyleUtils$$.$getSizeInPixels$($legendOptions$$2$$.size, $availSpace$$28_bounds$$8$$.$w$), $availSpace$$28_bounds$$8$$.$h$)
      }else {
        $actualSize_maxWidth$$4$$ = $isHoriz$$9$$ ? $availSpace$$28_bounds$$8$$.$w$ : D.$DvtChartStyleUtils$$.$getSizeInPixels$($legendOptions$$2$$.maxSize, $availSpace$$28_bounds$$8$$.$w$);
        var $maxHeight$$3$$ = $isHoriz$$9$$ ? D.$DvtChartStyleUtils$$.$getSizeInPixels$($legendOptions$$2$$.maxSize, $availSpace$$28_bounds$$8$$.$h$) : $availSpace$$28_bounds$$8$$.$h$;
        $actualSize_maxWidth$$4$$ = $legend$$1$$.$getPreferredSize$($legendOptions$$2$$, $actualSize_maxWidth$$4$$, $maxHeight$$3$$)
      }
      $legend$$1$$.$render$($legendOptions$$2$$, $actualSize_maxWidth$$4$$.$w$, $actualSize_maxWidth$$4$$.$h$);
      $gap$$11_options$$37$$ = $isHoriz$$9$$ ? (0,D.$DvtChartDefaults$getGapHeight$$)($chart$$39$$, $gap$$11_options$$37$$.layout.legendGapHeight) : window.Math.ceil($gap$$11_options$$37$$.layout.legendGapWidth * (0,D.$JSCompiler_StaticMethods_getGapWidthRatio$$)($chart$$39$$));
      (0,D.$DvtLayoutUtils$position$$)($availSpace$$28_bounds$$8$$, $position$$11_shiftedPos$$, $legend$$1$$, $actualSize_maxWidth$$4$$.$w$, $actualSize_maxWidth$$4$$.$h$, $gap$$11_options$$37$$);
      $availSpace$$28_bounds$$8$$ = $legend$$1$$.$_bounds$;
      $position$$11_shiftedPos$$ = (0,D.$JSCompiler_StaticMethods_localToStage$$)($legend$$1$$, new D.$DvtPoint$$($availSpace$$28_bounds$$8$$.x, $availSpace$$28_bounds$$8$$.y));
      $availSpace$$28_bounds$$8$$.x = $position$$11_shiftedPos$$.x;
      $availSpace$$28_bounds$$8$$.y = $position$$11_shiftedPos$$.y;
...
D.$DvtChartLegendRenderer$$.$_createLegendItem$ = function $$DvtChartLegendRenderer$$$$_createLegendItem$$($chart$$42$$, $seriesIndex$$17$$) {
  ...
  if(!$seriesItem$$1$$ || "off" == $displayInLegend_series$$6$$ || "on" != $displayInLegend_series$$6$$ && !D.$DvtChartDataUtils$$.$hasSeriesData$($chart$$42$$, $seriesIndex$$17$$)) {
    return D.$JSCompiler_alias_NULL$$
  }
  ...
  var $displayInLegend_series$$6$$ = D.$DvtChartDataUtils$$.$getSeries$($chart$$42$$, $seriesIndex$$17$$), $hiddenCategories_index$$131$$ = D.$DvtChartStyleUtils$$.$getHiddenCategories$($chart$$42$$), $hiddenCategories_index$$131$$ = D.$DvtArrayUtils$$.$getIndex$($hiddenCategories_index$$131$$, $displayInLegend_series$$6$$), $legendItem$$2_seriesLabel$$ = {id:$displayInLegend_series$$6$$, text:$legendItem$$2_seriesLabel$$, categoryVisibility:0 <= $hiddenCategories_index$$131$$ ? "hidden" : "visible"};
...
D.$DvtPlotAreaRenderer$$.$_renderBackgroundObjects$ = function $$DvtPlotAreaRenderer$$$$_renderBackgroundObjects$$($chart$$64$$, $container$$40$$, $availSpace$$47$$) {
  var $clipGroup_options$$47$$ = $chart$$64$$.$getOptions$(), $background$$1_cx_points$$2$$, $areaContainer$$2_context$$36$$ = $chart$$64$$.$getCtx$();
  ...
  if($clipGroup_options$$47$$.xAxis.referenceObjects || $clipGroup_options$$47$$.yAxis.referenceObjects || $clipGroup_options$$47$$.y2Axis.referenceObjects) {
    $clipGroup_options$$47$$ = D.$DvtPlotAreaRenderer$$.$createClippedGroup$($chart$$64$$, $container$$40$$, $availSpace$$47$$), D.$DvtRefObjRenderer$$.$renderBackgroundObjects$($chart$$64$$, $clipGroup_options$$47$$, $availSpace$$47$$)
  }
...
D.$DvtPlotAreaRenderer$$.$_renderMajorTicks$ = function $$DvtPlotAreaRenderer$$$$_renderMajorTicks$$($chart$$67$$, $container$$43$$, $axis$$67$$, $availSpace$$50$$) {
  D.$DvtPlotAreaRenderer$$.$_renderGridlines$($chart$$67$$, $container$$43$$, $axis$$67$$.$getOptions$().majorTick, $axis$$67$$.$getPosition$(), $axis$$67$$.$getMajorTickCoords$(), $axis$$67$$.$getBaselineCoord$(), $availSpace$$50$$)
};
D.$DvtPlotAreaRenderer$$.$_renderMinorTicks$ = function $$DvtPlotAreaRenderer$$$$_renderMinorTicks$$($chart$$68$$, $container$$44$$, $axis$$68$$, $availSpace$$51$$) {
  D.$DvtPlotAreaRenderer$$.$_renderGridlines$($chart$$68$$, $container$$44$$, $axis$$68$$.$getOptions$().minorTick, $axis$$68$$.$getPosition$(), $axis$$68$$.$getMinorTickCoords$(), D.$JSCompiler_alias_NULL$$, $availSpace$$51$$)
};
D.$DvtPlotAreaRenderer$$.$_renderAxisLine$ = function $$DvtPlotAreaRenderer$$$$_renderAxisLine$$($chart$$69$$, $container$$45$$, $oAxis_options$$48$$, $dAxis$$, $availSpace$$52$$) {
  $oAxis_options$$48$$ = $oAxis_options$$48$$.$getOptions$();
  var $coord$$15_position$$15$$ = $oAxis_options$$48$$.position, $coord$$15_position$$15$$ = "bottom" == $coord$$15_position$$15$$ || "right" == $coord$$15_position$$15$$ || "tangential" == $coord$$15_position$$15$$ ? (0,D.$JSCompiler_StaticMethods_axisToPlotArea$$)($dAxis$$, window.Math.max($dAxis$$.$Info$.$getStartCoord$(), $dAxis$$.$Info$.$getEndCoord$())) : (0,D.$JSCompiler_StaticMethods_axisToPlotArea$$)($dAxis$$, window.Math.min($dAxis$$.$Info$.$getStartCoord$(), $dAxis$$.$Info$.$getEndCoord$()));
  D.$DvtPlotAreaRenderer$$.$_renderGridlines$($chart$$69$$, $container$$45$$, $oAxis_options$$48$$.axisLine, $dAxis$$.$getPosition$(), [$coord$$15_position$$15$$], D.$JSCompiler_alias_NULL$$, $availSpace$$52$$)
};
D.$DvtPlotAreaRenderer$$.$_renderGridlines$ = function $$DvtPlotAreaRenderer$$$$_renderGridlines$$($chart$$70$$, $container$$46$$, $i$$156_options$$49$$, $position$$16$$, $coords$$8$$, $baselineCoord$$1$$, $availSpace$$53$$) {
  var $baselineColor_lineColor$$ = $i$$156_options$$49$$.lineColor, $lineStroke$$2$$ = new D.$DvtSolidStroke$$($baselineColor_lineColor$$, 1, $i$$156_options$$49$$.lineWidth);
  $i$$156_options$$49$$.lineStyle && $lineStroke$$2$$.$setStyle$((0,D.$DvtStroke$convertTypeString$$)($i$$156_options$$49$$.lineStyle));
  var $baselineStroke$$ = $lineStroke$$2$$.$clone$();
  "inherit" != $i$$156_options$$49$$.baselineColor && ($baselineColor_lineColor$$ = "auto" == $i$$156_options$$49$$.baselineColor ? D.$DvtColorUtils$$.$getDarker$($baselineColor_lineColor$$, 0.4) : $i$$156_options$$49$$.baselineColor, $baselineStroke$$.$setColor$($baselineColor_lineColor$$));
  $baselineStroke$$.$setWidth$($i$$156_options$$49$$.baselineWidth != D.$JSCompiler_alias_NULL$$ ? $i$$156_options$$49$$.baselineWidth : $i$$156_options$$49$$.lineWidth);
  $baselineStroke$$.$setStyle$((0,D.$DvtStroke$convertTypeString$$)($i$$156_options$$49$$.baselineStyle ? $i$$156_options$$49$$.baselineStyle : $i$$156_options$$49$$.lineStyle));
  for($i$$156_options$$49$$ = 0;$i$$156_options$$49$$ < $coords$$8$$.length;$i$$156_options$$49$$++) {
    D.$DvtPlotAreaRenderer$$.$_renderGridline$($chart$$70$$, $container$$46$$, $position$$16$$, $coords$$8$$[$i$$156_options$$49$$], $baselineCoord$$1$$ != D.$JSCompiler_alias_NULL$$ && $coords$$8$$[$i$$156_options$$49$$] == $baselineCoord$$1$$ ? $baselineStroke$$ : $lineStroke$$2$$, $availSpace$$53$$)
  }
};
D.$DvtPlotAreaRenderer$$.$_renderGridline$ = function $$DvtPlotAreaRenderer$$$$_renderGridline$$($chart$$71$$, $container$$47$$, $position$$17$$, $coord$$16_points$$3$$, $stroke$$5$$, $availSpace$$54$$) {
  ...
  "radial" == $position$$17$$ ? (D.$DvtChartAxisUtils$$.$isGridPolygonal$($chart$$71$$) ? ($coord$$16_points$$3$$ = D.$DvtPolygonUtils$$.$getRegularPolygonPoints$(0, 0, D.$DvtChartDataUtils$$.$getGroupCount$($chart$$71$$), $coord$$16_points$$3$$), $context$$37_line$$7$$ = new D.$DvtPolygon$$($context$$37_line$$7$$, $coord$$16_points$$3$$)) : $context$$37_line$$7$$ = new D.$DvtCircle$$($context$$37_line$$7$$, 0, 0, $coord$$16_points$$3$$), (0,D.$JSCompiler_StaticMethods_setInvisibleFill$$)($context$$37_line$$7$$), 
  (0,D.$JSCompiler_StaticMethods_setTranslate$$)($context$$37_line$$7$$, $availSpace$$54$$.x + $availSpace$$54$$.$w$ / 2, $availSpace$$54$$.y + $availSpace$$54$$.$h$ / 2)) : "tangential" == $position$$17$$ ? ($context$$37_line$$7$$ = new D.$DvtLine$$($context$$37_line$$7$$, 0, 0, $chart$$71$$.$getRadius$() * window.Math.sin($coord$$16_points$$3$$), -$chart$$71$$.$getRadius$() * window.Math.cos($coord$$16_points$$3$$)), 0.01 > $coord$$16_points$$3$$ % window.Math.PI / 2 && $usePixelHinting$$ && (0,D.$JSCompiler_StaticMethods_setPixelHinting$$)($context$$37_line$$7$$), 
  (0,D.$JSCompiler_StaticMethods_setTranslate$$)($context$$37_line$$7$$, $availSpace$$54$$.x + $availSpace$$54$$.$w$ / 2, $availSpace$$54$$.y + $availSpace$$54$$.$h$ / 2)) : ($context$$37_line$$7$$ = "top" == $position$$17$$ || "bottom" == $position$$17$$ ? new D.$DvtLine$$($context$$37_line$$7$$, $coord$$16_points$$3$$, $availSpace$$54$$.y, $coord$$16_points$$3$$, $availSpace$$54$$.y + $availSpace$$54$$.$h$) : new D.$DvtLine$$($context$$37_line$$7$$, $availSpace$$54$$.x, $coord$$16_points$$3$$, 
  $availSpace$$54$$.x + $availSpace$$54$$.$w$, $coord$$16_points$$3$$), $usePixelHinting$$ && (0,D.$JSCompiler_StaticMethods_setPixelHinting$$)($context$$37_line$$7$$));
...
D.$DvtPlotAreaRenderer$$.$_renderForegroundObjects$ = function $$DvtPlotAreaRenderer$$$$_renderForegroundObjects$$($chart$$72$$, $container$$48_selected$$2$$, $availSpace$$55$$) {
  ...
  $bBLAC_options$$50$$ = $chart$$72$$.$getOptions$();
  if($bBLAC_options$$50$$.xAxis.referenceObjects || $bBLAC_options$$50$$.yAxis.referenceObjects || $bBLAC_options$$50$$.y2Axis.referenceObjects) {
...
D.$DvtPlotAreaRenderer$$.$_renderDataLabel$ = function $$DvtPlotAreaRenderer$$$$_renderDataLabel$$($chart$$73$$, $container$$49$$, $bbox$$5_cmd$$2_dataItemBounds_padding$$6$$, $seriesIndex$$19$$, $groupIndex$$11$$, $dataColor_style$$48_textDim$$3$$, $type$$75$$) {
  if(!D.$DvtChartTypeUtils$$.$isOverview$($chart$$73$$)) {
    var $label$$26_labelString$$ = D.$DvtChartDataUtils$$.$getDataLabel$($chart$$73$$, $seriesIndex$$19$$, $groupIndex$$11$$, $type$$75$$);
    if($label$$26_labelString$$ != D.$JSCompiler_alias_NULL$$) {
      $label$$26_labelString$$ = new D.$DvtOutputText$$($chart$$73$$.$getCtx$(), $label$$26_labelString$$, 0, 0);
      $label$$26_labelString$$.$setMouseEnabled$(D.$JSCompiler_alias_FALSE$$);
      var $position$$18_size$$16$$ = D.$DvtChartStyleUtils$$.$getDataLabelPosition$($chart$$73$$, $seriesIndex$$19$$, $groupIndex$$11$$, $type$$75$$);
      $dataColor_style$$48_textDim$$3$$ = D.$DvtChartStyleUtils$$.$getDataLabelStyle$($chart$$73$$, $seriesIndex$$19$$, $groupIndex$$11$$, $dataColor_style$$48_textDim$$3$$, $position$$18_size$$16$$, $type$$75$$);
      $label$$26_labelString$$.$setCSSStyle$($dataColor_style$$48_textDim$$3$$);
      $label$$26_labelString$$.$setY$($bbox$$5_cmd$$2_dataItemBounds_padding$$6$$.y + $bbox$$5_cmd$$2_dataItemBounds_padding$$6$$.$h$ / 2);
      $label$$26_labelString$$.$setX$($bbox$$5_cmd$$2_dataItemBounds_padding$$6$$.x + $bbox$$5_cmd$$2_dataItemBounds_padding$$6$$.$w$ / 2);
      $label$$26_labelString$$.$alignCenter$();
      $label$$26_labelString$$.$alignMiddle$();
      $dataColor_style$$48_textDim$$3$$ = $label$$26_labelString$$.$measureDimensions$();
      if("left" == $position$$18_size$$16$$) {
        $label$$26_labelString$$.$setX$($bbox$$5_cmd$$2_dataItemBounds_padding$$6$$.x - $dataColor_style$$48_textDim$$3$$.$w$ / 2 - D.$DvtPlotAreaRenderer$$.$_MARKER_DATA_LABEL_GAP$)
      }else {
        if("right" == $position$$18_size$$16$$) {
          $label$$26_labelString$$.$setX$($bbox$$5_cmd$$2_dataItemBounds_padding$$6$$.x + $bbox$$5_cmd$$2_dataItemBounds_padding$$6$$.$w$ + $dataColor_style$$48_textDim$$3$$.$w$ / 2 + D.$DvtPlotAreaRenderer$$.$_MARKER_DATA_LABEL_GAP$)
        }else {
          if("top" == $position$$18_size$$16$$) {
            $label$$26_labelString$$.$setY$($bbox$$5_cmd$$2_dataItemBounds_padding$$6$$.y - $dataColor_style$$48_textDim$$3$$.$h$ / 2)
          }else {
            if("bottom" == $position$$18_size$$16$$) {
              $label$$26_labelString$$.$setY$($bbox$$5_cmd$$2_dataItemBounds_padding$$6$$.y + $bbox$$5_cmd$$2_dataItemBounds_padding$$6$$.$h$ + $dataColor_style$$48_textDim$$3$$.$h$ / 2 + D.$DvtPlotAreaRenderer$$.$_MARKER_DATA_LABEL_GAP$ / 2)
            }else {
              if("bar" == D.$DvtChartStyleUtils$$.$getSeriesType$($chart$$73$$, $seriesIndex$$19$$)) {
                ...
                "inLeft" == $position$$18_size$$16$$ ? $label$$26_labelString$$.$setX$($bbox$$5_cmd$$2_dataItemBounds_padding$$6$$.x + $dataColor_style$$48_textDim$$3$$.$w$ / 2 + D.$DvtPlotAreaRenderer$$.$_MARKER_DATA_LABEL_GAP$) : "inRight" == $position$$18_size$$16$$ ? $label$$26_labelString$$.$setX$($bbox$$5_cmd$$2_dataItemBounds_padding$$6$$.x + $bbox$$5_cmd$$2_dataItemBounds_padding$$6$$.$w$ - $dataColor_style$$48_textDim$$3$$.$w$ / 2 - D.$DvtPlotAreaRenderer$$.$_MARKER_DATA_LABEL_GAP$) : "inTop" == 
                $position$$18_size$$16$$ ? $label$$26_labelString$$.$setY$($bbox$$5_cmd$$2_dataItemBounds_padding$$6$$.y + $dataColor_style$$48_textDim$$3$$.$h$ / 2 + D.$DvtPlotAreaRenderer$$.$_MARKER_DATA_LABEL_GAP$) : "inBottom" == $position$$18_size$$16$$ && $label$$26_labelString$$.$setY$($bbox$$5_cmd$$2_dataItemBounds_padding$$6$$.y + $bbox$$5_cmd$$2_dataItemBounds_padding$$6$$.$h$ - $dataColor_style$$48_textDim$$3$$.$h$ / 2 - D.$DvtPlotAreaRenderer$$.$_MARKER_DATA_LABEL_GAP$ / 2)
              }else {
                if(D.$DvtChartTypeUtils$$.$isBubble$($chart$$73$$) && ($bbox$$5_cmd$$2_dataItemBounds_padding$$6$$.x += D.$DvtPlotAreaRenderer$$.$_MARKER_DATA_LABEL_GAP$, $bbox$$5_cmd$$2_dataItemBounds_padding$$6$$.y += D.$DvtPlotAreaRenderer$$.$_MARKER_DATA_LABEL_GAP$, $bbox$$5_cmd$$2_dataItemBounds_padding$$6$$.$h$ -= 2 * D.$DvtPlotAreaRenderer$$.$_MARKER_DATA_LABEL_GAP$, $bbox$$5_cmd$$2_dataItemBounds_padding$$6$$.$w$ -= 2 * D.$DvtPlotAreaRenderer$$.$_MARKER_DATA_LABEL_GAP$, $position$$18_size$$16$$ = 
                $label$$26_labelString$$.$getOptimalFontSize$($bbox$$5_cmd$$2_dataItemBounds_padding$$6$$), $label$$26_labelString$$.$setFontSize$($position$$18_size$$16$$), !D.$DvtTextUtils$$.$fitText$($label$$26_labelString$$, $bbox$$5_cmd$$2_dataItemBounds_padding$$6$$.$w$, $bbox$$5_cmd$$2_dataItemBounds_padding$$6$$.$h$, $container$$49$$, D.$DvtPlotAreaRenderer$$.$_MIN_CHARS_DATA_LABEL$))) {
                  return
                }
              }
              D.$DvtChartStyleUtils$$.$getPattern$($chart$$73$$, $seriesIndex$$19$$, $groupIndex$$11$$) != D.$JSCompiler_alias_NULL$$ && ($dataColor_style$$48_textDim$$3$$ = $label$$26_labelString$$.$getDimensions$(), $bbox$$5_cmd$$2_dataItemBounds_padding$$6$$ = 0.15 * $dataColor_style$$48_textDim$$3$$.$h$, $bbox$$5_cmd$$2_dataItemBounds_padding$$6$$ = D.$DvtPathUtils$$.$roundedRectangle$($dataColor_style$$48_textDim$$3$$.x - $bbox$$5_cmd$$2_dataItemBounds_padding$$6$$, $dataColor_style$$48_textDim$$3$$.y, 
      ...
      D.$DvtChartStyleUtils$$.$optimizeMarkerStroke$($chart$$73$$) && $label$$26_labelString$$.$setSolidStroke$("none");
      $container$$49$$.$addChild$($label$$26_labelString$$);
      (0,D.$JSCompiler_StaticMethods_getDataLabels$$)($chart$$73$$).push($label$$26_labelString$$)
    }
  }
};
...
D.$DvtPlotAreaRenderer$$.$_getMarkerInfo$ = function $$DvtPlotAreaRenderer$$$$_getMarkerInfo$$($chart$$78_markerSize$$, $seriesIndex$$23$$, $groupIndex$$13$$, $availSpace$$58_pos$$9$$) {
  var $options$$51_shape$$28$$ = $chart$$78_markerSize$$.$getOptions$(), $isPolar$$2_prevValue$$ = D.$DvtChartTypeUtils$$.$isPolar$($chart$$78_markerSize$$), $nextIndex$$1_nextValue$$2_numGroups$$2$$ = D.$DvtChartDataUtils$$.$getGroupCount$($chart$$78_markerSize$$), $bMarkerDisplayed_dataValue$$ = D.$DvtChartDataUtils$$.getValue($chart$$78_markerSize$$, $seriesIndex$$23$$, $groupIndex$$13$$);
  ...
  $availSpace$$58_pos$$9$$ = D.$DvtChartDataUtils$$.$getMarkerPosition$($chart$$78_markerSize$$, $seriesIndex$$23$$, $groupIndex$$13$$, $availSpace$$58_pos$$9$$);
  if(!$availSpace$$58_pos$$9$$) {
    return D.$JSCompiler_alias_NULL$$
  }
  ...
  if(!$bMarkerDisplayed_dataValue$$) {
    if(D.$DvtChartAxisUtils$$.$isMixedFrequency$($chart$$78_markerSize$$)) {
  ...
  if(($options$$51_shape$$28$$._duringAnimation || D.$DvtChartTypeUtils$$.$isOverview$($chart$$78_markerSize$$) || D.$DvtChartTypeUtils$$.$isSpark$($chart$$78_markerSize$$)) && !$bMarkerDisplayed_dataValue$$ && !D.$DvtChartDataUtils$$.$isDataSelected$($chart$$78_markerSize$$, $seriesIndex$$23$$, $groupIndex$$13$$)) {
    return D.$JSCompiler_alias_NULL$$
  }
  $options$$51_shape$$28$$ = D.$DvtChartStyleUtils$$.$getMarkerShape$($chart$$78_markerSize$$, $seriesIndex$$23$$, $groupIndex$$13$$);
  $chart$$78_markerSize$$ = D.$DvtChartStyleUtils$$.$getMarkerSize$($chart$$78_markerSize$$, $seriesIndex$$23$$, $groupIndex$$13$$);
  return{$seriesIndex$:$seriesIndex$$23$$, $groupIndex$:$groupIndex$$13$$, x:$availSpace$$58_pos$$9$$.x, y:$availSpace$$58_pos$$9$$.y, shape:$options$$51_shape$$28$$, size:$chart$$78_markerSize$$, $markerDisplayed$:$bMarkerDisplayed_dataValue$$}
};
...
D.$DvtPlotAreaRenderer$$.$_addMarkerHitArea$ = function $$DvtPlotAreaRenderer$$$$_addMarkerHitArea$$($marker$$5$$, $hitArea$$1_x$$75$$, $y$$55$$, $bOptimizeStroke$$1$$) {
  $hitArea$$1_x$$75$$ = new D.$DvtRect$$($marker$$5$$.$getCtx$(), $hitArea$$1_x$$75$$ - D.$DvtPlotAreaRenderer$$.$_MIN_TOUCH_MARKER_SIZE$ / 2, $y$$55$$ - D.$DvtPlotAreaRenderer$$.$_MIN_TOUCH_MARKER_SIZE$ / 2, D.$DvtPlotAreaRenderer$$.$_MIN_TOUCH_MARKER_SIZE$, D.$DvtPlotAreaRenderer$$.$_MIN_TOUCH_MARKER_SIZE$);
  ...
  for(var $isTouchDevice$$2$$ = (0,D.$DvtAgent$isTouchDevice$$)(), $context$$39$$ = $chart$$80$$.$getCtx$(), $xAxis$$ = $chart$$80$$.$xAxis$, $yAxis$$ = D.$DvtChartDataUtils$$.$isAssignedToY2$($chart$$80$$, $seriesIndex$$25$$) ? $chart$$80$$.$y2Axis$ : $chart$$80$$.$yAxis$, $options$$52$$ = $chart$$80$$.$getOptions$(), $numGroups$$4$$ = D.$DvtChartDataUtils$$.$getGroupCount$($chart$$80$$), $markers$$5$$ = [], $groupIndex$$15$$ = 0;$groupIndex$$15$$ < $numGroups$$4$$;$groupIndex$$15$$++) {
    if(!D.$DvtPlotAreaRenderer$$.$_isDataItemFiltered$($chart$$80$$, $seriesIndex$$25$$, $groupIndex$$15$$) && D.$DvtChartStyleUtils$$.$isDataItemRendered$($chart$$80$$, $seriesIndex$$25$$, $groupIndex$$15$$)) {
      ...
      if(!($dataPos$$3_xCoord$$1$$ == D.$JSCompiler_alias_NULL$$ || $hitArea$$2_lowCoord_pLow$$ == D.$JSCompiler_alias_NULL$$ || $highCoord_markerSize$$1$$ == D.$JSCompiler_alias_NULL$$)) {
        ...
        if(!$options$$52$$._duringAnimation && !D.$DvtChartTypeUtils$$.$isOverview$($chart$$80$$) && !D.$DvtChartTypeUtils$$.$isSpark$($chart$$80$$) || $bMarkerDisplayed$$1_marker$$6$$ || D.$DvtChartDataUtils$$.$isDataSelected$($chart$$80$$, $seriesIndex$$25$$, $groupIndex$$15$$)) {
...
D.$DvtPlotAreaRenderer$$.$_renderBars$ = function $$DvtPlotAreaRenderer$$$$_renderBars$$($chart$$81$$, $container$$54$$, $availSpace$$61$$) {
  for(var $bHoriz$$3$$ = D.$DvtChartTypeUtils$$.$isHorizontal$($chart$$81$$), $bPolar$$ = D.$DvtChartTypeUtils$$.$isPolar$($chart$$81$$), $bStock$$ = D.$DvtChartTypeUtils$$.$isStock$($chart$$81$$), $bPixelSpacing$$ = "pixel" == D.$DvtChartStyleUtils$$.$getBarSpacing$($chart$$81$$), $groupIndex$$16$$ = 0;$groupIndex$$16$$ < D.$DvtChartDataUtils$$.$getGroupCount$($chart$$81$$);$groupIndex$$16$$++) {
    for(var $seriesIndex$$26$$ = 0;$seriesIndex$$26$$ < D.$DvtChartDataUtils$$.$getSeriesCount$($chart$$81$$);$seriesIndex$$26$$++) {
      if(D.$DvtChartDataUtils$$.$isDataItemInViewport$($chart$$81$$, $seriesIndex$$26$$, $groupIndex$$16$$) && "bar" == D.$DvtChartStyleUtils$$.$getSeriesType$($chart$$81$$, $seriesIndex$$26$$)) {
        ...
        if($barData_markers$$6$$ != D.$JSCompiler_alias_NULL$$) {
          var $shape$$29_yCoord$$1$$ = $barData_markers$$6$$.$yCoord$, $baseCoord_stroke$$7$$ = $barData_markers$$6$$.$baseCoord$, $axisCoord_borderWidth$$6_innerColor$$2$$ = $barData_markers$$6$$.$axisCoord$, $outerColor$$2_x1$$6$$ = $barData_markers$$6$$.$x1$, $x2$$4$$ = $barData_markers$$6$$.$x2$, $barWidth_fill$$3$$ = $barData_markers$$6$$.$barWidth$, $bInvisible_borderColor$$12_dataColor$$3$$ = D.$JSCompiler_alias_FALSE$$;
          1 > window.Math.abs($shape$$29_yCoord$$1$$ - $baseCoord_stroke$$7$$) && (D.$DvtChartStyleUtils$$.$isRangeSeries$($chart$$81$$, $seriesIndex$$26$$) ? $shape$$29_yCoord$$1$$-- : ($bInvisible_borderColor$$12_dataColor$$3$$ = D.$JSCompiler_alias_TRUE$$, $shape$$29_yCoord$$1$$ > $baseCoord_stroke$$7$$ ? $shape$$29_yCoord$$1$$ = $baseCoord_stroke$$7$$ + 3 : $shape$$29_yCoord$$1$$ <= $baseCoord_stroke$$7$$ && ($shape$$29_yCoord$$1$$ = $baseCoord_stroke$$7$$ - 3)));
          $shape$$29_yCoord$$1$$ = $bPolar$$ ? new D.$DvtChartPolarBar$$($chart$$81$$, $axisCoord_borderWidth$$6_innerColor$$2$$, $baseCoord_stroke$$7$$, $shape$$29_yCoord$$1$$, $outerColor$$2_x1$$6$$, $x2$$4$$, $availSpace$$61$$) : new D.$DvtChartBar$$($chart$$81$$, $axisCoord_borderWidth$$6_innerColor$$2$$, $baseCoord_stroke$$7$$, $shape$$29_yCoord$$1$$, $outerColor$$2_x1$$6$$, $x2$$4$$);
          $container$$54$$.$addChild$($shape$$29_yCoord$$1$$);
          D.$DvtChartStyleUtils$$.$isSelectable$($chart$$81$$, $seriesIndex$$26$$, $groupIndex$$16$$) && $shape$$29_yCoord$$1$$.setCursor("pointer");
          $baseCoord_stroke$$7$$ = D.$JSCompiler_alias_NULL$$;
          $bInvisible_borderColor$$12_dataColor$$3$$ ? $barWidth_fill$$3$$ = (0,D.$DvtSolidFill$invisibleFill$$)() : ($barWidth_fill$$3$$ = D.$DvtChartSeriesEffectUtils$$.$getBarFill$($chart$$81$$, $seriesIndex$$26$$, $groupIndex$$16$$, $bHoriz$$3$$, $barWidth_fill$$3$$), $bInvisible_borderColor$$12_dataColor$$3$$ = D.$DvtChartStyleUtils$$.$getBorderColor$($chart$$81$$, $seriesIndex$$26$$, $groupIndex$$16$$), $axisCoord_borderWidth$$6_innerColor$$2$$ = D.$DvtChartStyleUtils$$.$getBorderWidth$($chart$$81$$, 
          ...
          $shape$$29_yCoord$$1$$.$setStyleProperties$($barWidth_fill$$3$$, $baseCoord_stroke$$7$$, $bInvisible_borderColor$$12_dataColor$$3$$, $axisCoord_borderWidth$$6_innerColor$$2$$, $outerColor$$2_x1$$6$$);
          $bPixelSpacing$$ && (0,D.$JSCompiler_StaticMethods_setPixelHinting$$)($shape$$29_yCoord$$1$$);
          (0,D.$DvtChartObjPeer$associate$$)($shape$$29_yCoord$$1$$, $chart$$81$$, $seriesIndex$$26$$, $groupIndex$$16$$, $barData_markers$$6$$.$dataPos$);
          D.$DvtChartStyleUtils$$.$isRangeSeries$($chart$$81$$, $seriesIndex$$26$$) ? (D.$DvtPlotAreaRenderer$$.$_renderDataLabel$($chart$$81$$, $container$$54$$, $shape$$29_yCoord$$1$$.$getBoundingBox$(), $seriesIndex$$26$$, $groupIndex$$16$$, $bInvisible_borderColor$$12_dataColor$$3$$, "low"), D.$DvtPlotAreaRenderer$$.$_renderDataLabel$($chart$$81$$, $container$$54$$, $shape$$29_yCoord$$1$$.$getBoundingBox$(), $seriesIndex$$26$$, $groupIndex$$16$$, $bInvisible_borderColor$$12_dataColor$$3$$, "high")) : 
          D.$DvtPlotAreaRenderer$$.$_renderDataLabel$($chart$$81$$, $container$$54$$, $shape$$29_yCoord$$1$$.$getBoundingBox$(), $seriesIndex$$26$$, $groupIndex$$16$$, $bInvisible_borderColor$$12_dataColor$$3$$);
          $barData_markers$$6$$ = [];
          $barData_markers$$6$$.push($shape$$29_yCoord$$1$$);
...
D.$DvtPlotAreaRenderer$$.$_renderStock$ = function $$DvtPlotAreaRenderer$$$$_renderStock$$($chart$$82$$, $container$$55$$) {
  var $options$$53$$ = $chart$$82$$.$getOptions$(), $xAxis$$1$$ = $chart$$82$$.$xAxis$, $yAxis$$1$$ = $chart$$82$$.$yAxis$;
    ...
    for(var $groupIndex$$17$$ = 0;$groupIndex$$17$$ < D.$DvtChartDataUtils$$.$getGroupCount$($chart$$82$$);$groupIndex$$17$$++) {
      if(D.$DvtChartDataUtils$$.$isDataItemInViewport$($chart$$82$$, 0, $groupIndex$$17$$)) {
        ...
        if(!($openValue$$ == D.$JSCompiler_alias_NULL$$ || $closeValue$$ == D.$JSCompiler_alias_NULL$$)) {
          ...
          $candlestick_highValue$$ = new D.$DvtChartCandlestick$$($chart$$82$$.$getCtx$(), $dataPos$$4_markers$$7_xCoord$$2_xValue$$, $barWidth$$1_fill$$4_fill$$inline_2240$$, $dataItem$$5_openCoord$$, $closeCoord$$, $lowCoord$$1$$, $borderColor$$13_highCoord$$1_outerColor$$3$$);
          ...
          var $barWidth$$1_fill$$4_fill$$inline_2240$$ = D.$DvtChartSeriesEffectUtils$$.$getBarFill$($chart$$82$$, 0, $groupIndex$$17$$, D.$JSCompiler_alias_FALSE$$, $barWidth$$1_fill$$4_fill$$inline_2240$$), $renderRange_stroke$$8$$ = D.$JSCompiler_alias_NULL$$, $borderColor$$13_highCoord$$1_outerColor$$3$$ = D.$DvtChartStyleUtils$$.$getBorderColor$($chart$$82$$, 0, $groupIndex$$17$$), $borderWidth$$7_rangeColor$$ = D.$DvtChartStyleUtils$$.$getBorderWidth$($chart$$82$$, 0, $groupIndex$$17$$);
          $borderColor$$13_highCoord$$1_outerColor$$3$$ ? $renderRange_stroke$$8$$ = new D.$DvtSolidStroke$$($borderColor$$13_highCoord$$1_outerColor$$3$$, D.$JSCompiler_alias_NULL$$, $borderWidth$$7_rangeColor$$) : $barWidth$$1_fill$$4_fill$$inline_2240$$ instanceof D.$DvtPatternFill$$ && ($renderRange_stroke$$8$$ = new D.$DvtSolidStroke$$($barWidth$$1_fill$$4_fill$$inline_2240$$.$getColor$(), D.$JSCompiler_alias_NULL$$, $borderWidth$$7_rangeColor$$));
          var $dataColor$$4$$ = D.$DvtChartStyleUtils$$.$getColor$($chart$$82$$, 0, $groupIndex$$17$$), $innerColor$$3$$ = D.$DvtChartStyleUtils$$.$getSelectedInnerColor$($chart$$82$$), $borderColor$$13_highCoord$$1_outerColor$$3$$ = D.$DvtChartStyleUtils$$.$getSelectedOuterColor$($chart$$82$$), $borderWidth$$7_rangeColor$$ = $options$$53$$.styleDefaults.stockRangeColor;
          $candlestick_highValue$$.$_changeShape$.$setStyleProperties$($barWidth$$1_fill$$4_fill$$inline_2240$$, $renderRange_stroke$$8$$, $dataColor$$4$$, $innerColor$$3$$, $borderColor$$13_highCoord$$1_outerColor$$3$$);
          $barWidth$$1_fill$$4_fill$$inline_2240$$ = new D.$DvtSolidFill$$($borderWidth$$7_rangeColor$$);
          $candlestick_highValue$$.$_rangeShape$ && $candlestick_highValue$$.$_rangeShape$.$setStyleProperties$($barWidth$$1_fill$$4_fill$$inline_2240$$, $renderRange_stroke$$8$$, $borderWidth$$7_rangeColor$$, D.$JSCompiler_alias_NULL$$, $borderColor$$13_highCoord$$1_outerColor$$3$$);
...
D.$DvtPlotAreaRenderer$$.$_getAreaCoordsForSeries$ = function $$DvtPlotAreaRenderer$$$$_getAreaCoordsForSeries$$($bPolar$$2_chart$$86$$, $rawCoords_seriesIndex$$30$$, $lastIndex$$2_prevCoords$$1$$) {
  ...
  for($i$$159$$ = 0;$i$$159$$ < $rawCoords_seriesIndex$$30$$.length;$i$$159$$++) {
    if($rawCoords_seriesIndex$$30$$[$i$$159$$].x != D.$JSCompiler_alias_NULL$$) {
      var $coord$$17$$ = $coords$$10$$[$rawCoords_seriesIndex$$30$$[$i$$159$$].$groupIndex$], $prevIndex$$1$$ = $bPolar$$2_chart$$86$$ && 0 == $i$$159$$ ? $lastIndex$$2_prevCoords$$1$$ : $i$$159$$ - 1, $nextIndex$$2$$ = $bPolar$$2_chart$$86$$ && $i$$159$$ == $lastIndex$$2_prevCoords$$1$$ ? 0 : $i$$159$$ + 1;
      0 <= $prevIndex$$1$$ && $rawCoords_seriesIndex$$30$$[$prevIndex$$1$$].x != D.$JSCompiler_alias_NULL$$ && ($coord$$17$$.$y1$ = $rawCoords_seriesIndex$$30$$[$i$$159$$].$y1$);
      $nextIndex$$2$$ <= $lastIndex$$2_prevCoords$$1$$ && $rawCoords_seriesIndex$$30$$[$nextIndex$$2$$].x != D.$JSCompiler_alias_NULL$$ && ($coord$$17$$.$y2$ = $rawCoords_seriesIndex$$30$$[$i$$159$$].$y2$);
      $coord$$17$$.x = $rawCoords_seriesIndex$$30$$[$i$$159$$].x;
      $coord$$17$$.$filtered$ = $coord$$17$$.$y1$ == $coord$$17$$.$y2$ ? $rawCoords_seriesIndex$$30$$[$i$$159$$].$filtered$ : D.$JSCompiler_alias_FALSE$$
    }
  }
  return $coords$$10$$
};
...
D.$DvtPlotAreaRenderer$$.$_filterScatterBubble$ = function $$DvtPlotAreaRenderer$$$$_filterScatterBubble$$($chart$$88$$, $availSpace$$68$$) {
  ...
  if(!($pixelMap_seriesCount$$10$$ * $groupCount$$4_markerIndex$$ < D.$DvtPlotAreaRenderer$$.$_FILTER_THRESHOLD_SCATTER_BUBBLE$)) {
    for(var $markerInfos$$ = [], $markerInfo$$1_seriesIndex$$32$$ = 0;$markerInfo$$1_seriesIndex$$32$$ < $pixelMap_seriesCount$$10$$;$markerInfo$$1_seriesIndex$$32$$++) {
      if(D.$DvtChartStyleUtils$$.$isSeriesRendered$($chart$$88$$, $markerInfo$$1_seriesIndex$$32$$)) {
        for(var $alpha$$3_dataColor$$5_groupIndex$$18$$ = 0;$alpha$$3_dataColor$$5_groupIndex$$18$$ < $groupCount$$4_markerIndex$$;$alpha$$3_dataColor$$5_groupIndex$$18$$++) {
          $markerInfos$$.push(D.$DvtPlotAreaRenderer$$.$_getMarkerInfo$($chart$$88$$, $markerInfo$$1_seriesIndex$$32$$, $alpha$$3_dataColor$$5_groupIndex$$18$$, $availSpace$$68$$))
        }
      }
    }
    if(!($markerInfos$$.length < D.$DvtPlotAreaRenderer$$.$_FILTER_THRESHOLD_SCATTER_BUBBLE$)) {
      ...
      for($groupCount$$4_markerIndex$$ = $markerInfos$$.length - 1;0 <= $groupCount$$4_markerIndex$$;$groupCount$$4_markerIndex$$--) {
        var $markerInfo$$1_seriesIndex$$32$$ = $markerInfos$$[$groupCount$$4_markerIndex$$], $alpha$$3_dataColor$$5_groupIndex$$18$$ = D.$DvtChartStyleUtils$$.$getColor$($chart$$88$$, $markerInfo$$1_seriesIndex$$32$$.$seriesIndex$, $markerInfo$$1_seriesIndex$$32$$.$groupIndex$), $alpha$$3_dataColor$$5_groupIndex$$18$$ = $markerInfo$$1_seriesIndex$$32$$.$markerDisplayed$ ? D.$DvtColorUtils$$.$getAlpha$($alpha$$3_dataColor$$5_groupIndex$$18$$) : 0, $dataItem$$6$$ = D.$DvtChartDataUtils$$.$getDataItem$($chart$$88$$, 
        $markerInfo$$1_seriesIndex$$32$$.$seriesIndex$, $markerInfo$$1_seriesIndex$$32$$.$groupIndex$);
        D.$DvtChartMarkerUtils$$.$checkPixelMap$($pixelMap_seriesCount$$10$$, $markerInfo$$1_seriesIndex$$32$$.x, $markerInfo$$1_seriesIndex$$32$$.y, $markerInfo$$1_seriesIndex$$32$$.size) ? $dataItem$$6$$._filtered = D.$JSCompiler_alias_TRUE$$ : 0 < $alpha$$3_dataColor$$5_groupIndex$$18$$ && (D.$DvtChartMarkerUtils$$.$updatePixelMap$($pixelMap_seriesCount$$10$$, $markerInfo$$1_seriesIndex$$32$$.x, $markerInfo$$1_seriesIndex$$32$$.y, $markerInfo$$1_seriesIndex$$32$$.size, $alpha$$3_dataColor$$5_groupIndex$$18$$), 
...
D.$DvtPlotAreaRenderer$$.$_filterPointsForSeries$ = function $$DvtPlotAreaRenderer$$$$_filterPointsForSeries$$($chart$$89$$, $seriesIndex$$33$$) {
  var $maxNumPts_setSize$$ = $chart$$89$$.$_plotAreaSpace$.$w$, $seriesItems$$3$$ = D.$DvtChartDataUtils$$.$getSeriesItem$($chart$$89$$, $seriesIndex$$33$$).items, $axisInfo$$11_i$$160$$ = $chart$$89$$.$xAxis$.$Info$, $maxNumPts_setSize$$ = window.Math.round(2 * ($seriesItems$$3$$.length / (($axisInfo$$11_i$$160$$.$DataMax$ - $axisInfo$$11_i$$160$$.$DataMin$) / ($axisInfo$$11_i$$160$$.$MaxValue$ - $axisInfo$$11_i$$160$$.$MinValue$))) / $maxNumPts_setSize$$);
  if(2 >= $maxNumPts_setSize$$) {
    for($axisInfo$$11_i$$160$$ = 0;$axisInfo$$11_i$$160$$ < $seriesItems$$3$$.length;$axisInfo$$11_i$$160$$++) {
      ($dataItem$$7$$ = $seriesItems$$3$$[$axisInfo$$11_i$$160$$]) && ($dataItem$$7$$._filtered = D.$JSCompiler_alias_FALSE$$)
    }
  }else {
    for(var $maxIndex$$1$$, $maxValue$$3$$, $minIndex$$, $minValue$$4$$, $dataItem$$7$$, $dataValue$$1$$, $filtered$$ = D.$JSCompiler_alias_FALSE$$, $axisInfo$$11_i$$160$$ = 0;$axisInfo$$11_i$$160$$ < $seriesItems$$3$$.length;$axisInfo$$11_i$$160$$ += $maxNumPts_setSize$$) {
      $maxIndex$$1$$ = -1;
      $maxValue$$3$$ = -window.Infinity;
      $minIndex$$ = -1;
      $minValue$$4$$ = window.Infinity;
      for(var $j$$28$$ = $axisInfo$$11_i$$160$$;$j$$28$$ < window.Math.min($axisInfo$$11_i$$160$$ + $maxNumPts_setSize$$, $seriesItems$$3$$.length);$j$$28$$++) {
      ...
      for($j$$28$$ = $axisInfo$$11_i$$160$$;$j$$28$$ < window.Math.min($axisInfo$$11_i$$160$$ + $maxNumPts_setSize$$, $seriesItems$$3$$.length);$j$$28$$++) {
...
D.$DvtPlotAreaRenderer$$.$_getCoordsForSeries$ = function $$DvtPlotAreaRenderer$$$$_getCoordsForSeries$$($chart$$91$$, $seriesIndex$$35$$, $type$$78$$) {
  ...
  for(var $coords$$12$$ = [], $groupIndex$$20$$ = 0;$groupIndex$$20$$ < D.$DvtChartDataUtils$$.$getGroupCount$($chart$$91$$);$groupIndex$$20$$++) {
    var $coord$$18_group$$13$$ = D.$DvtChartDataUtils$$.$getGroup$($chart$$91$$, $groupIndex$$20$$), $dataValue$$2_xCoord$$3$$ = D.$DvtChartDataUtils$$.getValue($chart$$91$$, $seriesIndex$$35$$, $groupIndex$$20$$), $xValue$$1$$ = D.$DvtChartDataUtils$$.$getXValue$($chart$$91$$, $seriesIndex$$35$$, $groupIndex$$20$$), $yCoord$$2_yValue$$ = D.$JSCompiler_alias_NULL$$;
    ...
    $yCoord$$2_yValue$$ == D.$JSCompiler_alias_NULL$$ || (0,window.isNaN)($yCoord$$2_yValue$$) || !D.$DvtChartDataUtils$$.$isDataItemInViewport$($chart$$91$$, $seriesIndex$$35$$, $groupIndex$$20$$) ? $coords$$12$$.push(new D.$DvtChartCoord$$(D.$JSCompiler_alias_NULL$$, D.$JSCompiler_alias_NULL$$, D.$JSCompiler_alias_NULL$$, $groupIndex$$20$$, $coord$$18_group$$13$$, D.$JSCompiler_alias_FALSE$$)) : (D.$DvtChartTypeUtils$$.$isPolar$($chart$$91$$) && ($yCoord$$2_yValue$$ = window.Math.max($yCoord$$2_yValue$$, 
    $yAxis$$2$$.$Info$.$MinValue$)), $dataValue$$2_xCoord$$3$$ = $xAxis$$2$$.$getUnboundedCoordAt$($xValue$$1$$), $yCoord$$2_yValue$$ = $yAxis$$2$$.$getUnboundedCoordAt$($yCoord$$2_yValue$$), $coord$$18_group$$13$$ = new D.$DvtChartCoord$$($dataValue$$2_xCoord$$3$$, $yCoord$$2_yValue$$, $yCoord$$2_yValue$$, $groupIndex$$20$$, $coord$$18_group$$13$$, D.$DvtPlotAreaRenderer$$.$_isDataItemFiltered$($chart$$91$$, $seriesIndex$$35$$, $groupIndex$$20$$)), $coords$$12$$.push($coord$$18_group$$13$$))
  }
  return $coords$$12$$
};
D.$DvtPlotAreaRenderer$$.$createClippedGroup$ = function $$DvtPlotAreaRenderer$$$$createClippedGroup$$($chart$$92_points$$4_r$$inline_2260$$, $clip$$1_container$$60$$, $availSpace$$70_cy$$2$$) {
  var $clipGroup$$4$$ = new D.$DvtContainer$$($clip$$1_container$$60$$.$getCtx$());
  $clip$$1_container$$60$$.$addChild$($clipGroup$$4$$);
  $clip$$1_container$$60$$ = new D.$DvtClipPath$$($chart$$92_points$$4_r$$inline_2260$$.getId());
  var $buffer$$8_cx$$1_obj$$inline_2255$$ = D.$DvtPlotAreaRenderer$$.$_extendClipGroup$($chart$$92_points$$4_r$$inline_2260$$);
  if(D.$DvtChartTypeUtils$$.$isPolar$($chart$$92_points$$4_r$$inline_2260$$)) {
    if($buffer$$8_cx$$1_obj$$inline_2255$$ = $availSpace$$70_cy$$2$$.x + $availSpace$$70_cy$$2$$.$w$ / 2, $availSpace$$70_cy$$2$$ = $availSpace$$70_cy$$2$$.y + $availSpace$$70_cy$$2$$.$h$ / 2, D.$DvtChartAxisUtils$$.$isGridPolygonal$($chart$$92_points$$4_r$$inline_2260$$)) {
      $chart$$92_points$$4_r$$inline_2260$$ = D.$DvtPolygonUtils$$.$getRegularPolygonPoints$($buffer$$8_cx$$1_obj$$inline_2255$$, $availSpace$$70_cy$$2$$, D.$DvtChartDataUtils$$.$getGroupCount$($chart$$92_points$$4_r$$inline_2260$$), $chart$$92_points$$4_r$$inline_2260$$.$getRadius$()), $buffer$$8_cx$$1_obj$$inline_2255$$ = {type:3}, $buffer$$8_cx$$1_obj$$inline_2255$$.$points$ = $chart$$92_points$$4_r$$inline_2260$$, $buffer$$8_cx$$1_obj$$inline_2255$$ && $clip$$1_container$$60$$.$_regions$.push($buffer$$8_cx$$1_obj$$inline_2255$$)
    }else {
      $chart$$92_points$$4_r$$inline_2260$$ = $chart$$92_points$$4_r$$inline_2260$$.$getRadius$();
      var $obj$$inline_2261$$ = {type:5};
      $obj$$inline_2261$$.$cx$ = $buffer$$8_cx$$1_obj$$inline_2255$$;
      $obj$$inline_2261$$.$cy$ = $availSpace$$70_cy$$2$$;
      $obj$$inline_2261$$.$r$ = $chart$$92_points$$4_r$$inline_2260$$;
      $obj$$inline_2261$$ && $clip$$1_container$$60$$.$_regions$.push($obj$$inline_2261$$)
    }
  }else {
    D.$DvtChartTypeUtils$$.$isHorizontal$($chart$$92_points$$4_r$$inline_2260$$) ? (0,D.$JSCompiler_StaticMethods_addRect$$)($clip$$1_container$$60$$, $availSpace$$70_cy$$2$$.x - $buffer$$8_cx$$1_obj$$inline_2255$$, $availSpace$$70_cy$$2$$.y, $availSpace$$70_cy$$2$$.$w$ + 2 * $buffer$$8_cx$$1_obj$$inline_2255$$, $availSpace$$70_cy$$2$$.$h$) : (0,D.$JSCompiler_StaticMethods_addRect$$)($clip$$1_container$$60$$, $availSpace$$70_cy$$2$$.x, $availSpace$$70_cy$$2$$.y - $buffer$$8_cx$$1_obj$$inline_2255$$, 
    $availSpace$$70_cy$$2$$.$w$, $availSpace$$70_cy$$2$$.$h$ + 2 * $buffer$$8_cx$$1_obj$$inline_2255$$)
  }
...
D.$DvtPlotAreaRenderer$$.$convertAxisCoord$ = function $$DvtPlotAreaRenderer$$$$convertAxisCoord$$($cartesian_chart$$93$$, $coord$$19$$, $availSpace$$72$$) {
  return D.$DvtChartTypeUtils$$.$isPolar$($cartesian_chart$$93$$) ? ($cartesian_chart$$93$$ = D.$DvtPlotAreaRenderer$$.$polarToCartesian$($coord$$19$$.y, $coord$$19$$.x, $availSpace$$72$$), new D.$DvtPoint$$($cartesian_chart$$93$$.x, $cartesian_chart$$93$$.y)) : D.$DvtChartTypeUtils$$.$isHorizontal$($cartesian_chart$$93$$) ? new D.$DvtPoint$$($coord$$19$$.y, $coord$$19$$.x) : new D.$DvtPoint$$($coord$$19$$.x, $coord$$19$$.y)
};
...
D.$DvtFunnelRenderer$$.$_renderFunnelSlices$ = function $$DvtFunnelRenderer$$$$_renderFunnelSlices$$($chart$$62$$, $container$$38$$, $availSpace$$45$$) {
  for(var $maxGapSize_options$$46_totalValue$$ = $chart$$62$$.$getOptions$(), $seriesCount$$6_slice$$1_targetValue$$ = D.$DvtChartDataUtils$$.$getSeriesCount$($chart$$62$$), $gapRatio_gapSize$$ = D.$DvtChartStyleUtils$$.$getDataItemGaps$($chart$$62$$), $maxGapSize_options$$46_totalValue$$ = window.Math.min(D.$DvtFunnelRenderer$$.$_MAX_WIDTH_FOR_GAPS$ * $availSpace$$45$$.$w$ / ($seriesCount$$6_slice$$1_targetValue$$ - 1), ("on" == $maxGapSize_options$$46_totalValue$$.styleDefaults.threeDEffect ? D.$DvtFunnelRenderer$$.$_DEFAULT_3D_GAP_RATIO$ : 
  D.$DvtFunnelRenderer$$.$_DEFAULT_2D_GAP_RATIO$) * $availSpace$$45$$.$w$), $gapRatio_gapSize$$ = $gapRatio_gapSize$$ * $maxGapSize_options$$46_totalValue$$, $numDrawnSeries$$ = $maxGapSize_options$$46_totalValue$$ = 0, $cumulativeValue$$ = 0, $seriesIndex$$18$$ = 0;$seriesIndex$$18$$ < $seriesCount$$6_slice$$1_targetValue$$;$seriesIndex$$18$$++) {
    if(D.$DvtChartStyleUtils$$.$isDataItemRendered$($chart$$62$$, $seriesIndex$$18$$)) {
      ...
      0 >= $value$$90$$ || ($maxGapSize_options$$46_totalValue$$ += $value$$90$$)
    }
  }
  if(0 == $maxGapSize_options$$46_totalValue$$) {
    return D.$JSCompiler_alias_FALSE$$
  }
  for($seriesIndex$$18$$ = $seriesCount$$6_slice$$1_targetValue$$ - 1;0 <= $seriesIndex$$18$$;$seriesIndex$$18$$--) {
    ...
    ($seriesCount$$6_slice$$1_targetValue$$ != D.$JSCompiler_alias_NULL$$ ? ($cumulativeValue$$ += $seriesCount$$6_slice$$1_targetValue$$ / $maxGapSize_options$$46_totalValue$$, $seriesCount$$6_slice$$1_targetValue$$ = new D.$DvtFunnelSlice$$($chart$$62$$, $seriesIndex$$18$$, $numDrawnSeries$$, $availSpace$$45$$.$w$, $availSpace$$45$$.$h$, 1 - $cumulativeValue$$, $seriesCount$$6_slice$$1_targetValue$$ / $maxGapSize_options$$46_totalValue$$, $value$$90$$ / $seriesCount$$6_slice$$1_targetValue$$, $gapRatio_gapSize$$)) : 
    ($cumulativeValue$$ += $value$$90$$ / $maxGapSize_options$$46_totalValue$$, $seriesCount$$6_slice$$1_targetValue$$ = new D.$DvtFunnelSlice$$($chart$$62$$, $seriesIndex$$18$$, $numDrawnSeries$$, $availSpace$$45$$.$w$, $availSpace$$45$$.$h$, 1 - $cumulativeValue$$, $value$$90$$ / $maxGapSize_options$$46_totalValue$$, D.$JSCompiler_alias_NULL$$, $gapRatio_gapSize$$)), $numDrawnSeries$$++, $container$$38$$.$addChild$($seriesCount$$6_slice$$1_targetValue$$), (0,D.$DvtChartObjPeer$associate$$)($seriesCount$$6_slice$$1_targetValue$$, 
...
D.$DvtRefObjRenderer$$.$renderBackgroundObjects$ = function $$DvtRefObjRenderer$$$$renderBackgroundObjects$$($chart$$95$$, $container$$61$$, $plotAreaBounds$$3$$) {
  D.$DvtRefObjRenderer$$.$_renderObjects$($chart$$95$$, $container$$61$$, $plotAreaBounds$$3$$, "back")
};
D.$DvtRefObjRenderer$$.$renderForegroundObjects$ = function $$DvtRefObjRenderer$$$$renderForegroundObjects$$($chart$$96$$, $container$$62$$, $plotAreaBounds$$4$$) {
  D.$DvtRefObjRenderer$$.$_renderObjects$($chart$$96$$, $container$$62$$, $plotAreaBounds$$4$$, "front")
};
D.$DvtRefObjRenderer$$.$_renderObjects$ = function $$DvtRefObjRenderer$$$$_renderObjects$$($chart$$97$$, $container$$63$$, $plotAreaBounds$$5$$, $location$$21$$) {
  D.$DvtRefObjRenderer$$.$_renderObjectsForAxis$($chart$$97$$, $container$$63$$, $plotAreaBounds$$5$$, $location$$21$$, $chart$$97$$.$xAxis$, D.$DvtChartRefObjUtils$$.$getAxisRefObjs$($chart$$97$$, "x"));
  D.$DvtRefObjRenderer$$.$_renderObjectsForAxis$($chart$$97$$, $container$$63$$, $plotAreaBounds$$5$$, $location$$21$$, $chart$$97$$.$yAxis$, D.$DvtChartRefObjUtils$$.$getAxisRefObjs$($chart$$97$$, "y"));
  D.$DvtRefObjRenderer$$.$_renderObjectsForAxis$($chart$$97$$, $container$$63$$, $plotAreaBounds$$5$$, $location$$21$$, $chart$$97$$.$y2Axis$, D.$DvtChartRefObjUtils$$.$getAxisRefObjs$($chart$$97$$, "y2"))
};
D.$DvtRefObjRenderer$$.$_renderObjectsForAxis$ = function $$DvtRefObjRenderer$$$$_renderObjectsForAxis$$($chart$$98$$, $container$$64$$, $plotAreaBounds$$6$$, $location$$22$$, $axis$$70$$, $objects$$) {
  if($objects$$ && $axis$$70$$) {
    for(var $i$$161$$ = 0;$i$$161$$ < $objects$$.length;$i$$161$$++) {
      ...
      if(D.$DvtChartRefObjUtils$$.$isObjectRendered$($refObj$$3_refObjPeer$$) && $refObj$$3_refObjPeer$$ && D.$DvtChartRefObjUtils$$.$getLocation$($refObj$$3_refObjPeer$$) == $location$$22$$) {
        var $shape$$30$$, $type$$79$$ = D.$DvtChartRefObjUtils$$.$getType$($refObj$$3_refObjPeer$$);
        "area" == $type$$79$$ ? $shape$$30$$ = D.$DvtRefObjRenderer$$.$_createReferenceArea$($refObj$$3_refObjPeer$$, $chart$$98$$, $plotAreaBounds$$6$$, $axis$$70$$) : "line" == $type$$79$$ && ($shape$$30$$ = D.$DvtRefObjRenderer$$.$_createReferenceLine$($refObj$$3_refObjPeer$$, $chart$$98$$, $plotAreaBounds$$6$$, $axis$$70$$));
        $shape$$30$$ != D.$JSCompiler_alias_NULL$$ && ($refObj$$3_refObjPeer$$ = new D.$DvtRefObjPeer$$($chart$$98$$, [$shape$$30$$], $refObj$$3_refObjPeer$$, $i$$161$$, $axis$$70$$ == $chart$$98$$.$xAxis$ ? "xAxis" : $axis$$70$$ == $chart$$98$$.$yAxis$ ? "yAxis" : "y2Axis"), $chart$$98$$.$registerObject$($refObj$$3_refObjPeer$$), $chart$$98$$.$__getEventManager$().$associate$($shape$$30$$, $refObj$$3_refObjPeer$$), $container$$64$$.$addChild$($shape$$30$$))
      }
    }
  }
};
D.$DvtRefObjRenderer$$.$_createReferenceArea$ = function $$DvtRefObjRenderer$$$$_createReferenceArea$$($cy$$3_highVal_pointIndex_refObj$$4$$, $chart$$99_outerPoints_radius$$3$$, $cmds$$4_innerPoints_nSides_pHigh$$1_plotAreaBounds$$7_shape$$31$$, $axis$$71_highCoord$$2$$) {
  var $context$$40_items$$2$$ = $chart$$99_outerPoints_radius$$3$$.$getCtx$(), $color$$9_position$$19$$ = $axis$$71_highCoord$$2$$.$getPosition$(), $bHoriz$$4_cx$$2_lowCoords$$ = "top" == $color$$9_position$$19$$ || "bottom" == $color$$9_position$$19$$, $bRadial_highCoords_pLow$$1$$ = "radial" == $color$$9_position$$19$$, $color$$9_position$$19$$ = D.$DvtChartRefObjUtils$$.$getColor$($cy$$3_highVal_pointIndex_refObj$$4$$), $lineType$$2_lowCoord$$2_lowVal$$ = D.$DvtChartRefObjUtils$$.$getLineType$($cy$$3_highVal_pointIndex_refObj$$4$$);
  if($cy$$3_highVal_pointIndex_refObj$$4$$.items != D.$JSCompiler_alias_NULL$$ && $axis$$71_highCoord$$2$$ == $chart$$99_outerPoints_radius$$3$$.$yAxis$) {
    $context$$40_items$$2$$ = $cy$$3_highVal_pointIndex_refObj$$4$$.items;
    $bRadial_highCoords_pLow$$1$$ = [];
    $bHoriz$$4_cx$$2_lowCoords$$ = [];
    ...
    for($cy$$3_highVal_pointIndex_refObj$$4$$ = 0;$cy$$3_highVal_pointIndex_refObj$$4$$ < $context$$40_items$$2$$.length;$cy$$3_highVal_pointIndex_refObj$$4$$++) {
      ...
      if($lCoord_lVal$$ == D.$JSCompiler_alias_NULL$$ || $dataItem$$9_hCoord_hVal$$ == D.$JSCompiler_alias_NULL$$) {
        $bRadial_highCoords_pLow$$1$$.push(new D.$DvtChartCoord$$), $bHoriz$$4_cx$$2_lowCoords$$.push(new D.$DvtChartCoord$$)
      }else {
        var $lCoord_lVal$$ = $axis$$71_highCoord$$2$$.$getUnboundedCoordAt$($lCoord_lVal$$), $dataItem$$9_hCoord_hVal$$ = $axis$$71_highCoord$$2$$.$getUnboundedCoordAt$($dataItem$$9_hCoord_hVal$$), $xCoord$$4$$ = $chart$$99_outerPoints_radius$$3$$.$xAxis$.$getUnboundedCoordAt$(D.$DvtChartRefObjUtils$$.$getXValue$($chart$$99_outerPoints_radius$$3$$, $context$$40_items$$2$$, $cy$$3_highVal_pointIndex_refObj$$4$$));
        $bRadial_highCoords_pLow$$1$$.push(new D.$DvtChartCoord$$($xCoord$$4$$, $dataItem$$9_hCoord_hVal$$, $dataItem$$9_hCoord_hVal$$));
        $bHoriz$$4_cx$$2_lowCoords$$.push(new D.$DvtChartCoord$$($xCoord$$4$$, $lCoord_lVal$$, $lCoord_lVal$$))
      }
    }
    $cmds$$4_innerPoints_nSides_pHigh$$1_plotAreaBounds$$7_shape$$31$$ = new D.$DvtChartLineArea$$($chart$$99_outerPoints_radius$$3$$, D.$JSCompiler_alias_TRUE$$, $cmds$$4_innerPoints_nSides_pHigh$$1_plotAreaBounds$$7_shape$$31$$, D.$JSCompiler_alias_NULL$$, new D.$DvtSolidFill$$($color$$9_position$$19$$), D.$JSCompiler_alias_NULL$$, $lineType$$2_lowCoord$$2_lowVal$$, $bRadial_highCoords_pLow$$1$$, $lineType$$2_lowCoord$$2_lowVal$$, $bHoriz$$4_cx$$2_lowCoords$$)
  }else {
    ...
    if($lineType$$2_lowCoord$$2_lowVal$$ == D.$JSCompiler_alias_NULL$$ || -window.Infinity == $lineType$$2_lowCoord$$2_lowVal$$) {
      $lineType$$2_lowCoord$$2_lowVal$$ = $axis$$71_highCoord$$2$$.$Info$.$GlobalMin$
    }
    if($cy$$3_highVal_pointIndex_refObj$$4$$ == D.$JSCompiler_alias_NULL$$ || window.Infinity == $cy$$3_highVal_pointIndex_refObj$$4$$) {
      $cy$$3_highVal_pointIndex_refObj$$4$$ = $axis$$71_highCoord$$2$$.$Info$.$GlobalMax$
    }
    $lineType$$2_lowCoord$$2_lowVal$$ = D.$DvtRefObjRenderer$$.$_getAxisCoord$($chart$$99_outerPoints_radius$$3$$, $axis$$71_highCoord$$2$$, $lineType$$2_lowCoord$$2_lowVal$$);
    $axis$$71_highCoord$$2$$ = D.$DvtRefObjRenderer$$.$_getAxisCoord$($chart$$99_outerPoints_radius$$3$$, $axis$$71_highCoord$$2$$, $cy$$3_highVal_pointIndex_refObj$$4$$);
    D.$DvtChartTypeUtils$$.$isPolar$($chart$$99_outerPoints_radius$$3$$) ? ($bHoriz$$4_cx$$2_lowCoords$$ = $cmds$$4_innerPoints_nSides_pHigh$$1_plotAreaBounds$$7_shape$$31$$.x + $cmds$$4_innerPoints_nSides_pHigh$$1_plotAreaBounds$$7_shape$$31$$.$w$ / 2, $cy$$3_highVal_pointIndex_refObj$$4$$ = $cmds$$4_innerPoints_nSides_pHigh$$1_plotAreaBounds$$7_shape$$31$$.y + $cmds$$4_innerPoints_nSides_pHigh$$1_plotAreaBounds$$7_shape$$31$$.$h$ / 2, $bRadial_highCoords_pLow$$1$$ ? D.$DvtChartAxisUtils$$.$isGridPolygonal$($chart$$99_outerPoints_radius$$3$$) ? 
    ($cmds$$4_innerPoints_nSides_pHigh$$1_plotAreaBounds$$7_shape$$31$$ = D.$DvtChartDataUtils$$.$getGroupCount$($chart$$99_outerPoints_radius$$3$$), $chart$$99_outerPoints_radius$$3$$ = D.$DvtPolygonUtils$$.$getRegularPolygonPoints$($bHoriz$$4_cx$$2_lowCoords$$, $cy$$3_highVal_pointIndex_refObj$$4$$, $cmds$$4_innerPoints_nSides_pHigh$$1_plotAreaBounds$$7_shape$$31$$, $axis$$71_highCoord$$2$$, 1), $cmds$$4_innerPoints_nSides_pHigh$$1_plotAreaBounds$$7_shape$$31$$ = D.$DvtPolygonUtils$$.$getRegularPolygonPoints$($bHoriz$$4_cx$$2_lowCoords$$, 
    $cy$$3_highVal_pointIndex_refObj$$4$$, $cmds$$4_innerPoints_nSides_pHigh$$1_plotAreaBounds$$7_shape$$31$$, $lineType$$2_lowCoord$$2_lowVal$$, 0), $cmds$$4_innerPoints_nSides_pHigh$$1_plotAreaBounds$$7_shape$$31$$ = D.$DvtPathUtils$$.$polyline$($chart$$99_outerPoints_radius$$3$$) + D.$DvtPathUtils$$.$polyline$($cmds$$4_innerPoints_nSides_pHigh$$1_plotAreaBounds$$7_shape$$31$$) + D.$DvtPathUtils$$.closePath()) : $cmds$$4_innerPoints_nSides_pHigh$$1_plotAreaBounds$$7_shape$$31$$ = D.$DvtPathUtils$$.moveTo($bHoriz$$4_cx$$2_lowCoords$$, 
    $cy$$3_highVal_pointIndex_refObj$$4$$ - $axis$$71_highCoord$$2$$) + D.$DvtPathUtils$$.arcTo($axis$$71_highCoord$$2$$, $axis$$71_highCoord$$2$$, window.Math.PI, 1, $bHoriz$$4_cx$$2_lowCoords$$, $cy$$3_highVal_pointIndex_refObj$$4$$ + $axis$$71_highCoord$$2$$) + D.$DvtPathUtils$$.arcTo($axis$$71_highCoord$$2$$, $axis$$71_highCoord$$2$$, window.Math.PI, 1, $bHoriz$$4_cx$$2_lowCoords$$, $cy$$3_highVal_pointIndex_refObj$$4$$ - $axis$$71_highCoord$$2$$) + D.$DvtPathUtils$$.moveTo($bHoriz$$4_cx$$2_lowCoords$$, 
    $cy$$3_highVal_pointIndex_refObj$$4$$ - $lineType$$2_lowCoord$$2_lowVal$$) + D.$DvtPathUtils$$.arcTo($lineType$$2_lowCoord$$2_lowVal$$, $lineType$$2_lowCoord$$2_lowVal$$, window.Math.PI, 0, $bHoriz$$4_cx$$2_lowCoords$$, $cy$$3_highVal_pointIndex_refObj$$4$$ + $lineType$$2_lowCoord$$2_lowVal$$) + D.$DvtPathUtils$$.arcTo($lineType$$2_lowCoord$$2_lowVal$$, $lineType$$2_lowCoord$$2_lowVal$$, window.Math.PI, 0, $bHoriz$$4_cx$$2_lowCoords$$, $cy$$3_highVal_pointIndex_refObj$$4$$ - $lineType$$2_lowCoord$$2_lowVal$$) + 
    D.$DvtPathUtils$$.closePath() : ($chart$$99_outerPoints_radius$$3$$ = $chart$$99_outerPoints_radius$$3$$.$getRadius$(), $bRadial_highCoords_pLow$$1$$ = D.$DvtPlotAreaRenderer$$.$polarToCartesian$($chart$$99_outerPoints_radius$$3$$, $lineType$$2_lowCoord$$2_lowVal$$, $cmds$$4_innerPoints_nSides_pHigh$$1_plotAreaBounds$$7_shape$$31$$), $cmds$$4_innerPoints_nSides_pHigh$$1_plotAreaBounds$$7_shape$$31$$ = D.$DvtPlotAreaRenderer$$.$polarToCartesian$($chart$$99_outerPoints_radius$$3$$, $axis$$71_highCoord$$2$$, 
    $cmds$$4_innerPoints_nSides_pHigh$$1_plotAreaBounds$$7_shape$$31$$), $cmds$$4_innerPoints_nSides_pHigh$$1_plotAreaBounds$$7_shape$$31$$ = D.$DvtPathUtils$$.moveTo($bHoriz$$4_cx$$2_lowCoords$$, $cy$$3_highVal_pointIndex_refObj$$4$$) + D.$DvtPathUtils$$.lineTo($bRadial_highCoords_pLow$$1$$.x, $bRadial_highCoords_pLow$$1$$.y) + D.$DvtPathUtils$$.arcTo($chart$$99_outerPoints_radius$$3$$, $chart$$99_outerPoints_radius$$3$$, $axis$$71_highCoord$$2$$ - $lineType$$2_lowCoord$$2_lowVal$$, (0,D.$DvtAgent$isRightToLeft$$)($context$$40_items$$2$$) ? 
    0 : 1, $cmds$$4_innerPoints_nSides_pHigh$$1_plotAreaBounds$$7_shape$$31$$.x, $cmds$$4_innerPoints_nSides_pHigh$$1_plotAreaBounds$$7_shape$$31$$.y) + D.$DvtPathUtils$$.lineTo($cmds$$4_innerPoints_nSides_pHigh$$1_plotAreaBounds$$7_shape$$31$$.x, $cmds$$4_innerPoints_nSides_pHigh$$1_plotAreaBounds$$7_shape$$31$$.y) + D.$DvtPathUtils$$.closePath()), $cmds$$4_innerPoints_nSides_pHigh$$1_plotAreaBounds$$7_shape$$31$$ = new D.$DvtPath$$($context$$40_items$$2$$, $cmds$$4_innerPoints_nSides_pHigh$$1_plotAreaBounds$$7_shape$$31$$)) : 
    $cmds$$4_innerPoints_nSides_pHigh$$1_plotAreaBounds$$7_shape$$31$$ = new D.$DvtPolygon$$($context$$40_items$$2$$, $bHoriz$$4_cx$$2_lowCoords$$ ? [$lineType$$2_lowCoord$$2_lowVal$$, 0, $axis$$71_highCoord$$2$$, 0, $axis$$71_highCoord$$2$$, $cmds$$4_innerPoints_nSides_pHigh$$1_plotAreaBounds$$7_shape$$31$$.$h$, $lineType$$2_lowCoord$$2_lowVal$$, $cmds$$4_innerPoints_nSides_pHigh$$1_plotAreaBounds$$7_shape$$31$$.$h$] : [0, $lineType$$2_lowCoord$$2_lowVal$$, 0, $axis$$71_highCoord$$2$$, $cmds$$4_innerPoints_nSides_pHigh$$1_plotAreaBounds$$7_shape$$31$$.$w$, 
    $axis$$71_highCoord$$2$$, $cmds$$4_innerPoints_nSides_pHigh$$1_plotAreaBounds$$7_shape$$31$$.$w$, $lineType$$2_lowCoord$$2_lowVal$$]);
    $cmds$$4_innerPoints_nSides_pHigh$$1_plotAreaBounds$$7_shape$$31$$.$setSolidFill$($color$$9_position$$19$$)
  }
  return $cmds$$4_innerPoints_nSides_pHigh$$1_plotAreaBounds$$7_shape$$31$$
};
D.$DvtRefObjRenderer$$.$_createReferenceLine$ = function $$DvtRefObjRenderer$$$$_createReferenceLine$$($lineCoord$$1_refObj$$5_value$$91_xCoord$$5$$, $cartesian$$1_chart$$100_shape$$32$$, $plotAreaBounds$$8$$, $axis$$72_cx$$3$$) {
  var $lineWidth$$2_position$$20_stroke$$11$$ = $axis$$72_cx$$3$$.$getPosition$(), $bHoriz$$5_items$$3$$ = "top" == $lineWidth$$2_position$$20_stroke$$11$$ || "bottom" == $lineWidth$$2_position$$20_stroke$$11$$, $bRadial$$1_coords$$13_points$$6$$ = "radial" == $lineWidth$$2_position$$20_stroke$$11$$, $bTangential_pointIndex$$1$$ = "tangential" == $lineWidth$$2_position$$20_stroke$$11$$, $lineWidth$$2_position$$20_stroke$$11$$ = D.$DvtChartRefObjUtils$$.$getLineWidth$($lineCoord$$1_refObj$$5_value$$91_xCoord$$5$$), 
  ...
  $color$$10_context$$41_dataItem$$10_yCoord$$3$$ = $cartesian$$1_chart$$100_shape$$32$$.$getCtx$();
  if($lineCoord$$1_refObj$$5_value$$91_xCoord$$5$$.items != D.$JSCompiler_alias_NULL$$ && $axis$$72_cx$$3$$ == $cartesian$$1_chart$$100_shape$$32$$.$yAxis$) {
    $bHoriz$$5_items$$3$$ = $lineCoord$$1_refObj$$5_value$$91_xCoord$$5$$.items;
    $bRadial$$1_coords$$13_points$$6$$ = [];
    if((0,D.$JSCompiler_StaticMethods_isGroupAxis$$)($cartesian$$1_chart$$100_shape$$32$$.$xAxis$)) {
      for(;$bHoriz$$5_items$$3$$.length < D.$DvtChartDataUtils$$.$getGroupCount$($cartesian$$1_chart$$100_shape$$32$$);) {
        $bHoriz$$5_items$$3$$.push(D.$JSCompiler_alias_NULL$$)
      }
    }
    $bRadial$$1_coords$$13_points$$6$$ = [];
    for($bTangential_pointIndex$$1$$ = 0;$bTangential_pointIndex$$1$$ < $bHoriz$$5_items$$3$$.length;$bTangential_pointIndex$$1$$++) {
      $color$$10_context$$41_dataItem$$10_yCoord$$3$$ = $bHoriz$$5_items$$3$$[$bTangential_pointIndex$$1$$], $lineCoord$$1_refObj$$5_value$$91_xCoord$$5$$ = D.$JSCompiler_alias_NULL$$, $color$$10_context$$41_dataItem$$10_yCoord$$3$$ != D.$JSCompiler_alias_NULL$$ && ((0,window.isNaN)($color$$10_context$$41_dataItem$$10_yCoord$$3$$) ? $color$$10_context$$41_dataItem$$10_yCoord$$3$$.value != D.$JSCompiler_alias_NULL$$ && ($lineCoord$$1_refObj$$5_value$$91_xCoord$$5$$ = $color$$10_context$$41_dataItem$$10_yCoord$$3$$.value) : 
      $lineCoord$$1_refObj$$5_value$$91_xCoord$$5$$ = $color$$10_context$$41_dataItem$$10_yCoord$$3$$), $lineCoord$$1_refObj$$5_value$$91_xCoord$$5$$ == D.$JSCompiler_alias_NULL$$ ? $bRadial$$1_coords$$13_points$$6$$.push(new D.$DvtChartCoord$$) : ($color$$10_context$$41_dataItem$$10_yCoord$$3$$ = $axis$$72_cx$$3$$.$getUnboundedCoordAt$($lineCoord$$1_refObj$$5_value$$91_xCoord$$5$$), $lineCoord$$1_refObj$$5_value$$91_xCoord$$5$$ = $cartesian$$1_chart$$100_shape$$32$$.$xAxis$.$getUnboundedCoordAt$(D.$DvtChartRefObjUtils$$.$getXValue$($cartesian$$1_chart$$100_shape$$32$$, 
      $bHoriz$$5_items$$3$$, $bTangential_pointIndex$$1$$)), $bRadial$$1_coords$$13_points$$6$$.push(new D.$DvtChartCoord$$($lineCoord$$1_refObj$$5_value$$91_xCoord$$5$$, $color$$10_context$$41_dataItem$$10_yCoord$$3$$, $color$$10_context$$41_dataItem$$10_yCoord$$3$$)))
    }
    $cartesian$$1_chart$$100_shape$$32$$ = new D.$DvtChartLineArea$$($cartesian$$1_chart$$100_shape$$32$$, D.$JSCompiler_alias_FALSE$$, $plotAreaBounds$$8$$, D.$JSCompiler_alias_NULL$$, D.$JSCompiler_alias_NULL$$, $lineWidth$$2_position$$20_stroke$$11$$, $cy$$4_lineType$$3$$, $bRadial$$1_coords$$13_points$$6$$)
  }else {
    if($lineCoord$$1_refObj$$5_value$$91_xCoord$$5$$.value) {
      $lineCoord$$1_refObj$$5_value$$91_xCoord$$5$$ = D.$DvtRefObjRenderer$$.$_getAxisCoord$($cartesian$$1_chart$$100_shape$$32$$, $axis$$72_cx$$3$$, $lineCoord$$1_refObj$$5_value$$91_xCoord$$5$$.value);
      ...
      $axis$$72_cx$$3$$ = $plotAreaBounds$$8$$.x + $plotAreaBounds$$8$$.$w$ / 2;
      $cy$$4_lineType$$3$$ = $plotAreaBounds$$8$$.y + $plotAreaBounds$$8$$.$h$ / 2;
      $bRadial$$1_coords$$13_points$$6$$ ? (D.$DvtChartAxisUtils$$.$isGridPolygonal$($cartesian$$1_chart$$100_shape$$32$$) ? ($bRadial$$1_coords$$13_points$$6$$ = D.$DvtPolygonUtils$$.$getRegularPolygonPoints$($axis$$72_cx$$3$$, $cy$$4_lineType$$3$$, D.$DvtChartDataUtils$$.$getGroupCount$($cartesian$$1_chart$$100_shape$$32$$), $lineCoord$$1_refObj$$5_value$$91_xCoord$$5$$), $cartesian$$1_chart$$100_shape$$32$$ = new D.$DvtPolygon$$($color$$10_context$$41_dataItem$$10_yCoord$$3$$, $bRadial$$1_coords$$13_points$$6$$)) : 
      $cartesian$$1_chart$$100_shape$$32$$ = new D.$DvtCircle$$($color$$10_context$$41_dataItem$$10_yCoord$$3$$, $axis$$72_cx$$3$$, $cy$$4_lineType$$3$$, $lineCoord$$1_refObj$$5_value$$91_xCoord$$5$$), $cartesian$$1_chart$$100_shape$$32$$.$setFill$(D.$JSCompiler_alias_NULL$$)) : $bTangential_pointIndex$$1$$ ? ($cartesian$$1_chart$$100_shape$$32$$ = D.$DvtPlotAreaRenderer$$.$polarToCartesian$($cartesian$$1_chart$$100_shape$$32$$.$getRadius$(), $lineCoord$$1_refObj$$5_value$$91_xCoord$$5$$, $plotAreaBounds$$8$$), 
      $cartesian$$1_chart$$100_shape$$32$$ = new D.$DvtLine$$($color$$10_context$$41_dataItem$$10_yCoord$$3$$, $axis$$72_cx$$3$$, $cy$$4_lineType$$3$$, $cartesian$$1_chart$$100_shape$$32$$.x, $cartesian$$1_chart$$100_shape$$32$$.y)) : ($cartesian$$1_chart$$100_shape$$32$$ = $bHoriz$$5_items$$3$$ ? new D.$DvtLine$$($color$$10_context$$41_dataItem$$10_yCoord$$3$$, $lineCoord$$1_refObj$$5_value$$91_xCoord$$5$$, 0, $lineCoord$$1_refObj$$5_value$$91_xCoord$$5$$, $plotAreaBounds$$8$$.$h$) : new D.$DvtLine$$($color$$10_context$$41_dataItem$$10_yCoord$$3$$, 
      0, $lineCoord$$1_refObj$$5_value$$91_xCoord$$5$$, $plotAreaBounds$$8$$.$w$, $lineCoord$$1_refObj$$5_value$$91_xCoord$$5$$), (0,D.$JSCompiler_StaticMethods_setPixelHinting$$)($cartesian$$1_chart$$100_shape$$32$$));
      $cartesian$$1_chart$$100_shape$$32$$.$setStroke$($lineWidth$$2_position$$20_stroke$$11$$)
    }else {
      return D.$JSCompiler_alias_NULL$$
    }
  }
  return $cartesian$$1_chart$$100_shape$$32$$
};
D.$DvtRefObjRenderer$$.$_getAxisCoord$ = function $$DvtRefObjRenderer$$$$_getAxisCoord$$($chart$$101_index$$132$$, $axis$$73$$, $value$$92$$) {
  return(0,D.$JSCompiler_StaticMethods_isGroupAxis$$)($axis$$73$$) && ($chart$$101_index$$132$$ = D.$DvtChartDataUtils$$.$getGroupIndex$($chart$$101_index$$132$$, $value$$92$$), 0 <= $chart$$101_index$$132$$) ? $axis$$73$$.$getUnboundedCoordAt$($chart$$101_index$$132$$) : !(0,window.isNaN)($value$$92$$) ? $axis$$73$$.$getUnboundedCoordAt$($value$$92$$) : D.$JSCompiler_alias_NULL$$
};
...
D.$DvtSparkChart$$.newInstance = function $$DvtSparkChart$$$newInstance$($context$$543$$, $callback$$141$$, $callbackObj$$91$$) {
  var $sparkChart$$ = new D.$DvtSparkChart$$;
  $sparkChart$$.Init($context$$543$$, $callback$$141$$, $callbackObj$$91$$);
  return $sparkChart$$
};
...
D.$DvtSparkChart$$.prototype.Init = function $$DvtSparkChart$$$$Init$($context$$544$$, $callback$$142$$, $callbackObj$$92$$) {
  D.$DvtSparkChart$$.$superclass$.Init.call(this, $context$$544$$, $callback$$142$$, $callbackObj$$92$$);
  this.$Defaults$ = new D.$DvtSparkChartDefaults$$;
  this.$_eventHandler$ = new D.$DvtEventManager$$($context$$544$$, this.$__dispatchEvent$, this);
  this.$_eventHandler$.$addListeners$(this);
  this.$_chart$ = (0,D.$DvtChart$newInstance$$)($context$$544$$);
  this.$addChild$(this.$_chart$);
  this.$_tooltipMask$ = new D.$DvtRect$$($context$$544$$);
  this.$addChild$(this.$_tooltipMask$);
  this.setId("sparkChart1000" + window.Math.floor(1E9 * window.Math.random()))
};
D.$DvtSparkChart$$.prototype.$SetOptions$ = function $$DvtSparkChart$$$$$SetOptions$$($options$$233$$) {
  $options$$233$$ ? (this.$Options$ = this.$Defaults$.$calcOptions$($options$$233$$), (0,D.$DvtAgent$isEnvironmentBrowser$$)() || (this.$Options$.animationOnDisplay = "none", this.$Options$.animationOnDataChange = "none")) : this.$Options$ || (this.$Options$ = (0,D.$JSCompiler_StaticMethods_GetDefaults$$)(this))
};
...
D.$DvtSparkChart$$.prototype.$render$ = function $$DvtSparkChart$$$$$render$$($options$$234_tooltip$$51$$, $width$$148$$, $height$$135$$) {
  this.$SetOptions$($options$$234_tooltip$$51$$);
  !(0,window.isNaN)($width$$148$$) && !(0,window.isNaN)($height$$135$$) && (this.$Width$ = $width$$148$$, this.$Height$ = $height$$135$$);
  D.$DvtSparkChartRenderer$$.$render$(this, this.$Width$, this.$Height$);
  $options$$234_tooltip$$51$$ = this.$Options$.shortDesc;
  ...
  $options$$234_tooltip$$51$$ && this.$_eventHandler$.$associate$(this.$_tooltipMask$, new D.$DvtSimpleObjPeer$$(D.$JSCompiler_alias_NULL$$, $options$$234_tooltip$$51$$, this.$Options$.color));
...
D.$DvtSparkChart$$.prototype.$__getEventManager$ = (0,D.$JSCompiler_get$$)("$_eventHandler$");
...
D.$DvtSparkChartRenderer$$.$render$ = function $$DvtSparkChartRenderer$$$$render$$($items$$29_spark$$, $width$$149$$, $height$$136$$) {
  var $chart$$327$$ = $items$$29_spark$$.$_chart$, $chartOptions$$ = D.$DvtSparkChartRenderer$$.$_convertOptionsObj$($items$$29_spark$$), $markerGap$$1_options$$235$$ = $items$$29_spark$$.$getOptions$();
  if("area" == $markerGap$$1_options$$235$$.type || "line" == $markerGap$$1_options$$235$$.type || "lineWithArea" == $markerGap$$1_options$$235$$.type) {
    $items$$29_spark$$ = D.$DvtSparkChartRenderer$$.$_getDataItems$($items$$29_spark$$);
    var $hasMarkers$$ = D.$JSCompiler_alias_FALSE$$;
    if($markerGap$$1_options$$235$$.firstColor || $markerGap$$1_options$$235$$.lastColor || $markerGap$$1_options$$235$$.highColor || $markerGap$$1_options$$235$$.lowColor) {
      $hasMarkers$$ = D.$JSCompiler_alias_TRUE$$
    }else {
      for(var $i$$756$$ = 0;$i$$756$$ < $items$$29_spark$$.length;$i$$756$$++) {
        if($items$$29_spark$$[$i$$756$$] && "on" == $items$$29_spark$$[$i$$756$$].markerDisplayed) {
          $hasMarkers$$ = D.$JSCompiler_alias_TRUE$$;
          break
        }
      }
    }
    if($hasMarkers$$ && 0 < $items$$29_spark$$.length || "none" == $markerGap$$1_options$$235$$.lineType) {
      $markerGap$$1_options$$235$$ = $markerGap$$1_options$$235$$.markerSize / 2, $width$$149$$ -= 2 * $markerGap$$1_options$$235$$, $height$$136$$ -= 2 * $markerGap$$1_options$$235$$, (0,D.$JSCompiler_StaticMethods_setTranslate$$)($chart$$327$$, $markerGap$$1_options$$235$$, $markerGap$$1_options$$235$$)
    }
  }
  $chart$$327$$.$render$($chartOptions$$, $width$$149$$, $height$$136$$)
};
D.$DvtSparkChartRenderer$$.$_getDataItems$ = function $$DvtSparkChartRenderer$$$$_getDataItems$$($options$$236_spark$$1$$) {
  return($options$$236_spark$$1$$ = $options$$236_spark$$1$$.$getOptions$()) && $options$$236_spark$$1$$.items ? $options$$236_spark$$1$$.items : []
};
D.$DvtSparkChartRenderer$$.$_convertOptionsObj$ = function $$DvtSparkChartRenderer$$$$_convertOptionsObj$$($items$$30_spark$$2$$) {
  var $options$$237$$ = $items$$30_spark$$2$$.$getOptions$(), $chartOptions$$1$$ = {styleDefaults:{}, xAxis:{}, yAxis:{}, groups:[]};
  $chartOptions$$1$$.translations = $options$$237$$.translations;
  var $bFloatingBar_zeroBaseline$$1$$ = "floatingBar" == $options$$237$$.type, $axisGap$$1_barSpacing_chartItems$$ = [], $highIndex$$ = -1, $lowIndex$$ = -1, $highValue$$2$$ = -window.Infinity, $lowValue$$2$$ = window.Infinity;
  $items$$30_spark$$2$$ = D.$DvtSparkChartRenderer$$.$_getDataItems$($items$$30_spark$$2$$);
  for(var $i$$757$$ = 0;$i$$757$$ < $items$$30_spark$$2$$.length;$i$$757$$++) {
    var $item$$45_topValue$$ = $items$$30_spark$$2$$[$i$$757$$], $baseValue_chartItem$$ = {};
    $item$$45_topValue$$ instanceof window.Object ? ($bFloatingBar_zeroBaseline$$1$$ ? ($baseValue_chartItem$$.low = $item$$45_topValue$$.floatValue, $baseValue_chartItem$$.high = $item$$45_topValue$$.floatValue + $item$$45_topValue$$.value) : ($baseValue_chartItem$$.value = $item$$45_topValue$$.value, $baseValue_chartItem$$.low = $item$$45_topValue$$.low, $baseValue_chartItem$$.high = $item$$45_topValue$$.high), $item$$45_topValue$$.date && ($chartOptions$$1$$.timeAxisType = "enabled", $chartOptions$$1$$.groups.push($item$$45_topValue$$.date)), 
    "on" == $item$$45_topValue$$.markerDisplayed && ($baseValue_chartItem$$.markerDisplayed = "on"), $item$$45_topValue$$.color && ($baseValue_chartItem$$.color = $item$$45_topValue$$.color), $item$$45_topValue$$.borderColor && ($baseValue_chartItem$$.borderColor = $item$$45_topValue$$.borderColor), $item$$45_topValue$$.markerShape && ($baseValue_chartItem$$.markerShape = $item$$45_topValue$$.markerShape), $item$$45_topValue$$.markerSize && ($baseValue_chartItem$$.markerSize = $item$$45_topValue$$.markerSize)) : 
    $baseValue_chartItem$$.value = $item$$45_topValue$$;
    $axisGap$$1_barSpacing_chartItems$$.push($baseValue_chartItem$$);
    $item$$45_topValue$$ = $baseValue_chartItem$$.value != D.$JSCompiler_alias_NULL$$ ? $baseValue_chartItem$$.value : window.Math.max($baseValue_chartItem$$.low, $baseValue_chartItem$$.high);
    $highValue$$2$$ < $item$$45_topValue$$ && ($highValue$$2$$ = $item$$45_topValue$$, $highIndex$$ = $i$$757$$);
    ...
    $lowValue$$2$$ > $baseValue_chartItem$$ && ($lowValue$$2$$ = $baseValue_chartItem$$, $lowIndex$$ = $i$$757$$)
  }
  $options$$237$$.highColor && 0 <= $highIndex$$ && ($axisGap$$1_barSpacing_chartItems$$[$highIndex$$].markerDisplayed = "on", $axisGap$$1_barSpacing_chartItems$$[$highIndex$$].color || ($axisGap$$1_barSpacing_chartItems$$[$highIndex$$].color = $options$$237$$.highColor));
  $options$$237$$.lowColor && 0 <= $lowIndex$$ && ($axisGap$$1_barSpacing_chartItems$$[$lowIndex$$].markerDisplayed = "on", $axisGap$$1_barSpacing_chartItems$$[$lowIndex$$].color || ($axisGap$$1_barSpacing_chartItems$$[$lowIndex$$].color = $options$$237$$.lowColor));
  $options$$237$$.firstColor && 0 < $axisGap$$1_barSpacing_chartItems$$.length && ($axisGap$$1_barSpacing_chartItems$$[0].markerDisplayed = "on", $axisGap$$1_barSpacing_chartItems$$[0].color || ($axisGap$$1_barSpacing_chartItems$$[0].color = $options$$237$$.firstColor));
  $options$$237$$.lastColor && 0 < $axisGap$$1_barSpacing_chartItems$$.length && ($axisGap$$1_barSpacing_chartItems$$[$axisGap$$1_barSpacing_chartItems$$.length - 1].markerDisplayed = "on", $axisGap$$1_barSpacing_chartItems$$[$axisGap$$1_barSpacing_chartItems$$.length - 1].color || ($axisGap$$1_barSpacing_chartItems$$[$axisGap$$1_barSpacing_chartItems$$.length - 1].color = $options$$237$$.lastColor));
  $chartOptions$$1$$.series = [{items:$axisGap$$1_barSpacing_chartItems$$, areaColor:$options$$237$$.areaColor}];
  $options$$237$$.referenceObjects && ($chartOptions$$1$$.yAxis.referenceObjects = $options$$237$$.referenceObjects);
  $chartOptions$$1$$.__spark = D.$JSCompiler_alias_TRUE$$;
  $axisGap$$1_barSpacing_chartItems$$ = $options$$237$$.barSpacing;
  ...
  $chartOptions$$1$$.type = $bFloatingBar_zeroBaseline$$1$$ ? "bar" : $options$$237$$.type;
  $chartOptions$$1$$.animationOnDataChange = $options$$237$$.animationOnDataChange;
  $chartOptions$$1$$.animationOnDisplay = $options$$237$$.animationOnDisplay;
  $chartOptions$$1$$.emptyText = $options$$237$$.emptyText;
  $chartOptions$$1$$.styleDefaults.colors = [$options$$237$$.color];
  $chartOptions$$1$$.styleDefaults.animationDuration = $options$$237$$.animationDuration;
  $chartOptions$$1$$.styleDefaults.animationIndicators = "none";
  $chartOptions$$1$$.styleDefaults.lineWidth = $options$$237$$.lineWidth;
  $chartOptions$$1$$.styleDefaults.lineStyle = $options$$237$$.lineStyle;
  $chartOptions$$1$$.styleDefaults.lineType = $options$$237$$.lineType;
  $chartOptions$$1$$.styleDefaults.markerSize = $options$$237$$.markerSize;
  $chartOptions$$1$$.styleDefaults.markerShape = $options$$237$$.markerShape;
  $chartOptions$$1$$.styleDefaults.barGapRatio = $options$$237$$.barGapRatio;
  $chartOptions$$1$$.styleDefaults.dataItemGaps = "0%";
  $chartOptions$$1$$.xAxis.rendered = "off";
  $chartOptions$$1$$.yAxis.rendered = "off";
  $bFloatingBar_zeroBaseline$$1$$ = "zero" == $options$$237$$.baselineScaling;
  ...
  $chartOptions$$1$$.styleDefaults.seriesEffect = "none" == $options$$237$$.visualEffects || !("area" == $options$$237$$.type || "lineWithArea" == $options$$237$$.type) ? "color" : "gradient";
