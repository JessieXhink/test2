...
define(["ojs/ojcore", "jquery"], function($oj$$9$$, $$$$9$$) {
  ...
  $oj$$9$$.$ArrayTableDataSource$.prototype.reset = function $$oj$$9$$$$ArrayTableDataSource$$$reset$($data$$58$$, $options$$231$$) {
    ...
    this.$_rows$.indexes = [];
    this.$_totalSize$ = 0;
    null != $data$$58$$ && this.add($data$$58$$, $options$$231$$);
  ...
  $oj$$9$$.$ArrayTableDataSource$.$_getKey$ = function $$oj$$9$$$$ArrayTableDataSource$$$_getKey$$($val$$27$$, $attr$$14$$) {
    return $$$$9$$.isFunction($val$$27$$[$attr$$14$$]) ? $val$$27$$[$attr$$14$$]() : $val$$27$$[$attr$$14$$];
  };
  ...
  $oj$$9$$.$CollectionTableDataSource$.prototype.at = function $$oj$$9$$$$CollectionTableDataSource$$$at$($index$$104$$, $options$$239$$) {
    ...
    return new Promise(function($resolve$$26$$, $reject$$26$$) {
      null != $model$$57$$ ? $model$$57$$.then(function($resolvedModel$$) {
        ...
        $self$$49$$.$_isFetchingForAt$ = !1;
        $oj$$9$$.$TableDataSource$.$superclass$.handleEvent.call($self$$49$$, $oj$$9$$.$TableDataSource$.$EventType$.ERROR, $e$$49$$);
        $reject$$26$$($e$$49$$);
      }) : $resolve$$26$$(null);
    });
  };
  ...
  $oj$$9$$.$CollectionTableDataSource$.prototype.get = function $$oj$$9$$$$CollectionTableDataSource$$$get$($id$$20$$, $options$$241$$) {
    ...
    return new Promise(function($resolve$$27$$, $reject$$27$$) {
      null != $model$$58$$ ? $model$$58$$.then(function($resolvedModel$$1$$) {
        ...
        $oj$$9$$.$TableDataSource$.$superclass$.handleEvent.call($self$$50$$, $oj$$9$$.$TableDataSource$.$EventType$.ERROR, $e$$50$$);
        $reject$$27$$($e$$50$$);
      }) : $resolve$$27$$(null);
    });
  };
  ...
  $oj$$9$$.$CollectionTableDataSource$.prototype.$_addCollectionEventListeners$ = function $$oj$$9$$$$CollectionTableDataSource$$$$_addCollectionEventListeners$$() {
    var $self$$52$$ = this;
    this.$_collection$.on($oj$$9$$.$Events$.$EventType$.SYNC, function($event$$66_result$$25$$) {
      if ($event$$66_result$$25$$ instanceof $oj$$9$$.$Collection$ && !$self$$52$$.$_isFetchingForAt$ && !$self$$52$$.$_isFetching$) {
        var $startIndex$$3$$ = $event$$66_result$$25$$.offset, $pageSize$$2$$ = $event$$66_result$$25$$.lastFetchCount;
        0 < $pageSize$$2$$ ? ($self$$52$$.$_startIndex$ = $startIndex$$3$$, $self$$52$$.$_pageSize$ = $pageSize$$2$$, $self$$52$$.$_isFetchingForAt$ = !0, $event$$66_result$$25$$.$IterativeAt$($startIndex$$3$$, $startIndex$$3$$ + $pageSize$$2$$).then(function($modelArray$$2$$) {
        ...
        })) : ($event$$66_result$$25$$ = $self$$52$$.$_getRowArray$(), $self$$52$$.$_endFetch$.call($self$$52$$, {silent:!1}, $event$$66_result$$25$$, null));
      }
    });
    this.$_collection$.on($oj$$9$$.$Events$.$EventType$.ALLADDED, function($event$$67$$, $modelArray$$3$$) {
    ...
    this.$_collection$.on($oj$$9$$.$Events$.$EventType$.ALLREMOVED, function($event$$68$$, $modelArray$$4$$) {
    ...
    this.$_collection$.on($oj$$9$$.$Events$.$EventType$.RESET, function($event$$69$$) {
      $oj$$9$$.$TableDataSource$.$superclass$.handleEvent.call($self$$52$$, $oj$$9$$.$TableDataSource$.$EventType$.RESET, $event$$69$$);
    });
    this.$_collection$.on($oj$$9$$.$Events$.$EventType$.SORT, function($event$$70$$, $eventOpts$$2$$) {
      null != $eventOpts$$2$$ && $eventOpts$$2$$.add || $oj$$9$$.$TableDataSource$.$superclass$.handleEvent.call($self$$52$$, $oj$$9$$.$TableDataSource$.$EventType$.SORT, $event$$70$$);
    });
    this.$_collection$.on($oj$$9$$.$Events$.$EventType$.CHANGE, function($event$$71$$) {
      $oj$$9$$.$TableDataSource$.$superclass$.handleEvent.call($self$$52$$, $oj$$9$$.$TableDataSource$.$EventType$.CHANGE, {data:[$event$$71$$.attributes], keys:[$event$$71$$.id], indexes:[$event$$71$$.index]});
    });
    this.$_collection$.on($oj$$9$$.$Events$.$EventType$.DESTROY, function($event$$72$$) {
      $oj$$9$$.$TableDataSource$.$superclass$.handleEvent.call($self$$52$$, $oj$$9$$.$TableDataSource$.$EventType$.DESTROY, $event$$72$$);
    });
    this.$_collection$.on($oj$$9$$.$Events$.$EventType$.REFRESH, function($event$$73$$) {
      $oj$$9$$.$TableDataSource$.$superclass$.handleEvent.call($self$$52$$, $oj$$9$$.$TableDataSource$.$EventType$.REFRESH, $event$$73$$);
    });
    ...
    return new Promise(function($resolve$$29$$, $reject$$29$$) {
      if ($self$$53$$.$_isPaged$) {
        ...
        if (0 < $self$$53$$.$_collection$.size()) {
          ...
          }, error:function($collection$$31$$, $e$$51$$) {
            $self$$53$$.$_collection$ = $collection$$31$$;
            $self$$53$$.$_endFetch$.call($self$$53$$, $options$$243$$, null, $e$$51$$);
            $reject$$29$$($e$$51$$);
          }});
        }
      }
  ...
  $oj$$9$$.$DomScroller$ = function $$oj$$9$$$$DomScroller$$($element$$61$$, $datasource$$, $options$$246$$) {
    $options$$246$$ = $options$$246$$ || {};
    this.$_data$ = $datasource$$;
    this.$_element$ = $element$$61$$;
    ...
    $$$$9$$(this.$_element$).on("scroll.domscroller", function($event$$74_maxScrollTop$$) {
      var $scrollTop$$ = $$$$9$$($event$$74_maxScrollTop$$.target).scrollTop();
      $event$$74_maxScrollTop$$ = $$$$9$$($event$$74_maxScrollTop$$.target)[0].scrollHeight - $$$$9$$($event$$74_maxScrollTop$$.target)[0].clientHeight;
      0 < $event$$74_maxScrollTop$$ && this.$_handleScrollerScrollTop$($scrollTop$$, $event$$74_maxScrollTop$$);
    }.bind(this));
  };
  ...
  $oj$$9$$.$DomScroller$.prototype.checkViewport = function $$oj$$9$$$$DomScroller$$$checkViewport$() {
    return this.$_checkOverflow$() ? Promise.resolve(null) : this.$_fetchMoreRows$();
  };
  ...
  $oj$$9$$.$DomScroller$.prototype.$_checkOverflow$ = function $$oj$$9$$$$DomScroller$$$$_checkOverflow$$() {
    var $element$$62$$ = this.$_element$;
    return 0 < $element$$62$$[0].clientHeight && $element$$62$$[0].scrollHeight > $element$$62$$[0].clientHeight ? !0 : !1;
  };
  $oj$$9$$.$DomScroller$.prototype.$_fetchMoreRows$ = function $$oj$$9$$$$DomScroller$$$$_fetchMoreRows$$() {
    ...
    if (0 < $remainingCount$$) {
      ...
      return $remainingCount$$ < this.$_fetchSize$ ? new Promise(function($resolve$$30$$) {
        $fetchPromise$$.then(function($result$$32$$) {
          null != $result$$32$$ && ($result$$32$$.maxCount = $self$$55$$.$_maxCount$, $result$$32$$.maxCountLimit = !0, $self$$55$$.$_rowCount$ = $result$$32$$.data.length + $result$$32$$.startIndex);
          $resolve$$30$$($result$$32$$);
        });
      }) : new Promise(function($resolve$$31$$) {
        $fetchPromise$$.then(function($result$$33$$) {
          null != $result$$33$$ && ($self$$55$$.$_rowCount$ = $result$$33$$.data.length + $result$$33$$.startIndex);
  ...
  $oj$$9$$.$DomScroller$.prototype.$_fetchNext$ = function $$oj$$9$$$$DomScroller$$$$_fetchNext$$($options$$247$$) {
    ...
    if (-1 == this.$_data$.totalSize() || this.$_data$.totalSize() > this.$_currentStartIndex$) {
      ...
      return new Promise(function($resolve$$32$$, $reject$$32$$) {
        $self$$56$$.$_data$.fetch({startIndex:$self$$56$$.$_currentStartIndex$, pageSize:$pageSize$$4$$}).then(function($result$$34$$) {
          $resolve$$32$$($result$$34$$);
        }, function() {
          $reject$$32$$(null);
        });
      });
  ...
  $oj$$9$$.$PagingTableDataSource$.prototype.setPage = function $$oj$$9$$$$PagingTableDataSource$$$setPage$($value$$171$$, $options$$250$$) {
    ...
    return new Promise(function($resolve$$33$$, $reject$$33$$) {
      0 < $self$$57$$.$_pageSize$ ? $self$$57$$.$dataSource$.fetch($options$$250$$).then(function($result$$35$$) {
        $result$$35$$.startIndex = 0;
  ...
  $oj$$9$$.$PagingTableDataSource$.prototype.fetch = function $$oj$$9$$$$PagingTableDataSource$$$fetch$($options$$252$$) {
    ...
    return new Promise(function($resolve$$34$$, $reject$$34$$) {
      0 < $pageSize$$5$$ ? $self$$58$$.$dataSource$.fetch($options$$252$$).then(function($result$$36$$) {
        $self$$58$$.$_updateEndIndex$();
        $resolve$$34$$($result$$36$$);
      }, function($e$$53$$) {
        $reject$$34$$($e$$53$$);
      }) : $resolve$$34$$(null);
    });
  ...
  $oj$$9$$.$PagingTableDataSource$.prototype.on = function $$oj$$9$$$$PagingTableDataSource$$$on$($eventType$$31$$, $eventHandler$$3$$) {
    ...
    if ($eventType$$31$$ == $oj$$9$$.$TableDataSource$.$EventType$.SYNC) {
      var $ev$$ = function $$ev$$$($event$$75$$) {
        $self$$59$$.$_handleSyncEvent$($event$$75$$, $eventHandler$$3$$);
      };
      $dataSource$$1$$.on($eventType$$31$$, $ev$$);
      return $ev$$;
    }
    if ($eventType$$31$$ == $oj$$9$$.$TableDataSource$.$EventType$.ADD || $eventType$$31$$ == $oj$$9$$.$TableDataSource$.$EventType$.REMOVE || $eventType$$31$$ == $oj$$9$$.$TableDataSource$.$EventType$.CHANGE) {
      return $ev$$ = function $$ev$$$($event$$76$$) {
        $self$$59$$.$_handleRowEvent$($event$$76$$, $eventHandler$$3$$);
      }, $dataSource$$1$$.on($eventType$$31$$, $ev$$), $ev$$;
    }
    if ($eventType$$31$$ == $oj$$9$$.$TableDataSource$.$EventType$.REFRESH || $eventType$$31$$ == $oj$$9$$.$TableDataSource$.$EventType$.RESET) {
      return $ev$$ = function $$ev$$$($event$$77$$) {
        $self$$59$$.$_startIndex$ = 0;
        $eventHandler$$3$$($event$$77$$);
      }, $dataSource$$1$$.on($eventType$$31$$, $ev$$), $ev$$;
    }
  ...
  $oj$$9$$.$PagingTableDataSource$.prototype.$_handleRowEvent$ = function $$oj$$9$$$$PagingTableDataSource$$$$_handleRowEvent$$($event$$78$$, $eventHandler$$5$$) {
    var $ignoreRows$$ = [], $i$$157$$;
    for ($i$$157$$ = 0;$i$$157$$ < $event$$78$$.indexes.length;$i$$157$$++) {
      var $rowIdx$$ = $event$$78$$.indexes[$i$$157$$];
      void 0 !== $rowIdx$$ && ($rowIdx$$ -= this.$_startIndex$, (0 > $rowIdx$$ || $rowIdx$$ >= this.$_startIndex$ + this.$_pageSize$) && $ignoreRows$$.push($i$$157$$));
    }
    if (0 < $ignoreRows$$.length) {
      for ($ignoreRows$$.sort(function($a$$98$$, $b$$63$$) {
        return $a$$98$$ - $b$$63$$;
      }), $i$$157$$ = $ignoreRows$$.length - 1;0 <= $i$$157$$;$i$$157$$--) {
        $event$$78$$.data.splice($ignoreRows$$[$i$$157$$], 1), $event$$78$$.indexes.splice($ignoreRows$$[$i$$157$$], 1), $event$$78$$.keys.splice($ignoreRows$$[$i$$157$$], 1);
      }
    }
    this.$_updateEndIndex$();
    $event$$78$$.startIndex = this.$_startIndex$;
    $eventHandler$$5$$($event$$78$$);
  };
  $oj$$9$$.$PagingTableDataSource$.prototype.$_handleSyncEvent$ = function $$oj$$9$$$$PagingTableDataSource$$$$_handleSyncEvent$$($event$$79$$, $eventHandler$$6$$) {
    $event$$79$$.startIndex != this.$_startIndex$ && (this.$_startIndex$ = $event$$79$$.startIndex);
    this.$_updateEndIndex$();
    if ("page" == this.$_fetchType$) {
      var $clonedEvent$$ = {};
      $oj$$9$$.$CollectionUtils$.$copyInto$($clonedEvent$$, $event$$79$$);
      $clonedEvent$$.startIndex = 0;
      $eventHandler$$6$$($clonedEvent$$);
    } else {
      $eventHandler$$6$$($event$$79$$);
    }
  };
  ...
  $oj$$9$$.$JsonNodeSet$ = function $$oj$$9$$$$JsonNodeSet$$($startNode$$, $endNode$$, $data$$60$$, $currKey$$) {
  ...
  $oj$$9$$.$JsonNodeSet$.prototype.$_updateDepth$ = function $$oj$$9$$$$JsonNodeSet$$$$_updateDepth$$($currChild$$3$$, $offset$$17$$) {
    ...
    if ($currChild$$3$$.children && 0 != $currChild$$3$$.children.length) {
      for ($i$$158$$ = 0;$i$$158$$ < $currChild$$3$$.children.length;$i$$158$$++) {
        this.$_updateDepth$($currChild$$3$$.children[$i$$158$$], $offset$$17$$);
      }
    }
  };
  $oj$$9$$.$JsonNodeSet$.prototype.$getChildNodeSet$ = function $$oj$$9$$$$JsonNodeSet$$$$getChildNodeSet$$($index$$108_key$$54$$) {
    var $results$$2$$, $depth$$6$$, $i$$159$$;
    ...
    for ($i$$159$$ = 0;$i$$159$$ < $results$$2$$.length;$i$$159$$++) {
      this.$_updateDepth$($results$$2$$[$i$$159$$], $depth$$6$$);
    }
  ...
  $oj$$9$$.$DataGridDataSource$ = function $$oj$$9$$$$DataGridDataSource$$($data$$61$$) {
    $oj$$9$$.$DataGridDataSource$.$superclass$.constructor.call(this, $data$$61$$);
  };
