...
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore"], function($oj$$51$$, $$$$48$$) {
  (function() {
    $oj$$51$$.$__registerWidget$("oj.ojTrain", $$$$48$$.oj.baseComponent, {version:"1.0.0", defaultElement:"\x3cdiv\x3e", widgetEventPrefix:"oj", options:{steps:[], selected:"", optionChange:null, beforeDeselect:null, deselect:null, beforeSelect:null, select:null}, $_stepNum$:0, $_stepArray$:null, _ComponentCreate:function() {
      ...
      var $i$$435_options$$381$$ = this.options, $stepTag_steps$$4$$ = $i$$435_options$$381$$.steps;
      ...
      var $styleClass$$8$$ = this.element.attr("class");
      (this.$_stretch$ = null != $styleClass$$8$$ && 0 <= $styleClass$$8$$.indexOf("oj-train-stretch")) && this.$_connectorWrapper$.css("padding", "0 " + 100 / (2 * this.$_stepNum$) + "%");
      ...
      this.$_setupArray$();
      this.$_selectedIndex$ = this.$_getStepIndex$($i$$435_options$$381$$.selected);
      -1 === this.$_selectedIndex$ && $stepTag_steps$$4$$[0] && $stepTag_steps$$4$$[0].id && (this.$_selectedIndex$ = 0, $i$$435_options$$381$$.selected = $stepTag_steps$$4$$[0].id);
      for ($i$$435_options$$381$$ = 0;$i$$435_options$$381$$ < this.$_stepNum$;$i$$435_options$$381$$++) {
        $stepTag_steps$$4$$ = $$$$48$$("\x3cli\x3e").addClass("oj-train-step-list-item").attr({id:this.$_stepArray$[$i$$435_options$$381$$][1]}), $stepTag_steps$$4$$.appendTo(this.$_stepList$), this.$_drawLabel$($i$$435_options$$381$$), this.$_drawStepFill$($i$$435_options$$381$$), this.$_drawButton$($i$$435_options$$381$$), this.$_drawMessageType$($i$$435_options$$381$$), this.$_stretch$ && $stepTag_steps$$4$$.css("width", 100 / this.$_stepNum$ + "%");
      }
      ...
      this.$_stepArray$ = [];
      for (var $i$$436$$ = 0;$i$$436$$ < this.$_stepNum$;$i$$436$$++) {
        var $step$$4$$ = $options$$382$$.steps[$i$$436$$];
        this.$_stepArray$[$i$$436$$] = Array(5);
        this.$_stepArray$[$i$$436$$][0] = $step$$4$$.label ? $step$$4$$.label : null;
        this.$_stepArray$[$i$$436$$][1] = $step$$4$$.id ? $step$$4$$.id : null;
        this.$_stepArray$[$i$$436$$][2] = $step$$4$$.disabled ? !0 : !1;
        this.$_stepArray$[$i$$436$$][3] = $step$$4$$.visited ? !0 : !1;
        this.$_stepArray$[$i$$436$$][4] = $step$$4$$.messageType ? $step$$4$$.messageType : null;
      }
    }, $_drawButton$:function($index$$283$$) {
      var $button$$1$$ = $$$$48$$("\x3cdiv/\x3e").addClass("oj-train-button"), $scrnRead$$ = $$$$48$$("\x3cspan/\x3e"), $self$$188$$ = this, $desc$$1$$ = "";
      if (this.$_stepArray$[$index$$283$$]) {
        ...
        this.$_stepArray$[$index$$283$$][2] || this.$_selectedIndex$ === $index$$283$$ || (this._hoverable($button$$1$$), $button$$1$$.on("click" + this.eventNamespace, function() {
          $self$$188$$.$_fireOptionChange$("selected", $self$$188$$.options.selected, this.parentNode.parentNode.id, !0);
          $self$$188$$.refresh();
        }));
      ...
      var $icon$$7$$ = $$$$48$$("\x3cdiv/\x3e").addClass("oj-train-icon"), $scrnRead$$1$$ = $$$$48$$("\x3cspan/\x3e"), $desc$$2$$ = "", $self$$189$$ = this;
      if (this.$_stepArray$[$index$$284$$]) {
        ...
        this.$_stepArray$[$index$$284$$][2] || this.$_selectedIndex$ === $index$$284$$ || (this._hoverable($icon$$7$$), $icon$$7$$.on("click" + this.eventNamespace, function() {
          $self$$189$$.$_fireOptionChange$("selected", $self$$189$$.options.selected, this.parentNode.parentNode.parentNode.id, !0);
          $self$$189$$.refresh();
        }));
      ...
      if (this.$_stepArray$[$index$$286$$]) {
        var $labelWrapper$$ = $$$$48$$("\x3cdiv/\x3e").addClass("oj-train-label-wrapper"), $label$$13_stepLi$$1$$ = $$$$48$$("\x3ca\x3e" + this.$_stepArray$[$index$$286$$][0] + "\x3c/a\x3e"), $disabled$$9$$ = this.$_stepArray$[$index$$286$$][2];
        $labelWrapper$$.append($label$$13_stepLi$$1$$);
        $label$$13_stepLi$$1$$.addClass("oj-train-label");
        $index$$286$$ === this.$_selectedIndex$ ? $label$$13_stepLi$$1$$.addClass("oj-selected") : this.$_stepArray$[$index$$286$$][3] && !$disabled$$9$$ ? $label$$13_stepLi$$1$$.addClass("oj-visited") : $disabled$$9$$ && $label$$13_stepLi$$1$$.addClass("oj-disabled");
        $disabled$$9$$ || ($label$$13_stepLi$$1$$.attr("href", "#"), this._hoverable($label$$13_stepLi$$1$$), $label$$13_stepLi$$1$$.on("click keydown" + this.eventNamespace, function($event$$564$$) {
          if ($event$$564$$.keyCode === $$$$48$$.ui.keyCode.ENTER || "click" === $event$$564$$.type) {
            $event$$564$$.preventDefault(), $self$$190$$.$_fireOptionChange$("selected", $self$$190$$.options.selected, this.parentNode.parentNode.id, !0), $self$$190$$.refresh(), $event$$564$$.keyCode === $$$$48$$.ui.keyCode.ENTER && $self$$190$$.$_setFocus$(this.parentNode.parentNode.id);
          }
        }));
        $label$$13_stepLi$$1$$ = this.$_stepList$.children().eq($index$$286$$).children();
      ...
      for (var $i$$437$$ = 0;$i$$437$$ < this.$_stepNum$;$i$$437$$++) {
        if (this.$_stepArray$[$i$$437$$] && this.$_stepArray$[$i$$437$$][1] === $id$$54$$) {
          return $i$$437$$;
        }
      }
      return-1;
      ...
      for (var $i$$438$$ = 0;$i$$438$$ < this.$_stepNum$;$i$$438$$++) {
        if (this.$_stepArray$[$i$$438$$] && this.$_stepArray$[$i$$438$$][1] === $id$$55$$) {
          return jQuery.extend({}, this.options.steps[$i$$438$$]);
        }
      }
      return null;
    }, nextSelectableStep:function() {
      for (var $i$$439$$ = this.$_getStepIndex$(this.options.selected);$i$$439$$ < this.$_stepNum$;$i$$439$$++) {
        if ($i$$439$$ + 1 < this.$_stepNum$ && this.$_stepArray$[$i$$439$$ + 1] && !this.$_stepArray$[$i$$439$$ + 1][2]) {
          return this.$_stepArray$[$i$$439$$ + 1][1];
        }
      }
      return null;
    }, previousSelectableStep:function() {
      for (var $i$$440$$ = this.$_getStepIndex$(this.options.selected);0 <= $i$$440$$;$i$$440$$--) {
        if (this.$_stepArray$[$i$$440$$ - 1] && !this.$_stepArray$[$i$$440$$ - 1][2]) {
      ...
      for (var $i$$441$$ = 0;$i$$441$$ < this.$_stepNum$;$i$$441$$++) {
        if (this.$_stepArray$[($id$$56_index$$287$$ + $i$$441$$ + 1) % this.$_stepNum$] && !this.$_stepArray$[($id$$56_index$$287$$ + $i$$441$$ + 1) % this.$_stepNum$][2]) {
          this.$_stepList$.children().eq(($id$$56_index$$287$$ + $i$$441$$ + 1) % this.$_stepNum$).find(".oj-train-label").focus();
          break;
        }
      }
    }, getNodeBySubId:function($locator$$53$$) {
      if (null === $locator$$53$$) {
        return this.element ? this.element[0] : null;
      }
      var $index$$288$$ = $locator$$53$$.index;
      if ("number" !== typeof $index$$288$$ || 0 > $index$$288$$ || $index$$288$$ >= this.$_stepNum$) {
        return null;
      }
      switch($locator$$53$$.subId) {
