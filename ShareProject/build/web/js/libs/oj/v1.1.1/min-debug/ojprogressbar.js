...
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore"], function($oj$$60$$, $$$$55$$) {
  (function() {
    $oj$$60$$.$__registerWidget$("oj.ojProgressbar", $$$$55$$.oj.baseComponent, {version:"1.0.0", defaultElement:"\x3cdiv\x3e", widgetEventPrefix:"oj", options:{max:100, value:0, disabled:!1}, min:0, $_indeterminate$:!1, _ComponentCreate:function() {
      ...
      var $dom_element$$123$$ = this.element;
      this._super($originalDefaults$$19$$, $constructorOptions$$21$$);
      void 0 === $constructorOptions$$21$$.max && ($dom_element$$123$$ = $dom_element$$123$$.attr("max") || void 0, null != $dom_element$$123$$ && (this.options.max = $dom_element$$123$$));
    }, $_constrainedValue$:function($newValue$$16$$) {
      void 0 === $newValue$$16$$ && ($newValue$$16$$ = this.options.value);
      this.$_indeterminate$ = -1 == $newValue$$16$$;
      "number" !== typeof $newValue$$16$$ && ($newValue$$16$$ = isNaN($newValue$$16$$) ? 0 : Number($newValue$$16$$));
      return this.$_indeterminate$ ? -1 : Math.min(this.options.max, Math.max(this.min, $newValue$$16$$));
    }, _setOptions:function($options$$393$$, $flags$$45$$) {
      var $value$$278$$ = $options$$393$$.value;
      delete $options$$393$$.value;
      this._super($options$$393$$, $flags$$45$$);
      this.options.disabled || (this.options.value = this.$_constrainedValue$($value$$278$$), this.$_refreshValue$());
    }, _setOption:function($key$$178$$, $value$$279$$, $flags$$46$$) {
      "max" === $key$$178$$ && ($value$$279$$ = Math.max(this.min, $value$$279$$));
      this._super($key$$178$$, $value$$279$$, $flags$$46$$);
