...
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore", "ojs/ojdvt-base", "ojs/internal-deps/dvt/DvtChart"], function($oj$$43$$, $$$$42$$, $comp$$15$$, $base$$12$$, $dvt$$9$$) {
  $oj$$43$$.$SparkChartDataItem$ = function $$oj$$43$$$$SparkChartDataItem$$($data$$170$$) {
    this.$_data$ = $data$$170$$;
  };
  ...
  $oj$$43$$.$__registerWidget$("oj.ojChart", $$$$42$$.oj.dvtBaseComponent, {widgetEventPrefix:"oj", options:{categoryFilter:null, categoryHighlight:null, optionChange:null, selectInput:null, viewportChange:null, viewportChangeInput:null, drill:null}, $_CreateDvtComponent$:function($context$$108$$, $callback$$117$$, $callbackObj$$11$$) {
    return $dvt$$9$$.DvtChart.newInstance($context$$108$$, $callback$$117$$, $callbackObj$$11$$);
  }, $_ConvertLocatorToSubId$:function($locator$$47$$) {
    var $subId$$44$$ = $locator$$47$$.subId;
    "oj-chart-item" == $subId$$44$$ ? $subId$$44$$ = "dataItem[" + $locator$$47$$.seriesIndex + "][" + $locator$$47$$.itemIndex + "]" : "oj-chart-group" == $subId$$44$$ ? $subId$$44$$ = "group" + this.$_GetStringFromIndexPath$($locator$$47$$.indexPath) : "oj-chart-series" == $subId$$44$$ ? $subId$$44$$ = "series[" + $locator$$47$$.index + "]" : "oj-chart-axis-title" == $subId$$44$$ ? $subId$$44$$ = $locator$$47$$.axis + ":title" : "oj-chart-reference-object" == $subId$$44$$ ? $subId$$44$$ = $locator$$47$$.axis + 
    ":referenceObject[" + $locator$$47$$.index + "]" : "oj-legend-section" == $subId$$44$$ ? $subId$$44$$ = "legend:section" + this.$_GetStringFromIndexPath$($locator$$47$$.indexPath) : "oj-legend-item" == $subId$$44$$ ? ($subId$$44$$ = "legend:section" + this.$_GetStringFromIndexPath$($locator$$47$$.sectionIndexPath), $subId$$44$$ += ":item[" + $locator$$47$$.itemIndex + "]") : "oj-chart-tooltip" == $subId$$44$$ && ($subId$$44$$ = "tooltip");
    return $subId$$44$$;
  }, $_ConvertSubIdToLocator$:function($itemSubstr_subId$$45$$) {
    var $locator$$48$$ = {};
    if (0 == $itemSubstr_subId$$45$$.indexOf("dataItem")) {
      var $indexPath$$3_sectionSubstr$$ = this.$_GetIndexPath$($itemSubstr_subId$$45$$);
      $locator$$48$$.subId = "oj-chart-item";
      $locator$$48$$.seriesIndex = $indexPath$$3_sectionSubstr$$[0];
      $locator$$48$$.itemIndex = $indexPath$$3_sectionSubstr$$[1];
    } else {
      if (0 == $itemSubstr_subId$$45$$.indexOf("group")) {
        $locator$$48$$.subId = "oj-chart-group", $locator$$48$$.indexPath = this.$_GetIndexPath$($itemSubstr_subId$$45$$);
      } else {
        if (0 == $itemSubstr_subId$$45$$.indexOf("series")) {
          $locator$$48$$.subId = "oj-chart-series", $locator$$48$$.index = this.$_GetFirstIndex$($itemSubstr_subId$$45$$);
        } else {
          if (0 < $itemSubstr_subId$$45$$.indexOf("Axis:title")) {
            $locator$$48$$.subId = "oj-chart-axis-title", $locator$$48$$.axis = $itemSubstr_subId$$45$$.substring(0, $itemSubstr_subId$$45$$.indexOf(":"));
          } else {
            if (0 < $itemSubstr_subId$$45$$.indexOf("Axis:referenceObject")) {
              $locator$$48$$.subId = "oj-chart-reference-object", $locator$$48$$.axis = $itemSubstr_subId$$45$$.substring(0, $itemSubstr_subId$$45$$.indexOf(":")), $locator$$48$$.index = this.$_GetFirstIndex$($itemSubstr_subId$$45$$);
            } else {
              if (0 == $itemSubstr_subId$$45$$.indexOf("legend")) {
                if (0 < $itemSubstr_subId$$45$$.indexOf(":item")) {
                  var $itemStartIndex$$ = $itemSubstr_subId$$45$$.indexOf(":item"), $indexPath$$3_sectionSubstr$$ = $itemSubstr_subId$$45$$.substring(0, $itemStartIndex$$);
                  $itemSubstr_subId$$45$$ = $itemSubstr_subId$$45$$.substring($itemStartIndex$$);
                  $locator$$48$$.subId = "oj-legend-item";
                  $locator$$48$$.sectionIndexPath = this.$_GetIndexPath$($indexPath$$3_sectionSubstr$$);
                  $locator$$48$$.itemIndex = this.$_GetFirstIndex$($itemSubstr_subId$$45$$);
                } else {
                  0 == $itemSubstr_subId$$45$$.indexOf("section") && ($locator$$48$$.subId = "oj-legend-section", $locator$$48$$.indexPath = this.$_GetIndexPath$($itemSubstr_subId$$45$$));
                }
              } else {
                "tooltip" == $itemSubstr_subId$$45$$ && ($locator$$48$$.subId = "oj-chart-tooltip");
              }
            }
          }
        }
    ...
    var $filterType_type$$96$$ = $event$$516_selectPayload$$ && $event$$516_selectPayload$$.getType ? $event$$516_selectPayload$$.getType() : null;
    if ($filterType_type$$96$$ === $dvt$$9$$.DvtSelectionEvent.TYPE || $filterType_type$$96$$ === $dvt$$9$$.DvtSelectionEvent.TYPE_INPUT) {
      var $selection$$16$$ = $event$$516_selectPayload$$.getSelection();
      if ($selection$$16$$) {
        for (var $selectedItems_viewportChangePayload$$1$$ = [], $i$$424$$ = 0;$i$$424$$ < $selection$$16$$.length;$i$$424$$++) {
          var $selectedItem$$ = {id:$selection$$16$$[$i$$424$$].getId(), series:$selection$$16$$[$i$$424$$].getSeries(), group:$selection$$16$$[$i$$424$$].getGroup()};
        ...
        $filterType_type$$96$$ === $dvt$$9$$.DvtSelectionEvent.TYPE ? this.$_UserOptionChange$("selection", $selectedItems_viewportChangePayload$$1$$, $event$$516_selectPayload$$) : ($event$$516_selectPayload$$.items = $selectedItems_viewportChangePayload$$1$$, this._trigger("selectInput", null, $event$$516_selectPayload$$));
      }
    } else {
      $filterType_type$$96$$ === $dvt$$9$$.DvtCategoryHideShowEvent.TYPE_HIDE || $filterType_type$$96$$ === $dvt$$9$$.DvtCategoryHideShowEvent.TYPE_SHOW ? ($filterType_type$$96$$ = $filterType_type$$96$$ === $dvt$$9$$.DvtCategoryHideShowEvent.TYPE_HIDE ? "out" : "in", this._trigger("categoryFilter", null, {category:$event$$516_selectPayload$$.getCategory(), type:$filterType_type$$96$$}), this.$_UserOptionChange$("hiddenCategories", $event$$516_selectPayload$$.hiddenCategories)) : $filterType_type$$96$$ === 
      $dvt$$9$$.DvtCategoryRolloverEvent.TYPE_OVER || $filterType_type$$96$$ === $dvt$$9$$.DvtCategoryRolloverEvent.TYPE_OUT ? (this._trigger("categoryHighlight", null, {categories:$event$$516_selectPayload$$.categories, type:$filterType_type$$96$$ === $dvt$$9$$.DvtCategoryRolloverEvent.TYPE_OVER ? "on" : "off"}), this.$_UserOptionChange$("highlightedCategories", $event$$516_selectPayload$$.categories)) : $filterType_type$$96$$ === $dvt$$9$$.DvtChartViewportChangeEvent.TYPE || $filterType_type$$96$$ === 
      $dvt$$9$$.DvtChartViewportChangeEvent.TYPE_INPUT ? ($selectedItems_viewportChangePayload$$1$$ = {endGroup:$event$$516_selectPayload$$.getEndGroup(), startGroup:$event$$516_selectPayload$$.getStartGroup(), xMax:$event$$516_selectPayload$$.getXMax(), xMin:$event$$516_selectPayload$$.getXMin(), yMax:$event$$516_selectPayload$$.getYMax(), yMin:$event$$516_selectPayload$$.getYMin()}, $filterType_type$$96$$ === $dvt$$9$$.DvtChartViewportChangeEvent.TYPE && (this.options.xAxis || (this.options.xAxis = 
      ...
      $event$$516_selectPayload$$.getYMin(), this.options.yAxis.viewportMax = $event$$516_selectPayload$$.getYMax())), this._trigger($filterType_type$$96$$ === $dvt$$9$$.DvtChartViewportChangeEvent.TYPE ? "viewportChange" : "viewportChangeInput", null, $selectedItems_viewportChangePayload$$1$$)) : $filterType_type$$96$$ === $dvt$$9$$.DvtDrillEvent.TYPE ? this._trigger("drill", null, {id:$event$$516_selectPayload$$.getId(), series:$event$$516_selectPayload$$.getSeries(), group:$event$$516_selectPayload$$.getGroup()}) : 
  ...
  $oj$$43$$.$__registerWidget$("oj.ojSparkChart", $$$$42$$.oj.dvtBaseComponent, {widgetEventPrefix:"oj", options:{}, $_CreateDvtComponent$:function($context$$109$$, $callback$$118$$, $callbackObj$$12$$) {
    return $dvt$$9$$.DvtSparkChart.newInstance($context$$109$$, $callback$$118$$, $callbackObj$$12$$);
  }, $_GetComponentStyleClasses$:function() {
