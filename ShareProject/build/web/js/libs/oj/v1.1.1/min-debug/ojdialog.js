...
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore", "ojs/ojpopupcore", "jqueryui-amd/draggable"], function($oj$$34$$, $$$$33$$) {
  (function() {
    ...
    $oj$$34$$.$__registerWidget$("oj.ojResizable", $$$$33$$.oj.baseComponent, {version:"1.0.0", widgetEventPrefix:"oj", options:{cancel:"input,textarea,button,select,option", distance:1, delay:0, maxHeight:null, maxWidth:null, minHeight:10, minWidth:10, alsoResize:!1, animate:!1, animateDuration:"slow", animateEasing:"swing", containment:!1, ghost:!1, grid:!1, handles:"e,s,se", helper:!1, resize:null, start:null, stop:null}, $_mouseInit$:function() {
      var $that$$1$$ = this;
      this.element.bind("mousedown." + this.widgetName, function($event$$423$$) {
        return $that$$1$$.$_mouseDown$($event$$423$$);
      }).bind("click." + this.widgetName, function($event$$424$$) {
        if (!0 === $$$$33$$.data($event$$424$$.target, $that$$1$$.widgetName + ".preventClickEvent")) {
          return $$$$33$$.removeData($event$$424$$.target, $that$$1$$.widgetName + ".preventClickEvent"), $event$$424$$.stopImmediatePropagation(), !1;
        }
      });
    }, $_mouseDestroy$:function() {
      this.element.unbind("." + this.widgetName);
      this.$_mouseMoveDelegate$ && this.document.unbind("mousemove." + this.widgetName, this.$_mouseMoveDelegate$).unbind("mouseup." + this.widgetName, this.$_mouseUpDelegate$);
    }, $_mouseDown$:function($event$$425$$) {
      if (!$mouseHandled$$) {
        this.$_mouseStarted$ && this.$_mouseUp$($event$$425$$);
        this.$_mouseDownEvent$ = $event$$425$$;
        var $that$$2$$ = this, $btnIsLeft$$ = 1 === $event$$425$$.which, $elIsCancel$$ = "string" === typeof this.options.cancel && $event$$425$$.target.nodeName ? $$$$33$$($event$$425$$.target).closest(this.options.cancel).length : !1;
        if (!$btnIsLeft$$ || $elIsCancel$$ || !this.$_mouseCapture$($event$$425$$)) {
          return!0;
        }
        (this.$mouseDelayMet$ = !this.options.delay) || setTimeout(function() {
          $that$$2$$.$mouseDelayMet$ = !0;
        }, this.options.delay);
        if (this.$_mouseDistanceMet$($event$$425$$) && this.$mouseDelayMet$ && (this.$_mouseStarted$ = !1 !== this.$_mouseStart$($event$$425$$), !this.$_mouseStarted$)) {
          return $event$$425$$.preventDefault(), !0;
        }
        !0 === $$$$33$$.data($event$$425$$.target, this.widgetName + ".preventClickEvent") && $$$$33$$.removeData($event$$425$$.target, this.widgetName + ".preventClickEvent");
        this.$_mouseMoveDelegate$ = function $this$$_mouseMoveDelegate$$($event$$426$$) {
          return $that$$2$$.$_mouseMove$($event$$426$$);
        };
        this.$_mouseUpDelegate$ = function $this$$_mouseUpDelegate$$($event$$427$$) {
          return $that$$2$$.$_mouseUp$($event$$427$$);
        };
        this.document.bind("mousemove." + this.widgetName, this.$_mouseMoveDelegate$).bind("mouseup." + this.widgetName, this.$_mouseUpDelegate$);
        $event$$425$$.preventDefault();
        return $mouseHandled$$ = !0;
      }
    }, $_mouseMove$:function($event$$428$$) {
      if ($$$$33$$.ui.$ie$ && (!document.documentMode || 9 > document.documentMode) && !$event$$428$$.button || !$event$$428$$.which) {
        return this.$_mouseUp$($event$$428$$);
      }
      if (this.$_mouseStarted$) {
        return this.$_mouseDrag$($event$$428$$), $event$$428$$.preventDefault();
      }
      this.$_mouseDistanceMet$($event$$428$$) && this.$mouseDelayMet$ && ((this.$_mouseStarted$ = !1 !== this.$_mouseStart$(this.$_mouseDownEvent$, $event$$428$$)) ? this.$_mouseDrag$($event$$428$$) : this.$_mouseUp$($event$$428$$));
      return!this.$_mouseStarted$;
    }, $_mouseUp$:function($event$$429$$) {
      this.document.unbind("mousemove." + this.widgetName, this.$_mouseMoveDelegate$).unbind("mouseup." + this.widgetName, this.$_mouseUpDelegate$);
      this.$_mouseStarted$ && (this.$_mouseStarted$ = !1, $event$$429$$.target === this.$_mouseDownEvent$.target && $$$$33$$.data($event$$429$$.target, this.widgetName + ".preventClickEvent", !0), this.$_mouseStop$($event$$429$$));
      return $mouseHandled$$ = !1;
    }, $_mouseDistanceMet$:function($event$$430$$) {
      return Math.max(Math.abs(this.$_mouseDownEvent$.pageX - $event$$430$$.pageX), Math.abs(this.$_mouseDownEvent$.pageY - $event$$430$$.pageY)) >= this.options.distance;
      ...
      this._super();
      var $n$$24_o$$, $i$$377$$, $handle$$19$$, $axis$$46$$, $hname$$, $that$$3$$ = this;
      $n$$24_o$$ = this.options;
      ...
      if (this.handles.constructor === String) {
        for ("all" === this.handles && (this.handles = "n,e,s,w,se,sw,ne,nw"), $n$$24_o$$ = this.handles.split(","), this.handles = {}, $i$$377$$ = 0;$i$$377$$ < $n$$24_o$$.length;$i$$377$$++) {
          $handle$$19$$ = $$$$33$$.trim($n$$24_o$$[$i$$377$$]), $hname$$ = "oj-resizable-" + $handle$$19$$, $axis$$46$$ = $$$$33$$("\x3cdiv class\x3d'oj-resizable-handle " + $hname$$ + "'\x3e\x3c/div\x3e"), this.handles[$handle$$19$$] = ".oj-resizable-" + $handle$$19$$, this.element.append($axis$$46$$);
        }
      }
      this.$_renderAxis$ = function $this$$_renderAxis$$() {
        for (var $i$$378$$ in this.handles) {
          this.handles[$i$$378$$].constructor === String && (this.handles[$i$$378$$] = this.element.children(this.handles[$i$$378$$]).first().show());
        }
      };
      this.$_renderAxis$();
      ...
      var $i$$379$$, $handle$$20$$, $capture$$ = !1;
      for ($i$$379$$ in this.handles) {
        if ($handle$$20$$ = $$$$33$$(this.handles[$i$$379$$])[0], $handle$$20$$ === $event$$431$$.target || $$$$33$$.contains($handle$$20$$, $event$$431$$.target)) {
          $capture$$ = !0;
        }
      }
      ...
      var $data$$150_dx$$4$$, $el$$13$$ = this.helper, $props$$19$$ = {}, $dy$$4_smp$$ = this.$originalMousePosition$;
      $data$$150_dx$$4$$ = $event$$433$$.pageX - $dy$$4_smp$$.left || 0;
      var $dy$$4_smp$$ = $event$$433$$.pageY - $dy$$4_smp$$.top || 0, $trigger$$ = this.$_change$[this.axis];
      this.$prevPosition$ = {top:this.position.top, left:this.position.left};
      this.$prevSize$ = {width:this.size.width, height:this.size.height};
      if (!$trigger$$) {
        return!1;
      }
      $data$$150_dx$$4$$ = $trigger$$.apply(this, [$event$$433$$, $data$$150_dx$$4$$, $dy$$4_smp$$]);
      this.$_updateVirtualBoundaries$($event$$433$$.shiftKey);
      $event$$433$$.shiftKey && ($data$$150_dx$$4$$ = this.$_updateRatio$($data$$150_dx$$4$$, $event$$433$$));
      $data$$150_dx$$4$$ = this.$_respectSize$($data$$150_dx$$4$$, $event$$433$$);
      this.$_updateCache$($data$$150_dx$$4$$);
      ...
      $$$$33$$.isEmptyObject($props$$19$$) || this._trigger("resize", $event$$433$$, this.ui());
      return!1;
    ...
    }, $_updateCache$:function($data$$151$$) {
      this.offset = this.helper.offset();
      this.$_isNumber$($data$$151$$.left) && (this.position.left = $data$$151$$.left);
      this.$_isNumber$($data$$151$$.top) && (this.position.top = $data$$151$$.top);
      this.$_isNumber$($data$$151$$.height) && (this.size.height = $data$$151$$.height);
      this.$_isNumber$($data$$151$$.width) && (this.size.width = $data$$151$$.width);
    }, $_updateRatio$:function($data$$152$$) {
      var $cpos$$ = this.position, $csize$$ = this.size, $a$$109$$ = this.axis;
      this.$_isNumber$($data$$152$$.height) ? $data$$152$$.width = $data$$152$$.height * this.$aspectRatio$ : this.$_isNumber$($data$$152$$.width) && ($data$$152$$.height = $data$$152$$.width / this.$aspectRatio$);
      "sw" === $a$$109$$ && ($data$$152$$.left = $cpos$$.left + ($csize$$.width - $data$$152$$.width), $data$$152$$.top = null);
      "nw" === $a$$109$$ && ($data$$152$$.top = $cpos$$.top + ($csize$$.height - $data$$152$$.height), $data$$152$$.left = $cpos$$.left + ($csize$$.width - $data$$152$$.width));
      return $data$$152$$;
    }, $_respectSize$:function($data$$153$$) {
      var $o$$4$$ = this.$_vBoundaries$, $a$$110_ch$$2$$ = this.axis, $ismaxw$$ = this.$_isNumber$($data$$153$$.width) && $o$$4$$.maxWidth && $o$$4$$.maxWidth < $data$$153$$.width, $ismaxh$$ = this.$_isNumber$($data$$153$$.height) && $o$$4$$.maxHeight && $o$$4$$.maxHeight < $data$$153$$.height, $isminw$$ = this.$_isNumber$($data$$153$$.width) && $o$$4$$.minWidth && $o$$4$$.minWidth > $data$$153$$.width, $isminh$$ = this.$_isNumber$($data$$153$$.height) && $o$$4$$.minHeight && $o$$4$$.minHeight > 
      $data$$153$$.height, $dw$$ = this.$originalPosition$.left + this.$originalSize$.width, $dh$$ = this.position.top + this.size.height, $cw$$ = /sw|nw|w/.test($a$$110_ch$$2$$), $a$$110_ch$$2$$ = /nw|ne|n/.test($a$$110_ch$$2$$);
      $isminw$$ && ($data$$153$$.width = $o$$4$$.minWidth);
      $isminh$$ && ($data$$153$$.height = $o$$4$$.minHeight);
      $ismaxw$$ && ($data$$153$$.width = $o$$4$$.maxWidth);
      $ismaxh$$ && ($data$$153$$.height = $o$$4$$.maxHeight);
      $isminw$$ && $cw$$ && ($data$$153$$.left = $dw$$ - $o$$4$$.minWidth);
      $ismaxw$$ && $cw$$ && ($data$$153$$.left = $dw$$ - $o$$4$$.maxWidth);
      $isminh$$ && $a$$110_ch$$2$$ && ($data$$153$$.top = $dh$$ - $o$$4$$.minHeight);
      $ismaxh$$ && $a$$110_ch$$2$$ && ($data$$153$$.top = $dh$$ - $o$$4$$.maxHeight);
      $data$$153$$.width || $data$$153$$.height || $data$$153$$.left || !$data$$153$$.top ? $data$$153$$.width || $data$$153$$.height || $data$$153$$.top || !$data$$153$$.left || ($data$$153$$.left = null) : $data$$153$$.top = null;
      return $data$$153$$;
    }, $_proportionallyResize$:function() {
      if (this.$_proportionallyResizeElements$.length) {
        var $i$$380$$, $j$$40$$, $borders$$, $paddings$$, $prel$$, $element$$110$$ = this.helper || this.element;
        for ($i$$380$$ = 0;$i$$380$$ < this.$_proportionallyResizeElements$.length;$i$$380$$++) {
          $prel$$ = this.$_proportionallyResizeElements$[$i$$380$$];
          if (!this.$borderDif$) {
          ...
          $prel$$.css({height:$element$$110$$.height() - this.$borderDif$[0] - this.$borderDif$[2] || 0, width:$element$$110$$.width() - this.$borderDif$[1] - this.$borderDif$[3] || 0});
        }
      }
      ...
      return $$$$33$$.extend(this.$_change$.s.apply(this, arguments), this.$_change$.e.apply(this, [$event$$439$$, $dx$$9$$, $dy$$7$$]));
    }, sw:function($event$$440$$, $dx$$10$$, $dy$$8$$) {
      return $$$$33$$.extend(this.$_change$.s.apply(this, arguments), this.$_change$.w.apply(this, [$event$$440$$, $dx$$10$$, $dy$$8$$]));
    }, ne:function($event$$441$$, $dx$$11$$, $dy$$9$$) {
      return $$$$33$$.extend(this.$_change$.n.apply(this, arguments), this.$_change$.e.apply(this, [$event$$441$$, $dx$$11$$, $dy$$9$$]));
    }, nw:function($event$$442$$, $dx$$12$$, $dy$$10$$) {
      return $$$$33$$.extend(this.$_change$.n.apply(this, arguments), this.$_change$.w.apply(this, [$event$$442$$, $dx$$12$$, $dy$$10$$]));
    ...
    }, $_alsoresize_resize$:function($event$$444$$, $ui$$20$$) {
      function $_alsoResize$$($exp$$5$$, $c$$46$$) {
        $$$$33$$($exp$$5$$).each(function() {
          ...
          $$$$33$$.each($c$$46$$ && $c$$46$$.length ? $c$$46$$ : $el$$16$$.parents($ui$$20$$.$originalElement$[0]).length ? ["width", "height"] : ["width", "height", "top", "left"], function($i$$381$$, $prop$$65$$) {
      ...
      var $element$$111$$, $p$$7$$, $co_oc$$, $ch$$3_height$$28$$, $cw$$1_width$$30$$, $that$$7$$ = this, $ce_el$$17$$ = $that$$7$$.element;
      ...
      if ($ce_el$$17$$ = $co_oc$$ instanceof $$$$33$$ ? $co_oc$$.get(0) : /parent/.test($co_oc$$) ? $ce_el$$17$$.parent().get(0) : $co_oc$$) {
        $that$$7$$.$containerElement$ = $$$$33$$($ce_el$$17$$), /document/.test($co_oc$$) || $co_oc$$ === document ? ($that$$7$$.$containerOffset$ = {left:0, top:0}, $that$$7$$.$containerPosition$ = {left:0, top:0}, $that$$7$$.$parentData$ = {element:$$$$33$$(document), left:0, top:0, width:$$$$33$$(document).width(), height:$$$$33$$(document).height() || document.body.parentNode.scrollHeight}) : ($element$$111$$ = $$$$33$$($ce_el$$17$$), $p$$7$$ = [], $$$$33$$(["Top", "Right", "Left", "Bottom"]).each(function($i$$382$$, 
        $name$$109$$) {
          $p$$7$$[$i$$382$$] = $that$$7$$.$_num$($element$$111$$.css("padding" + $name$$109$$));
        }), $that$$7$$.$containerOffset$ = $element$$111$$.offset(), $that$$7$$.$containerPosition$ = $element$$111$$.position(), $that$$7$$.$containerSize$ = {height:$element$$111$$.innerHeight() - $p$$7$$[3], width:$element$$111$$.innerWidth() - $p$$7$$[1]}, $co_oc$$ = $that$$7$$.$containerOffset$, $ch$$3_height$$28$$ = $that$$7$$.$containerSize$.height, $cw$$1_width$$30$$ = $that$$7$$.$containerSize$.width, $cw$$1_width$$30$$ = $that$$7$$.$_hasScroll$($ce_el$$17$$, "left") ? $ce_el$$17$$.scrollWidth : 
    ...
    }, $_containment_resize$:function($event$$445$$, $ui$$21$$) {
  ...
  (function() {
    $oj$$34$$.$__registerWidget$("oj.ojDialog", $$$$33$$.oj.baseComponent, {version:"1.0.0", widgetEventPrefix:"oj", options:{cancelBehavior:"icon", dragAffordance:"title-bar", initialVisibility:"hide", modality:"modal", position:{my:"center", at:"center", of:window, collision:"fit", $using$:function($pos$$11$$) {
    ...
    }, disable:$$$$33$$.noop, enable:$$$$33$$.noop, close:function($event$$446$$) {
      ...
      return this.$_isOpen$;
    }, open:function($event$$447_psOptions$$5$$) {
      !1 !== this._trigger("beforeOpen", $event$$447_psOptions$$5$$) && (this.isOpen() || (this.$_isOpen$ = !0, this.opener = $$$$33$$(this.document[0].activeElement), this.$_size$(), "resizable" === this.options.resizeBehavior && this.$_makeResizable$(), $event$$447_psOptions$$5$$ = {}, $event$$447_psOptions$$5$$[$oj$$34$$.$PopupService$.$OPTION$.$POPUP$] = this.$uiDialog$, $event$$447_psOptions$$5$$[$oj$$34$$.$PopupService$.$OPTION$.$LAUNCHER$] = this.opener, $event$$447_psOptions$$5$$[$oj$$34$$.$PopupService$.$OPTION$.$POSITION$] = 
      this.options.position, $event$$447_psOptions$$5$$[$oj$$34$$.$PopupService$.$OPTION$.$MODALITY$] = this.options.modality, $event$$447_psOptions$$5$$[$oj$$34$$.$PopupService$.$OPTION$.$EVENTS$] = this.$_getPopupServiceEvents$(), $event$$447_psOptions$$5$$[$oj$$34$$.$PopupService$.$OPTION$.$LAYER_SELECTORS$] = "oj-dialog-layer", $oj$$34$$.$PopupService$.$getInstance$().open($event$$447_psOptions$$5$$), this._trigger("open")), this.$_focusTabbable$());
    }, refresh:function() {
      this._super();
      this.$_size$();
      this.$_resizeBody$();
    ...
    }, _keepFocus:function($activeElement$$inline_946_event$$448$$) {
      $activeElement$$inline_946_event$$448$$.preventDefault();
      $activeElement$$inline_946_event$$448$$ = this.document[0].activeElement;
      this.$uiDialog$[0] === $activeElement$$inline_946_event$$448$$ || $$$$33$$.contains(this.$uiDialog$[0], $activeElement$$inline_946_event$$448$$) || this.$_focusTabbable$();
      ...
      this._on(this.$uiDialog$, {keyup:function() {
        ...
        if ("none" != this.options.cancelBehavior && !$event$$450$$.isDefaultPrevented() && $event$$450$$.keyCode && $event$$450$$.keyCode === $$$$33$$.ui.keyCode.ESCAPE) {
          $event$$450$$.preventDefault(), $event$$450$$.stopImmediatePropagation(), this.close($event$$450$$);
        } else {
          if ($event$$450$$.keyCode === $$$$33$$.ui.keyCode.TAB && "modeless" !== this.options.modality) {
            var $tabbables$$ = this.$uiDialog$.find(":tabbable"), $first$$7_index$$222$$ = $tabbables$$.filter(":first"), $last$$4$$ = $tabbables$$.filter(":last");
            $event$$450$$.shiftKey ? $event$$450$$.shiftKey && ($event$$450$$.target === $first$$7_index$$222$$[0] || $event$$450$$.target === this.$uiDialog$[0] ? ($last$$4$$.focus(), $event$$450$$.preventDefault()) : ($first$$7_index$$222$$ = $tabbables$$.index(document.activeElement), 1 == $first$$7_index$$222$$ && $tabbables$$[0] && ($tabbables$$[0].focus(), $event$$450$$.preventDefault()))) : $event$$450$$.target === $last$$4$$[0] || $event$$450$$.target === this.$uiDialog$[0] ? ($first$$7_index$$222$$.focus(), 
            $event$$450$$.preventDefault()) : ($first$$7_index$$222$$ = $tabbables$$.index(document.activeElement), 0 == $first$$7_index$$222$$ && $tabbables$$[1] && ($tabbables$$[1].focus(), $event$$450$$.preventDefault()));
          }
        }
      }});
      ...
      this._on(this.$uiDialogTitlebarCloseWrapper$, {click:function($event$$451$$) {
        ...
        $$$$33$$($event$$452$$.currentTarget).addClass("oj-active");
      }, mouseup:function($event$$453$$) {
        $$$$33$$($event$$453$$.currentTarget).removeClass("oj-active");
      }, mouseenter:function($event$$454$$) {
        $$$$33$$($event$$454$$.currentTarget).addClass("oj-hover");
      }, mouseleave:function($currTarget$$7_event$$455$$) {
        $currTarget$$7_event$$455$$ = $currTarget$$7_event$$455$$.currentTarget;
        $$$$33$$($currTarget$$7_event$$455$$).removeClass("oj-hover");
        $$$$33$$($currTarget$$7_event$$455$$).removeClass("oj-active");
      }, keyup:function($event$$456$$) {
        if ($event$$456$$.keyCode && $event$$456$$.keyCode === $$$$33$$.ui.keyCode.SPACE || $event$$456$$.keyCode === $$$$33$$.ui.keyCode.ENTER) {
      ...
      this._on(this.$uiDialogTitlebar$, {mousedown:function($event$$457$$) {
        $$$$33$$($event$$457$$.target).closest(".oj-dialog-close-icon") || this.$uiDialog$.focus();
      }});
      ...
      this.$uiDialog$.draggable({$addClasses$:!1, cancel:".oj-dialog-content, .oj-dialog-header-close", handle:".oj-dialog-header", containment:"document", start:function($event$$458$$, $ui$$23$$) {
        $$$$33$$(this).addClass("oj-dialog-dragging");
        $that$$11$$.$_blockFrames$();
        $that$$11$$._trigger("dragStart", $event$$458$$, $filteredUi$$($ui$$23$$));
      }, drag:function($event$$459$$, $ui$$24$$) {
        $that$$11$$._trigger("drag", $event$$459$$, $filteredUi$$($ui$$24$$));
      }, stop:function($event$$460$$, $ui$$25$$) {
        ...
        $that$$11$$._trigger("dragStop", $event$$460$$, $filteredUi$$($ui$$25$$));
      }});
      ...
      this.$_resizableComponent$({cancel:".oj-dialog-content", containment:"document", handles:"n,e,s,w,se,sw,ne,nw", start:function($event$$461$$, $ui$$27$$) {
        $that$$12$$.$_isResizing$ = !0;
        $$$$33$$(this).addClass("oj-dialog-resizing");
        $that$$12$$.$_blockFrames$();
        $that$$12$$._trigger("resizeStart", $event$$461$$, $filteredUi$$1$$($ui$$27$$));
      }, resize:function($event$$462$$, $ui$$28$$) {
        $that$$12$$._trigger("resize", $event$$462$$, $filteredUi$$1$$($ui$$28$$));
      }, stop:function($event$$463$$, $ui$$29$$) {
        $that$$12$$.$_isResizing$ = !1;
        $$$$33$$(this).removeClass("oj-dialog-resizing");
        $that$$12$$.$_unblockFrames$();
        $that$$12$$._trigger("resizeStop", $event$$463$$, $filteredUi$$1$$($ui$$29$$));
      }});
    }, $_position$:function() {
    ...
    }, _setOption:function($isDraggable$$1_key$$143$$, $value$$247$$, $flags$$35$$) {
      var $isResizable_psOptions$$6_uiDialog$$;
      $isResizable_psOptions$$6_uiDialog$$ = this.$uiDialog$;
      if ("disabled" !== $isDraggable$$1_key$$143$$) {
        switch(this._super($isDraggable$$1_key$$143$$, $value$$247$$, $flags$$35$$), $isDraggable$$1_key$$143$$) {
          case "dragAffordance":
    ...
    }, getNodeBySubId:function($dotSubId_locator$$32_subId$$31$$) {
      if (null == $dotSubId_locator$$32_subId$$31$$) {
        return this.element ? this.element[0] : null;
      }
      $dotSubId_locator$$32_subId$$31$$ = $dotSubId_locator$$32_subId$$31$$.subId;
      switch($dotSubId_locator$$32_subId$$31$$) {
        case "oj-dialog":
        ;
        ...
        case "oj-resizable-nw":
          return $dotSubId_locator$$32_subId$$31$$ = "." + $dotSubId_locator$$32_subId$$31$$, this.widget().find($dotSubId_locator$$32_subId$$31$$)[0];
      }
      return null;
