...
define(["ojs/ojcore", "jquery", "hammerjs", "promise", "ojs/ojjquery-hammer", "ojs/ojcomponentcore"], function($oj$$23$$, $$$$22$$, $Hammer$$3$$) {
  ...
  $oj$$23$$.$OffcanvasUtils$.$_registerCloseHandler$ = function $$oj$$23$$$$OffcanvasUtils$$$_registerCloseHandler$$($offcanvas$$4$$) {
    ...
    if ($oj$$23$$.$OffcanvasUtils$.$_isAutoDismiss$($offcanvas$$4$$)) {
      var $drawer$$5$$ = $$$$22$$($offcanvas$$4$$.selector), $dismisHandler$$ = $offcanvas$$4$$.dismisHandler = function $$offcanvas$$4$$$dismisHandler$($event$$293$$) {
        var $target$$85$$ = $event$$293$$.target;
        $oj$$23$$.$DomUtils$.$isChromeEvent$($event$$293$$) || "focus" === $event$$293$$.type && !$$$$22$$($target$$85$$).is(":focusable") || $oj$$23$$.$DomUtils$.$isLogicalAncestorOrSelf$($drawer$$5$$[0], $target$$85$$) || $oj$$23$$.$OffcanvasUtils$.close($offcanvas$$4$$);
  ...
  $oj$$23$$.$OffcanvasUtils$.$_registerSwipeHandler$ = function $$oj$$23$$$$OffcanvasUtils$$$_registerSwipeHandler$$($offcanvas$$6$$) {
    if ($oj$$23$$.$DomUtils$.$isTouchSupported$()) {
      ...
      $drawer$$6_drawerHammer$$ = $drawer$$6_drawerHammer$$.$ojHammer$($options$$313$$).on($swipeEvent$$, function($event$$294$$) {
  ...
  $oj$$23$$.$OffcanvasUtils$.$setupResponsive$ = function $$oj$$23$$$$OffcanvasUtils$$$setupResponsive$$($mqListener_offcanvas$$9$$) {
    ...
    if (null !== $mqs_query$$9$$) {
      ...
      $mqListener_offcanvas$$9$$ = function $$mqListener_offcanvas$$9$$$($event$$295$$) {
        $oj$$23$$.$OffcanvasUtils$.$_setVisible$($selector$$26$$, $event$$295$$.matches, $edge$$9$$);
      };
  ...
  $oj$$23$$.$OffcanvasUtils$.open = function $$oj$$23$$$$OffcanvasUtils$$open$($offcanvas$$11$$) {
    ...
    var $oldOffcanvas_promise$$3$$ = new Promise(function($resolve$$48$$, $reject$$47$$) {
      $oj$$23$$.$Assert$.$assertPrototype$($drawer$$11$$, jQuery);
      var $edge$$10$$ = $oj$$23$$.$OffcanvasUtils$.$_saveEdge$($offcanvas$$11$$), $displayMode$$1_event$$296$$ = $$$$22$$.Event("ojbeforeopen");
      $drawer$$11$$.trigger($displayMode$$1_event$$296$$, $offcanvas$$11$$);
      if (!1 === $displayMode$$1_event$$296$$.result) {
        $reject$$47$$("ojbeforeopen veto");
      } else {
        var $size$$21$$, $displayMode$$1_event$$296$$ = $offcanvas$$11$$.displayMode, $wrapper$$7$$ = $oj$$23$$.$OffcanvasUtils$.$_getAnimateWrapper$($offcanvas$$11$$);
        ...
        "start" == $edge$$10$$ || "end" == $edge$$10$$ ? ($size$$21$$ = void 0 === $size$$21$$ ? $drawer$$11$$.outerWidth(!0) + "px" : $size$$21$$, "push" == $displayMode$$1_event$$296$$ && $oj$$23$$.$OffcanvasUtils$.$_setTranslationX$($wrapper$$7$$, $edge$$10$$, $size$$21$$)) : ($size$$21$$ = void 0 === $size$$21$$ ? $drawer$$11$$.outerHeight(!0) + "px" : $size$$21$$, "push" == $displayMode$$1_event$$296$$ && $oj$$23$$.$OffcanvasUtils$.$_setTranslationY$($wrapper$$7$$, $edge$$10$$, $size$$21$$));
  ...
  $oj$$23$$.$OffcanvasUtils$.$_close$ = function $$oj$$23$$$$OffcanvasUtils$$$_close$$($selector$$27$$, $animation$$) {
    ...
    var $promise$$4$$ = new Promise(function($resolve$$49$$, $reject$$48$$) {
      if ($oj$$23$$.$OffcanvasUtils$.$_isOpen$($drawer$$12$$)) {
        $selector$$27$$ != $offcanvas$$13$$.selector && $resolve$$49$$(!0);
        ...
        $outerWrapper$$1$$.hasClass($edge$$11_shiftSelector$$) || $resolve$$49$$(!0);
        var $event$$297_wrapper$$8$$ = $$$$22$$.Event("ojbeforeclose");
        $drawer$$12$$.trigger($event$$297_wrapper$$8$$, $offcanvas$$13$$);
        !1 === $event$$297_wrapper$$8$$.result ? $reject$$48$$("beforeClose veto") : ($event$$297_wrapper$$8$$ = $oj$$23$$.$OffcanvasUtils$.$_getAnimateWrapper$($offcanvas$$13$$), $animation$$ && $oj$$23$$.$OffcanvasUtils$.$_onTransitionEnd$($event$$297_wrapper$$8$$, function() {
          $oj$$23$$.$OffcanvasUtils$.$_afterCloseHandler$($offcanvas$$13$$);
          $resolve$$49$$(!0);
        }), "push" == $displayMode$$2$$ && $oj$$23$$.$OffcanvasUtils$.$_setTransform$($event$$297_wrapper$$8$$, ""), $outerWrapper$$1$$.removeClass($edge$$11_shiftSelector$$), $animation$$ ? $event$$297_wrapper$$8$$.addClass("oj-offcanvas-transition") : ($oj$$23$$.$OffcanvasUtils$.$_afterCloseHandler$($offcanvas$$13$$), $resolve$$49$$(!0)));
      } else {
        $resolve$$49$$(!0);
      }
    });
