...
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore", "ojs/ojconveyorbelt", "jqueryui-amd/sortable", "ojs/ojtouchproxy"], function($oj$$46$$, $$$$45$$) {
  (function() {
    ...
    $oj$$46$$.$__registerWidget$("oj.ojTabs", $$$$45$$.oj.baseComponent, {widgetEventPrefix:"oj", delay:300, options:{selected:0, disabledTabs:null, truncation:"auto", selectOn:"click", orientation:"horizontal", edge:"top", removable:!1, reorderable:!1, beforeSelect:null, select:null, beforeDeselect:null, deselect:null, beforeRemove:null, remove:null, beforeReorder:null, reorder:null, optionChange:null}, _ComponentCreate:function() {
    ...
    }, $_NotifyContextMenuGesture$:function($menu$$24_openOptions$$7$$, $event$$530$$, $eventType$$54$$) {
      if (this.$_isInATab$($event$$530$$.target) && (!this.$_touchProxy$ || !this.$_touchProxy$.$_touchMoved$)) {
        var $disabledState$$1_keyboard$$1$$ = "keyboard" === $eventType$$54$$;
        if ("contextmenu" == $event$$530$$.type || $disabledState$$1_keyboard$$1$$ || "touch" == $eventType$$54$$) {
          $menu$$24_openOptions$$7$$ = {launcher:$$$$45$$($event$$530$$.target).closest("li")}, this.$_menu$.tab = $disabledState$$1_keyboard$$1$$ ? this.$active$ : $menu$$24_openOptions$$7$$.launcher, this.$_menu$.tab ? (this.$_menu$.$usermenu$ && (this.$_menu$.$$elemPasteBefore$ || this.$_menu$.$$elemPasteAfter$) && ($disabledState$$1_keyboard$$1$$ = !this.$_menu$.$cutTab$, this.$_menu$.$$elemPasteBefore$.hasClass("oj-disabled") != $disabledState$$1_keyboard$$1$$ && ($disabledState$$1_keyboard$$1$$ ? 
          (this.$_menu$.$$elemPasteBefore$.addClass("oj-disabled"), this.$_menu$.$$elemPasteAfter$.addClass("oj-disabled")) : (this.$_menu$.$$elemPasteBefore$.removeClass("oj-disabled"), this.$_menu$.$$elemPasteAfter$.removeClass("oj-disabled")), this.$_menu$.$$container$.ojMenu("refresh"))), this.$_OpenContextMenu$($event$$530$$, $eventType$$54$$, $menu$$24_openOptions$$7$$)) : $event$$530$$.preventDefault();
        }
      }
    }, $_tabKeydown$:function($event$$531$$) {
      if (!this.$_handlePageNav$($event$$531$$)) {
        ...
        switch($event$$531$$.keyCode) {
          ...
          case $$$$45$$.ui.keyCode.HOME:
            ...
            break;
          case 46:
            this.options.removable && ($anchor$$3_focusedTab$$ = this.$_getCloseIcons$(this.$active$)) && ($event$$531$$.preventDefault(), this.$_removeTabHandler$({target:$anchor$$3_focusedTab$$, currentTarget:$anchor$$3_focusedTab$$, preventDefault:$$$$45$$.noop}));
            return;
          default:
            return;
        }
        ...
        if (!$event$$531$$.ctrlKey) {
          $anchor$$3_focusedTab$$.attr("aria-selected", "false");
          $enabledTabs_selTab$$.attr("aria-selected", "true");
          var $idOrIndex$$ = this.$_getTabIdOrIndex$($enabledTabs_selTab$$), $self$$172$$ = this;
          this.$activating$ = this._delay(function() {
            $self$$172$$ && $self$$172$$.$tabs$ && $self$$172$$.option("selected", $idOrIndex$$, {_context:{originalEvent:$event$$531$$}});
          }, this.delay);
        }
      }
    }, $_panelKeydown$:function($event$$532$$) {
      $$$$45$$($event$$532$$.target).closest(".oj-tabs-selected").attr("id") === this.element.children(".oj-tabs-selected").attr("id") && !this.$_handlePageNav$($event$$532$$) && $event$$532$$.ctrlKey && $event$$532$$.keyCode === $$$$45$$.ui.keyCode.UP && ($event$$532$$.preventDefault(), this.$active$.focus());
    }, $_handlePageNav$:function($event$$533$$) {
      var $selectedIndex$$3$$ = this.$_getSelectedIndex$();
      if ($event$$533$$.ctrlKey && $event$$533$$.keyCode === $$$$45$$.ui.keyCode.PAGE_UP) {
        return this.$_activate$(this.$_focusNextTab$($selectedIndex$$3$$, !1)), !0;
      }
      if ($event$$533$$.ctrlKey && $event$$533$$.keyCode === $$$$45$$.ui.keyCode.PAGE_DOWN) {
    ...
    }, _setOption:function($edge$$12_key$$167_selectedIndex$$4$$, $value$$258$$, $flags$$41$$) {
      ...
      var $self$$173$$ = this, $edge$$13$$ = this.options.edge;
      this.$_destroyTabBar$();
      this.$_createTabbar$();
      ...
      this.$tablist$.children("li").each(function() {
        ...
        $self$$173$$.$tabs$ = $self$$173$$.$tabs$.add($tab$$);
        var $anchor$$4_anchorId_div$$9$$ = $anchor$$4_anchorId_div$$9$$.uniqueId().attr("id"), $panelId$$ = $tab$$.attr("data-content"), $panel$$ = $self$$173$$.element.find($self$$173$$.$_sanitizeSelector$("#" + $panelId$$));
        $tab$$.attr({"aria-controls":$panelId$$, "aria-labelledby":$anchor$$4_anchorId_div$$9$$});
        $self$$173$$.$panels$ = $self$$173$$.$panels$.add($panel$$);
        $panel$$.attr("aria-labelledby", $anchor$$4_anchorId_div$$9$$).attr("role", "tabpanel");
      });
      "start" != $edge$$13$$ && "end" != $edge$$13$$ || $self$$173$$.$tablist$.addClass("oj-tabs-nav-root");
      this.$_initialRender$ && this.$_setOjDisabledOnTab$(this.options.disabledTabs);
    }, $_setupEvents$:function() {
      var $events$$15$$ = {keydown:this.$_tabKeydown$}, $enabledTabs$$2_event$$534$$ = this.options.selectOn, $selectOnClick$$ = !1;
      if ($enabledTabs$$2_event$$534$$) {
        var $self$$174$$ = this;
        $$$$45$$.each($enabledTabs$$2_event$$534$$.split(" "), function($index$$260$$, $eventName$$2$$) {
          "click" == $eventName$$2$$ && ($selectOnClick$$ = !0);
          $oj$$46$$.$DomUtils$.$isValidIdentifier$($eventName$$2$$) && ($events$$15$$[$eventName$$2$$] = $self$$174$$.$_eventHandler$);
        });
      }
      $enabledTabs$$2_event$$534$$ = this.$_getEnabledTabs$();
      this._on($enabledTabs$$2_event$$534$$, $events$$15$$);
      $selectOnClick$$ || this._on($enabledTabs$$2_event$$534$$, {click:function($e$$143$$) {
        $e$$143$$.preventDefault();
      }});
      this.$panels$.on("keydown" + this.eventNamespace, this.$_panelKeydown$.bind(this));
      if (this.options.removable) {
        var $revents$$ = {click:this.$_removeTabHandler$};
        this._on(this.$_getCloseIcons$($enabledTabs$$2_event$$534$$), $revents$$);
      }
      this._focusable($enabledTabs$$2_event$$534$$);
      this._hoverable($enabledTabs$$2_event$$534$$);
      this.$_activeable$($enabledTabs$$2_event$$534$$);
    ...
    }, $_eventHandler$:function($event$$535$$) {
      var $active$$2_eventData$$25$$ = this.$active$, $tab$$1$$ = $$$$45$$($event$$535$$.currentTarget).closest("li"), $clickedIsActive$$ = $active$$2_eventData$$25$$ && $tab$$1$$[0] === $active$$2_eventData$$25$$[0], $oToContent$$ = this.$_getPanelForTab$($tab$$1$$), $oFromContent$$ = $active$$2_eventData$$25$$ && $active$$2_eventData$$25$$.length ? this.$_getPanelForTab$($active$$2_eventData$$25$$) : $$$$45$$(), $active$$2_eventData$$25$$ = {fromTab:$active$$2_eventData$$25$$, fromContent:$oFromContent$$, 
      toTab:$tab$$1$$, toContent:$oToContent$$};
      $event$$535$$.preventDefault();
      $tab$$1$$.hasClass("oj-disabled") || this.$running$ || $clickedIsActive$$ || $oFromContent$$ && $oFromContent$$.length && !1 === this._trigger("beforeDeselect", $event$$535$$, $active$$2_eventData$$25$$) || !this.$_initialRender$ && !1 === this._trigger("beforeSelect", $event$$535$$, $active$$2_eventData$$25$$) || (this.$_initialRender$ ? this.options.selected = this.$_getTabIdOrIndex$($tab$$1$$) : this.option("selected", this.$_getTabIdOrIndex$($tab$$1$$), {_context:{originalEvent:$event$$535$$, 
      $internalSet$:!0}}), this.$active$ = $tab$$1$$, $oToContent$$.addClass("oj-tabs-selected"), $oFromContent$$ && $oFromContent$$.length && $oFromContent$$.removeClass("oj-tabs-selected"), this.$_toggle$($event$$535$$, $active$$2_eventData$$25$$));
    }, $_toggle$:function($event$$536$$, $eventData$$26$$) {
      ...
      this.$running$ = !1;
      this.$_initialRender$ || (this._trigger("deselect", $event$$536$$, $eventData$$26$$), this._trigger("select", $event$$536$$, $eventData$$26$$));
      ...
      var $self$$176$$ = this, $tab$$2$$, $div$$11$$, $anchor$$6$$, $header$$12$$;
      this.$tabs$.each(function($index$$262$$) {
        ...
        $self$$176$$.$_isOldMarkup$ ? $header$$12$$.prependTo($self$$176$$.$panels$.get($index$$262$$)) : $div$$11$$.hasClass("oj-tabs-gen-div") && $anchor$$6$$.hasClass("oj-tabs-gen-a") ? ($header$$12$$.prependTo($tab$$2$$), $div$$11$$.remove()) : $anchor$$6$$.hasClass("oj-tabs-gen-a") ? ($header$$12$$.prependTo($div$$11$$), $anchor$$6$$.remove()) : $div$$11$$.hasClass("oj-tabs-gen-div") && ($anchor$$6$$.prependTo($tab$$2$$), $div$$11$$.remove());
      });
    ...
    }, $_removeTabHandler$:function($event$$537$$) {
      var $tab$$3$$ = $$$$45$$($event$$537$$.currentTarget).closest("li"), $panel$$2$$ = this.$_getPanelForTab$($tab$$3$$), $eventData$$27$$ = {tab:$tab$$3$$, content:$panel$$2$$};
      if ($tab$$3$$ && !1 !== this._trigger("beforeRemove", $event$$537$$, $eventData$$27$$)) {
        $event$$537$$.preventDefault();
        if ($tab$$3$$.hasClass("oj-selected")) {
          var $nextIndex$$1$$ = this.$_getNextEnabledTab$(this.$tabs$.index($tab$$3$$));
          void 0 === $nextIndex$$1$$ ? (this.$active$ = void 0, this.option("selected", void 0, {_context:{originalEvent:$event$$537$$, $internalSet$:!0}})) : (this.$_fireSelectEvents$($nextIndex$$1$$), this.option("selected", this.$_getTabIdOrIndex$($$$$45$$(this.$tabs$[$nextIndex$$1$$])), {_context:{originalEvent:$event$$537$$, $internalSet$:!0}}));
        }
        ...
        this.refresh();
        this._trigger("remove", $event$$537$$, $eventData$$27$$);
      }
      ...
      window.setTimeout(function() {
        $self$$177$$.$tabs$ && $tab$$5$$[0].scrollIntoView(!1);
      }, 0);
      ...
      if (this.options.reorderable) {
        ...
        this.$tablist$.sortable({axis:$self$$178$$.$_isHorizontal$() ? "x" : "y", stop:function($event$$538$$, $ui$$38$$) {
          var $mvTab$$ = $ui$$38$$.item;
          $self$$178$$.$_doReorder$($event$$538$$, $mvTab$$, $mvTab$$.prev()) || $self$$178$$.$tablist$.sortable("cancel");
        }});
        this.$_sortable$ = !0;
      } else {
    ...
    }, getNodeBySubId:function($index$$265_locator$$50$$) {
      if (null == $index$$265_locator$$50$$) {
        return this.element ? this.element[0] : null;
      }
      var $subId$$47$$ = $index$$265_locator$$50$$.subId;
      $index$$265_locator$$50$$ = $index$$265_locator$$50$$.index;
      if ("oj-conveyorbelt" != $subId$$47$$ && ("number" !== typeof $index$$265_locator$$50$$ || 0 > $index$$265_locator$$50$$ || $index$$265_locator$$50$$ >= this.$panels$.length)) {
        return null;
      }
      switch($subId$$47$$) {
        ...
        case "oj-tabs-panel":
          return this.$_getPanelForTab$(this.$tabs$[$index$$265_locator$$50$$])[0];
        case "oj-tabs-tab":
          return this.$tabs$[$index$$265_locator$$50$$];
        case "oj-tabs-title":
          return $$$$45$$(this.$tabs$[$index$$265_locator$$50$$]).find(".oj-tabs-title")[0];
        case "oj-tabs-close-icon":
          return $$$$45$$(this.$tabs$[$index$$265_locator$$50$$]).find("." + $subId$$47$$)[0];
      }
      return null;
    ...
    }, $_menu_paste$:function($event$$539$$, $obj$$110$$, $pasteBefore$$2$$) {
      if (!$obj$$110$$ || !$obj$$110$$.length || !this.$_menu$.$cutTab$) {
        return!1;
      }
      var $mvTab$$1$$ = this.$_menu$.$cutTab$;
      this.$_menu$.$cutTab$ = !1;
      this.$_doReorder$($event$$539$$, $mvTab$$1$$, $obj$$110$$, $pasteBefore$$2$$);
    }, $_handleContextMenuSelect$:function($ev$$7$$, $ui$$39$$) {
      var $id$$49$$ = $ui$$39$$ ? $ui$$39$$.item.attr("id") : void 0;
      "ojtabscut" === $id$$49$$ ? this.$_menu_cut$(this.$_menu$.tab) : "ojtabspastebefore" === $id$$49$$ ? this.$_menu_paste$($ev$$7$$, this.$_menu$.tab, !0) : "ojtabspasteafter" === $id$$49$$ && this.$_menu_paste$($ev$$7$$, this.$_menu$.tab, !1);
      ...
      if (this.$_menu$ && this.$_menu$.$usermenu$ && this.options.reorderable) {
        var $$menuContainer$$2$$ = this.$_menu$.$$container$, $self$$179$$ = this;
        ...
        $$menuContainer$$2$$.find("[data-oj-command]").each(function() {
          if (0 === $$$$45$$(this).children("a").length) {
            ...
            $$$$45$$(this).replaceWith($self$$179$$.$_buildContextMenuItem$($command$$13$$));
    ...
    }, $_doReorder$:function($event$$540$$, $mvTab$$2$$, $prevTab$$, $pasteBefore$$3$$) {
      var $mvContent$$ = this.$_getPanelForTab$($mvTab$$2$$), $eventData$$28$$ = {tab:$mvTab$$2$$, content:$mvContent$$};
      if (!1 === this._trigger("beforeReorder", $event$$540$$, $eventData$$28$$)) {
        return!1;
      }
      ...
      this.refresh();
      $mvTab$$2$$.focus();
      this._trigger("reorder", $event$$540$$, $eventData$$28$$);
      return!0;
      ...
      if ($disTabs$$ && 0 < $disTabs$$.length) {
        for (var $id$$52$$, $tab$$8$$, $i$$427$$ = 0;$i$$427$$ < $disTabs$$.length;$i$$427$$++) {
          if ($tab$$8$$ = this.$_getTab$($disTabs$$[$i$$427$$])) {
      ...
      if (!$arr$$23$$) {
        ...
        this.$tablist$.children().each(function() {
          var $tab$$9$$ = $$$$45$$(this);
          $tab$$9$$.hasClass("oj-disabled") && $arr$$23$$.push($self$$180$$.$_getTabIdOrIndex$($tab$$9$$));
        });
      }
    ...
    }, $_isInATab$:function($element$$114$$) {
      var $found$$6$$ = !1;
      this.$tabs$.each(function() {
        if (this === $element$$114$$ || $$$$45$$.contains(this, $element$$114$$)) {
          return $found$$6$$ = !0, !1;
        }
      });
      return $found$$6$$;
    }, $_createTabbar$:function() {
      var $contentIds$$ = this.$_getContentIds$(), $self$$181$$ = this, $tabbar$$5$$ = this.element.children("ul");
      0 < $tabbar$$5$$.length && $tabbar$$5$$.children("li").each(function($index$$271$$) {
        $self$$181$$.$_wrapLi$($$$$45$$(this), $contentIds$$[$index$$271$$]);
      });
    }, $_createTabbarFromOldMarkup$:function() {
      var $tabbar$$6$$ = this.element.children("ul");
      if (0 == $tabbar$$6$$.length) {
        var $self$$182$$ = this, $contentIds$$1$$ = this.$_getContentIds$(), $tabbar$$6$$ = $$$$45$$("\x3cul\x3e");
        this.element.children().each(function($index$$272$$) {
          $self$$182$$.$_wrapLi$($$$$45$$(this).find("\x3e :first-child"), $contentIds$$1$$[$index$$272$$]).appendTo($tabbar$$6$$);
        });
        $tabbar$$6$$.prependTo(this.element);
      }
    }, $_addFacets$:function() {
      var $navRoot$$3$$ = this.element.children(".oj-tabs-nav-root"), $self$$183$$ = this, $tabbarWrapper$$ = $navRoot$$3$$.children(".oj-tabs-conveyorbelt-wrapper");
      $navRoot$$3$$.index();
      this.element.children(".oj-tabs-facet").each(function() {
        var $facet$$1$$ = $$$$45$$(this), $facetId$$ = $self$$183$$.$_getUniqueId$($facet$$1$$);
