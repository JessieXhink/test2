...
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore"], function($oj$$19$$, $$$$18$$) {
  $oj$$19$$.$DataSourceContentHandler$ = function $$oj$$19$$$$DataSourceContentHandler$$($widget$$5$$, $root$$3$$, $data$$133$$) {
    this.$m_root$ = $root$$3$$;
    this.$m_widget$ = $widget$$5$$;
    this.$m_fetching$ = !1;
    this.$setDataSource$($data$$133$$);
  };
  ...
  $oj$$19$$.$DataSourceContentHandler$.prototype.$GetKey$ = function $$oj$$19$$$$DataSourceContentHandler$$$$GetKey$$($element$$97$$) {
    return $element$$97$$.key;
  };
  $oj$$19$$.$DataSourceContentHandler$.prototype.$FindElementByKey$ = function $$oj$$19$$$$DataSourceContentHandler$$$$FindElementByKey$$($key$$93$$) {
    var $children$$5$$, $i$$291$$, $elem$$20$$;
    $children$$5$$ = $$$$18$$(this.$m_root$).find("." + this.$m_widget$.$getItemElementStyleClass$());
    for ($i$$291$$ = 0;$i$$291$$ < $children$$5$$.length;$i$$291$$++) {
      if ($elem$$20$$ = $children$$5$$[$i$$291$$], $key$$93$$ == this.$GetKey$($elem$$20$$)) {
        return $elem$$20$$;
      }
    }
    return null;
  ...
  $oj$$19$$.$DataSourceContentHandler$.prototype.$addItem$ = function $$oj$$19$$$$DataSourceContentHandler$$$$addItem$$($parentElement$$5$$, $context$$59_index$$156$$, $content$$15_data$$134$$, $metadata$$4_renderer_textWrapper$$, $callback$$99$$) {
    var $item$$9$$;
    ...
    $context$$59_index$$156$$ = this.$createContext$($context$$59_index$$156$$, $content$$15_data$$134$$, $metadata$$4_renderer_textWrapper$$, $item$$9$$);
    $metadata$$4_renderer_textWrapper$$ = this.$m_widget$.$_getItemRenderer$();
    null != $metadata$$4_renderer_textWrapper$$ ? ($content$$15_data$$134$$ = $metadata$$4_renderer_textWrapper$$.call(this, $context$$59_index$$156$$), null != $content$$15_data$$134$$ && (null === $content$$15_data$$134$$.parentNode || $content$$15_data$$134$$.parentNode instanceof DocumentFragment ? $item$$9$$.appendChild($content$$15_data$$134$$) : null == $content$$15_data$$134$$.parentNode && $content$$15_data$$134$$.toString && ($metadata$$4_renderer_textWrapper$$ = document.createElement("span"), 
    $metadata$$4_renderer_textWrapper$$.appendChild(document.createTextNode($content$$15_data$$134$$.toString())), $item$$9$$.appendChild($metadata$$4_renderer_textWrapper$$)))) : ($metadata$$4_renderer_textWrapper$$ = document.createElement("span"), $metadata$$4_renderer_textWrapper$$.appendChild(document.createTextNode(null == $content$$15_data$$134$$ ? "" : $content$$15_data$$134$$.toString())), $item$$9$$.appendChild($metadata$$4_renderer_textWrapper$$));
  ...
  $oj$$19$$.$DataSourceContentHandler$.prototype.$createContext$ = function $$oj$$19$$$$DataSourceContentHandler$$$$createContext$$($index$$157$$, $data$$135$$, $metadata$$5$$, $elem$$21$$) {
    var $context$$61$$, $prop$$64$$;
    $context$$61$$ = {};
    $context$$61$$.parentElement = $elem$$21$$;
    $context$$61$$.index = $index$$157$$;
    $context$$61$$.data = $data$$135$$;
  ...
  $oj$$19$$.$TableDataSourceContentHandler$ = function $$oj$$19$$$$TableDataSourceContentHandler$$($widget$$6$$, $root$$4$$, $data$$136$$) {
    $oj$$19$$.$TableDataSourceContentHandler$.$superclass$.constructor.call(this, $widget$$6$$, $root$$4$$, $data$$136$$);
  };
  ...
  $oj$$19$$.$TableDataSourceContentHandler$.prototype.$setDataSource$ = function $$oj$$19$$$$TableDataSourceContentHandler$$$$setDataSource$$($dataSource$$9$$) {
    ...
    if (null != $dataSource$$9$$) {
      $dataSource$$9$$ instanceof $oj$$19$$.$PagingTableDataSource$ || (this.$m_initFetch$ = !0, this.$_isLoadMoreOnScroll$() && ($self$$111$$ = this, this.$m_domScrollerMaxCountFunc$ = function $this$$m_domScrollerMaxCountFunc$$($result$$56$$) {
        null != $result$$56$$ && ($result$$56$$.maxCountLimit ? $self$$111$$.$_handleScrollerMaxRowCount$() : $self$$111$$.$_handleFetchedData$($result$$56$$));
  ...
  $oj$$19$$.$TableDataSourceContentHandler$.prototype.$fetchRows$ = function $$oj$$19$$$$TableDataSourceContentHandler$$$$fetchRows$$($forceFetch$$1_options$$297_promise$$2$$) {
    ...
    if (this.$IsReady$() && (this.$m_fetching$ = !0, this.$m_initFetch$ || $forceFetch$$1_options$$297_promise$$2$$)) {
      ...
      $forceFetch$$1_options$$297_promise$$2$$.then(function($value$$221$$) {
        $self$$112$$.$m_initFetch$ && $self$$112$$.$_handleFetchedData$($value$$221$$);
      }, function($reason$$4$$) {
        $self$$112$$.$_handleFetchError$($reason$$4$$);
      });
      return;
    }
  ...
  $oj$$19$$.$TableDataSourceContentHandler$.prototype.$_handleFetchSuccess$ = function $$oj$$19$$$$TableDataSourceContentHandler$$$$_handleFetchSuccess$$($data$$137$$, $keys$$31$$) {
    var $index$$158$$, $i$$292$$, $row$$47$$;
    $index$$158$$ = this.$m_root$.childElementCount;
    for ($i$$292$$ = 0;$i$$292$$ < $data$$137$$.length;$i$$292$$++) {
      $row$$47$$ = $data$$137$$[$i$$292$$], this.$addItem$(this.$m_root$, $index$$158$$, $row$$47$$, this.getMetadata($index$$158$$, $keys$$31$$[$i$$292$$], $row$$47$$)), $index$$158$$ += 1;
    }
  };
  $oj$$19$$.$TableDataSourceContentHandler$.prototype.$handleModelAddEvent$ = function $$oj$$19$$$$TableDataSourceContentHandler$$$$handleModelAddEvent$$($event$$215_keys$$32$$) {
    var $data$$138$$, $index$$159$$, $i$$293$$;
    if (null != this.$m_root$ && ($data$$138$$ = $event$$215_keys$$32$$.data, $event$$215_keys$$32$$ = $event$$215_keys$$32$$.keys, null != $data$$138$$ && null != $event$$215_keys$$32$$ && 0 < $event$$215_keys$$32$$.length && 0 < $data$$138$$.length && $event$$215_keys$$32$$.length == $data$$138$$.length)) {
      $index$$159$$ = this.$m_root$.childElementCount;
      for ($i$$293$$ = 0;$i$$293$$ < $data$$138$$.length;$i$$293$$++) {
        this.$addItem$(this.$m_root$, $index$$159$$, $data$$138$$[$i$$293$$], this.getMetadata($index$$159$$, $event$$215_keys$$32$$[$i$$293$$], $data$$138$$[$i$$293$$]), this.$afterRenderItemForInsertEvent$.bind(this)), $index$$159$$++;
      }
      this.$fetchEnd$();
    }
  };
  $oj$$19$$.$TableDataSourceContentHandler$.prototype.$_handleAddTransitionEnd$ = function $$oj$$19$$$$TableDataSourceContentHandler$$$$_handleAddTransitionEnd$$($event$$216$$) {
    $$$$18$$($event$$216$$.target).removeClass("oj-listview-item-add-remove-transition").addClass(this.$m_widget$.$getItemStyleClass$()).off("transitionend", this.$m_addTransitionEndListener$).children().children().unwrap();
  };
  $oj$$19$$.$TableDataSourceContentHandler$.prototype.$handleModelRemoveEvent$ = function $$oj$$19$$$$TableDataSourceContentHandler$$$$handleModelRemoveEvent$$($event$$217_keys$$33$$) {
    var $i$$294$$, $elem$$24$$;
    $event$$217_keys$$33$$ = $event$$217_keys$$33$$.keys;
    if (null != this.$m_root$ && null != $event$$217_keys$$33$$ && 0 != $event$$217_keys$$33$$.length) {
      for ($i$$294$$ = 0;$i$$294$$ < $event$$217_keys$$33$$.length;$i$$294$$++) {
        $elem$$24$$ = this.$FindElementByKey$($event$$217_keys$$33$$[$i$$294$$]), null != $elem$$24$$ && this.$_removeItem$($elem$$24$$);
      }
    }
  };
  ...
  $oj$$19$$.$TableDataSourceContentHandler$.prototype.$_handleRemoveTransitionEnd$ = function $$oj$$19$$$$TableDataSourceContentHandler$$$$_handleRemoveTransitionEnd$$($elem$$26_event$$218$$) {
    var $parent$$21$$;
    $elem$$26_event$$218$$ = $$$$18$$($elem$$26_event$$218$$.target);
    $parent$$21$$ = $elem$$26_event$$218$$.parent();
    $elem$$26_event$$218$$.off("transitionend", this.$m_removeTransitionEndListener$);
    $elem$$26_event$$218$$.remove();
  ...
  $oj$$19$$.$TableDataSourceContentHandler$.prototype.$_handleFetchedData$ = function $$oj$$19$$$$TableDataSourceContentHandler$$$$_handleFetchedData$$($dataObj_keys$$34$$) {
    var $data$$139$$;
    null != this.$m_root$ && ($data$$139$$ = $dataObj_keys$$34$$.data, $dataObj_keys$$34$$ = $dataObj_keys$$34$$.keys, Array.isArray($data$$139$$) && Array.isArray($dataObj_keys$$34$$) && $data$$139$$.length == $dataObj_keys$$34$$.length && (this.$_handleFetchSuccess$($data$$139$$, $dataObj_keys$$34$$), this.$fetchEnd$()));
  };
  $oj$$19$$.$TableDataSourceContentHandler$.prototype.$handleModelSyncEvent$ = function $$oj$$19$$$$TableDataSourceContentHandler$$$$handleModelSyncEvent$$($event$$220$$) {
    null != this.$m_root$ && ($$$$18$$(this.$m_root$).empty(), this.$m_widget$.$ClearCache$(), this.$_handleFetchedData$($event$$220$$));
  };
  ...
  $oj$$19$$.$TableDataSourceContentHandler$.prototype.getMetadata = function $$oj$$19$$$$TableDataSourceContentHandler$$$getMetadata$($index$$161$$, $key$$94$$, $context$$66_data$$140$$) {
    $context$$66_data$$140$$ = $context$$66_data$$140$$.context;
    null == $context$$66_data$$140$$ && ($context$$66_data$$140$$ = {});
    null == $context$$66_data$$140$$.index && ($context$$66_data$$140$$.index = $index$$161$$);
    null == $context$$66_data$$140$$.key && ($context$$66_data$$140$$.key = $key$$94$$);
    return $context$$66_data$$140$$;
  };
  $oj$$19$$.$TreeDataSourceContentHandler$ = function $$oj$$19$$$$TreeDataSourceContentHandler$$($widget$$7$$, $root$$5$$, $data$$141$$) {
    $oj$$19$$.$TreeDataSourceContentHandler$.$superclass$.constructor.call(this, $widget$$7$$, $root$$5$$, $data$$141$$);
  };
  ...
  $oj$$19$$.$TreeDataSourceContentHandler$.prototype.$_handleFetchSuccess$ = function $$oj$$19$$$$TreeDataSourceContentHandler$$$$_handleFetchSuccess$$($nodeSet$$14$$, $parent$$23_start$$41$$, $parentElem$$1$$, $successCallback$$26$$) {
    var $count$$35$$, $i$$295$$, $data$$142$$, $metadata$$6$$;
    $parent$$23_start$$41$$ = $nodeSet$$14$$.$getStart$();
    $count$$35$$ = $nodeSet$$14$$.$getCount$();
    for ($i$$295$$ = 0;$i$$295$$ < $count$$35$$;$i$$295$$++) {
      $data$$142$$ = $nodeSet$$14$$.getData($parent$$23_start$$41$$ + $i$$295$$), $metadata$$6$$ = $nodeSet$$14$$.getMetadata($parent$$23_start$$41$$ + $i$$295$$), this.$addItem$($parentElem$$1$$, $parent$$23_start$$41$$ + $i$$295$$, $data$$142$$, $metadata$$6$$);
    }
    this.$m_fetching$ = !1;
  ...
  $oj$$19$$.$StaticContentHandler$.prototype.$restoreContent$ = function $$oj$$19$$$$StaticContentHandler$$$$restoreContent$$($elem$$28$$, $depth$$9$$) {
    var $groupStyleClass$$1$$, $groupCollapseStyleClass$$1$$, $groupExpandStyleClass$$, $itemStyleClass$$4$$, $itemElementStyleClass$$, $items$$, $i$$296$$, $groupItem$$2_item$$19$$, $groupItems$$;
  ...
  $oj$$19$$.$StaticContentHandler$.prototype.$modifyContent$ = function $$oj$$19$$$$StaticContentHandler$$$$modifyContent$$($elem$$29$$, $depth$$10$$) {
    var $itemStyleClass$$5$$, $itemElementStyleClass$$1$$, $groupStyleClass$$2$$, $groupItemStyleClass$$1$$, $groupCollapseStyleClass$$2$$, $collapseClass$$1$$, $items$$1$$, $expandable$$, $i$$297$$, $item$$20$$, $context$$68$$, $groupItem$$3_groupItems$$1$$, $content$$19$$, $icon$$1$$;
  ...
  $oj$$19$$.$StaticContentHandler$.prototype.$GetKey$ = function $$oj$$19$$$$StaticContentHandler$$$$GetKey$$($element$$98$$) {
    return $$$$18$$($element$$98$$).attr("id");
  };
  ...
  $oj$$19$$.$_ojListView$ = function($SuperClass$$1$$, $methods$$2$$) {
    ...
    this.$ojContext$._on(this.element, {click:function($event$$222$$) {
      $self$$114$$.$HandleMouseClick$($event$$222$$);
      $self$$114$$.$m_preActive$ = !1;
    }, mousedown:function() {
      $self$$114$$.$m_preActive$ = !0;
    }, mouseout:function($event$$224$$) {
      $self$$114$$.$_handleMouseOut$($event$$224$$);
    }, mouseover:function($event$$225$$) {
      $self$$114$$.$_handleMouseOver$($event$$225$$);
    }, keydown:function($event$$226$$) {
      $self$$114$$.$HandleKeyDown$($event$$226$$);
    }, focus:function($event$$227$$) {
      $self$$114$$.$HandleFocus$($event$$227$$);
    }, blur:function($event$$228$$) {
      $self$$114$$.$HandleBlur$($event$$228$$);
    }});
  ...
  }, getNodeBySubId:function($anchor$$1_item$$25_key$$96_locator$$20$$) {
    return null == $anchor$$1_item$$25_key$$96_locator$$20$$ ? this.element ? this.element[0] : null : "oj-listview-icon" === $anchor$$1_item$$25_key$$96_locator$$20$$.subId && ($anchor$$1_item$$25_key$$96_locator$$20$$ = $anchor$$1_item$$25_key$$96_locator$$20$$.key, $anchor$$1_item$$25_key$$96_locator$$20$$ = this.$FindElementByKey$($anchor$$1_item$$25_key$$96_locator$$20$$), null != $anchor$$1_item$$25_key$$96_locator$$20$$ && $anchor$$1_item$$25_key$$96_locator$$20$$.firstElementChild && ($anchor$$1_item$$25_key$$96_locator$$20$$ = 
    $anchor$$1_item$$25_key$$96_locator$$20$$.firstElementChild.firstElementChild, null != $anchor$$1_item$$25_key$$96_locator$$20$$ && ($$$$18$$($anchor$$1_item$$25_key$$96_locator$$20$$).hasClass(this.$getExpandIconStyleClass$()) || $$$$18$$($anchor$$1_item$$25_key$$96_locator$$20$$).hasClass(this.$getCollapseIconStyleClass$())))) ? $anchor$$1_item$$25_key$$96_locator$$20$$ : null;
    ...
    return null;
  }, $_unregisterResizeListener$:function($element$$99$$) {
    $element$$99$$ && this.$_resizeHandler$ && $oj$$19$$.$DomUtils$.$removeResizeListener$($element$$99$$, this.$_resizeHandler$);
  }, $_registerResizeListener$:function($element$$100$$) {
    $element$$100$$ && (null == this.$_resizeHandler$ && (this.$_resizeHandler$ = this.$_handleResize$.bind(this)), $oj$$19$$.$DomUtils$.$addResizeListener$($element$$100$$, this.$_resizeHandler$));
    ...
    var $self$$115$$, $selection$$6$$, $i$$298$$;
    ...
    if (null != $elem$$30_expanded$$1_options$$299$$.currentItem) {
      ...
      if (null != $elem$$30_expanded$$1_options$$299$$.expanded) {
        this.$m_contentHandler$.$IsHierarchical$() && ($elem$$30_expanded$$1_options$$299$$ = $elem$$30_expanded$$1_options$$299$$.expanded, Array.isArray($elem$$30_expanded$$1_options$$299$$) && (this.$_collapseAll$(), $self$$115$$ = this, $$$$18$$.each($elem$$30_expanded$$1_options$$299$$, function($index$$162$$, $value$$222$$) {
          $self$$115$$.$expandKey$($value$$222$$, !1, !1);
        })));
      } else {
        if (null != $elem$$30_expanded$$1_options$$299$$.selection) {
          if (this.$_isSelectionEnabled$()) {
            for ($elem$$30_expanded$$1_options$$299$$.selection = this.$_filterSelection$($elem$$30_expanded$$1_options$$299$$.selection), $selection$$6$$ = $elem$$30_expanded$$1_options$$299$$.selection, this.$_clearSelection$(!1), $i$$298$$ = 0;$i$$298$$ < $selection$$6$$.length;$i$$298$$++) {
              $elem$$30_expanded$$1_options$$299$$ = this.$FindElementByKey$($selection$$6$$[$i$$298$$]), null != $elem$$30_expanded$$1_options$$299$$ && this.$_applySelection$($elem$$30_expanded$$1_options$$299$$, $selection$$6$$[$i$$298$$]);
            }
          }
        } else {
    ...
    return!1;
  }, $Trigger$:function($type$$82$$, $event$$230$$, $ui$$5$$) {
    return this.$ojContext$._trigger($type$$82$$, $event$$230$$, $ui$$5$$);
  }, $SetOption$:function($key$$98$$, $value$$223$$, $flags$$23$$) {
    this.$ojContext$.option($key$$98$$, $value$$223$$, $flags$$23$$);
  }, $GetOption$:function($key$$99$$) {
    return this.$ojContext$.option($key$$99$$);
  }, $_initContentHandler$:function() {
    var $data$$143$$;
    $data$$143$$ = this.$GetOption$("data");
    if (null != $data$$143$$) {
      if ($data$$143$$ instanceof $oj$$19$$.$TableDataSource$) {
        this.$m_contentHandler$ = new $oj$$19$$.$TableDataSourceContentHandler$(this, this.element[0], $data$$143$$);
      } else {
        if ($data$$143$$ instanceof $oj$$19$$.$TreeDataSource$) {
          this.$m_contentHandler$ = new $oj$$19$$.$TreeDataSourceContentHandler$(this, this.element[0], $data$$143$$);
        } else {
          throw "Invalid data";
        }
      }
  ...
  }, $_getItemOption$:function($name$$105_value$$224$$, $context$$73$$, $resolve$$47$$) {
    $name$$105_value$$224$$ = this.options.item[$name$$105_value$$224$$];
    return "function" == typeof $name$$105_value$$224$$ && $resolve$$47$$ ? $name$$105_value$$224$$.call(this, $context$$73$$) : $name$$105_value$$224$$;
    ...
    var $clone$$2_expanded$$3_selection$$7$$, $i$$299_index$$163$$, $self$$117$$;
    ...
    if (this.$_isSelectionEnabled$()) {
      if ($clone$$2_expanded$$3_selection$$7$$ = this.$GetOption$("selection"), this.$IsSelectable$($elem$$32$$)) {
        for ($i$$299_index$$163$$ = 0;$i$$299_index$$163$$ < $clone$$2_expanded$$3_selection$$7$$.length;$i$$299_index$$163$$++) {
          if ($clone$$2_expanded$$3_selection$$7$$[$i$$299_index$$163$$] == $context$$74$$.key && (this.$_applySelection$($elem$$32$$, $clone$$2_expanded$$3_selection$$7$$[$i$$299_index$$163$$]), !this.$_isMultipleSelection$())) {
        ...
        $i$$299_index$$163$$ = $clone$$2_expanded$$3_selection$$7$$.indexOf($context$$74$$.key), -1 < $i$$299_index$$163$$ && ($clone$$2_expanded$$3_selection$$7$$ = $clone$$2_expanded$$3_selection$$7$$.slice(0), $clone$$2_expanded$$3_selection$$7$$.splice($i$$299_index$$163$$, 1), this.$SetOption$("selection", $clone$$2_expanded$$3_selection$$7$$, {_context:{originalEvent:null, $internalSet$:!0}, changed:!0}));
      }
    }
    this.$m_contentHandler$.$IsHierarchical$() && this.$GetState$($$$$18$$($elem$$32$$)) == this.$STATE_COLLAPSED$ && ($clone$$2_expanded$$3_selection$$7$$ = this.$GetOption$("expanded"), this.$_isExpandAll$() ? this.$ExpandItem$($$$$18$$($elem$$32$$), null, !1, null, !1, !1, !1) : Array.isArray($clone$$2_expanded$$3_selection$$7$$) && ($self$$117$$ = this, $$$$18$$.each($clone$$2_expanded$$3_selection$$7$$, function($index$$164$$, $value$$225$$) {
      $value$$225$$ == $context$$74$$.key && $self$$117$$.$ExpandItem$($$$$18$$($elem$$32$$), null, !1, null, !1, !1, !1);
    })));
  ...
  }, $notifyContextMenuGesture$:function($menu$$6_openOptions$$4_parent$$24$$, $event$$231$$, $eventType$$39$$) {
    if (this.$IsNodeEditableOrClickable$($$$$18$$($event$$231$$.target))) {
      return!1;
    }
    $menu$$6_openOptions$$4_parent$$24$$ = $$$$18$$($event$$231$$.target).closest("." + this.$getItemElementStyleClass$());
    ...
    this.$ojContext$.$_OpenContextMenu$($event$$231$$, $eventType$$39$$, $menu$$6_openOptions$$4_parent$$24$$);
    ...
    return!1;
  }, $_disableAllTabbableElements$:function($element$$101$$) {
    var $tabIndex$$2$$;
    $$$$18$$($element$$101$$).find("a, input, select, textarea, button, object, .oj-component-initnode").each(function() {
  ...
  }, $HandleFocus$:function($event$$232$$) {
    this.$_getListContainer$().addClass("oj-focus-ancestor");
    null == this.$m_active$ ? this.$_isTouchSupport$() || this.$m_preActive$ || this.$_initFocus$($event$$232$$) : $$$$18$$(this.$m_active$.elem).addClass("oj-focus");
  }, $_initFocus$:function($event$$233$$) {
    var $items$$2$$, $i$$300$$, $item$$31$$;
    $items$$2$$ = this.$_getItemsCache$();
    for ($i$$300$$ = 0;$i$$300$$ < $items$$2$$.length;$i$$300$$++) {
      if ($item$$31$$ = $$$$18$$($items$$2$$[$i$$300$$]), !this.$SkipFocus$($item$$31$$)) {
        this.$_activeAndFocus$($item$$31$$, $event$$233$$);
        break;
      }
    }
  }, $HandleBlur$:function() {
    this.$_getListContainer$().removeClass("oj-focus-ancestor");
    null != this.$m_active$ && $$$$18$$(this.$m_active$.elem).removeClass("oj-focus");
  }, $_handleMouseOut$:function($event$$235_item$$32$$) {
    $event$$235_item$$32$$ = this.$FindItem$($event$$235_item$$32$$.target);
    null != $event$$235_item$$32$$ && (this.$m_hoverItem$ = null, this.$_unhighlightElem$($event$$235_item$$32$$, "oj-hover"));
  }, $_handleMouseOver$:function($event$$236_item$$33$$) {
    $event$$236_item$$33$$ = this.$FindItem$($event$$236_item$$33$$.target);
    null == $event$$236_item$$33$$ || this.$SkipFocus$($event$$236_item$$33$$) || (this.$m_hoverItem$ = $event$$236_item$$33$$, this.$_highlightElem$($event$$236_item$$33$$, "oj-hover"));
  }, $HandleKeyDown$:function($event$$237$$) {
    var $keyCode$$4$$, $current$$6$$;
    if (this.$isExpandable$() && ($keyCode$$4$$ = $event$$237$$.keyCode, $keyCode$$4$$ === this.$LEFT_KEY$ || $keyCode$$4$$ === this.$RIGHT_KEY$)) {
      if ($current$$6$$ = this.$m_active$.elem, $keyCode$$4$$ === this.$LEFT_KEY$) {
        if (this.$GetState$($current$$6$$) == this.$STATE_EXPANDED$) {
          this.$CollapseItem$($current$$6$$, $event$$237$$, !0, this.$m_active$.key, !0, !0);
          return;
        }
      } else {
        if (this.$GetState$($current$$6$$) == this.$STATE_COLLAPSED$) {
          this.$ExpandItem$($current$$6$$, $event$$237$$, !0, this.$m_active$.key, !0, !0, !0);
          return;
        }
      }
    }
    !0 === this.$HandleSelectionOrActiveKeyDown$($event$$237$$) && $event$$237$$.preventDefault();
  }, $HandleMouseClick$:function($event$$238$$) {
    var $collapseIconClass_item$$34$$, $expandIconClass$$, $groupItemClass$$, $target$$81$$;
    0 === $event$$238$$.button && ($collapseIconClass_item$$34$$ = this.$getCollapseIconStyleClass$(), $expandIconClass$$ = this.$getExpandIconStyleClass$(), $groupItemClass$$ = this.$getGroupItemStyleClass$(), $target$$81$$ = $$$$18$$($event$$238$$.target), $target$$81$$.hasClass($expandIconClass$$) ? (this.$_collapse$($event$$238$$), $event$$238$$.preventDefault()) : $target$$81$$.hasClass($collapseIconClass_item$$34$$) ? (this.$_expand$($event$$238$$), $event$$238$$.preventDefault()) : ($collapseIconClass_item$$34$$ = 
    this.$FindItem$($target$$81$$), null == $collapseIconClass_item$$34$$ || 0 == $collapseIconClass_item$$34$$.length || this.$SkipFocus$($collapseIconClass_item$$34$$) || (this.$_isSelectionEnabled$() && this.$IsSelectable$($collapseIconClass_item$$34$$[0]) ? this.$_isTouchSupport$() ? this.$_handleTouchSelection$($collapseIconClass_item$$34$$, $event$$238$$) : this.$HandleClickSelection$($collapseIconClass_item$$34$$, $event$$238$$) : this.$_handleClickActive$($collapseIconClass_item$$34$$, $event$$238$$), 
    this.$isExpandable$() && $target$$81$$.closest("." + $groupItemClass$$) && (this.$GetState$($collapseIconClass_item$$34$$) == this.$STATE_COLLAPSED$ ? this.$_expand$($event$$238$$) : this.$GetState$($collapseIconClass_item$$34$$) == this.$STATE_EXPANDED$ && this.$_collapse$($event$$238$$)))));
  }, $_isTouchSupport$:function() {
    return $oj$$19$$.$DomUtils$.$isTouchSupported$();
  }, $_ctrlEquivalent$:function($event$$239$$) {
    return $oj$$19$$.$DomUtils$.$isMetaKeyPressed$($event$$239$$);
  }, $_createSubId$:function($subId$$22$$) {
    return[this.element.attr("id"), $subId$$22$$].join(":");
    ...
    return this.$m_items$;
  }, $HandleArrowKeys$:function($keyCode$$6_next$$3$$, $isExtend$$, $event$$240$$) {
    ...
    switch($keyCode$$6_next$$3$$) {
      case this.$UP_KEY$:
        ...
        if (0 <= $current$$7_currentIndex$$1$$) {
          ...
          $isExtend$$ ? (this.$_extendSelection$($keyCode$$6_next$$3$$, $event$$240$$), this.$m_isNavigate$ = !1) : (this.$_activeAndFocus$($keyCode$$6_next$$3$$, $event$$240$$), this.$m_isNavigate$ = !0);
        }
        $processed$$1$$ = !0;
        break;
      case this.$DOWN_KEY$:
  ...
  }, $_setActive$:function($item$$35$$, $event$$241$$) {
  ...
  }, $_handleClickActive$:function($item$$36$$, $event$$242$$) {
    this.$_activeAndFocus$($item$$36$$, $event$$242$$);
  }, $_activeAndFocus$:function($item$$37$$, $event$$243$$) {
    this.$_scrollToVisible$($item$$37$$[0]);
    this.$UnhighlightActive$();
    this.$_setActive$($item$$37$$, $event$$243$$);
    ...
    var $filtered$$2$$, $i$$301$$, $elem$$40$$;
    $filtered$$2$$ = [];
    for ($i$$301$$ = 0;$i$$301$$ < $selection$$8$$.length && ($elem$$40$$ = this.$FindElementByKey$($selection$$8$$[$i$$301$$]), null == $elem$$40$$ || !this.$IsSelectable$($elem$$40$$) || ($filtered$$2$$.push($selection$$8$$[$i$$301$$]), this.$_isMultipleSelection$()));$i$$301$$++) {
    }
    return $filtered$$2$$;
  }, $_unhighlightSelection$:function() {
    var $self$$118$$, $elem$$41$$;
    null != this.$m_keyElemMap$ && ($self$$118$$ = this, $$$$18$$.each(this.$GetOption$("selection"), function($index$$168$$, $value$$226$$) {
      $elem$$41$$ = $self$$118$$.$FindElementByKey$($value$$226$$);
      null != $elem$$41$$ && $self$$118$$.$_unhighlightElem$($elem$$41$$, "oj-selected");
    }));
  ...
  }, $HandleClickSelection$:function($item$$39$$, $event$$244$$) {
    var $ctrlKey$$2$$, $shiftKey$$2$$;
    this.$_scrollToVisible$($item$$39$$[0]);
    $ctrlKey$$2$$ = this.$_ctrlEquivalent$($event$$244$$);
    $shiftKey$$2$$ = $event$$244$$.shiftKey;
    this.$_isMultipleSelection$() ? $ctrlKey$$2$$ || $shiftKey$$2$$ ? !$ctrlKey$$2$$ && $shiftKey$$2$$ ? this.$_extendSelection$($item$$39$$, $event$$244$$) : this.$_augmentSelectionAndFocus$($item$$39$$, $event$$244$$) : this.$SelectAndFocus$($item$$39$$, $event$$244$$) : this.$SelectAndFocus$($item$$39$$, $event$$244$$);
  }, $_handleTouchSelection$:function($item$$40$$, $event$$245$$) {
    this.$_isMultipleSelection$() ? this.$_augmentSelectionAndFocus$($item$$40$$, $event$$245$$) : this.$SelectAndFocus$($item$$40$$, $event$$245$$);
  ...
  }, $SelectAndFocus$:function($item$$41$$, $event$$246$$) {
    this.$_clearSelection$(!1);
    this.$_augmentSelectionAndFocus$($item$$41$$, $event$$246$$, []);
  }, $_extendSelection$:function($item$$42$$, $event$$247$$) {
    var $current$$8$$;
    null != this.$m_active$ && ($current$$8$$ = this.$m_selectionFrontier$, $current$$8$$ != $item$$42$$ && this.$_extendSelectionRange$(this.$m_active$.elem, $item$$42$$, $event$$247$$));
  }, $_extendSelectionRange$:function($from$$1$$, $to$$1$$, $event$$248$$) {
    this.$_clearSelection$(!1);
    this.$m_selectionFrontier$ = $to$$1$$;
    this.$_highlightRange$($from$$1$$, $to$$1$$, $event$$248$$);
    this.$HighlightActive$();
  }, $_highlightRange$:function($start$$42_startIndex$$30_to$$2$$, $end$$15_from$$2_i$$302$$, $event$$249$$) {
    ...
    $endIndex$$10_item$$43$$ = $items$$4$$.index($end$$15_from$$2_i$$302$$);
    $start$$42_startIndex$$30_to$$2$$ > $endIndex$$10_item$$43$$ ? $end$$15_from$$2_i$$302$$ = $endIndex$$10_item$$43$$ : ($end$$15_from$$2_i$$302$$ = $start$$42_startIndex$$30_to$$2$$, $start$$42_startIndex$$30_to$$2$$ = $endIndex$$10_item$$43$$);
    for (;$end$$15_from$$2_i$$302$$ <= $start$$42_startIndex$$30_to$$2$$;$end$$15_from$$2_i$$302$$++) {
      $endIndex$$10_item$$43$$ = $items$$4$$[$end$$15_from$$2_i$$302$$], this.$IsSelectable$($endIndex$$10_item$$43$$) && ($key$$102$$ = this.$m_contentHandler$.$GetKey$($endIndex$$10_item$$43$$), this.$_applySelection$($endIndex$$10_item$$43$$, $key$$102$$), $selection$$9$$.push($key$$102$$));
    }
    this.$SetOption$("selection", $selection$$9$$, {_context:{originalEvent:$event$$249$$, $internalSet$:!0}, changed:!0});
  }, $_applySelection$:function($element$$102$$, $key$$103$$) {
    null == this.$m_keyElemMap$ && (this.$m_keyElemMap$ = {});
    this.$m_keyElemMap$[$key$$103$$] = $$$$18$$($element$$102$$).attr("id");
    this.$_highlightElem$($element$$102$$, "oj-selected");
  }, $_augmentSelectionAndFocus$:function($item$$44$$, $event$$250$$, $selection$$10$$) {
    ...
    this.$_setActive$($item$$44$$, $event$$250$$);
    this.$HighlightActive$();
    this.$SetOption$("selection", $selection$$10$$, {_context:{originalEvent:$event$$250$$, $internalSet$:!0}, changed:!0});
  }, $ToggleSelection$:function($event$$251$$, $keepCurrentSelection$$, $skipIfNotSelected$$) {
    ...
    this.$SetOption$("selection", $selection$$11$$, {_context:{originalEvent:$event$$251$$, $internalSet$:!0}, changed:!0});
  }, $HandleSelectionOrActiveKeyDown$:function($event$$252$$) {
    var $first$$6_keyCode$$7$$, $ctrlKey$$3_current$$9_last$$, $shiftKey$$3$$, $processed$$2$$ = !1;
    if (null == this.$m_active$) {
      return!1;
    }
    $first$$6_keyCode$$7$$ = $event$$252$$.keyCode;
    $ctrlKey$$3_current$$9_last$$ = this.$m_active$.elem;
    this.$_isActionableMode$() ? $first$$6_keyCode$$7$$ == this.$ESC_KEY$ ? (this.$_setActionableMode$(!1), this.$_disableAllTabbableElements$($ctrlKey$$3_current$$9_last$$), this.$HighlightActive$(), $processed$$2$$ = !0) : $first$$6_keyCode$$7$$ === this.$TAB_KEY$ && ($first$$6_keyCode$$7$$ = $ctrlKey$$3_current$$9_last$$.find("[data-first]"), $ctrlKey$$3_current$$9_last$$ = $ctrlKey$$3_current$$9_last$$.find("[data-last]"), $event$$252$$.shiftKey ? 0 < $first$$6_keyCode$$7$$.length && 0 < $ctrlKey$$3_current$$9_last$$.length && 
    $first$$6_keyCode$$7$$ != $ctrlKey$$3_current$$9_last$$ && $event$$252$$.target == $first$$6_keyCode$$7$$[0] && ($ctrlKey$$3_current$$9_last$$[0].focus(), $processed$$2$$ = !0) : 0 < $first$$6_keyCode$$7$$.length && 0 < $ctrlKey$$3_current$$9_last$$.length && $first$$6_keyCode$$7$$ != $ctrlKey$$3_current$$9_last$$ && $event$$252$$.target == $ctrlKey$$3_current$$9_last$$[0] && ($first$$6_keyCode$$7$$[0].focus(), $processed$$2$$ = !0)) : $first$$6_keyCode$$7$$ == this.$F2_KEY$ ? (this.$_enableAllTabbableElements$($ctrlKey$$3_current$$9_last$$), 
    $first$$6_keyCode$$7$$ = $ctrlKey$$3_current$$9_last$$.find("[data-first]"), 0 < $first$$6_keyCode$$7$$.length && ($first$$6_keyCode$$7$$[0].focus(), this.$_setActionableMode$(!0))) : $first$$6_keyCode$$7$$ == this.$SPACE_KEY$ && this.$_isSelectionEnabled$() ? ($ctrlKey$$3_current$$9_last$$ = this.$_ctrlEquivalent$($event$$252$$), ($shiftKey$$3$$ = $event$$252$$.shiftKey) && !$ctrlKey$$3_current$$9_last$$ && null != this.$m_selectionFrontier$ && this.$_isMultipleSelection$() ? this.$_extendSelectionRange$(this.$m_selectionFrontier$, 
    this.$m_active$.elem, $event$$252$$) : this.$ToggleSelection$($event$$252$$, $ctrlKey$$3_current$$9_last$$ && !$shiftKey$$3$$ && this.$_isMultipleSelection$(), !1), $processed$$2$$ = !0) : $first$$6_keyCode$$7$$ == this.$ENTER_KEY$ && this.$_isSelectionEnabled$() ? this.$ToggleSelection$($event$$252$$, !1, !0) : this.$IsArrowKey$($first$$6_keyCode$$7$$) && ($ctrlKey$$3_current$$9_last$$ = this.$_ctrlEquivalent$($event$$252$$), $shiftKey$$3$$ = $event$$252$$.shiftKey, $ctrlKey$$3_current$$9_last$$ || 
    ($processed$$2$$ = this.$HandleArrowKeys$($first$$6_keyCode$$7$$, $shiftKey$$3$$ && this.$_isSelectionEnabled$() && this.$_isMultipleSelection$(), $event$$252$$)));
    return $processed$$2$$;
  ...
  }, $_expand$:function($event$$253$$) {
    var $item$$47$$ = this.$FindItem$($event$$253$$.target);
    null != $item$$47$$ && 0 < $item$$47$$.length && this.$ExpandItem$($item$$47$$, $event$$253$$, !0, null, !0, !0, !0);
  }, $ExpandItem$:function($item$$48$$, $event$$254$$, $animate$$, $cancelled$$1_key$$107$$, $beforeVetoable$$, $fireEvent$$1$$, $fireBeforeEvent$$) {
    var $ui$$9$$;
    if (this.$GetState$($item$$48$$) == this.$STATE_COLLAPSED$) {
      ...
      if ($fireBeforeEvent$$ && ($cancelled$$1_key$$107$$ = !this.$Trigger$("beforeExpand", $event$$254$$, $ui$$9$$)) && $beforeVetoable$$) {
        return;
      }
      this.$m_contentHandler$.$Expand$($item$$48$$, function($groupItem$$4$$) {
        this.$_expandSuccess$($groupItem$$4$$, $animate$$, $event$$254$$, $ui$$9$$, $fireEvent$$1$$);
      }.bind(this));
      this.$m_items$ = null;
      null != $event$$254$$ && $event$$254$$.stopPropagation();
    }
  }, $_expandSuccess$:function($groupItem$$5_item$$49$$, $animate$$1_collapseClass$$2$$, $event$$255$$, $ui$$10$$, $fireEvent$$2$$) {
    var $expandClass$$;
    ...
    $fireEvent$$2$$ && this.$Trigger$("expand", $event$$255$$, $ui$$10$$);
  ...
  }, $_handleExpandTransitionEnd$:function($event$$256_groupItem$$8$$) {
    $event$$256_groupItem$$8$$ = $$$$18$$($event$$256_groupItem$$8$$.target);
    $event$$256_groupItem$$8$$.off("transitionend", this.$m_expandTransitionEndListener$);
    this.$_isTouchSupport$() || $event$$256_groupItem$$8$$.css("maxHeight", "");
    this.$AnimateExpandComplete$($event$$256_groupItem$$8$$);
  ...
  }, $_collapse$:function($event$$257$$) {
    var $item$$52$$ = this.$FindItem$($event$$257$$.target);
    null != $item$$52$$ && 0 < $item$$52$$.length && this.$CollapseItem$($item$$52$$, $event$$257$$, !0, null, !0, !0);
  }, $CollapseItem$:function($item$$53$$, $event$$258$$, $animate$$3_collapseClass$$3$$, $key$$110_ui$$11$$, $beforeVetoable$$1_expandClass$$1$$, $fireEvent$$3$$) {
    var $cancelled$$2$$;
    this.$GetState$($item$$53$$) == this.$STATE_EXPANDED$ && (null == $key$$110_ui$$11$$ && ($key$$110_ui$$11$$ = this.$GetKey$($item$$53$$[0])), $key$$110_ui$$11$$ = {item:$item$$53$$, key:$key$$110_ui$$11$$}, $cancelled$$2$$ = !this.$Trigger$("beforeCollapse", $event$$258$$, $key$$110_ui$$11$$), $cancelled$$2$$ && $beforeVetoable$$1_expandClass$$1$$ || (this.$AnimateCollapse$($item$$53$$, $animate$$3_collapseClass$$3$$), this.$SetState$($item$$53$$, this.$STATE_COLLAPSED$), $animate$$3_collapseClass$$3$$ = 
    this.$getCollapseIconStyleClass$(), $beforeVetoable$$1_expandClass$$1$$ = this.$getExpandIconStyleClass$(), $item$$53$$.find("." + $beforeVetoable$$1_expandClass$$1$$).first().removeClass($beforeVetoable$$1_expandClass$$1$$).addClass($animate$$3_collapseClass$$3$$), this.$m_items$ = null, null != $event$$258$$ && $event$$258$$.stopPropagation(), $fireEvent$$3$$ && this.$Trigger$("collapse", $event$$258$$, $key$$110_ui$$11$$)));
  ...
  }, $_handleCollapseTransitionEnd$:function($event$$259_groupItem$$11$$) {
    $event$$259_groupItem$$11$$ = $$$$18$$($event$$259_groupItem$$11$$.target);
    $event$$259_groupItem$$11$$.off("transitionend", this.$m_collapseTransitionEndListener$);
    this.$AnimateCollapseComplete$($event$$259_groupItem$$11$$);
    ...
    var $expanded$$7$$, $self$$120$$, $item$$56$$;
    $expanded$$7$$ = [];
    $self$$120$$ = this;
    this.$_getItemsCache$().each(function() {
      $item$$56$$ = $$$$18$$(this);
      $self$$120$$.$GetState$($item$$56$$) == $self$$120$$.$STATE_EXPANDED$ && $expanded$$7$$.push($self$$120$$.$GetKey$($item$$56$$[0]));
    });
    return $expanded$$7$$;
  ...
  $oj$$19$$.$__registerWidget$("oj.ojListView", $$$$18$$.oj.baseComponent, {widgetEventPrefix:"oj", options:{currentItem:null, data:null, drillMode:"collapsible", expanded:"auto", item:{focusable:!0, renderer:null, selectable:!0}, scrollPolicy:"auto", scrollPolicyOptions:{fetchSize:25, maxCount:500}, selection:[], selectionMode:"none", beforeCurrentItem:null, beforeExpand:null, beforeCollapse:null, collapse:null, expand:null, optionChange:null, ready:null}, _ComponentCreate:function() {
    ...
    this._super();
  }, $_NotifyContextMenuGesture$:function($menu$$7$$, $event$$260$$, $eventType$$40$$) {
    this.$listview$.$notifyContextMenuGesture$($menu$$7$$, $event$$260$$, $eventType$$40$$);
  }, _setOptions:function($options$$300$$, $flags$$24$$) {
    var $needRefresh$$ = this.$listview$.$setOptions$($options$$300$$, $flags$$24$$);
    this._super($options$$300$$, $flags$$24$$);
    ...
    return this.$listview$.getNodeBySubId($locator$$21$$);
