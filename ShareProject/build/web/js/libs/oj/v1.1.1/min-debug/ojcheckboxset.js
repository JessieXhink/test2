...
define(["ojs/ojcore", "jquery", "ojs/ojeditablevalue", "ojs/ojradiocheckbox"], function($oj$$38$$, $$$$37$$) {
  (function() {
    ...
    }, $_NotifyContextMenuGesture$:function($launcher$$13_menu$$21$$, $event$$501$$, $eventType$$51$$) {
      $launcher$$13_menu$$21$$ = this.element.find("input[type\x3dcheckbox]:tabbable").first();
      this.$_OpenContextMenu$($event$$501$$, $eventType$$51$$, {launcher:$launcher$$13_menu$$21$$});
    }, $_setup$:function() {
      this.$_propagateDisabled$(this.options.disabled);
    }, $_events$:{change:function($event$$502$$) {
      this.$_HandleChangeEvent$($event$$502$$);
    }}, $_HandleChangeEvent$:function($event$$503$$) {
      var $submittedValue$$3$$ = this.$_GetDisplayValue$();
      this.$_SetValue$($submittedValue$$3$$, $event$$503$$, $_sValueChangeCheckFalse$$);
    ...
    }, _setOption:function($key$$154$$, $value$$253$$, $flags$$38$$) {
      this._super($key$$154$$, $value$$253$$, $flags$$38$$);
      "disabled" === $key$$154$$ && this.$_propagateDisabled$($value$$253$$);
    }, getNodeBySubId:function($locator$$38_subId$$36$$) {
      var $node$$106$$ = this._super($locator$$38_subId$$36$$);
      return $node$$106$$ || ($locator$$38_subId$$36$$ = $locator$$38_subId$$36$$.subId, "oj-checkboxset-inputs" !== $locator$$38_subId$$36$$) ? $node$$106$$ || null : this.$$checkboxes$.get();
    }, _destroy:function() {
