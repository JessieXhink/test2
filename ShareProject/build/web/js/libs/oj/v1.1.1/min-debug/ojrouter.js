...
define(["ojs/ojcore", "knockout", "signals", "promise"], function($oj$$17$$, $ko$$3$$, $signals$$1$$) {
  (function() {
    function $_updateAll$$($allChanges$$3$$) {
      ...
      for (var $change$$3_hasChanged$$1$$ = !1, $i$$276$$ = 0;$i$$276$$ < $allChanges$$3$$.length && ($change$$3_hasChanged$$1$$ = $allChanges$$3$$[$i$$276$$], $change$$3_hasChanged$$1$$ = $change$$3_hasChanged$$1$$.$router$.$_update$($change$$3_hasChanged$$1$$.value), $change$$3_hasChanged$$1$$);$i$$276$$++) {
      }
    ...
    function $_canEnter$$($allChanges$$2$$) {
      ...
      for (var $canEnter$$ = !0, $promise$$1$$ = Promise.resolve(!0), $allPromises$$1$$ = [], $i$$274$$ = 0;$i$$274$$ < $allChanges$$2$$.length;$i$$274$$++) {
        var $canEnterCallback_change$$2$$ = $allChanges$$2$$[$i$$274$$], $newState$$ = $canEnterCallback_change$$2$$.$router$.$stateFromIdCallback$($canEnterCallback_change$$2$$.value);
        if ($newState$$ && ($canEnterCallback_change$$2$$ = $newState$$.canEnter, "function" === typeof $canEnterCallback_change$$2$$)) {
          var $result$$55$$;
          try {
            $result$$55$$ = $canEnterCallback_change$$2$$();
          } catch ($err$$14$$) {
            return $oj$$17$$.$Logger$.error("Error when executing canEnter callback: " + $err$$14$$.message), Promise.resolve([]);
          }
          if ($result$$55$$ && $result$$55$$.then) {
            $promise$$1$$ = $result$$55$$;
          } else {
            if ($canEnter$$ = $result$$55$$, !$canEnter$$) {
      ...
      return $canEnter$$ ? Promise.all($allPromises$$1$$).then(function($results$$10$$) {
        for (var $i$$275$$ = 0;$i$$275$$ < $results$$10$$.length;$i$$275$$++) {
          if (!$results$$10$$[$i$$275$$]) {
            return $oj$$17$$.$Logger$.info("CanEnter promise at position " + $i$$275$$ + " returned false."), [];
          }
        }
        return $allChanges$$2$$;
      }) : Promise.resolve([]);
    ...
    function $getChildRouter$$($router$$2$$, $value$$207$$) {
      for (var $subRouter$$, $i$$266$$ = 0;$i$$266$$ < $router$$2$$.$_childRouters$.length;$i$$266$$++) {
        var $sr$$ = $router$$2$$.$_childRouters$[$i$$266$$].$router$;
    ...
    function $addStateParam$$($url$$24$$, $extraState$$1$$) {
      if ($extraState$$1$$ && 0 < Object.getOwnPropertyNames($extraState$$1$$).length) {
        ...
        $url$$24$$ = $JSCompiler_temp_const$$6$$ + ($sep$$1$$ + $param$$inline_786$$);
      }
      return $url$$24$$;
    }
    function $handlePopState$$() {
      $oj$$17$$.$Logger$.info("Handling popState event with URL: " + window.location.href);
      for (var $subRouter$$1$$ = null, $i$$267$$ = 0;$i$$267$$ < $rootRouter$$.$_childRouters$.length;$i$$267$$++) {
        var $sr$$1$$ = $rootRouter$$.$_childRouters$[$i$$267$$].$router$;
    ...
    function $_buildAllCanExitPromises$$($router$$5$$, $promisesArray$$) {
      ...
      if ($currentState$$) {
        for (var $canExitCallback_i$$268$$ = 0;$canExitCallback_i$$268$$ < $router$$5$$.$_childRouters$.length;$canExitCallback_i$$268$$++) {
          if ($canExit$$1$$ = $_buildAllCanExitPromises$$($router$$5$$.$_childRouters$[$canExitCallback_i$$268$$].$router$, $promisesArray$$), !$canExit$$1$$) {
            return!1;
          }
        }
        $canExitCallback_i$$268$$ = $currentState$$.$viewModel$ && $currentState$$.$viewModel$.canExit ? $currentState$$.$viewModel$.canExit : $currentState$$.canExit;
        if ("function" === typeof $canExitCallback_i$$268$$) {
          var $result$$53$$;
          try {
            $result$$53$$ = $canExitCallback_i$$268$$();
          } catch ($err$$13$$) {
            return $oj$$17$$.$Logger$.error("Error when executing canExit callback: " + $err$$13$$.message), !1;
          }
          $result$$53$$ && $result$$53$$.then ? $promise$$ = $result$$53$$ : ($result$$53$$ || $oj$$17$$.$Logger$.info("canExit is false for state " + $currentState$$.id), $canExit$$1$$ = $result$$53$$);
        }
      }
    ...
    function $_canExit$$($canExit$$2_router$$6$$) {
      ...
      return($canExit$$2_router$$6$$ = $_buildAllCanExitPromises$$($canExit$$2_router$$6$$, $allPromises$$)) ? Promise.all($allPromises$$).then(function($results$$9$$) {
        for (var $i$$269$$ = 0;$i$$269$$ < $results$$9$$.length;$i$$269$$++) {
          if (!$results$$9$$[$i$$269$$]) {
            return $oj$$17$$.$Logger$.info("CanExit promise at position " + $i$$269$$ + " returned false."), !1;
          }
        }
        return!0;
    ...
    function $parseAndUpdate$$($extra$$inline_789_url$$26$$) {
      ...
      try {
        ...
        if ($stateStr$$inline_791$$) {
          ...
          "0" === $compressionType$$inline_998_reducedChanges$$inline_794$$ && ($param$$inline_997_search$$inline_790$$ = decodeURIComponent($param$$inline_997_search$$inline_790$$));
    ...
    var $_ojBaseUrl$$, $_basePathName$$, $_thisPage$$ = function getThisPage() {
      var $result$$52$$ = "", $url$$22$$ = window.location.pathname;
      -1 !== $url$$22$$.indexOf(".html", $url$$22$$.length - 5) && ($result$$52$$ = $url$$22$$.split("/").pop());
      return $result$$52$$;
      ...
      if (!$LZString$$.$_baseReverseDic$[$alphabet$$]) {
        ...
        for (var $i$$271$$ = 0;$i$$271$$ < $alphabet$$.length;$i$$271$$++) {
          $LZString$$.$_baseReverseDic$[$alphabet$$][$alphabet$$[$i$$271$$]] = $i$$271$$;
        }
      }
      ...
      var $i$$272$$, $value$$208$$, $context_dictionary$$ = {}, $context_dictionaryToCreate$$ = {}, $context_c$$ = "", $context_wc$$ = "", $context_w$$ = "", $context_enlargeIn$$ = 2, $context_dictSize$$ = 3, $context_numBits$$ = 2, $context_data_string$$ = "", $context_data_val$$ = 0, $context_data_position$$ = 0, $ii$$;
        ...
        if ($context_c$$ = $uncompressed$$[$ii$$], Object.prototype.hasOwnProperty.call($context_dictionary$$, $context_c$$) || ($context_dictionary$$[$context_c$$] = $context_dictSize$$++, $context_dictionaryToCreate$$[$context_c$$] = !0), $context_wc$$ = $context_w$$ + $context_c$$, Object.prototype.hasOwnProperty.call($context_dictionary$$, $context_wc$$)) {
          ...
          if (Object.prototype.hasOwnProperty.call($context_dictionaryToCreate$$, $context_w$$)) {
            if (256 > $context_w$$.charCodeAt(0)) {
              for ($i$$272$$ = 0;$i$$272$$ < $context_numBits$$;$i$$272$$++) {
            ...
            for ($value$$208$$ = $context_dictionary$$[$context_w$$], $i$$272$$ = 0;$i$$272$$ < $context_numBits$$;$i$$272$$++) {
              $context_data_val$$ = $context_data_val$$ << 1 | $value$$208$$ & 1, $context_data_position$$ == $bitsPerChar$$ - 1 ? ($context_data_position$$ = 0, $context_data_string$$ += $getCharFromInt$$($context_data_val$$), $context_data_val$$ = 0) : $context_data_position$$++, $value$$208$$ >>= 1;
            }
          }
          $context_enlargeIn$$--;
      ...
      for (var $dictionary$$ = [], $enlargeIn$$ = 4, $dictSize$$ = 4, $numBits$$ = 3, $bits_entry$$3$$ = "", $i$$273_result$$54$$ = "", $w$$5$$, $resb$$, $maxpower$$, $power$$, $c$$36$$, $f$$3$$ = $LZString$$.$_f$, $data$$131$$ = {val:$getNextValue$$(0), position:$resetValue$$, index:1}, $i$$273_result$$54$$ = 0;3 > $i$$273_result$$54$$;$i$$273_result$$54$$ += 1) {
        $dictionary$$[$i$$273_result$$54$$] = $i$$273_result$$54$$;
      }
      $bits_entry$$3$$ = 0;
      $maxpower$$ = Math.pow(2, 2);
      for ($power$$ = 1;$power$$ != $maxpower$$;) {
        $resb$$ = $data$$131$$.val & $data$$131$$.position, $data$$131$$.position >>= 1, 0 == $data$$131$$.position && ($data$$131$$.position = $resetValue$$, $data$$131$$.val = $getNextValue$$($data$$131$$.index++)), $bits_entry$$3$$ |= (0 < $resb$$ ? 1 : 0) * $power$$, $power$$ <<= 1;
      }
      switch($bits_entry$$3$$) {
        case 0:
          $bits_entry$$3$$ = 0;
      ...
      for ($w$$5$$ = $i$$273_result$$54$$ = $dictionary$$[3] = $c$$36$$;;) {
        if ($data$$131$$.index > $length$$14$$) {
          return "";
        }
        $bits_entry$$3$$ = 0;
    ...
    $oj$$17$$.$Router$ = function $$oj$$17$$$$Router$$($key$$87$$, $parentRouter$$) {
      var $router$$7$$ = this;
      $oj$$17$$.$RouterState$ = function $$oj$$17$$$$RouterState$$($id$$32$$, $options$$296$$) {
        ...
        "boolean" === typeof $options$$296$$.isDefault && $options$$296$$.isDefault && ($router$$7$$.$_defaultStateId$ = $id$$32$$);
      ...
      $oj$$17$$.$RouterState$.prototype.$isCurrent$ = function $$oj$$17$$$$RouterState$$$$isCurrent$$() {
        return $router$$7$$.$_stateId$() === this.id;
      };
    ...
    $oj$$17$$.$Router$.prototype.$createChildRouter$ = function $$oj$$17$$$$Router$$$$createChildRouter$$($name$$103$$) {
      ...
      for (var $childRouter_i$$277$$ = 0;$childRouter_i$$277$$ < this.$_childRouters$.length;$childRouter_i$$277$$++) {
        var $sr$$2$$ = this.$_childRouters$[$childRouter_i$$277$$].$router$;
      ...
      $childRouter_i$$277$$ = new $oj$$17$$.$Router$($name$$103$$, this);
      this.$_childRouters$.push({name:$name$$103$$, $router$:$childRouter_i$$277$$});
      return $childRouter_i$$277$$;
    };
    ...
    $oj$$17$$.$Router$.prototype.$stateFromIdCallback$ = function $$oj$$17$$$$Router$$$$stateFromIdCallback$$($stateId$$1$$) {
      var $state$$inline_810$$;
      if ($stateId$$1$$ && this.$_states$) {
        $oj$$17$$.$Assert$.$assertString$($stateId$$1$$);
        for (var $i$$inline_811$$ = 0;$i$$inline_811$$ < this.$_states$.length;$i$$inline_811$$++) {
          var $stateAt$$inline_812$$ = this.$_states$[$i$$inline_811$$];
          if ($stateAt$$inline_812$$.id === $stateId$$1$$) {
            $state$$inline_810$$ = $stateAt$$inline_812$$;
            break;
          }
        }
      }
      return $state$$inline_810$$;
    };
    $oj$$17$$.$Router$.prototype.$_update$ = function $$oj$$17$$$$Router$$$$_update$$($callback$$inline_822_newValue$$10_state$$inline_821$$) {
      var $callback$$inline_817_hasChanged$$2_state$$inline_816$$ = !1;
      $callback$$inline_822_newValue$$10_state$$inline_821$$ && !this.$stateFromIdCallback$($callback$$inline_822_newValue$$10_state$$inline_821$$) ? $oj$$17$$.$Logger$.error('State id: "' + $callback$$inline_822_newValue$$10_state$$inline_821$$ + '" is not a valid state for ' + $getRouterFullName$$(this)) : ($oj$$17$$.$Logger$.info("Updating state of " + $getRouterFullName$$(this) + " to " + $callback$$inline_822_newValue$$10_state$$inline_821$$), ($callback$$inline_817_hasChanged$$2_state$$inline_816$$ = 
      this.$stateFromIdCallback$(this.$_stateId$())) && ($callback$$inline_817_hasChanged$$2_state$$inline_816$$ = $callback$$inline_817_hasChanged$$2_state$$inline_816$$.exit) && $callback$$inline_817_hasChanged$$2_state$$inline_816$$.call(this), this.$_stateId$($callback$$inline_822_newValue$$10_state$$inline_821$$), $callback$$inline_817_hasChanged$$2_state$$inline_816$$ = !0, $callback$$inline_822_newValue$$10_state$$inline_821$$ && ($callback$$inline_822_newValue$$10_state$$inline_821$$ = this.$stateFromIdCallback$($callback$$inline_822_newValue$$10_state$$inline_821$$)) && 
      ($callback$$inline_822_newValue$$10_state$$inline_821$$ = $callback$$inline_822_newValue$$10_state$$inline_821$$.enter) && $callback$$inline_822_newValue$$10_state$$inline_821$$.call(this));
      return $callback$$inline_817_hasChanged$$2_state$$inline_816$$;
    };
    $oj$$17$$.$Router$.prototype.$configure$ = function $$oj$$17$$$$Router$$$$configure$$($option$$25$$) {
      ...
      delete this.$_states$;
      this.$_states$ = null;
      "function" === typeof $option$$25$$ ? this.$stateFromIdCallback$ = $option$$25$$ : (this.$_states$ = [], delete this.$stateFromIdCallback$, Object.keys($option$$25$$).forEach(function($key$$88$$) {
        this.$_states$.push(new $oj$$17$$.$RouterState$($key$$88$$, $option$$25$$[$key$$88$$]));
      }, this));
      return this;
    };
    ...
    $oj$$17$$.$Router$.prototype.go = function $$oj$$17$$$$Router$$$go$($allStates_shortUrl$$1_stateId$$3$$) {
      ...
      $oj$$17$$.$Assert$.$assertStringOrNull$($allStates_shortUrl$$1_stateId$$3$$);
      ...
      if ($allStates_shortUrl$$1_stateId$$3$$) {
        if ($state$$8$$ = this.$stateFromIdCallback$($allStates_shortUrl$$1_stateId$$3$$), !$state$$8$$) {
          return $dispatchTransitionedToState$$(!1), Promise.reject(Error('State id "' + $allStates_shortUrl$$1_stateId$$3$$ + '" does not exist.'));
        }
      } else {
        this.$_defaultStateId$ && ($state$$8$$ = this.$stateFromIdCallback$(this.$_defaultStateId$));
      }
    ...
    $oj$$17$$.$Router$.prototype.$store$ = function $$oj$$17$$$$Router$$$$store$$($data$$132_extraState$$2$$) {
      this.$_extra$ = $data$$132_extraState$$2$$;
      $data$$132_extraState$$2$$ = {};
      for (var $router$$8$$ = this;$router$$8$$;) {
        $router$$8$$.$_extra$ && ($data$$132_extraState$$2$$[$router$$8$$.name] = $router$$8$$.$_extra$), $router$$8$$ = $router$$8$$.parent;
      }
      for (var $router$$8$$ = this, $nextLevel_url$$27$$;$router$$8$$;) {
        for (var $i$$278$$ = 0;$i$$278$$ < $router$$8$$.$_childRouters$.length;$i$$278$$++) {
          var $sr$$3$$ = $router$$8$$.$_childRouters$[$i$$278$$].$router$;
          if ($router$$8$$.$_stateId$() && $router$$8$$.$_stateId$() === $sr$$3$$.$_parentState$) {
            $sr$$3$$.$_extra$ && ($data$$132_extraState$$2$$[$sr$$3$$.name] = $sr$$3$$.$_extra$);
      ...
      $nextLevel_url$$27$$ = $addStateParam$$($nextLevel_url$$27$$, $data$$132_extraState$$2$$);
    ...
    $oj$$17$$.$Router$.prototype.$dispose$ = function $$oj$$17$$$$Router$$$$dispose$$() {
      ...
      if (this.parent) {
        for (var $parentChildren$$ = this.parent.$_childRouters$, $i$$279$$ = 0;$i$$279$$ < $parentChildren$$.length;$i$$279$$++) {
          if ($parentChildren$$[$i$$279$$].$router$.name === this.name) {
            $parentChildren$$.splice($i$$279$$, 1);
            break;
          }
        }
      } else {
