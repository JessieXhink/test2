...
define(["ojs/ojcore", "jquery", "jqueryui-amd/core", "jqueryui-amd/widget", "ojs/ojmessaging"], function($oj$$3$$, $$$$3$$) {
  ...
  $oj$$3$$.$FocusUtils$.$containsFocus$ = function $$oj$$3$$$$FocusUtils$$$containsFocus$$($element$$22$$) {
    var $activeElem$$ = document.activeElement;
    return $element$$22$$ && $activeElem$$ ? $oj$$3$$.$DomUtils$.$isAncestorOrSelf$($element$$22$$, $activeElem$$) : !1;
  };
  $oj$$3$$.$FocusUtils$.$focusElement$ = function $$oj$$3$$$$FocusUtils$$$focusElement$$($element$$23$$) {
    $element$$23$$.focus();
  };
  $oj$$3$$.$FocusUtils$.$focusFirstTabStop$ = function $$oj$$3$$$$FocusUtils$$$focusFirstTabStop$$($element$$24_focusElement$$) {
    ($element$$24_focusElement$$ = $oj$$3$$.$FocusUtils$.$getFirstTabStop$($element$$24_focusElement$$)) && $oj$$3$$.$FocusUtils$.$focusElement$($element$$24_focusElement$$);
  };
  $oj$$3$$.$FocusUtils$.$getFirstTabStop$ = function $$oj$$3$$$$FocusUtils$$$getFirstTabStop$$($element$$25_jqFocusables$$) {
    var $jqElem$$ = $$$$3$$($element$$25_jqFocusables$$);
    return $jqElem$$.is($oj$$3$$.$FocusUtils$.$_TABBABLE$) ? $element$$25_jqFocusables$$ : ($element$$25_jqFocusables$$ = $jqElem$$.find($oj$$3$$.$FocusUtils$.$_TABBABLE$)) && 0 < $element$$25_jqFocusables$$.length ? $element$$25_jqFocusables$$[0] : null;
  };
  $oj$$3$$.$DomUtils$ = {};
  ...
  $oj$$3$$.$DomUtils$.$_cleanElementHtml$ = function $$oj$$3$$$$DomUtils$$$_cleanElementHtml$$($node$$11$$) {
    for (var $children$$ = $node$$11$$.childNodes, $child$$1$$, $attrs$$19$$, $attr$$11$$, $childHasAttr$$, $i$$87$$, $count$$22$$ = $children$$.length - 1;0 <= $count$$22$$;) {
      if (($child$$1$$ = $children$$.item($count$$22$$)) && 1 === $child$$1$$.nodeType) {
        if ($oj$$3$$.$DomUtils$.$_LEGAL_ELEMENTS$[$child$$1$$.nodeName]) {
          ...
          for ($i$$87$$ = $attrs$$19$$.length - 1;0 <= $i$$87$$;$i$$87$$--) {
            $attr$$11$$ = $attrs$$19$$[$i$$87$$], ($childHasAttr$$ = void 0 !== $$$$3$$($child$$1$$).attr($attr$$11$$.name)) && ($oj$$3$$.$DomUtils$.$_LEGAL_ATTRIBUTES$[$attr$$11$$.name] || $child$$1$$.removeAttribute($attr$$11$$.nodeName));
          }
  ...
  $oj$$3$$.$DomUtils$.$_ResizeTracker$ = function $$oj$$3$$$$DomUtils$$$_ResizeTracker$$($div$$2$$) {
    ...
    function $_notifyListeners$$($i$$88_useAfterPaint$$) {
      var $newWidth$$1$$ = $div$$2$$.offsetWidth, $newHeight$$1$$ = $div$$2$$.offsetHeight;
      $_listeners$$.has() && ($i$$88_useAfterPaint$$ ? (null !== $_invokeId$$ && $oj$$3$$.$DomUtils$.$_cancelInvokeAfterPaint$($_invokeId$$), $_invokeId$$ = $oj$$3$$.$DomUtils$.$_invokeAfterPaint$(function() {
        $_invokeId$$ = null;
        $_listeners$$.fire($newWidth$$1$$, $newHeight$$1$$);
      })) : $_listeners$$.fire($newWidth$$1$$, $newHeight$$1$$));
      for ($i$$88_useAfterPaint$$ = 0;$i$$88_useAfterPaint$$ < $_collapsingManagers$$.length;$i$$88_useAfterPaint$$++) {
        $_collapsingManagers$$[$i$$88_useAfterPaint$$].$getCallback$()($newWidth$$1$$, $newHeight$$1$$);
      }
    }
  ...
  $oj$$3$$.$DomUtils$.$isChromeEvent$ = function $$oj$$3$$$$DomUtils$$$isChromeEvent$$($JSCompiler_temp$$9_event$$32$$) {
    ...
    if (!("clientX" in $JSCompiler_temp$$9_event$$32$$ && "clientY" in $JSCompiler_temp$$9_event$$32$$)) {
      return!1;
    }
    ...
    if ($oj$$3$$.$AgentUtils$.$OS$.$ANDROID$ === $agentInfo$$1$$.os || $oj$$3$$.$AgentUtils$.$OS$.$IOS$ === $agentInfo$$1$$.os) {
      $JSCompiler_temp$$9_event$$32$$ = !1;
    } else {
      var $JSCompiler_temp$$10$$;
      if ($oj$$3$$.$AgentUtils$.$ENGINE$.$GECKO$ === $agentInfo$$1$$.engine) {
        try {
          $JSCompiler_temp$$10$$ = $JSCompiler_temp$$9_event$$32$$.originalTarget.localName ? !1 : !0;
        } catch ($e$$inline_463$$) {
          $JSCompiler_temp$$10$$ = !0;
        }
      } else {
        $JSCompiler_temp$$10$$ = $oj$$3$$.$AgentUtils$.$ENGINE$.$WEBKIT$ === $agentInfo$$1$$.engine ? $_isChromeEventWebkit$$($JSCompiler_temp$$9_event$$32$$) : $oj$$3$$.$AgentUtils$.$BROWSER$.$IE$ === $agentInfo$$1$$.browser ? $_isChromeEventWebkit$$($JSCompiler_temp$$9_event$$32$$) : !1;
      }
      $JSCompiler_temp$$9_event$$32$$ = $JSCompiler_temp$$10$$;
    }
    return $JSCompiler_temp$$9_event$$32$$;
  };
  ...
  $oj$$3$$.$DomUtils$.$isWithinViewport$ = function $$oj$$3$$$$DomUtils$$$isWithinViewport$$($element$$26$$, $checkBrowserViewport$$) {
    ...
    function $hasOverflow$$($element$$27$$) {
      return "visible" !== $element$$27$$.css("overflow-x") || "visible" !== $element$$27$$.css("overflow-y");
    }
    if (!$element$$26$$) {
      return!1;
    }
    var $alignBox$$ = $element$$26$$[0].getBoundingClientRect();
    if ($checkBrowserViewport$$ && !$isVisible$$($alignBox$$, $$$$3$$(document.body).offset())) {
      return!1;
    }
    for (var $isWithinViewPort_parentBox$$ = !0, $parent$$2$$ = $element$$26$$.parent();$isWithinViewPort_parentBox$$ && $parent$$2$$ && 0 < $parent$$2$$.length && 1 === $parent$$2$$[0].nodeType;) {
  ...
  $oj$$3$$.$ComponentMessaging$.prototype.$activate$ = function $$oj$$3$$$$ComponentMessaging$$$$activate$$($launcher$$, $content$$5$$) {
    ...
    this.$_activated$ ? this.$_reactivate$() : ($$$$3$$.each(this.$_strategies$, function($i$$89$$, $strategy$$) {
  ...
  $oj$$3$$.$ComponentMessaging$.prototype.update = function $$oj$$3$$$$ComponentMessaging$$$update$($content$$6$$) {
    ...
    this.$_activated$ && $$$$3$$.each(this.$_strategies$, function($i$$90$$, $strategy$$1$$) {
  ...
  $oj$$3$$.$ComponentMessaging$.prototype.$deactivate$ = function $$oj$$3$$$$ComponentMessaging$$$$deactivate$$() {
    $$$$3$$.each(this.$_strategies$, function($i$$91$$, $strategy$$2$$) {
  ...
  $oj$$3$$.$ComponentMessaging$.prototype.$_getResolvedMessagingDisplayOptions$ = function $$oj$$3$$$$ComponentMessaging$$$$_getResolvedMessagingDisplayOptions$$() {
    var $artifactsByDisplayType$$ = {}, $artifactDisplayTypeResolved$$ = !1, $displayTypes$$, $displayType_key$$34$$, $compPH$$ = this.$_component$.options.placeholder, $artifact$$, $keys$$5$$, $i$$92$$, $j$$7$$, $messagingPreferences$$ = this.$_component$.options.displayOptions || {}, $$messagingPreferences$$ = {};
    $keys$$5$$ = Object.keys($messagingPreferences$$);
    for ($i$$92$$ = 0;$i$$92$$ < $keys$$5$$.length;$i$$92$$++) {
      $displayType_key$$34$$ = $keys$$5$$[$i$$92$$];
  ...
  $$$$3$$(document).ready(function() {
    var $div$$inline_489$$ = $$$$3$$("\x3cdiv style\x3d'border: 1px solid;border-color:red green;position: absolute;top: -999px;background-image: url(data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACwAAAAAAQABAAACAkQBADs\x3d);'\x3e\x3c/div\x3e"), $bki$$inline_490$$;
    $div$$inline_489$$.appendTo("body");
    $bki$$inline_490$$ = $div$$inline_489$$.css("backgroundImage");
    $div$$inline_489$$.css("borderTopColor") != $div$$inline_489$$.css("borderRightColor") && (null == $bki$$inline_490$$ || "none" != $bki$$inline_490$$ && "url (invalid-url:)" != $bki$$inline_490$$) || $$$$3$$("body").addClass("oj-hicontrast");
    $div$$inline_489$$.remove();
  });
  $$$$3$$(document).ready(function() {
