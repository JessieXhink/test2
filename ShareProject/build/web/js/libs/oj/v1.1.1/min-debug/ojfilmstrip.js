...
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore", "promise"], function($oj$$24$$, $$$$23$$) {
  ...
  $oj$$24$$.$FilmStripPagingModel$.prototype.setPage = function $$oj$$24$$$$FilmStripPagingModel$$$setPage$($page$$8$$, $options$$314$$) {
    ...
    try {
      ...
      var $pageCount$$1$$ = this.getPageCount(), $self$$128$$ = this;
      return new Promise(function($resolve$$50$$) {
        $prevPageCount$$ != $pageCount$$1$$ && $self$$128$$.handleEvent("pageCount", {pageCount:$pageCount$$1$$, previousPageCount:$prevPageCount$$});
        $bFiredBeforePageEvent$$ && $self$$128$$.handleEvent("page", {page:$page$$8$$, previousPage:$prevPage$$});
        $resolve$$50$$(null);
      });
    } catch ($e$$93$$) {
      return Promise.reject(null);
  ...
  (function() {
    ...
    $oj$$24$$.$__registerWidget$("oj.ojFilmStrip", $$$$23$$.oj.baseComponent, {defaultElement:"\x3cdiv\x3e", widgetEventPrefix:"oj", options:{maxItemsPerPage:0, orientation:"horizontal", currentItem:0, arrowPlacement:"adjacent", arrowVisibility:"auto"}, _ComponentCreate:function() {
      ...
      if (this.$_canCalculateSizes$()) {
        ...
        var $elem$$58_oldIsInit$$ = this.element, $self$$129$$ = this;
        $isInit_pagingModel$$ ? (this.$_itemsPerPage$ = 0, this.$_handlePageFunc$ = function $this$$_handlePageFunc$$($event$$298$$) {
          $self$$129$$.$_handlePage$($event$$298$$);
          ...
          $self$$129$$.$_handleTransitionEnd$();
        }, this.$_handleResizeFunc$ = function $this$$_handleResizeFunc$$() {
          $self$$129$$.$_handleResize$();
        }, this.$_bTouchSupported$ && (this.$_handleTouchStartFunc$ = function $this$$_handleTouchStartFunc$$($event$$300$$) {
          $self$$129$$.$_handleTouchStart$($event$$300$$);
        }, this.$_handleTouchMoveFunc$ = function $this$$_handleTouchMoveFunc$$($event$$301$$) {
          $self$$129$$.$_handleTouchMove$($event$$301$$);
        }, this.$_handleTouchEndFunc$ = function $this$$_handleTouchEndFunc$$($event$$302$$) {
          $self$$129$$.$_handleTouchEnd$($event$$302$$);
        }, this.$_addTouchListeners$()), this.$_handleMouseDownFunc$ = function $this$$_handleMouseDownFunc$$($event$$303$$) {
          $self$$129$$.$_handleMouseDown$($event$$303$$);
        }, this.$_handleMouseMoveFunc$ = function $this$$_handleMouseMoveFunc$$($event$$304$$) {
          $self$$129$$.$_handleMouseMove$($event$$304$$);
        }, this.$_handleMouseUpFunc$ = function $this$$_handleMouseUpFunc$$($event$$305$$) {
          $self$$129$$.$_handleMouseUp$($event$$305$$);
        }, this.$_addMouseListeners$(), this.$_handleKeyDownFunc$ = function $this$$_handleKeyDownFunc$$($event$$306$$) {
          $self$$129$$.$_handleKeyDown$($event$$306$$);
        }, this.$_addKeyListeners$()) : this.$_destroyInternal$();
        for (var $originalItems$$ = $elem$$58_oldIsInit$$.children(), $i$$321$$ = 0;$i$$321$$ < $originalItems$$.length;$i$$321$$++) {
          $oj$$24$$.Components.$subtreeDetached$($originalItems$$[$i$$321$$]);
        }
        ...
        this.$_wrapChildren$();
        this.$_adjustSizes$();
        for ($i$$321$$ = 0;$i$$321$$ < $originalItems$$.length;$i$$321$$++) {
          $oj$$24$$.Components.$subtreeAttached$($originalItems$$[$i$$321$$]);
        }
      ...
      for (var $originalItems$$1$$ = this.$_getItems$(), $i$$322$$ = 0;$i$$322$$ < $originalItems$$1$$.length;$i$$322$$++) {
        $oj$$24$$.Components.$subtreeDetached$($originalItems$$1$$[$i$$322$$]);
      }
      this.$_clearCalculatedSizes$();
      this.$_getItemContainers$().unwrap();
      this.$_unwrapChildren$();
      for ($i$$322$$ = 0;$i$$322$$ < $originalItems$$1$$.length;$i$$322$$++) {
        $oj$$24$$.Components.$subtreeAttached$($originalItems$$1$$[$i$$322$$]);
      }
    }, _setOption:function($key$$136$$, $value$$233$$, $flags$$29$$) {
      ...
      this._super($key$$136$$, $value$$233$$, $flags$$29$$);
      switch($key$$136$$) {
        case $_CURRENT_ITEM$$:
      ...
      if (!this.$_bHandlingResize$) {
        ...
        if (!this.$_queuedHandleResize$) {
          ...
          this.$_queuedHandleResize$ = setTimeout(function() {
            $self$$130$$.$_queuedHandleResize$ = null;
      ...
      this.element.on("mouseenter" + this.$navArrowHoverableEventNamespace$, function($event$$307$$) {
        $$$$23$$($event$$307$$.currentTarget).hasClass("oj-disabled") || $$$$23$$($event$$307$$.currentTarget).addClass($_OJ_FILMSTRIP_HOVER$$);
      }).on("mouseleave" + this.$navArrowHoverableEventNamespace$, function($event$$308$$) {
        $$$$23$$($event$$308$$.currentTarget).removeClass($_OJ_FILMSTRIP_HOVER$$);
      });
      ...
      var $elem$$66_label$$8$$ = this.element, $locationMarker_navArrow$$ = this.$_isHorizontal$() ? $_OJ_START$$ : $_OJ_TOP$$, $container$$15$$ = this.$_createNavigationArrowContainer$($locationMarker_navArrow$$);
      this.options.arrowPlacement === $_OVERLAY$$ ? $elem$$66_label$$8$$.append($container$$15$$) : $elem$$66_label$$8$$.prepend($container$$15$$);
      var $elem$$66_label$$8$$ = $_escapeHtml$$(this.$getTranslatedString$("labelAccArrowPreviousPage")), $tooltip$$ = $_escapeHtml$$(this.$getTranslatedString$("tipArrowPreviousPage")), $locationMarker_navArrow$$ = this.$_createNavigationArrow$($container$$15$$, $locationMarker_navArrow$$, $elem$$66_label$$8$$, $tooltip$$), $self$$131$$ = this;
      $locationMarker_navArrow$$.on("click", function() {
        $self$$131$$.$_prevPage$();
      });
      return $locationMarker_navArrow$$;
    }, $_createNextNavArrow$:function() {
      var $elem$$67_label$$9$$ = this.element, $locationMarker$$1_navArrow$$1$$ = this.$_isHorizontal$() ? $_OJ_END$$ : $_OJ_BOTTOM$$, $container$$16$$ = this.$_createNavigationArrowContainer$($locationMarker$$1_navArrow$$1$$);
      $elem$$67_label$$9$$.append($container$$16$$);
      var $elem$$67_label$$9$$ = $_escapeHtml$$(this.$getTranslatedString$("labelAccArrowNextPage")), $tooltip$$1$$ = $_escapeHtml$$(this.$getTranslatedString$("tipArrowNextPage")), $locationMarker$$1_navArrow$$1$$ = this.$_createNavigationArrow$($container$$16$$, $locationMarker$$1_navArrow$$1$$, $elem$$67_label$$9$$, $tooltip$$1$$), $self$$132$$ = this;
      ...
      return $container$$17$$;
    }, $_createNavigationArrow$:function($arrowElem_parentElem$$3$$, $elemId_locationMarker$$3$$, $label$$10$$, $tooltip$$2$$) {
      ...
      $label$$10$$ && $arrowElem_parentElem$$3$$.attr("aria-label", $label$$10$$);
      ...
      if ($elem$$69_firstArrowContainer_pagingModel$$7$$.getPageCount() != $bCalcItemsPerPage_fitItemSize_newPageCount$$1$$ || this.$_itemsPerPage$ != $fitCount_itemsPerPage$$ || !$optionItem_pages$$2$$ || 1 > $optionItem_pages$$2$$.length) {
        ...
        if ($bNotifyAttach_contentWrapper_newPageIndex$$1$$) {
          for (var $i$$323$$ = 0;$i$$323$$ < $items$$10$$.length;$i$$323$$++) {
            $oj$$24$$.Components.$subtreeDetached$($items$$10$$[$i$$323$$]);
          }
        }
        $optionItem_pages$$2$$ && 0 < $optionItem_pages$$2$$.length && $items$$10$$.unwrap();
        for ($i$$323$$ = 0;$i$$323$$ < $items$$10$$.length;$i$$323$$ += $fitCount_itemsPerPage$$) {
          $items$$10$$.slice($i$$323$$, $i$$323$$ + $fitCount_itemsPerPage$$).wrapAll("\x3cdiv class\x3d'" + $_OJ_FILMSTRIP_CONTAINER$$ + " " + $_OJ_FILMSTRIP_PAGE$$ + "' style\x3d'" + $_DISPLAY$$ + ": " + $_NONE$$ + ";' " + $_ARIA_HIDDEN$$ + "\x3d'true'\x3e\x3c/div\x3e");
        }
        if ($bNotifyAttach_contentWrapper_newPageIndex$$1$$) {
          for ($i$$323$$ = 0;$i$$323$$ < $items$$10$$.length;$i$$323$$++) {
            $oj$$24$$.Components.$subtreeAttached$($items$$10$$[$i$$323$$]);
          }
        }
      }
      $optionItem_pages$$2$$ = this.$_getPages$();
    ...
    }, $_handlePage$:function($event$$309_pagesWrapper$$6$$) {
      var $pageIndex$$1$$ = $event$$309_pagesWrapper$$6$$.page, $prevPageIndex$$ = $event$$309_pagesWrapper$$6$$.previousPage;
      $event$$309_pagesWrapper$$6$$ = this.$_pagesWrapper$;
      ...
      -1 < $prevPageIndex$$ && !$bImmediate$$ && ($bDeferScroll$$ = !0, $event$$309_pagesWrapper$$6$$.css(this.$_getCssSizeAttr$(), 2 * this.$_componentSize$), $pageIndex$$1$$ < $prevPageIndex$$ && $bPageHidden$$ && $event$$309_pagesWrapper$$6$$.css($cssAttr$$1$$, -this.$_componentSize$ + $_PX$$), $pageIndex$$1$$ > $prevPageIndex$$ ? ($oldPage_pageSize$$10$$.addClass($_OJ_FILMSTRIP_TRANSITION_NEXT_OLDPAGE_FROM$$), $newPage$$.addClass($_OJ_FILMSTRIP_TRANSITION_NEXT_NEWPAGE_FROM$$)) : ($oldPage_pageSize$$10$$.addClass($_OJ_FILMSTRIP_TRANSITION_PREV_OLDPAGE_FROM$$), 
      $newPage$$.addClass($_OJ_FILMSTRIP_TRANSITION_PREV_NEWPAGE_FROM$$)));
      if ($bDeferScroll$$) {
        var $self$$133$$ = this, $bDragInit$$ = this.$_bDragInit$;
        $bDragInit$$ && 0 > $prevPageIndex$$ && $pages$$3$$.filter($_VISIBLE_SELECTOR$$).addClass($_OJ_FILMSTRIP_TRANSITION$$);
        setTimeout(function() {
          $self$$133$$.$_finishHandlePage$($pageIndex$$1$$, $prevPageIndex$$, $bImmediate$$, $bDragInit$$);
        }, 25);
      } else {
      ...
      for (var $newFirstItem_pageIndex$$3_pagesWrapper$$8$$ = this.$_pagingModel$.getPage(), $firstTabStop_pages$$5$$ = this.$_getPages$(), $i$$324$$ = 0;$i$$324$$ < $firstTabStop_pages$$5$$.length;$i$$324$$++) {
        $i$$324$$ != $newFirstItem_pageIndex$$3_pagesWrapper$$8$$ && this.$_hidePage$($$$$23$$($firstTabStop_pages$$5$$[$i$$324$$]));
      }
      ...
      if ("number" === typeof $item$$86$$) {
        ...
        if ("string" === typeof $item$$86$$ && $oj$$24$$.$DomUtils$.$isValidIdentifier$($item$$86$$)) {
          for (var $i$$325$$ = 0;$i$$325$$ < $items$$11$$.length;$i$$325$$++) {
            var $itemId$$ = $items$$11$$[$i$$325$$].id;
    ...
    }, $_handleMouseDown$:function($event$$311$$) {
      this.$_dragScrollStart$($event$$311$$.originalEvent);
    }, $_handleMouseMove$:function($event$$312$$) {
      this.$_dragScrollMove$($event$$312$$, $event$$312$$.originalEvent);
    }, $_handleMouseUp$:function() {
      this.$_dragScrollEnd$();
    }, $_handleTouchStart$:function($event$$314_eventTouches$$) {
      $event$$314_eventTouches$$ = $event$$314_eventTouches$$.originalEvent.touches;
      1 === $event$$314_eventTouches$$.length && this.$_dragScrollStart$($event$$314_eventTouches$$[0]);
    }, $_handleTouchMove$:function($event$$315$$) {
      this.$_dragScrollMove$($event$$315$$, $event$$315$$.originalEvent.touches[0]);
      (this.$_bTouch$ || this.$_scrolledForThisTouch$) && $event$$315$$.preventDefault();
    ...
    }, $_dragScrollMove$:function($event$$317$$, $coordsObj$$2$$) {
      if (this.$_bTouch$) {
        ...
        if (this.$_bDragInit$) {
          ...
          this.$_scrolledForThisTouch$ && ($event$$317$$.preventDefault(), $event$$317$$.stopPropagation());
        } else {
    ...
    }, getNodeBySubId:function($locator$$25_subId$$25$$) {
      if (null == $locator$$25_subId$$25$$) {
        return this.element ? this.element[0] : null;
      }
      $locator$$25_subId$$25$$ = $locator$$25_subId$$25$$.subId;
      return "oj-filmstrip-start-arrow" === $locator$$25_subId$$25$$ ? this.widget().find($_PERIOD$$ + $_OJ_FILMSTRIP_ARROW$$ + $_PERIOD$$ + $_OJ_START$$)[0] : "oj-filmstrip-end-arrow" === $locator$$25_subId$$25$$ ? this.widget().find($_PERIOD$$ + $_OJ_FILMSTRIP_ARROW$$ + $_PERIOD$$ + $_OJ_END$$)[0] : "oj-filmstrip-top-arrow" === $locator$$25_subId$$25$$ ? this.widget().find($_PERIOD$$ + $_OJ_FILMSTRIP_ARROW$$ + $_PERIOD$$ + $_OJ_TOP$$)[0] : "oj-filmstrip-bottom-arrow" === $locator$$25_subId$$25$$ ? 
