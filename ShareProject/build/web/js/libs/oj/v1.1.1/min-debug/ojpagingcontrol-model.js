...
define(["ojs/ojcore", "jquery", "knockout", "ojs/ojpagingcontrol", "ojs/ojknockout-model"], function($oj$$26$$, $$$$25$$, $ko$$4$$) {
  ...
  $oj$$26$$.$CollectionPagingDataSource$.prototype.$_refreshDataWindow$ = function $$oj$$26$$$$CollectionPagingDataSource$$$$_refreshDataWindow$$() {
    ...
    return this.$collection$.$IterativeAt$(this.current, this.current + this.$dataWindow$.length).then(function($array$$15$$) {
      for (var $i$$350$$ = 0;$i$$350$$ < $array$$15$$.length;$i$$350$$++) {
        $self$$141$$.$dataWindow$[$i$$350$$] = $array$$15$$[$i$$350$$];
      }
      $self$$141$$.$_refreshObservableDataWindow$();
      $self$$141$$.$_endIndex$ = $self$$141$$.$_startIndex$ + $self$$141$$.$dataWindow$.length - 1;
    });
  };
  $oj$$26$$.$CollectionPagingDataSource$.prototype.$_refreshObservableDataWindow$ = function $$oj$$26$$$$CollectionPagingDataSource$$$$_refreshObservableDataWindow$$() {
    if (void 0 !== this.$observableDataWindow$) {
      ...
      for (var $i$$351$$ = 0;$i$$351$$ < this.$dataWindow$.length;$i$$351$$++) {
        this.$observableDataWindow$.push($oj$$26$$.$KnockoutUtils$.map(this.$dataWindow$[$i$$351$$]));
      }
    }
  };
  ...
  $oj$$26$$.$CollectionPagingDataSource$.prototype.setPage = function $$oj$$26$$$$CollectionPagingDataSource$$$setPage$($value$$235$$, $options$$335$$) {
    ...
    var $self$$142$$ = this;
    return new Promise(function($resolve$$51$$, $reject$$50$$) {
      $self$$142$$.$_fetchInternal$($options$$335$$).then(function() {
        $oj$$26$$.$CollectionPagingDataSource$.$superclass$.handleEvent.call($self$$142$$, $oj$$26$$.$PagingModel$.$EventType$.PAGE, {page:$self$$142$$.$_page$, previousPage:$previousPage$$3$$});
        $resolve$$51$$(null);
      }, function() {
        $self$$142$$.$_page$ = $previousPage$$3$$;
        $self$$142$$.$_startIndex$ = $self$$142$$.$_page$ * $self$$142$$.pageSize;
        $reject$$50$$(null);
      });
    });
  };
  ...
  $oj$$26$$.$CollectionPagingDataSource$.prototype.$_fetchInternal$ = function $$oj$$26$$$$CollectionPagingDataSource$$$$_fetchInternal$$($options$$337$$) {
    ...
    return new Promise(function($resolve$$52$$) {
      try {
        $self$$144$$.$collection$.fetch({success:function() {
          $self$$144$$.$_refreshDataWindow$().then(function() {
            $self$$144$$.$_processSuccess$($opts$$31$$);
            $resolve$$52$$({data:$self$$144$$.$getWindow$(), startIndex:$self$$144$$.current});
          });
        }});
      } catch ($e$$98$$) {
        $self$$144$$.$_refreshDataWindow$().then(function() {
  ...
  $oj$$26$$.$CollectionPagingDataSource$.prototype.handleEvent = function $$oj$$26$$$$CollectionPagingDataSource$$$handleEvent$($eventType$$44$$, $event$$337$$) {
    return $oj$$26$$.$CollectionPagingDataSource$.$superclass$.handleEvent.call(this, $eventType$$44$$, $event$$337$$);
  };
  ...
  $oj$$26$$.$ArrayPagingDataSource$ = function $$oj$$26$$$$ArrayPagingDataSource$$($data$$144$$) {
    this.data = $data$$144$$;
    this.current = 0;
    this.Init();
    this.$_setPageSize$(10);
  ...
  $oj$$26$$.$ArrayPagingDataSource$.prototype.$_refreshDataWindow$ = function $$oj$$26$$$$ArrayPagingDataSource$$$$_refreshDataWindow$$($options$$339$$) {
    ...
    this.$dataWindow$ = Array(this.$_getSize$());
    for (var $i$$352$$ = 0;$i$$352$$ < this.$dataWindow$.length;$i$$352$$++) {
      this.$dataWindow$[$i$$352$$] = this.data[this.current + $i$$352$$];
    }
  ...
  $oj$$26$$.$ArrayPagingDataSource$.prototype.$_refreshObservableDataWindow$ = function $$oj$$26$$$$ArrayPagingDataSource$$$$_refreshObservableDataWindow$$() {
    if (void 0 !== this.$observableDataWindow$) {
      ...
      for (var $i$$353$$ = 0;$i$$353$$ < this.$dataWindow$.length;$i$$353$$++) {
        this.$observableDataWindow$.push(this.$dataWindow$[$i$$353$$]);
      }
    }
  };
  $oj$$26$$.$ArrayPagingDataSource$.prototype.handleEvent = function $$oj$$26$$$$ArrayPagingDataSource$$$handleEvent$($eventType$$45$$, $event$$338$$) {
    return $oj$$26$$.$ArrayPagingDataSource$.$superclass$.handleEvent.call(this, $eventType$$45$$, $event$$338$$);
  };
  ...
  $oj$$26$$.$ArrayPagingDataSource$.prototype.setPage = function $$oj$$26$$$$ArrayPagingDataSource$$$setPage$($value$$236$$, $options$$340$$) {
    ...
    return new Promise(function($resolve$$53$$, $reject$$52$$) {
      $self$$145$$.$_fetchInternal$($options$$340$$).then(function() {
        $oj$$26$$.$ArrayPagingDataSource$.$superclass$.handleEvent.call($self$$145$$, $oj$$26$$.$PagingModel$.$EventType$.PAGE, {page:$self$$145$$.$_page$, previousPage:$previousPage$$4$$});
        $resolve$$53$$(null);
      }, function() {
        $self$$145$$.$_page$ = $previousPage$$4$$;
        $self$$145$$.$_startIndex$ = $self$$145$$.$_page$ * $self$$145$$.pageSize;
        $reject$$52$$(null);
      });
    });
  };
