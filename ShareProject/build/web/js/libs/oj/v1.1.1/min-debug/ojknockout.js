...
define(["ojs/ojcore", "jquery", "knockout"], function($oj$$7$$, $$$$7$$, $ko$$1$$) {
  function $_extractValueFromChangeEvent$$($event$$54$$, $eventData$$1$$) {
    var $nameVal$$ = {};
    $nameVal$$.value = $eventData$$1$$.value;
    return $nameVal$$;
  }
  function $_extractOptionChange$$($event$$55$$, $eventData$$2$$) {
  ...
  function $_handleManagedAttributes$$($i$$125_name$$80$$, $value$$148$$, $bindingContext$$3$$) {
    if ("areaLayers" === $i$$125_name$$80$$) {
      for ($i$$125_name$$80$$ = 0;$i$$125_name$$80$$ < $value$$148$$.length;$i$$125_name$$80$$++) {
        var $areaDataLayer$$ = $value$$148$$[$i$$125_name$$80$$].areaDataLayer;
        if ($areaDataLayer$$) {
          var $template$$3$$ = $areaDataLayer$$.template;
          null != $template$$3$$ && ($areaDataLayer$$.renderer = $_getDataLayerRenderer$$($bindingContext$$3$$, $template$$3$$));
        }
      }
      return{areaLayers:$value$$148$$};
    }
    if ("pointDataLayers" === $i$$125_name$$80$$) {
      for ($i$$125_name$$80$$ = 0;$i$$125_name$$80$$ < $value$$148$$.length;$i$$125_name$$80$$++) {
        $template$$3$$ = $value$$148$$[$i$$125_name$$80$$].template, null != $template$$3$$ && ($value$$148$$[$i$$125_name$$80$$].renderer = $_getDataLayerRenderer$$($bindingContext$$3$$, $template$$3$$));
      }
      return{pointDataLayers:$value$$148$$};
    }
    return null;
  }
  function $_getTableColumnTemplateRenderer$$($bindingContext$$4$$, $type$$76$$, $template$$4$$) {
    var $rendererOption$$ = {};
    (function($template$$5$$, $type$$77$$) {
      $rendererOption$$ = function $$rendererOption$$$($params$$13$$) {
        var $childContext$$2$$ = null, $parentElement$$ = null;
        "header" == $type$$77$$ ? ($childContext$$2$$ = $bindingContext$$4$$.extend({$columnIndex:$params$$13$$.columnIndex, $headerContext:$params$$13$$.headerContext, $data:$params$$13$$.data}), $parentElement$$ = $params$$13$$.headerContext.parentElement) : "cell" == $type$$77$$ && ($childContext$$2$$ = $bindingContext$$4$$.createChildContext($params$$13$$.row, null, function($binding$$2$$) {
          $binding$$2$$.$columnIndex = $params$$13$$.columnIndex;
          $binding$$2$$.$cellContext = $params$$13$$.cellContext;
        }), $parentElement$$ = $params$$13$$.cellContext.parentElement);
        "footer" == $type$$77$$ && ($childContext$$2$$ = $bindingContext$$4$$.extend({$columnIndex:$params$$13$$.columnIndex, $footerContext:$params$$13$$.footerContext}), $parentElement$$ = $params$$13$$.footerContext.parentElement);
        $ko$$1$$.renderTemplate($template$$5$$, $childContext$$2$$, null, $parentElement$$, "replaceNode");
      };
    })($template$$4$$, $type$$76$$);
    return $rendererOption$$;
  }
  function $_getTableRowTemplateRenderer$$($bindingContext$$5$$, $template$$6$$) {
    return function($params$$14$$) {
      var $childContext$$3$$ = $bindingContext$$5$$.createChildContext($params$$14$$.row, null, function($binding$$3$$) {
        $binding$$3$$.$rowContext = $params$$14$$.rowContext;
      });
      $ko$$1$$.renderTemplate($template$$6$$, $childContext$$3$$, null, $params$$14$$.rowContext.parentElement, "replaceNode");
    };
  }
  function $_getDiagramNodeRenderer$$($bindingContext$$6$$, $template$$7$$) {
    return function($context$$46$$) {
      var $model$$56$$ = $bindingContext$$6$$.createChildContext($context$$46$$.data);
      $ko$$1$$.renderTemplate($template$$7$$, $model$$56$$, null, $context$$46$$.parentElement);
      return null;
    };
  }
  function $_getListViewItemRenderer$$($bindingContext$$8$$, $template$$8$$) {
    return function($context$$47$$) {
      var $parent$$6$$, $childContext$$4$$;
      $parent$$6$$ = $context$$47$$.parentElement;
      $childContext$$4$$ = $bindingContext$$8$$.createChildContext($context$$47$$.data, null, function($binding$$4$$) {
        $binding$$4$$.$itemContext = $context$$47$$;
      });
      $ko$$1$$.renderTemplate($template$$8$$, $childContext$$4$$, null, $parent$$6$$, "replaceNode");
      return null;
    };
  }
  function $_handleListViewManagedAttributes$$($name$$82_template$$9$$, $value$$150$$, $bindingContext$$9$$) {
    return "item" == $name$$82_template$$9$$ ? ($name$$82_template$$9$$ = $value$$150$$.template, null != $name$$82_template$$9$$ && ($value$$150$$.renderer = $_getListViewItemRenderer$$($bindingContext$$9$$, $name$$82_template$$9$$)), {item:$value$$150$$}) : null;
  }
  ...
  $oj$$7$$.$ComponentBinding$.prototype._init = function $$oj$$7$$$$ComponentBinding$$$_init$($element$$41$$, $valueAccessor$$, $allBindingsAccessor$$, $viewModel$$1$$, $bindingContext$$10$$) {
    $ko$$1$$.applyBindingsToDescendants($bindingContext$$10$$, $element$$41$$);
    $$$$7$$($element$$41$$).data($oj$$7$$.$ComponentBinding$.$_NEEDS_JUIB_INIT$, !0);
    return{controlsDescendantBindings:!0};
  };
  $oj$$7$$.$ComponentBinding$.prototype.$_update$ = function $$oj$$7$$$$ComponentBinding$$$$_update$$($element$$42$$, $valueAccessor$$1$$, $allBindingsAccessor$$1$$, $jelem$$4_viewModel$$2$$, $bindingContext$$11$$) {
    $jelem$$4_viewModel$$2$$ = $$$$7$$($element$$42$$);
    $jelem$$4_viewModel$$2$$.data($oj$$7$$.$ComponentBinding$.$_NEEDS_JUIB_INIT$) && ($jelem$$4_viewModel$$2$$.removeData($oj$$7$$.$ComponentBinding$.$_NEEDS_JUIB_INIT$), this.$_initComponent$($element$$42$$, $jelem$$4_viewModel$$2$$, $valueAccessor$$1$$, $allBindingsAccessor$$1$$, $bindingContext$$11$$));
  };
  $oj$$7$$.$ComponentBinding$.prototype.$_initComponent$ = function $$oj$$7$$$$ComponentBinding$$$$_initComponent$$($element$$43$$, $jelem$$5$$, $valueAccessor$$2$$, $allBindingsAccessor$$2$$, $bindingContext$$12$$) {
    var $options$$212$$ = $valueAccessor$$2$$(), $roleAttrName$$ = null, $disposed$$ = !1, $registeredListers$$ = [], $tracker$$3$$ = null, $comp$$2$$ = null, $roleListener$$ = null, $bindingMap$$ = $oj$$7$$.$ComponentBinding$.$_getBindingValueMap$(this.$_bindingNames$, $element$$43$$, $bindingContext$$12$$), $managedAttrMap$$ = {}, $specifiedManagedAttrs$$ = {}, $binding$$5$$ = this, $stage$$ = 0, $attributeEvaluatorCache$$ = {}, $componentName$$1$$ = this.$_bindingOptions$.componentName;
    if (null == $componentName$$1$$) {
      ...
      $roleListener$$ = $ko$$1$$.computed(function() {
        ...
        0 == $stage$$ ? $componentName$$1$$ = $ko$$1$$.utils.unwrapObservable($role$$) : ($bindingMap$$ = null, $comp$$2$$ ? $comp$$2$$("destroy") : ($roleListener$$.dispose(), $roleListener$$ = null), this.$_initComponent$($element$$43$$, $jelem$$5$$, $valueAccessor$$2$$, $allBindingsAccessor$$2$$, $bindingContext$$12$$));
        return null;
    ...
    if (null != $componentName$$1$$) {
      if ($comp$$2$$ = $jelem$$5$$[$componentName$$1$$], "function" === typeof $comp$$2$$) {
        ...
        $jelem$$5$$.on("ojdestroy" + $oj$$7$$.$ComponentBinding$.$_HANDLER_NAMESPACE$, function($destroyCallback_evt$$18_l$$2$$) {
          if ($destroyCallback_evt$$18_l$$2$$.target && $destroyCallback_evt$$18_l$$2$$.target == $element$$43$$) {
            ($destroyCallback_evt$$18_l$$2$$ = $binding$$5$$.$_bindingOptions$.beforeDestroy) && $destroyCallback_evt$$18_l$$2$$($element$$43$$, $comp$$2$$, $valueAccessor$$2$$, $allBindingsAccessor$$2$$, $bindingContext$$12$$);
            $oj$$7$$.$ComponentBinding$.$_deliverCreateDestroyEventToManagedProps$(!1, $specifiedManagedAttrs$$, $element$$43$$, $comp$$2$$, $valueAccessor$$2$$, $allBindingsAccessor$$2$$, $bindingContext$$12$$);
            $disposed$$ = !0;
        ...
        for (var $propertyMap$$ = {}, $tracker$$3$$ = new $ComponentChangeTracker$$($comp$$2$$, $element$$43$$, $oj$$7$$.$ComponentBinding$.$_changeQueue$), $defaultInstance_defaultManagedMap_mutationOptions_writablePropMap$$ = {"^slider$":[{event:"slidechange", getter:$_extractValueFromChangeEvent$$}], "^oj*":[{event:"ojoptionchange", getter:$_extractOptionChange$$}]}, $handler$$46$$ = function $$handler$$46$$$() {
          ...
          if (0 === $stage$$) {
            ...
            null != $initFunc_k$$5_managedPropEntry_updateFunc$$ ? ($specifiedManagedAttrs$$[$initProps_prop$$57_updateProps$$] = $initFunc_k$$5_managedPropEntry_updateFunc$$, $initFunc_k$$5_managedPropEntry_updateFunc$$ = $initFunc_k$$5_managedPropEntry_updateFunc$$.$init$, null != $initFunc_k$$5_managedPropEntry_updateFunc$$ && ($initProps_prop$$57_updateProps$$ = $initFunc_k$$5_managedPropEntry_updateFunc$$($initProps_prop$$57_updateProps$$, $currentVal_exp$$1_updateKeys_v_value$$151$$, $element$$43$$, 
            ...
            if (!$disposed$$) {
              if ($currentVal_exp$$1_updateKeys_v_value$$151$$ = $oj$$7$$.$ComponentBinding$.$_toJS$($currentVal_exp$$1_updateKeys_v_value$$151$$), null != $managedAttrMap$$[$initProps_prop$$57_updateProps$$]) {
                if ($initFunc_k$$5_managedPropEntry_updateFunc$$ = $managedAttrMap$$[$initProps_prop$$57_updateProps$$].update, null != $initFunc_k$$5_managedPropEntry_updateFunc$$) {
                  for ($initProps_prop$$57_updateProps$$ = $initFunc_k$$5_managedPropEntry_updateFunc$$($initProps_prop$$57_updateProps$$, $currentVal_exp$$1_updateKeys_v_value$$151$$, $element$$43$$, $comp$$2$$, $valueAccessor$$2$$, $allBindingsAccessor$$2$$, $bindingContext$$12$$) || {}, $currentVal_exp$$1_updateKeys_v_value$$151$$ = Object.keys($initProps_prop$$57_updateProps$$), $initFunc_k$$5_managedPropEntry_updateFunc$$ = 0;$initFunc_k$$5_managedPropEntry_updateFunc$$ < $currentVal_exp$$1_updateKeys_v_value$$151$$.length;$initFunc_k$$5_managedPropEntry_updateFunc$$++) {
          ...
          $p$$3$$ = $optionKeys$$[$k$$4$$], $p$$3$$ !== $roleAttrName$$ && $registeredListers$$.push($ko$$1$$.computed($handler$$46$$, {$_property$:$p$$3$$}, {disposeWhenNodeIsRemoved:$element$$43$$}));
        }
        ...
        ($createCallback_mo$$ = this.$_bindingOptions$.afterCreate) && $createCallback_mo$$($element$$43$$, $comp$$2$$, $valueAccessor$$2$$, $allBindingsAccessor$$2$$, $bindingContext$$12$$);
        $oj$$7$$.$ComponentBinding$.$_deliverCreateDestroyEventToManagedProps$(!0, $specifiedManagedAttrs$$, $element$$43$$, $comp$$2$$, $valueAccessor$$2$$, $allBindingsAccessor$$2$$, $bindingContext$$12$$);
        $propertyMap$$ = null;
      } else {
  ...
  $oj$$7$$.$ComponentBinding$.$_getBindingValueMap$ = function $$oj$$7$$$$ComponentBinding$$$_getBindingValueMap$$($n$$20_names$$3$$, $elem$$18_keyValueArray$$, $bindingContext$$13_i$$127_key$$41$$) {
    ...
    var $map$$ = {}, $bindingValue_keyValueEntry_provider$$ = null, $bindingValue_keyValueEntry_provider$$ = $ko$$1$$.bindingProvider.instance, $e$$48_selfVal$$;
    $e$$48_selfVal$$ = null;
    ...
    for ($bindingContext$$13_i$$127_key$$41$$ = 0;$bindingContext$$13_i$$127_key$$41$$ < $elem$$18_keyValueArray$$.length;$bindingContext$$13_i$$127_key$$41$$++) {
      ...
      if (0 <= $n$$20_names$$3$$.indexOf($bindingKey$$)) {
        $e$$48_selfVal$$ = $bindingValue_keyValueEntry_provider$$.value;
        break;
      }
    }
    if (!$e$$48_selfVal$$) {
    ...
    $elem$$18_keyValueArray$$ = $ko$$1$$.jsonExpressionRewriting.parseObjectLiteral($e$$48_selfVal$$);
    for ($n$$20_names$$3$$ = 0;$n$$20_names$$3$$ < $elem$$18_keyValueArray$$.length;$n$$20_names$$3$$++) {
      $e$$48_selfVal$$ = $elem$$18_keyValueArray$$[$n$$20_names$$3$$], $bindingContext$$13_i$$127_key$$41$$ = $e$$48_selfVal$$.key, null != $bindingContext$$13_i$$127_key$$41$$ && ($map$$[$trim$$($bindingContext$$13_i$$127_key$$41$$)] = $trim$$($e$$48_selfVal$$.value));
    }
    return $map$$;
  };
  ...
  $oj$$7$$.$ComponentBinding$.$_deliverCreateDestroyEventToManagedProps$ = function $$oj$$7$$$$ComponentBinding$$$_deliverCreateDestroyEventToManagedProps$$($isCreate$$, $managedAttrMap$$2$$, $element$$44$$, $comp$$3$$, $valueAccessor$$3$$, $allBindingsAccessor$$3$$, $bindingContext$$17$$) {
    for (var $props$$7$$ = Object.keys($managedAttrMap$$2$$), $i$$130$$ = 0;$i$$130$$ < $props$$7$$.length;$i$$130$$++) {
      ...
      ($callback$$85_entry$$ = $isCreate$$ ? $callback$$85_entry$$.$afterCreate$ : $callback$$85_entry$$.$beforeDestroy$) && $callback$$85_entry$$($prop$$59$$, $element$$44$$, $comp$$3$$, $valueAccessor$$3$$, $allBindingsAccessor$$3$$, $bindingContext$$17$$);
    }
  };
  ...
  $ComponentChangeTracker$$.prototype.Init = function $$ComponentChangeTracker$$$$Init$($component$$7$$, $element$$45$$, $queue$$1$$) {
    $ComponentChangeTracker$$.$superclass$.Init.call(this);
    this.$_component$ = $component$$7$$;
    this.$_element$ = $element$$45$$;
    this.$_queue$ = $queue$$1$$;
    this.$_changes$ = {};
  ...
  $ComponentChangeTracker$$.prototype.$applyChanges$ = function $$ComponentChangeTracker$$$$$applyChanges$$($changes$$1$$) {
    if (null != $oj$$7$$.Components.$getWidgetConstructor$(this.$_element$)) {
      var $mutationOptions$$2$$ = $oj$$7$$.$ComponentBinding$.$_extractDotNotationOptions$($changes$$1$$), $flags$$14$$ = {changed:!0};
      this.$_component$("option", $changes$$1$$, $flags$$14$$);
      for (var $mo$$2$$ in $mutationOptions$$2$$) {
        this.$_component$("option", $mo$$2$$, $mutationOptions$$2$$[$mo$$2$$], $flags$$14$$);
      }
    }
  };
  ...
  $oj$$7$$.$koStringTemplateEngine$.$install$ = function $$oj$$7$$$$koStringTemplateEngine$$$install$$() {
    if (!$ko$$1$$.templates) {
      var $_templateText$$ = {}, $_templateData$$ = {}, $_engine$$ = new $ko$$1$$.nativeTemplateEngine, $StringTemplate$$ = function $$StringTemplate$$$($template$$10$$) {
        ...
        this.text = function $this$text$($value$$154$$) {
          if (!$value$$154$$) {
            return $_templateText$$[this.$_templateName$];
          }
          $_templateText$$[this.$_templateName$] = $value$$154$$;
        };
        this.data = function $this$data$($key$$43$$, $value$$155$$) {
          $_templateData$$[this.$_templateName$] || ($_templateData$$[this.$_templateName$] = {});
          if (1 === arguments.length) {
            return $_templateData$$[this.$_templateName$][$key$$43$$];
          }
          $_templateData$$[this.$_templateName$][$key$$43$$] = $value$$155$$;
        };
      };
  ...
  $oj$$7$$.$ComponentBinding$.$getDefaultInstance$().$setupManagedAttributes$({attributes:["header", "cell"], init:function($cellTemplate_column_name$$89_row$$, $value$$156$$, $columnTemplate_element$$46_rowTemplate$$, $widgetConstructor$$, $valueAccessor$$4$$, $allBindingsAccessor$$4$$, $bindingContext$$18$$) {
    if ("header" === $cellTemplate_column_name$$89_row$$) {
      return $cellTemplate_column_name$$89_row$$ = $value$$156$$.row, null != $cellTemplate_column_name$$89_row$$ && ($columnTemplate_element$$46_rowTemplate$$ = $cellTemplate_column_name$$89_row$$.template, null != $columnTemplate_element$$46_rowTemplate$$ && ($cellTemplate_column_name$$89_row$$.renderer = $_getDataGridHeaderRenderer$$($bindingContext$$18$$, $columnTemplate_element$$46_rowTemplate$$))), $cellTemplate_column_name$$89_row$$ = $value$$156$$.column, null != $cellTemplate_column_name$$89_row$$ && 
      ($columnTemplate_element$$46_rowTemplate$$ = $cellTemplate_column_name$$89_row$$.template, null != $columnTemplate_element$$46_rowTemplate$$ && ($cellTemplate_column_name$$89_row$$.renderer = $_getDataGridHeaderRenderer$$($bindingContext$$18$$, $columnTemplate_element$$46_rowTemplate$$))), {header:$value$$156$$};
    }
    if ("cell" === $cellTemplate_column_name$$89_row$$) {
      return $cellTemplate_column_name$$89_row$$ = $value$$156$$.template, null != $cellTemplate_column_name$$89_row$$ && ($value$$156$$.renderer = $_getDataGridCellRenderer$$($bindingContext$$18$$, $cellTemplate_column_name$$89_row$$)), {cell:$value$$156$$};
    }
  }, update:function($cellTemplate$$1_column$$1_name$$90_row$$1$$, $value$$157$$, $columnTemplate$$1_element$$47_rowTemplate$$1$$, $widgetConstructor$$1$$, $valueAccessor$$5$$, $allBindingsAccessor$$5$$, $bindingContext$$19$$) {
    return "header" === $cellTemplate$$1_column$$1_name$$90_row$$1$$ ? ($cellTemplate$$1_column$$1_name$$90_row$$1$$ = $value$$157$$.row, null != $cellTemplate$$1_column$$1_name$$90_row$$1$$ && ($columnTemplate$$1_element$$47_rowTemplate$$1$$ = $cellTemplate$$1_column$$1_name$$90_row$$1$$.template, null != $columnTemplate$$1_element$$47_rowTemplate$$1$$ && ($cellTemplate$$1_column$$1_name$$90_row$$1$$.renderer = $_getDataGridHeaderRenderer$$($bindingContext$$19$$, $columnTemplate$$1_element$$47_rowTemplate$$1$$))), 
    $cellTemplate$$1_column$$1_name$$90_row$$1$$ = $value$$157$$.column, null != $cellTemplate$$1_column$$1_name$$90_row$$1$$ && ($columnTemplate$$1_element$$47_rowTemplate$$1$$ = $cellTemplate$$1_column$$1_name$$90_row$$1$$.template, null != $columnTemplate$$1_element$$47_rowTemplate$$1$$ && ($cellTemplate$$1_column$$1_name$$90_row$$1$$.renderer = $_getDataGridHeaderRenderer$$($bindingContext$$19$$, $columnTemplate$$1_element$$47_rowTemplate$$1$$))), {header:$value$$157$$}) : "cell" === $cellTemplate$$1_column$$1_name$$90_row$$1$$ ? 
    ($cellTemplate$$1_column$$1_name$$90_row$$1$$ = $value$$157$$.template, null != $cellTemplate$$1_column$$1_name$$90_row$$1$$ && ($value$$157$$.renderer = $_getDataGridCellRenderer$$($bindingContext$$19$$, $cellTemplate$$1_column$$1_name$$90_row$$1$$)), {cell:$value$$157$$}) : null;
  }, "for":"ojDataGrid"});
  $ko$$1$$.bindingHandlers.ojContextMenu = {update:function $$ko$$1$$$bindingHandlers$ojContextMenu$update$($element$$48$$, $valueAccessor$$6$$) {
    function $launch$$1$$($event$$58$$, $eventType$$29_openOptions$$1$$, $pressHold$$1$$) {
      ...
      "touchstart" === $doubleOpenType$$1$$ && "contextmenu" === $event$$58$$.type || "contextmenu" === $doubleOpenType$$1$$ && "touchstart" === $event$$58$$.type ? ($doubleOpenType$$1$$ = null, clearTimeout($doubleOpenTimer$$1$$)) : !$event$$58$$.isDefaultPrevented() && ($eventType$$29_openOptions$$1$$ = {launcher:$$element$$, initialFocus:"menu", position:{mouse:{my:"start top", at:"start bottom", of:$event$$58$$}, touch:{my:"start\x3e40 center", at:"start bottom", of:$event$$58$$, collision:"flipfit"}, 
      keyboard:{my:"start top", at:"start bottom", of:"launcher"}}[$eventType$$29_openOptions$$1$$]}, $menu$$3$$.$__openingContextMenu$ = !0, $menu$$3$$.open($event$$58$$, $eventType$$29_openOptions$$1$$), $menu$$3$$.$__openingContextMenu$ = !1, $getContextMenuNode$$().is(":visible") && ($event$$58$$.preventDefault(), document.addEventListener("keyup", $preventKeyUpEventIfMenuOpen$$), "touchstart" === $event$$58$$.type || "contextmenu" === $event$$58$$.type)) && ($doubleOpenType$$1$$ = $event$$58$$.type, 
      $doubleOpenTimer$$1$$ = setTimeout(function() {
        $doubleOpenType$$1$$ = null;
      }, 300));
    }
    function $preventKeyUpEventIfMenuOpen$$($event$$57$$) {
      121 == $event$$57$$.which && $event$$57$$.shiftKey && $getContextMenuNode$$().is(":visible") && $event$$57$$.preventDefault();
    }
    ...
    $$menu$$ = $_menu$$ = void 0;
    var $menuSelector$$ = $ko$$1$$.utils.unwrapObservable($valueAccessor$$6$$());
    "string" !== $$$$7$$.type($menuSelector$$) && ($menuSelector$$ = $element$$48$$.getAttribute("contextmenu")) && ($menuSelector$$ = "#" + $menuSelector$$);
    $clickListener$$ = function $$clickListener$$$($event$$60$$) {
      if ($isPressHold$$1$$) {
        return $event$$60$$.preventDefault(), $event$$60$$.stopPropagation(), $isPressHold$$1$$ = !1;
      }
    };
    $element$$48$$.addEventListener("click", $clickListener$$, !0);
    $$element$$.on("touchstart.ojContextMenu mousedown.ojContextMenu keydown.ojContextMenu ", function($event$$61$$) {
      if ("mousedown" !== $event$$61$$.type || !$getContextMenu$$().$__contextMenuPressHoldJustEnded$()) {
        return $isPressHold$$1$$ = !1, "touchstart" === $event$$61$$.type && ($touchInProgress$$1$$ = !0, $pressHoldTimer$$ = setTimeout($launch$$1$$.bind(void 0, $event$$61$$, "touch", !0), 750)), !0;
      }
    }).on("touchend.ojContextMenu touchcancel.ojContextMenu", function() {
      $touchInProgress$$1$$ = !1;
      clearTimeout($pressHoldTimer$$);
      return!0;
    }).on("keydown.ojContextMenu contextmenu.ojContextMenu", function($event$$63$$) {
      ("contextmenu" === $event$$63$$.type || 121 == $event$$63$$.which && $event$$63$$.shiftKey) && $launch$$1$$($event$$63$$, $touchInProgress$$1$$ ? "touch" : "keydown" === $event$$63$$.type ? "keyboard" : "mouse", !1);
      return!0;
    }).addClass("oj-menu-context-menu-launcher");
  }};
  $oj$$7$$.$ComponentBinding$.$getDefaultInstance$().$setupManagedAttributes$({attributes:["areaLayers", "pointDataLayers"], init:function($name$$91$$, $value$$158$$, $element$$49$$, $widgetConstructor$$2$$, $valueAccessor$$7$$, $allBindingsAccessor$$6$$, $bindingContext$$21$$) {
    return $_handleManagedAttributes$$($name$$91$$, $value$$158$$, $bindingContext$$21$$);
  }, update:function($name$$92$$, $value$$159$$, $element$$50$$, $widgetConstructor$$3$$, $valueAccessor$$8$$, $allBindingsAccessor$$7$$, $bindingContext$$22$$) {
    return $_handleManagedAttributes$$($name$$92$$, $value$$159$$, $bindingContext$$22$$);
  }, "for":"ojThematicMap"});
  $oj$$7$$.$ComponentBinding$.$getDefaultInstance$().$setupManagedAttributes$({attributes:["columns", "columnsDefault", "rowTemplate"], init:function($name$$93$$, $value$$160$$, $element$$51_i$$132$$, $template$$12_widgetConstructor$$4$$, $footerTemplate_valueAccessor$$9$$, $allBindingsAccessor$$8_headerTemplate$$, $bindingContext$$23$$) {
    if ("columns" == $name$$93$$ || "columnsDefault" == $name$$93$$) {
      for ($element$$51_i$$132$$ = 0;$element$$51_i$$132$$ < $value$$160$$.length;$element$$51_i$$132$$++) {
        var $column$$2$$ = $value$$160$$[$element$$51_i$$132$$];
        $template$$12_widgetConstructor$$4$$ = $column$$2$$.template;
        $footerTemplate_valueAccessor$$9$$ = $column$$2$$.footerTemplate;
        $allBindingsAccessor$$8_headerTemplate$$ = $column$$2$$.headerTemplate;
        null != $template$$12_widgetConstructor$$4$$ && ($column$$2$$.renderer = $_getTableColumnTemplateRenderer$$($bindingContext$$23$$, "cell", $template$$12_widgetConstructor$$4$$));
        null != $footerTemplate_valueAccessor$$9$$ && ($column$$2$$.footerRenderer = $_getTableColumnTemplateRenderer$$($bindingContext$$23$$, "footer", $footerTemplate_valueAccessor$$9$$));
        null != $allBindingsAccessor$$8_headerTemplate$$ && ($column$$2$$.headerRenderer = $_getTableColumnTemplateRenderer$$($bindingContext$$23$$, "header", $allBindingsAccessor$$8_headerTemplate$$));
      }
      return "columns" == $name$$93$$ ? {columns:$value$$160$$} : {columnsDefault:$value$$160$$};
    }
    if ("rowTemplate" == $name$$93$$) {
      return{rowRenderer:$_getTableRowTemplateRenderer$$($bindingContext$$23$$, $value$$160$$)};
    }
  }, update:function($name$$94$$, $value$$161$$, $element$$52_i$$133$$, $widgetConstructor$$5$$, $template$$13_valueAccessor$$10$$, $allBindingsAccessor$$9_footerTemplate$$1$$, $bindingContext$$24$$) {
    if ("columns" == $name$$94$$ || "columnsDefault" == $name$$94$$) {
      var $headerTemplate$$1$$;
      for ($element$$52_i$$133$$ = 0;$element$$52_i$$133$$ < $value$$161$$.length;$element$$52_i$$133$$++) {
        var $column$$3$$ = $value$$161$$[$element$$52_i$$133$$];
        $template$$13_valueAccessor$$10$$ = $column$$3$$.template;
        $allBindingsAccessor$$9_footerTemplate$$1$$ = $column$$3$$.footerTemplate;
        $headerTemplate$$1$$ = $column$$3$$.headerTemplate;
        null != $template$$13_valueAccessor$$10$$ && ($column$$3$$.renderer = $_getTableColumnTemplateRenderer$$($bindingContext$$24$$, "cell", $template$$13_valueAccessor$$10$$));
        null != $allBindingsAccessor$$9_footerTemplate$$1$$ && ($column$$3$$.footerRenderer = $_getTableColumnTemplateRenderer$$($bindingContext$$24$$, "footer", $allBindingsAccessor$$9_footerTemplate$$1$$));
        null != $headerTemplate$$1$$ && ($column$$3$$.headerRenderer = $_getTableColumnTemplateRenderer$$($bindingContext$$24$$, "header", $headerTemplate$$1$$));
      }
      "columns" == $name$$94$$ ? $widgetConstructor$$5$$({columns:$value$$161$$}) : $widgetConstructor$$5$$({columnsDefault:$value$$161$$});
    } else {
      if ("rowTemplate" == $name$$94$$) {
        return{rowRenderer:$_getTableRowTemplateRenderer$$($bindingContext$$24$$, $value$$161$$)};
      }
    }
    return null;
  }, "for":"ojTable"});
  ...
  $oj$$7$$.$ComponentBinding$.$getDefaultInstance$().$setupManagedAttributes$({attributes:["template"], init:function($name$$95$$, $value$$162$$, $element$$53$$, $widgetConstructor$$6$$, $valueAccessor$$11$$, $allBindingsAccessor$$10$$, $bindingContext$$25$$) {
    return "template" === $name$$95$$ ? {_templateFunction:$_getDiagramNodeRenderer$$($bindingContext$$25$$, $value$$162$$)} : null;
  }, update:function($name$$96$$, $value$$163$$, $element$$54$$, $widgetConstructor$$7$$, $valueAccessor$$12$$, $allBindingsAccessor$$11$$, $bindingContext$$26$$) {
    return "template" === $name$$96$$ ? {_templateFunction:$_getDiagramNodeRenderer$$($bindingContext$$26$$, $value$$163$$)} : null;
  }, "for":"ojDiagram"});
  $oj$$7$$.$ComponentBinding$.$getDefaultInstance$().$setupManagedAttributes$({attributes:["item"], init:function($name$$97_result$$16$$, $value$$164$$, $element$$55$$, $widgetConstructor$$8$$, $valueAccessor$$13$$, $allBindingsAccessor$$12$$, $bindingContext$$27$$) {
    $name$$97_result$$16$$ = $_handleListViewManagedAttributes$$($name$$97_result$$16$$, $value$$164$$, $bindingContext$$27$$);
    if (null != $name$$97_result$$16$$) {
      return $name$$97_result$$16$$;
    }
  }, update:function($name$$98$$, $value$$165$$, $element$$56$$, $widgetConstructor$$9$$, $valueAccessor$$14$$, $allBindingsAccessor$$13$$, $bindingContext$$28$$) {
    return $_handleListViewManagedAttributes$$($name$$98$$, $value$$165$$, $bindingContext$$28$$);
