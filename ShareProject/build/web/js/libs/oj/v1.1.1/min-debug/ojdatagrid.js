...
define(["ojs/ojcore", "jquery", "ojs/internal-deps/datagrid/DvtDataGrid", "ojs/ojcomponentcore", "ojs/ojdatacollection-common", "ojs/ojinputnumber", "ojs/ojmenu", "ojs/ojdialog", "ojs/ojpagingcontrol"], function($oj$$11$$, $$$$11$$, $DvtDataGrid$$1$$) {
  $oj$$11$$.$ArrayDataGridDataSource$ = function $$oj$$11$$$$ArrayDataGridDataSource$$($data$$79$$, $options$$257$$) {
    if (!($data$$79$$ instanceof Array) && "function" != typeof $data$$79$$ && "function" != typeof $data$$79$$.$subscribe$) {
    ...
    $oj$$11$$.$ArrayDataGridDataSource$.$superclass$.constructor.call(this, $data$$79$$);
  };
  ...
  $oj$$11$$.$ArrayDataGridDataSource$.prototype.$_initializeRowKeys$ = function $$oj$$11$$$$ArrayDataGridDataSource$$$$_initializeRowKeys$$() {
    var $data$$80$$;
    $data$$80$$ = this.$getDataArray$();
    for (this.$lastKey$ = 0;this.$lastKey$ < $data$$80$$.length;this.$lastKey$ += 1) {
      $data$$80$$[this.$lastKey$].ojKey = this.$lastKey$.toString();
    }
  };
  $oj$$11$$.$ArrayDataGridDataSource$.prototype.$_getColumnsForScaffolding$ = function $$oj$$11$$$$ArrayDataGridDataSource$$$$_getColumnsForScaffolding$$($data$$81$$) {
    var $propertyName$$8$$, $columns$$;
    if ("number" !== typeof $data$$81$$.length || 0 === $data$$81$$.length) {
      return[];
    }
    $columns$$ = [];
    for ($propertyName$$8$$ in $data$$81$$[0]) {
      $data$$81$$[0].hasOwnProperty($propertyName$$8$$) && (void 0 != this.$rowHeaderKey$ && $propertyName$$8$$ == this.$rowHeaderKey$ || $columns$$.push($propertyName$$8$$));
    }
    return $columns$$;
  };
  ...
  $oj$$11$$.$ArrayDataGridDataSource$.prototype.$_getHeaderData$ = function $$oj$$11$$$$ArrayDataGridDataSource$$$$_getHeaderData$$($axis$$3$$, $index$$110$$) {
    var $data$$82$$;
    if ("row" === $axis$$3$$) {
      return $data$$82$$ = this.$getDataArray$(), void 0 != this.$rowHeaderKey$ ? $data$$82$$[$index$$110$$][this.$rowHeaderKey$] : 0 < $data$$82$$.length && $data$$82$$[0] instanceof Array ? void 0 === this.$_getRowKeyByIndex$($index$$110$$) ? $index$$110$$.toString() : this.$_getRowKeyByIndex$($index$$110$$) : null;
    }
    if ("column" === $axis$$3$$) {
  ...
  $oj$$11$$.$ArrayDataGridDataSource$.prototype.$fetchHeaders$ = function $$oj$$11$$$$ArrayDataGridDataSource$$$$fetchHeaders$$($headerRange$$1$$, $callbacks$$16$$, $callbackObjects$$4$$) {
    var $axis$$5_headerSet$$, $start$$27$$, $count$$28_end$$8$$, $data$$83$$;
    ...
    "column" === $axis$$5_headerSet$$ ? $count$$28_end$$8$$ = Math.min(this.columns.length, $start$$27$$ + $count$$28_end$$8$$) : ($data$$83$$ = this.$getDataArray$(), $count$$28_end$$8$$ = void 0 !== this.$rowHeaderKey$ || 0 < $data$$83$$.length && $data$$83$$[0] instanceof Array ? Math.min($data$$83$$.length, $start$$27$$ + $count$$28_end$$8$$) : $start$$27$$);
  ...
  $oj$$11$$.$ArrayDataGridDataSource$.prototype.$fetchCells$ = function $$oj$$11$$$$ArrayDataGridDataSource$$$$fetchCells$$($cellRanges$$, $callbacks$$17$$, $callbackObjects$$5$$) {
    var $cellSet_i$$164$$, $cellRange$$1$$, $rowStart$$, $rowEnd$$, $colStart$$, $colEnd$$;
    for ($cellSet_i$$164$$ = 0;$cellSet_i$$164$$ < $cellRanges$$.length;$cellSet_i$$164$$ += 1) {
  ...
  $oj$$11$$.$ArrayDataGridDataSource$.prototype.keys = function $$oj$$11$$$$ArrayDataGridDataSource$$$keys$($indexes$$1$$) {
    ...
    return new Promise(function($resolve$$37$$) {
      $resolve$$37$$({row:this.$_getRowKeyByIndex$($rowIndex$$), column:this.columns[$columnIndex$$]});
    }.bind(this));
  };
  ...
  $oj$$11$$.$ArrayDataGridDataSource$.prototype.$indexes$ = function $$oj$$11$$$$ArrayDataGridDataSource$$$$indexes$$($keys$$9$$) {
    ...
    return new Promise(function($resolve$$38$$) {
      $resolve$$38$$({row:this.$_getRowIndexByKey$($rowKey$$), column:this.columns.indexOf($columnKey$$)});
    }.bind(this));
  };
  ...
  $oj$$11$$.$ArrayDataGridDataSource$.prototype.sort = function $$oj$$11$$$$ArrayDataGridDataSource$$$sort$($criteria$$9_direction$$7$$, $callbacks$$18$$, $callbackObjects$$6$$) {
    var $sortArray$$ = [], $newColumns$$ = [], $axis$$6_i$$165$$, $headerIndex_headerKey$$;
    ...
    if (null == $criteria$$9_direction$$7$$) {
      ...
      if ($axis$$6_i$$165$$ = $criteria$$9_direction$$7$$.axis, $headerIndex_headerKey$$ = $criteria$$9_direction$$7$$.key, $criteria$$9_direction$$7$$ = $criteria$$9_direction$$7$$.direction, "column" === $axis$$6_i$$165$$) {
        ...
        if ("row" === $axis$$6_i$$165$$) {
          ...
          for ($axis$$6_i$$165$$ = 0;$axis$$6_i$$165$$ < this.columns.length;$axis$$6_i$$165$$ += 1) {
            $sortArray$$[$axis$$6_i$$165$$] = this.$getDataArray$()[$headerIndex_headerKey$$][this.columns[$axis$$6_i$$165$$]];
          }
          $sortArray$$.sort(this.$_naturalSort$($criteria$$9_direction$$7$$));
          for ($axis$$6_i$$165$$ = 0;$axis$$6_i$$165$$ < this.columns.length;$axis$$6_i$$165$$ += 1) {
            $newColumns$$[$axis$$6_i$$165$$] = this.columns[$sortArray$$.indexOf(this.$getDataArray$()[$headerIndex_headerKey$$][this.columns[$axis$$6_i$$165$$]])];
          }
  ...
  $oj$$11$$.$ArrayDataGridDataSource$.prototype.move = function $$oj$$11$$$$ArrayDataGridDataSource$$$move$($moveKey$$, $atKey$$) {
    var $event$$113_moveKeyIndex$$, $moveData$$, $atKeyIndex$$;
    $event$$113_moveKeyIndex$$ = this.$_getRowIndexByKey$($moveKey$$);
    $moveData$$ = this.data.splice($event$$113_moveKeyIndex$$, 1)[0];
    this.data instanceof Array && ($event$$113_moveKeyIndex$$ = this.$_getModelEvent$("delete", $moveKey$$, null, $event$$113_moveKeyIndex$$, -1, !0), this.handleEvent("change", $event$$113_moveKeyIndex$$));
    null === $atKey$$ ? this.data.push($moveData$$) : ($atKeyIndex$$ = this.$_getRowIndexByKey$($atKey$$), this.data.splice($atKeyIndex$$, 0, $moveData$$));
    this.data instanceof Array && ($event$$113_moveKeyIndex$$ = this.$_getModelEvent$("insert", $moveKey$$, null, $atKeyIndex$$, -1), this.handleEvent("change", $event$$113_moveKeyIndex$$));
  ...
  $oj$$11$$.$ArrayDataGridDataSource$.prototype.$_getRowIndexByKey$ = function $$oj$$11$$$$ArrayDataGridDataSource$$$$_getRowIndexByKey$$($key$$57$$) {
    var $i$$166$$, $data$$85$$ = this.$getDataArray$();
    for ($i$$166$$ = 0;$i$$166$$ < $data$$85$$.length;$i$$166$$++) {
      if ($data$$85$$[$i$$166$$].ojKey === $key$$57$$) {
        return $i$$166$$;
      }
    }
    return-1;
  ...
  $oj$$11$$.$ArrayDataGridDataSource$.prototype.$_getRowKeyByIndex$ = function $$oj$$11$$$$ArrayDataGridDataSource$$$$_getRowKeyByIndex$$($index$$112$$) {
    var $data$$86$$ = this.$getDataArray$();
    return $data$$86$$[$index$$112$$] ? $data$$86$$[$index$$112$$].ojKey : null;
  };
  $oj$$11$$.$ArrayDataGridDataSource$.prototype.$_getModelEvent$ = function $$oj$$11$$$$ArrayDataGridDataSource$$$$_getModelEvent$$($operation$$3$$, $rowKey$$1$$, $columnKey$$1$$, $rowIndex$$1$$, $columnIndex$$1$$, $silent$$26$$) {
    var $event$$114$$ = {source:this};
    $event$$114$$.operation = $operation$$3$$;
    $event$$114$$.keys = {row:$rowKey$$1$$, column:$columnKey$$1$$};
    $event$$114$$.indexes = {row:$rowIndex$$1$$, column:$columnIndex$$1$$};
    $event$$114$$.silent = $silent$$26$$;
    return $event$$114$$;
  };
  $oj$$11$$.$ArrayDataGridDataSource$.prototype.$_subscribe$ = function $$oj$$11$$$$ArrayDataGridDataSource$$$$_subscribe$$($changes$$4$$) {
    var $i$$167$$, $move_rowData_rowKey$$2$$, $change_event$$115_rowIndex$$2$$, $added$$1$$ = !1;
    $move_rowData_rowKey$$2$$ = !1;
    var $keys$$10$$ = [], $indexes$$2$$ = [];
    for ($i$$167$$ = 0;$i$$167$$ < $changes$$4$$.length;$i$$167$$++) {
      $change_event$$115_rowIndex$$2$$ = $changes$$4$$[$i$$167$$];
      if (void 0 !== $change_event$$115_rowIndex$$2$$.moved) {
        $move_rowData_rowKey$$2$$ = !0;
        $change_event$$115_rowIndex$$2$$ = this.$_getModelEvent$("refresh", null, null);
        this.handleEvent("change", $change_event$$115_rowIndex$$2$$);
        break;
      }
      "added" === $change_event$$115_rowIndex$$2$$.status && ($added$$1$$ = !0);
    }
    if (!$move_rowData_rowKey$$2$$) {
      for ($i$$167$$ = 0;$i$$167$$ < $changes$$4$$.length;$i$$167$$++) {
        $change_event$$115_rowIndex$$2$$ = $changes$$4$$[$i$$167$$], "deleted" === $change_event$$115_rowIndex$$2$$.status && ($move_rowData_rowKey$$2$$ = $change_event$$115_rowIndex$$2$$.value, $change_event$$115_rowIndex$$2$$ = $change_event$$115_rowIndex$$2$$.index, $move_rowData_rowKey$$2$$ = $move_rowData_rowKey$$2$$.ojKey, $keys$$10$$.push({row:$move_rowData_rowKey$$2$$, column:-1}), $indexes$$2$$.push({row:$change_event$$115_rowIndex$$2$$, column:-1}));
      }
      0 < $keys$$10$$.length && ($change_event$$115_rowIndex$$2$$ = {source:this, operation:"delete", keys:$keys$$10$$, indexes:$indexes$$2$$, silent:$added$$1$$}, this.handleEvent("change", $change_event$$115_rowIndex$$2$$));
      for ($i$$167$$ = 0;$i$$167$$ < $changes$$4$$.length;$i$$167$$++) {
        $change_event$$115_rowIndex$$2$$ = $changes$$4$$[$i$$167$$], "added" === $change_event$$115_rowIndex$$2$$.status && ($move_rowData_rowKey$$2$$ = $change_event$$115_rowIndex$$2$$.value, $change_event$$115_rowIndex$$2$$ = $change_event$$115_rowIndex$$2$$.index, null == $move_rowData_rowKey$$2$$.ojKey && ($move_rowData_rowKey$$2$$.ojKey = this.$lastKey$.toString(), this.$lastKey$++), $move_rowData_rowKey$$2$$ = $move_rowData_rowKey$$2$$.ojKey, $change_event$$115_rowIndex$$2$$ = this.$_getModelEvent$("insert", 
        $move_rowData_rowKey$$2$$, null, $change_event$$115_rowIndex$$2$$, -1), this.handleEvent("change", $change_event$$115_rowIndex$$2$$));
      }
    }
    null != this.$origData$ && (this.$origData$ = this.data.slice());
  };
  ...
  height:"disable"}, sortable:"auto", style:null}}, cell:{className:null, renderer:null, style:null}, resize:null, sort:null, optionChange:null}, _ComponentCreate:function() {
    ...
    this.$_unregisterResizeListener$(this.root);
    $$$$11$$(this.root).empty();
  }, _setOptions:function($options$$258$$, $flags$$15$$) {
    var $isRefresh$$;
    this.$datasource$ ? ($isRefresh$$ = this.$_shouldRefresh$($options$$258$$), this._super($options$$258$$, $flags$$15$$), $isRefresh$$ ? this.refresh() : this.grid.UpdateOptions($options$$258$$)) : (this._super($options$$258$$, $flags$$15$$), null != $options$$258$$.data && this.refresh());
    ...
    var $i$$168$$, $key$$62$$, $isRefresh$$1$$, $elm$$, $itm$$, $opt$$19$$;
    $isRefresh$$1$$ = !1;
            ...
            for ($elm$$ in $options$$259$$.header) {
              if ("column" == $elm$$ || "row" == $elm$$ || "cell" == $elm$$) {
                for ($itm$$ in $options$$259$$.header[$elm$$]) {
                  for ($i$$168$$ = 0;$i$$168$$ < this.$redrawSet$.header.length;$i$$168$$++) {
                    if ($itm$$ == this.$redrawSet$.header[$i$$168$$]) {
  ...
  }, $_handleContextMenuSelect$:function($event$$117$$, $ui$$3$$) {
  ...
  }, $_NotifyContextMenuGesture$:function($menu$$4$$, $event$$118$$, $eventType$$33$$) {
    this.grid.handleContextMenuGesture($event$$118$$, $eventType$$33$$, this.$_contextMenuGestureCallback$.bind(this));
  }, $_contextMenuGestureCallback$:function($capabilities_returnVal$$1$$, $event$$119$$, $eventType$$34$$) {
    var $launcher$$7_openOptions$$2$$;
    null != $capabilities_returnVal$$1$$ && (this.$contextMenuEvent$ = $event$$119$$.originalEvent, $launcher$$7_openOptions$$2$$ = $capabilities_returnVal$$1$$.launcher, $capabilities_returnVal$$1$$ = $capabilities_returnVal$$1$$.capabilities, this.$_manageContextMenu$($capabilities_returnVal$$1$$), $launcher$$7_openOptions$$2$$ = "keyboard" === $eventType$$34$$ ? {position:{of:$launcher$$7_openOptions$$2$$}, launcher:$$$$11$$($launcher$$7_openOptions$$2$$)} : {launcher:$$$$11$$($launcher$$7_openOptions$$2$$)}, 
    this.$_OpenContextMenu$($event$$119$$, $eventType$$34$$, $launcher$$7_openOptions$$2$$));
  ...
  }, $_findCellIndex$:function($columnIndex$$2_element$$64$$) {
    var $row$$15$$;
    $row$$15$$ = $columnIndex$$2_element$$64$$.parent();
    $columnIndex$$2_element$$64$$ = $columnIndex$$2_element$$64$$.index();
    return{rowIndex:$row$$15$$.index() - 1, columnIndex:$columnIndex$$2_element$$64$$};
    ...
    var $headerIndex$$1$$, $headerExtent$$, $i$$169$$;
    ...
    for ($i$$169$$ = $headers$$2$$.parent().parent().hasClass(this.$_getMappedStyle$("colheader")) ? 0 : 1;$i$$169$$ < $headers$$2$$.length;$i$$169$$++) {
      if ($headerIndex$$1$$ = parseInt($headers$$2$$.eq($i$$169$$).attr(this.$_getMappedAttribute$("start")), 10), $headerExtent$$ = parseInt($headers$$2$$.eq($i$$169$$).attr(this.$_getMappedAttribute$("extent")), 10), $index$$117$$ >= $headerIndex$$1$$ && $index$$117$$ < $headerIndex$$1$$ + $headerExtent$$) {
        return $level$$12$$ === $currentLevel$$1$$ ? $headers$$2$$.eq($i$$169$$) : this.$_getGroupingContainer$($index$$117$$, $level$$12$$, $currentLevel$$1$$ + 1, $headers$$2$$.eq($i$$169$$).children());
      }
    }
    return null;
  ...
  $oj$$11$$.$FlattenedTreeCellSet$ = function $$oj$$11$$$$FlattenedTreeCellSet$$($startRow$$, $endRow$$, $startColumn$$, $endColumn$$, $nodeSet$$2$$, $columns$$1$$) {
  ...
  $oj$$11$$.$FlattenedTreeCellSet$.prototype.getData = function $$oj$$11$$$$FlattenedTreeCellSet$$$getData$($indexes$$4_row$$16_rowData$$1$$) {
    var $column$$6_columnKey$$2_relIndex$$;
    $column$$6_columnKey$$2_relIndex$$ = this.$_getRelIndexes$($indexes$$4_row$$16_rowData$$1$$);
    if (null == $column$$6_columnKey$$2_relIndex$$) {
      return null;
    }
    $indexes$$4_row$$16_rowData$$1$$ = $column$$6_columnKey$$2_relIndex$$[0];
    $column$$6_columnKey$$2_relIndex$$ = $column$$6_columnKey$$2_relIndex$$[1];
    $oj$$11$$.$Assert$.assert($indexes$$4_row$$16_rowData$$1$$ < this.$m_nodeSet$.$getStart$() + this.$m_nodeSet$.$getCount$() && $column$$6_columnKey$$2_relIndex$$ < this.$m_columns$.length);
    $column$$6_columnKey$$2_relIndex$$ = this.$m_columns$[$column$$6_columnKey$$2_relIndex$$];
    $indexes$$4_row$$16_rowData$$1$$ = this.$m_nodeSet$.getData($indexes$$4_row$$16_rowData$$1$$);
    return null != $indexes$$4_row$$16_rowData$$1$$ ? $indexes$$4_row$$16_rowData$$1$$.get ? $indexes$$4_row$$16_rowData$$1$$.get($column$$6_columnKey$$2_relIndex$$) : $indexes$$4_row$$16_rowData$$1$$[$column$$6_columnKey$$2_relIndex$$] : null;
  };
  ...
  $oj$$11$$.$FlattenedTreeCellSet$.prototype.getMetadata = function $$oj$$11$$$$FlattenedTreeCellSet$$$getMetadata$($indexes$$5_metadata$$2_row$$17$$) {
    var $column$$7_columnKey$$3_relIndex$$1$$;
    $column$$7_columnKey$$3_relIndex$$1$$ = this.$_getRelIndexes$($indexes$$5_metadata$$2_row$$17$$);
    if (null == $column$$7_columnKey$$3_relIndex$$1$$) {
      return null;
    }
    $indexes$$5_metadata$$2_row$$17$$ = $column$$7_columnKey$$3_relIndex$$1$$[0];
    $column$$7_columnKey$$3_relIndex$$1$$ = $column$$7_columnKey$$3_relIndex$$1$$[1];
    $oj$$11$$.$Assert$.assert($indexes$$5_metadata$$2_row$$17$$ < this.$m_nodeSet$.$getStart$() + this.$m_nodeSet$.$getCount$() && $column$$7_columnKey$$3_relIndex$$1$$ < this.$m_columns$.length);
    $column$$7_columnKey$$3_relIndex$$1$$ = this.$m_columns$[$column$$7_columnKey$$3_relIndex$$1$$];
    $indexes$$5_metadata$$2_row$$17$$ = this.$m_nodeSet$.getMetadata($indexes$$5_metadata$$2_row$$17$$);
    $indexes$$5_metadata$$2_row$$17$$.keys = {row:$indexes$$5_metadata$$2_row$$17$$.key, column:$column$$7_columnKey$$3_relIndex$$1$$};
    return $indexes$$5_metadata$$2_row$$17$$;
  };
  ...
  $oj$$11$$.$FlattenedTreeCellSet$.prototype.$_getRelIndexes$ = function $$oj$$11$$$$FlattenedTreeCellSet$$$$_getRelIndexes$$($column$$8_indexes$$6$$) {
    var $row$$18$$;
    $oj$$11$$.$Assert$.$assertObject$($column$$8_indexes$$6$$);
    if (null == this.$m_nodeSet$ || 0 == this.$m_nodeSet$.length) {
      return null;
    }
    $row$$18$$ = $column$$8_indexes$$6$$.row - this.$m_startRow$ + this.$m_nodeSet$.$getStart$();
    $column$$8_indexes$$6$$ = $column$$8_indexes$$6$$.column;
    $oj$$11$$.$Assert$.$assertNumber$($row$$18$$, null);
    $oj$$11$$.$Assert$.$assertNumber$($column$$8_indexes$$6$$, null);
    $oj$$11$$.$Assert$.assert(0 <= $row$$18$$ && 0 <= $column$$8_indexes$$6$$);
    return[$row$$18$$, $column$$8_indexes$$6$$];
  };
  $oj$$11$$.$FlattenedTreeCellSet$.prototype.$getStart$ = function $$oj$$11$$$$FlattenedTreeCellSet$$$$getStart$$($axis$$11$$) {
    return "row" === $axis$$11$$ ? this.$m_startRow$ : "column" === $axis$$11$$ ? this.$m_startColumn$ : 0;
  };
  ...
  $oj$$11$$.$FlattenedTreeCellSet$.prototype.$getCount$ = function $$oj$$11$$$$FlattenedTreeCellSet$$$$getCount$$($axis$$12$$) {
    return "row" === $axis$$12$$ ? Math.min(this.$m_endRow$ - this.$m_startRow$, this.$m_nodeSet$.$getCount$()) : "column" === $axis$$12$$ ? this.$m_endColumn$ - this.$m_startColumn$ : 0;
  };
  ...
  $oj$$11$$.$FlattenedTreeHeaderSet$ = function $$oj$$11$$$$FlattenedTreeHeaderSet$$($start$$29$$, $end$$9$$, $headers$$3$$, $nodeSet$$3$$, $rowHeader$$1$$) {
    ...
    this.$m_nodeSet$ = $nodeSet$$3$$;
    this.$m_rowHeader$ = $rowHeader$$1$$;
  };
  $goog$exportPath_$$("FlattenedTreeHeaderSet", $oj$$11$$.$FlattenedTreeHeaderSet$, $oj$$11$$);
  $oj$$11$$.$FlattenedTreeHeaderSet$.prototype.getData = function $$oj$$11$$$$FlattenedTreeHeaderSet$$$getData$($index$$119$$, $level$$14$$) {
    var $rowData$$2$$;
    ...
    return null != this.$m_rowHeader$ && null != this.$m_nodeSet$ ? ($rowData$$2$$ = this.$m_nodeSet$.getData($index$$119$$), null != $rowData$$2$$ ? $rowData$$2$$.get ? $rowData$$2$$.get(this.$m_rowHeader$) : $rowData$$2$$[this.$m_rowHeader$] : null) : this.$m_headers$[$index$$119$$];
  };
  ...
  $oj$$11$$.$FlattenedTreeHeaderSet$.prototype.getMetadata = function $$oj$$11$$$$FlattenedTreeHeaderSet$$$getMetadata$($index$$120$$, $level$$15$$) {
  ...
  $oj$$11$$.$FlattenedTreeHeaderSet$.prototype.$getExtent$ = function $$oj$$11$$$$FlattenedTreeHeaderSet$$$$getExtent$$($index$$121$$, $level$$16$$) {
  ...
  $oj$$11$$.$FlattenedTreeHeaderSet$.prototype.$getDepth$ = function $$oj$$11$$$$FlattenedTreeHeaderSet$$$$getDepth$$($index$$122$$, $level$$17$$) {
  ...
  $oj$$11$$.$ArrayCellSet$ = function $$oj$$11$$$$ArrayCellSet$$($startRow$$1$$, $endRow$$1$$, $startColumn$$1$$, $endColumn$$1$$, $callback$$86$$) {
  ...
  $oj$$11$$.$ArrayCellSet$.prototype.getData = function $$oj$$11$$$$ArrayCellSet$$$getData$($indexes$$7$$) {
    return this.$m_callback$.$_getCellData$($indexes$$7$$.row, $indexes$$7$$.column);
  };
  $oj$$11$$.$Object$.$exportPrototypeSymbol$("ArrayCellSet.prototype.getData", {getData:$oj$$11$$.$ArrayCellSet$.prototype.getData});
  $oj$$11$$.$ArrayCellSet$.prototype.getMetadata = function $$oj$$11$$$$ArrayCellSet$$$getMetadata$($indexes$$8$$) {
    return this.$m_callback$.$_getCellMetadata$($indexes$$8$$.row, $indexes$$8$$.column);
  };
  ...
  $oj$$11$$.$ArrayCellSet$.prototype.$getStart$ = function $$oj$$11$$$$ArrayCellSet$$$$getStart$$($axis$$13$$) {
    return "row" == $axis$$13$$ ? this.$m_startRow$ : "column" == $axis$$13$$ ? this.$m_startColumn$ : -1;
  };
  $oj$$11$$.$Object$.$exportPrototypeSymbol$("ArrayCellSet.prototype.getStart", {$getStart$:$oj$$11$$.$ArrayCellSet$.prototype.$getStart$});
  $oj$$11$$.$ArrayCellSet$.prototype.$getCount$ = function $$oj$$11$$$$ArrayCellSet$$$$getCount$$($axis$$14$$) {
    return "row" === $axis$$14$$ ? Math.max(0, this.$m_endRow$ - this.$m_startRow$) : "column" === $axis$$14$$ ? Math.max(0, this.$m_endColumn$ - this.$m_startColumn$) : 0;
  };
  ...
  $oj$$11$$.$FlattenedTreeDataGridDataSource$.prototype.$getCountPrecision$ = function $$oj$$11$$$$FlattenedTreeDataGridDataSource$$$$getCountPrecision$$($axis$$15$$) {
    return "row" === $axis$$15$$ ? "estimate" : "actual";
  };
  ...
  $oj$$11$$.$FlattenedTreeDataGridDataSource$.prototype.$getCount$ = function $$oj$$11$$$$FlattenedTreeDataGridDataSource$$$$getCount$$($axis$$16$$) {
    return "row" === $axis$$16$$ ? -1 : "column" === $axis$$16$$ ? this.$m_columns$.length : 0;
  };
  ...
  $oj$$11$$.$FlattenedTreeDataGridDataSource$.prototype.$fetchHeaders$ = function $$oj$$11$$$$FlattenedTreeDataGridDataSource$$$$fetchHeaders$$($headerRange$$2$$, $callbacks$$21$$, $callbackObjects$$9$$) {
    var $axis$$17_columnCount$$, $headerSet$$1$$;
    $axis$$17_columnCount$$ = $headerRange$$2$$.axis;
    if ("column" === $axis$$17_columnCount$$) {
      $axis$$17_columnCount$$ = $headerRange$$2$$.start + $headerRange$$2$$.count, $axis$$17_columnCount$$ > this.$getCount$("column") && ($axis$$17_columnCount$$ = this.$getCount$("column") - $headerRange$$2$$.start), $headerSet$$1$$ = new $oj$$11$$.$FlattenedTreeHeaderSet$($headerRange$$2$$.start, $axis$$17_columnCount$$, this.$m_columns$);
    } else {
      if ("row" === $axis$$17_columnCount$$) {
        ...
        $headerSet$$1$$ = new $oj$$11$$.$ArrayHeaderSet$($headerRange$$2$$.start, $headerRange$$2$$.start, $axis$$17_columnCount$$, null);
      }
    }
  ...
  $oj$$11$$.$FlattenedTreeDataGridDataSource$.prototype.$fetchCells$ = function $$oj$$11$$$$FlattenedTreeDataGridDataSource$$$$fetchCells$$($cellRanges$$1$$, $callbacks$$22$$, $callbackObjects$$10$$) {
    var $i$$170$$, $cellRange$$2$$, $rowStart$$1$$, $rowCount$$2$$;
    for ($i$$170$$ = 0;$i$$170$$ < $cellRanges$$1$$.length;$i$$170$$++) {
      if ($cellRange$$2$$ = $cellRanges$$1$$[$i$$170$$], "row" == $cellRange$$2$$.axis) {
        $rowStart$$1$$ = $cellRange$$2$$.start;
        $rowCount$$2$$ = $cellRange$$2$$.count;
        break;
      }
    }
    $oj$$11$$.$FlattenedTreeDataGridDataSource$.$superclass$.$fetchRows$.call(this, {start:$rowStart$$1$$, count:$rowCount$$2$$}, {success:function($nodeSet$$4$$) {
      this.$_handleFetchRowsSuccess$($nodeSet$$4$$, $cellRanges$$1$$, $callbacks$$22$$, $callbackObjects$$10$$, 0);
  ...
  $oj$$11$$.$FlattenedTreeDataGridDataSource$.prototype.keys = function $$oj$$11$$$$FlattenedTreeDataGridDataSource$$$keys$($indexes$$9$$) {
    ...
    return new Promise(function($resolve$$39$$) {
      $rowIndex$$5$$ > $oj$$11$$.$FlattenedTreeDataGridDataSource$.$superclass$.$getFetchedRange$.call(this).end || $colIndex$$ > this.$m_columns$.length ? $resolve$$39$$(null) : $resolve$$39$$({row:$oj$$11$$.$FlattenedTreeDataGridDataSource$.$superclass$.getKey.call(this, $rowIndex$$5$$), column:this.$m_columns$[$colIndex$$]});
    }.bind(this));
  };
  ...
  $oj$$11$$.$FlattenedTreeDataGridDataSource$.prototype.$indexes$ = function $$oj$$11$$$$FlattenedTreeDataGridDataSource$$$$indexes$$($keys$$11$$) {
    var $rowIndex$$6$$, $colIndex$$1$$, $rowKey$$4$$, $colKey$$, $i$$171$$;
    ...
    return new Promise(function($resolve$$40$$) {
      ...
      for ($i$$171$$ = 0;$i$$171$$ < this.$m_columns$.length;$i$$171$$++) {
        if (this.$m_columns$[$i$$171$$] === $colKey$$) {
          $colIndex$$1$$ = $i$$171$$;
          break;
        }
      }
      0 <= $rowIndex$$6$$ || 0 <= $colIndex$$1$$ ? $resolve$$40$$({row:$rowIndex$$6$$, column:$colIndex$$1$$}) : $resolve$$40$$(null);
    }.bind(this));
  };
  ...
  $oj$$11$$.$FlattenedTreeDataGridDataSource$.prototype.$_handleFetchRowsSuccess$ = function $$oj$$11$$$$FlattenedTreeDataGridDataSource$$$$_handleFetchRowsSuccess$$($cellSet$$1_nodeSet$$5$$, $cellRanges$$2$$, $callbacks$$26$$, $callbackObjects$$13$$) {
    var $headerRange$$3_i$$172$$, $cellRange$$3$$, $rowStart$$2$$, $rowCount$$3$$, $columnStart$$, $columnCount$$1$$;
    for ($headerRange$$3_i$$172$$ = 0;$headerRange$$3_i$$172$$ < $cellRanges$$2$$.length;$headerRange$$3_i$$172$$++) {
      $cellRange$$3$$ = $cellRanges$$2$$[$headerRange$$3_i$$172$$], "row" == $cellRange$$3$$.axis ? ($rowStart$$2$$ = $cellRange$$3$$.start, $rowCount$$3$$ = $cellRange$$3$$.count) : "column" == $cellRange$$3$$.axis && ($columnStart$$ = $cellRange$$3$$.start, $columnCount$$1$$ = $cellRange$$3$$.count, $columnStart$$ + $columnCount$$1$$ > this.$getCount$("column") && ($columnCount$$1$$ = this.$getCount$("column") - $columnStart$$));
    }
    this.$m_fetchHeaderRequest$ && ($headerRange$$3_i$$172$$ = this.$m_fetchHeaderRequest$.range, $headerRange$$3_i$$172$$.start == $rowStart$$2$$ && $headerRange$$3_i$$172$$.count == $rowCount$$3$$ && this.$_handleRowHeaderFetchSuccess$($cellSet$$1_nodeSet$$5$$, $headerRange$$3_i$$172$$, this.$m_fetchHeaderRequest$.callbacks, this.$m_fetchHeaderRequest$.callbackObjects), this.$m_fetchHeaderRequest$ = null);
    $cellSet$$1_nodeSet$$5$$ = new $oj$$11$$.$FlattenedTreeCellSet$($rowStart$$2$$, $rowStart$$2$$ + $rowCount$$3$$, $columnStart$$, $columnStart$$ + $columnCount$$1$$, $cellSet$$1_nodeSet$$5$$, this.$m_columns$);
    $callbacks$$26$$.success && (null == $callbackObjects$$13$$ && ($callbackObjects$$13$$ = {}), $callbacks$$26$$.success.call($callbackObjects$$13$$.success, $cellSet$$1_nodeSet$$5$$, $cellRanges$$2$$));
  };
  ...
  $oj$$11$$.$FlattenedTreeDataGridDataSource$.prototype.$_handleRowHeaderFetchSuccess$ = function $$oj$$11$$$$FlattenedTreeDataGridDataSource$$$$_handleRowHeaderFetchSuccess$$($headerSet$$2_nodeSet$$6$$, $headerRange$$5$$, $callbacks$$28$$, $callbackObjects$$15$$) {
    $headerSet$$2_nodeSet$$6$$ = new $oj$$11$$.$FlattenedTreeHeaderSet$($headerRange$$5$$.start, $headerRange$$5$$.start + $headerRange$$5$$.count, this.$m_columns$, $headerSet$$2_nodeSet$$6$$, this.$m_rowHeader$);
    $callbacks$$28$$.success && (null == $callbackObjects$$15$$ && ($callbackObjects$$15$$ = {}), $callbacks$$28$$.success.call($callbackObjects$$15$$.success, $headerSet$$2_nodeSet$$6$$, $headerRange$$5$$));
  };
  $oj$$11$$.$FlattenedTreeDataGridDataSource$.prototype.$insertRows$ = function $$oj$$11$$$$FlattenedTreeDataGridDataSource$$$$insertRows$$($event$$120_insertAtIndex$$, $cellSet$$2_insertAtRowKey$$, $nodeSet$$7$$) {
    var $headerSet$$3$$, $i$$173$$, $keys$$12$$, $indexes$$10$$;
    $headerSet$$3$$ = null;
    this.$m_rowHeader$ && ($headerSet$$3$$ = new $oj$$11$$.$FlattenedTreeHeaderSet$($event$$120_insertAtIndex$$, $event$$120_insertAtIndex$$ + $nodeSet$$7$$.$getCount$(), this.$m_columns$, $nodeSet$$7$$, this.$m_rowHeader$));
    $cellSet$$2_insertAtRowKey$$ = new $oj$$11$$.$FlattenedTreeCellSet$($event$$120_insertAtIndex$$, $event$$120_insertAtIndex$$ + $nodeSet$$7$$.$getCount$(), 0, this.$m_columns$.length, $nodeSet$$7$$, this.$m_columns$);
    $keys$$12$$ = [];
    $indexes$$10$$ = [];
    for ($i$$173$$ = 0;$i$$173$$ < $nodeSet$$7$$.$getCount$();$i$$173$$++) {
      $keys$$12$$.push({row:this.$_getEntry$($event$$120_insertAtIndex$$ + $i$$173$$).key}), $indexes$$10$$.push({row:$event$$120_insertAtIndex$$ + $i$$173$$, column:-1});
    }
    $event$$120_insertAtIndex$$ = {source:this, operation:"insert"};
    $event$$120_insertAtIndex$$.result = $cellSet$$2_insertAtRowKey$$;
    $headerSet$$3$$ && ($event$$120_insertAtIndex$$.header = $headerSet$$3$$);
    $event$$120_insertAtIndex$$.keys = $keys$$12$$;
    $event$$120_insertAtIndex$$.indexes = $indexes$$10$$;
    $oj$$11$$.$FlattenedTreeDataGridDataSource$.$superclass$.handleEvent.call(this, "change", $event$$120_insertAtIndex$$);
  };
  $oj$$11$$.$FlattenedTreeDataGridDataSource$.prototype.$removeRows$ = function $$oj$$11$$$$FlattenedTreeDataGridDataSource$$$$removeRows$$($event$$121_rowKeys$$) {
    var $keys$$13$$, $i$$174$$, $indexes$$11$$;
    $keys$$13$$ = [];
    $indexes$$11$$ = [];
    for ($i$$174$$ = 0;$i$$174$$ < $event$$121_rowKeys$$.length;$i$$174$$++) {
      $keys$$13$$.push({row:$event$$121_rowKeys$$[$i$$174$$].key}), $indexes$$11$$.push({row:$event$$121_rowKeys$$[$i$$174$$].index, column:-1});
    }
    $event$$121_rowKeys$$ = {source:this, operation:"delete"};
    $event$$121_rowKeys$$.keys = $keys$$13$$;
    $event$$121_rowKeys$$.indexes = $indexes$$11$$;
    $oj$$11$$.$FlattenedTreeDataGridDataSource$.$superclass$.handleEvent.call(this, "change", $event$$121_rowKeys$$);
  };
  ...
  $oj$$11$$.$PagingCellSet$.prototype.$getCount$ = function $$oj$$11$$$$PagingCellSet$$$$getCount$$($axis$$18$$) {
    return this.$m_cellSet$.$getCount$($axis$$18$$);
  };
  ...
  $oj$$11$$.$PagingHeaderSet$ = function $$oj$$11$$$$PagingHeaderSet$$($headerSet$$4$$, $startIndex$$14$$) {
    this.$m_headerSet$ = $headerSet$$4$$;
    this.$m_startIndex$ = $startIndex$$14$$;
  };
  $goog$exportPath_$$("PagingHeaderSet", $oj$$11$$.$PagingHeaderSet$, $oj$$11$$);
  $oj$$11$$.$PagingHeaderSet$.prototype.getData = function $$oj$$11$$$$PagingHeaderSet$$$getData$($index$$123$$, $level$$18$$) {
    return this.$m_headerSet$.getData($index$$123$$ + this.$m_startIndex$, $level$$18$$);
  };
  $oj$$11$$.$Object$.$exportPrototypeSymbol$("PagingHeaderSet.prototype.getData", {getData:$oj$$11$$.$PagingHeaderSet$.prototype.getData});
  $oj$$11$$.$PagingHeaderSet$.prototype.getMetadata = function $$oj$$11$$$$PagingHeaderSet$$$getMetadata$($index$$124$$, $level$$19$$) {
    return this.$m_headerSet$.getMetadata($index$$124$$ + this.$m_startIndex$, $level$$19$$);
  };
  ...
  $oj$$11$$.$PagingHeaderSet$.prototype.$getExtent$ = function $$oj$$11$$$$PagingHeaderSet$$$$getExtent$$($index$$125$$, $level$$20$$) {
    return this.$m_headerSet$.$getExtent$($index$$125$$, $level$$20$$);
  };
  ...
  $oj$$11$$.$PagingHeaderSet$.prototype.$getDepth$ = function $$oj$$11$$$$PagingHeaderSet$$$$getDepth$$($index$$126$$, $level$$21$$) {
    return this.$m_headerSet$.$getDepth$($index$$126$$, $level$$21$$);
  };
  ...
  $oj$$11$$.$PagingDataGridDataSource$.prototype.setPage = function $$oj$$11$$$$PagingDataGridDataSource$$$setPage$($value$$174$$, $options$$262$$) {
    ...
    var $self$$70$$ = this;
    return new Promise(function($resolve$$41$$, $reject$$41$$) {
  ...
  $oj$$11$$.$PagingDataGridDataSource$.prototype.$getCount$ = function $$oj$$11$$$$PagingDataGridDataSource$$$$getCount$$($axis$$19$$) {
    return this.$dataSource$.$getCount$($axis$$19$$);
  };
  ...
  $oj$$11$$.$PagingDataGridDataSource$.prototype.$getCountPrecision$ = function $$oj$$11$$$$PagingDataGridDataSource$$$$getCountPrecision$$($axis$$20$$) {
    return this.$dataSource$.$getCountPrecision$($axis$$20$$);
  };
  ...
  $oj$$11$$.$PagingDataGridDataSource$.prototype.$_handleRowHeaderFetchSuccess$ = function $$oj$$11$$$$PagingDataGridDataSource$$$$_handleRowHeaderFetchSuccess$$($headerSet$$6$$, $headerRange$$7$$) {
    $headerRange$$7$$.start -= this.$_startIndex$;
    this.$_pendingRowHeaderCallback$.callbacks.success.call(this.$_pendingRowHeaderCallback$.callbackObjects.success, new $oj$$11$$.$PagingHeaderSet$($headerSet$$6$$, this.$_startIndex$), $headerRange$$7$$);
  ...
  $oj$$11$$.$PagingDataGridDataSource$.prototype.$fetchCells$ = function $$oj$$11$$$$PagingDataGridDataSource$$$$fetchCells$$($cellRanges$$3$$, $callbacks$$31$$, $callbackObjects$$17$$) {
    ...
    if (null == this.$_initialized$) {
      $cellSet$$4_i$$175$$ = new $oj$$11$$.$ArrayCellSet$(0, 0, 0, 0, null), null != $callbacks$$31$$ && $callbacks$$31$$.success && $callbacks$$31$$.success.call($callbackObjects$$17$$.success, $cellSet$$4_i$$175$$, $cellRanges$$3$$);
    } else {
      for ($cellSet$$4_i$$175$$ = 0;$cellSet$$4_i$$175$$ < $cellRanges$$3$$.length;$cellSet$$4_i$$175$$ += 1) {
        "row" === $cellRanges$$3$$[$cellSet$$4_i$$175$$].axis && ($cellRanges$$3$$[$cellSet$$4_i$$175$$].start += this.$_startIndex$, $cellRanges$$3$$[$cellSet$$4_i$$175$$].start + $cellRanges$$3$$[$cellSet$$4_i$$175$$].count > this.$_startIndex$ + this.$_pageSize$ && ($cellRanges$$3$$[$cellSet$$4_i$$175$$].count = this.$_pageSize$ - $cellRanges$$3$$[$cellSet$$4_i$$175$$].start));
      }
  ...
  $oj$$11$$.$PagingDataGridDataSource$.prototype.$_handleCellsFetchSuccess$ = function $$oj$$11$$$$PagingDataGridDataSource$$$$_handleCellsFetchSuccess$$($cellSet$$5$$, $cellRanges$$4$$) {
    var $i$$176$$;
    for ($i$$176$$ = 0;$i$$176$$ < $cellRanges$$4$$.length;$i$$176$$ += 1) {
      "row" === $cellRanges$$4$$[$i$$176$$].axis && ($cellRanges$$4$$[$i$$176$$].start -= this.$_startIndex$);
    }
  ...
  $oj$$11$$.$ArrayHeaderSet$ = function $$oj$$11$$$$ArrayHeaderSet$$($start$$30$$, $end$$10$$, $axis$$21$$, $callback$$87$$) {
  ...
  $oj$$11$$.$ArrayHeaderSet$.prototype.getData = function $$oj$$11$$$$ArrayHeaderSet$$$getData$($index$$127$$, $level$$22$$) {
    if (null == this.$m_callback$) {
      return null;
    }
    $oj$$11$$.$Assert$.assert($index$$127$$ <= this.$m_end$ && $index$$127$$ >= this.$m_start$, "index out of bounds");
    $oj$$11$$.$Assert$.assert(null == $level$$22$$ || 0 == $level$$22$$, "level out of bounds");
    return this.$m_callback$.$_getHeaderData$(this.$m_axis$, $index$$127$$);
  };
  $oj$$11$$.$Object$.$exportPrototypeSymbol$("ArrayHeaderSet.prototype.getData", {getData:$oj$$11$$.$ArrayHeaderSet$.prototype.getData});
  $oj$$11$$.$ArrayHeaderSet$.prototype.getMetadata = function $$oj$$11$$$$ArrayHeaderSet$$$getMetadata$($index$$128$$, $level$$23$$) {
    if (null == this.$m_callback$) {
      return null;
    }
    $oj$$11$$.$Assert$.assert($index$$128$$ <= this.$m_end$ && $index$$128$$ >= this.$m_start$, "index out of bounds");
    $oj$$11$$.$Assert$.assert(null == $level$$23$$ || 0 == $level$$23$$, "level out of bounds");
    return this.$m_callback$.$_getHeaderMetadata$(this.$m_axis$, $index$$128$$);
  };
  ...
  $oj$$11$$.$ArrayHeaderSet$.prototype.$getExtent$ = function $$oj$$11$$$$ArrayHeaderSet$$$$getExtent$$($index$$129$$, $level$$24$$) {
    $oj$$11$$.$Assert$.assert($index$$129$$ <= this.$m_end$ && $index$$129$$ >= this.$m_start$, "index out of bounds");
    $oj$$11$$.$Assert$.assert(null == $level$$24$$ || 0 == $level$$24$$, "level out of bounds");
    return{extent:1, more:{before:!1, after:!1}};
  };
  $oj$$11$$.$Object$.$exportPrototypeSymbol$("ArrayHeaderSet.prototype.getExtent", {$getExtent$:$oj$$11$$.$ArrayHeaderSet$.prototype.$getExtent$});
  $oj$$11$$.$ArrayHeaderSet$.prototype.$getDepth$ = function $$oj$$11$$$$ArrayHeaderSet$$$$getDepth$$($index$$130$$, $level$$25$$) {
    $oj$$11$$.$Assert$.assert($index$$130$$ <= this.$m_end$ && $index$$130$$ >= this.$m_start$, "index out of bounds");
    $oj$$11$$.$Assert$.assert(null == $level$$25$$ || 0 == $level$$25$$, "level out of bounds");
    return 1;
  };
