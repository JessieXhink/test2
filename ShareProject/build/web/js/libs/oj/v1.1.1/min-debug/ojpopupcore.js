...
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore", "jqueryui-amd/position"], function($oj$$30$$, $$$$29$$) {
  ...
  $oj$$30$$.$PositionUtils$.$normalizeHorizontalAlignment$ = function $$oj$$30$$$$PositionUtils$$$normalizeHorizontalAlignment$$($position$$23$$, $isRtl$$2$$) {
    ...
    for (var $target$$90$$ = $$$$29$$.extend({}, $position$$23$$), $i$$354$$ = 0;$i$$354$$ < $oj$$30$$.$PositionUtils$.$_ALIGN_RULE_PROPERTIES$.length;$i$$354$$++) {
      var $propName$$4$$ = $oj$$30$$.$PositionUtils$.$_ALIGN_RULE_PROPERTIES$[$i$$354$$], $align$$ = $target$$90$$[$propName$$4$$];
  ...
  $oj$$30$$.$PositionUtils$.$normalizePositionOf$ = function $$oj$$30$$$$PositionUtils$$$normalizePositionOf$$($of$$, $launcher$$9$$, $event$$395$$) {
    return "event" === $of$$ ? $event$$395$$ : null == $of$$ || "launcher" === $of$$ ? $launcher$$9$$ : $of$$;
  };
  ...
  $$$$29$$.ui.position.flipcenter = {left:function $$$$$29$$$ui$position$flipcenter$left$($position$$24$$, $data$$145$$) {
    var $posLeft$$ = $position$$24$$.left;
    $$$$29$$.ui.position.flip.left.call(this, $position$$24$$, $data$$145$$);
    var $overRight_within$$ = $data$$145$$.within, $dirFactor_withinOffset$$ = $overRight_within$$.isWindow ? $overRight_within$$.scrollLeft : $overRight_within$$.offset.left, $collisionPosLeft$$ = $position$$24$$.left - $data$$145$$.collisionPosition.marginLeft, $overRight_within$$ = $collisionPosLeft$$ + $data$$145$$.collisionWidth - $overRight_within$$.width - $dirFactor_withinOffset$$;
    if (0 < $dirFactor_withinOffset$$ - $collisionPosLeft$$ || 0 < $overRight_within$$) {
      "right" === $data$$145$$.at[0] ? $posLeft$$ -= $data$$145$$.targetWidth / 2 : "left" === $data$$145$$.at[0] && ($posLeft$$ += $data$$145$$.targetWidth / 2), $dirFactor_withinOffset$$ = "rtl" === $oj$$30$$.$DomUtils$.$getReadingDirection$() ? -1 : 1, $posLeft$$ -= $data$$145$$.elemWidth / 2 * $dirFactor_withinOffset$$, $position$$24$$.left = $posLeft$$;
    }
  }, top:function $$$$$29$$$ui$position$flipcenter$top$($position$$25$$, $data$$146$$) {
    var $posTop$$ = $position$$25$$.top;
    $$$$29$$.ui.position.flip.top.call(this, $position$$25$$, $data$$146$$);
    var $within$$1_withinOffset$$1$$ = $data$$146$$.within, $within$$1_withinOffset$$1$$ = $within$$1_withinOffset$$1$$.isWindow ? $within$$1_withinOffset$$1$$.scrollTop : $within$$1_withinOffset$$1$$.offset.top, $collisionPosTop$$ = $position$$25$$.top - $data$$146$$.collisionPosition.marginTop, $overBottom$$ = $collisionPosTop$$ + $data$$146$$.collisionHeight - $data$$146$$.within.height - $within$$1_withinOffset$$1$$;
    if (0 < $within$$1_withinOffset$$1$$ - $collisionPosTop$$ || 0 < $overBottom$$) {
      "top" === $data$$146$$.at[1] ? $posTop$$ += $data$$146$$.targetHeight / 2 : "bottom" === $data$$146$$.at[1] && ($posTop$$ -= $data$$146$$.targetHeight / 2), $posTop$$ += $data$$146$$.elemHeight / 2, $position$$25$$.top = $posTop$$;
    }
  }};
  ...
  $oj$$30$$.$PopupServiceImpl$.prototype.$triggerOnDescendents$ = function $$oj$$30$$$$PopupServiceImpl$$$$triggerOnDescendents$$($layer$$1_popup$$7$$, $event$$397$$, $argsArray$$1$$) {
    var $context$$81$$ = {};
    $context$$81$$.event = $event$$397$$;
    $context$$81$$.argsArray = $argsArray$$1$$;
    $layer$$1_popup$$7$$ = $oj$$30$$.$ZOrderUtils$.$getFirstAncestorLayer$($layer$$1_popup$$7$$);
    $oj$$30$$.$ZOrderUtils$.$postOrderVisit$($layer$$1_popup$$7$$, this.$_triggerOnDescendentsVisitCallback$, $context$$81$$);
  };
  $oj$$30$$.$PopupServiceImpl$.prototype.$_triggerOnDescendentsVisitCallback$ = function $$oj$$30$$$$PopupServiceImpl$$$$_triggerOnDescendentsVisitCallback$$($layer$$2$$, $context$$82$$) {
    var $event$$398$$ = $context$$82$$.event, $argsArray$$2$$ = $context$$82$$.argsArray, $events$$5$$ = $oj$$30$$.$ZOrderUtils$.$getEvents$($layer$$2$$);
    $events$$5$$ && $$$$29$$.isFunction($events$$5$$[$event$$398$$]) && $events$$5$$[$event$$398$$].apply(this, $argsArray$$2$$);
  ...
  $oj$$30$$.$PopupServiceImpl$.prototype.$_assertEventSink$ = function $$oj$$30$$$$PopupServiceImpl$$$$_assertEventSink$$() {
    ...
    if (!$docElement_hasPopupsOpen$$ && $callbackEventFilter_simpleTapRecognizer$$) {
      ...
      for (var $i$$355$$ = 0;$i$$355$$ < $oj$$30$$.$PopupServiceImpl$.$_REDISTRIBUTE_EVENTS$.length;$i$$355$$++) {
        var $event$$399$$ = $oj$$30$$.$PopupServiceImpl$.$_REDISTRIBUTE_EVENTS$[$i$$355$$];
        $docElement_hasPopupsOpen$$.removeEventListener($event$$399$$, $callbackEventFilter_simpleTapRecognizer$$, !0);
      }
      ...
      if ($docElement_hasPopupsOpen$$ && !$callbackEventFilter_simpleTapRecognizer$$) {
        ...
        for ($i$$355$$ = 0;$i$$355$$ < $oj$$30$$.$PopupServiceImpl$.$_REDISTRIBUTE_EVENTS$.length;$i$$355$$++) {
          $event$$399$$ = $oj$$30$$.$PopupServiceImpl$.$_REDISTRIBUTE_EVENTS$[$i$$355$$], $docElement_hasPopupsOpen$$.addEventListener($event$$399$$, $callbackEventFilter_simpleTapRecognizer$$, !0);
        }
  ...
  $oj$$30$$.$PopupServiceImpl$.prototype.$_eventFilterCallback$ = function $$oj$$30$$$$PopupServiceImpl$$$$_eventFilterCallback$$($event$$400$$) {
    var $context$$83_target$$91$$ = $$$$29$$($event$$400$$.target);
    if (!$oj$$30$$.$ZOrderUtils$.$hasPopupsOpen$()) {
      this.$_assertEventSink$();
    } else {
      if (!$oj$$30$$.$DomUtils$.$isChromeEvent$($event$$400$$) && ("focus" !== $event$$400$$.type || $context$$83_target$$91$$.is(":focusable"))) {
        var $defaultLayer$$ = $oj$$30$$.$ZOrderUtils$.$getDefaultLayer$();
        if ("keydown" === $event$$400$$.type && $oj$$30$$.$ZOrderUtils$.$hasModalDialogOpen$() && !$oj$$30$$.$DomUtils$.$isAncestor$($defaultLayer$$[0], $context$$83_target$$91$$[0])) {
          $oj$$30$$.$ZOrderUtils$.$eatEvent$($$$$29$$.Event($event$$400$$));
        } else {
          var $props$$16_targetWitinLayer$$ = $oj$$30$$.$ZOrderUtils$.$getFirstAncestorLayer$($context$$83_target$$91$$);
          ...
          if ("focus" !== $event$$400$$.type || "-1" !== $context$$83_target$$91$$.attr("tabindex")) {
            var $context$$83_target$$91$$ = {}, $props$$16_targetWitinLayer$$ = {}, $key$$141$$;
            for ($key$$141$$ in $event$$400$$) {
              $$$$29$$.isFunction($event$$400$$[$key$$141$$]) || ($props$$16_targetWitinLayer$$[$key$$141$$] = $event$$400$$[$key$$141$$]);
            }
            $context$$83_target$$91$$.event = $$$$29$$.Event($event$$400$$, $props$$16_targetWitinLayer$$);
            $oj$$30$$.$ZOrderUtils$.$postOrderVisit$($defaultLayer$$, $oj$$30$$.$PopupServiceImpl$.$_redistributeVisitCallback$, $context$$83_target$$91$$);
          }
        }
      }
    }
  };
  $oj$$30$$.$PopupServiceImpl$.$_redistributeVisitCallback$ = function $$oj$$30$$$$PopupServiceImpl$$$_redistributeVisitCallback$$($layer$$3$$, $context$$84$$) {
    var $events$$6$$ = $oj$$30$$.$ZOrderUtils$.$getEvents$($layer$$3$$), $event$$401$$ = $context$$84$$.event;
    if ($events$$6$$ && $$$$29$$.isFunction($events$$6$$[$oj$$30$$.$PopupService$.$EVENT$.$POPUP_AUTODISMISS$])) {
      $events$$6$$[$oj$$30$$.$PopupService$.$EVENT$.$POPUP_AUTODISMISS$]($event$$401$$);
    }
    return $oj$$30$$.$ZOrderUtils$.$VISIT_RESULT$.$ACCEPT$;
  };
  ...
  $oj$$30$$.$PopupServiceImpl$.$_refreshVisitCallback$ = function $$oj$$30$$$$PopupServiceImpl$$$_refreshVisitCallback$$($layer$$4$$, $context$$85$$) {
    if (0 < $context$$85$$.level) {
  ...
  $oj$$30$$.$ZOrderUtils$.$_closeDescendantPopupsCallback$ = function $$oj$$30$$$$ZOrderUtils$$$_closeDescendantPopupsCallback$$($layer$$11$$, $context$$86$$) {
  ...
  $oj$$30$$.$ZOrderUtils$.$hasModalDialogOpen$ = function $$oj$$30$$$$ZOrderUtils$$$hasModalDialogOpen$$() {
    for (var $children$$19$$ = $oj$$30$$.$ZOrderUtils$.$getDefaultLayer$().children(), $i$$356$$ = $children$$19$$.length - 1;-1 < $i$$356$$;$i$$356$$--) {
      if ($$$$29$$($children$$19$$[$i$$356$$]).hasClass($oj$$30$$.$ZOrderUtils$.$_OVERLAY_SELECTOR$)) {
        return!0;
      }
    }
    return!1;
  ...
  $oj$$30$$.$ZOrderUtils$.$postOrderVisit$ = function $$oj$$30$$$$ZOrderUtils$$$postOrderVisit$$($layer$$15$$, $callback$$102$$, $context$$87$$) {
    $context$$87$$ || ($context$$87$$ = {});
    $context$$87$$.level = 0;
    $context$$87$$.type = $oj$$30$$.$ZOrderUtils$.$_VISIT_TRAVERSAL$.$POST_ORDER$;
    $oj$$30$$.$ZOrderUtils$.$_visitTree$($layer$$15$$, $callback$$102$$, $context$$87$$);
  };
  $oj$$30$$.$ZOrderUtils$.$preOrderVisit$ = function $$oj$$30$$$$ZOrderUtils$$$preOrderVisit$$($layer$$16$$, $callback$$103$$, $context$$88$$) {
    $context$$88$$ || ($context$$88$$ = {});
    $context$$88$$.level = 0;
    $context$$88$$.type = $oj$$30$$.$ZOrderUtils$.$_VISIT_TRAVERSAL$.$PRE_ORDER$;
    $oj$$30$$.$ZOrderUtils$.$_visitTree$($layer$$16$$, $callback$$103$$, $context$$88$$);
  };
  $oj$$30$$.$ZOrderUtils$.$_visitTree$ = function $$oj$$30$$$$ZOrderUtils$$$_visitTree$$($children$$20_layer$$17$$, $callback$$104$$, $context$$89$$) {
    var $level$$42$$ = $context$$89$$.level;
    $children$$20_layer$$17$$ = $children$$20_layer$$17$$.children();
    for (var $i$$357$$ = $children$$20_layer$$17$$.length - 1;-1 < $i$$357$$;$i$$357$$--) {
      var $child$$17$$ = $$$$29$$($children$$20_layer$$17$$[$i$$357$$]);
      if ($oj$$30$$.$ZOrderUtils$.$_hasSurrogate$($child$$17$$[0])) {
        var $vrtn$$;
        if ($context$$89$$.type === $oj$$30$$.$ZOrderUtils$.$_VISIT_TRAVERSAL$.$PRE_ORDER$) {
          $vrtn$$ = $callback$$104$$($child$$17$$, $context$$89$$);
        ...
        $context$$89$$.level = $level$$42$$ + 1;
        $vrtn$$ = $oj$$30$$.$ZOrderUtils$.$_visitTree$($child$$17$$, $callback$$104$$, $context$$89$$);
        $context$$89$$.level = $level$$42$$;
        if ($vrtn$$ === $oj$$30$$.$ZOrderUtils$.$VISIT_RESULT$.$COMPLETE$) {
          return $vrtn$$;
        }
        if ($context$$89$$.type === $oj$$30$$.$ZOrderUtils$.$_VISIT_TRAVERSAL$.$POST_ORDER$) {
          $vrtn$$ = $callback$$104$$($child$$17$$, $context$$89$$);
          if ($vrtn$$ === $oj$$30$$.$ZOrderUtils$.$VISIT_RESULT$.$COMPLETE$) {
            return $vrtn$$;
          }
  ...
  $oj$$30$$.$ZOrderUtils$.$_hasSurrogate$ = function $$oj$$30$$$$ZOrderUtils$$$_hasSurrogate$$($element$$107$$) {
    return 1 === $element$$107$$.nodeType && $element$$107$$.hasAttribute($oj$$30$$.$ZOrderUtils$.$_SURROGATE_ATTR$) ? !0 : !1;
  };
  ...
  $oj$$30$$.$ZOrderUtils$.$getOpenPopupCount$ = function $$oj$$30$$$$ZOrderUtils$$$getOpenPopupCount$$() {
    var $context$$90$$ = {popupCount:0}, $defaultLayer$$5$$ = $oj$$30$$.$ZOrderUtils$.$getDefaultLayer$();
    $oj$$30$$.$ZOrderUtils$.$preOrderVisit$($defaultLayer$$5$$, $oj$$30$$.$ZOrderUtils$.$_openPopupCountCallback$, $context$$90$$);
    return $context$$90$$.popupCount;
  };
  $oj$$30$$.$ZOrderUtils$.$_openPopupCountCallback$ = function $$oj$$30$$$$ZOrderUtils$$$_openPopupCountCallback$$($layer$$18$$, $context$$91$$) {
    $context$$91$$.popupCount += 1;
    return $oj$$30$$.$ZOrderUtils$.$VISIT_RESULT$.$ACCEPT$;
  };
  $oj$$30$$.$ZOrderUtils$.$findOpenPopups$ = function $$oj$$30$$$$ZOrderUtils$$$findOpenPopups$$() {
    var $context$$92$$ = {}, $defaultLayer$$6_popups$$2$$ = [];
    $context$$92$$.popups = $defaultLayer$$6_popups$$2$$;
    $defaultLayer$$6_popups$$2$$ = $oj$$30$$.$ZOrderUtils$.$getDefaultLayer$();
    $oj$$30$$.$ZOrderUtils$.$preOrderVisit$($defaultLayer$$6_popups$$2$$, $oj$$30$$.$ZOrderUtils$.$_openPopupsCallback$, $context$$92$$);
    $defaultLayer$$6_popups$$2$$ = $context$$92$$.popups;
    return $$$$29$$($defaultLayer$$6_popups$$2$$);
  };
  $oj$$30$$.$ZOrderUtils$.$_openPopupsCallback$ = function $$oj$$30$$$$ZOrderUtils$$$_openPopupsCallback$$($layer$$19$$, $context$$93$$) {
    $context$$93$$.popups.push($layer$$19$$[0]);
    return $oj$$30$$.$ZOrderUtils$.$VISIT_RESULT$.$ACCEPT$;
  };
  $oj$$30$$.$ZOrderUtils$.$compareStackingContexts$ = function $$oj$$30$$$$ZOrderUtils$$$compareStackingContexts$$($el1$$1$$, $el2$$1$$) {
    function $describeStackingContext$$($element$$108$$, $allLevels$$) {
      for (var $positions$$ = ["absolute", "relative", "fixed"], $parents$$4$$ = $element$$108$$.parents(), $stack_tmp$$2$$ = [], $i$$359$$ = $parents$$4$$.length - 1;-1 < $i$$359$$;$i$$359$$--) {
        $stack_tmp$$2$$.push($$$$29$$($parents$$4$$[$i$$359$$]));
      }
      $parents$$4$$ = $stack_tmp$$2$$;
      $parents$$4$$.push($element$$108$$);
      for (var $stack_tmp$$2$$ = [], $level$$43$$ = 0, $i$$359$$ = 0;$i$$359$$ < $parents$$4$$.length;$i$$359$$++) {
        var $order_parent$$39$$ = $parents$$4$$[$i$$359$$], $position$$27$$ = $order_parent$$39$$.css("position"), $opacity$$1$$ = $oj$$30$$.$DomUtils$.$getCSSLengthAsFloat$($order_parent$$39$$.css("opacity")), $zindex$$ = $oj$$30$$.$DomUtils$.$getCSSLengthAsInt$($order_parent$$39$$.css("z-index")), $order_parent$$39$$ = $$$$29$$.inArray($order_parent$$39$$[0], $order_parent$$39$$.parent().children());
    ...
    function $compareSets$$($n1$$3$$, $n2$$3$$) {
      for (var $maxLen$$1$$ = Math.max($n1$$3$$.length, $n2$$3$$.length), $i$$360$$ = 0;$i$$360$$ < $maxLen$$1$$;$i$$360$$++) {
        var $e1$$1$$ = $i$$360$$ < $n1$$3$$.length ? $n1$$3$$[$i$$360$$] : -1, $e2$$1$$ = $i$$360$$ < $n2$$3$$.length ? $n2$$3$$[$i$$360$$] : -1;
        if ($e1$$1$$ !== $e2$$1$$) {
    ...
    for (var $n1$$2$$ = $describeStackingContext$$($el1$$1$$, !1), $n2$$2$$ = $describeStackingContext$$($el2$$1$$, !1), $maxLen$$ = Math.max($n1$$2$$.length, $n2$$2$$.length), $i$$358$$ = 0;$i$$358$$ < $maxLen$$;$i$$358$$++) {
      var $c$$45_e1$$ = $i$$358$$ < $n1$$2$$.length ? $n1$$2$$[$i$$358$$].weight : [-1], $e2$$ = $i$$358$$ < $n2$$2$$.length ? $n2$$2$$[$i$$358$$].weight : [-1], $c$$45_e1$$ = $compareSets$$($c$$45_e1$$, $e2$$);
      if (0 !== $c$$45_e1$$) {
        return $c$$45_e1$$;
      }
    }
    ...
    for ($i$$358$$ = 0;$i$$358$$ < $maxLen$$;$i$$358$$++) {
      if ($c$$45_e1$$ = $i$$358$$ < $n1$$2$$.length ? $n1$$2$$[$i$$358$$].order : [-1], $e2$$ = $i$$358$$ < $n2$$2$$.length ? $n2$$2$$[$i$$358$$].order : [-1], $c$$45_e1$$ = $compareSets$$($c$$45_e1$$, $e2$$), 0 !== $c$$45_e1$$) {
        return $c$$45_e1$$;
      }
    }
    return 0;
  };
  $oj$$30$$.$ZOrderUtils$.$eatEvent$ = function $$oj$$30$$$$ZOrderUtils$$$eatEvent$$($event$$403$$) {
    $event$$403$$.stopPropagation();
    $event$$403$$.preventDefault();
  };
  ...
  $oj$$30$$.$SimpleTapRecognizer$.prototype.Init = function $$oj$$30$$$$SimpleTapRecognizer$$$Init$() {
    ...
    for (var $eventHandlerCallback$$ = this.$_eventHandlerCallback$ = $$$$29$$.proxy(this.$_eventHandler$, this), $docElement$$1$$ = document.documentElement, $i$$361$$ = 0;$i$$361$$ < $oj$$30$$.$SimpleTapRecognizer$.$_TOUCHEVENTS$.length;$i$$361$$++) {
      $docElement$$1$$.addEventListener($oj$$30$$.$SimpleTapRecognizer$.$_TOUCHEVENTS$[$i$$361$$], $eventHandlerCallback$$, !0);
    }
  };
  $oj$$30$$.$SimpleTapRecognizer$.prototype.$_eventHandler$ = function $$oj$$30$$$$SimpleTapRecognizer$$$$_eventHandler$$($event$$404$$) {
    var $tapCallback$$1$$ = this.$_tapCallback$, $eventType$$49$$ = $event$$404$$.type;
    "touchstart" === $eventType$$49$$ ? this.$_touchStartEvent$ = $event$$404$$ : "touchmove" === $eventType$$49$$ || "touchcancel" === $eventType$$49$$ ? delete this.$_touchStartEvent$ : "touchend" === $eventType$$49$$ && (this.$_touchStartEvent$ && $tapCallback$$1$$(this.$_touchStartEvent$), delete this.$_touchStartEvent$);
  };
  $oj$$30$$.$SimpleTapRecognizer$.prototype.destroy = function $$oj$$30$$$$SimpleTapRecognizer$$$destroy$() {
    ...
    for (var $docElement$$2$$ = document.documentElement, $i$$362$$ = 0;$i$$362$$ < $oj$$30$$.$SimpleTapRecognizer$.$_TOUCHEVENTS$.length;$i$$362$$++) {
      $docElement$$2$$.removeEventListener($oj$$30$$.$SimpleTapRecognizer$.$_TOUCHEVENTS$[$i$$362$$], $eventHandlerCallback$$1$$, !0);
    }
  };
  ...
  $oj$$30$$.$PopupSkipLink$.prototype.Init = function $$oj$$30$$$$PopupSkipLink$$$Init$() {
    ...
    var $id$$38$$ = this.$_id$;
    delete this.$_id$;
    var $link$$ = $$$$29$$("\x3ca\x3e").attr({tabindex:"-1", href:"#"});
    $oj$$30$$.$StringUtils$.$isEmpty$($id$$38$$) || $link$$.attr("id", $id$$38$$);
    $link$$.addClass("oj-helper-hidden-accessible");
    $link$$.text($message$$36$$);
    $link$$.insertAfter($sibling$$1$$);
    $link$$.on("click", $callback$$106$$);
    $sibling$$1$$.data($oj$$30$$.$PopupSkipLink$.$_SKIPLINK_ATTR$, $link$$);
  };
  $oj$$30$$.$PopupSkipLink$.prototype.destroy = function $$oj$$30$$$$PopupSkipLink$$$destroy$() {
    ...
    if ($sibling$$2$$) {
      var $link$$1$$ = $sibling$$2$$.data($oj$$30$$.$PopupSkipLink$.$_SKIPLINK_ATTR$);
      $sibling$$2$$.removeData($oj$$30$$.$PopupSkipLink$.$_SKIPLINK_ATTR$);
      $link$$1$$ && ($link$$1$$.off("click", $callback$$107$$), $link$$1$$.remove());
    }
  };
  $oj$$30$$.$PopupSkipLink$.prototype.getLink = function $$oj$$30$$$$PopupSkipLink$$$getLink$() {
    var $sibling$$3$$ = this.$_sibling$, $link$$2$$;
    $sibling$$3$$ && ($link$$2$$ = $sibling$$3$$.data($oj$$30$$.$PopupSkipLink$.$_SKIPLINK_ATTR$));
    return $link$$2$$;
  };
