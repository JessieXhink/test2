...
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore"], function($oj$$28$$, $$$$27$$) {
  (function() {
    ...
    $oj$$28$$.$__registerWidget$("oj.ojButton", $$$$27$$.oj.baseComponent, {defaultElement:"\x3cbutton\x3e", widgetEventPrefix:"oj", options:{disabled:!1, display:"all", label:null, icons:{start:null, end:null}, menu:null}, $_InitOptions$:function($originalDefaults$$9$$, $constructorOptions$$11$$) {
      ...
      function $endHandler$$() {
        $self$$146$$.$_lastTouch$ = Date.now();
        $self$$146$$.$rootElement$.removeClass($activeClass$$);
        $self$$146$$.$rootElement$.removeClass("oj-hover");
        $self$$146$$.$_toggleDefaultClasses$();
      }
      this._super();
      ...
      var $self$$146$$ = this, $tabIndex$$4_toggleButton$$ = this.$_isToggle$, $activeClass$$ = $tabIndex$$4_toggleButton$$ ? "" : "oj-active";
      ...
      this.$buttonElement$.bind("touchstart" + this.eventNamespace, function() {
        $self$$146$$.$_IsEffectivelyDisabled$() || ($$$$27$$(this).addClass($activeClass$$), $self$$146$$.$_toggleDefaultClasses$());
        ...
        $self$$146$$.$_IsEffectivelyDisabled$() || $self$$146$$.$_recentTouch$() || (this === $_lastActive$$ && $self$$146$$.$rootElement$.addClass("oj-active"), $self$$146$$.$rootElement$.addClass("oj-hover").removeClass("oj-default oj-focus-only"));
      }).bind("mouseleave" + this.eventNamespace, function() {
        $self$$146$$.$rootElement$.removeClass("oj-hover");
        $self$$146$$.$_IsEffectivelyDisabled$() || ($self$$146$$.$rootElement$.removeClass($activeClass$$), $self$$146$$.$_toggleDefaultClasses$());
      }).bind("click" + this.eventNamespace, function($event$$340$$) {
        var $effectivelyDisabled$$ = $self$$146$$.$_IsEffectivelyDisabled$();
        $effectivelyDisabled$$ && $event$$340$$.preventDefault();
        $effectivelyDisabled$$ && $event$$340$$.stopImmediatePropagation();
      });
      this.element.attr("role", "button").bind("focus" + this.eventNamespace, function() {
        $self$$146$$.$rootElement$.addClass("oj-focus");
        $self$$146$$.$_toggleDefaultClasses$();
      }).bind("blur" + this.eventNamespace, function() {
        $self$$146$$.$rootElement$.removeClass("oj-focus");
        $self$$146$$.$_toggleDefaultClasses$();
      });
      $tabIndex$$4_toggleButton$$ && (this.element.bind("change" + this.eventNamespace, function($event$$341$$) {
        $self$$146$$.$_applyCheckedStateFromDom$(!0);
        ...
        $buttonset$$ && void 0 !== $checkedState$$ && $buttonset$$.option("checked", $checkedState$$, {_context:{$writeback$:!0, originalEvent:$event$$341$$, $internalSet$:!0}});
      }), this.$buttonElement$.bind("mousedown" + this.eventNamespace, function() {
        $self$$146$$.$_IsEffectivelyDisabled$() || ($_lastToggleActive$$ = this, $self$$146$$.document.one("mouseup", function() {
          $_lastToggleActive$$ = null;
        }));
      }).bind("mouseup" + this.eventNamespace, function() {
        $self$$146$$.$_IsEffectivelyDisabled$() || this !== $_lastToggleActive$$ || $self$$146$$.element.focus();
      }));
      "checkbox" === this.type ? (this.$buttonElement$.bind("click" + this.eventNamespace, function() {
        if ($self$$146$$.$_IsEffectivelyDisabled$()) {
          return!1;
        }
      }), this.element.bind("keyup" + this.eventNamespace, function($event$$345$$) {
        $event$$345$$.keyCode === $$$$27$$.ui.keyCode.ENTER && ($self$$146$$.$_IsEffectivelyDisabled$() || $self$$146$$.element.click());
      })) : "radio" === this.type ? (this.$buttonElement$.bind("click" + this.eventNamespace, function() {
        if ($self$$146$$.$_IsEffectivelyDisabled$()) {
          return!1;
        }
      }), this.element.bind("keyup" + this.eventNamespace, function($event$$346$$) {
        $event$$346$$.keyCode !== $$$$27$$.ui.keyCode.ENTER || $self$$146$$.element[0].checked || $self$$146$$.$_IsEffectivelyDisabled$() || ($self$$146$$.element[0].checked = !0, $self$$146$$.element.change(), $self$$146$$.element.click());
      })) : (this.$buttonElement$.bind("mousedown" + this.eventNamespace, function($event$$347$$) {
        if ($self$$146$$.$_IsEffectivelyDisabled$()) {
          return!1;
        }
        1 !== $event$$347$$.which || $self$$146$$.$_recentTouch$() || ($$$$27$$(this).addClass("oj-active").removeClass("oj-default oj-focus-only"), $_lastActive$$ = this, $self$$146$$.document.one("mouseup", function() {
          $_lastActive$$ = null;
        }));
      }).bind("mouseup" + this.eventNamespace, function() {
        if ($self$$146$$.$_IsEffectivelyDisabled$()) {
        ...
        $self$$146$$.$_toggleDefaultClasses$();
      }).bind("keydown" + this.eventNamespace, function($event$$348$$) {
        if ($self$$146$$.$_IsEffectivelyDisabled$()) {
          return!1;
        }
        var $isSpace$$ = $event$$348$$.keyCode === $$$$27$$.ui.keyCode.SPACE;
        "anchor" === $self$$146$$.type && $isSpace$$ && $event$$348$$.preventDefault();
        ($isSpace$$ || $event$$348$$.keyCode === $$$$27$$.ui.keyCode.ENTER) && $$$$27$$(this).addClass("oj-active").removeClass("oj-default oj-focus-only");
      }).bind("keyup" + this.eventNamespace + " blur" + this.eventNamespace, function() {
        $$$$27$$(this).removeClass("oj-active");
        $self$$146$$.$_toggleDefaultClasses$();
      }), "anchor" === this.type && ($tabIndex$$4_toggleButton$$ = this.$buttonElement$.attr("tabindex"), ("undefined" === $tabIndex$$4_toggleButton$$ || null === $tabIndex$$4_toggleButton$$ || isNaN($tabIndex$$4_toggleButton$$)) && this.$buttonElement$.attr("tabindex", "0"), this.$buttonElement$.bind("keyup" + this.eventNamespace, function($event$$349$$) {
        $event$$349$$.keyCode === $$$$27$$.ui.keyCode.SPACE && $$$$27$$(this).click();
      })));
    ...
    }, $_NotifyContextMenuGesture$:function($menu$$12$$, $event$$350$$, $eventType$$46$$) {
      this.$_OpenContextMenu$($event$$350$$, $eventType$$46$$, {position:{of:"keyboard" === $eventType$$46$$ ? this.$rootElement$ : $event$$350$$}});
    ...
    }, _setOption:function($key$$138$$, $value$$237$$, $flags$$31$$) {
      this._super($key$$138$$, $value$$237$$, $flags$$31$$);
      switch($key$$138$$) {
        case "disabled":
          this.$_updateEffectivelyDisabled$();
          break;
      ...
      if (this.options.menu) {
        var $self$$147$$ = this;
        this.element.attr("aria-haspopup", !0).on("keydown" + this.$menuEventNamespace$, function($event$$351$$) {
          if ($event$$351$$.which === $$$$27$$.ui.keyCode.DOWN) {
            $self$$147$$.$_showMenu$($event$$351$$, "firstItem"), $event$$351$$.preventDefault();
          } else {
            if ($event$$351$$.which === $$$$27$$.ui.keyCode.ESCAPE) {
              var $bubbleEscUp$$ = $self$$147$$.$_checkMenuParent$($self$$147$$.$rootElement$);
              $self$$147$$.$_dismissMenu$($event$$351$$);
              return $bubbleEscUp$$;
            }
          }
          return!0;
        }).on("click" + this.$menuEventNamespace$, function($event$$352$$) {
          var $menu$$13$$ = $self$$147$$.$_getMenu$();
          $menu$$13$$.$__spaceEnterDownInMenu$ || $self$$147$$.$_showMenu$($event$$352$$, "firstItem");
          $menu$$13$$.$__spaceEnterDownInMenu$ = !1;
          $event$$352$$.preventDefault();
          return!0;
        });
      }
    }, $_checkMenuParent$:function($element$$104$$) {
      return!$element$$104$$.hasClass("oj-selected");
      ...
      if (!this.$_menu$) {
        ...
        var $self$$148$$ = this;
        this.$_menu$.widget().on("oj__dismiss" + this.$menuEventNamespace$, function($event$$353$$) {
          $self$$148$$.$_menuDismissHandler$($event$$353$$);
        }).on("ojbeforeopen" + this.$menuEventNamespace$, function($event$$354$$) {
          $self$$148$$.$_launchingMenu$ || $self$$148$$.$_menuDismissHandler$($event$$354$$);
          $self$$148$$.$_launchingMenu$ = !1;
        });
      }
      return this.$_menu$;
    }, $_showMenu$:function($event$$355$$, $focus$$) {
      this.$_IsEffectivelyDisabled$() || (this.$_launchingMenu$ = !0, this.$_getMenu$().open($event$$355$$, {launcher:this.element, initialFocus:$focus$$}), this.$_menuVisible$ = !0, this.$rootElement$.addClass("oj-selected").removeClass("oj-default oj-focus-only"));
    }, $_dismissMenu$:function($event$$356$$) {
      this.$_menuVisible$ && (this.$_menu$.$__collapseAll$($event$$356$$, !0), this.$_menu$.$__dismiss$($event$$356$$));
    ...
    $oj$$28$$.$__registerWidget$("oj.ojButtonset", $$$$27$$.oj.baseComponent, {$_items$:"button, input[type\x3dbutton], input[type\x3dsubmit], input[type\x3dreset], input[type\x3dcheckbox], input[type\x3dradio], a", widgetEventPrefix:"oj", options:{checked:null, focusManagement:"oneTabstop"}, $_setCheckedOnDom$:function($checked$$1$$, $$buttons$$1$$) {
      ...
      this.$_setup$(!0);
    }, $_NotifyContextMenuGesture$:function($currentButton_menu$$14$$, $event$$358$$, $eventType$$47$$) {
      $currentButton_menu$$14$$ = this.element.find(":oj-button[tabindex\x3d0]");
      this.$_OpenContextMenu$($event$$358$$, $eventType$$47$$, {launcher:$currentButton_menu$$14$$, position:{of:"keyboard" === $eventType$$47$$ ? $currentButton_menu$$14$$.ojButton("widget") : $event$$358$$}});
    ...
    }, _setOption:function($key$$139$$, $value$$238$$, $flags$$32$$) {
      ...
      "oneTabstop" === this.options.focusManagement && (this.$$buttons$.unbind("keydown" + this.eventNamespace).bind("keydown" + this.eventNamespace, function($event$$359$$) {
        $self$$149$$.$_handleKeyDown$($event$$359$$, $$$$27$$(this));
      }).unbind("click" + this.eventNamespace).bind("click" + this.eventNamespace, function() {
        $$$$27$$(this).data("oj-ojButton").$_IsEffectivelyDisabled$() || $self$$149$$.$_setTabStop$($$$$27$$(this));
      }).unbind("focus" + this.eventNamespace).bind("focus" + this.eventNamespace, function() {
        $self$$149$$.$_setTabStop$($$$$27$$(this));
    ...
    }, $_handleKeyDown$:function($event$$362$$, $$button$$2$$) {
      switch($event$$362$$.which) {
        case $$$$27$$.ui.keyCode.LEFT:
        ;
        case $$$$27$$.ui.keyCode.RIGHT:
          $event$$362$$.preventDefault();
          var $$enabledButtons$$1$$ = this.$$enabledButtons$, $length$$15$$ = $$enabledButtons$$1$$.length;
          if (2 > $length$$15$$) {
            break;
          }
          var $oldIndex$$1$$ = $$enabledButtons$$1$$.index($$button$$2$$);
          $$enabledButtons$$1$$.eq(($oldIndex$$1$$ + ($event$$362$$.which == $$$$27$$.ui.keyCode.RIGHT ^ this.$isRtl$ ? 1 : -1) + $length$$15$$) % $length$$15$$).focus();
          break;
        case $$$$27$$.ui.keyCode.UP:
        ;
        case $$$$27$$.ui.keyCode.DOWN:
          "radio" == $$button$$2$$.attr("type") && $event$$362$$.preventDefault();
      }
    }, _destroy:function() {
