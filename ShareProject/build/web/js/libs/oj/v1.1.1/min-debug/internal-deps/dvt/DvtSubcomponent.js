...
D.$DvtDiscreteAttrGroups$$.prototype.get = function $$DvtDiscreteAttrGroups$$$$get$($group$$36$$) {
  ...
  for(var $i$$767$$ = 0;$i$$767$$ < this.$_results$.length;$i$$767$$++) {
    if(this.$_results$[$i$$767$$].group == $group$$36$$) {
      return this.$_results$[$i$$767$$].$params$
    }
  }
  return D.$JSCompiler_alias_NULL$$
};
...
D.$DvtContinuousAttrGroups$$.prototype.get = function $$DvtContinuousAttrGroups$$$$get$($index$$227_ratio$$17_value$$181$$) {
  if((0,window.isNaN)($index$$227_ratio$$17_value$$181$$) || $index$$227_ratio$$17_value$$181$$ === D.$JSCompiler_alias_NULL$$) {
    return D.$JSCompiler_alias_NULL$$
  }
  $index$$227_ratio$$17_value$$181$$ = 0 < this.$_range$ ? ($index$$227_ratio$$17_value$$181$$ - this.$_minValue$) / this.$_range$ : 0.5;
  $index$$227_ratio$$17_value$$181$$ = window.Math.max(window.Math.min($index$$227_ratio$$17_value$$181$$, 1), 0);
  $index$$227_ratio$$17_value$$181$$ *= this.$_ramp$.length - 1;
  return $index$$227_ratio$$17_value$$181$$ === window.Math.round($index$$227_ratio$$17_value$$181$$) ? this.$_ramp$[$index$$227_ratio$$17_value$$181$$] : D.$DvtColorUtils$$.$interpolateColor$(this.$_ramp$[window.Math.floor($index$$227_ratio$$17_value$$181$$)], this.$_ramp$[window.Math.ceil($index$$227_ratio$$17_value$$181$$)], $index$$227_ratio$$17_value$$181$$ - window.Math.floor($index$$227_ratio$$17_value$$181$$))
};
...
D.$DvtLegendAttrGroupsRenderer$$.$renderAttrGroups$ = function $$DvtLegendAttrGroupsRenderer$$$$renderAttrGroups$$($context$$553$$, $eventManager$$39$$, $container$$168$$, $availWidth$$12$$, $availHeight$$9$$, $attrGroups$$3$$, $styles$$13$$) {
  var $colorContainer$$ = D.$JSCompiler_alias_NULL$$;
  $attrGroups$$3$$ && ($attrGroups$$3$$ instanceof D.$DvtContinuousAttrGroups$$ ? $colorContainer$$ = D.$DvtLegendAttrGroupsRenderer$$.$_renderAttrGroupsContinuous$($context$$553$$, $eventManager$$39$$, $container$$168$$, $availWidth$$12$$, $attrGroups$$3$$, $styles$$13$$) : $attrGroups$$3$$ instanceof D.$DvtDiscreteAttrGroups$$ && ($colorContainer$$ = D.$DvtLegendAttrGroupsRenderer$$.$_renderAttrGroupsDiscrete$($context$$553$$, $container$$168$$, $availWidth$$12$$, $availHeight$$9$$, $attrGroups$$3$$, 
  $styles$$13$$)));
  return $colorContainer$$
};
D.$DvtLegendAttrGroupsRenderer$$.$_renderAttrGroupsContinuous$ = function $$DvtLegendAttrGroupsRenderer$$$$_renderAttrGroupsContinuous$$($context$$554_maxLabel$$3$$, $eventManager$$40$$, $container$$169_minLabelStr$$, $availWidth$$13$$, $attrGroups$$4_maxLabelStr$$, $maxLabelWidth$$5_minLabelWidth_styles$$14$$) {
  var $isRTL$$33$$ = (0,D.$DvtAgent$isRightToLeft$$)($context$$554_maxLabel$$3$$), $labelY$$3$$ = D.$DvtLegendAttrGroupsRenderer$$.$_CONTINUOUS_ITEM_HEIGHT$ / 2 + D.$DvtLegendAttrGroupsRenderer$$.$_CONTINUOUS_GROUP_GAP$, $colorContainer$$1$$ = new D.$DvtContainer$$($context$$554_maxLabel$$3$$);
  $container$$169_minLabelStr$$.$addChild$($colorContainer$$1$$);
  $container$$169_minLabelStr$$ = $attrGroups$$4_maxLabelStr$$.$getMinLabel$();
  var $minLabel$$2$$ = new D.$DvtOutputText$$($context$$554_maxLabel$$3$$, $container$$169_minLabelStr$$, 0, $labelY$$3$$);
  ...
  var $gradientRect$$ = new D.$DvtRect$$($context$$554_maxLabel$$3$$, 0, D.$DvtLegendAttrGroupsRenderer$$.$_CONTINUOUS_GROUP_GAP$, D.$DvtLegendAttrGroupsRenderer$$.$_CONTINUOUS_ITEM_WIDTH$, D.$DvtLegendAttrGroupsRenderer$$.$_CONTINUOUS_ITEM_HEIGHT$), $gradientWidth_ramp$$1$$ = $isRTL$$33$$ ? $attrGroups$$4_maxLabelStr$$.$_ramp$.slice(0).slice().reverse() : $attrGroups$$4_maxLabelStr$$.$_ramp$.slice(0);
  ...
  $context$$554_maxLabel$$3$$ = new D.$DvtOutputText$$($context$$554_maxLabel$$3$$, $attrGroups$$4_maxLabelStr$$, 0, $labelY$$3$$);
  $context$$554_maxLabel$$3$$.$setCSSStyle$($maxLabelWidth$$5_minLabelWidth_styles$$14$$.$labelStyle$);
  $context$$554_maxLabel$$3$$.$alignMiddle$();
  $colorContainer$$1$$.$addChild$($context$$554_maxLabel$$3$$);
  $isRTL$$33$$ ? ($maxLabelWidth$$5_minLabelWidth_styles$$14$$ = $context$$554_maxLabel$$3$$.$measureDimensions$().$w$ + D.$DvtLegendAttrGroupsRenderer$$.$_CONTINUOUS_ITEM_GAP$, $gradientRect$$.$setTranslateX$($maxLabelWidth$$5_minLabelWidth_styles$$14$$), $minLabel$$2$$.$setX$($maxLabelWidth$$5_minLabelWidth_styles$$14$$ + $gradientWidth_ramp$$1$$)) : ($maxLabelWidth$$5_minLabelWidth_styles$$14$$ = $minLabel$$2$$.$measureDimensions$().$w$ + D.$DvtLegendAttrGroupsRenderer$$.$_CONTINUOUS_ITEM_GAP$, 
  $gradientRect$$.$setTranslateX$($maxLabelWidth$$5_minLabelWidth_styles$$14$$), $context$$554_maxLabel$$3$$.$setX$($maxLabelWidth$$5_minLabelWidth_styles$$14$$ + $gradientWidth_ramp$$1$$));
  $eventManager$$40$$.$associate$($gradientRect$$, new D.$DvtSimpleObjPeer$$($container$$169_minLabelStr$$ + " - " + $attrGroups$$4_maxLabelStr$$));
  $colorContainer$$1$$.$getDimensions$().$w$ > $availWidth$$13$$ && ($colorContainer$$1$$.removeChild($minLabel$$2$$), $colorContainer$$1$$.removeChild($context$$554_maxLabel$$3$$), $gradientRect$$.$setTranslateX$(0));
  return $colorContainer$$1$$
};
D.$DvtLegendAttrGroupsRenderer$$.$_renderAttrGroupsDiscrete$ = function $$DvtLegendAttrGroupsRenderer$$$$_renderAttrGroupsDiscrete$$($context$$555_rect$$46$$, $component$$27_container$$170_items$$31$$, $actualDims_availWidth$$14$$, $availHeight$$11_preferredDims$$, $attrGroups$$5_mappings$$, $legendOptions$$8_styles$$15$$) {
  var $ret$$94$$ = new D.$DvtContainer$$($context$$555_rect$$46$$);
  $component$$27_container$$170_items$$31$$.$addChild$($ret$$94$$);
  $component$$27_container$$170_items$$31$$ = [];
  $attrGroups$$5_mappings$$ = $attrGroups$$5_mappings$$.$_results$.slice(0);
  for(var $i$$768$$ = 0;$i$$768$$ < $attrGroups$$5_mappings$$.length;$i$$768$$++) {
    var $mapping$$3$$ = $attrGroups$$5_mappings$$[$i$$768$$];
    $component$$27_container$$170_items$$31$$.push({text:$mapping$$3$$.$groupLabel$, color:$mapping$$3$$.$params$.color, pattern:$mapping$$3$$.$params$.pattern, borderColor:$legendOptions$$8_styles$$15$$.borderColor})
  }
  $legendOptions$$8_styles$$15$$ = {sections:[{items:$component$$27_container$$170_items$$31$$}], orientation:"horizontal", layout:{outerGapWidth:0, outerGapHeight:0}, textStyle:$legendOptions$$8_styles$$15$$.$labelStyle$.toString()};
  $component$$27_container$$170_items$$31$$ = (0,D.$DvtLegend$newInstance$$)($context$$555_rect$$46$$);
  $component$$27_container$$170_items$$31$$.setId(D.$JSCompiler_alias_NULL$$);
  $ret$$94$$.$addChild$($component$$27_container$$170_items$$31$$);
  $availHeight$$11_preferredDims$$ = $component$$27_container$$170_items$$31$$.$getPreferredSize$($legendOptions$$8_styles$$15$$, $actualDims_availWidth$$14$$, $availHeight$$11_preferredDims$$ * D.$DvtLegendAttrGroupsRenderer$$.$_LEGEND_MAX_HEIGHT$);
  $component$$27_container$$170_items$$31$$.$render$($legendOptions$$8_styles$$15$$, $actualDims_availWidth$$14$$, $availHeight$$11_preferredDims$$.$h$);
  $actualDims_availWidth$$14$$ = $component$$27_container$$170_items$$31$$.$getContentDimensions$();
  $context$$555_rect$$46$$ = new D.$DvtRect$$($context$$555_rect$$46$$, 0, 0, $actualDims_availWidth$$14$$.$w$, $availHeight$$11_preferredDims$$.$h$);
  (0,D.$JSCompiler_StaticMethods_setInvisibleFill$$)($context$$555_rect$$46$$);
  $ret$$94$$.$addChildAt$($context$$555_rect$$46$$, 0);
  return $ret$$94$$
};
...
D.$DvtBreadcrumbs$$ = function $$DvtBreadcrumbs$$$($context$$556$$, $callback$$143$$, $callbackObj$$93$$, $options$$238$$) {
  this.Init($context$$556$$, $callback$$143$$, $callbackObj$$93$$, $options$$238$$)
};
...
D.$JSCompiler_prototypeAlias$$.Init = function $$JSCompiler_prototypeAlias$$$Init$($context$$557$$, $callback$$144$$, $callbackObj$$94$$, $options$$239$$) {
  D.$DvtBreadcrumbs$$.$superclass$.Init.call(this, $context$$557$$);
  this.$setOptions$($options$$239$$);
  this.$_eventHandler$ = new D.$DvtBreadcrumbsEventManager$$(this, $context$$557$$, $callback$$144$$, $callbackObj$$94$$);
...
D.$JSCompiler_prototypeAlias$$.$setOptions$ = function $$JSCompiler_prototypeAlias$$$$setOptions$$($options$$240$$) {
  this.$_options$ = D.$DvtBreadcrumbsDefaults$$.$calcOptions$($options$$240$$)
};
D.$JSCompiler_prototypeAlias$$.$render$ = function $$JSCompiler_prototypeAlias$$$$render$$($data$$99$$, $width$$152$$) {
  this.$_data$ = $data$$99$$ ? D.$DvtJSONUtils$$.$clone$($data$$99$$) : this.$_data$;
  this.$removeChildren$();
...
D.$JSCompiler_prototypeAlias$$.$_updateKeyboardFocusEffect$ = function $$JSCompiler_prototypeAlias$$$$_updateKeyboardFocusEffect$$($prevIdx$$, $nextIdx$$) {
  var $prevKeyboardFocusRect$$ = this.$_keyboardFocusRect$, $context$$558_nextKeyboardFocusRect$$ = D.$JSCompiler_alias_NULL$$, $matrix$$20_nextCrumbObj$$ = (0,D.$JSCompiler_StaticMethods_getCrumb$$)(this, $nextIdx$$);
  if($matrix$$20_nextCrumbObj$$) {
    var $bounds$$144_peer$$25$$ = this.$_eventHandler$.$GetLogicalObject$($matrix$$20_nextCrumbObj$$);
    $bounds$$144_peer$$25$$ && $bounds$$144_peer$$25$$.$isDrillable$ && $bounds$$144_peer$$25$$.$isDrillable$() ? ($context$$558_nextKeyboardFocusRect$$ = this.$getCtx$(), $bounds$$144_peer$$25$$ = $matrix$$20_nextCrumbObj$$.$getDimensions$(), $matrix$$20_nextCrumbObj$$ = $matrix$$20_nextCrumbObj$$.$getMatrix$(), this.$_keyboardFocusRect$ = $context$$558_nextKeyboardFocusRect$$ = new D.$DvtKeyboardFocusEffect$$($context$$558_nextKeyboardFocusRect$$, this, $bounds$$144_peer$$25$$, $matrix$$20_nextCrumbObj$$)) : 
    this.$_keyboardFocusRect$ = D.$JSCompiler_alias_NULL$$
  }
  $prevKeyboardFocusRect$$ && $prevKeyboardFocusRect$$.$hide$();
  $context$$558_nextKeyboardFocusRect$$ && $context$$558_nextKeyboardFocusRect$$.show()
};
...
D.$JSCompiler_StaticMethods_getCrumbIndex$$ = function $$JSCompiler_StaticMethods_getCrumbIndex$$$($JSCompiler_StaticMethods_getCrumbIndex$self$$, $crumb$$) {
  for(var $crumbs$$1$$ = $JSCompiler_StaticMethods_getCrumbIndex$self$$.$_crumbs$, $i$$769$$ = 0;$i$$769$$ < $crumbs$$1$$.length;$i$$769$$++) {
    if($crumbs$$1$$[$i$$769$$] == $crumb$$) {
      return $i$$769$$
    }
  }
};
...
D.$DvtBreadcrumbsDefaults$$.$getGapSize$ = function $$DvtBreadcrumbsDefaults$$$$getGapSize$$($options$$241$$, $defaultSize$$2$$) {
  return window.Math.ceil($defaultSize$$2$$ * $options$$241$$.layout.gapRatio)
};
D.$DvtBreadcrumbsEventManager$$ = function $$DvtBreadcrumbsEventManager$$$($breadcrumbs$$2$$, $context$$559$$, $callback$$145$$, $callbackObj$$95$$) {
  this.Init($context$$559$$, $callback$$145$$, $callbackObj$$95$$);
  this.$_breadcrumbs$ = $breadcrumbs$$2$$
};
D.$DvtObj$$.$createSubclass$(D.$DvtBreadcrumbsEventManager$$, D.$DvtEventManager$$, "DvtBreadcrumbsEventManager");
D.$DvtBreadcrumbsEventManager$$.prototype.$OnClick$ = function $$DvtBreadcrumbsEventManager$$$$$OnClick$$($event$$707$$) {
  D.$DvtBreadcrumbsEventManager$$.$superclass$.$OnClick$.call(this, $event$$707$$);
  (0,D.$JSCompiler_StaticMethods__processBreadcrumbs$$)(this, this.$GetLogicalObject$($event$$707$$.target))
};
D.$DvtBreadcrumbsEventManager$$.prototype.$HandleTouchClickInternal$ = function $$DvtBreadcrumbsEventManager$$$$$HandleTouchClickInternal$$($event$$708$$) {
  (0,D.$JSCompiler_StaticMethods__processBreadcrumbs$$)(this, this.$GetLogicalObject$($event$$708$$.target))
};
D.$JSCompiler_StaticMethods__processBreadcrumbs$$ = function $$JSCompiler_StaticMethods__processBreadcrumbs$$$($JSCompiler_StaticMethods__processBreadcrumbs$self$$, $obj$$331$$) {
  if($obj$$331$$ && $obj$$331$$ instanceof D.$DvtBreadcrumbsPeer$$ && $obj$$331$$.$isDrillable$()) {
    var $event$$709$$ = new D.$DvtBreadcrumbsDrillEvent$$($obj$$331$$.getId());
    $JSCompiler_StaticMethods__processBreadcrumbs$self$$.$FireEvent$($event$$709$$, $JSCompiler_StaticMethods__processBreadcrumbs$self$$.$_breadcrumbs$)
  }
};
D.$DvtBreadcrumbsEventManager$$.prototype.$handleKeyboardEvent$ = function $$DvtBreadcrumbsEventManager$$$$$handleKeyboardEvent$$($event$$710$$) {
  var $eventConsumed$$4$$ = D.$JSCompiler_alias_TRUE$$, $JSCompiler_StaticMethods_updateCrumbFocus$self$$inline_7981_curCrumbIdx_keyCode$$41$$ = $event$$710$$.keyCode;
  if(9 == $JSCompiler_StaticMethods_updateCrumbFocus$self$$inline_7981_curCrumbIdx_keyCode$$41$$) {
    var $JSCompiler_StaticMethods_updateCrumbFocus$self$$inline_7981_curCrumbIdx_keyCode$$41$$ = this.$_breadcrumbs$, $prevCrumbIdx$$inline_7983$$ = $JSCompiler_StaticMethods_updateCrumbFocus$self$$inline_7981_curCrumbIdx_keyCode$$41$$.$_curCrumbIdx$, $JSCompiler_inline_result$$9348_prevIndex$$inline_11314$$;
    $JSCompiler_inline_result$$9348_prevIndex$$inline_11314$$ = $prevCrumbIdx$$inline_7983$$;
    var $bForward$$inline_11315$$ = !$event$$710$$.shiftKey;
    $JSCompiler_inline_result$$9348_prevIndex$$inline_11314$$ = -1 == $JSCompiler_inline_result$$9348_prevIndex$$inline_11314$$ ? $bForward$$inline_11315$$ ? 0 : $JSCompiler_StaticMethods_updateCrumbFocus$self$$inline_7981_curCrumbIdx_keyCode$$41$$.$_data$.$items$.length - 2 : $bForward$$inline_11315$$ ? $JSCompiler_inline_result$$9348_prevIndex$$inline_11314$$ == $JSCompiler_StaticMethods_updateCrumbFocus$self$$inline_7981_curCrumbIdx_keyCode$$41$$.$_data$.$items$.length - 2 ? -1 : ++$JSCompiler_inline_result$$9348_prevIndex$$inline_11314$$ : 
    0 == $JSCompiler_inline_result$$9348_prevIndex$$inline_11314$$ ? -1 : --$JSCompiler_inline_result$$9348_prevIndex$$inline_11314$$;
    $JSCompiler_StaticMethods_updateCrumbFocus$self$$inline_7981_curCrumbIdx_keyCode$$41$$.$_curCrumbIdx$ = $JSCompiler_inline_result$$9348_prevIndex$$inline_11314$$;
    $JSCompiler_StaticMethods_updateCrumbFocus$self$$inline_7981_curCrumbIdx_keyCode$$41$$.$_updateKeyboardFocusEffect$($prevCrumbIdx$$inline_7983$$, $JSCompiler_StaticMethods_updateCrumbFocus$self$$inline_7981_curCrumbIdx_keyCode$$41$$.$_curCrumbIdx$);
    $JSCompiler_StaticMethods_updateCrumbFocus$self$$inline_7981_curCrumbIdx_keyCode$$41$$ = $JSCompiler_StaticMethods_updateCrumbFocus$self$$inline_7981_curCrumbIdx_keyCode$$41$$.$_curCrumbIdx$;
    -1 == $JSCompiler_StaticMethods_updateCrumbFocus$self$$inline_7981_curCrumbIdx_keyCode$$41$$ ? $eventConsumed$$4$$ = D.$JSCompiler_alias_FALSE$$ : this.$UpdateActiveElement$((0,D.$JSCompiler_StaticMethods_getCrumb$$)(this.$_breadcrumbs$, $JSCompiler_StaticMethods_updateCrumbFocus$self$$inline_7981_curCrumbIdx_keyCode$$41$$))
  }else {
    13 == $JSCompiler_StaticMethods_updateCrumbFocus$self$$inline_7981_curCrumbIdx_keyCode$$41$$ && (0,D.$JSCompiler_StaticMethods__processBreadcrumbs$$)(this, this.$GetLogicalObject$((0,D.$JSCompiler_StaticMethods_getCrumb$$)(this.$_breadcrumbs$, this.$_breadcrumbs$.$_curCrumbIdx$)))
  }
  $eventConsumed$$4$$ && (0,D.$DvtEventManager$consumeEvent$$)($event$$710$$);
...
D.$DvtBreadcrumbsRenderer$$.$render$ = function $$DvtBreadcrumbsRenderer$$$$render$$($breadcrumbs$$3$$, $container$$171$$, $width$$153$$) {
  for(var $context$$560$$ = $breadcrumbs$$3$$.$getCtx$(), $dataItems$$1$$ = ($breadcrumbs$$3$$.$_data$ ? $breadcrumbs$$3$$.$_data$ : {}).$items$ ? ($breadcrumbs$$3$$.$_data$ ? $breadcrumbs$$3$$.$_data$ : {}).$items$ : [], $options$$242$$ = $breadcrumbs$$3$$.$_options$, $eventManager$$42$$ = $breadcrumbs$$3$$.$getEventManager$(), $labels$$23$$ = [], $peers$$8$$ = [], $i$$770$$ = 0;$i$$770$$ < $dataItems$$1$$.length;$i$$770$$++) {
    var $dataItem$$40_peer$$26$$ = $dataItems$$1$$[$i$$770$$];
    if($dataItem$$40_peer$$26$$) {
      var $label$$71$$ = D.$DvtBreadcrumbsRenderer$$.$_createLabel$($context$$560$$, $dataItem$$40_peer$$26$$.label ? $dataItem$$40_peer$$26$$.label : "", $options$$242$$, $i$$770$$ < $dataItems$$1$$.length - 1);
      $labels$$23$$.push($label$$71$$);
      $dataItem$$40_peer$$26$$ = new D.$DvtBreadcrumbsPeer$$($dataItem$$40_peer$$26$$.id, $label$$71$$);
      $eventManager$$42$$.$associate$($label$$71$$, $dataItem$$40_peer$$26$$);
      $peers$$8$$.push($dataItem$$40_peer$$26$$);
      $i$$770$$ < $dataItems$$1$$.length - 1 && $dataItem$$40_peer$$26$$.$setDrillable$(D.$JSCompiler_alias_TRUE$$)
    }
  }
  $breadcrumbs$$3$$.$_crumbs$ = $labels$$23$$;
  (0,D.$DvtAgent$isRightToLeft$$)($context$$560$$) ? D.$DvtBreadcrumbsRenderer$$.$_positionLabelsBidi$($breadcrumbs$$3$$, $container$$171$$, $width$$153$$, $labels$$23$$, $peers$$8$$) : D.$DvtBreadcrumbsRenderer$$.$_positionLabels$($breadcrumbs$$3$$, $container$$171$$, $width$$153$$, $labels$$23$$, $peers$$8$$)
};
D.$DvtBreadcrumbsRenderer$$.$_createButtonState$ = function $$DvtBreadcrumbsRenderer$$$$_createButtonState$$($context$$561_state$$95$$, $dvtText_text$$104$$, $cssStyle$$37$$) {
  $dvtText_text$$104$$ = new D.$DvtOutputText$$($context$$561_state$$95$$, $dvtText_text$$104$$, 0, 0);
  $dvtText_text$$104$$.$setMouseEnabled$(D.$JSCompiler_alias_FALSE$$);
  $dvtText_text$$104$$.$setCSSStyle$($cssStyle$$37$$);
  var $padTop$$1$$ = (0,D.$JSCompiler_StaticMethods_getPadding$$)($cssStyle$$37$$, "padding-top"), $padRight$$1$$ = (0,D.$JSCompiler_StaticMethods_getPadding$$)($cssStyle$$37$$, "padding-right"), $padBottom$$1$$ = (0,D.$JSCompiler_StaticMethods_getPadding$$)($cssStyle$$37$$, "padding-bottom"), $padLeft$$1$$ = (0,D.$JSCompiler_StaticMethods_getPadding$$)($cssStyle$$37$$, "padding-left"), $labelDims$$10$$ = (0,D.$DvtDisplayableUtils$getDimensionsForced$$)($context$$561_state$$95$$, $dvtText_text$$104$$);
  $context$$561_state$$95$$ = new D.$DvtRect$$($context$$561_state$$95$$, 0, 0, $labelDims$$10$$.$w$ + $padLeft$$1$$ + $padRight$$1$$, $labelDims$$10$$.$h$ + $padTop$$1$$ + $padBottom$$1$$);
  (0,D.$JSCompiler_StaticMethods_setInvisibleFill$$)($context$$561_state$$95$$);
  $context$$561_state$$95$$.$setCSSStyle$($cssStyle$$37$$);
  (0,D.$JSCompiler_StaticMethods_setTranslate$$)($dvtText_text$$104$$, $padLeft$$1$$, $padTop$$1$$);
  $context$$561_state$$95$$.$addChild$($dvtText_text$$104$$);
  return $context$$561_state$$95$$
};
D.$DvtBreadcrumbsRenderer$$.$_createLabel$ = function $$DvtBreadcrumbsRenderer$$$$_createLabel$$($context$$562_label$$72$$, $textStr$$11$$, $dwn$$16_dwnCss_options$$243$$, $bEnabled$$6_cssStyle$$38_ovr$$16_ovrCss$$) {
  if($bEnabled$$6_cssStyle$$38_ovr$$16_ovrCss$$ && ($dwn$$16_dwnCss_options$$243$$.$labelStyleOver$ || $dwn$$16_dwnCss_options$$243$$.$labelStyleDown$)) {
    var $ena$$20_enaCss$$ = new D.$DvtCSSStyle$$($dwn$$16_dwnCss_options$$243$$.$labelStyle$);
    $bEnabled$$6_cssStyle$$38_ovr$$16_ovrCss$$ = new D.$DvtCSSStyle$$($dwn$$16_dwnCss_options$$243$$.$labelStyleOver$);
    $dwn$$16_dwnCss_options$$243$$ = new D.$DvtCSSStyle$$($dwn$$16_dwnCss_options$$243$$.$labelStyleDown$);
    $ena$$20_enaCss$$ = D.$DvtBreadcrumbsRenderer$$.$_createButtonState$($context$$562_label$$72$$, $textStr$$11$$, $ena$$20_enaCss$$);
    $bEnabled$$6_cssStyle$$38_ovr$$16_ovrCss$$ = D.$DvtBreadcrumbsRenderer$$.$_createButtonState$($context$$562_label$$72$$, $textStr$$11$$, $bEnabled$$6_cssStyle$$38_ovr$$16_ovrCss$$);
    $dwn$$16_dwnCss_options$$243$$ = D.$DvtBreadcrumbsRenderer$$.$_createButtonState$($context$$562_label$$72$$, $textStr$$11$$, $dwn$$16_dwnCss_options$$243$$);
    $context$$562_label$$72$$ = new D.$DvtButton$$($context$$562_label$$72$$, $ena$$20_enaCss$$, $bEnabled$$6_cssStyle$$38_ovr$$16_ovrCss$$, $dwn$$16_dwnCss_options$$243$$);
    $context$$562_label$$72$$.$setAriaRole$("link");
    $context$$562_label$$72$$.$setAriaProperty$("label", $textStr$$11$$)
  }else {
    $bEnabled$$6_cssStyle$$38_ovr$$16_ovrCss$$ = new D.$DvtCSSStyle$$($bEnabled$$6_cssStyle$$38_ovr$$16_ovrCss$$ ? $dwn$$16_dwnCss_options$$243$$.$labelStyle$ : $dwn$$16_dwnCss_options$$243$$.$disabledLabelStyle$), (0,D.$JSCompiler_StaticMethods_getPadding$$)($bEnabled$$6_cssStyle$$38_ovr$$16_ovrCss$$, "padding-left") || (0,D.$JSCompiler_StaticMethods_getPadding$$)($bEnabled$$6_cssStyle$$38_ovr$$16_ovrCss$$, "padding-right") || (0,D.$JSCompiler_StaticMethods_getPadding$$)($bEnabled$$6_cssStyle$$38_ovr$$16_ovrCss$$, 
    "padding-top") || (0,D.$JSCompiler_StaticMethods_getPadding$$)($bEnabled$$6_cssStyle$$38_ovr$$16_ovrCss$$, "padding-bottom") ? $context$$562_label$$72$$ = D.$DvtBreadcrumbsRenderer$$.$_createButtonState$($context$$562_label$$72$$, $textStr$$11$$, $bEnabled$$6_cssStyle$$38_ovr$$16_ovrCss$$) : ($context$$562_label$$72$$ = new D.$DvtOutputText$$($context$$562_label$$72$$, $textStr$$11$$, 0, 0), $context$$562_label$$72$$.$setCSSStyle$($bEnabled$$6_cssStyle$$38_ovr$$16_ovrCss$$))
  }
  return $context$$562_label$$72$$
};
D.$DvtBreadcrumbsRenderer$$.$_getLabelTextString$ = function $$DvtBreadcrumbsRenderer$$$$_getLabelTextString$$($label$$73_text$$105$$) {
  if($label$$73_text$$105$$ instanceof D.$DvtButton$$) {
    return $label$$73_text$$105$$ = $label$$73_text$$105$$.$upState$.$getChildAt$(0), $label$$73_text$$105$$.$getTextString$()
  }
  $label$$73_text$$105$$ instanceof D.$DvtRect$$ && ($label$$73_text$$105$$ = $label$$73_text$$105$$.$getChildAt$(0));
  return $label$$73_text$$105$$.$getTextString$()
};
D.$DvtBreadcrumbsRenderer$$.$_truncateLabels$ = function $$DvtBreadcrumbsRenderer$$$$_truncateLabels$$($label$$74$$, $maxWidth$$25$$) {
  if($label$$74$$ instanceof D.$DvtButton$$) {
    var $text$$106$$ = $label$$74$$.$upState$.$getChildAt$(0);
    D.$DvtTextUtils$$.$fitText$($text$$106$$, window.Math.max($maxWidth$$25$$ - $text$$106$$.$getTranslateX$(), 0), window.Infinity, $text$$106$$.getParent());
    $text$$106$$ = $label$$74$$.$overState$.$getChildAt$(0);
    D.$DvtTextUtils$$.$fitText$($text$$106$$, window.Math.max($maxWidth$$25$$ - $text$$106$$.$getTranslateX$(), 0), window.Infinity, $text$$106$$.getParent());
    $text$$106$$ = $label$$74$$.$downState$.$getChildAt$(0);
    D.$DvtTextUtils$$.$fitText$($text$$106$$, window.Math.max($maxWidth$$25$$ - $text$$106$$.$getTranslateX$(), 0), window.Infinity, $text$$106$$.getParent())
  }else {
    $label$$74$$ instanceof D.$DvtRect$$ ? ($text$$106$$ = $label$$74$$.$getChildAt$(0), D.$DvtTextUtils$$.$fitText$($text$$106$$, window.Math.max($maxWidth$$25$$ - $text$$106$$.$getTranslateX$(), 0), window.Infinity, $text$$106$$.getParent())) : D.$DvtTextUtils$$.$fitText$($label$$74$$, $maxWidth$$25$$, window.Infinity, $label$$74$$.getParent())
  }
};
D.$DvtBreadcrumbsRenderer$$.$_positionLabels$ = function $$DvtBreadcrumbsRenderer$$$$_positionLabels$$($breadcrumbs$$4_labelString$$6$$, $container$$172$$, $availWidth$$15$$, $labels$$24$$, $peers$$9$$) {
  for(var $options$$244$$ = $breadcrumbs$$4_labelString$$6$$.$_options$, $eventManager$$43$$ = $breadcrumbs$$4_labelString$$6$$.$getEventManager$(), $arDims$$ = [], $maxHeight$$14$$ = 0, $i$$771$$ = 0;$i$$771$$ < $labels$$24$$.length;$i$$771$$++) {
    $container$$172$$.$addChild$($labels$$24$$[$i$$771$$]);
    var $dims$$62_separator$$1$$ = $labels$$24$$[$i$$771$$].$getDimensions$();
    $arDims$$[$i$$771$$] = $dims$$62_separator$$1$$;
    $maxHeight$$14$$ = window.Math.max($dims$$62_separator$$1$$.$h$, $maxHeight$$14$$);
    $container$$172$$.removeChild($labels$$24$$[$i$$771$$])
  }
  for(var $x$$253$$ = 0, $i$$771$$ = 0;$i$$771$$ < $labels$$24$$.length;$i$$771$$++) {
    $container$$172$$.$addChild$($labels$$24$$[$i$$771$$]);
    $dims$$62_separator$$1$$ = $arDims$$[$i$$771$$];
    (0,D.$JSCompiler_StaticMethods_setTranslate$$)($labels$$24$$[$i$$771$$], $x$$253$$, 0.5 * ($maxHeight$$14$$ - $dims$$62_separator$$1$$.$h$));
    if((0,D.$DvtAgent$isTouchDevice$$)()) {
      var $rect$$47_sepDims_separatorWidth$$ = new D.$DvtRect$$($container$$172$$.$getCtx$(), -D.$DvtBreadcrumbsRenderer$$.$_TOUCH_BUFFER$, -D.$DvtBreadcrumbsRenderer$$.$_TOUCH_BUFFER$, $dims$$62_separator$$1$$.$w$ + 2 * D.$DvtBreadcrumbsRenderer$$.$_TOUCH_BUFFER$, $dims$$62_separator$$1$$.$h$ + 2 * D.$DvtBreadcrumbsRenderer$$.$_TOUCH_BUFFER$);
      (0,D.$JSCompiler_StaticMethods_setInvisibleFill$$)($rect$$47_sepDims_separatorWidth$$);
      $labels$$24$$[$i$$771$$].$addChild$($rect$$47_sepDims_separatorWidth$$);
      $i$$771$$ < $peers$$9$$.length && $eventManager$$43$$.$associate$($rect$$47_sepDims_separatorWidth$$, $peers$$9$$[$i$$771$$])
    }
    if($x$$253$$ + $dims$$62_separator$$1$$.$w$ > $availWidth$$15$$) {
      $breadcrumbs$$4_labelString$$6$$ = D.$DvtBreadcrumbsRenderer$$.$_getLabelTextString$($labels$$24$$[$i$$771$$]);
      D.$DvtBreadcrumbsRenderer$$.$_truncateLabels$($labels$$24$$[$i$$771$$], $availWidth$$15$$ - $x$$253$$);
      $i$$771$$ < $peers$$9$$.length ? $peers$$9$$[$i$$771$$].$setTooltip$($breadcrumbs$$4_labelString$$6$$) : $eventManager$$43$$.$associate$($labels$$24$$[$i$$771$$], new D.$DvtSimpleObjPeer$$($breadcrumbs$$4_labelString$$6$$));
      break
    }else {
      $x$$253$$ += $dims$$62_separator$$1$$.$w$ + $options$$244$$.$__labelGap$
    }
    if($i$$771$$ < $labels$$24$$.length - 1) {
      $dims$$62_separator$$1$$ = D.$DvtBreadcrumbsRenderer$$.$_newSeparator$($breadcrumbs$$4_labelString$$6$$);
      $container$$172$$.$addChild$($dims$$62_separator$$1$$);
      $rect$$47_sepDims_separatorWidth$$ = $dims$$62_separator$$1$$.$getDimensions$();
      (0,D.$JSCompiler_StaticMethods_setTranslate$$)($dims$$62_separator$$1$$, $x$$253$$, 0.5 * ($maxHeight$$14$$ - $rect$$47_sepDims_separatorWidth$$.$h$));
      $rect$$47_sepDims_separatorWidth$$ = $rect$$47_sepDims_separatorWidth$$.$w$;
      if($x$$253$$ + $rect$$47_sepDims_separatorWidth$$ > $availWidth$$15$$) {
        $container$$172$$.removeChild($dims$$62_separator$$1$$);
        break
      }
      $x$$253$$ += $rect$$47_sepDims_separatorWidth$$ + $options$$244$$.$__labelGap$
    }
  }
};
D.$DvtBreadcrumbsRenderer$$.$_positionLabelsBidi$ = function $$DvtBreadcrumbsRenderer$$$$_positionLabelsBidi$$($breadcrumbs$$5_labelString$$7$$, $container$$173$$, $availWidth$$16_x$$254$$, $labels$$25$$, $peers$$10$$) {
  for(var $options$$245$$ = $breadcrumbs$$5_labelString$$7$$.$_options$, $eventManager$$44$$ = $breadcrumbs$$5_labelString$$7$$.$getEventManager$(), $i$$772$$ = 0;$i$$772$$ < $labels$$25$$.length;$i$$772$$++) {
    $container$$173$$.$addChild$($labels$$25$$[$i$$772$$]);
    var $dims$$63_separator$$2$$ = $labels$$25$$[$i$$772$$].$getDimensions$();
    if((0,D.$DvtAgent$isTouchDevice$$)()) {
      var $rect$$48_separatorWidth$$1$$ = new D.$DvtRect$$($container$$173$$.$getCtx$(), -D.$DvtBreadcrumbsRenderer$$.$_TOUCH_BUFFER$, -D.$DvtBreadcrumbsRenderer$$.$_TOUCH_BUFFER$, $dims$$63_separator$$2$$.$w$ + 2 * D.$DvtBreadcrumbsRenderer$$.$_TOUCH_BUFFER$, $dims$$63_separator$$2$$.$h$ + 2 * D.$DvtBreadcrumbsRenderer$$.$_TOUCH_BUFFER$);
      (0,D.$JSCompiler_StaticMethods_setInvisibleFill$$)($rect$$48_separatorWidth$$1$$);
      $labels$$25$$[$i$$772$$].$addChild$($rect$$48_separatorWidth$$1$$);
      $i$$772$$ < $peers$$10$$.length && $eventManager$$44$$.$associate$($rect$$48_separatorWidth$$1$$, $peers$$10$$[$i$$772$$])
    }
    if(0 > $availWidth$$16_x$$254$$ - $dims$$63_separator$$2$$.$w$) {
      $breadcrumbs$$5_labelString$$7$$ = D.$DvtBreadcrumbsRenderer$$.$_getLabelTextString$($labels$$25$$[$i$$772$$]);
      D.$DvtBreadcrumbsRenderer$$.$_truncateLabels$($labels$$25$$[$i$$772$$], $availWidth$$16_x$$254$$);
      $labels$$25$$[$i$$772$$].$setTranslateX$(0);
      $i$$772$$ < $peers$$10$$.length ? $peers$$10$$[$i$$772$$].$setTooltip$($breadcrumbs$$5_labelString$$7$$) : $eventManager$$44$$.$associate$($labels$$25$$[$i$$772$$], new D.$DvtSimpleObjPeer$$($breadcrumbs$$5_labelString$$7$$));
      break
    }else {
      $labels$$25$$[$i$$772$$].$setTranslateX$($availWidth$$16_x$$254$$ - $dims$$63_separator$$2$$.$w$), $availWidth$$16_x$$254$$ -= $dims$$63_separator$$2$$.$w$ + $options$$245$$.$__labelGap$
    }
    if($i$$772$$ < $labels$$25$$.length - 1) {
      if($dims$$63_separator$$2$$ = D.$DvtBreadcrumbsRenderer$$.$_newSeparator$($breadcrumbs$$5_labelString$$7$$), $container$$173$$.$addChild$($dims$$63_separator$$2$$), $rect$$48_separatorWidth$$1$$ = $dims$$63_separator$$2$$.$getDimensions$().$w$, 0 > $availWidth$$16_x$$254$$ - $rect$$48_separatorWidth$$1$$) {
        $container$$173$$.removeChild($dims$$63_separator$$2$$);
        break
      }else {
        $dims$$63_separator$$2$$.$setTranslateX$($availWidth$$16_x$$254$$ - $rect$$48_separatorWidth$$1$$), $availWidth$$16_x$$254$$ -= $rect$$48_separatorWidth$$1$$ + $options$$245$$.$__labelGap$
      }
    }
  }
};
D.$DvtBreadcrumbsRenderer$$.$_newSeparator$ = function $$DvtBreadcrumbsRenderer$$$$_newSeparator$$($breadcrumbs$$6_label$$75$$) {
  var $options$$246$$ = $breadcrumbs$$6_label$$75$$.$_options$;
  $breadcrumbs$$6_label$$75$$ = new D.$DvtOutputText$$($breadcrumbs$$6_label$$75$$.$getCtx$(), $options$$246$$.$__labelSeparator$, 0, 0);
  $breadcrumbs$$6_label$$75$$.$setCSSStyle$(new D.$DvtCSSStyle$$($options$$246$$.$labelStyle$));
  return $breadcrumbs$$6_label$$75$$
};
...
D.$DvtPanelDrawer$$ = function $$DvtPanelDrawer$$$($context$$563$$, $callback$$146$$, $callbackObj$$96$$, $sid$$1$$) {
  this.Init($context$$563$$, $callback$$146$$, $callbackObj$$96$$, $sid$$1$$)
};
D.$DvtObj$$.$createSubclass$(D.$DvtPanelDrawer$$, D.$DvtContainer$$, "DvtPanelDrawer");
D.$DvtPanelDrawer$$.prototype.Init = function $$DvtPanelDrawer$$$$Init$($context$$564$$, $callback$$147$$, $callbackObj$$97$$, $sid$$2$$) {
  D.$DvtPanelDrawer$$.$superclass$.Init.call(this, $context$$564$$, D.$JSCompiler_alias_NULL$$, "panelDrawer" + $sid$$2$$);
  this.$_sid$ = $sid$$2$$;
  this.$_eventManager$ = new D.$DvtPanelDrawerEventManager$$($context$$564$$, $callback$$147$$, $callbackObj$$97$$);
  ...
  this.$_callbackObj$ = $callbackObj$$97$$;
  this.$_panels$ = {};
  this.$_panelOrder$ = [];
  ...
  $callbackObj$$97$$ && (this.$_styleMap$ = $callbackObj$$97$$.$getSubcomponentStyles$());
...
D.$DvtPanelDrawer$$.prototype.$setDisclosed$ = function $$DvtPanelDrawer$$$$$setDisclosed$$($bDisclosed$$11_destX$$inline_7994$$, $anim$$inline_7995_anim$$inline_8001_bImmediate$$21$$, $onEnd$$9$$) {
  if(!this.$_bTransition$) {
    var $oldDisclosed$$1$$ = this.$_bDisclosed$;
    this.$_bDisclosed$ = $bDisclosed$$11_destX$$inline_7994$$;
    if($oldDisclosed$$1$$ != $bDisclosed$$11_destX$$inline_7994$$) {
      if(this.$_bTransition$ = D.$JSCompiler_alias_TRUE$$, $bDisclosed$$11_destX$$inline_7994$$) {
        (0,D.$JSCompiler_StaticMethods_DisplayPanel$$)(this, (0,D.$JSCompiler_StaticMethods_getDisplayedPanelId$$)(this));
        $bDisclosed$$11_destX$$inline_7994$$ = -(0.8 * this.$_expandedContent$.getWidth());
        "right" == this.$_discloseDirection$ && ($bDisclosed$$11_destX$$inline_7994$$ = -$bDisclosed$$11_destX$$inline_7994$$, this.$_expandedContent$.$setX$((0.8 - 1) * this.$_expandedContent$.getWidth()));
        if($anim$$inline_7995_anim$$inline_8001_bImmediate$$21$$) {
          this.$_contentPane$.$setTranslateX$($bDisclosed$$11_destX$$inline_7994$$), $onEnd$$9$$ && $onEnd$$9$$(), this.$_bTransition$ = D.$JSCompiler_alias_FALSE$$
        }else {
          if($anim$$inline_7995_anim$$inline_8001_bImmediate$$21$$ = new D.$DvtAnimator$$(this.$getCtx$(), 0.25), $anim$$inline_7995_anim$$inline_8001_bImmediate$$21$$.$setEasing$(D.$DvtEasing$backOut$$), (0,D.$JSCompiler_StaticMethods_addProp$$)($anim$$inline_7995_anim$$inline_8001_bImmediate$$21$$, "typeNumber", this.$_contentPane$, this.$_contentPane$.$getTranslateX$, this.$_contentPane$.$setTranslateX$, $bDisclosed$$11_destX$$inline_7994$$), $onEnd$$9$$ && (0,D.$DvtPlayable$appendOnEnd$$)($anim$$inline_7995_anim$$inline_8001_bImmediate$$21$$, 
          $onEnd$$9$$), $anim$$inline_7995_anim$$inline_8001_bImmediate$$21$$) {
            var $thisRef$$inline_7996$$ = this;
            (0,D.$DvtPlayable$appendOnEnd$$)($anim$$inline_7995_anim$$inline_8001_bImmediate$$21$$, function() {
              $thisRef$$inline_7996$$.$_bTransition$ = D.$JSCompiler_alias_FALSE$$
            });
            $anim$$inline_7995_anim$$inline_8001_bImmediate$$21$$.play()
          }
        }
        ...
        if($anim$$inline_7995_anim$$inline_8001_bImmediate$$21$$) {
          ...
          $anim$$inline_7995_anim$$inline_8001_bImmediate$$21$$ = new D.$DvtAnimator$$(this.$getCtx$(), 0.25);
          $anim$$inline_7995_anim$$inline_8001_bImmediate$$21$$.$setEasing$(D.$DvtEasing$backIn$$);
          (0,D.$JSCompiler_StaticMethods_addProp$$)($anim$$inline_7995_anim$$inline_8001_bImmediate$$21$$, "typeNumber", this.$_contentPane$, this.$_contentPane$.$getTranslateX$, this.$_contentPane$.$setTranslateX$, 0);
          (0,D.$DvtPlayable$appendOnEnd$$)($anim$$inline_7995_anim$$inline_8001_bImmediate$$21$$, this.$RemoveExpandedContent$, this);
          (0,D.$DvtPlayable$appendOnEnd$$)($anim$$inline_7995_anim$$inline_8001_bImmediate$$21$$, this.$ChangeTabsState$, this);
          $onEnd$$9$$ && (0,D.$DvtPlayable$appendOnEnd$$)($anim$$inline_7995_anim$$inline_8001_bImmediate$$21$$, $onEnd$$9$$);
          var $thisRef$$inline_8002$$ = this;
          (0,D.$DvtPlayable$appendOnEnd$$)($anim$$inline_7995_anim$$inline_8001_bImmediate$$21$$, function() {
            $thisRef$$inline_8002$$.$_bTransition$ = D.$JSCompiler_alias_FALSE$$
          });
          $anim$$inline_7995_anim$$inline_8001_bImmediate$$21$$.play()
        }
      }
...
D.$DvtPanelDrawer$$.prototype.$renderComponent$ = function $$DvtPanelDrawer$$$$$renderComponent$$() {
  ...
  if(!this.$_isFixed$) {
    var $currX$$inline_8005$$ = -42;
    "right" == this.$_discloseDirection$ && ($currX$$inline_8005$$ = 0);
    var $currY$$inline_8006$$ = 15;
    if("top" == this.$_dockSide$) {
      for(var $i$$inline_8007$$ = 0;$i$$inline_8007$$ < this.$_panelOrder$.length;$i$$inline_8007$$++) {
        var $panelId$$inline_8008_tab$$inline_8009$$ = this.$_panelOrder$[$i$$inline_8007$$], $panelId$$inline_8008_tab$$inline_8009$$ = (0,D.$JSCompiler_StaticMethods_RenderTab$$)(this, $panelId$$inline_8008_tab$$inline_8009$$);
        (0,D.$JSCompiler_StaticMethods_setTranslate$$)($panelId$$inline_8008_tab$$inline_8009$$, $currX$$inline_8005$$, $currY$$inline_8006$$);
        $currY$$inline_8006$$ += 42
      }
    }else {
      if("bottom" == this.$_dockSide$) {
        $currY$$inline_8006$$ = -57;
        for($i$$inline_8007$$ = this.$_panelOrder$.length - 1;0 <= $i$$inline_8007$$;$i$$inline_8007$$--) {
          $panelId$$inline_8008_tab$$inline_8009$$ = this.$_panelOrder$[$i$$inline_8007$$], $panelId$$inline_8008_tab$$inline_8009$$ = (0,D.$JSCompiler_StaticMethods_RenderTab$$)(this, $panelId$$inline_8008_tab$$inline_8009$$), (0,D.$JSCompiler_StaticMethods_setTranslate$$)($panelId$$inline_8008_tab$$inline_8009$$, $currX$$inline_8005$$, $currY$$inline_8006$$), $currY$$inline_8006$$ -= 42
        }
      }
    }
  }
...
D.$JSCompiler_StaticMethods_RenderTab$$ = function $$JSCompiler_StaticMethods_RenderTab$$$($JSCompiler_StaticMethods_RenderTab$self$$, $panelId$$3$$) {
  var $closedPath_downState$$17$$, $arPoints$$inline_8012_tab$$1$$;
  switch($JSCompiler_StaticMethods_RenderTab$self$$.$_discloseDirection$) {
    case "right":
      $arPoints$$inline_8012_tab$$1$$ = ["M", 0, 0, "L", 42 - $JSCompiler_StaticMethods_RenderTab$self$$.$_borderRadius$, 0, "A", $JSCompiler_StaticMethods_RenderTab$self$$.$_borderRadius$, $JSCompiler_StaticMethods_RenderTab$self$$.$_borderRadius$, 0, 0, 1, 42, $JSCompiler_StaticMethods_RenderTab$self$$.$_borderRadius$, "L", 42, 42 - $JSCompiler_StaticMethods_RenderTab$self$$.$_borderRadius$, "A", $JSCompiler_StaticMethods_RenderTab$self$$.$_borderRadius$, $JSCompiler_StaticMethods_RenderTab$self$$.$_borderRadius$, 
      0, 0, 1, 42 - $JSCompiler_StaticMethods_RenderTab$self$$.$_borderRadius$, 42, "L", 0, 42];
      break;
    default:
      $arPoints$$inline_8012_tab$$1$$ = ["M", 42, 0, "L", $JSCompiler_StaticMethods_RenderTab$self$$.$_borderRadius$, 0, "A", $JSCompiler_StaticMethods_RenderTab$self$$.$_borderRadius$, $JSCompiler_StaticMethods_RenderTab$self$$.$_borderRadius$, 0, 0, 0, 0, $JSCompiler_StaticMethods_RenderTab$self$$.$_borderRadius$, "L", 0, 42 - $JSCompiler_StaticMethods_RenderTab$self$$.$_borderRadius$, "A", $JSCompiler_StaticMethods_RenderTab$self$$.$_borderRadius$, $JSCompiler_StaticMethods_RenderTab$self$$.$_borderRadius$, 
      0, 0, 0, $JSCompiler_StaticMethods_RenderTab$self$$.$_borderRadius$, 42, "L", 42, 42]
  }
  $closedPath_downState$$17$$ = $arPoints$$inline_8012_tab$$1$$;
  $arPoints$$inline_8012_tab$$1$$ = new D.$DvtPanelDrawerTab$$($JSCompiler_StaticMethods_RenderTab$self$$.$getCtx$(), $closedPath_downState$$17$$, $panelId$$3$$, $JSCompiler_StaticMethods_RenderTab$self$$);
  (0,D.$JSCompiler_StaticMethods_setPixelHinting$$)($arPoints$$inline_8012_tab$$1$$);
  $arPoints$$inline_8012_tab$$1$$.setCursor("pointer");
  $JSCompiler_StaticMethods_RenderTab$self$$.$_contentPane$.$addChildAt$($arPoints$$inline_8012_tab$$1$$, 0);
  $arPoints$$inline_8012_tab$$1$$.$setSolidFill$($JSCompiler_StaticMethods_RenderTab$self$$.$_bgInactiveColor$, $JSCompiler_StaticMethods_RenderTab$self$$.$_bgAlpha$);
  $arPoints$$inline_8012_tab$$1$$.$setSolidStroke$($JSCompiler_StaticMethods_RenderTab$self$$.$_borderInactiveColor$, 1, 1);
  var $panelObj$$ = $JSCompiler_StaticMethods_RenderTab$self$$.$_panels$[$panelId$$3$$], $icon$$46_upState$$20$$ = new D.$DvtPath$$($JSCompiler_StaticMethods_RenderTab$self$$.$getCtx$(), $closedPath_downState$$17$$);
  (0,D.$JSCompiler_StaticMethods_setInvisibleFill$$)($icon$$46_upState$$20$$);
  (0,D.$JSCompiler_StaticMethods_setTranslate$$)($panelObj$$.iconUp, 9, 9);
  $icon$$46_upState$$20$$.$addChild$($panelObj$$.iconUp);
  ...
  $icon$$46_upState$$20$$ = new D.$DvtButton$$($JSCompiler_StaticMethods_RenderTab$self$$.$getCtx$(), $icon$$46_upState$$20$$, $overState$$17$$, $closedPath_downState$$17$$);
  $icon$$46_upState$$20$$.$_bToggleEnabled$ = D.$JSCompiler_alias_TRUE$$;
  $panelObj$$.icon = $icon$$46_upState$$20$$;
  $arPoints$$inline_8012_tab$$1$$.$addChild$($icon$$46_upState$$20$$);
  $JSCompiler_StaticMethods_RenderTab$self$$.$_tabs$[$panelId$$3$$] = $arPoints$$inline_8012_tab$$1$$;
  $JSCompiler_StaticMethods_RenderTab$self$$.$_eventManager$.$associate$($arPoints$$inline_8012_tab$$1$$, {$HandleClick$:function() {
    ...
    var $closedPath_downState$$17$$ = $JSCompiler_StaticMethods_RenderTab$self$$.$_tabs$[$panelId$$3$$].$isShowingKeyboardFocusEffect$(), $arPoints$$inline_8012_tab$$1$$ = function $$arPoints$$inline_8012_tab$$1$$$() {
      var $panelId$$3$$ = $JSCompiler_StaticMethods_RenderTab$self$$.$getCtx$().$getTooltipManager$();
      $panelId$$3$$ && $panelId$$3$$.$hideTooltip$()
    };
    $JSCompiler_StaticMethods_RenderTab$self$$.$isDisclosed$() ? $JSCompiler_StaticMethods_RenderTab$self$$.$_oldDisplayedPanelId$ == $panelId$$3$$ ? $JSCompiler_StaticMethods_RenderTab$self$$.$setDisclosed$(D.$JSCompiler_alias_FALSE$$, D.$JSCompiler_alias_FALSE$$, $arPoints$$inline_8012_tab$$1$$) : ($JSCompiler_StaticMethods_RenderTab$self$$.$ChangeTabsState$(), (0,D.$JSCompiler_StaticMethods_ChangePanels$$)($JSCompiler_StaticMethods_RenderTab$self$$, $panelId$$3$$, D.$JSCompiler_alias_FALSE$$)) : 
    ($JSCompiler_StaticMethods_RenderTab$self$$.$setDisclosed$(D.$JSCompiler_alias_TRUE$$, D.$JSCompiler_alias_FALSE$$, $arPoints$$inline_8012_tab$$1$$), $JSCompiler_StaticMethods_RenderTab$self$$.$ApplyAlphasRollover$());
  ...
  $arPoints$$inline_8012_tab$$1$$.$addAccessibilityAttributes$();
  return $arPoints$$inline_8012_tab$$1$$
};
...
D.$JSCompiler_StaticMethods_DisplayPanel$$ = function $$JSCompiler_StaticMethods_DisplayPanel$$$($JSCompiler_StaticMethods_DisplayPanel$self$$, $id$$267$$, $anim$$33$$) {
  ...
  var $ecw$$inline_8025_panel$$5$$ = $JSCompiler_StaticMethods_DisplayPanel$self$$.$_panels$[$id$$267$$].panel;
  if($ecw$$inline_8025_panel$$5$$) {
    $JSCompiler_StaticMethods_DisplayPanel$self$$.$_expandedContentPanel$.$addChild$($ecw$$inline_8025_panel$$5$$);
    if($JSCompiler_StaticMethods_DisplayPanel$self$$.$_oldDisplayedPanelId$) {
      var $ech$$inline_8026_oldPanel$$2$$ = $JSCompiler_StaticMethods_DisplayPanel$self$$.$_panels$[$JSCompiler_StaticMethods_DisplayPanel$self$$.$_oldDisplayedPanelId$].panel;
      $ech$$inline_8026_oldPanel$$2$$ && $ech$$inline_8026_oldPanel$$2$$.$removeEvtListener$("dvtResizeEvent", $JSCompiler_StaticMethods_DisplayPanel$self$$.$HandlePanelResize$, D.$JSCompiler_alias_FALSE$$, $JSCompiler_StaticMethods_DisplayPanel$self$$)
    }
    $ecw$$inline_8025_panel$$5$$.$addEvtListener$("dvtResizeEvent", $JSCompiler_StaticMethods_DisplayPanel$self$$.$HandlePanelResize$, D.$JSCompiler_alias_FALSE$$, $JSCompiler_StaticMethods_DisplayPanel$self$$)
  }
  ...
  var $dims$$inline_8029_panel$$inline_8024$$ = $JSCompiler_StaticMethods_DisplayPanel$self$$.$_panels$[$id$$267$$].panel, $ecw$$inline_8025_panel$$5$$ = 2 * $JSCompiler_StaticMethods_DisplayPanel$self$$.$_contentPadding$, $ech$$inline_8026_oldPanel$$2$$ = 2 * $JSCompiler_StaticMethods_DisplayPanel$self$$.$_contentPadding$, $xx$$inline_8027$$ = 0, $yy$$inline_8028$$ = 0;
  $dims$$inline_8029_panel$$inline_8024$$ && ($dims$$inline_8029_panel$$inline_8024$$ = $dims$$inline_8029_panel$$inline_8024$$.$getDimensionsWithStroke$(), $ecw$$inline_8025_panel$$5$$ = (0,D.$JSCompiler_StaticMethods_GetExpandedContentWidth$$)($JSCompiler_StaticMethods_DisplayPanel$self$$, $dims$$inline_8029_panel$$inline_8024$$.$w$), $ech$$inline_8026_oldPanel$$2$$ = (0,D.$JSCompiler_StaticMethods_GetExpandedContentHeight$$)($JSCompiler_StaticMethods_DisplayPanel$self$$, $dims$$inline_8029_panel$$inline_8024$$.$h$), 
  $xx$$inline_8027$$ = $dims$$inline_8029_panel$$inline_8024$$.x, $yy$$inline_8028$$ = $dims$$inline_8029_panel$$inline_8024$$.y);
  (0,D.$JSCompiler_StaticMethods__refreshPanelSize$$)($JSCompiler_StaticMethods_DisplayPanel$self$$, $id$$267$$, $anim$$33$$, $ecw$$inline_8025_panel$$5$$, $ech$$inline_8026_oldPanel$$2$$, $xx$$inline_8027$$, $yy$$inline_8028$$)
};
D.$DvtPanelDrawer$$.prototype.$HandlePanelResize$ = function $$DvtPanelDrawer$$$$$HandlePanelResize$$($event$$712_yy$$61$$) {
  var $anim$$34$$ = new D.$DvtAnimator$$(this.$getCtx$(), 0.25), $ecw_resizeWidth$$1$$ = $event$$712_yy$$61$$.getWidth(), $ech_resizeHeight$$1$$ = $event$$712_yy$$61$$.getHeight(), $ecw_resizeWidth$$1$$ = (0,D.$JSCompiler_StaticMethods_GetExpandedContentWidth$$)(this, $ecw_resizeWidth$$1$$), $ech_resizeHeight$$1$$ = (0,D.$JSCompiler_StaticMethods_GetExpandedContentHeight$$)(this, $ech_resizeHeight$$1$$), $xx$$61$$ = $event$$712_yy$$61$$.$getX$() ? $event$$712_yy$$61$$.$getX$() : 0;
  $event$$712_yy$$61$$ = $event$$712_yy$$61$$.$getY$() ? $event$$712_yy$$61$$.$getY$() : 0;
  (0,D.$JSCompiler_StaticMethods__refreshPanelSize$$)(this, (0,D.$JSCompiler_StaticMethods_getDisplayedPanelId$$)(this), $anim$$34$$, $ecw_resizeWidth$$1$$, $ech_resizeHeight$$1$$, $xx$$61$$, $event$$712_yy$$61$$);
  $anim$$34$$.play()
};
...
D.$JSCompiler_StaticMethods_ApplyFillAlpha$$ = function $$JSCompiler_StaticMethods_ApplyFillAlpha$$$($JSCompiler_StaticMethods_ApplyFillAlpha$self$$, $alpha$$51$$) {
  if($JSCompiler_StaticMethods_ApplyFillAlpha$self$$.$_expandedContent$) {
    var $fill$$73$$ = $JSCompiler_StaticMethods_ApplyFillAlpha$self$$.$_expandedContent$.$getFill$().$clone$();
    $fill$$73$$.$setAlpha$($alpha$$51$$);
    $JSCompiler_StaticMethods_ApplyFillAlpha$self$$.$_expandedContent$.$setFill$($fill$$73$$)
  }
  for(var $panelId$$6$$ in $JSCompiler_StaticMethods_ApplyFillAlpha$self$$.$_tabs$) {
    ...
    $tab$$3$$ && ($fill$$73$$ = $tab$$3$$.$getFill$().$clone$(), $fill$$73$$.$setAlpha$($alpha$$51$$), $tab$$3$$.$setFill$($fill$$73$$))
  }
};
D.$JSCompiler_StaticMethods_ApplyStrokeAlpha$$ = function $$JSCompiler_StaticMethods_ApplyStrokeAlpha$$$($JSCompiler_StaticMethods_ApplyStrokeAlpha$self$$) {
  if($JSCompiler_StaticMethods_ApplyStrokeAlpha$self$$.$_expandedBorder$) {
    var $stroke$$103$$ = $JSCompiler_StaticMethods_ApplyStrokeAlpha$self$$.$_expandedBorder$.$getStroke$().$clone$();
    $stroke$$103$$.$setAlpha$(1);
    $JSCompiler_StaticMethods_ApplyStrokeAlpha$self$$.$_expandedBorder$.$setStroke$($stroke$$103$$)
  }
  $JSCompiler_StaticMethods_ApplyStrokeAlpha$self$$.$_expandedBorderResizable$ && ($stroke$$103$$ = $JSCompiler_StaticMethods_ApplyStrokeAlpha$self$$.$_expandedBorderResizable$.$getStroke$().$clone$(), $stroke$$103$$.$setAlpha$(1), $JSCompiler_StaticMethods_ApplyStrokeAlpha$self$$.$_expandedBorderResizable$.$setStroke$($stroke$$103$$));
  for(var $panelId$$7$$ in $JSCompiler_StaticMethods_ApplyStrokeAlpha$self$$.$_tabs$) {
    ...
    $tab$$4$$ && ($stroke$$103$$ = $tab$$4$$.$getStroke$().$clone$(), $stroke$$103$$.$setAlpha$(1), $tab$$4$$.$setStroke$($stroke$$103$$))
  }
};
D.$JSCompiler_prototypeAlias$$ = D.$DvtPanelDrawer$$.prototype;
D.$JSCompiler_prototypeAlias$$.$deEmphasizeStart$ = function $$JSCompiler_prototypeAlias$$$$deEmphasizeStart$$() {
  ...
  for(var $panelId$$8$$ in this.$_tabs$) {
    var $icon$$47$$ = this.$GetIcon$($panelId$$8$$);
    $icon$$47$$ && $icon$$47$$.$setAlpha$(1)
  }
};
D.$JSCompiler_prototypeAlias$$.$deEmphasizeEnd$ = function $$JSCompiler_prototypeAlias$$$$deEmphasizeEnd$$() {
  ...
  for(var $panelId$$9$$ in this.$_tabs$) {
    var $icon$$48$$ = this.$GetIcon$($panelId$$9$$);
    $icon$$48$$ && $icon$$48$$.$setAlpha$(1)
  }
...
D.$JSCompiler_prototypeAlias$$.$ChangeTabsState$ = function $$JSCompiler_prototypeAlias$$$$ChangeTabsState$$() {
  for(var $panelId$$10$$ in this.$_tabs$) {
    ...
    var $bActivePanel$$ = this.$isDisclosed$() && $panelId$$10$$ == (0,D.$JSCompiler_StaticMethods_getDisplayedPanelId$$)(this), $icon$$49$$ = this.$GetIcon$($panelId$$10$$);
    $icon$$49$$ && (0,D.$JSCompiler_StaticMethods_setToggled$$)($icon$$49$$, $bActivePanel$$);
    $bActivePanel$$ ? this.$_activeContent$.$addChild$($tab$$5$$) : this.$_contentPane$.$addChildAt$($tab$$5$$, 0)
  }
};
D.$JSCompiler_StaticMethods_setMaxContainerHeight$$ = function $$JSCompiler_StaticMethods_setMaxContainerHeight$$$($JSCompiler_StaticMethods_setMaxContainerHeight$self$$, $height$$139$$) {
  if(!$JSCompiler_StaticMethods_setMaxContainerHeight$self$$.$_maxContainerHeight$ || $JSCompiler_StaticMethods_setMaxContainerHeight$self$$.$_maxContainerHeight$ < $height$$139$$) {
    $JSCompiler_StaticMethods_setMaxContainerHeight$self$$.$_maxContainerHeight$ = $height$$139$$
  }
};
...
D.$DvtPanelDrawerTab$$ = function $$DvtPanelDrawerTab$$$($context$$566$$, $cmds$$26$$, $id$$270$$, $panelDrawer$$7$$) {
  this.Init($context$$566$$, $cmds$$26$$, $id$$270$$, $panelDrawer$$7$$)
};
...
D.$JSCompiler_prototypeAlias$$.Init = function $$JSCompiler_prototypeAlias$$$Init$($context$$567$$, $cmds$$27$$, $id$$271$$, $panelDrawer$$8$$) {
  D.$DvtPanelDrawerTab$$.$superclass$.Init.call(this, $context$$567$$, $cmds$$27$$, "pdcp_tab_" + $id$$271$$);
  this.$_panelDrawer$ = $panelDrawer$$8$$;
  this.$_isDisclosed$ = D.$JSCompiler_alias_FALSE$$;
  this.$_panelId$ = $id$$271$$
};
D.$JSCompiler_prototypeAlias$$.$HandleKeyboardEvent$ = function $$JSCompiler_prototypeAlias$$$$HandleKeyboardEvent$$($event$$722_mouseEvent$$6$$) {
  var $eventManager$$45_keyCode$$43$$ = $event$$722_mouseEvent$$6$$.keyCode;
  if(13 == $eventManager$$45_keyCode$$43$$ || 32 == $eventManager$$45_keyCode$$43$$) {
    var $eventManager$$45_keyCode$$43$$ = this.$_panelDrawer$.$getEventManager$(), $point$$56$$ = (0,D.$JSCompiler_StaticMethods_localToStage$$)(this, new D.$DvtPoint$$(0, 0));
    $event$$722_mouseEvent$$6$$ = D.$DvtSvgEventFactory$$.$generateMouseEventFromKeyboardEvent$($event$$722_mouseEvent$$6$$, $eventManager$$45_keyCode$$43$$.$_context$, $point$$56$$.x, $point$$56$$.y);
    $event$$722_mouseEvent$$6$$.target = this;
    $eventManager$$45_keyCode$$43$$.$PreOnClick$($event$$722_mouseEvent$$6$$)
  }
};
...
D.$JSCompiler_prototypeAlias$$.$getAriaLabel$ = function $$JSCompiler_prototypeAlias$$$$getAriaLabel$$() {
  var $states$$14$$ = [];
  $states$$14$$.push(this.$isDisclosed$() ? (0,D.$DvtBundle$getTranslatedString$$)("DvtUtilBundle", "STATE_EXPANDED") : (0,D.$DvtBundle$getTranslatedString$$)("DvtUtilBundle", "STATE_COLLAPSED"));
  return(0,D.$DvtDisplayable$generateAriaLabel$$)(this.$_panelDrawer$.$_panels$[this.$_panelId$].tooltip, $states$$14$$)
};
...
D.$JSCompiler_prototypeAlias$$.$getNextNavigable$ = function $$JSCompiler_prototypeAlias$$$$getNextNavigable$$($event$$723$$) {
  return this.$_panelDrawer$.$getEventManager$().$KeyboardHandler$.$getNextNavigable$(this, $event$$723$$)
};
...
D.$DvtPanelDrawerEventManager$$ = function $$DvtPanelDrawerEventManager$$$($context$$565$$, $callback$$148$$, $callbackObj$$98$$) {
  this.Init($context$$565$$, $callback$$148$$, $callbackObj$$98$$)
};
...
D.$JSCompiler_prototypeAlias$$.$OnClick$ = function $$JSCompiler_prototypeAlias$$$$OnClick$$($event$$715$$) {
  var $obj$$332$$ = this.$GetLogicalObject$((0,D.$JSCompiler_StaticMethods_GetCurrentTargetForEvent$$)($event$$715$$));
  D.$DvtPanelDrawerEventManager$$.$superclass$.$OnClick$.call(this, $event$$715$$);
  $obj$$332$$ && ($obj$$332$$.$HandleClick$ && $obj$$332$$.$HandleClick$($event$$715$$), $event$$715$$.stopPropagation())
};
D.$JSCompiler_prototypeAlias$$.$OnDblClick$ = function $$JSCompiler_prototypeAlias$$$$OnDblClick$$($event$$716$$) {
  D.$DvtPanelDrawerEventManager$$.$superclass$.$OnDblClick$.call(this, $event$$716$$);
  var $obj$$333$$ = this.$GetLogicalObject$((0,D.$JSCompiler_StaticMethods_GetCurrentTargetForEvent$$)($event$$716$$));
  $obj$$333$$ && ($obj$$333$$.$isDoubleClickable$ && ($obj$$333$$.$isDoubleClickable$() && $obj$$333$$.$HandleDblClick$) && $obj$$333$$.$HandleDblClick$($event$$716$$), $event$$716$$.stopPropagation())
};
D.$JSCompiler_prototypeAlias$$.$OnRollOver$ = function $$JSCompiler_prototypeAlias$$$$OnRollOver$$($event$$717$$) {
  D.$DvtPanelDrawerEventManager$$.$superclass$.$OnRollOver$.call(this, $event$$717$$);
  var $obj$$334$$ = this.$GetLogicalObject$((0,D.$JSCompiler_StaticMethods_GetCurrentTargetForEvent$$)($event$$717$$));
  $obj$$334$$ && $obj$$334$$.$HandleRollOver$ && $obj$$334$$.$HandleRollOver$($event$$717$$)
};
D.$JSCompiler_prototypeAlias$$.$OnRollOut$ = function $$JSCompiler_prototypeAlias$$$$OnRollOut$$($event$$718$$) {
  D.$DvtPanelDrawerEventManager$$.$superclass$.$OnRollOut$.call(this, $event$$718$$);
  var $obj$$335$$ = this.$GetLogicalObject$((0,D.$JSCompiler_StaticMethods_GetCurrentTargetForEvent$$)($event$$718$$));
  $obj$$335$$ && $obj$$335$$.$HandleRollOut$ && $obj$$335$$.$HandleRollOut$($event$$718$$)
};
D.$JSCompiler_prototypeAlias$$.$OnComponentTouchClick$ = function $$JSCompiler_prototypeAlias$$$$OnComponentTouchClick$$($event$$719$$) {
  var $obj$$336$$ = this.$GetLogicalObject$((0,D.$JSCompiler_StaticMethods_GetCurrentTargetForEvent$$)($event$$719$$));
  D.$DvtPanelDrawerEventManager$$.$superclass$.$OnComponentTouchClick$.call(this, $event$$719$$);
  $obj$$336$$ && ($obj$$336$$.$HandleClick$ && $obj$$336$$.$HandleClick$($event$$719$$), $event$$719$$.stopPropagation())
};
...
D.$DvtPanelDrawerKeyboardHandler$$.prototype.$processKeyDown$ = function $$DvtPanelDrawerKeyboardHandler$$$$$processKeyDown$$($event$$720$$) {
  var $keyCode$$42_next$$14$$ = $event$$720$$.keyCode, $currentNavigable$$12$$ = this.$_eventManager$.$getFocus$();
  return 9 == $keyCode$$42_next$$14$$ ? ($keyCode$$42_next$$14$$ = D.$JSCompiler_alias_NULL$$, (0,D.$DvtEventManager$consumeEvent$$)($event$$720$$), $keyCode$$42_next$$14$$ = $currentNavigable$$12$$ ? $currentNavigable$$12$$ : this.$_panelDrawer$.$_tabs$[this.$_panelDrawer$.$_panelOrder$[0]]) : 13 == $keyCode$$42_next$$14$$ || 32 == $keyCode$$42_next$$14$$ ? ($currentNavigable$$12$$.$HandleKeyboardEvent$($event$$720$$), D.$JSCompiler_alias_NULL$$) : D.$DvtPanelDrawerKeyboardHandler$$.$superclass$.$processKeyDown$.call(this, 
  $event$$720$$)
};
D.$DvtPanelDrawerKeyboardHandler$$.prototype.$getNextNavigable$ = function $$DvtPanelDrawerKeyboardHandler$$$$$getNextNavigable$$($currentNavigable$$13$$, $event$$721$$) {
  if(!(40 == $event$$721$$.keyCode || 38 == $event$$721$$.keyCode)) {
    return $currentNavigable$$13$$
  }
  for(var $next$$15$$ = $currentNavigable$$13$$, $bForward$$10$$ = 40 == $event$$721$$.keyCode ? D.$JSCompiler_alias_TRUE$$ : D.$JSCompiler_alias_FALSE$$, $panelIds$$1$$ = this.$_panelDrawer$.$_panelOrder$, $panelIndex$$ = -1, $i$$774$$ = 0;$i$$774$$ < $panelIds$$1$$.length;$i$$774$$++) {
    if($currentNavigable$$13$$ == this.$_panelDrawer$.$_tabs$[$panelIds$$1$$[$i$$774$$]]) {
      $panelIndex$$ = $bForward$$10$$ ? $i$$774$$ == $panelIds$$1$$.length - 1 ? -1 : $i$$774$$ + 1 : 0 == $i$$774$$ ? -1 : $i$$774$$ - 1;
      break
    }
  }
...
D.$DvtAccordion$$ = function $$DvtAccordion$$$($context$$545$$, $id$$250$$, $w$$62$$, $h$$60$$, $eventManager$$32$$, $images$$16$$, $styleMap$$87$$) {
  this.Init($context$$545$$, $id$$250$$, $w$$62$$, $h$$60$$, $eventManager$$32$$, $images$$16$$, $styleMap$$87$$)
};
D.$DvtObj$$.$createSubclass$(D.$DvtAccordion$$, D.$DvtContainer$$, "DvtAccordion");
D.$DvtAccordion$$.prototype.Init = function $$DvtAccordion$$$$Init$($context$$546$$, $id$$251$$, $w$$63$$, $h$$61$$, $eventManager$$33$$, $images$$17$$, $styleMap$$88$$) {
  D.$DvtAccordion$$.$superclass$.Init.call(this, $context$$546$$, D.$JSCompiler_alias_NULL$$, $id$$251$$);
  this.$_images$ = $images$$17$$;
  this.$_styleMap$ = (new D.$DvtAccordionDefaults$$).$calcOptions$($styleMap$$88$$);
  this.$_sections$ = {};
  this.$_sectionOrder$ = [];
  this.$_maxWidth$ = $w$$63$$;
  this.$_minWidth$ = 0;
  this.$_maxHeight$ = $h$$61$$;
  this.$_bExpandMany$ = this.$_bCollapseAll$ = D.$JSCompiler_alias_FALSE$$;
  this.$_eventManager$ = $eventManager$$33$$
};
D.$JSCompiler_StaticMethods_addSection$$ = function $$JSCompiler_StaticMethods_addSection$$$($JSCompiler_StaticMethods_addSection$self$$, $accordionSection_title$$17$$, $sectionContent$$3$$, $isActive$$1$$, $id$$252$$) {
  $id$$252$$ || ($id$$252$$ = "accordion_" + $accordionSection_title$$17$$.replace(/ /g, "_") + window.Math.floor(1E9 * window.Math.random()));
  $accordionSection_title$$17$$ = new D.$DvtAccordionSection$$($JSCompiler_StaticMethods_addSection$self$$.$getCtx$(), $sectionContent$$3$$, $accordionSection_title$$17$$, $isActive$$1$$, D.$JSCompiler_alias_TRUE$$, $JSCompiler_StaticMethods_addSection$self$$, $JSCompiler_StaticMethods_addSection$self$$.$_eventManager$, $id$$252$$, $JSCompiler_StaticMethods_addSection$self$$.$_images$, $JSCompiler_StaticMethods_addSection$self$$.$_styleMap$);
  $JSCompiler_StaticMethods_addSection$self$$.$_sections$[$id$$252$$] = $accordionSection_title$$17$$;
  $JSCompiler_StaticMethods_addSection$self$$.$_sectionOrder$.push($id$$252$$);
  $JSCompiler_StaticMethods_addSection$self$$.$addChild$($accordionSection_title$$17$$)
};
D.$DvtAccordion$$.prototype.$render$ = function $$DvtAccordion$$$$$render$$() {
  for(var $maxSectionWidth$$ = (0,D.$JSCompiler_StaticMethods_getMaxSectionWidth$$)(this), $bHasActive$$ = D.$JSCompiler_alias_FALSE$$, $i$$758$$ = 0;$i$$758$$ < this.$_sectionOrder$.length;$i$$758$$++) {
    var $section$$11$$ = (0,D.$JSCompiler_StaticMethods_getSectionByIndex$$)(this, $i$$758$$);
...
D.$DvtAccordion$$.prototype.update = function $$DvtAccordion$$$$update$($activeSection_activeSectionId$$1$$) {
  ...
  var $JSCompiler_temp$$215_currActiveState_i$$759_section$$inline_7928$$ = $activeSection_activeSectionId$$1$$.$_isActive$;
  if($JSCompiler_temp$$215_currActiveState_i$$759_section$$inline_7928$$) {
    if($JSCompiler_temp$$215_currActiveState_i$$759_section$$inline_7928$$) {
      if($activeSection_activeSectionId$$1$$.$_isCollapsible$) {
        if(this.$_bCollapseAll$) {
          $JSCompiler_temp$$215_currActiveState_i$$759_section$$inline_7928$$ = D.$JSCompiler_alias_TRUE$$
        }else {
          for(var $expandedSectionCounter$$inline_7929$$ = 0, $i$$inline_7930$$ = 0;$i$$inline_7930$$ < this.$_sectionOrder$.length;$i$$inline_7930$$++) {
            $JSCompiler_temp$$215_currActiveState_i$$759_section$$inline_7928$$ = (0,D.$JSCompiler_StaticMethods_getSectionByIndex$$)(this, $i$$inline_7930$$), $JSCompiler_temp$$215_currActiveState_i$$759_section$$inline_7928$$.$_isActive$ && $expandedSectionCounter$$inline_7929$$++
          }
          $JSCompiler_temp$$215_currActiveState_i$$759_section$$inline_7928$$ = 1 < $expandedSectionCounter$$inline_7929$$
        }
      }else {
        $JSCompiler_temp$$215_currActiveState_i$$759_section$$inline_7928$$ = D.$JSCompiler_alias_FALSE$$
      }
    }
    $JSCompiler_temp$$215_currActiveState_i$$759_section$$inline_7928$$ && $activeSection_activeSectionId$$1$$.setActive(D.$JSCompiler_alias_FALSE$$)
  }else {
    if(!this.$_bExpandMany$) {
      for($JSCompiler_temp$$215_currActiveState_i$$759_section$$inline_7928$$ = 0;$JSCompiler_temp$$215_currActiveState_i$$759_section$$inline_7928$$ < this.$_sectionOrder$.length;$JSCompiler_temp$$215_currActiveState_i$$759_section$$inline_7928$$++) {
        (0,D.$JSCompiler_StaticMethods_getSectionByIndex$$)(this, $JSCompiler_temp$$215_currActiveState_i$$759_section$$inline_7928$$).setActive(D.$JSCompiler_alias_FALSE$$)
      }
    }
...
D.$JSCompiler_StaticMethods_getMaxSectionWidth$$ = function $$JSCompiler_StaticMethods_getMaxSectionWidth$$$($JSCompiler_StaticMethods_getMaxSectionWidth$self$$) {
  if(!$JSCompiler_StaticMethods_getMaxSectionWidth$self$$.$_maxSectionWidth$) {
    for(var $maxSectionWidth$$1$$ = 0, $paddingX$$1$$ = $JSCompiler_StaticMethods_getMaxSectionWidth$self$$.$_styleMap$.paddingX, $i$$760$$ = 0;$i$$760$$ < $JSCompiler_StaticMethods_getMaxSectionWidth$self$$.$_sectionOrder$.length;$i$$760$$++) {
      var $secWidth_section$$12$$ = (0,D.$JSCompiler_StaticMethods_getSectionByIndex$$)($JSCompiler_StaticMethods_getMaxSectionWidth$self$$, $i$$760$$), $JSCompiler_StaticMethods_GetTitleDimensions$self$$inline_7932_dim$$72$$;
      $JSCompiler_StaticMethods_GetTitleDimensions$self$$inline_7932_dim$$72$$ = $secWidth_section$$12$$;
      if(!$JSCompiler_StaticMethods_GetTitleDimensions$self$$inline_7932_dim$$72$$.$_titleDim$) {
        var $dim$$inline_7934_text$$inline_7933$$ = new D.$DvtOutputText$$($JSCompiler_StaticMethods_GetTitleDimensions$self$$inline_7932_dim$$72$$.$_context$, $JSCompiler_StaticMethods_GetTitleDimensions$self$$inline_7932_dim$$72$$.$_title$);
        $dim$$inline_7934_text$$inline_7933$$.$setCSSStyle$($JSCompiler_StaticMethods_GetTitleDimensions$self$$inline_7932_dim$$72$$.$_titleStyle$);
        if($dim$$inline_7934_text$$inline_7933$$ = $dim$$inline_7934_text$$inline_7933$$.$measureDimensions$()) {
          $dim$$inline_7934_text$$inline_7933$$.$w$ = $dim$$inline_7934_text$$inline_7933$$.$w$ + $JSCompiler_StaticMethods_GetTitleDimensions$self$$inline_7932_dim$$72$$.$_imageWidth$ + $JSCompiler_StaticMethods_GetTitleDimensions$self$$inline_7932_dim$$72$$.$_textPadding$
        }
        $JSCompiler_StaticMethods_GetTitleDimensions$self$$inline_7932_dim$$72$$.$_titleDim$ = $dim$$inline_7934_text$$inline_7933$$
      }
      $JSCompiler_StaticMethods_GetTitleDimensions$self$$inline_7932_dim$$72$$ = $JSCompiler_StaticMethods_GetTitleDimensions$self$$inline_7932_dim$$72$$.$_titleDim$;
      $JSCompiler_StaticMethods_GetTitleDimensions$self$$inline_7932_dim$$72$$.$w$ > $maxSectionWidth$$1$$ && ($maxSectionWidth$$1$$ = $JSCompiler_StaticMethods_GetTitleDimensions$self$$inline_7932_dim$$72$$.$w$);
...
D.$DvtAccordion$$.prototype.$getExpandedHeight$ = function $$DvtAccordion$$$$$getExpandedHeight$$() {
  if(!this.$_maxHeight$) {
    for(var $maxCollapsibleSectionHeight$$ = 0, $maxFixedSectionHeight$$ = 0, $i$$761$$ = 0;$i$$761$$ < this.$_sectionOrder$.length;$i$$761$$++) {
      var $section$$13$$ = (0,D.$JSCompiler_StaticMethods_getSectionByIndex$$)(this, $i$$761$$), $JSCompiler_StaticMethods_getExpandedDimensions$self$$inline_7936_sectionHeight$$ = $section$$13$$, $dim$$inline_7937$$ = D.$JSCompiler_alias_NULL$$;
      0 > $JSCompiler_StaticMethods_getExpandedDimensions$self$$inline_7936_sectionHeight$$.$getChildIndex$($JSCompiler_StaticMethods_getExpandedDimensions$self$$inline_7936_sectionHeight$$.$_sectionContent$) ? ($JSCompiler_StaticMethods_getExpandedDimensions$self$$inline_7936_sectionHeight$$.$addChild$($JSCompiler_StaticMethods_getExpandedDimensions$self$$inline_7936_sectionHeight$$.$_sectionContent$), $JSCompiler_StaticMethods_getExpandedDimensions$self$$inline_7936_sectionHeight$$.$_sectionContent$.$setTranslateX$($JSCompiler_StaticMethods_getExpandedDimensions$self$$inline_7936_sectionHeight$$.$_paddingX$), 
      $JSCompiler_StaticMethods_getExpandedDimensions$self$$inline_7936_sectionHeight$$.$_sectionContent$.$setTranslateY$($JSCompiler_StaticMethods_getExpandedDimensions$self$$inline_7936_sectionHeight$$.$_headerHeight$ + $JSCompiler_StaticMethods_getExpandedDimensions$self$$inline_7936_sectionHeight$$.$_paddingY$), $dim$$inline_7937$$ = $JSCompiler_StaticMethods_getExpandedDimensions$self$$inline_7936_sectionHeight$$.$getDimensionsWithStroke$(), $JSCompiler_StaticMethods_getExpandedDimensions$self$$inline_7936_sectionHeight$$.removeChild($JSCompiler_StaticMethods_getExpandedDimensions$self$$inline_7936_sectionHeight$$.$_sectionContent$)) : 
      $dim$$inline_7937$$ = $JSCompiler_StaticMethods_getExpandedDimensions$self$$inline_7936_sectionHeight$$.$getDimensionsWithStroke$();
      $JSCompiler_StaticMethods_getExpandedDimensions$self$$inline_7936_sectionHeight$$ = $dim$$inline_7937$$.$h$;
      if($section$$13$$.$_isCollapsible$ && $JSCompiler_StaticMethods_getExpandedDimensions$self$$inline_7936_sectionHeight$$ > $maxCollapsibleSectionHeight$$) {
        $maxCollapsibleSectionHeight$$ = $JSCompiler_StaticMethods_getExpandedDimensions$self$$inline_7936_sectionHeight$$
      }else {
        if(!$section$$13$$.$_isCollapsible$ || this.$_bExpandMany$) {
          $maxFixedSectionHeight$$ += $JSCompiler_StaticMethods_getExpandedDimensions$self$$inline_7936_sectionHeight$$
        }
      }
    }
...
D.$JSCompiler_StaticMethods_getSectionByIndex$$ = function $$JSCompiler_StaticMethods_getSectionByIndex$$$($JSCompiler_StaticMethods_getSectionByIndex$self$$, $index$$224$$) {
  return 0 <= $index$$224$$ && $index$$224$$ < $JSCompiler_StaticMethods_getSectionByIndex$self$$.$_sectionOrder$.length ? $JSCompiler_StaticMethods_getSectionByIndex$self$$.$_sections$[$JSCompiler_StaticMethods_getSectionByIndex$self$$.$_sectionOrder$[$index$$224$$]] : D.$JSCompiler_alias_NULL$$
};
D.$JSCompiler_StaticMethods__drawSections$$ = function $$JSCompiler_StaticMethods__drawSections$$$($JSCompiler_StaticMethods__drawSections$self$$) {
  for(var $currY$$21_dims$$60$$ = 0, $i$$763$$ = 0;$i$$763$$ < $JSCompiler_StaticMethods__drawSections$self$$.$_sectionOrder$.length;$i$$763$$++) {
    var $section$$15$$ = (0,D.$JSCompiler_StaticMethods_getSectionByIndex$$)($JSCompiler_StaticMethods__drawSections$self$$, $i$$763$$);
...
D.$DvtAccordion$$.prototype.$getSections$ = function $$DvtAccordion$$$$$getSections$$() {
  for(var $sections$$5$$ = [], $i$$764$$ = 0;$i$$764$$ < this.$_sectionOrder$.length;$i$$764$$++) {
    $sections$$5$$.push((0,D.$JSCompiler_StaticMethods_getSectionByIndex$$)(this, $i$$764$$))
  }
  return $sections$$5$$
};
D.$DvtAccordionSection$$ = function $$DvtAccordionSection$$$($context$$547$$, $section$$16$$, $title$$18$$, $isActive$$2$$, $isCollapsible$$2$$, $parent$$78$$, $eventManager$$34$$, $id$$253$$, $images$$18$$, $styleMap$$89$$) {
  this.Init($context$$547$$, $section$$16$$, $title$$18$$, $isActive$$2$$, $isCollapsible$$2$$, $parent$$78$$, $eventManager$$34$$, $id$$253$$, $images$$18$$, $styleMap$$89$$)
};
...
D.$JSCompiler_prototypeAlias$$.Init = function $$JSCompiler_prototypeAlias$$$Init$($context$$548$$, $section$$17$$, $title$$19$$, $isActive$$3$$, $isCollapsible$$3$$, $parent$$79$$, $eventManager$$35$$, $id$$254$$, $images$$19$$, $styleMap$$90$$) {
  D.$DvtAccordionSection$$.$superclass$.Init.call(this, $context$$548$$, D.$JSCompiler_alias_NULL$$, $id$$254$$);
  this.$_parent$ = $parent$$79$$;
  this.$_images$ = $images$$19$$;
  this.$_title$ = $title$$19$$;
  this.$_id$ = $id$$254$$;
...
D.$JSCompiler_prototypeAlias$$.$render$ = function $$JSCompiler_prototypeAlias$$$$render$$($base$$inline_7946_width$$150$$) {
  var $height$$inline_7941_text$$inline_7947$$ = this.$_headerHeight$;
  if(this.$_isCollapsible$) {
    var $ariaLabel$$inline_7945_ena$$inline_7942$$, $ovr$$inline_7943$$, $dwn$$inline_7944$$;
    this.$_images$.$getAttr$ ? ($ariaLabel$$inline_7945_ena$$inline_7942$$ = (0,D.$JSCompiler_StaticMethods__createHeaderState$$)(this, 0, this.$_images$.$getAttr$("sectionExpEna"), this.$_title$, $base$$inline_7946_width$$150$$, $height$$inline_7941_text$$inline_7947$$), $ovr$$inline_7943$$ = (0,D.$JSCompiler_StaticMethods__createHeaderState$$)(this, 1, this.$_images$.$getAttr$("sectionExpOvr"), this.$_title$, $base$$inline_7946_width$$150$$, $height$$inline_7941_text$$inline_7947$$), $dwn$$inline_7944$$ = 
    (0,D.$JSCompiler_StaticMethods__createHeaderState$$)(this, 2, this.$_images$.$getAttr$("sectionExpDwn"), this.$_title$, $base$$inline_7946_width$$150$$, $height$$inline_7941_text$$inline_7947$$)) : ($ariaLabel$$inline_7945_ena$$inline_7942$$ = (0,D.$JSCompiler_StaticMethods__createHeaderState$$)(this, 0, this.$_images$.sectionExpEna, this.$_title$, $base$$inline_7946_width$$150$$, $height$$inline_7941_text$$inline_7947$$), $ovr$$inline_7943$$ = (0,D.$JSCompiler_StaticMethods__createHeaderState$$)(this, 
    1, this.$_images$.sectionExpOvr, this.$_title$, $base$$inline_7946_width$$150$$, $height$$inline_7941_text$$inline_7947$$), $dwn$$inline_7944$$ = (0,D.$JSCompiler_StaticMethods__createHeaderState$$)(this, 2, this.$_images$.sectionExpDwn, this.$_title$, $base$$inline_7946_width$$150$$, $height$$inline_7941_text$$inline_7947$$));
    this.$_expandedBtn$ = new D.$DvtButton$$(this.$_context$, $ariaLabel$$inline_7945_ena$$inline_7942$$, $ovr$$inline_7943$$, $dwn$$inline_7944$$);
    this.$_expandedBtn$.$setAriaRole$("button");
    $ariaLabel$$inline_7945_ena$$inline_7942$$ = (0,D.$DvtDisplayable$generateAriaLabel$$)(this.$_title$, [(0,D.$DvtBundle$getTranslatedString$$)("DvtUtilBundle", "STATE_EXPANDED")]);
    this.$_expandedBtn$.$setAriaProperty$("label", $ariaLabel$$inline_7945_ena$$inline_7942$$);
    this.$_images$.$getAttr$ ? ($ariaLabel$$inline_7945_ena$$inline_7942$$ = (0,D.$JSCompiler_StaticMethods__createHeaderState$$)(this, 0, this.$_images$.$getAttr$("sectionColEna"), this.$_title$, $base$$inline_7946_width$$150$$, $height$$inline_7941_text$$inline_7947$$), $ovr$$inline_7943$$ = (0,D.$JSCompiler_StaticMethods__createHeaderState$$)(this, 1, this.$_images$.$getAttr$("sectionColOvr"), this.$_title$, $base$$inline_7946_width$$150$$, $height$$inline_7941_text$$inline_7947$$), $dwn$$inline_7944$$ = 
    (0,D.$JSCompiler_StaticMethods__createHeaderState$$)(this, 2, this.$_images$.$getAttr$("sectionColDwn"), this.$_title$, $base$$inline_7946_width$$150$$, $height$$inline_7941_text$$inline_7947$$)) : ($ariaLabel$$inline_7945_ena$$inline_7942$$ = (0,D.$JSCompiler_StaticMethods__createHeaderState$$)(this, 0, this.$_images$.sectionColEna, this.$_title$, $base$$inline_7946_width$$150$$, $height$$inline_7941_text$$inline_7947$$), $ovr$$inline_7943$$ = (0,D.$JSCompiler_StaticMethods__createHeaderState$$)(this, 
    1, this.$_images$.sectionColOvr, this.$_title$, $base$$inline_7946_width$$150$$, $height$$inline_7941_text$$inline_7947$$), $dwn$$inline_7944$$ = (0,D.$JSCompiler_StaticMethods__createHeaderState$$)(this, 2, this.$_images$.sectionColDwn, this.$_title$, $base$$inline_7946_width$$150$$, $height$$inline_7941_text$$inline_7947$$));
    this.$_collapsedBtn$ = new D.$DvtButton$$(this.$_context$, $ariaLabel$$inline_7945_ena$$inline_7942$$, $ovr$$inline_7943$$, $dwn$$inline_7944$$);
    this.$_collapsedBtn$.$setAriaRole$("button");
    $ariaLabel$$inline_7945_ena$$inline_7942$$ = (0,D.$DvtDisplayable$generateAriaLabel$$)(this.$_title$, [(0,D.$DvtBundle$getTranslatedString$$)("DvtUtilBundle", "STATE_COLLAPSED")]);
    this.$_collapsedBtn$.$setAriaProperty$("label", $ariaLabel$$inline_7945_ena$$inline_7942$$);
    this.$_eventManager$.$associate$(this.$_expandedBtn$, this);
    this.$_eventManager$.$associate$(this.$_collapsedBtn$, this)
  }else {
    $base$$inline_7946_width$$150$$ = (0,D.$JSCompiler_StaticMethods__createButtonBase$$)(this, 3, $base$$inline_7946_width$$150$$, $height$$inline_7941_text$$inline_7947$$), $height$$inline_7941_text$$inline_7947$$ = (0,D.$JSCompiler_StaticMethods__createButtonText$$)(this, this.$_title$), this.$_header$ = new D.$DvtContainer$$(this.$_context$), this.$_header$.$addChild$($base$$inline_7946_width$$150$$), this.$_header$.$addChild$($height$$inline_7941_text$$inline_7947$$)
  }
...
D.$JSCompiler_StaticMethods__createHeaderState$$ = function $$JSCompiler_StaticMethods__createHeaderState$$$($JSCompiler_StaticMethods__createHeaderState$self$$, $base$$6_state$$91$$, $image$$21_uri$$21$$, $label$$69_text$$102$$, $ww$$115$$, $dim$$77_hh$$99$$) {
  ...
  ($image$$21_uri$$21$$ = $image$$21_uri$$21$$ ? new D.$DvtImage$$($JSCompiler_StaticMethods__createHeaderState$self$$.$_context$, $image$$21_uri$$21$$, 0, $imageOffsetY$$, $imageWidth$$, $imageHeight$$) : D.$JSCompiler_alias_NULL$$) && $buttonState$$4$$.$addChild$($image$$21_uri$$21$$);
  $label$$69_text$$102$$ = (0,D.$JSCompiler_StaticMethods__createButtonText$$)($JSCompiler_StaticMethods__createHeaderState$self$$, $label$$69_text$$102$$, $ww$$115$$ - $imageWidth$$ - 0, $dim$$77_hh$$99$$, $buttonState$$4$$);
  (0,D.$DvtAgent$isRightToLeft$$)($JSCompiler_StaticMethods__createHeaderState$self$$.$_context$) ? ($dim$$77_hh$$99$$ = $label$$69_text$$102$$.$measureDimensions$(), $label$$69_text$$102$$.$setTranslateX$($ww$$115$$ - $dim$$77_hh$$99$$.$w$ - $imageWidth$$), $image$$21_uri$$21$$ && $image$$21_uri$$21$$.$setTranslateX$($ww$$115$$ - $imageWidth$$)) : $label$$69_text$$102$$.$setTranslateX$($imageWidth$$);
  $JSCompiler_StaticMethods__createHeaderState$self$$.$_keyboardFocusEffect$ || $JSCompiler_StaticMethods__createHeaderState$self$$.$_createKeyboardFocusEffect$($image$$21_uri$$21$$ ? $image$$21_uri$$21$$ : $label$$69_text$$102$$);
  return $buttonState$$4$$
};
D.$JSCompiler_StaticMethods__createButtonText$$ = function $$JSCompiler_StaticMethods__createButtonText$$$($JSCompiler_StaticMethods__createButtonText$self$$, $dims$$61_label$$70$$, $ww$$116$$, $hh$$100$$, $container$$167$$) {
  var $text$$103$$ = D.$JSCompiler_alias_NULL$$;
  if($dims$$61_label$$70$$) {
    $text$$103$$ = new D.$DvtOutputText$$($JSCompiler_StaticMethods__createButtonText$self$$.$_context$, $dims$$61_label$$70$$);
    $text$$103$$.$setCSSStyle$($JSCompiler_StaticMethods__createButtonText$self$$.$_titleStyle$);
    D.$DvtTextUtils$$.$fitText$($text$$103$$, $ww$$116$$, $hh$$100$$, $container$$167$$);
    $dims$$61_label$$70$$ = $text$$103$$.$measureDimensions$();
    if(!$JSCompiler_StaticMethods__createButtonText$self$$.$_titleDim$ || $JSCompiler_StaticMethods__createButtonText$self$$.$_titleDim$.$w$ < $dims$$61_label$$70$$.$w$ || $JSCompiler_StaticMethods__createButtonText$self$$.$_titleDim$.$h$ < $dims$$61_label$$70$$.$h$) {
      $JSCompiler_StaticMethods__createButtonText$self$$.$_titleDim$ = $dims$$61_label$$70$$
    }
    $text$$103$$.$setTranslateY$(($JSCompiler_StaticMethods__createButtonText$self$$.$_headerHeight$ - $dims$$61_label$$70$$.$h$) / 2)
  }
  return $text$$103$$
};
...
D.$DvtAccordionSection$_getFill$$ = function $$DvtAccordionSection$_getFill$$$($angle$$53_gradObj$$6_style$$100$$) {
  ...
  var $arAlphas$$32_fill$$72$$ = D.$JSCompiler_alias_NULL$$;
  if($angle$$53_gradObj$$6_style$$100$$ && $angle$$53_gradObj$$6_style$$100$$ instanceof D.$DvtCSSGradient$$) {
    var $arColors$$34_color$$86$$ = $angle$$53_gradObj$$6_style$$100$$.$_arColors$, $arAlphas$$32_fill$$72$$ = $angle$$53_gradObj$$6_style$$100$$.$_arAlphas$, $arStops$$27$$ = $angle$$53_gradObj$$6_style$$100$$.$_arRatios$;
    $angle$$53_gradObj$$6_style$$100$$ = $angle$$53_gradObj$$6_style$$100$$.$getAngle$();
    $arAlphas$$32_fill$$72$$ = new D.$DvtLinearGradientFill$$($angle$$53_gradObj$$6_style$$100$$, $arColors$$34_color$$86$$, $arAlphas$$32_fill$$72$$, $arStops$$27$$)
  }else {
    $arColors$$34_color$$86$$ && ($arAlphas$$32_fill$$72$$ = new D.$DvtSolidFill$$($arColors$$34_color$$86$$, 1))
  }
  return $arAlphas$$32_fill$$72$$
};
...
D.$JSCompiler_prototypeAlias$$.$getKeyboardBoundingBox$ = function $$JSCompiler_prototypeAlias$$$$getKeyboardBoundingBox$$() {
  var $obj$$326_stageP2$$5$$ = this.$_isActive$ ? this.$_expandedBtn$ : this.$_collapsedBtn$, $bounds$$142$$ = $obj$$326_stageP2$$5$$.$getDimensions$(), $stageP1$$5$$ = (0,D.$JSCompiler_StaticMethods_localToStage$$)($obj$$326_stageP2$$5$$, new D.$DvtPoint$$($bounds$$142$$.x, $bounds$$142$$.y)), $obj$$326_stageP2$$5$$ = (0,D.$JSCompiler_StaticMethods_localToStage$$)($obj$$326_stageP2$$5$$, new D.$DvtPoint$$($bounds$$142$$.x + $bounds$$142$$.$w$, $bounds$$142$$.y + $bounds$$142$$.$h$));
  return new D.$DvtRectangle$$($stageP1$$5$$.x, $stageP1$$5$$.y, $obj$$326_stageP2$$5$$.x - $stageP1$$5$$.x, $obj$$326_stageP2$$5$$.y - $stageP1$$5$$.y)
};
D.$JSCompiler_prototypeAlias$$.$getTargetElem$ = function $$JSCompiler_prototypeAlias$$$$getTargetElem$$() {
...
D.$JSCompiler_prototypeAlias$$.$isShowingKeyboardFocusEffect$ = (0,D.$JSCompiler_get$$)("$_isShowingKeyboardFocusEffect$");
D.$JSCompiler_prototypeAlias$$.$getNextNavigable$ = function $$JSCompiler_prototypeAlias$$$$getNextNavigable$$($event$$704$$) {
  return this.$_eventManager$.$KeyboardHandler$.$getNextNavigable$(this, $event$$704$$)
};
D.$JSCompiler_prototypeAlias$$.$_createKeyboardFocusEffect$ = function $$JSCompiler_prototypeAlias$$$$_createKeyboardFocusEffect$$($obj$$328_y$$226$$) {
  var $dim$$78$$ = $obj$$328_y$$226$$.$getDimensions$(), $x$$250$$ = $obj$$328_y$$226$$.$getTranslateX$() || $dim$$78$$.x;
  $obj$$328_y$$226$$ = $obj$$328_y$$226$$.$getTranslateY$() || $dim$$78$$.y;
  this.$_keyboardFocusEffect$ = new D.$DvtKeyboardFocusEffect$$(this.$getCtx$(), this, new D.$DvtRectangle$$($x$$250$$, $obj$$328_y$$226$$, $dim$$78$$.$w$, $dim$$78$$.$h$), D.$JSCompiler_alias_NULL$$, D.$JSCompiler_alias_NULL$$, D.$JSCompiler_alias_TRUE$$)
};
...
D.$DvtTrain$$ = function $$DvtTrain$$$($context$$551$$, $eventManager$$36$$, $labels$$21$$, $buttonStyles$$12$$, $id$$257$$, $isAltaSkin$$4$$) {
  this.Init($context$$551$$, $eventManager$$36$$, $labels$$21$$, $buttonStyles$$12$$, $id$$257$$, $isAltaSkin$$4$$)
};
D.$DvtObj$$.$createSubclass$(D.$DvtTrain$$, D.$DvtContainer$$, "DvtTrain");
D.$DvtTrain$$.prototype.Init = function $$DvtTrain$$$$Init$($context$$552$$, $eventManager$$37$$, $labels$$22$$, $buttonStyles$$13$$, $id$$258$$, $isAltaSkin$$5$$) {
  D.$DvtTrain$$.$superclass$.Init.call(this, $context$$552$$, D.$JSCompiler_alias_NULL$$, $id$$258$$);
  this.$_tooltipManager$ = $context$$552$$.$getTooltipManager$();
...
D.$DvtTrain$$.prototype.$setSelectedIndex$ = function $$DvtTrain$$$$$setSelectedIndex$$($index$$225$$) {
  0 <= $index$$225$$ && $index$$225$$ < this.$_count$ && (0,D.$JSCompiler_StaticMethods_SelectedIndexChanged$$)(this, this.$_selectedIndex$, $index$$225$$)
};
D.$DvtTrain$$.prototype.$HandleClick$ = function $$DvtTrain$$$$$HandleClick$$($event$$705_selIndex$$3$$) {
  (0,D.$DvtEventManager$consumeEvent$$)($event$$705_selIndex$$3$$);
  for(var $event$$inline_7953_i$$765$$ = 0;$event$$inline_7953_i$$765$$ < this.$_buttons$.length;$event$$inline_7953_i$$765$$++) {
    var $target$$124$$ = $event$$705_selIndex$$3$$.target;
    if(this.$_buttons$[$event$$inline_7953_i$$765$$] === $target$$124$$ || this.$_buttons$[$event$$inline_7953_i$$765$$] === $target$$124$$.getParent()) {
      $event$$705_selIndex$$3$$ = this.$_selectedIndex$;
      (0,D.$JSCompiler_StaticMethods_SelectedIndexChanged$$)(this, $event$$705_selIndex$$3$$, $event$$inline_7953_i$$765$$);
      $event$$705_selIndex$$3$$ != $event$$inline_7953_i$$765$$ && ($event$$inline_7953_i$$765$$ = new D.$DvtTrainEvent$$(this.$_selectedIndex$), this.$FireListener$($event$$inline_7953_i$$765$$, D.$JSCompiler_alias_FALSE$$));
      break
    }
  }
};
...
D.$DvtTrain$$.prototype.$RenderSelf$ = function $$DvtTrain$$$$$RenderSelf$$($eventManager$$38$$) {
  var $bBiDi$$6$$ = (0,D.$DvtAgent$isRightToLeft$$)(this.$getCtx$()), $buttonSize_buttonStyle$$inline_7956$$;
  if(!this.$_buttonSize$) {
    if(this.$_buttonStyles$ && ($buttonSize_buttonStyle$$inline_7956$$ = this.$_buttonStyles$[0])) {
      this.$_buttonSize$ = (0,D.$DvtCSSStyle$toNumber$$)($buttonSize_buttonStyle$$inline_7956$$.getWidth())
    }
    this.$_buttonSize$ || (this.$_buttonSize$ = 8)
  }
  $buttonSize_buttonStyle$$inline_7956$$ = this.$_buttonSize$;
  for(var $i$$766$$ = 0;$i$$766$$ < this.$_count$;$i$$766$$++) {
    var $button$$75$$, $button$$inline_7959_j$$104$$ = $button$$75$$ = this.$CreateButton$($buttonSize_buttonStyle$$inline_7956$$, $i$$766$$ == this.$_selectedIndex$, this.$_labels$[$i$$766$$]);
    $button$$inline_7959_j$$104$$.$addEvtListener$(D.$DvtTouchEvent$$.$TOUCHSTART$, this.$HandleClick$, D.$JSCompiler_alias_FALSE$$, this);
    (0,D.$DvtAgent$isTouchDevice$$)() || $button$$inline_7959_j$$104$$.$addEvtListener$(D.$DvtMouseEvent$CLICK$$, this.$HandleClick$, D.$JSCompiler_alias_FALSE$$, this);
    $button$$inline_7959_j$$104$$ = $i$$766$$;
    $bBiDi$$6$$ && ($button$$inline_7959_j$$104$$ = this.$_count$ - 1 - $i$$766$$);
    $eventManager$$38$$ && $eventManager$$38$$.$associate$($button$$75$$, $button$$75$$);
    (0,D.$JSCompiler_StaticMethods_setTranslate$$)($button$$75$$, $button$$inline_7959_j$$104$$ * ($buttonSize_buttonStyle$$inline_7956$$ + 3), this.$_isAltaSkin$ ? 0 : 1);
    this.$addChild$($button$$75$$);
    this.$_buttons$[$i$$766$$] = $button$$75$$
  }
};
...
D.$JSCompiler_StaticMethods_MakeButtonState$$ = function $$JSCompiler_StaticMethods_MakeButtonState$$$($JSCompiler_StaticMethods_MakeButtonState$self_JSCompiler_temp$$144_shape$$89_shape$$inline_7968$$, $buttonSize$$3$$, $state$$94$$, $bSelected$$5$$) {
  var $bdColor$$inline_7965_style$$102_url$$27$$ = $JSCompiler_StaticMethods_MakeButtonState$self_JSCompiler_temp$$144_shape$$89_shape$$inline_7968$$.$_buttonStyles$ ? $JSCompiler_StaticMethods_MakeButtonState$self_JSCompiler_temp$$144_shape$$89_shape$$inline_7968$$.$_buttonStyles$[$state$$94$$] : D.$JSCompiler_alias_NULL$$;
  if($bdColor$$inline_7965_style$$102_url$$27$$ = $bdColor$$inline_7965_style$$102_url$$27$$ ? $bdColor$$inline_7965_style$$102_url$$27$$.$getStyle$("content") : D.$JSCompiler_alias_NULL$$) {
    $JSCompiler_StaticMethods_MakeButtonState$self_JSCompiler_temp$$144_shape$$89_shape$$inline_7968$$ = $JSCompiler_StaticMethods_MakeButtonState$self_JSCompiler_temp$$144_shape$$89_shape$$inline_7968$$.$CreateButtonState$($bdColor$$inline_7965_style$$102_url$$27$$, $buttonSize$$3$$)
  }else {
    var $buttonStyle$$inline_7964$$, $bgColor$$inline_7966$$, $offset$$inline_7967$$;
    2 == $state$$94$$ ? ($offset$$inline_7967$$ = 0, $bgColor$$inline_7966$$ = "#61bde3", $bdColor$$inline_7965_style$$102_url$$27$$ = "#0066ff", $JSCompiler_StaticMethods_MakeButtonState$self_JSCompiler_temp$$144_shape$$89_shape$$inline_7968$$.$_buttonStyles$ && ($buttonStyle$$inline_7964$$ = $JSCompiler_StaticMethods_MakeButtonState$self_JSCompiler_temp$$144_shape$$89_shape$$inline_7968$$.$_buttonStyles$[2])) : ($offset$$inline_7967$$ = 1, $bgColor$$inline_7966$$ = "#c0cbd5", $bdColor$$inline_7965_style$$102_url$$27$$ = 
    "#5d7891", $JSCompiler_StaticMethods_MakeButtonState$self_JSCompiler_temp$$144_shape$$89_shape$$inline_7968$$.$_buttonStyles$ && ($buttonStyle$$inline_7964$$ = $JSCompiler_StaticMethods_MakeButtonState$self_JSCompiler_temp$$144_shape$$89_shape$$inline_7968$$.$_buttonStyles$[0]));
    $buttonStyle$$inline_7964$$ && ($buttonStyle$$inline_7964$$.$getStyle$("border-color") && ($bdColor$$inline_7965_style$$102_url$$27$$ = $buttonStyle$$inline_7964$$.$getStyle$("border-color")), $buttonStyle$$inline_7964$$.$getStyle$("background-color") && ($bgColor$$inline_7966$$ = $buttonStyle$$inline_7964$$.$getStyle$("background-color")));
    $JSCompiler_StaticMethods_MakeButtonState$self_JSCompiler_temp$$144_shape$$89_shape$$inline_7968$$ = new D.$DvtRect$$($JSCompiler_StaticMethods_MakeButtonState$self_JSCompiler_temp$$144_shape$$89_shape$$inline_7968$$.$getCtx$(), $offset$$inline_7967$$, $offset$$inline_7967$$, $buttonSize$$3$$ - 2 * $offset$$inline_7967$$, $buttonSize$$3$$ - 2 * $offset$$inline_7967$$);
    $JSCompiler_StaticMethods_MakeButtonState$self_JSCompiler_temp$$144_shape$$89_shape$$inline_7968$$.$setSolidFill$($bgColor$$inline_7966$$);
    $JSCompiler_StaticMethods_MakeButtonState$self_JSCompiler_temp$$144_shape$$89_shape$$inline_7968$$.$setSolidStroke$($bdColor$$inline_7965_style$$102_url$$27$$)
  }
  $JSCompiler_StaticMethods_MakeButtonState$self_JSCompiler_temp$$144_shape$$89_shape$$inline_7968$$.setCursor(0 == $state$$94$$ || $bSelected$$5$$ ? "default" : "pointer");
  return $JSCompiler_StaticMethods_MakeButtonState$self_JSCompiler_temp$$144_shape$$89_shape$$inline_7968$$
};
D.$DvtTrain$$.prototype.$CreateButton$ = function $$DvtTrain$$$$$CreateButton$$($button$$78_buttonSize$$4$$, $bSelected$$6$$, $tooltip$$52$$) {
  $button$$78_buttonSize$$4$$ = new D.$DvtButton$$(this.$getCtx$(), (0,D.$JSCompiler_StaticMethods_MakeButtonState$$)(this, $button$$78_buttonSize$$4$$, 0, $bSelected$$6$$), (0,D.$JSCompiler_StaticMethods_MakeButtonState$$)(this, $button$$78_buttonSize$$4$$, 1, $bSelected$$6$$), (0,D.$JSCompiler_StaticMethods_MakeButtonState$$)(this, $button$$78_buttonSize$$4$$, 2, $bSelected$$6$$), D.$JSCompiler_alias_NULL$$);
  $button$$78_buttonSize$$4$$.$setTooltip$($tooltip$$52$$);
  $button$$78_buttonSize$$4$$.$_bToggleEnabled$ = D.$JSCompiler_alias_TRUE$$;
  $bSelected$$6$$ && (0,D.$JSCompiler_StaticMethods_setToggled$$)($button$$78_buttonSize$$4$$, $bSelected$$6$$);
  return $button$$78_buttonSize$$4$$
};
D.$DvtTrainEvent$$ = function $$DvtTrainEvent$$$($index$$226$$) {
  this.Init("dvtTrain");
  this.type = this.$getType$();
  this.$_index$ = $index$$226$$
};
...
D.DvtOverviewWindow = function $DvtOverviewWindow$($context$$549$$, $id$$255$$, $x$$251$$, $y$$227$$, $ww$$118$$, $hh$$102$$) {
  this.Init($context$$549$$, $id$$255$$, $x$$251$$, $y$$227$$, $ww$$118$$, $hh$$102$$)
};
...
D.$JSCompiler_prototypeAlias$$.Init = function $$JSCompiler_prototypeAlias$$$Init$($context$$550$$, $id$$256$$, $x$$252$$, $y$$228$$, $ww$$119$$, $hh$$103$$) {
  D.DvtOverviewWindow.$superclass$.Init.call(this, $context$$550$$, D.$JSCompiler_alias_NULL$$, $id$$256$$);
  this.$_x$ = $x$$252$$;
  this.$_y$ = $y$$228$$;
  this.$_ww$ = $ww$$119$$;
  this.$_hh$ = $hh$$103$$;
...
D.$JSCompiler_prototypeAlias$$.$render$ = function $$JSCompiler_prototypeAlias$$$$render$$() {
  ...
  var $bgColor$$13_clipPath$$14$$ = new D.$DvtClipPath$$(this.getId());
  (0,D.$JSCompiler_StaticMethods_addRect$$)($bgColor$$13_clipPath$$14$$, 0, 0, this.$_ww$, this.$_hh$);
  this.$_overview$ = new D.$DvtRect$$(this.$_context$, 0, 0, this.$_ww$, this.$_hh$);
  (0,D.$JSCompiler_StaticMethods_setClipPath$$)(this.$_overview$, $bgColor$$13_clipPath$$14$$);
  ...
  $bgColor$$13_clipPath$$14$$ = this.$getSkinStyleAttr$(D.DvtOverviewWindow.$VIEWPORT_BG_COLOR$);
  this.$_viewport$.$setSolidStroke$(this.$getSkinStyleAttr$(D.DvtOverviewWindow.$VIEWPORT_BORDER_COLOR$), D.$JSCompiler_alias_NULL$$, 2);
  this.$_viewport$.$setSolidFill$($bgColor$$13_clipPath$$14$$);
...
D.$JSCompiler_StaticMethods__getCenteredViewportDimensions$$ = function $$JSCompiler_StaticMethods__getCenteredViewportDimensions$$$($JSCompiler_StaticMethods__getCenteredViewportDimensions$self$$, $pos$$67$$) {
  var $overviewStart_topLeft$$6$$ = (0,D.$JSCompiler_StaticMethods_localToStage$$)($JSCompiler_StaticMethods__getCenteredViewportDimensions$self$$.$_overview$, new D.$DvtPoint$$(0, 0)), $bottomRight$$6_viewportDims$$ = $JSCompiler_StaticMethods__getCenteredViewportDimensions$self$$.$_viewport$.$getDimensions$(), $centeredViewportX$$ = $pos$$67$$.x - $overviewStart_topLeft$$6$$.x - $bottomRight$$6_viewportDims$$.$w$ / 2, $centeredViewportY$$ = $pos$$67$$.y - $overviewStart_topLeft$$6$$.y - $bottomRight$$6_viewportDims$$.$h$ / 
...
D.DvtOverviewWindow.prototype.$getDimensions$ = function $DvtOverviewWindow$$$getDimensions$$($targetCoordinateSpace$$54$$) {
  var $bounds$$143$$ = new D.$DvtRectangle$$(0, 0, this.$_ww$, this.$_hh$);
  return!$targetCoordinateSpace$$54$$ || $targetCoordinateSpace$$54$$ === this ? $bounds$$143$$ : (0,D.$JSCompiler_StaticMethods_ConvertCoordSpaceRect$$)(this, $bounds$$143$$, $targetCoordinateSpace$$54$$)
};
