...
define(["ojs/ojcore", "jquery", "ojs/ojdatacollection-common", "ojs/ojmodel"], function($oj$$47$$) {
  ...
  $oj$$47$$.$CollectionDataGridDataSource$.prototype.$_getRanges$ = function $$oj$$47$$$$CollectionDataGridDataSource$$$$_getRanges$$($cellRanges$$5$$) {
    var $i$$428$$, $cellRange$$6$$, $rowStart$$4$$, $rowCount$$8$$, $colStart$$1$$, $colCount$$1$$;
    for ($i$$428$$ = 0;$i$$428$$ < $cellRanges$$5$$.length;$i$$428$$ += 1) {
      $cellRange$$6$$ = $cellRanges$$5$$[$i$$428$$], $oj$$47$$.$Assert$.assert("row" === $cellRange$$6$$.axis || "column" === $cellRange$$6$$.axis), $oj$$47$$.$Assert$.assert(0 < $cellRange$$6$$.count), "row" === $cellRange$$6$$.axis ? ($rowStart$$4$$ = $cellRange$$6$$.start, $rowCount$$8$$ = $cellRange$$6$$.count) : "column" === $cellRange$$6$$.axis && ($colStart$$1$$ = $cellRange$$6$$.start, $colCount$$1$$ = $cellRange$$6$$.count);
    }
  ...
  $oj$$47$$.$CollectionDataGridDataSource$.prototype.$_resolveModels$ = function $$oj$$47$$$$CollectionDataGridDataSource$$$$_resolveModels$$($i$$429_rowStart$$6$$, $rowEnd$$2$$, $set$$4$$, $ranges$$1$$, $callbacks$$58$$, $callbackObjects$$27$$) {
    var $promises$$;
    for ($promises$$ = [];$i$$429_rowStart$$6$$ < $rowEnd$$2$$;$i$$429_rowStart$$6$$++) {
      $promises$$.push(this.$collection$.at($i$$429_rowStart$$6$$, {deferred:!0}));
    }
  ...
  $oj$$47$$.$CollectionDataGridDataSource$.prototype.$_fetchCells$ = function $$oj$$47$$$$CollectionDataGridDataSource$$$$_fetchCells$$($cellRanges$$9_ranges$$2$$) {
    ...
    }.bind(this), function($e$$145$$) {
      this.$_fetchCellsError$($e$$145$$);
    }.bind(this));
  };
  ...
  $oj$$47$$.$CollectionDataGridDataSource$.prototype.keys = function $$oj$$47$$$$CollectionDataGridDataSource$$$keys$($indexes$$24$$) {
    var $rowIndex$$10$$, $columnIndex$$4$$, $rowKey$$38$$, $columnKey$$5$$, $atPromise$$, $self$$185$$;
    $rowIndex$$10$$ = $indexes$$24$$.row;
    $columnIndex$$4$$ = $indexes$$24$$.column;
    $self$$185$$ = this;
    return new Promise(function($resolve$$57$$) {
      $atPromise$$ = $self$$185$$.$collection$.at($rowIndex$$10$$, {deferred:!0});
      null != $atPromise$$ ? $atPromise$$.then(function($rowModel$$) {
        $rowKey$$38$$ = $oj$$47$$.$CollectionDataGridUtils$.$_getModelKey$($rowModel$$);
        null == $self$$185$$.columns && $self$$185$$.$_setupColumns$($rowModel$$);
        $columnKey$$5$$ = $self$$185$$.columns[$columnIndex$$4$$];
        $resolve$$57$$({row:null == $rowKey$$38$$ ? null : $rowKey$$38$$, column:null == $columnKey$$5$$ ? null : $columnKey$$5$$});
      }.bind($self$$185$$)) : $resolve$$57$$({row:null, column:null});
    });
  };
  ...
  $oj$$47$$.$CollectionDataGridDataSource$.prototype.$indexes$ = function $$oj$$47$$$$CollectionDataGridDataSource$$$$indexes$$($keys$$40$$) {
    var $rowKey$$39$$, $columnKey$$6$$, $columnIndex$$5$$, $self$$186$$;
    $rowKey$$39$$ = $keys$$40$$.row;
    $columnKey$$6$$ = $keys$$40$$.column;
    $self$$186$$ = this;
    return new Promise(function($resolve$$58$$) {
      $self$$186$$.$collection$.indexOf($rowKey$$39$$, {deferred:!0}).then(function($rowIndex$$11$$) {
        null == $self$$186$$.columns ? $self$$186$$.$collection$.first(1, {deferred:!0}).then(function($model$$80$$) {
          $self$$186$$.$_setupColumns$($model$$80$$);
          $columnIndex$$5$$ = $self$$186$$.columns.indexOf($columnKey$$6$$);
          $resolve$$58$$({row:$rowIndex$$11$$, column:$columnIndex$$5$$});
        }.bind($self$$186$$)) : ($columnIndex$$5$$ = $self$$186$$.columns.indexOf($columnKey$$6$$), $resolve$$58$$({row:$rowIndex$$11$$, column:$columnIndex$$5$$}));
      }.bind($self$$186$$));
    });
  };
  ...
  $oj$$47$$.$CollectionDataGridDataSource$.prototype.$_getModelEvent$ = function $$oj$$47$$$$CollectionDataGridDataSource$$$$_getModelEvent$$($operation$$7$$, $rowKey$$40$$, $columnKey$$7$$, $rowIndex$$12$$, $columnIndex$$6$$) {
    var $event$$541$$ = {source:this};
    $event$$541$$.operation = $operation$$7$$;
    $event$$541$$.keys = {row:$rowKey$$40$$, column:$columnKey$$7$$};
    $event$$541$$.indexes = {row:$rowIndex$$12$$, column:$columnIndex$$6$$};
    return $event$$541$$;
  };
  $oj$$47$$.$CollectionDataGridDataSource$.prototype.$_handleModelAdded$ = function $$oj$$47$$$$CollectionDataGridDataSource$$$$_handleModelAdded$$($model$$81$$) {
    ...
    this.$collection$.indexOf($model$$81$$, {deferred:!0}).then(function($index$$277$$) {
      ...
      $event$$542$$ = this.$_getModelEvent$("insert", $rowKey$$41$$, null, $index$$277$$, -1);
      this.handleEvent("change", $event$$542$$);
    }.bind(this));
  };
  ...
  $oj$$47$$.$CollectionDataGridDataSource$.prototype.$_handleModelChanged$ = function $$oj$$47$$$$CollectionDataGridDataSource$$$$_handleModelChanged$$($model$$83$$) {
    ...
    this.$collection$.indexOf($model$$83$$, {deferred:!0}).then(function($index$$278$$) {
      ...
      $event$$544$$ = this.$_getModelEvent$("update", $rowKey$$43$$, null, $index$$278$$, -1);
      this.handleEvent("change", $event$$544$$);
    }.bind(this));
  };
