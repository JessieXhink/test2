...
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore"], function($oj$$59$$, $$$$54$$) {
  (function() {
    $oj$$59$$.$__registerWidget$("oj.ojToolbar", $$$$54$$.oj.baseComponent, {widgetEventPrefix:"oj", options:{}, $_InitOptions$:function($originalDefaults$$18$$, $constructorOptions$$20$$) {
      ...
      this.$_setup$(!0);
    }, $_NotifyContextMenuGesture$:function($currentButton$$1_menu$$28$$, $event$$571$$, $eventType$$57$$) {
      $currentButton$$1_menu$$28$$ = this.element.find(":oj-button[tabindex\x3d0]");
      this.$_OpenContextMenu$($event$$571$$, $eventType$$57$$, {launcher:$currentButton$$1_menu$$28$$, position:{of:"keyboard" === $eventType$$57$$ ? $currentButton$$1_menu$$28$$.ojButton("widget") : $event$$571$$}});
      ...
      this.$$buttons$ = this.element.find(":oj-button").unbind("keydown" + this.eventNamespace).bind("keydown" + this.eventNamespace, function($event$$572$$) {
        $self$$192$$.$_handleKeyDown$($event$$572$$, $$$$54$$(this));
      }).unbind("click" + this.eventNamespace).bind("click" + this.eventNamespace, function() {
        $$$$54$$(this).ojButton("option", "disabled") || $self$$192$$.$_setTabStop$($$$$54$$(this));
      }).unbind("focus" + this.eventNamespace).bind("focus" + this.eventNamespace, function() {
        $self$$192$$.$_setTabStop$($$$$54$$(this));
      });
    ...
    }, $_handleKeyDown$:function($event$$575$$, $$button$$5$$) {
      switch($event$$575$$.which) {
        case $$$$54$$.ui.keyCode.LEFT:
        ;
        case $$$$54$$.ui.keyCode.RIGHT:
          $event$$575$$.preventDefault();
          var $$enabledButtons$$3$$ = this.$$enabledButtons$, $length$$19$$ = $$enabledButtons$$3$$.length;
          if (2 > $length$$19$$) {
            break;
          }
          var $oldIndex$$2$$ = $$enabledButtons$$3$$.index($$button$$5$$);
          $$enabledButtons$$3$$.eq(($oldIndex$$2$$ + ($event$$575$$.which == $$$$54$$.ui.keyCode.RIGHT ^ this.$isRtl$ ? 1 : -1) + $length$$19$$) % $length$$19$$).focus();
          break;
        case $$$$54$$.ui.keyCode.UP:
        ;
        case $$$$54$$.ui.keyCode.DOWN:
          "radio" == $$button$$5$$.attr("type") && $event$$575$$.preventDefault();
      }
    }, _destroy:function() {
