...
define(["ojs/ojcore", "jquery", "ojs/ojdatacollection-common", "ojs/ojmodel"], function($oj$$44$$) {
    ...
    if (null === $parent$$46$$) {
      ...
      this.$_getModelForId$(this.$rootCollection$, $parent$$46$$, 0).then(function($collection$$35_parentModel$$) {
        if ($collection$$35_parentModel$$) {
          $collection$$35_parentModel$$ = $self$$164$$.$GetChildCollection$($collection$$35_parentModel$$.$model$);
          try {
            $self$$164$$.$FetchCollection$($collection$$35_parentModel$$, $start$$49$$, $count$$49$$, $callbacks$$48$$, $parent$$46$$);
          } catch ($error$$44$$) {
  ...
  $oj$$44$$.$CollectionTreeDataSource$.prototype.$ModelAdded$ = function $$oj$$44$$$$CollectionTreeDataSource$$$$ModelAdded$$($event$$517_model$$60$$, $collection$$36_parents$$5$$, $options$$361$$) {
    var $index$$243$$ = 0;
    $options$$361$$ && $options$$361$$.at && ($index$$243$$ = $options$$361$$.at);
    $collection$$36_parents$$5$$ = this.$_getParentChain$($collection$$36_parents$$5$$);
    $event$$517_model$$60$$ = this.$_createEvent$(this, "insert", $index$$243$$, $collection$$36_parents$$5$$, this.$_putModelInNodeSet$(null != $collection$$36_parents$$5$$ && 0 < $collection$$36_parents$$5$$.length ? $collection$$36_parents$$5$$[$collection$$36_parents$$5$$.length - 1] : null, $event$$517_model$$60$$));
    this.handleEvent("change", $event$$517_model$$60$$);
  };
  $oj$$44$$.$CollectionTreeDataSource$.prototype.$ModelRemoved$ = function $$oj$$44$$$$CollectionTreeDataSource$$$$ModelRemoved$$($event$$518_model$$61$$, $collection$$37$$, $options$$362$$) {
    var $index$$244$$ = 0;
    $options$$362$$ && $options$$362$$.index && ($index$$244$$ = $options$$362$$.index);
    this.$_removeCollectionFromCache$($event$$518_model$$61$$);
    $event$$518_model$$61$$ = this.$_createEvent$(this, "delete", $index$$244$$, this.$_getParentChain$($collection$$37$$), null);
    this.handleEvent("change", $event$$518_model$$61$$);
  };
  $oj$$44$$.$CollectionTreeDataSource$.prototype.$ModelUpdated$ = function $$oj$$44$$$$CollectionTreeDataSource$$$$ModelUpdated$$($event$$519_model$$62$$) {
    var $collectionForModel$$ = this.$_getCollectionForModel$($event$$519_model$$62$$), $index$$245$$ = null, $parents$$6$$ = null;
    $collectionForModel$$ && ($index$$245$$ = $collectionForModel$$.index, $parents$$6$$ = this.$_getParentChain$($collectionForModel$$.$collection$));
    $event$$519_model$$62$$ = this.$_createEvent$(this, "update", $index$$245$$, $parents$$6$$, this.$_putModelInNodeSet$(null != $parents$$6$$ && 0 < $parents$$6$$.length ? $parents$$6$$[$parents$$6$$.length - 1] : null, $event$$519_model$$62$$));
    this.handleEvent("change", $event$$519_model$$62$$);
  };
  $oj$$44$$.$CollectionTreeDataSource$.prototype.$CollectionRefreshed$ = function $$oj$$44$$$$CollectionTreeDataSource$$$$CollectionRefreshed$$($collection$$38_event$$520$$) {
    $collection$$38_event$$520$$ = this.$_createEvent$(this, "refresh", null, this.$_getParentChain$($collection$$38_event$$520$$), null);
    this.handleEvent("refresh", $collection$$38_event$$520$$);
  };
  ...
  $oj$$44$$.$CollectionTreeDataSource$.prototype.$_keyInCollection$ = function $$oj$$44$$$$CollectionTreeDataSource$$$$_keyInCollection$$($key$$160$$, $collection$$42$$) {
    for (var $count$$50$$ = $collection$$42$$.length, $i$$425$$ = 0;$i$$425$$ < $count$$50$$;$i$$425$$++) {
      var $currKey$$1$$ = this.$_getCacheKey$($collection$$42$$.at($i$$425$$));
  ...
  $oj$$44$$.$CollectionTreeDataSource$.prototype.$_getCollectionForModel$ = function $$oj$$44$$$$CollectionTreeDataSource$$$$_getCollectionForModel$$($model$$68$$) {
    for (var $prop$$68$$ in this.$cache$) {
      if (this.$cache$.hasOwnProperty($prop$$68$$)) {
        for (var $collection$$43$$ = this.$cache$[$prop$$68$$], $i$$426$$ = 0;$i$$426$$ < $collection$$43$$.length;$i$$426$$++) {
          if ($collection$$43$$.at($i$$426$$) === $model$$68$$) {
            return{index:$i$$426$$, $collection$:$collection$$43$$};
          }
        }
      }
    }
  ...
  $oj$$44$$.$CollectionTreeDataSource$.prototype.$_createEvent$ = function $$oj$$44$$$$CollectionTreeDataSource$$$$_createEvent$$($source$$12$$, $operation$$6$$, $index$$246$$, $parent$$51$$, $data$$171$$) {
    return{source:$source$$12$$, operation:$operation$$6$$, index:$index$$246$$, parent:$parent$$51$$, data:$data$$171$$};
  };
  $oj$$44$$.$CollectionTreeDataSource$.prototype.$FetchCollection$ = function $$oj$$44$$$$CollectionTreeDataSource$$$$FetchCollection$$($collection$$47$$, $start$$50$$, $count$$51$$, $callbacks$$49$$, $parent$$52$$) {
    var $self$$165$$ = this;
    null === $collection$$47$$ && (($collection$$47$$ = this.$__getParentsChildCollectionFromCache$(null)) ? $collection$$47$$ = {$collection$:$collection$$47$$, $cached$:!0} : ($collection$$47$$ = {$collection$:$self$$165$$.$rootCollection$, $cached$:!1}, $self$$165$$.$_setCollectionInCache$(null, this.$rootCollection$)));
    $collection$$47$$ && $self$$165$$.$_fetch$($collection$$47$$, function($coll$$5$$) {
      $callbacks$$49$$.success && $callbacks$$49$$.success($self$$165$$.$_getNodeSet$($coll$$5$$, $parent$$52$$, $start$$50$$, $count$$51$$));
    }, $callbacks$$49$$.error);
  };
    ...
    return new Promise(function($resolve$$54$$) {
      function $checkNext$$($index$$247$$, $collection$$50$$, $key$$163$$) {
        $index$$247$$ < $collection$$50$$.length ? $collection$$50$$.at($index$$247$$, {deferred:!0}).then(function($model$$69$$) {
          if ($model$$69$$) {
            var $parse$$5$$ = $self$$166$$.$parseMetadata$($model$$69$$);
  ...
  $oj$$44$$.$CollectionTreeDataSource$.prototype.$_getModelForId$ = function $$oj$$44$$$$CollectionTreeDataSource$$$$_getModelForId$$($collection$$51$$, $key$$164$$, $depth$$25$$) {
    ...
    return new Promise(function($resolve$$55$$) {
      $self$$167$$.$_scanForKey$($collection$$51$$, $key$$164$$).then(function($model$$70$$) {
          ...
          if ($index$$248$$ < $max$$7$$) {
            ...
            $childColl$$1$$.$collection$ ? $tds$$.$_fetch$($childColl$$1$$, function($fetchColl$$) {
              $tds$$.$_getModelForId$($fetchColl$$, $key$$164$$, $depth$$25$$ + 1).then(function($childModel$$) {
                $childModel$$ ? $resolve$$55$$($childModel$$) : ($index$$248$$++, $getNextCollection$$($index$$248$$, $tds$$));
              });
        ...
        if ($model$$70$$) {
          $resolve$$55$$({$model$:$model$$70$$, depth:$depth$$25$$});
        } else {
          var $max$$7$$ = $collection$$51$$.length;
          $getNextCollection$$(0, $self$$167$$);
        }
      });
    });
  };
  ...
  $oj$$44$$.$CollectionTreeDataSource$.prototype.$fetchDescendants$ = function $$oj$$44$$$$CollectionTreeDataSource$$$$fetchDescendants$$($parent$$54$$, $callbacks$$50$$) {
    ...
    null === $parent$$54$$ ? this.$FetchCollection$(null, 0, -1, {success:function($nodeSet$$36$$) {
      ...
      $collection$$52_parentModel$$2$$ && ($collection$$52_parentModel$$2$$ = $self$$168$$.$GetChildCollection$($collection$$52_parentModel$$2$$.$model$), $self$$168$$.$FetchCollection$($collection$$52_parentModel$$2$$, 0, -1, {success:function($nodeSet$$37$$) {
  ...
  $oj$$44$$.$CollectionNodeSet$.prototype.$FetchChildNodeSet$ = function $$oj$$44$$$$CollectionNodeSet$$$$FetchChildNodeSet$$($index$$250$$, $callbacks$$54$$) {
    ...
    if (this.$treeDataSource$.$parseMetadata$($model$$71_parentKey$$14$$).leaf) {
      ...
      var $collection$$56$$ = this.$treeDataSource$.$GetChildCollection$($model$$71_parentKey$$14$$), $model$$71_parentKey$$14$$ = this.$treeDataSource$.$parseMetadata$($model$$71_parentKey$$14$$).key, $self$$169$$ = this;
      this.$treeDataSource$.$FetchCollection$($collection$$56$$, 0, -1, {success:function($nodeSet$$39$$) {
        $self$$169$$.$childNodeSet$[$index$$250$$] = $nodeSet$$39$$;
