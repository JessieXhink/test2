...
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore", "hammerjs", "ojs/ojdatacollection-common", "ojs/ojinputtext", "ojs/ojjquery-hammer"], function($oj$$10$$, $$$$10$$, $compCore$$, $Hammer$$2$$) {
  (function() {
    ...
    $_MODE$:{$_LOAD_MORE$:"loadMore", $_PAGE$:"page"}, $_PAGE_OPTION_LAYOUT$:{$_AUTO$:"auto", $_ALL$:"all", $_INPUT$:"input", $_RANGE_TEXT$:"rangeText", $_PAGES$:"pages", $_NAV$:"nav"}, $_PAGE_OPTION_DEFAULT_MAX_PAGE_LINKS$:6, $_TYPE$:{$_NUMBERS$:"numbers", $_DOTS$:"dots"}, firstPage:function() {
    ...
    }, $_events$:{"click .oj-pagingcontrol-loadmore-link":function($event$$80$$) {
      this.loadNext();
      $event$$80$$.preventDefault();
    }, "click .oj-pagingcontrol-nav-dot":function($event$$81$$) {
      var $pageNum$$ = $$$$10$$($event$$81$$.currentTarget).attr("data-oj-pagenum");
      this.page($pageNum$$);
      $event$$81$$.preventDefault();
    }, "click .oj-pagingcontrol-nav-page":function($event$$82$$) {
      var $pageNum$$1$$ = $$$$10$$($event$$82$$.currentTarget).attr("data-oj-pagenum");
      this.page($pageNum$$1$$);
      $event$$82$$.preventDefault();
    }, "click .oj-pagingcontrol-nav-first":function($event$$83$$) {
      $$$$10$$($event$$83$$.currentTarget).hasClass(this.$_MARKER_STYLE_CLASSES$.$_DISABLED$) || this.firstPage();
      $event$$83$$.preventDefault();
    }, "click .oj-pagingcontrol-nav-previous":function($event$$84$$) {
      $$$$10$$($event$$84$$.currentTarget).hasClass(this.$_MARKER_STYLE_CLASSES$.$_DISABLED$) || this.previousPage();
      $event$$84$$.preventDefault();
    }, "click .oj-pagingcontrol-nav-next":function($event$$85$$) {
      $$$$10$$($event$$85$$.currentTarget).hasClass(this.$_MARKER_STYLE_CLASSES$.$_DISABLED$) || this.nextPage();
      $event$$85$$.preventDefault();
    }, "click .oj-pagingcontrol-nav-last":function($event$$86$$) {
      $$$$10$$($event$$86$$.currentTarget).hasClass(this.$_MARKER_STYLE_CLASSES$.$_DISABLED$) || this.lastPage();
      $event$$86$$.preventDefault();
    }, "keypress .oj-pagingcontrol-nav-input":function($event$$87$$) {
      13 == $event$$87$$.which && $event$$87$$.preventDefault();
    }, "mousedown .oj-pagingcontrol-nav-first":function($event$$88$$) {
      $$$$10$$($event$$88$$.currentTarget).hasClass(this.$_MARKER_STYLE_CLASSES$.$_DISABLED$) || $$$$10$$($event$$88$$.target).addClass(this.$_MARKER_STYLE_CLASSES$.$_ACTIVE$);
      $event$$88$$.preventDefault();
    }, "mousedown .oj-pagingcontrol-nav-previous":function($event$$89$$) {
      $$$$10$$($event$$89$$.currentTarget).hasClass(this.$_MARKER_STYLE_CLASSES$.$_DISABLED$) || $$$$10$$($event$$89$$.target).addClass(this.$_MARKER_STYLE_CLASSES$.$_ACTIVE$);
      $event$$89$$.preventDefault();
    }, "mousedown .oj-pagingcontrol-nav-next":function($event$$90$$) {
      $$$$10$$($event$$90$$.currentTarget).hasClass(this.$_MARKER_STYLE_CLASSES$.$_DISABLED$) || $$$$10$$($event$$90$$.target).addClass(this.$_MARKER_STYLE_CLASSES$.$_ACTIVE$);
      $event$$90$$.preventDefault();
    }, "mousedown .oj-pagingcontrol-nav-last":function($event$$91$$) {
    ...
    }, "mouseup .oj-pagingcontrol-nav-first":function($event$$92$$) {
      $$$$10$$($event$$92$$.target).removeClass(this.$_MARKER_STYLE_CLASSES$.$_ACTIVE$);
      $event$$92$$.preventDefault();
    }, "mouseup .oj-pagingcontrol-nav-previous":function($event$$93$$) {
      $$$$10$$($event$$93$$.target).removeClass(this.$_MARKER_STYLE_CLASSES$.$_ACTIVE$);
      $event$$93$$.preventDefault();
    }, "mouseup .oj-pagingcontrol-nav-next":function($event$$94$$) {
      $$$$10$$($event$$94$$.target).removeClass(this.$_MARKER_STYLE_CLASSES$.$_ACTIVE$);
      $event$$94$$.preventDefault();
    }, "mouseup .oj-pagingcontrol-nav-last":function($event$$95$$) {
      $$$$10$$($event$$95$$.target).removeClass(this.$_MARKER_STYLE_CLASSES$.$_ACTIVE$);
      $event$$95$$.preventDefault();
    }, "mouseleave .oj-pagingcontrol-nav-first":function($event$$96$$) {
      $$$$10$$($event$$96$$.target).removeClass(this.$_MARKER_STYLE_CLASSES$.$_ACTIVE$);
      $event$$96$$.preventDefault();
    }, "mouseleave .oj-pagingcontrol-nav-previous":function($event$$97$$) {
      $$$$10$$($event$$97$$.target).removeClass(this.$_MARKER_STYLE_CLASSES$.$_ACTIVE$);
      $event$$97$$.preventDefault();
    }, "mouseleave .oj-pagingcontrol-nav-next":function($event$$98$$) {
      $$$$10$$($event$$98$$.target).removeClass(this.$_MARKER_STYLE_CLASSES$.$_ACTIVE$);
      $event$$98$$.preventDefault();
    }, "mouseleave .oj-pagingcontrol-nav-last":function($event$$99$$) {
      ...
      if (this.$_mode$ != this.options.mode) {
        ...
        if (this.options.mode == this.$_MODE$.$_LOAD_MORE$) {
          var $data$$68$$ = this.$_getData$(), $pagingControlLoadMore$$ = this.$_getPagingControlLoadMore$();
          null != $data$$68$$ && $startIndex$$4$$ + $size$$12$$ == $data$$68$$.totalSize() ? $pagingControlLoadMore$$.css("display", "none") : this.$_refreshPagingControlLoadMore$($size$$12$$, $startIndex$$4$$);
        } else {
      ...
      var $data$$69$$ = this.$_getData$(), $page$$3$$ = 0;
      null != $data$$69$$ && ($page$$3$$ = $data$$69$$.getPage());
      return $page$$3$$;
    }, $_getData$:function() {
      ...
      if (null != $size$$13$$) {
        var $itemRangeCurrentText_pageTo$$ = parseInt($startIndex$$5$$, 10) + parseInt($size$$13$$, 10), $itemRangeItemsSpan_itemRangeMaxSpan_itemRangeOfText_pageFrom$$ = 0 < $itemRangeCurrentText_pageTo$$ ? $itemRangeItemsSpan_itemRangeMaxSpan_itemRangeOfText_pageFrom$$ + 1 : 0, $data$$70_itemRangeItemsText$$ = this.$_getData$();
        if (null != $data$$70_itemRangeItemsText$$ && -1 != $data$$70_itemRangeItemsText$$.totalSize()) {
          var $itemRangeCurrentText_pageTo$$ = $itemRangeCurrentText_pageTo$$ > $data$$70_itemRangeItemsText$$.totalSize() ? $data$$70_itemRangeItemsText$$.totalSize() : $itemRangeCurrentText_pageTo$$, $itemRangeCurrentText_pageTo$$ = this.$getTranslatedString$(this.$_BUNDLE_KEY$.$_MSG_ITEM_RANGE_CURRENT$, {pageFrom:$itemRangeItemsSpan_itemRangeMaxSpan_itemRangeOfText_pageFrom$$, pageTo:$itemRangeCurrentText_pageTo$$}), $itemRangeItemsSpan_itemRangeMaxSpan_itemRangeOfText_pageFrom$$ = this.$getTranslatedString$(this.$_BUNDLE_KEY$.$_MSG_ITEM_RANGE_OF$), 
          ...
          $itemRangeItemsSpan_itemRangeMaxSpan_itemRangeOfText_pageFrom$$.text($data$$70_itemRangeItemsText$$.totalSize());
        ...
        $data$$70_itemRangeItemsText$$ = this.$getTranslatedString$(this.$_BUNDLE_KEY$.$_MSG_ITEM_RANGE_ITEMS$);
        $itemRangeItemsSpan_itemRangeMaxSpan_itemRangeOfText_pageFrom$$ = $$$$10$$(document.createElement("span"));
        $itemRangeItemsSpan_itemRangeMaxSpan_itemRangeOfText_pageFrom$$.text(" " + $data$$70_itemRangeItemsText$$);
        $itemRangeSpan$$.append($itemRangeItemsSpan_itemRangeMaxSpan_itemRangeOfText_pageFrom$$);
      }
      ...
      var $data$$71$$ = this.$_getData$(), $pageCount$$ = 0;
      null != $data$$71$$ && ($pageCount$$ = $data$$71$$.getPageCount());
      return $pageCount$$;
      ...
      this.$_queueRefresh$();
    }, $_handleDataPage$:function($event$$101$$) {
      $event$$101$$.page != $event$$101$$.previousPage && this.$_queueRefresh$();
    }, $_handleDataReset$:function() {
      this.$_invokeDataPage$(0, !1);
    }, $_handleDataRefresh$:function() {
      this.$_queueRefresh$();
    }, $_handleDataSort$:function($event$$104$$) {
      this.options.mode == this.$_MODE$.$_LOAD_MORE$ && this.$_handleDataReset$($event$$104$$);
    }, $_handleDataRowAdd$:function($event$$105$$) {
      this.options.mode == this.$_MODE$.$_PAGE$ && this.$_isOperationOnCurrentPage$($event$$105$$) ? this.$_invokeDataPage$(this.$_getCurrentPage$(), !0) : this.$_queueRefresh$();
    }, $_handleDataRowRemove$:function($event$$106$$) {
      0 < this.$_getTotalPages$() && this.$_getCurrentPage$() > this.$_getTotalPages$() - 1 ? this.$_invokeDataPage$(this.$_getTotalPages$() - 1, !0) : this.$_isOperationOnCurrentPage$($event$$106$$) ? this.$_invokeDataPage$(this.$_getCurrentPage$(), !0) : this.$_queueRefresh$();
    }, $_handlePageChange$:function($event$$107$$, $data$$72$$) {
      try {
        var $errSummary$$4_page$$5$$ = $data$$72$$.value;
      ...
      try {
        ...
        return Promise.reject($e$$54$$);
      }
      this.$_currentStartIndex$ = 0;
      if ($async$$) {
        return this.$_queuePageFetch$($page$$6$$), Promise.resolve();
      }
      var $data$$73$$ = this.$_getData$(), $self$$61$$ = this;
      return new Promise(function($resolve$$35$$, $reject$$35$$) {
        null != $data$$73$$ ? $data$$73$$.setPage($page$$6$$, {pageSize:$self$$61$$.options.pageSize}).then(function() {
          $resolve$$35$$(null);
        }, function($error$$28$$) {
          $reject$$35$$($error$$28$$);
        }) : $resolve$$35$$(null);
      ...
      var $data$$74$$ = this.$_getData$(), $pageSize$$6$$ = this.options.pageSize;
      this.$_currentStartIndex$ = this.$_currentStartIndex$ ? this.$_currentStartIndex$ + $pageSize$$6$$ : $pageSize$$6$$;
      if (-1 == $data$$74$$.totalSize() || $data$$74$$.totalSize() > this.$_currentStartIndex$) {
        var $self$$62$$ = this;
        return new Promise(function($resolve$$36$$, $reject$$36$$) {
          $data$$74$$.fetch({startIndex:$self$$62$$.$_currentStartIndex$, pageSize:$pageSize$$6$$}).then(function($result$$38$$) {
            $resolve$$36$$($result$$38$$);
          }, function() {
            $reject$$36$$(null);
          });
        });
    ...
    }, $_isOperationOnCurrentPage$:function($event$$108$$) {
      var $data$$75$$ = this.$_getData$(), $pageSize$$7$$ = this.options.pageSize, $i$$160$$;
      for ($i$$160$$ = 0;$i$$160$$ < $event$$108$$.indexes.length;$i$$160$$++) {
        var $rowIdx$$1$$ = $event$$108$$.indexes[$i$$160$$], $startIndex$$6$$ = $data$$75$$.getStartItemIndex();
      ...
      this.$_pendingPageFetch$ = this.$_pendingPageFetch$.then(function() {
        ...
        if (0 == $self$$63$$.$_pageFetchCount$) {
          ...
          var $data$$76$$ = $self$$63$$.$_getData$();
          null != $data$$76$$ && $data$$76$$.setPage($self$$63$$.$_pageFetchLatestPage$, {pageSize:$self$$63$$.options.pageSize});
        }
      }, function($error$$30$$) {
        $self$$63$$.$_pageFetchCount$--;
      ...
      if (null != $data$$77$$) {
        ...
        var $i$$161$$, $ev$$1$$;
        for ($i$$161$$ = 0;$i$$161$$ < this.$_dataSourceEventHandlers$.length;$i$$161$$++) {
          ($ev$$1$$ = $data$$77$$.on(this.$_dataSourceEventHandlers$[$i$$161$$].eventType, this.$_dataSourceEventHandlers$[$i$$161$$].eventHandler)) && (this.$_dataSourceEventHandlers$[$i$$161$$].eventHandler = $ev$$1$$);
        }
      }
      ...
      if ($oj$$10$$.$DomUtils$.$isTouchSupported$() && this.options.mode == this.$_MODE$.$_PAGE$) {
        ...
        if (null != $pagingControlNavArrowSection$$2$$) {
          ...
          if ("vertical" == this.options.pageOptions.orientation) {
            ...
            this.$_hammerSwipeUp$ = $pagingControlNavArrowSection$$2$$.$ojHammer$($options$$255$$).on("swipeup", function($event$$109$$) {
              $event$$109$$.preventDefault();
              $self$$66$$.nextPage();
            });
            this.$_hammerSwipeDown$ = $pagingControlNavArrowSection$$2$$.$ojHammer$($options$$255$$).on("swipedown", function($event$$110$$) {
              $event$$110$$.preventDefault();
              $self$$66$$.previousPage();
            });
          } else {
            $options$$255$$ = {recognizers:[[$Hammer$$2$$.Swipe, {direction:$Hammer$$2$$.DIRECTION_HORIZONTAL}]]}, this.$_hammerSwipeLeft$ = $pagingControlNavArrowSection$$2$$.$ojHammer$($options$$255$$).on("swipeleft", function($event$$111$$) {
              $event$$111$$.preventDefault();
              $self$$66$$.nextPage();
            }), this.$_hammerSwipeRight$ = $pagingControlNavArrowSection$$2$$.$ojHammer$($options$$255$$).on("swiperight", function($event$$112$$) {
      ...
      var $data$$78$$ = this.$_getData$();
      if (null != this.$_dataSourceEventHandlers$ && null != $data$$78$$) {
        var $i$$162$$;
        for ($i$$162$$ = 0;$i$$162$$ < this.$_dataSourceEventHandlers$.length;$i$$162$$++) {
          $data$$78$$.off(this.$_dataSourceEventHandlers$[$i$$162$$].eventType, this.$_dataSourceEventHandlers$[$i$$162$$].eventHandler);
        }
      }
    ...
    }, $_createPagingControlNavPages$:function($errDetail$$5_parentDiv_totalPages$$, $numLinks_pageList$$, $i$$163_size$$19$$) {
      ...
      if (0 <= $currentPage_pageAfterCurrent_pageNum$$3$$) {
        if (-1 != $errDetail$$5_parentDiv_totalPages$$ && $errDetail$$5_parentDiv_totalPages$$ <= $numPagesToAdd$$) {
          for ($numLinks_pageList$$[0] = 0, $i$$163_size$$19$$ = 1;$i$$163_size$$19$$ < $errDetail$$5_parentDiv_totalPages$$;$i$$163_size$$19$$++) {
            $numLinks_pageList$$[$i$$163_size$$19$$] = $i$$163_size$$19$$;
          }
        } else {
          ...
          for (-1 == $errDetail$$5_parentDiv_totalPages$$ && ($numPagesToAdd$$ = 0 < $i$$163_size$$19$$ ? 1 : 0);0 < $numPagesToAdd$$ && ($currentPage_pageAfterCurrent_pageNum$$3$$ <= $errDetail$$5_parentDiv_totalPages$$ || -1 == $errDetail$$5_parentDiv_totalPages$$);) {
