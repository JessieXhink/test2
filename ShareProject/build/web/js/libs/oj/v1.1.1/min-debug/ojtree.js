...
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore"], function($oj$$36$$, $$$$35$$) {
  (function() {
    ...
    function $_KeyFilterHandler$$($e$$102$$) {
      var $s$$10$$ = "";
      $oj$$36$$.$DomUtils$.$isMetaKeyPressed$($e$$102$$) ? $s$$10$$ += "ctrl+" : $e$$102$$.shiftKey && ($s$$10$$ += "shift+");
      var $key$$146$$ = $e$$102$$.which;
      switch($key$$146$$) {
        case 32:
          $s$$10$$ += "space";
          break;
      ...
      if (0 !== $s$$10$$.length && "shift+" != $s$$10$$ && "ctrl+" != $s$$10$$) {
        var $retHandler$$ = null;
        $$$$35$$.each($_aKeyHandlerStack$$, function($i$$395$$, $obj$$58$$) {
          if ($obj$$58$$.$_this$.$_data$.ui.$focused$) {
            return $obj$$58$$.$_this$.$_data$.ui.$touchEvent$ = !1, "shift+f10" == $s$$10$$ ? $obj$$58$$.$_this$.$_data$.menu.$activenode$ = $obj$$58$$.$_this$.$_data$.ui.$hovered$ : $obj$$58$$.$_handler$[$s$$10$$] && ($e$$102$$.preventDefault(), $retHandler$$ = $obj$$58$$.$_handler$[$s$$10$$].call($obj$$58$$.$_this$, $e$$102$$)), !1;
          }
        });
        if (null != $retHandler$$) {
          return $retHandler$$;
    ...
    function $_removeKeyFilter$$($selector$$36$$) {
      $$$$35$$.each($_aKeyHandlerStack$$, function($i$$396$$) {
        if ($_aKeyHandlerStack$$[$i$$396$$].$_selector$ === $selector$$36$$) {
          return $$$$35$$($selector$$36$$).off("keydown"), $_aKeyHandlerStack$$[$i$$396$$] = null, $_aKeyHandlerStack$$.splice($i$$396$$, 1), !1;
        }
      });
    }
    ...
    expandAll:null, hover:null, loaded:null, move:null, optionChange:null, paste:null, refresh:null, rename:null}, collapse:function($node$$61$$, $skipAnim$$) {
      var $dur$$ = ($skipAnim$$ = $skipAnim$$ || !1) ? 0 : this.$_animDuration$;
      $node$$61$$ = this.$_getNode$($node$$61$$);
      if (!$node$$61$$.length || -1 === $node$$61$$ || !$node$$61$$.hasClass("oj-expanded") || this.$_data$.$core$.locked || $node$$61$$.hasClass("oj-disabled")) {
        return!1;
      }
      var $rslt$$ = this.$_emitEvent$({obj:$node$$61$$, func:"collapse"}, "before");
      if ("boolean" != typeof $rslt$$ || $rslt$$) {
        $node$$61$$.removeClass("oj-expanded").addClass("oj-collapsed").attr("aria-expanded", "false"), $$$$35$$($node$$61$$.children()[0]).removeClass("oj-selected").addClass("oj-default"), !$skipAnim$$ && $dur$$ ? this.$_slide$($node$$61$$, !0) : this.$_transitionEnd$($$$$35$$($node$$61$$.children("UL")[0]), $node$$61$$);
      }
    }, $_slide$:function($node$$62$$, $bSlideUp$$) {
      var $$ul$$, $hNow$$, $hFinal$$;
      $$ul$$ = $$$$35$$($node$$62$$.children("ul"));
      ...
      return $h$$8$$ + 10;
    }, $_transitionEndHandler$:function($$ul$$1_e$$103$$) {
      $$ul$$1_e$$103$$ = $$$$35$$($$ul$$1_e$$103$$.target);
      var $node$$63$$ = $$ul$$1_e$$103$$.closest("li");
      this.$_isSafari$ ? $$ul$$1_e$$103$$[0].removeEventListener("webkitTransitionEnd", this.$_proxyTransitionEndHandler$) : $$ul$$1_e$$103$$[0].removeEventListener("transitionend", this.$_proxyTransitionEndHandler$);
      $$ul$$1_e$$103$$.removeClass("oj-tree-transition");
      this.$_transitionEnd$($$ul$$1_e$$103$$, $node$$63$$);
    }, $_transitionEnd$:function($$ul$$2$$, $node$$64$$) {
      $node$$64$$.hasClass("oj-collapsed") ? ($$ul$$2$$[0].style.display = "none", $$ul$$2$$.css("max-height", ""), this.$_emitEvent$({obj:$node$$64$$}, "collapse"), this.after_close($node$$64$$)) : ($$ul$$2$$[0].style.display = "block", $$ul$$2$$.css("max-height", ""), this.$_emitEvent$({obj:$node$$64$$}, "expand"), this.after_open($node$$64$$));
    }, collapseAll:function($node$$65$$, $anim$$) {
      var $origTarg$$ = $node$$65$$ ? $node$$65$$ : -1, $_this$$1$$ = this;
      if (!this.$_data$.$core$.locked && (($node$$65$$ = $node$$65$$ ? this.$_getNode$($node$$65$$) : this.$_$container$) && -1 !== $origTarg$$ && ($origTarg$$ = $node$$65$$), $node$$65$$ && -1 !== $origTarg$$ || ($node$$65$$ = this.$_$container_ul$), !$node$$65$$.hasClass("oj-disabled"))) {
        var $subject$$;
        -1 !== $origTarg$$ && this.isExpanded($node$$65$$) && ($subject$$ = $node$$65$$[0]);
        var $objs$$ = $node$$65$$.find("li.oj-expanded");
    ...
    }, expand:function($node$$66$$, $skipAnim$$1$$) {
      this.$_expand$($node$$66$$, !1, $skipAnim$$1$$);
      ...
      if ($nodes$$ && "array" === $$$$35$$.type($nodes$$)) {
        ...
        $exlen$$ = $nodes$$.length;
        $$$$35$$.each($nodes$$, function($i$$397$$, $val$$56$$) {
          $_this$$2$$.$_expand$($val$$56$$, !1, $skipAnim$$2$$);
        });
        return null;
      }
      ...
      return $$$$35$$($exlr$$);
    }, expandAll:function($node$$67$$, $anim$$1$$) {
      this.$_expandAll$($node$$67$$, $anim$$1$$);
    }, toggleExpand:function($node$$68$$, $skipAnim$$3$$) {
      if (($node$$68$$ = this.$_getNode$($node$$68$$)) && $node$$68$$.length && -1 !== $node$$68$$ && !$node$$68$$.hasClass("oj-disabled") && !this.$_data$.$core$.locked) {
        if ($node$$68$$.hasClass("oj-collapsed")) {
          return this.expand($node$$68$$, $skipAnim$$3$$);
        }
        if ($node$$68$$.hasClass("oj-expanded")) {
          return this.collapse($node$$68$$, $skipAnim$$3$$);
        }
      }
    }, deselect:function($node$$69$$) {
      var $prevSelections$$ = this.options.selection.slice(0);
      this.$_deselect$($node$$69$$);
      this.$_fireOptionChangeEvent$("selection", $prevSelections$$, null, null);
    }, deselectAll:function($context$$96$$) {
      if (!this.$_data$.$core$.locked) {
        var $prevSelections$$1$$ = this.options.selection.slice(0);
        this.$_deselectAll$($context$$96$$);
        this.$_fireOptionChangeEvent$("selection", $prevSelections$$1$$, null, null);
      }
    }, select:function($node$$70$$) {
      this.$_select$($node$$70$$, !0);
    }, toggleSelect:function($node$$71$$) {
      $node$$71$$ = this.$_getNode$($node$$71$$);
      if (!$node$$71$$.length || $node$$71$$.hasClass("oj-disabled") || this.$_data$.$core$.locked) {
        return!1;
      }
      this.isSelected($node$$71$$) ? this.deselect($node$$71$$) : this.$_select$($node$$71$$, !0);
      return!0;
    }, isCollapsed:function($node$$72$$) {
      return($node$$72$$ = this.$_getNode$($node$$72$$)) && -1 !== $node$$72$$ && $node$$72$$.hasClass("oj-collapsed");
    }, isExpanded:function($node$$73$$) {
      return($node$$73$$ = this.$_getNode$($node$$73$$)) && -1 !== $node$$73$$ && $node$$73$$.hasClass("oj-expanded");
    }, isLeaf:function($node$$74$$) {
      return this.$_isLeaf$($node$$74$$);
    }, isSelected:function($n$$27_node$$75$$) {
      $n$$27_node$$75$$ = this.$_getNode$($n$$27_node$$75$$);
      var $r$$4$$ = !1;
      $n$$27_node$$75$$ && $n$$27_node$$75$$.length && this.$_data$.ui.selected && ($r$$4$$ = 0 <= this.$_data$.ui.selected.index($n$$27_node$$75$$));
      return $r$$4$$;
    }, create:function($refnode$$, $position$$33$$, $data$$154$$) {
      return this.$_createNode$($refnode$$, $position$$33$$, $data$$154$$);
    }, remove:function($node$$76$$) {
      $node$$76$$ = this.$_getNode$($node$$76$$);
      if (!$node$$76$$.length || $node$$76$$.hasClass("oj-disabled") || this.$_data$.$core$.locked) {
        return!1;
      }
      var $p$$8_rslt$$1$$ = this.$_emitEvent$({obj:$node$$76$$, func:"remove"}, "before");
      if ("boolean" == typeof $p$$8_rslt$$1$$ && !$p$$8_rslt$$1$$) {
        return!1;
      }
      this.$__rollback$();
      var $p$$8_rslt$$1$$ = this.$_getParent$($node$$76$$), $prev$$3$$ = $$$$35$$([]), $t$$2$$ = this, $sib$$ = this.$_getPrev$($node$$76$$);
      $node$$76$$.each(function() {
        $prev$$3$$ = $prev$$3$$.add($t$$2$$.$_getPrev$(this));
      });
      $node$$76$$ = $node$$76$$.detach();
      ...
      this.$_emitEvent$({obj:$node$$76$$, prev:$sib$$, parent:$p$$8_rslt$$1$$}, "remove");
      return $node$$76$$;
    }, getText:function($node$$77$$) {
      $node$$77$$ = this.$_getNode$($node$$77$$);
      if (!$node$$77$$.length) {
        return!1;
      }
      $node$$77$$ = $node$$77$$.children("a:eq(0)");
      $node$$77$$ = $node$$77$$.find("span:eq(0)");
      return $node$$77$$[0].textContent;
    }, rename:function($node$$78$$, $text$$17$$) {
      this.$_rename_node$($node$$78$$, $text$$17$$);
    }, hover:function($node$$79$$) {
      if (!this.$_data$.menu.$activenode$ && ($node$$79$$ = this.$_getNode$($node$$79$$), $node$$79$$.length && !$node$$79$$.hasClass("oj-disabled") && !this.$_data$.$core$.locked && !$node$$79$$.hasClass("oj-hover"))) {
        var $rslt$$2$$ = this.$_emitEvent$({obj:$node$$79$$, func:"hover"}, "before");
        if ("boolean" != typeof $rslt$$2$$ || $rslt$$2$$) {
          $node$$79$$.hasClass("oj-hover") || this.dehover(), this.$_data$.ui.$hovered$ = $node$$79$$.children("a").addClass("oj-hover").parent(), this.$_$container_ul$.attr("aria-activedescendant", this.$_data$.ui.$hovered$.attr("id")), this.$_fix_scroll$($node$$79$$), this.$_emitEvent$({obj:$node$$79$$}, "hover");
        }
      }
    }, dehover:function() {
    ...
    }, getPath:function($node$$80$$, $idMode$$) {
      var $p$$10$$ = [], $_this$$3$$ = this;
      $node$$80$$ = this.$_getNode$($node$$80$$);
      if (-1 === $node$$80$$ || !$node$$80$$ || !$node$$80$$.length) {
        return!1;
      }
      $node$$80$$.parentsUntil(".oj-tree", "li").each(function() {
        $p$$10$$.push($idMode$$ ? this.id : $_this$$3$$.getText(this));
      });
      $p$$10$$.reverse();
      $p$$10$$.push($idMode$$ ? $node$$80$$.attr("id") : this.getText($node$$80$$));
      return $p$$10$$;
    }, getRoot:function() {
      return this.$_$container$.children("ul:eq(0)");
    }, refresh:function($node$$81$$) {
      this._super();
      this.$_data$.$core$.locked || this.$_refresh$($node$$81$$ ? $node$$81$$ : -1);
    }, move:function($node$$82$$, $refnode$$1$$, $position$$34$$, $iscopy$$) {
      this.$_moveNode$($node$$82$$, $refnode$$1$$, $position$$34$$, $iscopy$$);
    }, getType:function($node$$83$$) {
      return this.$_getType$($node$$83$$);
    }, setType:function($node$$84$$, $str$$22$$) {
      return this.$_setType$($node$$84$$, $str$$22$$);
    }, getNodeBySubId:function($locator$$34$$) {
      return $locator$$34$$ ? this.$_processSubId$($locator$$34$$) : this.element ? this.element[0] : null;
    }, getParent:function($l$$10_node$$85$$) {
      return($l$$10_node$$85$$ = this.$_getParent$($l$$10_node$$85$$)) && 0 < $l$$10_node$$85$$.length ? $l$$10_node$$85$$ : null;
    }, getPrevSibling:function($l$$11_node$$86$$) {
      return($l$$11_node$$86$$ = this.$_getPrev$($l$$11_node$$86$$, !0)) && 0 < $l$$11_node$$86$$.length ? $l$$11_node$$86$$ : null;
    }, getNextSibling:function($l$$12_node$$87$$) {
      return($l$$12_node$$87$$ = this.$_getNext$($l$$12_node$$87$$, !0)) && 0 < $l$$12_node$$87$$.length ? $l$$12_node$$87$$ : null;
    }, getChildren:function($l$$13_node$$88$$) {
      return($l$$13_node$$88$$ = this.$_getChildren$($l$$13_node$$88$$ ? $l$$13_node$$88$$ : -1)) && 0 < $l$$13_node$$88$$.length ? $l$$13_node$$88$$ : null;
      ...
      this._super();
    }, _setOption:function($key$$147$$, $newval$$, $flags$$37$$) {
      var $val$$57$$;
      if ("selection" === $key$$147$$) {
        ...
        if ("selectionMode" === $key$$147$$) {
          "none" === $newval$$ ? $val$$57$$ = 0 : "single" === $newval$$ ? $val$$57$$ = 1 : "multiple" === $newval$$ ? $val$$57$$ = -1 : ($val$$57$$ = 0, $newval$$ = "none"), $val$$57$$ != this.$_data$.$core$.$selectMode$ && (this.$_data$.$core$.$selectMode$ = $val$$57$$);
        } else {
          if ("icons" === $key$$147$$) {
            ...
            if ("contextMenu" === $key$$147$$) {
              ...
              if ("disabled" === $key$$147$$) {
                ...
                if ("data" === $key$$147$$) {
                  this._super($key$$147$$, $newval$$, $flags$$37$$);
                  this.$_initDSOpts$();
      ...
      var $i$$398$$, $j$$41$$, $id$$43$$, $len$$19$$, $len2$$, $bDiff$$ = !1, $bInList$$ = !1;
      ...
      if ($len$$19$$ !== $len2$$) {
        ...
        if (0 == $len$$19$$ && 0 === $len2$$) {
          ...
          for ($i$$398$$ = 0;$i$$398$$ < $len$$19$$;$i$$398$$++) {
            $id$$43$$ = $$$$35$$($value1$$11$$[$i$$398$$]).attr("id");
            $bInList$$ = !1;
    ...
    }, $_isLeaf$:function($node$$89$$) {
      return($node$$89$$ = this.$_getNode$($node$$89$$)) && -1 !== $node$$89$$ && $node$$89$$.hasClass("oj-tree-leaf");
    }, $_getNodeElem$:function($el$$19_node$$90$$) {
      $el$$19_node$$90$$ = this.$_$container_ul$.find($el$$19_node$$90$$);
      var $ret$$38$$ = !1;
      $el$$19_node$$90$$ && $el$$19_node$$90$$.length && 0 < $el$$19_node$$90$$.length && $$$$35$$($el$$19_node$$90$$).is("li") && ($ret$$38$$ = $el$$19_node$$90$$);
      return $ret$$38$$;
    }, $_reference$:function($node$$91$$, $o$$14$$) {
      var $ctor$$2_div$$7$$ = $node$$91$$.parents("div").eq(0);
      ...
      void 0 != $to$$3$$ && void 0 != $from$$3$$ && $$$$35$$.each($from$$3$$, function($prop$$66$$, $val$$58$$) {
        void 0 == $to$$3$$[$prop$$66$$] && ($to$$3$$[$prop$$66$$] = $val$$58$$);
      });
      ...
      $$$$35$$.grep($sels$$, function($node$$92$$, $i$$399$$) {
        if ($$elem$$ = $_this$$5$$.$_getNodeElem$($node$$92$$)) {
          $cur$$2$$.push($$elem$$), $sels$$[$i$$399$$] = $$elem$$[0];
        } else {
          return!1;
        }
        return!0;
      ...
      $$$$35$$.each($aSelected_newSels$$, function($i$$400$$, $node$$93$$) {
        $len$$20$$ = $cur$$2$$.length;
        $id$$44$$ = $$$$35$$($node$$93$$).attr("id");
        $inList$$ = !1;
        for ($i$$400$$ = 0;$i$$400$$ < $len$$20$$;$i$$400$$++) {
          if ($id$$44$$ == $cur$$2$$[$i$$400$$].attr("id")) {
            $inList$$ = !0;
            break;
          }
        }
        $inList$$ || $_this$$5$$.$_deselect$($node$$93$$);
      });
      ...
      return $ret$$39$$;
    }, $_rename_node$:function($node$$94$$, $text$$18$$) {
      var $t$$3$$;
      $node$$94$$ = this.$_getNode$($node$$94$$);
      this.$__rollback$();
      $t$$3$$ = this.getText($node$$94$$);
      if ($node$$94$$ && $node$$94$$.length) {
        var $rslt$$3$$ = this.$_emitEvent$({obj:$node$$94$$, func:"rename", title:$text$$18$$, prevTitle:$t$$3$$}, "before");
        if ("boolean" == typeof $rslt$$3$$ && !$rslt$$3$$) {
          return;
        }
      }
      $node$$94$$ && $node$$94$$.length && this.$_set_text$.apply(this, Array.prototype.slice.call(arguments)) && this.$_emitEvent$({obj:$node$$94$$, title:$text$$18$$, prevTitle:$t$$3$$}, "rename");
    ...
    }, $_getType$:function($node$$95$$) {
      var $n$$29$$ = null;
      this.options.types && ($n$$29$$ = this.$_getNode$($node$$95$$));
      return $n$$29$$ && $n$$29$$.length ? $n$$29$$.attr(this.options.types.attr) || "default" : !1;
    }, $_setType$:function($node$$96$$, $str$$23$$) {
      var $s$$11$$ = this.options.types, $tattr$$, $ret$$40$$ = !1;
      $node$$96$$ = this.$_getNode$($node$$96$$);
      $s$$11$$ && $node$$96$$ && -1 != $node$$96$$ && $node$$96$$.length && $str$$23$$ && ($tattr$$ = $s$$11$$.attr) && $s$$11$$[$str$$23$$] && ($node$$96$$.attr($tattr$$, $str$$23$$), $node$$96$$.addClass("oj-tree-type"), $ret$$40$$ = !0);
      return $ret$$40$$;
    }, $_check$:function($rule$$3$$, $obj$$67$$, $opts$$37$$) {
      $obj$$67$$ = this.$_getNode$($obj$$67$$);
      var $v$$3$$ = !1, $ty$$ = this.$_getType$($obj$$67$$), $d$$9$$ = 0, $_this$$6$$ = this, $s$$12$$ = this.$_getOptions$().types, $data$$155$$ = !1;
      if (-1 === $obj$$67$$) {
        if ($s$$12$$[$rule$$3$$]) {
          $v$$3$$ = $s$$12$$[$rule$$3$$];
        } else {
        ...
        ($data$$155$$ = this.$_data$.types.$defaults$.useData ? $obj$$67$$.data("oj-tree") : !1) && $data$$155$$.types && "undefined" !== typeof $data$$155$$.types[$rule$$3$$] ? $v$$3$$ = $data$$155$$.types[$rule$$3$$] : $s$$12$$.types[$ty$$] && "undefined" !== typeof $s$$12$$.types[$ty$$][$rule$$3$$] ? $v$$3$$ = $s$$12$$.types[$ty$$][$rule$$3$$] : $s$$12$$.types["default"] && "undefined" !== typeof $s$$12$$.types["default"][$rule$$3$$] && ($v$$3$$ = $s$$12$$.types["default"][$rule$$3$$]);
      }
      $$$$35$$.isFunction($v$$3$$) && ($v$$3$$ = $v$$3$$.call(this, $obj$$67$$));
      var $md$$ = this.$_data$.types.$defaults$.maxDepth;
      "maxDepth" === $rule$$3$$ && -1 !== $obj$$67$$ && !1 !== $opts$$37$$ && -2 !== this.$_data$.types.$defaults$.maxDepth && 0 !== $v$$3$$ && $obj$$67$$.children("a:eq(0)").parentsUntil(".oj-tree", "li").each(function($i$$401$$) {
        if (-1 !== $md$$ && 0 >= $md$$ - ($i$$401$$ + 1)) {
          return $v$$3$$ = 0, !1;
        }
        $d$$9$$ = 0 === $i$$401$$ ? $v$$3$$ : $_this$$6$$.$_check$($rule$$3$$, this, !1);
        if (-1 !== $d$$9$$ && 0 >= $d$$9$$ - ($i$$401$$ + 1)) {
          return $v$$3$$ = 0, !1;
        }
        0 <= $d$$9$$ && ($d$$9$$ - ($i$$401$$ + 1) < $v$$3$$ || 0 > $v$$3$$) && ($v$$3$$ = $d$$9$$ - ($i$$401$$ + 1));
        0 <= $md$$ && ($md$$ - ($i$$401$$ + 1) < $v$$3$$ || 0 > $v$$3$$) && ($v$$3$$ = $md$$ - ($i$$401$$ + 1));
      });
      return $v$$3$$;
      ...
      var $sp$$2$$;
      $$$$35$$.each($js$$.data, function($i$$403$$, $m$$23$$) {
    ...
    }, $_select$:function($node$$97$$, $bRet_check$$, $e$$105$$) {
      var $selectMode$$ = this.$_data$.$core$.$selectMode$;
      if (0 == $selectMode$$) {
        return!1;
      }
      $node$$97$$ = this.$_getNode$($node$$97$$);
      if (-1 == $node$$97$$ || !$node$$97$$ || !$node$$97$$.length || $node$$97$$.hasClass("oj-disabled") || this.$_data$.$core$.locked) {
        return!1;
      }
      $e$$105$$ && "touchend" == $e$$105$$.type || (this.$_data$.ui.$touchEvent$ = !1);
      var $isSelected$$ = this.isSelected($node$$97$$);
      if (!$isSelected$$) {
        var $prevSelections$$2_rslt$$5$$ = this.$_emitEvent$({obj:$node$$97$$, func:"select"}, "before");
        if ("boolean" == typeof $prevSelections$$2_rslt$$5$$ && !$prevSelections$$2_rslt$$5$$) {
          return!1;
        }
      }
      var $prevSelections$$2_rslt$$5$$ = this.options.selection.slice(0), $s$$14$$ = this.options, $isMultiple_selMultMod$$ = this.$_data$.ui.$defaults$.selectMultipleModifier, $isRange_selRangeMod$$ = this.$_data$.ui.$defaults$.selectRangeModifier, $disSelChildren$$ = this.$_data$.ui.$defaults$.disableSelectingChildren, $isMultiple_selMultMod$$ = "on" == $isMultiple_selMultMod$$ || !1 !== $isMultiple_selMultMod$$ && $e$$105$$ && $oj$$36$$.$DomUtils$.$isMetaKeyPressed$($e$$105$$), $isRange_selRangeMod$$ = 
      !1 !== $isRange_selRangeMod$$ && $e$$105$$ && $e$$105$$[$isRange_selRangeMod$$ + "Key"] && this.$_data$.ui.$lastSelected$ && this.$_data$.ui.$lastSelected$[0] !== $node$$97$$[0] && this.$_data$.ui.$lastSelected$.parent()[0] === $node$$97$$.parent()[0], $proceed$$ = !0, $t$$7$$ = this;
      if ($bRet_check$$) {
        if ($disSelChildren$$ && $isMultiple_selMultMod$$ && ($node$$97$$.parentsUntil(".oj-tree", "li").children("a.oj-selected").length || $node$$97$$.children("ul").find("a.oj-selected:eq(0)").length)) {
          return!1;
        }
        $proceed$$ = !1;
        switch(!0) {
          case $isRange_selRangeMod$$:
            ...
            $node$$97$$ = $node$$97$$[$node$$97$$.index() < this.$_data$.ui.$lastSelected$.index() ? "nextUntil" : "prevUntil"](".oj-tree-last-selected").addBack();
            -1 == $selectMode$$ || $node$$97$$.length < $selectMode$$ ? (this.$_data$.ui.$lastSelected$.removeClass("oj-tree-last-selected"), this.$_data$.ui.selected.each(function() {
          ...
          case $isSelected$$ && !$isMultiple_selMultMod$$:
            ...
            break;
          case !$isSelected$$ && !$isMultiple_selMultMod$$:
            $e$$105$$ ? this.$_data$.ui.selected && 1 == this.$_data$.ui.selected.length ? this.$_deselect$(this.$_data$.ui.selected) : this.$_deselectAll$(this.$_data$.ui.selected) : 1 === $selectMode$$ ? this.$_deselect$(this.$_data$.ui.selected) : 1 < $selectMode$$ && this.$_deselectAll$();
            $proceed$$ = !0;
            break;
          case $isSelected$$ && $isMultiple_selMultMod$$:
            this.deselect($node$$97$$);
            break;
          case !$isSelected$$ && $isMultiple_selMultMod$$:
      ...
      $bRet_check$$ = !1;
      $proceed$$ && !$isSelected$$ && ($isRange_selRangeMod$$ || (this.$_data$.ui.$lastSelected$ = $node$$97$$), $node$$97$$.children("a").addClass("oj-selected"), $node$$97$$.attr("aria-selected", "true"), $bRet_check$$ = !0, $s$$14$$.selectedParentExpand && $node$$97$$.parents(".oj-collapsed").each(function() {
        $t$$7$$.$_expand$(this, !1, !0);
      }), this.$_data$.ui.selected = this.$_data$.ui.selected.add($node$$97$$), this.$_fix_scroll$($node$$97$$.eq(0)), this.$_data$.$core$.$suppressSelectEvent$ || this.$_fireOptionChangeEvent$("selection", $prevSelections$$2_rslt$$5$$, null, $e$$105$$));
      return $bRet_check$$;
    }, $_deselect$:function($node$$98$$) {
      $node$$98$$ = this.$_getNode$($node$$98$$);
      if (!$node$$98$$.length) {
        return!1;
      }
      $node$$98$$.hasClass("oj-disabled") || this.$_data$.$core$.locked || !this.isSelected($node$$98$$) || ($node$$98$$.children("a").removeClass("oj-selected"), $node$$98$$.removeAttr("aria-selected"), this.$_data$.ui.selected = this.$_data$.ui.selected.not($node$$98$$), this.$_data$.ui.$lastSelected$ && this.$_data$.ui.$lastSelected$.length && this.$_data$.ui.$lastSelected$.get(0) === $node$$98$$.get(0) && (this.$_data$.ui.$lastSelected$ = this.$_data$.ui.selected.eq(0)));
    }, $_deselectAll$:function($context$$97_ret$$41$$) {
      if (!this.$_data$.$core$.locked && ($context$$97_ret$$41$$ = $context$$97_ret$$41$$ ? $$$$35$$($context$$97_ret$$41$$).find("a.oj-selected").parent() : this.$_$container$.find("a.oj-selected").parent(), $context$$97_ret$$41$$.not(".oj-disabled"), 0 !== $context$$97_ret$$41$$.length)) {
        var $_this$$9$$ = this;
        $$$$35$$.each($context$$97_ret$$41$$, function() {
          $_this$$9$$.$_deselect$(this);
        });
      }
    }, $_setSelected$:function($nodes$$2$$, $e$$106$$) {
      if (this.$_data$.$core$.locked) {
        return null;
      }
      if ($nodes$$2$$ && 0 < $nodes$$2$$.length) {
        var $_this$$10$$ = this;
        $$$$35$$.each($nodes$$2$$, function($i$$404$$, $val$$60$$) {
          $val$$60$$ && $_this$$10$$.$_select$($val$$60$$, !0, $e$$106$$);
        });
      }
    }, $_handleNodeTapClick$:function($event$$478$$) {
      $event$$478$$.preventDefault();
      $event$$478$$.currentTarget.blur();
      $$$$35$$($event$$478$$.currentTarget).hasClass("oj-tree-loading") || (this.$_setFocus$(), this.$_select$($event$$478$$.currentTarget, !0, $event$$478$$) && this.$_$container_ul$.focus());
      this.$_data$.ui.$touchEvent$ = !1;
    ...
    }, $_refresh$:function($node$$99$$) {
      this.$_refresh_core$($node$$99$$);
    }, $_refresh_core$:function($node$$100$$) {
      var $origTarg$$3$$ = $node$$100$$ ? $node$$100$$ : -1, $_this$$11$$ = this;
      this.$_save_opened$();
      $node$$100$$ || ($node$$100$$ = -1);
      ($node$$100$$ = this.$_getNode$($node$$100$$)) ? $origTarg$$3$$ = $node$$100$$ : $node$$100$$ = -1;
      -1 !== $node$$100$$ ? $node$$100$$.children("UL").remove() : (this.$_$container_ul$.empty(), this.$_processExistingMarkup$());
      this.$_load_node$($node$$100$$, function() {
      ...
      var $_this$$12$$ = this;
      this.$_data$.$core$.$toExpand$.length && $$$$35$$.each(this.$_data$.$core$.$toExpand$, function($i$$405$$, $val$$61$$) {
        $_this$$12$$.$_expand$($val$$61$$, !1, !0);
      });
      this.$_emitEvent$({}, "reopen", !0);
    }, $_getSelected$:function($context$$98_sel$$2$$) {
      var $ar$$1$$, $i$$406$$, $len$$21$$;
      $context$$98_sel$$2$$ = $context$$98_sel$$2$$ ? $$$$35$$($context$$98_sel$$2$$).find("a.oj-selected").parent() : this.$_data$.ui.selected;
      $ar$$1$$ = [];
      $len$$21$$ = $context$$98_sel$$2$$.length;
      for ($i$$406$$ = 0;$i$$406$$ < $len$$21$$;$i$$406$$++) {
        $ar$$1$$.push($context$$98_sel$$2$$[$i$$406$$]);
      }
      return $ar$$1$$;
    }, $_set_text$:function($obj$$75$$, $val$$62$$) {
      ...
      this.$_emitEvent$({obj:$obj$$75$$, name:$val$$62$$}, "set_text", !0);
      return $obj$$75$$[0].textContent = $val$$62$$;
    }, $_loadNodes$:function() {
      ...
      var $s$$16$$ = this.options.data, $data$$156$$ = null, $ajax$$ = null;
      $s$$16$$ && ($data$$156$$ = $s$$16$$.data || null, $ajax$$ = $s$$16$$.ajax || null);
      $obj$$84$$ = this.$_getNode$($obj$$84$$);
      return-1 == $obj$$84$$ || !$obj$$84$$ || !$ajax$$ && !$$$$35$$.isFunction($data$$156$$) || $obj$$84$$.is(".oj-expanded, .oj-tree-leaf") || 0 < $obj$$84$$.children("ul").children("li").size();
    }, reselect:function() {
      ...
      $$$$35$$.each($s$$17$$, function($i$$407$$, $val$$63$$) {
        $val$$63$$ && "#" !== $val$$63$$ && $_this$$16$$.select($val$$63$$);
      });
    ...
    }, $_JsonDSToJson$:function($parentKey$$12$$, $node$$101$$) {
      ...
      0 < $cc$$ && ($range$$22$$.count = $cc$$, $ds$$.$fetchChildren$($parentKey$$12$$, $range$$22$$, {success:$$$$35$$.proxy(function($jns$$) {
        for (var $c$$49$$ = $jns$$.$getCount$(), $attr$$17_n$$31_r$$7$$, $i$$408$$ = 0;$i$$408$$ < $c$$49$$;$i$$408$$++) {
          $node$$101$$ = {};
          ($attr$$17_n$$31_r$$7$$ = $jns$$.getData($i$$408$$)) && ($node$$101$$.attr = $attr$$17_n$$31_r$$7$$);
          $node$$101$$.title = $jns$$.$m_nodes$[$i$$408$$].title;
          $attr$$17_n$$31_r$$7$$.$metadata$ && ($node$$101$$.metadata = $jns$$.$m_nodes$[$i$$408$$].metadata);
          var $key$$148$$ = $node$$101$$.attr.id;
          $attr$$17_n$$31_r$$7$$ = $ds$$.$getChildCount$($key$$148$$);
          0 < $attr$$17_n$$31_r$$7$$ && ($attr$$17_n$$31_r$$7$$ = this.$_JsonDSToJson$($key$$148$$, $node$$101$$), $node$$101$$.children = $attr$$17_n$$31_r$$7$$.$js$);
          $arJson$$.push($node$$101$$);
        }
        $rslt$$7$$.success = !0;
        $rslt$$7$$.$js$ = $arJson$$;
      }, this), error:function() {
      ...
      var $d$$12_s$$20$$ = this.$_getOptions$().data, $data$$157$$ = $d$$12_s$$20$$ && $d$$12_s$$20$$.data || null, $ajax$$1$$ = $d$$12_s$$20$$ && $d$$12_s$$20$$.ajax || null;
      !$d$$12_s$$20$$ || $data$$157$$ || $ajax$$1$$ || ($data$$157$$ = $d$$12_s$$20$$);
      if (($obj$$87$$ = this.$_getNode$($obj$$87$$)) && -1 !== $obj$$87$$ && (this.$_data$.$ds$.$progressiveRender$ || this.$_data$.$ds$.$progressiveUnload$) && !$obj$$87$$.is(".oj-expanded, .oj-tree-leaf") && 0 === $obj$$87$$.children("ul").children("li").length && $obj$$87$$.data("oj-tree-children")) {
        ...
        switch(!0) {
          case !$data$$157$$ && !$ajax$$1$$:
            throw "ojTree - neither data nor ajax settings supplied.";;
          case $$$$35$$.isFunction($data$$157$$):
            $data$$157$$.call(this, $obj$$87$$, $$$$35$$.proxy(function($d$$13$$) {
            ...
            break;
          case !!$data$$157$$ && !$ajax$$1$$ || !!$data$$157$$ && !!$ajax$$1$$ && (!$obj$$87$$ || -1 === $obj$$87$$):
            $obj$$87$$ && -1 != $obj$$87$$ || (($d$$12_s$$20$$ = this.$_parseJson$($data$$157$$, $obj$$87$$)) ? (this.$_$container_ul$.empty().append($d$$12_s$$20$$.children()), this.$_cleanNode$()) : this.$_data$.$ds$.$correctState$ && this.$_$container_ul$.empty());
            $s_call$$4$$ && $s_call$$4$$.call(this);
            break;
          case !$data$$157$$ && !!$ajax$$1$$ || !!$data$$157$$ && !!$ajax$$1$$ && $obj$$87$$ && -1 !== $obj$$87$$:
            $error_func$$ = function $$error_func$$$($x$$54$$, $status$$30$$, $e$$107$$) {
              var $ef$$ = this.$_getOptions$().data.ajax.error;
              $ef$$ && $ef$$.call(this, $status$$30$$, $e$$107$$, $x$$54$$);
      ...
      var $d$$15$$ = !1, $tmp$$5$$, $i$$409$$, $j$$42$$, $title$$11$$;
      if (!$js$$1$$) {
        return $d$$15$$;
      }
      ...
      if ($$$$35$$.isArray($js$$1$$)) {
        ...
        $i$$409$$ = 0;
        for ($j$$42$$ = $js$$1$$.length;$i$$409$$ < $j$$42$$;$i$$409$$++) {
          $tmp$$5$$ = this.$_parseJson$($js$$1$$[$i$$409$$], $obj$$88_ul2$$, !0), $tmp$$5$$.length && ($d$$15$$ = $d$$15$$.append($tmp$$5$$));
        }
        $d$$15$$ = $d$$15$$.children();
      } else {
        ...
        $$$$35$$.each($js$$1$$.data, function($i$$410$$, $m$$24$$) {
      ...
      var $d$$16_s$$21$$ = this.$_getOptions$().data, $data$$158$$ = $d$$16_s$$21$$ && $d$$16_s$$21$$.data || null, $ajax$$2$$ = $d$$16_s$$21$$ && $d$$16_s$$21$$.ajax || null;
      ...
      switch(!0) {
        ...
        case !$data$$158$$ && !$ajax$$2$$:
          ...
          break;
        case !!$data$$158$$ && !$ajax$$2$$ || !!$data$$158$$ && !!$ajax$$2$$ && (!$obj$$90$$ || -1 === $obj$$90$$):
          $obj$$90$$ && -1 != $obj$$90$$ || ($d$$16_s$$21$$ = $$$$35$$($data$$158$$), $d$$16_s$$21$$.is("ul") || ($d$$16_s$$21$$ = $$$$35$$("\x3cul /\x3e").append($d$$16_s$$21$$)), this.$_$container_ul$.empty().append($d$$16_s$$21$$.children()).find("li, a").filter(function() {
            return!this.firstChild || !this.firstChild.tagName || "INS" !== this.firstChild.tagName;
          ...
          break;
        case !$data$$158$$ && !!$ajax$$2$$ || !!$data$$158$$ && !!$ajax$$2$$ && $obj$$90$$ && -1 !== $obj$$90$$:
          $obj$$90$$ = this.$_getNode$($obj$$90$$), $error_func$$1$$ = function $$error_func$$1$$$($x$$56$$, $t$$8$$, $e$$108$$) {
            var $ef$$1$$ = this.$_getOptions$().data.ajax.error;
            $ef$$1$$ && $ef$$1$$.call(this, $x$$56$$, $t$$8$$, $e$$108$$);
      ...
      $$$$35$$.each($elem$$148$$.find("li a"), function($i$$411$$, $val$$64$$) {
        var $ih$$ = $val$$64$$.innerHTML, $ih$$ = $ih$$.replace("ins\x3e", "ins\x3e\x3cspan class\x3d'oj-tree-title'\x3e");
        $val$$64$$.innerHTML = $ih$$ + "\x3c/span\x3e";
      });
    }, $_addDefType$:function($obj$$92$$) {
      var $s$$23$$, $typeAttr$$1$$;
      this.$_data$.types.$defType$ && ($typeAttr$$1$$ = ($s$$23$$ = this.options.types) ? $s$$23$$.attr : this.$_data$.types.$defaults$.attr, $$$$35$$.each($obj$$92$$.find("li"), function($i$$412$$, $val$$65$$) {
        $val$$65$$ = $$$$35$$($val$$65$$);
        $val$$65$$.attr($typeAttr$$1$$) || $val$$65$$.attr($typeAttr$$1$$, "oj-tree-deftype").addClass("oj-tree-type");
      }));
      ...
      if ($dnd_mLeft$$.$prepared$) {
        ...
        $$$$35$$.each($isParent$$1_lineTop_o$$18$$, $$$$35$$.proxy(function($i$$413$$, $val$$66$$) {
          if (this.$_data$.dnd[$val$$66$$]) {
            return $ctl$$.helper.children("ins").removeClass("oj-tree-drop-invalid").addClass("oj-tree-drop-ok"), this.$_$container$.removeClass("oj-invalid-drop"), $r$$8$$ = $val$$66$$, !1;
          }
        }, this));
      ...
      $vars$$3$$.$r$ && $vars$$3$$.$r$[0] === $e$$109$$.target.parentNode && ($dnd$$2$$.$to1$ && (clearTimeout($dnd$$2$$.$to1$), $dnd$$2$$.$to1$ = !1), $dnd$$2$$.$to2$ && (clearTimeout($dnd$$2$$.$to2$), $dnd$$2$$.$to2$ = !1));
    }, $_dnd_open$:function() {
      var $vars$$4$$ = this.$_data$.dnd.$vars$;
      this.$_data$.dnd.$to2$ = !1;
      this.expand($vars$$4$$.$r$, $$$$35$$.proxy(this.$_dnd_prepare$, this), !0);
    }, $_dnd_finish$:function($e$$110$$) {
      var $dnd$$3$$ = this.$_data$.dnd, $vars$$5$$ = this.$_data$.dnd.$vars$;
      $dnd$$3$$.$foreign$ ? ($dnd$$3$$.after || $dnd$$3$$.before || $dnd$$3$$.inside) && this.options.dnd.drag_finish.call(this, {o:$vars$$5$$.$o$, r:$vars$$5$$.$r$, p:$vars$$5$$.$last_pos$}) : (this.$_dnd_prepare$(), this.$_moveNode$($vars$$5$$.$o$, $vars$$5$$.$r$, $vars$$5$$.$last_pos$, $e$$110$$[this.options.dnd.copy_modifier + "Key"]));
      $vars$$5$$.$o$ && $vars$$5$$.$o$.removeClass("oj-drag").removeClass("oj-invalid-drop").removeClass("oj-valid-drop");
      $vars$$5$$.$o$ = !1;
      $vars$$5$$.$r$ = !1;
      $vars$$5$$.$m$.hide();
      $vars$$5$$.$ml$ && $vars$$5$$.$ml$.hide();
    }, $_start_drag$:function($obj$$94$$, $e$$111$$) {
      ...
      if (!$vars$$6$$.$o$.hasClass("oj-disabled") && !this.$_data$.$core$.locked) {
        ...
        this.$_drag_start$($e$$111$$, {$jstree$:!0, $obj$:$vars$$6$$.$o$}, "\x3cspan\x3e" + $dt$$ + "\x3c/span\x3e");
    ...
    }, $_drag_start$:function($e$$112$$, $data$$159$$, $html$$2$$) {
      var $ctl$$1$$ = this.$_data$.dnd.$ctl$;
      $ctl$$1$$.$is_drag$ && this.$_drag_stop$();
      try {
        $e$$112$$.currentTarget.unselectable = "on", $e$$112$$.currentTarget.onselectstart = function $$e$$112$$$currentTarget$onselectstart$() {
          return!1;
        }, $e$$112$$.currentTarget.style && ($e$$112$$.currentTarget.style.MozUserSelect = "none");
      } catch ($err$$21$$) {
      }
      $ctl$$1$$.$init_x$ = $e$$112$$.pageX;
      $ctl$$1$$.$init_y$ = $e$$112$$.pageY;
      $ctl$$1$$.$user_data$ = $data$$159$$;
      $ctl$$1$$.$is_down$ = !0;
      ...
      return!1;
    }, $_drag$:function($e$$113$$) {
      var $ctl$$2$$ = this.$_data$.dnd.$ctl$, $$title_vars$$7$$ = this.$_data$.dnd.$vars$;
      if ($ctl$$2$$.$is_down$) {
        if (!$ctl$$2$$.$is_drag$) {
          if (5 < Math.abs($e$$113$$.pageX - $ctl$$2$$.$init_x$) || 5 < Math.abs($e$$113$$.pageY - $ctl$$2$$.$init_y$)) {
            $ctl$$2$$.helper.appendTo("body"), $ctl$$2$$.$is_drag$ = !0, $$$$35$$(document).triggerHandler("drag_start.ojtreeu", [{event:$e$$113$$, data:$ctl$$2$$.$user_data$}]);
          } else {
            return;
          }
        }
        if ("mousemove" === $e$$113$$.type) {
          var $d$$19_l$$15$$ = $$$$35$$(document), $horizDisp_t$$10$$ = $d$$19_l$$15$$.scrollTop(), $d$$19_l$$15$$ = $d$$19_l$$15$$.scrollLeft();
          20 > $e$$113$$.pageY - $horizDisp_t$$10$$ ? ($$title_vars$$7$$.$sti$ && "down" === $$title_vars$$7$$.$dir1$ && (clearInterval($$title_vars$$7$$.$sti$), $$title_vars$$7$$.$sti$ = void 0), $$title_vars$$7$$.$sti$ || ($$title_vars$$7$$.$dir1$ = "up", $$title_vars$$7$$.$sti$ = setInterval(function() {
          ...
          20 > $$$$35$$(window).height() - ($e$$113$$.pageY - $horizDisp_t$$10$$) ? ($$title_vars$$7$$.$sti$ && "up" === $$title_vars$$7$$.$dir1$ && (clearInterval($$title_vars$$7$$.$sti$), $$title_vars$$7$$.$sti$ = void 0), $$title_vars$$7$$.$sti$ || ($$title_vars$$7$$.$dir1$ = "down", $$title_vars$$7$$.$sti$ = setInterval(function() {
          ...
          20 > $e$$113$$.pageX - $d$$19_l$$15$$ ? ($$title_vars$$7$$.$sli$ && "right" === $$title_vars$$7$$.$dir2$ && (clearInterval($$title_vars$$7$$.$sli$), $$title_vars$$7$$.$sli$ = void 0), $$title_vars$$7$$.$sli$ || ($$title_vars$$7$$.$dir2$ = "left", $$title_vars$$7$$.$sli$ = setInterval(function() {
          ...
          20 > $$$$35$$(window).width() - ($e$$113$$.pageX - $d$$19_l$$15$$) ? ($$title_vars$$7$$.$sli$ && "left" === $$title_vars$$7$$.$dir2$ && (clearInterval($$title_vars$$7$$.$sli$), $$title_vars$$7$$.$sli$ = void 0), $$title_vars$$7$$.$sli$ || ($$title_vars$$7$$.$dir2$ = "right", $$title_vars$$7$$.$sli$ = setInterval(function() {
        ...
        $ctl$$2$$.helper.css({left:$e$$113$$.pageX + $horizDisp_t$$10$$ + "px", top:$e$$113$$.pageY + $ctl$$2$$.$helper_top$ + "px"});
        $$$$35$$(document).triggerHandler("drag.ojtreeu", [{event:$e$$113$$, data:$ctl$$2$$.$user_data$}]);
      }
    }, $_drag_stop$:function($e$$114$$) {
      ...
      $$$$35$$(document).triggerHandler("drag_stop.ojtreeu", [{event:$e$$114$$ ? $e$$114$$ : {}, data:$ctl$$3$$.$user_data$}]);
      $ctl$$3$$.helper.remove();
      $ctl$$3$$.$init_x$ = 0;
      $ctl$$3$$.$init_y$ = 0;
      $ctl$$3$$.$user_data$ = {};
      ...
      this.$_data$.$core$.$toLoad$.length && ($$$$35$$.each(this.$_data$.$core$.$toLoad$, function($i$$414$$, $val$$67$$) {
        if ("#" == $val$$67$$) {
          return!0;
        }
        $n$$32$$ = $_this$$21$$.$_$container$.find($val$$67$$);
        $n$$32$$.length ? $_this$$21$$.isExpanded($val$$67$$) || $current$$24$$.push($val$$67$$) : $remaining$$1$$.push($val$$67$$);
      }), $current$$24$$.length && (this.$_data$.$core$.$toLoad$ = $remaining$$1$$, $$$$35$$.each($current$$24$$, function($i$$415$$, $val$$68$$) {
        $_this$$21$$.$_is_loaded$($val$$68$$) || ($_this$$21$$.$_load_node$($val$$68$$, function() {
          $_this$$21$$.$_reload_nodes$(!0);
        }, function() {
          $_this$$21$$.$_reload_nodes$(!0);
        }), $bDone$$ = !1);
      })));
      this.$_data$.$core$.$toExpand$.length && $$$$35$$.each(this.$_data$.$core$.$toExpand$, function($i$$416$$, $val$$69$$) {
        $_this$$21$$.isExpanded($val$$69$$) || $_this$$21$$.$_expand$($val$$69$$, !1, !0);
      });
      ...
      this.$_initDnD$();
      this.$_initMenu$();
    }, $_emitEvent$:function($data$$160$$, $evname$$, $bInternal$$) {
      if ($evname$$ && "string" === $$$$35$$.type($evname$$) && (!0 !== this.$_data$.$core$.locked || "unlock" === $evname$$ || "isLocked" === $evname$$ || "lock" === $evname$$)) {
        ...
        var $eventdata$$ = {};
        $eventdata$$.item = $data$$160$$ ? $data$$160$$.obj : void 0;
        $eventdata$$.inst = $func$$9_inst$$;
        $isBefore$$ ? ($func$$9_inst$$ = $data$$160$$.func, $eventdata$$.func = $func$$9_inst$$, $eventdata$$.args = $args$$19_bContinue$$, "rename" === $func$$9_inst$$ && ($eventdata$$.title = $data$$160$$.title, $eventdata$$.prevTitle = $data$$160$$.prevTitle)) : $isPublic$$ && ("move" == $evname$$ ? ($eventdata$$.position = $data$$160$$.$p$, $eventdata$$.reference = $data$$160$$.$r$, $eventdata$$.data = $data$$160$$) : "rename" == $evname$$ ? ($eventdata$$.title = $data$$160$$.title, $eventdata$$.prevTitle = 
        $data$$160$$.prevTitle) : "remove" == $evname$$ ? ($eventdata$$.parent = $data$$160$$.parent, $eventdata$$.prev = $data$$160$$.prev) : "delete" == $evname$$ ? ($eventdata$$.prev = $data$$160$$.prev, $eventdata$$.parent = $data$$160$$.parent) : "expandAll" === $evname$$ || "collapseAll" === $evname$$ || "deselectAll" === $evname$$ ? $eventdata$$.targ = $data$$160$$.targ : "loaded" === $evname$$ && ($eventdata$$.item = -1));
        if ($isPublic$$) {
      ...
      this.$_isTouch$ && this.$_$container$.delegate(".oj-tree-list ins.oj-tree-disclosure-icon", "touchend.ojtree", $$$$35$$.proxy(function($event$$479_trgt$$) {
        $event$$479_trgt$$.preventDefault();
        $event$$479_trgt$$ = $$$$35$$($event$$479_trgt$$.target);
        this.toggleExpand($event$$479_trgt$$);
      }, this));
      this.$_$container$.delegate(".oj-tree-list ins.oj-tree-disclosure-icon", "click.ojtree", $$$$35$$.proxy(function($event$$480_trgt$$1$$) {
        $event$$480_trgt$$1$$ = $$$$35$$($event$$480_trgt$$1$$.target);
        this.toggleExpand($event$$480_trgt$$1$$);
      }, this)).delegate(".oj-tree-list ins.oj-tree-disclosure-icon", "mousedown", $$$$35$$.proxy(function($event$$481$$) {
        this.$_data$.ui.$disclosureClick$ = !0;
        $$$$35$$($event$$481$$.target).removeClass("oj-default").removeClass("oj-hover").addClass("oj-selected");
      }, this)).delegate(".oj-tree-list ins.oj-tree-disclosure-icon", "mouseup", $$$$35$$.proxy(function($event$$482$$) {
        $$$$35$$($event$$482$$.target).removeClass("oj-selected").addClass("oj-default");
      ...
      this.$_isTouch$ && this.$_$container$.delegate(".oj-tree-list a", "touchend.ojtree", $$$$35$$.proxy(function($event$$484$$) {
        this.$_data$.ui.$touchEvent$ = !0;
        this.$_handleNodeTapClick$($event$$484$$);
        $$$$35$$($event$$484$$.currentTarget).hasClass("oj-tree-loading") || this.dehover();
      }, this));
      this.$_$container$.delegate(".oj-tree-list a", "click.ojtree", $$$$35$$.proxy(function($event$$485$$) {
        this.$_data$.ui.$touchEvent$ = !1;
        this.$_handleNodeTapClick$($event$$485$$);
      }, this)).delegate(".oj-tree-list a", "mouseenter.ojtree", $$$$35$$.proxy(function($event$$486$$) {
        $$$$35$$($event$$486$$.currentTarget).hasClass("oj-tree-loading") || this.hover($event$$486$$.target);
      }, this)).delegate(".oj-tree-list a", "mouseleave.ojtree", $$$$35$$.proxy(function($event$$487$$) {
        $$$$35$$($event$$487$$.currentTarget).hasClass("oj-tree-loading") || this.dehover($event$$487$$.target);
      }, this)).delegate(".oj-tree-list .oj-tree-disclosure-icon", "mouseenter.ojtree", $$$$35$$.proxy(function($event$$488$$) {
        $$$$35$$($event$$488$$.currentTarget).hasClass("oj-tree-loading") || this.$_disclosureHover$($event$$488$$.target, !0);
      }, this)).delegate(".oj-tree-list .oj-tree-disclosure-icon", "mouseleave.ojtree", $$$$35$$.proxy(function($event$$489$$) {
        $$$$35$$($event$$489$$.currentTarget).hasClass("oj-tree-loading") || this.$_disclosureHover$($event$$489$$.target, !1);
      }, this)).bind("_treereopen", $$$$35$$.proxy(function() {
        this.reselect();
      }, this)).bind("_treeget_rollback", $$$$35$$.proxy(function() {
        this.dehover();
        this.saveSelected();
      }, this)).bind("ojcollapse", $$$$35$$.proxy(function($event$$490$$, $ui$$33$$) {
      ...
      }, this)).bind("ojremove", $$$$35$$.proxy(function($event$$491$$, $ui$$34$$) {
      ...
      }, this)).bind("ojmove", $$$$35$$.proxy(function($event$$492$$, $ui$$35$$) {
        var $data$$161$$ = $ui$$35$$.data, $copy$$1_p$$13$$ = $data$$161$$.$cy$;
        $copy$$1_p$$13$$ && $data$$161$$.$oc$ && ($data$$161$$.$oc$.find("a.oj-selected").removeClass("oj-selected"), $data$$161$$.$oc$.removeAttr("aria-selected"));
        $data$$161$$.$ot$ === $data$$161$$.$rt$ || $copy$$1_p$$13$$ || ($copy$$1_p$$13$$ = $data$$161$$.$ot$.$_data$.ui, $copy$$1_p$$13$$.$lastHovered$ && ($data$$161$$.$o$.attr("id") == $copy$$1_p$$13$$.$lastHovered$.attr("id") && ($copy$$1_p$$13$$.$lastHovered$ = null), $copy$$1_p$$13$$.$lastSelected$ && $data$$161$$.$o$.attr("id") == $copy$$1_p$$13$$.$lastSelected$.attr("id") && ($copy$$1_p$$13$$.$lastSelected$ = null)));
      }, this));
      ...
      3 === this.$_data$.$ds$.type && (this.$_data$.$ds$.$progressiveUnload$ && this.$_$container$.bind("_treeafter_close", function($e$$117$$, $ui$$36$$) {
      ...
      $s$$27$$ && this.$_$container$.bind("_treeinit", $$$$35$$.proxy(function() {
        var $types$$ = $$$$35$$.extend(!0, {}, $s$$27$$.types), $attr$$18$$ = $s$$27$$.attr || this.$_data$.types.$defaults$.attr, $icons_css$$ = "", $_this$$24$$ = this;
        $$$$35$$.each($types$$, function($i$$417$$, $tp$$) {
          ...
          if ($tp$$.icon.image || $tp$$.icon.position) {
            "default" == $i$$417$$ ? ($_this$$24$$.$_data$.types.$defType$ = !0, $icons_css$$ += ".oj-tree-" + $_this$$24$$.$_getIndex$() + " .oj-tree-list li.oj-tree-type a \x3e .oj-tree-node-icon { ", $icons_css$$ += $_this$$24$$.$_addTypeCss$($tp$$, $icons_css$$), $icons_css$$ += "} ", $icons_css$$ += ".oj-tree-" + $_this$$24$$.$_getIndex$() + " .oj-tree-list li[" + $attr$$18$$ + '\x3d"oj-tree-deftype"].oj-tree-type \x3e a ins.oj-tree-node-icon { ') : $tp$$.icon.image && ($icons_css$$ += ".oj-tree-" + 
            $_this$$24$$.$_getIndex$() + " .oj-tree-list li[" + $attr$$18$$ + '\x3d"' + $i$$417$$ + '"].oj-tree-type \x3e a \x3e ins.oj-tree-node-icon { '), $icons_css$$ += $_this$$24$$.$_addTypeCss$($tp$$, $icons_css$$), $icons_css$$ += "} ";
          }
        });
        "" !== $icons_css$$ && $_addSheet$$({$str$:$icons_css$$, title:"oj-tree-types"});
      }, this)).bind("ojbefore", $$$$35$$.proxy(function($e$$118$$, $data$$162$$) {
        var $d$$20_o$$19_s$$28$$, $ty$$1$$, $func$$10$$ = $data$$162$$.func, $item$$95$$ = $data$$162$$.item;
        if (($d$$20_o$$19_s$$28$$ = ($d$$20_o$$19_s$$28$$ = this.$_data$.types.$defaults$.useData ? this.$_getNode$($item$$95$$) : !1) && -1 !== $d$$20_o$$19_s$$28$$ && $d$$20_o$$19_s$$28$$.length ? $d$$20_o$$19_s$$28$$.data("oj-tree") : !1) && $d$$20_o$$19_s$$28$$.types && !1 === $d$$20_o$$19_s$$28$$[$func$$10$$] || -1 !== $$$$35$$.inArray($func$$10$$, this.$_data$.types.$attachTo$) && $data$$162$$.item && ($data$$162$$.item.tagName || $data$$162$$.item.jquery) && ($d$$20_o$$19_s$$28$$ = this.options.types.types, 
        $ty$$1$$ = this.$_getType$($item$$95$$), ($d$$20_o$$19_s$$28$$[$ty$$1$$] && "undefined" !== typeof $d$$20_o$$19_s$$28$$[$ty$$1$$][$func$$10$$] || $d$$20_o$$19_s$$28$$["default"] && "undefined" !== typeof $d$$20_o$$19_s$$28$$["default"][$func$$10$$]) && !1 === this.$_check$($func$$10$$, $item$$95$$))) {
          return $e$$118$$.stopImmediatePropagation(), !1;
        }
      }, this));
      ...
      if (this.$_data$.dnd.reorder) {
        ...
        $s$$29_vars$$9$$.$m$ = $$$$35$$("\x3cdiv class\x3d'oj-tree-drop-marker'\x3e\x3cspan class\x3d'oj-tree-drop-ptr oj-component-icon'\x3e\x26#160;\x3c/span\x3e\x3c/div\x3e").hide().bind("mouseleave mouseenter", $$$$35$$.proxy(function($e$$119$$) {
          var $vars$$10$$ = this.$_data$.dnd.$vars$;
          $vars$$10$$.$m$.hide();
          $vars$$10$$.$ml$.hide();
          $e$$119$$.preventDefault();
          $e$$119$$.stopImmediatePropagation();
          return!1;
        }, this)).appendTo("body");
        $s$$29_vars$$9$$.$ml$ = $$$$35$$("\x3cdiv /\x3e").addClass("oj-tree-drop-marker-line").hide().bind("mouseup", function($e$$120$$) {
          var $vars$$11$$ = this.$_data$.dnd.$vars$;
          if ($vars$$11$$.$r$ && $vars$$11$$.$r$.length) {
            return $vars$$11$$.$r$.children("a").trigger($e$$120$$), $e$$120$$.preventDefault(), $e$$120$$.stopImmediatePropagation(), !1;
          }
        }).bind("mouseleave", $$$$35$$.proxy(function($e$$121$$) {
          var $vars$$12$$ = this.$_data$.dnd.$vars$, $rt$$ = $$$$35$$($e$$121$$.relatedTarget);
          if (($rt$$.is(".oj-tree") || 0 === $rt$$.closest(".oj-tree").length) && $vars$$12$$.$r$ && $vars$$12$$.$r$.length) {
            return $vars$$12$$.$r$.children("a").trigger($e$$121$$), $vars$$12$$.$m$.hide(), $vars$$12$$.$ml$.hide(), $e$$121$$.preventDefault(), $e$$121$$.stopImmediatePropagation(), !1;
          }
        }, this)).appendTo("body");
        this.$_data$.dnd.$ml_width$ = $s$$29_vars$$9$$.$ml$.width();
        $$$$35$$(document).bind("drag_start.ojtreeu", $$$$35$$.proxy(function($e$$122$$, $data$$163$$) {
          var $vars$$13$$ = this.$_data$.dnd.$vars$;
          $data$$163$$.data.$jstree$ && ($vars$$13$$.$m$.show(), $vars$$13$$.$ml$ && $vars$$13$$.$ml$.show());
        }, this));
        $$$$35$$(document).bind("drag_stop.ojtreeu", $$$$35$$.proxy(function($e$$123$$, $data$$164$$) {
          var $vars$$14$$ = this.$_data$.dnd.$vars$;
          $data$$164$$.data.$jstree$ && ($vars$$14$$.$m$.hide(), $vars$$14$$.$ml$ && $vars$$14$$.$ml$.hide());
        }, this));
        this.$_$container$.bind("mouseenter.ojtree", $$$$35$$.proxy(function($dc_e$$124_tr$$1$$) {
          var $ctl$$4$$ = this.$_data$.dnd.$ctl$, $vars$$15$$ = this.$_data$.dnd.$vars$;
          if ($ctl$$4$$.$is_drag$ && $ctl$$4$$.$user_data$.$jstree$ && (this.options.themes && ($vars$$15$$.$m$.addClass("oj-tree-" + this.$_data$.$themes$.$theme$), $vars$$15$$.$ml$ && $vars$$15$$.$ml$.addClass("oj-tree-" + this.$_data$.$themes$.$theme$), $ctl$$4$$.helper.addClass("oj-tree-dnd-helper oj-tree-" + this.$_data$.$themes$.$theme$)), $dc_e$$124_tr$$1$$.currentTarget === $dc_e$$124_tr$$1$$.target && $ctl$$4$$.$user_data$.$obj$ && $$$$35$$($ctl$$4$$.$user_data$.$obj$).length && $$$$35$$($ctl$$4$$.$user_data$.$obj$).parents(".oj-tree:eq(0)")[0] !== 
          $dc_e$$124_tr$$1$$.target)) {
            if ($dc_e$$124_tr$$1$$ = this.$_reference$($dc_e$$124_tr$$1$$.target), $dc_e$$124_tr$$1$$.data.dnd.$foreign$) {
              if ($dc_e$$124_tr$$1$$ = $dc_e$$124_tr$$1$$.options.dnd.drag_check.call(this, {o:$vars$$15$$.$o$, r:$dc_e$$124_tr$$1$$.$_$container$, is_root:!0}), !0 === $dc_e$$124_tr$$1$$ || !0 === $dc_e$$124_tr$$1$$.inside || !0 === $dc_e$$124_tr$$1$$.before || !0 === $dc_e$$124_tr$$1$$.after) {
              ...
              $dc_e$$124_tr$$1$$.$_prepare_move$($vars$$15$$.$o$, $dc_e$$124_tr$$1$$.$_$container$, "last"), $dc_e$$124_tr$$1$$.check_move() && ($ctl$$4$$.helper.children("ins").removeClass("oj-tree-drop-invalid").addClass("oj-tree-drop-ok"), this.$_$container$.removeClass("oj-invalid-drop"), $vars$$15$$.$o$ && $vars$$15$$.$o$.removeClass("oj-invalid-drop").addClass("oj-valid-drop"));
            }
          }
        }, this)).bind("mouseup.ojtree", $$$$35$$.proxy(function($dc$$1_e$$125$$) {
          var $vars$$16$$ = this.$_data$.dnd.$vars$, $ctl$$5_tr$$2$$ = this.$_data$.dnd.$ctl$;
          $ctl$$5_tr$$2$$.$is_drag$ && $ctl$$5_tr$$2$$.$user_data$.$jstree$ && $dc$$1_e$$125$$.currentTarget === $dc$$1_e$$125$$.target && $ctl$$5_tr$$2$$.$user_data$.$obj$ && $$$$35$$($ctl$$5_tr$$2$$.$user_data$.$obj$).length && $$$$35$$($ctl$$5_tr$$2$$.$user_data$.$obj$).parents(".oj-tree:eq(0)")[0] !== $dc$$1_e$$125$$.target && ($ctl$$5_tr$$2$$ = this.$_reference$($dc$$1_e$$125$$.currentTarget), $ctl$$5_tr$$2$$.data.dnd.foreign ? ($dc$$1_e$$125$$ = $ctl$$5_tr$$2$$.$_getOptions$().dnd.drag_check.call(this, 
          {o:$vars$$16$$.$o$, r:$ctl$$5_tr$$2$$.$_$container$, is_root:!0}), !0 !== $dc$$1_e$$125$$ && !0 !== $dc$$1_e$$125$$.inside && !0 !== $dc$$1_e$$125$$.before && !0 !== $dc$$1_e$$125$$.after || $ctl$$5_tr$$2$$.$_getOptions$().dnd.drag_finish.call(this, {o:$vars$$16$$.$o$, r:$ctl$$5_tr$$2$$.$_$container$, is_root:!0})) : $ctl$$5_tr$$2$$.$_moveNode$($vars$$16$$.$o$, $ctl$$5_tr$$2$$.$_$container$, "last", $dc$$1_e$$125$$[$ctl$$5_tr$$2$$.options.dnd.copy_modifier + "Key"]));
        }, this)).bind("mouseleave.ojtree", $$$$35$$.proxy(function($e$$126$$) {
          var $ctl$$6$$ = this.$_data$.dnd.$ctl$;
          if ($e$$126$$.relatedTarget && $$$$35$$($e$$126$$.relatedTarget).hasClass("oj-tree-drop-marker-line")) {
            return!1;
          }
        ...
        }, this)).bind("mousemove.ojtree", $$$$35$$.proxy(function($e$$127$$) {
          var $ctl$$7$$ = this.$_data$.dnd.$ctl$;
          if ($ctl$$7$$.$is_drag$ && $ctl$$7$$.$user_data$.$jstree$) {
            var $cnt$$1$$ = this.$_$container$[0];
            $e$$127$$.pageX + 24 > this.$_data$.dnd.$cof$.left + this.$_data$.dnd.$cw$ ? (this.$_data$.dnd.$i1$ && clearInterval(this.$_data$.dnd.$i1$), this.$_data$.dnd.$i1$ = setInterval($$$$35$$.proxy(function() {
              this.scrollLeft += $ctl$$7$$.$scroll_spd$;
            }, $cnt$$1$$), 100)) : $e$$127$$.pageX - 24 < this.$_data$.dnd.$cof$.left ? (this.$_data$.dnd.$i1$ && clearInterval(this.$_data$.dnd.$i1$), this.$_data$.dnd.$i1$ = setInterval($$$$35$$.proxy(function() {
              this.scrollLeft -= $ctl$$7$$.$scroll_spd$;
            }, $cnt$$1$$), 100)) : this.$_data$.dnd.$i1$ && clearInterval(this.$_data$.dnd.$i1$);
            $e$$127$$.pageY + 24 > this.$_data$.dnd.$cof$.top + this.$_data$.dnd.ch ? (this.$_data$.dnd.$i2$ && clearInterval(this.$_data$.dnd.$i2$), this.$_data$.dnd.$i2$ = setInterval($$$$35$$.proxy(function() {
              this.scrollTop += $ctl$$7$$.$scroll_spd$;
            }, $cnt$$1$$), 100)) : $e$$127$$.pageY - 24 < this.$_data$.dnd.$cof$.top ? (this.$_data$.dnd.$i2$ && clearInterval(this.$_data$.dnd.$i2$), this.$_data$.dnd.$i2$ = setInterval($$$$35$$.proxy(function() {
              this.scrollTop -= $ctl$$7$$.$scroll_spd$;
        ...
        }, this)).delegate(".oj-tree-list a", "mousedown.ojtree", $$$$35$$.proxy(function($e$$129$$) {
          if (1 === $e$$129$$.which) {
            return this.$_start_drag$($e$$129$$.currentTarget, $e$$129$$), !1;
          }
        }, this)).delegate(".oj-tree-list a", "mouseenter.ojtree", $$$$35$$.proxy(function($e$$130$$) {
          var $ctl$$9$$ = this.$_data$.dnd.$ctl$;
          $ctl$$9$$.$is_drag$ && $ctl$$9$$.$user_data$.$jstree$ && this.$_dnd_enter$($e$$130$$.currentTarget);
        }, this)).delegate(".oj-tree-list a", "mousemove.ojtree", $$$$35$$.proxy(function($e$$131$$) {
          var $ctl$$10$$ = this.$_data$.dnd.$ctl$, $vars$$18$$ = this.$_data$.dnd.$vars$;
          $ctl$$10$$.$is_drag$ && $ctl$$10$$.$user_data$.$jstree$ && ($vars$$18$$.$r$ && $vars$$18$$.$r$.length && $vars$$18$$.$r$.children("a")[0] === $e$$131$$.currentTarget || this.$_dnd_enter$($e$$131$$.currentTarget), "undefined" === typeof this.$_data$.dnd.off.top && (this.$_data$.dnd.off = $$$$35$$($e$$131$$.target).offset()), "undefined" === typeof this.$_data$.dnd.off.top && (this.$_data$.dnd.off = $$$$35$$($e$$131$$.target).offset()), this.$_data$.dnd.$w$ = ($e$$131$$.pageY - (this.$_data$.dnd.off.top || 
          0)) % this.$_data$.$core$.$li_height$, 0 > this.$_data$.dnd.$w$ && (this.$_data$.dnd.$w$ += this.$_data$.$core$.$li_height$), this.$_dnd_show$());
        }, this)).delegate(".oj-tree-list a", "mouseleave.ojtree", $$$$35$$.proxy(function($e$$132$$) {
          var $ctl$$11$$ = this.$_data$.dnd.$ctl$, $vars$$19$$ = this.$_data$.dnd.$vars$;
          if ($ctl$$11$$.$is_drag$ && $ctl$$11$$.$user_data$.$jstree$) {
            if ($e$$132$$.relatedTarget && $$$$35$$($e$$132$$.relatedTarget).hasClass("oj-tree-drop-marker-line")) {
              return!1;
            }
            ...
            this.$_data$.dnd.$mto$ = setTimeout(function($t$$11$$) {
              return function() {
                $t$$11$$.$_dnd_leave$($e$$132$$);
              };
            }(this), 0);
          }
        }, this)).delegate(".oj-tree-list a", "mouseup.ojtree", $$$$35$$.proxy(function($e$$133$$) {
          var $ctl$$12$$ = this.$_data$.dnd.$ctl$;
          $ctl$$12$$.$is_drag$ && $ctl$$12$$.$user_data$.$jstree$ && this.$_dnd_finish$($e$$133$$);
        }, this));
        ...
        }, this)).bind("drag_start.ojtreeu", $$$$35$$.proxy(function($e$$134$$, $data$$165$$) {
          if ($data$$165$$.data.$jstree$) {
            var $et$$ = $$$$35$$($data$$165$$.event.target);
            $et$$.closest(".jstree").hasClass("oj-tree-" + this.$_getIndex$()) && this.$_dnd_enter$($et$$);
          }
        }, this));
        $s$$29_vars$$9$$ = this.options.dnd;
        $s$$29_vars$$9$$.drag_target && $$$$35$$(document).delegate($s$$29_vars$$9$$.drag_target, "mousedown.ojtree-" + this.$_getIndex$(), $$$$35$$.proxy(function($e$$135$$) {
          var $cnt$$2_ctl$$13$$ = this.$_data$.dnd.$ctl$, $dnd$$6$$ = this.$_data$.dnd, $vars$$21$$ = this.$_data$.dnd.$vars$;
          $vars$$21$$.$o$ = $e$$135$$.target;
          this.$_drag_start$($e$$135$$, {$jstree$:!0, $obj$:$e$$135$$.target}, "\x3cins class\x3d'oj-tree-icon'\x3e\x3c/ins\x3e" + $$$$35$$($e$$135$$.target).text());
        ...
        $s$$29_vars$$9$$.drop_target && $$$$35$$(document).delegate($s$$29_vars$$9$$.drop_target, "mouseenter.ojtree-" + this.$_getIndex$(), $$$$35$$.proxy(function($e$$136$$) {
          var $dnd$$7$$ = this.$_data$.dnd, $vars$$22$$ = this.$_data$.dnd.$vars$;
          $dnd$$7$$.$active$ && this.options.dnd.drop_check.call(this, {o:$vars$$22$$.$o$, r:$$$$35$$($e$$136$$.target), e:$e$$136$$}) && ($dnd$$7$$.$ctl$.helper.children("ins").removeClass("oj-tree-drop-invalid").addClass("oj-tree-drop-ok"), this.$_$container$.removeClass("oj-invalid-drop"), $vars$$22$$.$o$ && $vars$$22$$.$o$.removeClass("oj-invalid-drop").addClass("oj-valid-drop"));
        ...
        }, this)).delegate($s$$29_vars$$9$$.drop_target, "mouseup.ojtree-" + this.$_getIndex$(), $$$$35$$.proxy(function($e$$138$$) {
          var $vars$$23$$ = this.$_data$.dnd.$vars$;
          this.$_data$.dnd.$active$ && this.$_data$.dnd.$ctl$.helper.children("ins").hasClass("oj-tree-drop-ok") && this.options.dnd.drop_finish.call(this, {o:$vars$$23$$.$o$, r:$$$$35$$($e$$138$$.target), e:$e$$138$$});
        }, this));
      }
    ...
    }, $_handleContextMenuSelect$:function($ev$$4$$, $ui$$37$$) {
    ...
    }, $_NotifyContextMenuGesture$:function($menu$$20_openOptions$$6$$, $event$$493$$, $eventType$$50$$) {
      var $disabledState_keyboard$$ = "keyboard" === $eventType$$50$$;
      if ("contextmenu" == $event$$493$$.type || $disabledState_keyboard$$ || "touch" == $eventType$$50$$) {
        this.$_data$.menu.$node$ = $disabledState_keyboard$$ ? this.$_data$.ui.$hovered$ : $$$$35$$($event$$493$$.target);
        ...
        ($disabledState_keyboard$$ ? this.$_data$.menu.$$elemPaste$.addClass("oj-disabled") : this.$_data$.menu.$$elemPaste$.removeClass("oj-disabled"), this.$_data$.menu.$$container$.ojMenu("refresh"))), this.$_OpenContextMenu$($event$$493$$, $eventType$$50$$, $menu$$20_openOptions$$6$$)) : $event$$493$$.preventDefault();
      }
    }, $_initCoreOpts$:function() {
      var $val$$70$$ = this.options.selectionMode, $val$$70$$ = void 0 == $val$$70$$ ? "single" : $val$$70$$;
      "none" === $val$$70$$ ? $val$$70$$ = 0 : "single" === $val$$70$$ ? $val$$70$$ = 1 : "multiple" === $val$$70$$ && ($val$$70$$ = -1);
      this.$_data$.$core$.$selectMode$ = $val$$70$$;
      ...
      var $data$$166$$ = this.$_data$;
      $data$$166$$.$core$ = {$initLoaded$:[], $selectMode$:1, $load_open$:!1, $li_height$:0, $notify_plugins$:!1, $toExpand$:!1, $toLoad$:!1, $prepared_move$:{}, $suppressSelectEvent$:!1, $strings$:{}};
      $data$$166$$.ui = {selected:$$$$35$$(), $lastSelected$:!1, $hovered$:null, $lastHovered$:null, $disclosureClick$:!1, $to_select$:null, opacity:1, $spacebar$:!1, $focused$:!1, $animDurDiv$:null, $touchEvent$:!1};
      $data$$166$$.ui.$defaults$ = {selectMultipleModifier:"ctrl", selectRangeModifier:"shift", disableSelectingChildren:!1};
      $data$$166$$.$crrm$ = {};
      $data$$166$$.$crrm$.$cp_nodes$ = !1;
      $data$$166$$.$crrm$.$ct_nodes$ = !1;
      $data$$166$$.$crrm$.$defaults$ = {inputWidthLimit:200, move:{alwaysCopy:!1, openOnMove:!0, defaultPosition:"last", checkMove:function $$data$$166$$$$crrm$$$defaults$$move$checkMove$() {
        return!0;
      }}};
      $data$$166$$.$crrm$.$prepared_move$ = {};
      $data$$166$$.$ds$ = {};
      $data$$166$$.$ds$.$progressiveRender$ = !1;
      $data$$166$$.$ds$.$progressiveUnload$ = !1;
      $data$$166$$.$ds$.$correctState$ = !0;
      $data$$166$$.$ds$.type = 0;
      $data$$166$$.$json$ = {};
      $data$$166$$.$json$.$defaults$ = {data:!1, ajax:!1};
      $data$$166$$.html = {};
      $data$$166$$.html.$defaults$ = {data:!1, ajax:!1};
      $data$$166$$.html.$useExistingMarkup$ = !1;
      $data$$166$$.html.$markup_ul$ = !1;
      $data$$166$$.html.$markup_div$ = !1;
      $data$$166$$.html.$markup$ = !1;
      $data$$166$$.html.$cloneMarkup$ = !1;
      $data$$166$$.$themes$ = {};
      $data$$166$$.$themes$.icons = !0;
      $data$$166$$.$themes$.$dots$ = !1;
      $data$$166$$.$themes$.$theme$ = "default";
      $data$$166$$.$themes$.url = !1;
      $data$$166$$.$themes$.$themes_loaded$ = [];
      $data$$166$$.$themes$.$_themes$ = !1;
      $data$$166$$.types = {};
      $data$$166$$.types.$attachTo$ = [];
      $data$$166$$.types.$defType$ = !1;
      $data$$166$$.types.$defaults$ = {maxChildren:-1, maxDepth:-1, validChildren:"all", useData:!1, attr:"type", types:{"default":{maxChildren:-1, maxDepth:-1, validChildren:"all"}}};
      $data$$166$$.menu = {};
      $data$$166$$.menu.$usermenu$ = !1;
      $data$$166$$.menu.$$container$ = !1;
      $data$$166$$.menu.$$elemPaste$ = !1;
      $data$$166$$.menu.$node$ = !1;
      $data$$166$$.menu.$activenode$ = !1;
      $data$$166$$.keys = {};
      $data$$166$$.keys.$enabled$ = !0;
      $data$$166$$.keys.bound = [];
      $data$$166$$.dnd = {};
      $data$$166$$.dnd.reorder = !1;
      $data$$166$$.dnd.$active$ = !1;
      $data$$166$$.dnd.after = !1;
      $data$$166$$.dnd.inside = !1;
      $data$$166$$.dnd.before = !1;
      $data$$166$$.dnd.off = !1;
      $data$$166$$.dnd.$prepared$ = !1;
      $data$$166$$.dnd.$w$ = 0;
      $data$$166$$.dnd.$to1$ = !1;
      $data$$166$$.dnd.$to2$ = !1;
      $data$$166$$.dnd.$cof$ = !1;
      ...
      $data$$166$$.dnd.$i2$ = !1;
      $data$$166$$.dnd.$mto$ = !1;
      $data$$166$$.dnd.$ml_width$ = 100;
      $data$$166$$.dnd.$targ_ml_width$ = 100;
      $data$$166$$.dnd.$defaults$ = {copy_modifier:"ctrl", check_timeout:100, open_timeout:500, drop_target:".oj-tree-drop", drop_check:function $$data$$166$$$dnd$$defaults$$drop_check$() {
        return!0;
      }, drop_finish:$$$$35$$.noop, drag_target:".oj-tree-draggable", drag_finish:$$$$35$$.noop, drag_check:function $$data$$166$$$dnd$$defaults$$drag_check$() {
        return{after:!1, before:!1, inside:!0};
      }};
      $data$$166$$.dnd.$vars$ = {};
      $data$$166$$.dnd.$vars$.$o$ = !1;
      $data$$166$$.dnd.$vars$.$r$ = !1;
      $data$$166$$.dnd.$vars$.$m$ = !1;
      $data$$166$$.dnd.$vars$.$ml$ = !1;
      $data$$166$$.dnd.$vars$.$sli$ = void 0;
      $data$$166$$.dnd.$vars$.$sti$ = void 0;
      $data$$166$$.dnd.$vars$.$dir1$ = !1;
      $data$$166$$.dnd.$vars$.$dir2$ = !1;
      $data$$166$$.dnd.$vars$.$last_pos$ = !1;
      $data$$166$$.dnd.$ctl$ = {};
      $data$$166$$.dnd.$ctl$.$is_down$ = !1;
      $data$$166$$.dnd.$ctl$.$is_drag$ = !1;
      $data$$166$$.dnd.$ctl$.helper = !1;
      $data$$166$$.dnd.$ctl$.$scroll_spd$ = 10;
      $data$$166$$.dnd.$ctl$.$init_x$ = 0;
      $data$$166$$.dnd.$ctl$.$init_y$ = 0;
      $data$$166$$.dnd.$ctl$.$threshold$ = 5;
      $data$$166$$.dnd.$ctl$.$helper_horiz$ = 15;
      $data$$166$$.dnd.$ctl$.$helper_top$ = 5;
      $data$$166$$.dnd.$ctl$.$user_data$ = {};
      ...
      if ($hover$$1$$) {
        ...
        $hover$$1$$ = $hover$$1$$[0];
        $$$$35$$.each($nodes$$5$$, function($i$$418$$, $node$$102$$) {
          $node$$102$$ == $hover$$1$$ && ($bContinue$$1$$ = !1);
          $_this$$25$$.$_select$($node$$102$$, !0);
          return $bContinue$$1$$;
        });
        this.$_data$.$core$.$suppressSelectEvent$ = !1;
        this.$_fireOptionChangeEvent$("selection", $prevSelections$$3$$, null, $event$$496$$);
      }
      return!1;
    }, "shift+pgdn":function($event$$497$$) {
      ...
      if ($hover$$2$$) {
        ...
        $hover$$2$$ = $hover$$2$$[0];
        $$$$35$$.each($l$$17$$, function($i$$419$$, $node$$103$$) {
          $bFound$$ || ($bFound$$ = $node$$103$$ == $hover$$2$$);
          $bFound$$ && !$_this$$26$$.isSelected($node$$103$$) && $_this$$26$$.$_select$($node$$103$$, !0);
          return!0;
        });
        this.$_data$.$core$.$suppressSelectEvent$ = !1;
        this.$_fireOptionChangeEvent$("selection", $prevSelections$$4$$, null, $event$$497$$);
      }
      return!1;
    }, f2:function() {
      ...
      "relative").append($$$$35$$("\x3cinput /\x3e", {value:$t$$15$$, "class":"oj-tree-rename-input", css:{padding:"0", border:"1px solid silver", position:"absolute", left:$rtl$$4$$ ? "auto" : $w1$$ + $w2$$ + 4 + "px", right:$rtl$$4$$ ? $w1$$ + $w2$$ + 4 + "px" : "auto", top:"0px", height:this.$_data$.$core$.$li_height$ - 2 + "px", lineHeight:this.$_data$.$core$.$li_height$ - 2 + "px", width:"150px"}, blur:$$$$35$$.proxy(function() {
        var $i$$420$$ = $obj$$105$$.children(".oj-tree-rename-input"), $v$$5$$ = $i$$420$$.val();
        "" === $v$$5$$ && ($v$$5$$ = $t$$15$$);
        $h1$$.remove();
        $i$$420$$.remove();
      ...
      }, this), keyup:function($event$$498_key$$151$$) {
        $event$$498_key$$151$$ = $event$$498_key$$151$$.keyCode || $event$$498_key$$151$$.which;
        if (!$_this$$28$$.$_done$) {
          return $_this$$28$$.$_done$ = !0, !1;
        }
        27 == $event$$498_key$$151$$ ? ($_this$$28$$.$_done$ = !1, this.value = $t$$15$$, this.blur()) : 13 == $event$$498_key$$151$$ ? ($_this$$28$$.$_done$ = !1, this.blur()) : $h2$$.width(Math.min($h1$$.text("pW" + this.value).width(), $w$$9$$));
      }, keypress:function($event$$499$$) {
        if (13 == ($event$$499$$.keyCode || $event$$499$$.which)) {
          return!1;
        }
    ...
    }, $_processSubId$:function($locator$$35_sNode$$) {
      var $c$$51_i$$421_subId$$33$$, $node$$104$$, $a$$115_sKey$$;
      $a$$115_sKey$$ = null;
      var $ret$$42$$;
      $locator$$35_sNode$$ && ($c$$51_i$$421_subId$$33$$ = $locator$$35_sNode$$.subId);
      if (!$c$$51_i$$421_subId$$33$$) {
        return null;
      }
      $a$$115_sKey$$ = $c$$51_i$$421_subId$$33$$.split("[");
      if (3 === $a$$115_sKey$$.length && ($a$$115_sKey$$[0] = $a$$115_sKey$$[0].trim(), "oj-tree-node" === $a$$115_sKey$$[0] && ($a$$115_sKey$$[1] = $a$$115_sKey$$[1].trim(), $c$$51_i$$421_subId$$33$$ = $a$$115_sKey$$[1].charAt(0), $c$$51_i$$421_subId$$33$$ = $a$$115_sKey$$[1].indexOf($c$$51_i$$421_subId$$33$$, 1), 0 <= $c$$51_i$$421_subId$$33$$ && ($locator$$35_sNode$$ = $a$$115_sKey$$[1].substring(1, $c$$51_i$$421_subId$$33$$).trim(), $a$$115_sKey$$[2] = $a$$115_sKey$$[2].trim(), $c$$51_i$$421_subId$$33$$ = 
      $a$$115_sKey$$[2].charAt(0), $c$$51_i$$421_subId$$33$$ = $a$$115_sKey$$[2].indexOf($c$$51_i$$421_subId$$33$$, 1), 0 <= $c$$51_i$$421_subId$$33$$)))) {
        $a$$115_sKey$$ = $a$$115_sKey$$[2].substring(1, $c$$51_i$$421_subId$$33$$).trim();
        try {
          $node$$104$$ = this.$_getNode$($locator$$35_sNode$$);
        } catch ($e$$142$$) {
          $node$$104$$ = null;
        }
        if ($a$$115_sKey$$ && $node$$104$$ && -1 !== $node$$104$$) {
          switch($a$$115_sKey$$) {
            case "icon":
              this.$_data$.$themes$.icons && ($ret$$42$$ = $node$$104$$.find(" \x3e a \x3e ins:eq(0)"));
              break;
            case "link":
              $ret$$42$$ = $node$$104$$.find(" \x3e a:eq(0)");
              break;
            case "disclosure":
              this.$_isLeaf$($node$$104$$) || ($ret$$42$$ = $node$$104$$.find(" \x3e ins:eq(0)"));
              break;
            case "title":
              $ret$$42$$ = $node$$104$$.find(" \x3e a \x3e span");
          }
        }
      }
      ...
      var $ret$$43$$ = 0, $span$$2_val$$71$$, $$div_c$$52_s$$35$$;
      window.getComputedStyle && ($$div_c$$52_s$$35$$ = this.$_data$.ui.$animDurDiv$, $$div_c$$52_s$$35$$ || ($$div_c$$52_s$$35$$ = $$$$35$$("\x3cdiv id\x3d'ojtree-comp-animduration'\x3e\x3cspan class\x3d'oj-tree-transition'\x3edummy\x3c/span\x3e\x3c/div\x3e"), this.$_data$.ui.$animDurDiv$ = $$div_c$$52_s$$35$$, $$$$35$$("body").append($$div_c$$52_s$$35$$)), $span$$2_val$$71$$ = $$div_c$$52_s$$35$$[0].childNodes[0], $span$$2_val$$71$$ = window.getComputedStyle($span$$2_val$$71$$), $span$$2_val$$71$$ = 
      $span$$2_val$$71$$.transitionDuration ? $span$$2_val$$71$$.transitionDuration : $span$$2_val$$71$$["-webkit-transition-duration"] ? $span$$2_val$$71$$["-webkit-transition-duration"] : 0, $$div_c$$52_s$$35$$.detach(), "string" == typeof $span$$2_val$$71$$ && 1 < $span$$2_val$$71$$.length && ($$div_c$$52_s$$35$$ = $span$$2_val$$71$$.charAt($span$$2_val$$71$$.length - 1).toLowerCase(), "s" == $$div_c$$52_s$$35$$ ? ($span$$2_val$$71$$ = $span$$2_val$$71$$.substring(0, $span$$2_val$$71$$.length - 
      1), $span$$2_val$$71$$ = parseFloat($span$$2_val$$71$$), isNaN($span$$2_val$$71$$) || ($ret$$43$$ = 1E3 * $span$$2_val$$71$$)) : 2 < $span$$2_val$$71$$.length && ($$div_c$$52_s$$35$$ = $span$$2_val$$71$$.substring($span$$2_val$$71$$.length - 2).toLowerCase(), "ms" == $$div_c$$52_s$$35$$ && ($span$$2_val$$71$$ = parseFloat($span$$2_val$$71$$), isNaN($span$$2_val$$71$$) || ($ret$$43$$ = $span$$2_val$$71$$)))));
      return $ret$$43$$;
