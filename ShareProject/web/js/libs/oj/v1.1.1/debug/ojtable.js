  ...
  oj.__registerWidget("oj.ojTable", $['oj']['baseComponent'],
    {
     ...
     /**
            ...
            data.fetch(options).then(function(result)
            {
              if (result != null)
              {
                if (result['data'] != null)
                {
                  ...
                  self._refreshAll({'data': result['data'], 'keys' : result['keys'], 'indexes': indexArray}, result['startIndex']);
                }
              }
      ...
      _refreshAll: function(resultObject, startIndex)
      {
        ...
        this._refreshTableFooter();
        this._refreshTableBody(resultObject, startIndex);      
      },
      /**
       * Handler for column sort
       * @param {number} columnIdx  column index
...
oj.TableDomUtils.prototype.createTableHeaderAccSelectRowColumn = function()
{
  ...
  headerColumn.text(selectRowTitle);
...
/**
  ...
  */
 oj.TableDomUtils.prototype.refreshTableDimensions = function(width, height)
{
