...
var DvtStyleProcessor = {
  ...
  'CSS_BACKGROUND_PROPERTIES':
    function(cssDiv) {
      return DvtStyleProcessor._buildCssBackgroundPropertiesString(cssDiv);
    },
  'CSS_URL':
    function(cssDiv) {
  ...
  for (var i=0;i<definitions.length; i++) {
    ...
    if(property) {
      ...
      if(value != null) {
        ...
        // If a handler was used, combine the value from the options with the value from the skin. The optionsValue is
        // always appended, so that it takes precedence.
        // TODO: There is a bug here where non-initial options specifications could wipe out properties from the skin. 
        //       We should fix this by storing a separate skin map that is passed to the JS component.
