...
oj.__registerWidget('oj.ojChart', $['oj']['dvtBaseComponent'],
  {
    ...
    _GetTranslationMap: function() {
      ...
      // Modify groupName for backwards compatibility
      translations['labelDefaultGroupName'] = translations['labelDefaultGroupName'].replace('{groupName}', '{0}');
 ...
 * 
 * <ul>
 * <li><b>indexPath</b>: The array of indices corresponding to the position of the group in the options array.</li>
 * </ul>
 * 
 * @ojsubid
 * @member
 ...
 * 
 * <ul>
 * <li><b>axis</b>: <code class="prettyprint">xAxis</code>, <code class="prettyprint">yAxis</code>, or <code class="prettyprint">y2Axis</code></li>
 * </ul>
 * 
 * @ojsubid
 * @member
 * @name oj-chart-axis-title
 * @memberof oj.ojChart
 * @instance
 * 
 ...
 * <ul>
 * <li><b>axis</b>: <code class="prettyprint">xAxis</code>, <code class="prettyprint">yAxis</code>, or <code class="prettyprint">y2Axis</code></li>
 * <li><b>index</b>: The index of the reference object for the specified axis.</li>
 * </ul>
 * 
 * @ojsubid
 * @member
 * @name oj-chart-reference-object
 * @memberof oj.ojChart
 * @instance
 * 
 ...
 * 
 * <ul>
 * <li><b>sectionIndexPath</b>: The array of numerical indices for the section.</li>
 * <li><b>itemIndex</b>: The index of the item within the specified section</li>
 * </ul>
 * 
 * @ojsubid
 * @member
