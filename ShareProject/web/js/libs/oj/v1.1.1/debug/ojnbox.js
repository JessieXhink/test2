 ...
 * 
 * <ul>
 * <li><b>row</b>: The id of the row.</li>
 * <li><b>column</b>: The id of the column.</li>
 * </ul>
 * 
 * @ojsubid
 * @member
 ...
 * 
 * <ul>
 * <li><b>index</b>: The index of the node in the dialog.</li>
 * </ul>
 * 
 * @ojsubid
 * @member
 * @name oj-nbox-dialog-node
 * @memberof oj.ojNBox
 * @instance
 * 
 ...
 * @ojsubid
 * @member
 * @name oj-nbox-dialog-close-button
 * @memberof oj.ojNBox
 * @instance
 * 
 ...
 * 
 * <ul>
 * <li><b>row</b>: The id of the row of the associated cell, if one exists.</li>
 * <li><b>column</b>: The id of the column of the associated cell, if one exists.</li>
 * <li><b>groupCategory</b>: The category represented by the returned group node.</li>
 * </ul>
 * 
 * @ojsubid
 * @member
 * @name oj-nbox-group-node
 * @memberof oj.ojNBox
 * @instance
 * 
 ...
 * 
 * <ul>
 * <li><b>row</b>: The id of the row of the containing cell.</li>
 * <li><b>column</b>: The id of the column of the containing cell.</li>
 * <li><b>index</b>: The index of the node in the specified cell.</li>
 * </ul>
 * 
 * @ojsubid
 * @member
