...
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore", "ojs/ojbutton", "ojs/ojmenu", "ojs/ojlistview"], function($oj$$20$$, $$$$19$$) {
  ...
  $oj$$20$$.$DefaultNavListHandler$.prototype.$HandleArrowKeys$ = function $$oj$$20$$$$DefaultNavListHandler$$$$HandleArrowKeys$$($keyCode$$9$$, $isExtend$$1$$, $event$$262$$) {
  ...
  $oj$$20$$.$HorizontalNavListHandler$.prototype.$HandleArrowKeys$ = function $$oj$$20$$$$HorizontalNavListHandler$$$$HandleArrowKeys$$($keyCode$$11_processed$$3$$, $isExtend$$2$$, $event$$263$$) {
    ...
    $keyCode$$11_processed$$3$$ = $_ojNavigationListView$$.$superclass$.$HandleArrowKeys$.call(this.$m_widget$, $keyCode$$11_processed$$3$$, $isExtend$$2$$, $event$$263$$);
  ...
  $oj$$20$$.$HorizontalNavListHandler$.prototype.$BeforeRenderComplete$ = function $$oj$$20$$$$HorizontalNavListHandler$$$$BeforeRenderComplete$$() {
    ...
    this.$m_widget$.element.find("." + this.$m_widget$.$getItemElementStyleClass$()).each(function($index$$172$$) {
      0 < $index$$172$$ && $$$$19$$(this).before('\x3cli role\x3d"separator" class\x3d"' + $self$$121$$.$m_widget$.$DIVIDER_STYLE_CLASS$ + '"\x3e\x3c/li\x3e');
    });
  };
  ...
  $oj$$20$$.$CollapsibleNavListHandler$.prototype.$HandleExpandAndCollapseKeys$ = function $$oj$$20$$$$CollapsibleNavListHandler$$$$HandleExpandAndCollapseKeys$$($event$$264$$, $keyCode$$13$$, $current$$12$$, $currentItemKey$$1$$) {
    ...
    if ($keyCode$$13$$ === this.$m_widget$.$LEFT_KEY$ || $keyCode$$13$$ === this.$m_widget$.$RIGHT_KEY$) {
      return $keyCode$$13$$ === this.$m_widget$.$LEFT_KEY$ && !this.$m_widget$.$isRtl$() || $keyCode$$13$$ === this.$m_widget$.$RIGHT_KEY$ && this.$m_widget$.$isRtl$() ? this.$m_widget$.$GetState$($current$$12$$) === this.$m_widget$.$STATE_EXPANDED$ && this.$m_widget$.$CollapseItem$($current$$12$$, $event$$264$$, !0, $currentItemKey$$1$$, !0, !0) : this.$m_widget$.$GetState$($current$$12$$) === this.$m_widget$.$STATE_COLLAPSED$ && this.$m_widget$.$ExpandItem$($current$$12$$, $event$$264$$, !0, $currentItemKey$$1$$, 
      !0, !0, !0), !0;
    }
  ...
  $oj$$20$$.$SlidingNavListHandler$.prototype.$_slideAnimation$ = function $$oj$$20$$$$SlidingNavListHandler$$$$_slideAnimation$$($item$$66$$, $isMovingNext$$, $focusableElement$$) {
    var $self$$122$$ = this, $list_root$$ = this.$m_widget$.$getRootElement$(), $contentWidth$$ = $list_root$$.outerWidth() / 2, $isRtl$$1$$ = this.$m_widget$.$isRtl$();
    ...
    $isRtl$$1$$ ? ($list_root$$.css({"margin-right":$contentWidth$$}), $list_root$$.animate({"margin-right":"0px"}, 400, "swing", function() {
      $self$$122$$.$_slideAnimationComplete$($item$$66$$, $isMovingNext$$, $focusableElement$$);
  ...
  $oj$$20$$.$SlidingNavListHandler$.prototype.$Expand$ = function $$oj$$20$$$$SlidingNavListHandler$$$$Expand$$($groupItem$$15$$, $animate$$9$$) {
    ...
    if (0 < $currentListRoot$$.length) {
      ...
      var $nextFocusableItem$$ = $sublist$$3$$.find("." + this.$m_widget$.$getItemElementStyleClass$() + ":eq(0)"), $listOfParents$$ = $target$$82$$.parentsUntil($currentListRoot$$, "ul"), $listOfParents$$ = $currentListRoot$$.is(this.$m_widget$.element) ? $listOfParents$$.get().concat($currentListRoot$$.get()) : $listOfParents$$.get(), $self$$123$$ = this, $itemNode$$, $listOfParents$$ = $$$$19$$($listOfParents$$.reverse());
      $listOfParents$$.each(function($i$$303$$, $parentList$$) {
        $parentLabel$$ = $$$$19$$($parentList$$).is($self$$123$$.$m_widget$.element) ? $self$$123$$.$m_widget$.$getRootLabel$() : $self$$123$$.$m_widget$.$getItemLabel$($$$$19$$($parentList$$).parent());
        $itemNode$$ = $i$$303$$ === $listOfParents$$.length - 1 ? $target$$82$$ : $$$$19$$($listOfParents$$.get($i$$303$$ + 1)).parent();
        $self$$123$$.$_addItemToHviewMenu$($self$$123$$.$m_widget$.$GetKey$($itemNode$$[0]), $self$$123$$.$m_widget$.$getItemLabel$($itemNode$$), $parentLabel$$);
        $self$$123$$.$m_expanded$.push($itemNode$$);
      });
    }
  ...
  $oj$$20$$.$SlidingNavListHandler$.prototype.$_initializeHierarchicalView$ = function $$oj$$20$$$$SlidingNavListHandler$$$$_initializeHierarchicalView$$() {
    var $self$$125$$ = this, $menuid$$ = this.$_hviewMenu$.uniqueId().attr("id");
    this.$_hviewMenu$.ojMenu({openOptions:{position:{my:"end top", at:"end bottom"}}, select:function($event$$265$$, $ui$$12$$) {
      for (var $itemsToRemove$$ = $ui$$12$$.item.nextAll(), $currentKey$$, $item$$70$$, $expandedItems$$ = $self$$125$$.$m_expanded$, $targetItemKey$$ = $ui$$12$$.item.data("key"), $i$$304$$ = $expandedItems$$.length - 1;0 <= $i$$304$$ && ($item$$70$$ = $expandedItems$$[$i$$304$$], $currentKey$$ = $self$$125$$.$m_widget$.$GetKey$($item$$70$$[0]), $self$$125$$.$m_widget$.$CollapseItem$($$$$19$$($item$$70$$), null, !0, $currentKey$$, !0, !0), $targetItemKey$$ !== $currentKey$$);$i$$304$$--) {
      }
      $itemsToRemove$$.remove();
      $ui$$12$$.item.remove();
      $self$$125$$.$_hviewMenu$.ojMenu("refresh");
    }});
  ...
  $oj$$20$$.$SlidingNavListHandler$.prototype.$_addItemToHviewMenu$ = function $$oj$$20$$$$SlidingNavListHandler$$$$_addItemToHviewMenu$$($itemKey$$, $label$$7$$, $parentLabel$$1$$) {
    if (this.$_hviewBtn$) {
      ...
      if (0 < $itemsinTree_menuItemLabel$$) {
        for (var $i$$305$$ = 0;$i$$305$$ < $itemsinTree_menuItemLabel$$;$i$$305$$++) {
          0 < $i$$305$$ && $menuItem$$.append($$$$19$$(document.createElement("span")).addClass("oj-navigationlist-hvitem-space"));
        }
      ...
      this.$_headerLabel$.text($label$$7$$);
    }
  };
  ...
  $_HORIZONTAL_NAVLIST_STYLE_CLASS$:"oj-navigationlist-horizontal", $_NAVLIST_HAS_ICONS$:"oj-navigationlist-has-icons", $_NAVLIST_ITEM_HAS_NO_ICON$:"oj-navigationlist-item-no-icon", $_NAVLIST_ITEM_TITLE$:"oj-navigationlist-item-title", $_NAVLIST_STYLE_CLASS$:"oj-navigationlist", $_NAVLIST_TOUCH_STYLE_CLASS$:"oj-navigationlist-touch", $_NAVLIST_LISTVIEW_CONTAINER_STYLE_CLASS$:"oj-navigationlist-listview-container", $getItemLabel$:function($itemContent$$8_target$$84$$) {
    ...
    for (var $i$$306$$ = 0;$i$$306$$ < $items$$7_list$$2$$.length;$i$$306$$++) {
      var $item$$73$$ = $items$$7_list$$2$$[$i$$306$$], $item$$73$$ = $$$$19$$($item$$73$$);
    ...
    var $self$$126$$ = this, $element$$103_listViewContainer$$ = $navlistopts_opts$$28$$.$ojContext$.element;
    $element$$103_listViewContainer$$.addClass(this.$_NAVLIST_STYLE_CLASS$);
    $oj$$20$$.$DomUtils$.$isTouchSupported$() && $element$$103_listViewContainer$$.addClass(this.$_NAVLIST_TOUCH_STYLE_CLASS$);
    this.$_list$ = $element$$103_listViewContainer$$.children("ul:first");
    0 === this.$_list$.length && (this.$_list$ = $$$$19$$(document.createElement("ul")), $element$$103_listViewContainer$$.append(this.$_list$));
    $element$$103_listViewContainer$$ = $$$$19$$(document.createElement("div"));
    $element$$103_listViewContainer$$.addClass(this.$_NAVLIST_LISTVIEW_CONTAINER_STYLE_CLASS$);
    this.$_list$.wrap($element$$103_listViewContainer$$);
    ...
    this.$ojContext$._on(this.$ojContext$.element, {"click .oj-navigationlist-previous-link":function() {
      $self$$126$$.$_collapseCurrentList$();
    }, "keydown .oj-navigationlist-previous-link":function($event$$267$$) {
      $event$$267$$.keyCode === $$$$19$$.ui.keyCode.ENTER && $self$$126$$.$_collapseCurrentList$();
    }, "keydown .oj-navigationlist-element":function($event$$268$$) {
      $event$$268$$.keyCode !== $$$$19$$.ui.keyCode.ESCAPE || $event$$268$$.isDefaultPrevented() || $self$$126$$.$_collapseCurrentList$();
    }});
  ...
  }, $HandleArrowKeys$:function($keyCode$$14$$, $isExtend$$3$$, $event$$269$$) {
    return this.$m_listHandler$.$HandleArrowKeys$($keyCode$$14$$, $isExtend$$3$$, $event$$269$$);
  ...
  }, $HandleMouseClick$:function($event$$272$$) {
    var $item$$77$$ = this.$FindItem$($$$$19$$($event$$272$$.target));
    null == $item$$77$$ || 0 === $item$$77$$.length || this.$SkipFocus$($item$$77$$) || (this.$GetKey$($item$$77$$[0]), this.$IsNodeEditableOrClickable$($$$$19$$($event$$272$$.target)) || $item$$77$$.hasClass("oj-disabled") || ($_ojNavigationListView$$.$superclass$.$HandleMouseClick$.apply(this, arguments), $event$$272$$.preventDefault(), this.element.focus()));
  }, $HandleKeyDown$:function($event$$273$$) {
    var $item$$78_key$$115_keyCode$$16$$;
    $item$$78_key$$115_keyCode$$16$$ = $event$$273$$.keyCode;
    this.$m_listHandler$.$HandleExpandAndCollapseKeys$($event$$273$$, $item$$78_key$$115_keyCode$$16$$, this.$m_active$.elem, this.$m_active$.key);
    ...
    this.$GetKey$($item$$78_key$$115_keyCode$$16$$[0]), this.$SetOption$("currentItem", $item$$78_key$$115_keyCode$$16$$), $event$$273$$.preventDefault()) : !0 === this.$HandleSelectionOrActiveKeyDown$($event$$273$$) && $event$$273$$.preventDefault();
  }, $ToggleSelection$:function($event$$274$$, $keepCurrentSelection$$1$$, $skipIfNotSelected$$1$$) {
    var $item$$79$$ = this.$m_active$.elem;
    this.$IsSelectable$($item$$79$$[0]) && (this.$_isSelected$($item$$79$$) || this.$_fireBeforeSelectEvent$($event$$274$$, $item$$79$$) && $_ojNavigationListView$$.$superclass$.$ToggleSelection$.apply(this, arguments));
  ...
  }, $Trigger$:function($type$$83$$, $event$$275$$, $ui$$13$$) {
    return "ready" !== $type$$83$$ ? this.$ojContext$._trigger($type$$83$$, $event$$275$$, $ui$$13$$) : !0;
  }, $SetOption$:function($key$$116$$, $value$$228$$, $flags$$25$$) {
    "selection" === $key$$116$$ ? $value$$228$$ && 0 < $value$$228$$.length ? this.$ojContext$.option($key$$116$$, $value$$228$$[0], $flags$$25$$) : this.$ojContext$.option($key$$116$$, null, $flags$$25$$) : this.$ojContext$.option($key$$116$$, $value$$228$$, $flags$$25$$);
  ...
  }, $setOptions$:function($options$$302$$, $flags$$26$$) {
      ...
      if ($value$$229$$) {
        ...
        if (!$item$$81_selection$$12$$ || 0 === $item$$81_selection$$12$$.length || $item$$81_selection$$12$$[0] !== $value$$229$$) {
          if ($item$$81_selection$$12$$ = this.$FindElementByKey$($value$$229$$), this.$IsSelectable$($item$$81_selection$$12$$) && this.$_fireBeforeSelectEvent$(null, $$$$19$$($item$$81_selection$$12$$))) {
            return $_ojNavigationListView$$.$superclass$.$setOptions$.call(this, {selection:[$value$$229$$]}, $flags$$26$$);
          }
        }
      } else {
        return $_ojNavigationListView$$.$superclass$.$setOptions$.call(this, {selection:[]}, $flags$$26$$);
      }
    } else {
      return $_ojNavigationListView$$.$superclass$.$setOptions$.call(this, $options$$302$$, $flags$$26$$);
    }
    return!1;
  ...
  }, $SelectAndFocus$:function($item$$82$$, $event$$276$$) {
    if (!$item$$82$$.hasClass("oj-disabled") && this.$IsSelectable$($item$$82$$[0])) {
      ...
      this.$_isSelected$($item$$82$$) || this.$_fireBeforeSelectEvent$($event$$276$$, $item$$82$$) && $_ojNavigationListView$$.$superclass$.$SelectAndFocus$.apply(this, arguments);
    }
  }, $_fireBeforeSelectEvent$:function($event$$277$$, $item$$83$$) {
    var $key$$119$$ = this.$GetKey$($item$$83$$[0]);
    return this.$Trigger$("beforeSelect", $event$$277$$, {item:$item$$83$$, key:$key$$119$$});
  ...
  }, getNodeBySubId:function($item$$85_key$$121_locator$$22$$) {
    var $subId$$23$$;
    if (null === $item$$85_key$$121_locator$$22$$) {
      return this.element ? this.element[0] : null;
    }
    $subId$$23$$ = $item$$85_key$$121_locator$$22$$.subId;
    return "oj-navigationlist-item" === $subId$$23$$ ? ($item$$85_key$$121_locator$$22$$ = $item$$85_key$$121_locator$$22$$.key, $item$$85_key$$121_locator$$22$$ = this.$FindElementByKey$($item$$85_key$$121_locator$$22$$)) : "oj-navigationlist-previous-link" === $subId$$23$$ ? this.$m_listHandler$.$_previousLink$ ? this.$m_listHandler$.$_previousLink$[0] : null : "oj-navigationlist-hierarchical-button" === $subId$$23$$ ? this.$m_listHandler$.$_hviewBtn$ ? this.$m_listHandler$.$_hviewBtn$[0] : null : 
    "oj-navigationlist-hierarchical-menu" === $subId$$23$$ ? this.$m_listHandler$.$_hviewMenu$ ? this.$m_listHandler$.$_hviewMenu$[0] : null : null;
  }, refresh:function() {
    this.$_resetNavlist$();
    this.$_initListHandler$();
  ...
  (function() {
    $oj$$20$$.$__registerWidget$("oj.ojNavigationList", $$$$19$$.oj.baseComponent, {widgetEventPrefix:"oj", options:{currentItem:null, drillMode:"none", edge:"start", rootLabel:null, selection:null, expanded:"auto", data:null, display:"all", item:{renderer:null, selectable:!0}, beforeSelect:null, beforeCollapse:null, beforeCurrentItem:null, collapse:null, beforeExpand:null, expand:null, optionChange:null}, _ComponentCreate:function() {
    ...
    }, $_NotifyContextMenuGesture$:function($menu$$8$$, $event$$278$$, $eventType$$41$$) {
      this.$navlist$.$notifyContextMenuGesture$($menu$$8$$, $event$$278$$, $eventType$$41$$);
    }, $_setup$:function() {
      ...
      return this.$navlist$.getNodeBySubId($locator$$23$$);
    ...
    }, _setOptions:function($options$$303$$, $flags$$27$$) {
      var $needRefresh$$1$$ = this.$navlist$.$setOptions$($options$$303$$, $flags$$27$$);
      this._super($options$$303$$, $flags$$27$$);
