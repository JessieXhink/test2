...
define(["ojs/ojcore", "jquery", "ojs/ojeditablevalue"], function($oj$$49$$) {
  (function() {
    $oj$$49$$.$__registerWidget$("oj.ojSwitch", $.oj.editableValue, {version:"1.1.0", defaultElement:"\x3cinput\x3e", widgetEventPrefix:"oj", options:{disabled:!1, readOnly:!1, required:!1, title:void 0, value:!1}, refresh:function() {
    ...
    }, getNodeBySubId:function($locator$$52_subId$$49$$) {
      var $node$$110$$, $rootElement$$1$$ = this.widget();
      $node$$110$$ = null == $locator$$52_subId$$49$$ || null == $locator$$52_subId$$49$$.subId ? $rootElement$$1$$ : null;
      return $node$$110$$ || ($locator$$52_subId$$49$$ = $locator$$52_subId$$49$$.subId, "oj-switch-thumb" !== $locator$$52_subId$$49$$ && "oj-switch-track" !== $locator$$52_subId$$49$$) ? $node$$110$$ || null : $rootElement$$1$$.find("." + $locator$$52_subId$$49$$)[0];
      ...
      $val$$75$$ = this.option("value");
      this.option({readOnly:!1, required:!1, value:!!$val$$75$$}, {_context:{$writeback$:!0, $internalSet$:!0}});
      ...
      var $rootElement$$2$$ = $(this.widget()), $thumbTitle$$ = this.option("title");
      void 0 !== $rootElement$$2$$ && (this.element.attr("checked", this.option("value")), $rootElement$$2$$.removeClass("oj-disabled oj-selected oj-hover oj-active"), $(this.$switchThumb$).attr("tabindex", "0"), this.option("disabled") && ($rootElement$$2$$.addClass("oj-disabled"), $(this.$switchThumb$).removeAttr("tabindex")), this.option("value") && $rootElement$$2$$.addClass("oj-selected"), void 0 !== $thumbTitle$$ && $(this.$switchThumb$).attr("title", $thumbTitle$$), $(this.$switchThumb$).attr("aria-checked", 
      this.option("value")), $(this.$switchThumb$).removeAttr("aria-disabled"), $rootElement$$2$$.removeAttr("aria-disabled"), this.$_CanSetValue$() || $(this.$switchThumb$).attr("aria-disabled", "true"));
    ...
    }, $_switchEvents$:{keydown:function($event$$559$$) {
      if ($event$$559$$.which === $.ui.keyCode.ENTER || $event$$559$$.which === $.ui.keyCode.SPACE) {
        $($event$$559$$.currentTarget).addClass("oj-active"), $event$$559$$.preventDefault();
      }
    }, keyup:function($event$$560$$) {
      $event$$560$$.which !== $.ui.keyCode.ENTER && $event$$560$$.which !== $.ui.keyCode.SPACE || this.$_SetValue$(!this.option("value"), $event$$560$$);
    }, mousedown:function($event$$561$$) {
      1 === $event$$561$$.which && $($event$$561$$.currentTarget).addClass("oj-active");
    }, mouseup:function($event$$562$$) {
      1 === $event$$562$$.which && this.$_SetValue$(!this.option("value"), $event$$562$$);
    }, $touchstart$:function($event$$563$$) {
      this.$_SetValue$(!this.option("value"), $event$$563$$);
      $event$$563$$.preventDefault();
      ...
      return this.$_element2$;
    }, _setOption:function($key$$171$$, $coercedValue$$2_value$$267$$, $flags$$44$$) {
      switch($key$$171$$) {
        case "disabled":
        ;
        case "value":
      ...
      this._super($key$$171$$, $coercedValue$$2_value$$267$$, $flags$$44$$);
      this.$_setup$();
    }});
  })();
});
