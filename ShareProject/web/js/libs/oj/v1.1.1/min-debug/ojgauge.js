...
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore", "ojs/ojdvt-base", "ojs/internal-deps/dvt/DvtGauge"], function($oj$$16$$, $$$$16$$, $comp$$5$$, $base$$4$$, $dvt$$2$$) {
  $oj$$16$$.$__registerWidget$("oj.dvtBaseGauge", $$$$16$$.oj.dvtBaseComponent, {$_ProcessStyles$:function() {
    ...
    return $ret$$30$$;
  }, $_HandleEvent$:function($event$$212$$) {
    var $type$$80$$ = $event$$212$$ && $event$$212$$.getType ? $event$$212$$.getType() : null;
    $type$$80$$ === $dvt$$2$$.DvtValueChangeEvent.TYPE ? this.$_UserOptionChange$("value", $event$$212$$.getNewValue()) : $type$$80$$ === $dvt$$2$$.DvtValueChangeEvent.TYPE_INPUT ? this._trigger("input", null, {value:$event$$212$$.getNewValue()}) : this._super($event$$212$$);
  }}, !0);
  $oj$$16$$.$__registerWidget$("oj.ojStatusMeterGauge", $$$$16$$.oj.dvtBaseGauge, {widgetEventPrefix:"oj", options:{input:null, optionChange:null}, $_CreateDvtComponent$:function($context$$55$$, $callback$$93$$, $callbackObj$$1$$) {
    return $dvt$$2$$.DvtStatusMeterGauge.newInstance($context$$55$$, $callback$$93$$, $callbackObj$$1$$);
  ...
  $oj$$16$$.$__registerWidget$("oj.ojDialGauge", $$$$16$$.oj.dvtBaseGauge, {widgetEventPrefix:"oj", options:{input:null, optionChange:null}, $_CreateDvtComponent$:function($context$$58$$, $callback$$96$$, $callbackObj$$4$$) {
    return $dvt$$2$$.DvtDialGauge.newInstance($context$$58$$, $callback$$96$$, $callbackObj$$4$$);
  }, $_GetComponentStyleClasses$:function() {
