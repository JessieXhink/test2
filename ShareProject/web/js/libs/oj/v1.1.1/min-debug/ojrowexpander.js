...
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore", "ojs/ojmodel", "ojs/ojdatacollection-common"], function($oj$$21$$, $$$$20$$) {
  ...
  $oj$$21$$.$FlattenedNodeSet$.prototype.$_getCount$ = function $$oj$$21$$$$FlattenedNodeSet$$$$_getCount$$($nodeSet$$16$$, $total$$) {
    var $start$$44$$, $count$$36$$, $i$$307$$, $child$$4$$;
    $start$$44$$ = $nodeSet$$16$$.$getStart$();
    $count$$36$$ = $nodeSet$$16$$.$getCount$();
    $total$$ += $count$$36$$;
    if ($nodeSet$$16$$.$getChildNodeSet$) {
      for ($i$$307$$ = 0;$i$$307$$ < $count$$36$$;$i$$307$$++) {
        $child$$4$$ = $nodeSet$$16$$.$getChildNodeSet$($i$$307$$ + $start$$44$$), null != $child$$4$$ && ($total$$ = this.$_getCount$($child$$4$$, $total$$));
      }
    }
    return $total$$;
  };
  ...
  $oj$$21$$.$FlattenedNodeSet$.prototype.$_getDataOrMetadata$ = function $$oj$$21$$$$FlattenedNodeSet$$$$_getDataOrMetadata$$($nodeSet$$19$$, $index$$180$$, $current$$15$$, $func$$8$$) {
    var $start$$45$$, $count$$37$$, $i$$308$$, $child$$5_currIndex_result$$57$$;
    $start$$45$$ = $nodeSet$$19$$.$getStart$();
    $count$$37$$ = $nodeSet$$19$$.$getCount$();
    for ($i$$308$$ = 0;$i$$308$$ < $count$$37$$;$i$$308$$++) {
      $child$$5_currIndex_result$$57$$ = $current$$15$$.index;
      if ($child$$5_currIndex_result$$57$$ === $index$$180$$) {
        return $func$$8$$.call(this, $nodeSet$$19$$, $i$$308$$ + $start$$45$$);
      }
      $current$$15$$.index = $child$$5_currIndex_result$$57$$ + 1;
      if ($nodeSet$$19$$.$getChildNodeSet$ && ($child$$5_currIndex_result$$57$$ = $nodeSet$$19$$.$getChildNodeSet$($i$$308$$ + $start$$45$$), null != $child$$5_currIndex_result$$57$$ && ($child$$5_currIndex_result$$57$$ = this.$_getDataOrMetadata$($child$$5_currIndex_result$$57$$, $index$$180$$, $current$$15$$, $func$$8$$), null != $child$$5_currIndex_result$$57$$))) {
        return $child$$5_currIndex_result$$57$$;
      }
    }
    return null;
  };
  ...
  $oj$$21$$.$MergedNodeSet$.prototype.$_findIndex$ = function $$oj$$21$$$$MergedNodeSet$$$$_findIndex$$($key$$127$$) {
    var $i$$309_start$$46$$, $end$$16$$, $rowKey$$19$$;
    $i$$309_start$$46$$ = this.$m_nodeSet1$.$getStart$();
    for ($end$$16$$ = $i$$309_start$$46$$ + this.$m_nodeSet1$.$getCount$();$i$$309_start$$46$$ < $end$$16$$;$i$$309_start$$46$$++) {
      if ($rowKey$$19$$ = this.$m_nodeSet1$.getMetadata($i$$309_start$$46$$).key, $key$$127$$ === $rowKey$$19$$) {
        return $i$$309_start$$46$$;
      }
    }
    return $end$$16$$ - 1;
  };
  ...
  $oj$$21$$.$MergedNodeSet$.prototype.getData = function $$oj$$21$$$$MergedNodeSet$$$getData$($index$$181_result$$58$$) {
    $index$$181_result$$58$$ = this.$_getRelativeIndex$($index$$181_result$$58$$);
    return $index$$181_result$$58$$.set.getData($index$$181_result$$58$$.index);
  };
  $oj$$21$$.$Object$.$exportPrototypeSymbol$("MergedNodeSet.prototype.getData", {getData:$oj$$21$$.$MergedNodeSet$.prototype.getData});
  $oj$$21$$.$MergedNodeSet$.prototype.getMetadata = function $$oj$$21$$$$MergedNodeSet$$$getMetadata$($index$$182_result$$59$$) {
    $index$$182_result$$59$$ = this.$_getRelativeIndex$($index$$182_result$$59$$);
    return $index$$182_result$$59$$.set.getMetadata($index$$182_result$$59$$.index);
  };
  ...
  $oj$$21$$.$NodeSetWrapper$.prototype.$getChildNodeSet$ = function $$oj$$21$$$$NodeSetWrapper$$$$getChildNodeSet$$($index$$186_result$$60$$) {
    return null != this.$m_collapsedKeys$ && -1 != this.$m_collapsedKeys$.indexOf(this.$m_nodeSet$.getMetadata($index$$186_result$$60$$).key) || !this.$m_nodeSet$.$getChildNodeSet$ || ($index$$186_result$$60$$ = this.$m_nodeSet$.$getChildNodeSet$($index$$186_result$$60$$), null == $index$$186_result$$60$$) ? null : new $oj$$21$$.$NodeSetWrapper$($index$$186_result$$60$$, this.$m_callback$, null, this.$m_collapsedKeys$);
  };
  ...
  $oj$$21$$.$FlattenedTreeDataSource$.prototype.handleEvent = function $$oj$$21$$$$FlattenedTreeDataSource$$$handleEvent$($eventType$$42$$, $event$$279$$) {
    return $oj$$21$$.$FlattenedTreeDataSource$.$superclass$.handleEvent.call(this, $eventType$$42$$, $event$$279$$);
  };
  ...
  $oj$$21$$.$FlattenedTreeDataSource$.prototype.$_fetchFromAncestors$ = function $$oj$$21$$$$FlattenedTreeDataSource$$$$_fetchFromAncestors$$($parent$$28$$, $depth$$15$$, $callbacks$$42$$, $maxFetchSize$$1$$) {
    var $options$$305$$, $remainToFetch$$, $i$$310$$, $currEntry_index$$188$$, $currDepth$$, $count$$42$$, $countUnknown$$, $range$$18$$, $fetchSize$$3$$;
    ...
    for ($i$$310$$ = this.$_getLastIndex$() - 1;0 <= $i$$310$$;$i$$310$$--) {
      if ($currEntry_index$$188$$ = this.$_getEntry$($i$$310$$), $currDepth$$ = $currEntry_index$$188$$.depth, $currDepth$$ < $depth$$15$$ && ($parent$$28$$ = $currEntry_index$$188$$.parent, $count$$42$$ = this.$m_wrapped$.$getChildCount$($parent$$28$$), $currEntry_index$$188$$ = $currEntry_index$$188$$.index, ($countUnknown$$ = -1 === $count$$42$$) || $currEntry_index$$188$$ < $count$$42$$ - 1)) {
        $range$$18$$ = {};
  ...
  $oj$$21$$.$FlattenedTreeDataSource$.prototype.$_processNodeSet$ = function $$oj$$21$$$$FlattenedTreeDataSource$$$$_processNodeSet$$($nodeSet$$27$$, $parent$$29$$, $depth$$16$$, $toExpand$$1$$) {
    var $nodeStart$$1$$, $nodeCount$$1$$, $i$$311$$, $key$$128_metadata$$8$$;
    $nodeStart$$1$$ = $nodeSet$$27$$.$getStart$();
    $nodeCount$$1$$ = $nodeSet$$27$$.$getCount$();
    for ($i$$311$$ = 0;$i$$311$$ < $nodeCount$$1$$;$i$$311$$++) {
      $key$$128_metadata$$8$$ = $nodeSet$$27$$.getMetadata($nodeStart$$1$$ + $i$$311$$), $key$$128_metadata$$8$$ = $key$$128_metadata$$8$$.key, this.$_addEntry$($key$$128_metadata$$8$$, $depth$$16$$, $nodeStart$$1$$ + $i$$311$$, $parent$$29$$), this.$_isExpanded$($key$$128_metadata$$8$$) && $toExpand$$1$$.push($key$$128_metadata$$8$$);
    }
  };
  ...
  $oj$$21$$.$FlattenedTreeDataSource$.prototype.$_processDescendantsNodeSet$ = function $$oj$$21$$$$FlattenedTreeDataSource$$$$_processDescendantsNodeSet$$($nodeSet$$30$$, $parent$$30$$, $depth$$17$$, $lastEntry$$2$$, $maxCount$$2$$, $options$$308$$) {
    var $nodeStart$$2$$, $nodeCount$$2$$, $i$$312$$, $childNodeSet_metadata$$10$$, $key$$130$$;
    $nodeStart$$2$$ = $nodeSet$$30$$.$getStart$();
    $nodeCount$$2$$ = $nodeSet$$30$$.$getCount$();
    for ($i$$312$$ = 0;$i$$312$$ < $nodeCount$$2$$ && $options$$308$$.count != $maxCount$$2$$;$i$$312$$++) {
      $childNodeSet_metadata$$10$$ = $nodeSet$$30$$.getMetadata($nodeStart$$2$$ + $i$$312$$);
      ...
      if (null == $lastEntry$$2$$ || $options$$308$$.found) {
        this.$_addEntry$($key$$130$$, $depth$$17$$, $nodeStart$$2$$ + $i$$312$$, $parent$$30$$), $options$$308$$.count += 1, $childNodeSet_metadata$$10$$.state = $childNodeSet_metadata$$10$$.leaf ? "leaf" : "expanded";
      }
      ...
      $nodeSet$$30$$.$getChildNodeSet$ && this.$_isExpanded$($key$$130$$) && ($childNodeSet_metadata$$10$$ = $nodeSet$$30$$.$getChildNodeSet$($i$$312$$), null != $childNodeSet_metadata$$10$$ && this.$_processDescendantsNodeSet$($childNodeSet_metadata$$10$$, $key$$130$$, $depth$$17$$ + 1, $lastEntry$$2$$, $maxCount$$2$$, $options$$308$$));
    }
  };
  ...
  $oj$$21$$.$FlattenedTreeDataSource$.prototype.collapse = function $$oj$$21$$$$FlattenedTreeDataSource$$$collapse$($rowKey$$23$$) {
    var $rowIndex$$9$$, $depth$$18_i$$313_parent$$31$$, $count$$45$$, $keys$$35_lastIndex$$, $j$$38$$;
    $rowIndex$$9$$ = this.$getIndex$($rowKey$$23$$) + 1;
    $depth$$18_i$$313_parent$$31$$ = this.$_getEntry$($rowIndex$$9$$ - 1);
    $count$$45$$ = 0;
    $depth$$18_i$$313_parent$$31$$ = $depth$$18_i$$313_parent$$31$$.depth;
    ...
    for ($j$$38$$ = $rowIndex$$9$$;$j$$38$$ < $keys$$35_lastIndex$$ + 1;$j$$38$$++) {
      ...
      if ($rowDepth$$ > $depth$$18_i$$313_parent$$31$$) {
        $count$$45$$ += 1;
      } else {
        if ($rowDepth$$ == $depth$$18_i$$313_parent$$31$$) {
          break;
    ...
    if (0 != $count$$45$$) {
      ...
      $keys$$35_lastIndex$$ = [];
      for ($depth$$18_i$$313_parent$$31$$ = 0;$depth$$18_i$$313_parent$$31$$ < $count$$45$$;$depth$$18_i$$313_parent$$31$$++) {
        $keys$$35_lastIndex$$.push({key:this.$_getEntry$($rowIndex$$9$$ + $depth$$18_i$$313_parent$$31$$).key, index:$rowIndex$$9$$ + $depth$$18_i$$313_parent$$31$$});
      }
  ...
  $oj$$21$$.$FlattenedTreeDataSource$.prototype.$_getKeyIndex$ = function $$oj$$21$$$$FlattenedTreeDataSource$$$$_getKeyIndex$$($arr$$21$$, $rowKey$$27$$) {
    var $i$$314$$, $index$$189$$;
    $index$$189$$ = -1;
    for ($i$$314$$ = 0;$i$$314$$ < $arr$$21$$.length;$i$$314$$++) {
      $arr$$21$$[$i$$314$$] === $rowKey$$27$$ && ($index$$189$$ = $i$$314$$);
    }
    return $index$$189$$;
  };
  ...
  $oj$$21$$.$FlattenedTreeDataSource$.prototype.$handleExpandSuccess$ = function $$oj$$21$$$$FlattenedTreeDataSource$$$$handleExpandSuccess$$($rowKey$$31$$, $maxCount$$4_nodeSet$$32$$, $childCount_j$$39$$, $callbacks$$45_options$$310$$) {
    var $refIndex$$1$$, $rangeStart$$, $metadata$$11_rowStart$$3$$, $rowCount$$7$$, $parent$$32$$, $depth$$19$$, $key$$131$$, $toExpand$$2$$, $i$$315$$, $queue$$4$$, $prevNodeSetInfo$$2$$;
    ...
    $toExpand$$2$$ = [];
    for ($i$$315$$ = $metadata$$11_rowStart$$3$$;$i$$315$$ < $rowCount$$7$$;$i$$315$$++) {
      $metadata$$11_rowStart$$3$$ = $maxCount$$4_nodeSet$$32$$.getMetadata($i$$315$$), $key$$131$$ = $metadata$$11_rowStart$$3$$.key, this.$_isExpanded$($key$$131$$) && $toExpand$$2$$.push($key$$131$$), this.$_insertRow$($refIndex$$1$$, $metadata$$11_rowStart$$3$$, $parent$$32$$.key, $i$$315$$, $depth$$19$$), $refIndex$$1$$++;
    }
  ...
  $oj$$21$$.$FlattenedTreeDataSource$.prototype.$_deleteAllRowsBelow$ = function $$oj$$21$$$$FlattenedTreeDataSource$$$$_deleteAllRowsBelow$$($index$$193$$, $count$$46$$) {
    ...
    $keys$$37$$ = [];
    for (var $i$$317$$ = 0;$i$$317$$ < $count$$46$$;$i$$317$$++) {
      $keys$$37$$.push({row:this.$_getEntry$($index$$193$$ + $i$$317$$).key, index:$index$$193$$ + $i$$317$$});
    }
    this.$_removeEntry$($index$$193$$, $count$$46$$);
    this.$removeRows$($keys$$37$$);
  };
  $oj$$21$$.$FlattenedTreeDataSource$.prototype.$_handleModelEvent$ = function $$oj$$21$$$$FlattenedTreeDataSource$$$$_handleModelEvent$$($event$$281$$) {
    var $operation$$5$$, $ancestors_parentKey$$7$$, $index$$194$$;
    $operation$$5$$ = $event$$281$$.operation;
    $ancestors_parentKey$$7$$ = $event$$281$$.parent;
    ...
    $index$$194$$ = $event$$281$$.index;
    "insert" === $operation$$5$$ ? this.$_handleInsertEvent$($ancestors_parentKey$$7$$, $index$$194$$, $event$$281$$.data) : "delete" === $operation$$5$$ ? this.$_handleDeleteEvent$($ancestors_parentKey$$7$$, $index$$194$$) : "refresh" === $operation$$5$$ && this.$_handleRefreshEvent$($ancestors_parentKey$$7$$);
  };
  ...
  $oj$$21$$.$FlattenedTreeDataSource$.prototype.$getIndex$ = function $$oj$$21$$$$FlattenedTreeDataSource$$$$getIndex$$($rowKey$$32$$) {
    var $lastIndex$$2$$, $i$$318$$, $rowData$$5$$;
    $lastIndex$$2$$ = this.$_getLastIndex$();
    for ($i$$318$$ = 0;$i$$318$$ <= $lastIndex$$2$$;$i$$318$$++) {
      if ($rowData$$5$$ = this.$_getEntry$($i$$318$$), $rowData$$5$$.key == $rowKey$$32$$) {
        return $i$$318$$;
      }
    }
    return-1;
  ...
  depth0:"oj-rowexpander-depth-0", depth1:"oj-rowexpander-depth-1", depth2:"oj-rowexpander-depth-2", depth3:"oj-rowexpander-depth-3", depth4:"oj-rowexpander-depth-4", depth5:"oj-rowexpander-depth-5", depth6:"oj-rowexpander-depth-6", depth7:"oj-rowexpander-depth-7"}, $constants$:{$MAX_STYLE_DEPTH$:7, $NUM5_KEY$:53}, _ComponentCreate:function() {
    ...
    "expanded" === this.$iconState$ || "collapsed" === this.$iconState$ ? ($$$$20$$(this.$toucharea$).on("touchend", function($event$$282$$) {
      $event$$282$$.preventDefault();
      $self$$127$$.$_fireExpandCollapse$();
    }), $$$$20$$(this.$toucharea$).on("click", function($event$$283$$) {
      $event$$283$$.preventDefault();
      $self$$127$$.$_fireExpandCollapse$();
    }), $$$$20$$(this.element).on("keypress", function($event$$284$$) {
      var $code$$7$$ = $event$$284$$.keyCode || $event$$284$$.which;
      if ($code$$7$$ === $$$$20$$.ui.keyCode.ENTER || $code$$7$$ === $$$$20$$.ui.keyCode.SPACE) {
        $self$$127$$.$_fireExpandCollapse$(), $event$$284$$.preventDefault(), $event$$284$$.target.focus();
      }
    ...
    this.element.empty();
  }, _setOption:function($key$$135$$, $value$$232$$, $flags$$28$$) {
    this._super($key$$135$$, $value$$232$$, $flags$$28$$);
    "context" == $key$$135$$ && this.refresh();
  }, $_addIndentation$:function() {
    var $i$$319_remainder$$, $depth$$23$$;
    $depth$$23$$ = this.depth - 1;
    if ($depth$$23$$ < this.$constants$.$MAX_STYLE_DEPTH$) {
      this.$_appendSpacer$($depth$$23$$);
    } else {
      for ($i$$319_remainder$$ = 1;$i$$319_remainder$$ <= $depth$$23$$ / this.$constants$.$MAX_STYLE_DEPTH$;$i$$319_remainder$$++) {
        this.$_appendSpacer$(this.$constants$.$MAX_STYLE_DEPTH$);
      }
      $i$$319_remainder$$ = $depth$$23$$ % this.$constants$.$MAX_STYLE_DEPTH$;
      $i$$319_remainder$$ < this.$constants$.$MAX_STYLE_DEPTH$ && this.$_appendSpacer$($i$$319_remainder$$);
    }
  ...
  }, $_handleActiveKeyChangeEvent$:function($event$$285$$, $ui$$14$$) {
  ...
  }, $_handleKeyDownEvent$:function($event$$286$$, $ui$$15$$) {
    var $ancestors$$2_code$$8_context$$79$$, $ancestorInfo$$, $i$$320$$;
    if (this.$rowKey$ === $ui$$15$$.rowKey && ($event$$286$$ = $event$$286$$.originalEvent, $ancestors$$2_code$$8_context$$79$$ = $event$$286$$.keyCode || $event$$286$$.which, $oj$$21$$.$DomUtils$.$isMetaKeyPressed$($event$$286$$))) {
      if ($ancestors$$2_code$$8_context$$79$$ == $$$$20$$.ui.keyCode.RIGHT && "collapsed" === this.$iconState$) {
        this.$_loading$(), this.$datasource$.expand(this.$rowKey$), $event$$286$$.preventDefault();
      } else {
        if ($ancestors$$2_code$$8_context$$79$$ == $$$$20$$.ui.keyCode.LEFT && "expanded" === this.$iconState$) {
          this.$_loading$(), this.$datasource$.collapse(this.$rowKey$), $event$$286$$.preventDefault();
        } else {
          if ($event$$286$$.altKey && $ancestors$$2_code$$8_context$$79$$ == this.$constants$.$NUM5_KEY$ && this.$component$.$_setAccessibleContext$) {
            ...
            if (null != $ancestors$$2_code$$8_context$$79$$ && 0 < $ancestors$$2_code$$8_context$$79$$.length) {
              for ($ancestorInfo$$ = [], $i$$320$$ = 0;$i$$320$$ < $ancestors$$2_code$$8_context$$79$$.length;$i$$320$$++) {
                $ancestorInfo$$.push({key:$ancestors$$2_code$$8_context$$79$$[$i$$320$$], label:this.$getTranslatedString$("accessibleLevelDescription", {level:$i$$320$$ + 1})});
              }
            }
    ...
    this.$_setIconStateClass$();
  }, $_handleExpandEvent$:function($event$$287_rowKey$$36$$) {
    $event$$287_rowKey$$36$$ = $event$$287_rowKey$$36$$.rowKey;
    $event$$287_rowKey$$36$$ === this.$rowKey$ && (this.$_removeIconStateClass$(), this.$iconState$ = "expanded", this.$_setIconStateClass$(), this.$_ariaExpanded$(!0), this._trigger("expand", null, {rowKey:$event$$287_rowKey$$36$$}));
  }, $_handleCollapseEvent$:function($event$$288_rowKey$$37$$) {
    $event$$288_rowKey$$37$$ = $event$$288_rowKey$$37$$.rowKey;
    $event$$288_rowKey$$37$$ === this.$rowKey$ && (this.$_removeIconStateClass$(), this.$iconState$ = "collapsed", this.$_setIconStateClass$(), this.$_ariaExpanded$(!1), this._trigger("collapse", null, {rowKey:$event$$288_rowKey$$37$$}));
    ...
    return null == $locator$$24$$ ? this.element ? this.element[0] : null : "oj-rowexpander-icon" === $locator$$24$$.subId && null != this.icon ? this.icon.get(0) : null;
