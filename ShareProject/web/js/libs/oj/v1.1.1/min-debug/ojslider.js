...
define(["ojs/ojcore", "jquery", "ojs/ojeditablevalue", "jqueryui-amd/draggable", "ojs/ojtouchproxy"], function($oj$$35$$, $$$$34$$) {
  (function() {
    $oj$$35$$.$__registerWidget$("oj.ojSlider", $$$$34$$.oj.editableValue, {defaultElement:"\x3cinput\x3e", version:"1.1.1", widgetEventPrefix:"oj", options:{distance:0, max:100, min:0, orientation:"horizontal", readOnly:!1, disabled:!1, step:1, type:"fromMin", value:0}, $_numPages$:5, $_isRTL$:function() {
      ...
      this._super();
      this.$_makeDraggable$();
      var $ariaLabelString_label$$12$$ = this.$_GetLabelElementLocal$();
      if ($ariaLabelString_label$$12$$) {
        var $thumb$$ = this.$_elementWrapped$.find(".oj-slider-thumb"), $labelId$$ = $ariaLabelString_label$$12$$.attr("id");
        $labelId$$ || ($labelId$$ = $ariaLabelString_label$$12$$.attr("for"));
        $thumb$$.attr("aria-labelledby", $labelId$$);
        1 < $ariaLabelString_label$$12$$.length && 1 < $thumb$$.length && $thumb$$[1].attr("aria-labelledby", String($labelId$$));
      } else {
        if ($ariaLabelString_label$$12$$ = this.element.attr("aria-label")) {
          $thumb$$ = this.$_elementWrapped$.find(".oj-slider-thumb"), $thumb$$.attr("aria-label", $ariaLabelString_label$$12$$);
        }
      }
      ...
      var $i$$383$$, $thumbCount$$, $thumb$$1$$ = "", $thumbClasses$$ = "class\x3d'oj-slider-thumb ui-state-default' tabindex\x3d'0' role\x3d'slider'" + ("aria-valuemin \x3d '" + this.$_valueMin$() + "' ") + ("aria-valuemax \x3d '" + this.$_valueMax$() + "' ") + "\x3e\x3c/span\x3e", $thumbs$$ = [];
      $thumbCount$$ = this.$_multipleThumbs$ ? this.options.value.length : 1;
      for ($i$$383$$ = 0;$i$$383$$ < $thumbCount$$;$i$$383$$++) {
        $thumb$$1$$ = "\x3cspan " + ("id\x3d'" + this.$_getThumbId$($i$$383$$) + "' ") + $thumbClasses$$, $thumbs$$.push($thumb$$1$$);
      }
      this.$_thumbs$ = $$$$34$$($thumbs$$.join("")).appendTo(this.$_sliderContainer$);
      this.$_thumb$ = this.$_thumbs$.eq(0);
      var $that$$13$$ = this;
      this.$_thumbs$.each(function($i$$384$$) {
        $$$$34$$(this).data("oj-slider-thumb-index", $i$$384$$);
      ...
      var $that$$14$$ = this;
      this.$_barback$.on("mousedown" + $that$$14$$.eventNamespace, function($event$$464$$) {
        $that$$14$$.$_initDragging$($event$$464$$, !1);
        $that$$14$$.$_mouseStop$($event$$464$$);
      ...
      if ($options$$357$$.type) {
        ...
        if (this.$_range$ && this.$_range$.length) {
          ...
          this.$_range$.on("mousedown" + $that$$15$$.eventNamespace, function($event$$465$$) {
            $that$$15$$.$_initDragging$($event$$465$$, !1);
            $that$$15$$.$_mouseStop$($event$$465$$);
    ...
    }, $_setupTouch$:function($e$$100$$) {
      this.$_touchProxy$ = $oj$$35$$.$_TouchProxy$.$addTouchListeners$($e$$100$$);
    }, $_tearDownTouch$:function($e$$101$$) {
      $oj$$35$$.$_TouchProxy$.$removeTouchListeners$($e$$101$$);
      ...
      return this._super();
    }, $_initDragging$:function($event$$466$$, $fromThumb$$) {
      ...
      !$fromThumb$$ || this.$_multipleThumbs$ ? ($position$$30$$ = {x:$event$$466$$.pageX, y:$event$$466$$.pageY}, $normValue$$ = this.$_getNormValueFromMouse$($position$$30$$)) : $normValue$$ = this.$_getNormValueFromThumb$();
      $distance$$ = this.$_valueMax$() - this.$_valueMin$() + 1;
      this.$_multipleThumbs$ && this.$_thumbs$.each(function($i$$387$$) {
        var $thisDistance$$ = Math.abs($normValue$$ - $that$$16$$.$_getMultiValues$($i$$387$$));
        if ($distance$$ > $thisDistance$$ || $distance$$ === $thisDistance$$ && ($i$$387$$ === $that$$16$$.$_lastChangedValueIndex$ || $that$$16$$.$_getMultiValues$($i$$387$$) === $o$$11$$.min)) {
          $distance$$ = $thisDistance$$, this.$_closestThumb$ = $$$$34$$(this), $index$$227$$ = $i$$387$$;
        }
      });
      this.$_dragInProgress$ = !0;
      this.$_thumbIndex$ = $index$$227$$;
      if (this.$_closestThumb$) {
        return this.$_thumbs$.hasClass("ui-state-hover") || this.$_slide$($event$$466$$, $index$$227$$, $normValue$$), this.$_getActiveThumb$().addClass("ui-state-active").focus(), !0;
      }
      ...
      return!1;
    }, $_mouseStop$:function($event$$468$$) {
      this.$_thumbs$.removeClass("ui-state-active");
      this.$_dragInProgress$ = !1;
      var $normValue$$1$$ = this.$_getNormValueFromThumb$();
      this.$_slide$($event$$468$$, this.$_thumbIndex$, $normValue$$1$$);
      this.$_change$($event$$468$$, this.$_thumbIndex$);
      this.$_thumbIndex$ = null;
      return!1;
    ...
    }, $_slide$:function($event$$469$$, $index$$228$$, $newVal$$1$$) {
      var $otherVal$$;
      this.$_multipleThumbs$ ? ($otherVal$$ = this.$_getMultiValues$($index$$228$$ ? 0 : 1), 2 === this.options.value.length && (0 === $index$$228$$ && $newVal$$1$$ > $otherVal$$ || 1 === $index$$228$$ && $newVal$$1$$ < $otherVal$$) && ($newVal$$1$$ = $otherVal$$), $newVal$$1$$ !== this.$_getMultiValues$($index$$228$$) && this.$_setMultiValue$($event$$469$$, $index$$228$$, $newVal$$1$$)) : $newVal$$1$$ !== this.$_getSingleValue$() && (this.$_setSingleValue$($event$$469$$, $newVal$$1$$), this.$_inputtag$ && 
      this.element.val($newVal$$1$$));
    }, $_change$:function($event$$470$$, $index$$229$$) {
      this.$_keySliding$ || this.$_dragInProgress$ || (this.$_multipleThumbs$ ? (this.$_lastChangedValues$ = this.$_getNewValues$($index$$229$$, this.$_newMultiValue$[$index$$229$$]), this.$_SetValue$(this.$_lastChangedValues$, $event$$470$$)) : this.$_SetValue$(this.$_newValue$, $event$$470$$), this.$_lastChangedValueIndex$ = $index$$229$$);
    ...
    }, $_setSingleValue$:function($event$$471$$, $newValue$$12$$) {
      this.$_newValue$ = this.$_trimAlignValue$($newValue$$12$$);
      this.$_change$($event$$471$$, 0);
      this.$_refreshValue$();
    ...
    }, $_setMultiValue$:function($event$$472$$, $index$$231$$, $newValue$$13$$) {
      this.$_newMultiValue$[$index$$231$$] = this.$_trimAlignValue$($newValue$$13$$);
      this.$_change$($event$$472$$, $index$$231$$);
      this.$_refreshValue$();
    }, _setOption:function($key$$144$$, $coercedValue_value$$248$$, $flags$$36$$) {
      ...
      "disabled" != $key$$144$$ && this._super($key$$144$$, $coercedValue_value$$248$$, $flags$$36$$);
      ...
      var $val$$49$$ = this.options.value;
      return $val$$49$$ = this.$_trimAlignValue$($val$$49$$);
    }, $_getValuesAligned$:function($index$$232$$) {
      return this.$_trimAlignValue$(this.options.value[$index$$232$$]);
    }, $_getNewValues$:function($index$$233$$, $newValue$$14$$) {
      var $vals$$, $i$$389$$;
      $vals$$ = this.options.value.slice();
      for ($i$$389$$ = 0;$i$$389$$ < $vals$$.length;$i$$389$$ += 1) {
        $vals$$[$i$$389$$] = this.$_trimAlignValue$($vals$$[$i$$389$$]);
      }
      $index$$233$$ === this.$_thumbIndex$ && ($vals$$[$index$$233$$] = $newValue$$14$$);
      return $vals$$;
    }, $_trimAlignValue$:function($alignValue_val$$51$$) {
      if ($alignValue_val$$51$$ <= this.$_valueMin$()) {
        return this.$_valueMin$();
      }
      if ($alignValue_val$$51$$ >= this.$_valueMax$()) {
        return this.$_valueMax$();
      }
      var $step$$ = 0 < this.options.step ? this.options.step : 1, $valModStep$$ = ($alignValue_val$$51$$ - this.$_valueMin$()) % $step$$;
      $alignValue_val$$51$$ -= $valModStep$$;
      2 * Math.abs($valModStep$$) >= $step$$ && ($alignValue_val$$51$$ += 0 < $valModStep$$ ? $step$$ : -$step$$);
      return parseFloat($alignValue_val$$51$$.toFixed(5));
      ...
      this.$_multipleThumbs$ ? this.$_thumbs$.toArray().forEach(function($current$$20$$, $i$$390$$) {
        var $thumb$$8$$ = $$$$34$$($current$$20$$);
        $valPercent$$ = 100 * this.$_getThumbsValueFrac$($i$$390$$);
        ...
        $$$$34$$($thumb$$8$$).attr("aria-valuenow", this.$_getMultiValues$($i$$390$$));
        this.$_setRangeMultiThumb$($valPercent$$, $i$$390$$);
    ...
    }, $_setRange$:function($val$$52$$) {
      var $oRange$$ = this.options.type;
      this.$_isVertical$() ? ("fromMin" === $oRange$$ && this.$_range$.css({height:$val$$52$$ + "%"}), "fromMax" === $oRange$$ && this.$_range$.css({height:100 - $val$$52$$ + "%"})) : this.$_isRTL$() ? ("fromMin" === $oRange$$ && this.$_range$.css({width:100 - $val$$52$$ + "%"}), "fromMax" === $oRange$$ && this.$_range$.css({width:$val$$52$$ + "%"})) : ("fromMin" === $oRange$$ && this.$_range$.css({width:$val$$52$$ + "%"}), "fromMax" === $oRange$$ && this.$_range$.css({width:100 - $val$$52$$ + "%"}));
    }, $_setRangeMultiThumb$:function($val$$53$$, $index$$235$$) {
      var $id$$42_thumb1Pct$$ = this.$_range$.attr("id");
      if (0 == $index$$235$$) {
        switch($id$$42_thumb1Pct$$ = 100 * this.$_getThumbsValueFrac$(1), this.options.type) {
          case "fromMin":
            this.$_isVertical$() ? this.$_range$.css({height:$val$$53$$ + "%"}) : this.$_range$.css({width:$val$$53$$ + "%"});
            break;
          case "range":
            this.$_isVertical$() ? (this.$_range$.css({top:100 - $id$$42_thumb1Pct$$ + "%"}), this.$_range$.css({height:$id$$42_thumb1Pct$$ - $val$$53$$ + "%"})) : this.$_isRTL$() ? (this.$_range$.css({left:100 - $id$$42_thumb1Pct$$ + "%"}), this.$_range$.css({width:$id$$42_thumb1Pct$$ - (100 - $val$$53$$) + "%"})) : (this.$_range$.css({left:$val$$53$$ + "%"}), this.$_range$.css({width:$id$$42_thumb1Pct$$ - $val$$53$$ + "%"}));
        }
      } else {
        var $thumb0Pct$$ = 100 * this.$_getThumbsValueFrac$(0);
        switch(this.options.type) {
          case "fromMax":
            this.$_isVertical$() ? this.$_range$.css({height:100 - $val$$53$$ + "%"}) : this.$_range$.css({width:100 - $val$$53$$ + "%"});
            break;
          case "range":
            this.$_isVertical$() ? document.getElementById($id$$42_thumb1Pct$$) && (this.$_range$.css({top:100 - $val$$53$$ + "%"}), this.$_range$.css({height:$val$$53$$ - $thumb0Pct$$ + "%"})) : this.$_isRTL$() ? document.getElementById($id$$42_thumb1Pct$$) && (this.$_range$.css({left:$val$$53$$ + "%"}), this.$_range$.css({width:-$val$$53$$ + 100 - $thumb0Pct$$ + "%"})) : document.getElementById($id$$42_thumb1Pct$$) && this.$_range$.css({width:$val$$53$$ - parseInt(document.getElementById($id$$42_thumb1Pct$$).style.left, 
            10) + "%"});
        }
      }
    }, $_thumbEvents$:{keydown:function($event$$473$$) {
      var $curVal_tempVal$$, $newVal$$2$$, $step$$1$$, $index$$236$$ = $$$$34$$($event$$473$$.target).data("oj-slider-thumb-index");
      this.$_thumbIndex$ = $index$$236$$;
      switch($event$$473$$.keyCode) {
        ...
        case $$$$34$$.ui.keyCode.LEFT:
          $event$$473$$.preventDefault(), this.$_keySliding$ || (this.$_keySliding$ = !0, $$$$34$$($event$$473$$.target).addClass("ui-state-active"));
      }
      ...
      this.$_slide$($event$$473$$, $index$$236$$, $newVal$$2$$);
    }, keyup:function($event$$474$$) {
      var $index$$237$$ = $$$$34$$($event$$474$$.target).data("oj-slider-thumb-index");
      this.$_thumbIndex$ = $index$$237$$;
      this.$_keySliding$ && (this.$_keySliding$ = !1, this.$_change$($event$$474$$, $index$$237$$), $$$$34$$($event$$474$$.target).removeClass("ui-state-active"));
      this.$_thumbIndex$ = null;
      this.$_refreshContainment$();
    }}, $_InitOptions$:function($originalDefaults$$11$$, $constructorOptions$$13$$) {
      var $opts$$35$$ = this.options, $self$$159$$ = this;
      ...
      {$attribute$:"max", $defaultOptionValue$:null}, {$attribute$:"step", $defaultOptionValue$:1}], $constructorOptions$$13$$, this, function($initializedOptions$$1$$) {
        for (var $toParse$$ = ["value", "step", "min", "max"], $i$$391$$ = 0;$i$$391$$ < $toParse$$.length;$i$$391$$++) {
          var $opt$$20$$ = $toParse$$[$i$$391$$], $value$$250$$ = $opt$$20$$ in $initializedOptions$$1$$ ? $initializedOptions$$1$$[$opt$$20$$] : $opts$$35$$[$opt$$20$$];
          null != $value$$250$$ && ("step" === $opt$$20$$ ? $initializedOptions$$1$$[$opt$$20$$] = $self$$159$$.$_parseStep$($value$$250$$) : "min" === $opt$$20$$ || "max" === $opt$$20$$ ? $initializedOptions$$1$$[$opt$$20$$] = $self$$159$$.$_parse$($opt$$20$$, $value$$250$$) : "value" === $opt$$20$$ && (Array.isArray($value$$250$$) ? $initializedOptions$$1$$[$opt$$20$$] = $value$$250$$ : $initializedOptions$$1$$[$opt$$20$$] = $self$$159$$.$_parse$($opt$$20$$, $value$$250$$)));
        }
      });
    ...
    }, getNodeBySubId:function($barId$$1_barValueId_locator$$33_subId$$32_thumbId$$4$$) {
      if (null == $barId$$1_barValueId_locator$$33_subId$$32_thumbId$$4$$) {
        return this.element ? this.element[0] : null;
      }
      $barId$$1_barValueId_locator$$33_subId$$32_thumbId$$4$$ = $barId$$1_barValueId_locator$$33_subId$$32_thumbId$$4$$.subId;
      return "oj-slider-thumb-0" === $barId$$1_barValueId_locator$$33_subId$$32_thumbId$$4$$ ? ($barId$$1_barValueId_locator$$33_subId$$32_thumbId$$4$$ = "#" + this.$_getThumbId$(0), this.widget().find($barId$$1_barValueId_locator$$33_subId$$32_thumbId$$4$$)[0]) : "oj-slider-thumb-1" === $barId$$1_barValueId_locator$$33_subId$$32_thumbId$$4$$ ? ($barId$$1_barValueId_locator$$33_subId$$32_thumbId$$4$$ = "#" + this.$_getThumbId$(1), this.widget().find($barId$$1_barValueId_locator$$33_subId$$32_thumbId$$4$$)[0]) : 
      "oj-slider-bar" === $barId$$1_barValueId_locator$$33_subId$$32_thumbId$$4$$ ? ($barId$$1_barValueId_locator$$33_subId$$32_thumbId$$4$$ = "#" + this.$_getBarBackgroundId$(), this.widget().find($barId$$1_barValueId_locator$$33_subId$$32_thumbId$$4$$)[0]) : "oj-slider-bar-value" === $barId$$1_barValueId_locator$$33_subId$$32_thumbId$$4$$ ? ($barId$$1_barValueId_locator$$33_subId$$32_thumbId$$4$$ = "#" + this.$_getBarValueId$(), this.widget().find($barId$$1_barValueId_locator$$33_subId$$32_thumbId$$4$$)[0]) : 
      null;
    }, getSubIdByNode:function($node$$60$$) {
      if (null != $node$$60$$) {
        if ($node$$60$$.id === this.$_getThumbId$(0) && $$$$34$$($node$$60$$).hasClass("oj-slider-thumb")) {
          return{subId:"oj-slider-thumb-0"};
        }
        if ($node$$60$$.id === this.$_getThumbId$(1) && $$$$34$$($node$$60$$).hasClass("oj-slider-thumb")) {
          return{subId:"oj-slider-thumb-1"};
        }
        if ($node$$60$$.id === this.$_getBarBackgroundId$() && $$$$34$$($node$$60$$).hasClass("oj-slider-bar")) {
          return{subId:"oj-slider-bar"};
        }
        if ($node$$60$$.id === this.$_getBarValueId$() && $$$$34$$($node$$60$$).hasClass("oj-slider-bar-value")) {
      ...
      return "oj-slider";
    }, $_parse$:function($option$$29$$, $val$$54$$) {
      var $returnValue$$2$$;
      $returnValue$$2$$ = null !== $val$$54$$ ? +$val$$54$$ : $val$$54$$;
      if (isNaN($returnValue$$2$$)) {
        throw Error(this.$getTranslatedString$("optionNum", {option:$option$$29$$}));
      }
      return $returnValue$$2$$;
    }, $_parseStep$:function($parsedStep_val$$55$$) {
      if (null === $parsedStep_val$$55$$) {
        return 1;
      }
      $parsedStep_val$$55$$ = this.$_parse$("step", $parsedStep_val$$55$$);
      if (0 >= $parsedStep_val$$55$$) {
        throw Error(this.$getTranslatedString$("invalidStep"));
      }
      if (null === $parsedStep_val$$55$$ || 0 >= $parsedStep_val$$55$$) {
        $parsedStep_val$$55$$ = 1;
      }
      return $parsedStep_val$$55$$;
      ...
      $thumbParam$$.draggable({axis:this.$_isVertical$() ? "y" : "x", containment:$containmentArray$$, grid:$g$$1$$, disabled:!1, start:function($event$$475$$) {
        $that$$17$$.$_initDragging$($event$$475$$, !0);
      }, drag:function($event$$476$$) {
        $that$$17$$.$_mouseDrag$($event$$476$$);
      }, stop:function($event$$477$$) {
        $that$$17$$.$_mouseStop$($event$$477$$);
        $that$$17$$.$_refreshContainment$();
      }});
    }, $_refreshContainment$:function() {
      var $containmentArray$$1$$;
      this.$_multipleThumbs$ && this.$_thumbs$.toArray().forEach(function($current$$21$$, $i$$392$$) {
        var $thumb$$9$$ = $$$$34$$($current$$21$$);
        $containmentArray$$1$$ = this.$_getContainmentArrayRange$($i$$392$$);
        $thumb$$9$$.draggable("option", "containment", $containmentArray$$1$$);
      }, this);
    }, $_makeDraggable$:function() {
      if (!this.options.disabled) {
        var $containmentArray$$2$$;
        this.$_multipleThumbs$ ? this.$_thumbs$.toArray().forEach(function($current$$22$$, $i$$393$$) {
          var $thumb$$10$$ = $$$$34$$($current$$22$$);
          $containmentArray$$2$$ = this.$_getContainmentArrayRange$($i$$393$$);
