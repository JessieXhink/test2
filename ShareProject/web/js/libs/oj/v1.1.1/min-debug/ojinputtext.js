...
define(["ojs/ojcore", "jquery", "ojs/ojeditablevalue"], function($oj$$5$$, $$$$5$$) {
  ...
  $defaultOptionValue$:!1, $validateOption$:!0}, {$attribute$:"required", $defaultOptionValue$:!1, $coerceDomValue$:!0, $validateOption$:!0}, {$attribute$:"title", $defaultOptionValue$:""}], _INPUT_HELPER_KEY:"", $_BLUR_HANDLER_KEY$:"blur", $_KEYDOWN_HANDLER_KEY$:"keydown", $_DROP_HANDLER_KEY$:"drop", options:{converter:void 0, placeholder:void 0, readOnly:void 0}, $_SaveAttributes$:function($element$$38$$) {
    ...
    if (!this.options.readOnly && !this.options.disabled) {
      this.$_eventHandlers$ = {};
      var $blurHandler_eventEntries$$ = $$$$5$$.proxy(this.$_onBlurHandler$, this), $i$$109_keyDownHandler$$ = $$$$5$$.proxy(this.$_onKeyDownHandler$, this), $dropHandler_j$$10$$ = function $$dropHandler_j$$10$$$() {
        this.focus();
      };
      this.element.on("blur", $blurHandler_eventEntries$$);
      this.element.on("keydown", $i$$109_keyDownHandler$$);
      this.element.on("drop", $dropHandler_j$$10$$);
      ...
      this.$_eventHandlers$[this.$_DROP_HANDLER_KEY$] = $dropHandler_j$$10$$;
    } else {
      if (this.$_eventHandlers$) {
        for ($blurHandler_eventEntries$$ = [this.$_BLUR_HANDLER_KEY$, this.$_KEYDOWN_HANDLER_KEY$, this.$_DROP_HANDLER_KEY$], $i$$109_keyDownHandler$$ = 0, $dropHandler_j$$10$$ = $blurHandler_eventEntries$$.length;$i$$109_keyDownHandler$$ < $dropHandler_j$$10$$;$i$$109_keyDownHandler$$++) {
  ...
  }, $_onBlurHandler$:function __onBlurHandler($event$$52$$) {
    this.$_SetValue$(this.$_GetDisplayValue$(), $event$$52$$);
  }, $_onKeyDownHandler$:function __onKeyDownHandler($event$$53$$) {
    $event$$53$$.keyCode === $$$$5$$.ui.keyCode.ENTER && this.$_SetValue$(this.$_GetDisplayValue$(), $event$$53$$);
  ...
  $oj$$5$$.$__registerWidget$("oj.ojInputText", $$$$5$$.oj.inputBase, {version:"1.0.0", defaultElement:"\x3cinput\x3e", widgetEventPrefix:"oj", _ATTR_CHECK:[{attr:"type", setMandatory:"text"}], _CLASS_NAMES:"oj-inputtext-input", _WIDGET_CLASS_NAMES:"oj-inputtext oj-form-control oj-component", options:{pattern:void 0}, getNodeBySubId:function($locator$$7$$) {
    ...
    $node$$20$$ || ($subId$$1$$ = $locator$$7$$.subId, "oj-inputtext-input" === $subId$$1$$ && ($node$$20$$ = this.element ? this.element[0] : null));
    return $node$$20$$ || null;
  ...
  $oj$$5$$.$__registerWidget$("oj.ojTextArea", $$$$5$$.oj.inputBase, {version:"1.0.0", defaultElement:"\x3ctextarea\x3e", widgetEventPrefix:"oj", _ATTR_CHECK:[], _CLASS_NAMES:"oj-textarea-input", _WIDGET_CLASS_NAMES:"oj-textarea oj-form-control oj-component", options:{pattern:void 0}, getNodeBySubId:function($locator$$8$$) {
    var $node$$21$$ = this._superApply(arguments), $subId$$2$$;
    $node$$21$$ || ($subId$$2$$ = $locator$$8$$.subId, "oj-textarea-input" === $subId$$2$$ && ($node$$21$$ = this.element ? this.element[0] : null));
    return $node$$21$$ || null;
  }, _GetDefaultStyleClass:function() {
    return "oj-textarea";
  }, $_GetTranslationsSectionName$:function() {
