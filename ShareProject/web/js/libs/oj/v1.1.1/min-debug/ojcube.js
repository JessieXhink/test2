...
define(["ojs/ojcore", "jquery", "promise", "ojs/ojdatacollection-common"], function($oj$$18$$, $$$$17$$) {
  ...
  $oj$$18$$.$Cube$.prototype.$getAxes$ = function $$oj$$18$$$$Cube$$$$getAxes$$() {
    var $cube_i$$280$$ = this.$_getPinnedCube$(), $axes$$ = [];
    Array.prototype.push.apply($axes$$, $cube_i$$280$$ ? $cube_i$$280$$.$getAxes$() : this.$_axes$);
    for ($cube_i$$280$$ = 2;$cube_i$$280$$ < this.$_axes$.length;$cube_i$$280$$++) {
      $axes$$.push(this.$_axes$[$cube_i$$280$$]);
    }
    return $axes$$;
  };
  ...
  $oj$$18$$.$Cube$.prototype.$_findAxisInLayout$ = function $$oj$$18$$$$Cube$$$$_findAxisInLayout$$($axis$$22$$) {
    for (var $i$$281$$ = 0;$i$$281$$ < this.$_layout$.length;$i$$281$$++) {
      if (this.$_layout$[$i$$281$$].axis === $axis$$22$$) {
        return this.$_layout$[$i$$281$$];
      }
    }
    return null;
  };
  ...
  $oj$$18$$.$Cube$.prototype.$GenerateAxes$ = function $$oj$$18$$$$Cube$$$$GenerateAxes$$() {
    ...
    this.$_pin$ = [];
    for (var $i$$282$$ = 0;$i$$282$$ < $nonPageLayout_pageLayout$$.length;$i$$282$$++) {
      this.$_getAxis$($nonPageLayout_pageLayout$$[$i$$282$$].axis, $nonPageLayout_pageLayout$$[$i$$282$$].levels), this.$_pin$.push({axis:$nonPageLayout_pageLayout$$[$i$$282$$].axis, index:0});
    }
    if (0 === $nonPageLayout_pageLayout$$.length) {
      for ($nonPageLayout_pageLayout$$ = this.$_getNonPageLayout$(), $i$$282$$ = 0;$i$$282$$ < $nonPageLayout_pageLayout$$.length;$i$$282$$++) {
        this.$_getAxis$($nonPageLayout_pageLayout$$[$i$$282$$].axis, $nonPageLayout_pageLayout$$[$i$$282$$].levels);
      }
    }
  };
  $oj$$18$$.$Cube$.prototype.$_getPageLayout$ = function $$oj$$18$$$$Cube$$$$_getPageLayout$$() {
    for (var $pageOnlyLayout$$ = [], $i$$283$$ = 0;$i$$283$$ < this.$_layout$.length;$i$$283$$++) {
      1 < this.$_layout$[$i$$283$$].axis && $pageOnlyLayout$$.push(this.$_layout$[$i$$283$$]);
    }
    return $pageOnlyLayout$$;
  };
  $oj$$18$$.$Cube$.prototype.$_getNonPageLayout$ = function $$oj$$18$$$$Cube$$$$_getNonPageLayout$$() {
    for (var $nonPageLayout$$1$$ = [], $i$$284$$ = 0;$i$$284$$ < this.$_layout$.length;$i$$284$$++) {
      2 > this.$_layout$[$i$$284$$].axis && $nonPageLayout$$1$$.push(this.$_layout$[$i$$284$$]);
    }
  ...
  $oj$$18$$.$Cube$.prototype.$_storeData$ = function $$oj$$18$$$$Cube$$$$_storeData$$($hash$$4$$, $dataHash$$1$$, $row$$38$$) {
    for (var $i$$285$$ = 0;$i$$285$$ < $hash$$4$$.length;$i$$285$$++) {
      this.$_data$[$hash$$4$$[$i$$285$$].key] = this.$_aggregate$($dataHash$$1$$[$i$$285$$], this.$_data$[$hash$$4$$[$i$$285$$].key], $row$$38$$);
    }
  };
  ...
  $oj$$18$$.$Cube$.prototype.$_getHashFromPin$ = function $$oj$$18$$$$Cube$$$$_getHashFromPin$$($pin$$1$$) {
    ...
    if ($pin$$1$$ && 0 < $pin$$1$$.length) {
      ...
      for (var $axes$$1$$ = this.$_axes$, $i$$286$$ = 0;$i$$286$$ < $pin$$1$$.length;$i$$286$$++) {
        $keys$$17$$ = $axes$$1$$[$pin$$1$$[$i$$286$$].axis].$GetCubeKeys$($pin$$1$$[$i$$286$$].index, $keys$$17$$);
      }
    }
  ...
  $oj$$18$$.$Cube$.prototype.$_aggregate$ = function $$oj$$18$$$$Cube$$$$_aggregate$$($hash$$5_val$$41$$, $currValue$$2$$, $row$$40$$) {
    ...
    switch($aggType$$1$$) {
      case $oj$$18$$.$CubeAggType$.SUM:
        return $avg_validCurr$$ && $validHash$$ ? $isNumCurr$$ && $isNumHash$$ ? this.$_createAggValue$($currValue$$2$$.value + $hash$$5_val$$41$$.value, $aggType$$1$$, $currValue$$2$$.rows, $row$$40$$, {}) : this.$_createAggValue$(NaN, $aggType$$1$$, $currValue$$2$$.rows, $row$$40$$, {}) : $validHash$$ && !$avg_validCurr$$ ? $isNumHash$$ ? this.$_createAggValue$($hash$$5_val$$41$$.value, $aggType$$1$$, [], $row$$40$$, {}) : this.$_createAggValue$(NaN, $aggType$$1$$, [], $row$$40$$, {}) : $currValue$$2$$;
      case $oj$$18$$.$CubeAggType$.AVERAGE:
        return $avg_validCurr$$ && $validHash$$ ? $isNumCurr$$ && $isNumHash$$ ? this.$_createAggValue$(($currValue$$2$$.$sum$ + $hash$$5_val$$41$$.value) / ($currValue$$2$$.rows.length + 1), $aggType$$1$$, $currValue$$2$$.rows, $row$$40$$, {$sum$:$currValue$$2$$.$sum$ + $hash$$5_val$$41$$.value}) : this.$_createAggValue$(NaN, $aggType$$1$$, $currValue$$2$$.rows, $row$$40$$, {$sum$:$currValue$$2$$.$sum$}) : $validHash$$ && !$avg_validCurr$$ ? $isNumHash$$ ? this.$_createAggValue$($hash$$5_val$$41$$.value, 
        $aggType$$1$$, [], $row$$40$$, {$sum$:$hash$$5_val$$41$$.value}) : this.$_createAggValue$(NaN, $aggType$$1$$, [], $row$$40$$, {$sum$:NaN}) : $currValue$$2$$;
      case $oj$$18$$.$CubeAggType$.VARIANCE:
      ;
      case $oj$$18$$.$CubeAggType$.STDDEV:
        return $avg_validCurr$$ && $validHash$$ ? $isNumCurr$$ && $isNumHash$$ ? ($avg_validCurr$$ = $currValue$$2$$.value + ($hash$$5_val$$41$$.value - $currValue$$2$$.value) / ($currValue$$2$$.rows.length + 1), this.$_createAggValue$($avg_validCurr$$, $aggType$$1$$, $currValue$$2$$.rows, $row$$40$$, {$square$:$currValue$$2$$.$square$ + ($hash$$5_val$$41$$.value - $currValue$$2$$.value) * ($hash$$5_val$$41$$.value - $avg_validCurr$$)})) : this.$_createAggValue$(NaN, $aggType$$1$$, $currValue$$2$$.rows, 
        $row$$40$$, {$square$:NaN}) : $validHash$$ && !$avg_validCurr$$ ? $isNumHash$$ ? this.$_createAggValue$($hash$$5_val$$41$$.value, $aggType$$1$$, [], $row$$40$$, {$square$:0}) : this.$_createAggValue$(NaN, $aggType$$1$$, [], $row$$40$$, {$square$:NaN}) : $currValue$$2$$;
      ...
      case $oj$$18$$.$CubeAggType$.FIRST:
        return $avg_validCurr$$ ? this.$_createAggValue$($currValue$$2$$.value, $aggType$$1$$, $currValue$$2$$.rows, $row$$40$$, {}) : $validHash$$ ? this.$_createAggValue$($hash$$5_val$$41$$.value, $aggType$$1$$, [], $row$$40$$, {}) : $currValue$$2$$;
      case $oj$$18$$.$CubeAggType$.MIN:
        return $avg_validCurr$$ && $validHash$$ ? $isNumCurr$$ && $isNumHash$$ ? this.$_createAggValue$(Math.min($currValue$$2$$.value, $hash$$5_val$$41$$.value), $aggType$$1$$, $currValue$$2$$.rows, $row$$40$$, {}) : this.$_createAggValue$(NaN, $aggType$$1$$, $currValue$$2$$.rows, $row$$40$$, {}) : $validHash$$ && !$avg_validCurr$$ ? $isNumHash$$ ? this.$_createAggValue$($hash$$5_val$$41$$.value, $aggType$$1$$, [], $row$$40$$, {}) : this.$_createAggValue$(NaN, $aggType$$1$$, [], $row$$40$$, {}) : 
        $currValue$$2$$;
      case $oj$$18$$.$CubeAggType$.MAX:
        return $avg_validCurr$$ && $validHash$$ ? $isNumCurr$$ && $isNumHash$$ ? this.$_createAggValue$(Math.max($currValue$$2$$.value, $hash$$5_val$$41$$.value), $aggType$$1$$, $currValue$$2$$.rows, $row$$40$$, {}) : this.$_createAggValue$(NaN, $aggType$$1$$, $currValue$$2$$.rows, $row$$40$$, {}) : $validHash$$ && !$avg_validCurr$$ ? $isNumHash$$ ? this.$_createAggValue$($hash$$5_val$$41$$.value, $aggType$$1$$, [], $row$$40$$, {}) : this.$_createAggValue$(NaN, $aggType$$1$$, [], $row$$40$$, {}) : 
        $currValue$$2$$;
      ...
      case $oj$$18$$.$CubeAggType$.CUSTOM:
        return $hash$$5_val$$41$$ = $aggObj$$.$callback$.call(this, $avg_validCurr$$ ? $currValue$$2$$.value : void 0, $validHash$$ ? $hash$$5_val$$41$$.value : void 0), this.$_createAggValue$($hash$$5_val$$41$$, $aggType$$1$$, $avg_validCurr$$ ? $currValue$$2$$.rows : [], $row$$40$$, {});
    }
  };
  ...
  $oj$$18$$.$CubeAxisValue$ = function $$oj$$18$$$$CubeAxisValue$$($value$$214$$, $label$$5$$, $level$$28$$, $parent$$19$$) {
    this.Init();
    this.$_children$ = [];
  ...
  $oj$$18$$.$CubeAxisValue$.prototype.$GetChild$ = function $$oj$$18$$$$CubeAxisValue$$$$GetChild$$($key$$90_val$$42$$) {
    var $c$$38_childLevel$$ = this.$_getChildLevel$();
    if (null === $c$$38_childLevel$$) {
      return null;
    }
    if ($c$$38_childLevel$$.$isDataValue$()) {
      return this.$_getDataValueChild$($key$$90_val$$42$$);
    }
    if ($key$$90_val$$42$$ = $key$$90_val$$42$$[$c$$38_childLevel$$.attribute]) {
      for ($c$$38_childLevel$$ = 0;$c$$38_childLevel$$ < this.$_children$.length;$c$$38_childLevel$$++) {
        if (this.$_children$[$c$$38_childLevel$$].$getValue$() === $key$$90_val$$42$$) {
  ...
  $oj$$18$$.$CubeAxisValue$.prototype.$_getDataValueChild$ = function $$oj$$18$$$$CubeAxisValue$$$$_getDataValueChild$$($key$$91$$) {
    for (var $c$$39$$ = 0;$c$$39$$ < this.$_children$.length;$c$$39$$++) {
      var $val$$43$$ = this.$_children$[$c$$39$$].$getValue$();
      if ($key$$91$$.hasOwnProperty($val$$43$$) && $key$$91$$[$val$$43$$] === $val$$43$$) {
  ...
  $oj$$18$$.$CubeAxisValue$.prototype.$AddNode$ = function $$oj$$18$$$$CubeAxisValue$$$$AddNode$$($newValue$$11_value$$216$$, $label$$6$$, $level$$29$$) {
    for (var $c$$40$$ = 0;$c$$40$$ < this.$_children$.length;$c$$40$$++) {
      if (this.$_children$[$c$$40$$].$getValue$() === $newValue$$11_value$$216$$) {
        return this.$_children$[$c$$40$$];
      }
    }
    $newValue$$11_value$$216$$ = new $oj$$18$$.$CubeAxisValue$($newValue$$11_value$$216$$, $label$$6$$, $level$$29$$, this);
    this.$_children$.push($newValue$$11_value$$216$$);
    return $newValue$$11_value$$216$$;
  };
  ...
  $oj$$18$$.$CubeAxis$ = function $$oj$$18$$$$CubeAxis$$($levels$$2$$, $axis$$29_i$$287$$, $cube$$3$$) {
    this.Init();
    this.axis = $axis$$29_i$$287$$;
    this.$_levels$ = [];
    for ($axis$$29_i$$287$$ = 0;$axis$$29_i$$287$$ < $levels$$2$$.length;$axis$$29_i$$287$$++) {
      this.$_levels$.push($cube$$3$$.$GenerateLevel$($levels$$2$$[$axis$$29_i$$287$$], this));
    }
    this.$_cube$ = $cube$$3$$;
  ...
  $oj$$18$$.$CubeAxis$.prototype.$GetPartialCubeKeys$ = function $$oj$$18$$$$CubeAxis$$$$GetPartialCubeKeys$$($index$$149_values$$10$$, $level$$30_stopLevel$$, $keys$$21$$) {
    ...
    for (var $v$$1$$ = 0;$v$$1$$ < $index$$149_values$$10$$.length;$v$$1$$++) {
      var $val$$44$$ = $index$$149_values$$10$$[$v$$1$$];
      $val$$44$$.$getLevel$().$isDataValue$() ? $keys$$21$$.$AddDataValue$($val$$44$$.$getValue$()) : $keys$$21$$.$UpdateKeys$($val$$44$$);
      if ($val$$44$$.$getLevel$() === $level$$30_stopLevel$$) {
        break;
      }
    }
    return $keys$$21$$;
  ...
  $oj$$18$$.$CubeLevel$ = function $$oj$$18$$$$CubeLevel$$($attribute$$4$$, $axis$$30$$, $dataValue$$1$$) {
    this.Init();
    this.attribute = $attribute$$4$$;
    this.$_axisObj$ = $axis$$30$$;
    this.axis = $axis$$30$$.axis;
  ...
  $oj$$18$$.$CubeLevel$.prototype.$getValue$ = function $$oj$$18$$$$CubeLevel$$$$getValue$$($index$$150_values$$11$$) {
    if ($index$$150_values$$11$$ = this.$_axisObj$.$getValues$($index$$150_values$$11$$)) {
      for (var $v$$2$$ = 0;$v$$2$$ < $index$$150_values$$11$$.length;$v$$2$$++) {
        if ($index$$150_values$$11$$[$v$$2$$].$getLevel$() === this) {
          return $index$$150_values$$11$$[$v$$2$$];
        }
      }
    }
    return null;
  ...
  $oj$$18$$.$CubeKeys$.prototype.$AddDataValue$ = function $$oj$$18$$$$CubeKeys$$$$AddDataValue$$($name$$104$$, $value$$217$$) {
    this.$_data$.push({name:$name$$104$$, value:$value$$217$$});
  };
  ...
  $oj$$18$$.$CubeCellSet$.prototype.$_getAxisMetadata$ = function $$oj$$18$$$$CubeCellSet$$$$_getAxisMetadata$$($indexes$$18$$, $axis$$31$$, $keys$$23_len$$18$$) {
    var $axes$$3$$ = this.$_cube$.$getAxes$();
    return void 0 !== $indexes$$18$$[$axis$$31$$] && $axes$$3$$.length >= $keys$$23_len$$18$$ ? ($keys$$23_len$$18$$ = new $oj$$18$$.$CubeKeys$, $keys$$23_len$$18$$ = $axes$$3$$[$oj$$18$$.$CubeDataGridDataSource$.$_convertAxes$($axis$$31$$)].$GetCubeKeys$($indexes$$18$$[$axis$$31$$], $keys$$23_len$$18$$), $keys$$23_len$$18$$.$GetHashCodes$()[0].key) : null;
  };
  $oj$$18$$.$CubeCellSet$.prototype.$getStart$ = function $$oj$$18$$$$CubeCellSet$$$$getStart$$($axis$$32$$) {
    return this.$_starts$[$axis$$32$$];
  };
  $oj$$18$$.$Object$.$exportPrototypeSymbol$("CubeCellSet.prototype.getStart", {$getStart$:$oj$$18$$.$CubeCellSet$.prototype.$getStart$});
  $oj$$18$$.$CubeCellSet$.prototype.$getCount$ = function $$oj$$18$$$$CubeCellSet$$$$getCount$$($axis$$33$$) {
    return this.$_counts$[$axis$$33$$];
  };
  ...
  $oj$$18$$.$DataColumnCube$.prototype.$GenerateLevel$ = function $$oj$$18$$$$DataColumnCube$$$$GenerateLevel$$($level$$31$$, $axis$$34$$) {
    return $level$$31$$.attribute === this.$_labelAttr$ ? new $oj$$18$$.$CubeLevel$($level$$31$$.attribute, $axis$$34$$, !0) : new $oj$$18$$.$CubeLevel$($level$$31$$.attribute, $axis$$34$$, !1);
  };
  $oj$$18$$.$DataColumnCube$.prototype.$ProcessLevel$ = function $$oj$$18$$$$DataColumnCube$$$$ProcessLevel$$($axis$$35$$, $levelNum$$1$$, $currNode$$2_node$$45$$, $row$$44$$, $keys$$24$$, $addKeys$$1$$) {
    if ($levelNum$$1$$ >= $axis$$35$$.$getLevels$().length) {
      return $keys$$24$$;
    }
    var $level$$32$$ = $axis$$35$$.$getLevels$()[$levelNum$$1$$], $value$$218$$ = $row$$44$$[$level$$32$$.attribute];
    $currNode$$2_node$$45$$ = $currNode$$2_node$$45$$.$AddNode$($value$$218$$, null, $level$$32$$);
    $level$$32$$.$isDataValue$() ? $keys$$24$$.$AddDataValue$($value$$218$$, $row$$44$$[this.$_valueAttr$]) : $keys$$24$$.$UpdateKeys$($currNode$$2_node$$45$$);
    return this.$ProcessLevel$($axis$$35$$, $levelNum$$1$$ + 1, $currNode$$2_node$$45$$, $row$$44$$, $keys$$24$$, $addKeys$$1$$);
  };
  ...
  $oj$$18$$.$DataColumnCube$.prototype.$_buildAggTypeLookup$ = function $$oj$$18$$$$DataColumnCube$$$$_buildAggTypeLookup$$() {
    ...
    if (this.$_aggregation$) {
      for (var $i$$288$$ = 0;$i$$288$$ < this.$_aggregation$.length;$i$$288$$++) {
        var $dv$$ = this.$_aggregation$[$i$$288$$], $agg$$1$$ = $dv$$.aggregation;
        this.$_dataValueAggType$[$dv$$.value] = $agg$$1$$ ? {$aggregation$:$agg$$1$$, $callback$:$dv$$.callback} : this.$_defaultAggregation$;
      }
    }
  };
  $oj$$18$$.$CubeDataValue$ = function $$oj$$18$$$$CubeDataValue$$($value$$219$$, $indices$$6$$, $aggType$$2$$, $rows$$9$$, $square$$) {
    this.Init();
    this.$_data$ = {};
    this.$_data$.value = $value$$219$$;
  ...
  $oj$$18$$.$CubeDataValue$.prototype.$_getVariance$ = function $$oj$$18$$$$CubeDataValue$$$$_getVariance$$() {
    ...
    var $count$$32$$ = this.$_data$.rows.length;
    return 1 < $count$$32$$ ? this.$_data$.$square$ / ($count$$32$$ - 1) : 0;
  };
  ...
  $oj$$18$$.$DataValueAttributeCube$.prototype.$GenerateLevel$ = function $$oj$$18$$$$DataValueAttributeCube$$$$GenerateLevel$$($level$$33$$, $axis$$36$$) {
    return $level$$33$$.dataValue ? new $oj$$18$$.$CubeLevel$(null, $axis$$36$$, !0) : new $oj$$18$$.$CubeLevel$($level$$33$$.attribute, $axis$$36$$, !1);
  };
  ...
  $oj$$18$$.$DataValueAttributeCube$.prototype.$ProcessLevel$ = function $$oj$$18$$$$DataValueAttributeCube$$$$ProcessLevel$$($axis$$37$$, $levelNum$$2$$, $currNode$$3_node$$46$$, $row$$45$$, $keys$$25$$, $addKeys$$2$$) {
    if ($levelNum$$2$$ >= $axis$$37$$.$getLevels$().length) {
      return $keys$$25$$;
    }
    var $level$$34$$ = $axis$$37$$.$getLevels$()[$levelNum$$2$$];
    if ($level$$34$$.$isDataValue$()) {
      return this.$_processDataValue$($axis$$37$$, $currNode$$3_node$$46$$, $row$$45$$, $levelNum$$2$$, $keys$$25$$);
    }
    $currNode$$3_node$$46$$ = $currNode$$3_node$$46$$.$AddNode$($row$$45$$[$level$$34$$.attribute], null, $level$$34$$);
    $addKeys$$2$$ && $keys$$25$$.$UpdateKeys$($currNode$$3_node$$46$$);
    return this.$ProcessLevel$($axis$$37$$, $levelNum$$2$$ + 1, $currNode$$3_node$$46$$, $row$$45$$, $keys$$25$$, $addKeys$$2$$);
  };
  $oj$$18$$.$DataValueAttributeCube$.prototype.$_processDataValue$ = function $$oj$$18$$$$DataValueAttributeCube$$$$_processDataValue$$($axis$$38$$, $node$$47$$, $row$$46$$, $levelNum$$3$$, $keys$$26$$) {
    for (var $dsKeysAdded$$ = !0, $d$$7$$ = 0;$d$$7$$ < this.$_dataValues$.length;$d$$7$$++) {
      ...
      $row$$46$$.hasOwnProperty($dvAttr$$) && ($currNode$$4_dvLabel$$ = $node$$47$$.$AddNode$($dvAttr$$, $currNode$$4_dvLabel$$, $axis$$38$$.$getLevels$()[$levelNum$$3$$]), $keys$$26$$.$AddDataValue$($dvAttr$$, $row$$46$$[$dvAttr$$]), this.$ProcessLevel$($axis$$38$$, $levelNum$$3$$ + 1, $currNode$$4_dvLabel$$, $row$$46$$, $keys$$26$$, $dsKeysAdded$$), $dsKeysAdded$$ = !1);
    }
    return $keys$$26$$;
  };
  $oj$$18$$.$DataValueAttributeCube$.prototype.$_buildAggTypeLookup$ = function $$oj$$18$$$$DataValueAttributeCube$$$$_buildAggTypeLookup$$() {
    this.$_dataValueAggType$ = [];
    for (var $i$$289$$ = 0;$i$$289$$ < this.$_dataValues$.length;$i$$289$$++) {
      var $dv$$1$$ = this.$_dataValues$[$i$$289$$];
  ...
  $oj$$18$$.$CubeHeaderSet$ = function $$oj$$18$$$$CubeHeaderSet$$($axis$$39$$, $cube$$5$$, $start$$37$$, $count$$33$$) {
    this.$_cube$ = $cube$$5$$;
    this.$_axis$ = $axis$$39$$;
    this.$_start$ = void 0 === $start$$37$$ ? 0 : $start$$37$$;
    this.$_count$ = void 0 === $count$$33$$ ? this.$_axis$.$getExtent$() : Math.min($count$$33$$, this.$_axis$.$getExtent$() - $start$$37$$);
    this.$_end$ = $start$$37$$ + $count$$33$$ - 1;
  };
  $goog$exportPath_$$("CubeHeaderSet", $oj$$18$$.$CubeHeaderSet$, $oj$$18$$);
  $oj$$18$$.$CubeHeaderSet$.prototype.getData = function $$oj$$18$$$$CubeHeaderSet$$$getData$($index$$151$$, $level$$35$$) {
    var $val$$45$$ = this.$_getValue$($index$$151$$, $level$$35$$);
  ...
  $oj$$18$$.$CubeHeaderSet$.prototype.getMetadata = function $$oj$$18$$$$CubeHeaderSet$$$getMetadata$($index$$152$$, $level$$36$$) {
    var $hash$$6_keys$$27$$ = new $oj$$18$$.$CubeKeys$, $hash$$6_keys$$27$$ = this.$_axis$.$GetPartialCubeKeys$($index$$152$$, $level$$36$$, $hash$$6_keys$$27$$);
  ...
  $oj$$18$$.$CubeHeaderSet$.prototype.$getExtent$ = function $$oj$$18$$$$CubeHeaderSet$$$$getExtent$$($index$$153$$, $level$$37$$) {
    var $start$$38_val$$46$$ = this.$_getValue$($index$$153$$, $level$$37$$), $extent$$ = $start$$38_val$$46$$.$getExtent$(), $start$$38_val$$46$$ = $start$$38_val$$46$$.$getStart$(), $end$$14$$ = $start$$38_val$$46$$ + $extent$$ - 1, $after$$ = $index$$153$$ < $start$$38_val$$46$$ + $extent$$ - 1;
    $start$$38_val$$46$$ < this.$_start$ && ($extent$$ -= this.$_start$ - $start$$38_val$$46$$);
    $end$$14$$ > this.$_end$ && ($extent$$ -= $end$$14$$ - this.$_end$);
    return{extent:$extent$$, more:{before:$index$$153$$ > $start$$38_val$$46$$, after:$after$$}};
  };
  $oj$$18$$.$Object$.$exportPrototypeSymbol$("CubeHeaderSet.prototype.getExtent", {$getExtent$:$oj$$18$$.$CubeHeaderSet$.prototype.$getExtent$});
  $oj$$18$$.$CubeHeaderSet$.prototype.$getDepth$ = function $$oj$$18$$$$CubeHeaderSet$$$$getDepth$$($index$$154$$, $level$$38$$) {
    return this.$_getValue$($index$$154$$, $level$$38$$).$getDepth$();
  };
  ...
  $oj$$18$$.$CubeHeaderSet$.prototype.$_getValue$ = function $$oj$$18$$$$CubeHeaderSet$$$$_getValue$$($index$$155$$, $level$$39$$) {
    void 0 === $level$$39$$ && ($level$$39$$ = 0);
    var $values$$12$$ = this.$_axis$.$getValues$($index$$155$$);
    return $values$$12$$ && $values$$12$$.length > $level$$39$$ ? $values$$12$$[$level$$39$$] : null;
  };
  ...
  $oj$$18$$.$CubeDataGridDataSource$.prototype.$getCount$ = function $$oj$$18$$$$CubeDataGridDataSource$$$$getCount$$($axis$$40_axisObj$$) {
    return($axis$$40_axisObj$$ = this.$_getAxis$($axis$$40_axisObj$$)) ? $axis$$40_axisObj$$.$getExtent$() : 0;
  };
  ...
  $oj$$18$$.$CubeDataGridDataSource$.prototype.$fetchCells$ = function $$oj$$18$$$$CubeDataGridDataSource$$$$fetchCells$$($cellRange$$5$$, $callbacks$$35$$, $callbackObjects$$21$$) {
    for (var $cubecells_obj$$54$$ = {}, $i$$290$$ = 0;$i$$290$$ < $cellRange$$5$$.length;$i$$290$$++) {
      var $start$$39$$ = void 0 === $cellRange$$5$$[$i$$290$$].start ? 0 : $cellRange$$5$$[$i$$290$$].start;
      if ("row" === $cellRange$$5$$[$i$$290$$].axis) {
        var $count$$34$$ = void 0 === $cellRange$$5$$[$i$$290$$].count ? this.data.$getAxes$()[1].$getExtent$() : $cellRange$$5$$[$i$$290$$].count;
        $cubecells_obj$$54$$.row = {start:$start$$39$$, count:$count$$34$$};
      }
      "column" === $cellRange$$5$$[$i$$290$$].axis && ($count$$34$$ = void 0 === $cellRange$$5$$[$i$$290$$].count ? this.data.$getAxes$()[0].$getExtent$() : $cellRange$$5$$[$i$$290$$].count, $cubecells_obj$$54$$.column = {start:$start$$39$$, count:$count$$34$$});
    }
  ...
  $oj$$18$$.$CubeDataGridDataSource$.prototype.$_getKey$ = function $$oj$$18$$$$CubeDataGridDataSource$$$$_getKey$$($indexes$$20_item$$8$$, $axis$$42$$, $retObj$$14$$) {
    var $axisObj$$1$$ = this.$_getAxis$($axis$$42$$);
    $indexes$$20_item$$8$$ = $indexes$$20_item$$8$$[$axis$$42$$];
    var $keys$$28$$ = new $oj$$18$$.$CubeKeys$, $keys$$28$$ = $axisObj$$1$$ ? $axisObj$$1$$.$GetCubeKeys$($indexes$$20_item$$8$$, $keys$$28$$) : "";
    $retObj$$14$$[$axis$$42$$] = $keys$$28$$.$GetHashCodes$()[0].key;
    return $retObj$$14$$;
  };
  $oj$$18$$.$CubeDataGridDataSource$.prototype.$indexes$ = function $$oj$$18$$$$CubeDataGridDataSource$$$$indexes$$($keys$$29$$) {
    var $retObj$$15$$ = {}, $retObj$$15$$ = this.$_getIndex$($keys$$29$$, "row", $retObj$$15$$), $retObj$$15$$ = this.$_getIndex$($keys$$29$$, "column", $retObj$$15$$);
  ...
  $oj$$18$$.$CubeDataGridDataSource$.prototype.$_getIndex$ = function $$oj$$18$$$$CubeDataGridDataSource$$$$_getIndex$$($keys$$30$$, $axis$$43$$, $retObj$$16$$) {
    $retObj$$16$$[$axis$$43$$] = this.$_getAxis$($axis$$43$$).$getIndex$($keys$$30$$[$axis$$43$$]);
    return $retObj$$16$$;
  };
  ...
  $oj$$18$$.$CubeDataGridDataSource$.$_convertAxes$ = function $$oj$$18$$$$CubeDataGridDataSource$$$_convertAxes$$($axis$$44$$) {
    return "row" === $axis$$44$$ ? 1 : 0;
  };
  $oj$$18$$.$CubeDataGridDataSource$.prototype.$_getAxis$ = function $$oj$$18$$$$CubeDataGridDataSource$$$$_getAxis$$($axis$$45_axisNum$$) {
    $axis$$45_axisNum$$ = $oj$$18$$.$CubeDataGridDataSource$.$_convertAxes$($axis$$45_axisNum$$);
    var $axes$$4$$ = this.data.$getAxes$();
    return $axes$$4$$.length > $axis$$45_axisNum$$ ? $axes$$4$$[$axis$$45_axisNum$$] : null;
  };
});
