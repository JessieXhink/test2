...
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore"], function($oj$$25$$, $$$$24$$) {
  function $MasonryLayoutCommon$$($elem$$78$$, $rtl$$2_sizeDivWrapper$$, $automationEnabled_style$$8$$, $selectors$$8_sizeDiv$$, $styles$$1$$, $callbackInfo$$) {
    ...
    var $self$$134$$ = this;
    this.$_handleTransitionEndFunc$ = function $this$$_handleTransitionEndFunc$$($event$$318$$) {
      $self$$134$$.$_handleTransitionEnd$($event$$318$$);
    };
    this.$_hideTilesFunc$ = function $this$$_hideTilesFunc$$() {
      $self$$134$$.$_hideTiles$();
    };
    this.$_handleHideTransitionEndFunc$ = function $this$$_handleHideTransitionEndFunc$$($event$$319$$) {
      $self$$134$$.$_handleHideTransitionEnd$($event$$319$$);
    };
    this.$_handleShowTransitionEndFunc$ = function $this$$_handleShowTransitionEndFunc$$($event$$320$$) {
      $self$$134$$.$_handleShowTransitionEnd$($event$$320$$);
    };
  }
  (function() {
    ...
    function $_removeStyleClassName$$($elem$$106$$, $styleClass$$6$$) {
      $$$$24$$($elem$$106$$).removeClass($styleClass$$6$$);
    }
    function $_addStyleClassName$$($elem$$105$$, $styleClass$$5$$) {
      $$$$24$$($elem$$105$$).addClass($styleClass$$5$$);
    }
    $oj$$25$$.$__registerWidget$("oj.ojMasonryLayout", $$$$24$$.oj.baseComponent, {defaultElement:"\x3cdiv\x3e", widgetEventPrefix:"oj", options:{reorderHandle:null, beforeInsert:null, insert:null, beforeRemove:null, remove:null, beforeResize:null, resize:null, beforeReorder:null, reorder:null}, _ComponentCreate:function() {
      ...
      this._super();
      this.$_needsSetup$ && this.$_setup$(this.$_needsSetup$[0]);
    }, $_NotifyContextMenuGesture$:function($menu$$9$$, $event$$321$$, $eventType$$43$$) {
      this.$_prepareContextMenuBeforeOpen$($event$$321$$);
      this.$_OpenContextMenu$($event$$321$$, $eventType$$43$$, {launcher:$$$$24$$($event$$321$$.target).closest(":tabbable")});
      ...
      if (this.$_canCalculateSizes$()) {
        ...
        if ($isInit$$1$$) {
          ...
          this.$_handleDragStartFunc$ = function $this$$_handleDragStartFunc$$($event$$322$$) {
            $self$$135$$.$_handleDragStart$($event$$322$$);
          };
          this.$_handleDragEnterFunc$ = function $this$$_handleDragEnterFunc$$($event$$323$$) {
            $self$$135$$.$_handleDragEnter$($event$$323$$);
          };
          this.$_handleDragOverFunc$ = function $this$$_handleDragOverFunc$$($event$$324$$) {
            $self$$135$$.$_handleDragOver$($event$$324$$);
          };
          this.$_handleDragLeaveFunc$ = function $this$$_handleDragLeaveFunc$$($event$$325$$) {
            $self$$135$$.$_handleDragLeave$($event$$325$$);
          };
          this.$_handleDragEndFunc$ = function $this$$_handleDragEndFunc$$($event$$326$$) {
            $self$$135$$.$_handleDragEnd$($event$$326$$);
          };
          this.$_handleDropFunc$ = function $this$$_handleDropFunc$$($event$$327$$) {
            $self$$135$$.$_handleDrop$($event$$327$$);
          };
      ...
      for (var $children$$6$$ = this.$_getTileElements$(), $numChildren$$ = $children$$6$$.length, $i$$326$$ = 0;$i$$326$$ < $numChildren$$;$i$$326$$++) {
        delete $children$$6$$[$i$$326$$].$_jetDataMasonryOriginalOrder$;
      }
      ...
      this._super();
    }, _setOption:function($key$$137$$, $value$$234$$, $flags$$30$$) {
      ...
      this._super($key$$137$$, $value$$234$$, $flags$$30$$);
      ...
      if (this.$_arTilesToInsert$) {
        for (var $arResizingTiles$$1_mlCommon$$5$$ = this.$_mlCommon$, $arTilesToInsert$$1_eventData$$13_prevSizeStyleClass$$1$$ = this.$_arTilesToInsert$, $i$$327$$ = 0;$i$$327$$ < $arTilesToInsert$$1_eventData$$13_prevSizeStyleClass$$1$$.length;$i$$327$$++) {
          $arResizingTiles$$1_mlCommon$$5$$.$showTile$($arTilesToInsert$$1_eventData$$13_prevSizeStyleClass$$1$$[$i$$327$$]);
        }
        this.$_arTilesToInsert$ = null;
      }
      if (this.$_arResizingTiles$) {
        $arResizingTiles$$1_mlCommon$$5$$ = this.$_arResizingTiles$;
        for ($i$$327$$ = 0;$i$$327$$ < $arResizingTiles$$1_mlCommon$$5$$.length;$i$$327$$ += 3) {
          var $arTilesToInsert$$1_eventData$$13_prevSizeStyleClass$$1$$ = $arResizingTiles$$1_mlCommon$$5$$[$i$$327$$ + 1], $sizeStyleClass$$1$$ = $arResizingTiles$$1_mlCommon$$5$$[$i$$327$$ + 2], $arTilesToInsert$$1_eventData$$13_prevSizeStyleClass$$1$$ = {tile:$$$$24$$($arResizingTiles$$1_mlCommon$$5$$[$i$$327$$]), previousSizeStyleClass:$arTilesToInsert$$1_eventData$$13_prevSizeStyleClass$$1$$, sizeStyleClass:$sizeStyleClass$$1$$};
      ...
      for (var $children$$9$$ = this.element.children($_TILE_SELECTOR$$), $numChildren$$1$$ = $children$$9$$.length, $arChildren$$ = [], $i$$328$$ = 0;$i$$328$$ < $numChildren$$1$$;$i$$328$$++) {
        var $child$$7$$ = $children$$9$$[$i$$328$$];
      ...
      if ($arTiles$$) {
        for (var $i$$329$$ = 0;$i$$329$$ < $arTiles$$.length;$i$$329$$++) {
          var $tile$$1$$ = $arTiles$$[$i$$329$$];
          $tile$$1$$.$_jetDataMasonryOriginalOrder$ || ($tile$$1$$.$_jetDataMasonryOriginalOrder$ = $i$$329$$ + 1);
        }
      }
      ...
      for (var $i$$330$$ = 0;$i$$330$$ < $children$$10$$.length;$i$$330$$++) {
        var $child$$8_sortedChildIndex$$ = $children$$10$$[$i$$330$$], $sortedChild$$ = $sortedChildren$$[$i$$330$$];
        $child$$8_sortedChildIndex$$ != $sortedChild$$ && ($oj$$25$$.Components.$subtreeDetached$($sortedChild$$), $child$$8_sortedChildIndex$$.parentNode.insertBefore($sortedChild$$, $child$$8_sortedChildIndex$$), $oj$$25$$.Components.$subtreeAttached$($sortedChild$$), $child$$8_sortedChildIndex$$ = $children$$10$$.indexOf($sortedChild$$), $child$$8_sortedChildIndex$$ > $i$$330$$ && ($children$$10$$.splice($child$$8_sortedChildIndex$$, 1), $children$$10$$.splice($i$$330$$, 0, $sortedChild$$)));
      }
      ...
      if ($arTiles$$1$$) {
        for (var $i$$331$$ = 0;$i$$331$$ < $arTiles$$1$$.length;$i$$331$$++) {
          var $tile$$2$$ = $arTiles$$1$$[$i$$331$$];
      ...
      if ($removedTile$$.$_jetDataMasonryOriginalOrder$) {
        ...
        if ($arTiles$$2$$) {
          for (var $i$$332$$ = 0;$i$$332$$ < $arTiles$$2$$.length;$i$$332$$++) {
            var $tile$$3$$ = $arTiles$$2$$[$i$$332$$];
      ...
      if (this.$_menu$ && this.$_menu$.$usermenu$ && this.options.reorderHandle) {
        var $$menuContainer$$ = this.$_menu$.$$container$, $self$$136$$ = this;
        ...
        $$menuContainer$$.find("[data-oj-command]").each(function() {
          if (0 === $$$$24$$(this).children("a").length) {
            ...
            $$$$24$$(this).replaceWith($self$$136$$.$_buildContextMenuItem$($command$$12$$));
    ...
    }, $_prepareContextMenuBeforeOpen$:function($e$$97_tile$$4$$) {
      $e$$97_tile$$4$$ = $_findContainingTile$$($e$$97_tile$$4$$.originalEvent.target, this.element[0]);
      this.$_menu$.tile = $e$$97_tile$$4$$;
      if (this.$_menu$.$usermenu$) {
        ...
        if ($elemCut_elemPasteAfter_elemPasteBefore$$) {
          ...
          $cutTile$$ && $e$$97_tile$$4$$ === $cutTile$$ && ($bDisable$$ = !0);
        ...
        if ($elemCut_elemPasteAfter_elemPasteBefore$$ = this.$_menu$.$$elemPasteAfter$) {
          $cutDisabled_pasteAfterDisabled_pasteBeforeDisabled$$ = $elemCut_elemPasteAfter_elemPasteBefore$$.hasClass($_OJ_DISABLED$$), $bDisable$$ = !1, $cutTile$$ && $cutTile$$ !== $e$$97_tile$$4$$ && $cutTile$$ !== $_getNextElement$$($e$$97_tile$$4$$) || ($bDisable$$ = !0), $bDisable$$ && !$cutDisabled_pasteAfterDisabled_pasteBeforeDisabled$$ ? ($elemCut_elemPasteAfter_elemPasteBefore$$.addClass($_OJ_DISABLED$$), $bRefreshMenu$$ = !0) : !$bDisable$$ && $cutDisabled_pasteAfterDisabled_pasteBeforeDisabled$$ && 
          ($elemCut_elemPasteAfter_elemPasteBefore$$.removeClass($_OJ_DISABLED$$), $bRefreshMenu$$ = !0);
        }
      ...
      var $label$$11$$ = $$$$24$$('\x3ca href\x3d"#"\x3e\x3c/a\x3e');
      $label$$11$$.text(this.$getTranslatedString$($cmd_transKey$$));
      $label$$11$$.wrap("\x3cli id\x3d" + $id$$35$$ + "\x3e\x3c/li\x3e");
      return $label$$11$$.parent();
    ...
    }, $_handleContextMenuSelect$:function($ev$$3$$, $ui$$16$$) {
      ...
      for (var $numChildren$$2$$ = $children$$11$$.length, $i$$333$$ = 0;$i$$333$$ < $numChildren$$2$$;$i$$333$$++) {
        if ($children$$11$$[$i$$333$$] === $tile$$5$$) {
          return $i$$333$$;
        }
      }
      return-1;
    ...
    }, $_handleDragStart$:function($event$$328_originalEvent$$5$$) {
      if (this.options.reorderHandle && !this.$_bDragging$) {
        var $tile$$6$$ = $_findContainingTile$$($event$$328_originalEvent$$5$$.target, this.element[0]);
        if ($tile$$6$$) {
          ...
          !1 !== this._trigger("beforeReorder", null, $eventData$$15_index$$208$$) && ($event$$328_originalEvent$$5$$ = $event$$328_originalEvent$$5$$.originalEvent, this.$_dragStart$($tile$$6$$, $event$$328_originalEvent$$5$$.pageX, $event$$328_originalEvent$$5$$.pageY, $event$$328_originalEvent$$5$$.dataTransfer));
        }
      }
    }, $_handleDragEnter$:function($event$$329_originalEvent$$6$$) {
      $event$$329_originalEvent$$6$$ = $event$$329_originalEvent$$6$$.originalEvent;
      var $elemUnderPoint_relatedTarget$$ = $event$$329_originalEvent$$6$$.relatedTarget, $elem$$98$$ = this.element[0], $enteringMasonryLayout$$ = !1;
      $elemUnderPoint_relatedTarget$$ ? $enteringMasonryLayout$$ = $elem$$98$$ != $elemUnderPoint_relatedTarget$$ && !$oj$$25$$.$DomUtils$.$isAncestor$($elem$$98$$, $elemUnderPoint_relatedTarget$$) : this.$_dragLeftMasonryLayout$ && ($enteringMasonryLayout$$ = ($elemUnderPoint_relatedTarget$$ = document.elementFromPoint($event$$329_originalEvent$$6$$.clientX, $event$$329_originalEvent$$6$$.clientY)) && ($elemUnderPoint_relatedTarget$$ == $elem$$98$$ || $oj$$25$$.$DomUtils$.$isAncestor$($elem$$98$$, 
      $elemUnderPoint_relatedTarget$$)));
      $enteringMasonryLayout$$ && ((this.$_dragLeftMasonryLayout$ = !1, this.$_draggedTile$) ? this.$_dropSite$ && ($$$$24$$(this.$_dropSite$).css("display", ""), this.$_mlCommon$.$setup$(!1, !0)) : $event$$329_originalEvent$$6$$.dataTransfer.dropEffect = "none");
    }, $_handleDragOver$:function($event$$330$$) {
      var $originalEvent$$7$$ = $event$$330$$.originalEvent;
      ...
      return!1;
    }, $_handleDragLeave$:function($elem$$99_event$$331$$) {
      var $elemUnderPoint$$1_originalEvent$$8$$ = $elem$$99_event$$331$$.originalEvent, $relatedTarget$$1$$ = $elemUnderPoint$$1_originalEvent$$8$$.relatedTarget;
      $elem$$99_event$$331$$ = this.element[0];
      var $leavingMasonryLayout$$ = !1;
      $leavingMasonryLayout$$ = $relatedTarget$$1$$ ? $elem$$99_event$$331$$ != $relatedTarget$$1$$ && !$oj$$25$$.$DomUtils$.$isAncestor$($elem$$99_event$$331$$, $relatedTarget$$1$$) : ($elemUnderPoint$$1_originalEvent$$8$$ = document.elementFromPoint($elemUnderPoint$$1_originalEvent$$8$$.clientX, $elemUnderPoint$$1_originalEvent$$8$$.clientY)) && $elemUnderPoint$$1_originalEvent$$8$$ != $elem$$99_event$$331$$ && !$oj$$25$$.$DomUtils$.$isAncestor$($elem$$99_event$$331$$, $elemUnderPoint$$1_originalEvent$$8$$);
    ...
    }, $_handleDrop$:function($event$$333$$) {
      ...
      this.$_dragStartHideTileTimeout$ = setTimeout(function() {
        ...
        $self$$137$$.$_dragStartHideTileTimeout$ = null;
  ...
  $MasonryLayoutCommon$$.prototype.destroy = function $$MasonryLayoutCommon$$$$destroy$() {
    for (var $elem$$111$$ = this.$_elem$, $children$$12$$ = this.$_getTileChildren$(), $i$$334$$ = 0;$i$$334$$ < $children$$12$$.length;$i$$334$$++) {
      var $style$$16$$ = $children$$12$$[$i$$334$$].style;
  ...
  $MasonryLayoutCommon$$.prototype.$finishLayoutCycle$ = function $$MasonryLayoutCommon$$$$$finishLayoutCycle$$() {
    ...
    for (var $tileChildren$$ = this.$_getTileChildren$(), $i$$335$$ = 0;$i$$335$$ < $tileChildren$$.length;$i$$335$$++) {
      var $child$$10$$ = $tileChildren$$[$i$$335$$];
  ...
  $MasonryLayoutCommon$$.$_arrayIndexOf$ = function $$MasonryLayoutCommon$$$$_arrayIndexOf$$($array$$14$$, $item$$88$$) {
    if ($array$$14$$) {
      for (var $i$$336$$ = 0;$i$$336$$ < $array$$14$$.length;$i$$336$$++) {
        if ($array$$14$$[$i$$336$$] == $item$$88$$) {
          return $i$$336$$;
        }
      }
    }
  ...
  $MasonryLayoutCommon$$.$_isMinimumAgentMet$ = function $$MasonryLayoutCommon$$$$_isMinimumAgentMet$$($actualAgentType$$, $actualAgentVersion$$) {
    ...
    if (0 == $argCount$$ % 2) {
      for (var $i$$337$$ = 0;$i$$337$$ <= $argCount$$ - 2;$i$$337$$ += 2) {
        if ($actualAgentType$$ == $agentRequirements$$[$i$$337$$]) {
          if ($actualAgentVersion$$ >= $agentRequirements$$[1 + $i$$337$$]) {
            return!0;
          }
          break;
        }
  ...
  $MasonryLayoutCommon$$.prototype.$_getTileChildren$ = function $$MasonryLayoutCommon$$$$$_getTileChildren$$() {
    for (var $children$$13$$ = this.$_elem$.querySelectorAll(this.$_tilesSelector$), $arChildren$$2$$ = [], $i$$338$$ = 0;$i$$338$$ < $children$$13$$.length;$i$$338$$++) {
      var $child$$11$$ = $children$$13$$[$i$$338$$], $childStyle$$ = $child$$11$$.style;
  ...
  $MasonryLayoutCommon$$.prototype.$_transitionLayout$ = function $$MasonryLayoutCommon$$$$$_transitionLayout$$() {
    ...
    if (this.$_arInfoletsToResize$) {
      ...
      for (var $i$$339$$ = 0;$i$$339$$ < $arInfoletsToResize$$1_calledHandleTransitionEnd$$.length;$i$$339$$ += 2) {
        var $resizedInfolet$$ = $arInfoletsToResize$$1_calledHandleTransitionEnd$$[$i$$339$$];
  ...
  $MasonryLayoutCommon$$.prototype.$_layout$ = function $$MasonryLayoutCommon$$$$$_layout$$() {
    ...
    for (var $i$$340$$ = 0;$i$$340$$ < $children$$14$$.length;$i$$340$$++) {
      var $child$$12$$ = $children$$14$$[$i$$340$$], $childSpan$$ = this.$_getTileSpanFunc$($child$$12$$);
  ...
  $MasonryLayoutCommon$$.prototype.$_reorderTilesForLayout$ = function $$MasonryLayoutCommon$$$$$_reorderTilesForLayout$$() {
    ...
    for (var $arTilePositions$$1$$ = $arTilePositions$$1$$.sort($MasonryLayoutCommon$$.$_compareTilePositions$), $children$$15$$ = this.$_getTileChildren$(), $i$$341$$ = 0;$i$$341$$ < $children$$15$$.length;$i$$341$$++) {
      var $child$$13_posTileIndex$$ = $children$$15$$[$i$$341$$], $posTile$$ = $arTilePositions$$1$$[$i$$341$$].tile;
      $child$$13_posTileIndex$$ != $posTile$$ && (this.$_subtreeDetachedFunc$($posTile$$), $child$$13_posTileIndex$$.parentNode.insertBefore($posTile$$, $child$$13_posTileIndex$$), this.$_subtreeAttachedFunc$($posTile$$), $child$$13_posTileIndex$$ = $MasonryLayoutCommon$$.$_arrayIndexOf$($children$$15$$, $posTile$$), $child$$13_posTileIndex$$ > $i$$341$$ && ($children$$15$$.splice($child$$13_posTileIndex$$, 1), $children$$15$$.splice($i$$341$$, 0, $posTile$$)));
    }
  };
  ...
  $MasonryLayoutCommon$$.prototype.$_addStyleClassToTiles$ = function $$MasonryLayoutCommon$$$$$_addStyleClassToTiles$$($styleClassName$$) {
    for (var $children$$16$$ = this.$_getTileChildren$(), $i$$342$$ = 0;$i$$342$$ < $children$$16$$.length;$i$$342$$++) {
      this.$_addStyleClassNameFunc$($children$$16$$[$i$$342$$], $styleClassName$$);
    }
  };
  $MasonryLayoutCommon$$.prototype.$_removeStyleClassFromTiles$ = function $$MasonryLayoutCommon$$$$$_removeStyleClassFromTiles$$($styleClassName$$1$$) {
    for (var $children$$17$$ = this.$_getTileChildren$(), $i$$343$$ = 0;$i$$343$$ < $children$$17$$.length;$i$$343$$++) {
      this.$_removeStyleClassNameFunc$($children$$17$$[$i$$343$$], $styleClassName$$1$$);
    }
  };
  ...
  $MasonryLayoutCommon$$.prototype.$_handleTransitionEnd$ = function $$MasonryLayoutCommon$$$$$_handleTransitionEnd$$($event$$334_i$$344$$) {
    var $arInfoletsToResize$$2_doneTransitioning$$ = !0;
    if (this.$_arMovedInfolets$) {
      var $arMovedInfolets$$1$$ = this.$_arMovedInfolets$;
      if ($event$$334_i$$344$$) {
        var $target$$87$$ = $event$$334_i$$344$$.target;
        for ($event$$334_i$$344$$ = 0;$event$$334_i$$344$$ < $arMovedInfolets$$1$$.length;$event$$334_i$$344$$++) {
          if ($target$$87$$ === $arMovedInfolets$$1$$[$event$$334_i$$344$$]) {
            $arMovedInfolets$$1$$.splice($event$$334_i$$344$$, 1);
            break;
          }
        }
      } else {
    ...
    if ($arInfoletsToResize$$2_doneTransitioning$$) {
      if (this.$_arInfoletsToResize$ && ($arInfoletsToResize$$2_doneTransitioning$$ = this.$_arInfoletsToResize$, this.$_arInfoletsToResize$ = null, this.$isAnimationEnabled$())) {
        for ($event$$334_i$$344$$ = 0;$event$$334_i$$344$$ < $arInfoletsToResize$$2_doneTransitioning$$.length;$event$$334_i$$344$$ += 2) {
          this.$_removeStyleClassNameFunc$($arInfoletsToResize$$2_doneTransitioning$$[$event$$334_i$$344$$], this.$_transitionResizeToStyleClass$);
        }
      }
  ...
  $MasonryLayoutCommon$$.prototype.$_hideTiles$ = function $$MasonryLayoutCommon$$$$$_hideTiles$$() {
    ...
    if (this.$_arInfoletsToHide$ && this.$isAnimationEnabled$()) {
      for (var $arInfoletsToHide$$1$$ = this.$_arInfoletsToHide$, $i$$345$$ = 0;$i$$345$$ < $arInfoletsToHide$$1$$.length;$i$$345$$++) {
        var $infolet$$5$$ = $arInfoletsToHide$$1$$[$i$$345$$];
      ...
      this.$_hideTilesInternalTimeout$ = setTimeout(function() {
        for (var $i$$346$$ = 0;$i$$346$$ < $arInfoletsToHide$$1$$.length;$i$$346$$++) {
          var $infolet$$6$$ = $arInfoletsToHide$$1$$[$i$$346$$];
          $self$$139$$.$_removeStyleClassNameFunc$($infolet$$6$$, $self$$139$$.$_transitionHideFromStyleClass$);
          $self$$139$$.$_addStyleClassNameFunc$($infolet$$6$$, $self$$139$$.$_transitionHideToStyleClass$);
        }
      }, 0);
    } else {
  ...
  $MasonryLayoutCommon$$.prototype.$_handleHideTransitionEnd$ = function $$MasonryLayoutCommon$$$$$_handleHideTransitionEnd$$($event$$335_infolet$$7$$) {
    this.$_hideTilesInternalTimeout$ && (clearTimeout(this.$_hideTilesInternalTimeout$), this.$_hideTilesInternalTimeout$ = null);
    if ($event$$335_infolet$$7$$) {
      $event$$335_infolet$$7$$.preventDefault();
      $event$$335_infolet$$7$$.stopPropagation();
      $event$$335_infolet$$7$$ = $event$$335_infolet$$7$$.target;
      this.$_removeStyleClassNameFunc$($event$$335_infolet$$7$$, this.$_transitionHideToStyleClass$);
      $MasonryLayoutCommon$$.$_removeBubbleEventListener$($event$$335_infolet$$7$$, "transitionend", this.$_handleHideTransitionEndFunc$);
      $MasonryLayoutCommon$$.$_removeBubbleEventListener$($event$$335_infolet$$7$$, "webkitTransitionEnd", this.$_handleHideTransitionEndFunc$);
      var $arInfoletsToHide$$2_newSizeStyleClass_style$$19$$ = this.$_arInfoletsToHide$;
      if ($arInfoletsToHide$$2_newSizeStyleClass_style$$19$$) {
        for (var $i$$347$$ = 0;$i$$347$$ < $arInfoletsToHide$$2_newSizeStyleClass_style$$19$$.length;$i$$347$$++) {
          var $oldSizeStyleClass$$1_tmpInfolet$$ = $arInfoletsToHide$$2_newSizeStyleClass_style$$19$$[$i$$347$$];
          if ($oldSizeStyleClass$$1_tmpInfolet$$ === $event$$335_infolet$$7$$) {
            $arInfoletsToHide$$2_newSizeStyleClass_style$$19$$.splice($i$$347$$, 1);
            this.$_arFireHideOnEnd$ || (this.$_arFireHideOnEnd$ = []);
            var $arFireHideOnEnd_arInfoletsToResize$$3$$ = this.$_arFireHideOnEnd$;
            $arFireHideOnEnd_arInfoletsToResize$$3$$.push($event$$335_infolet$$7$$);
            break;
          }
        }
      ...
      if (!this.$isAnimationEnabled$() && ($arInfoletsToHide$$2_newSizeStyleClass_style$$19$$ = this.$_arInfoletsToHide$)) {
        for ($i$$347$$ = 0;$i$$347$$ < $arInfoletsToHide$$2_newSizeStyleClass_style$$19$$.length;$i$$347$$++) {
          $oldSizeStyleClass$$1_tmpInfolet$$ = $arInfoletsToHide$$2_newSizeStyleClass_style$$19$$[$i$$347$$], this.$_arFireHideOnEnd$ || (this.$_arFireHideOnEnd$ = []), $arFireHideOnEnd_arInfoletsToResize$$3$$ = this.$_arFireHideOnEnd$, $arFireHideOnEnd_arInfoletsToResize$$3$$.push($oldSizeStyleClass$$1_tmpInfolet$$);
        }
    ...
    if (!this.$_arInfoletsToHide$) {
      if (this.$_arFireHideOnEnd$) {
        ...
        for ($i$$347$$ = 0;$i$$347$$ < $arFireHideOnEnd_arInfoletsToResize$$3$$.length;$i$$347$$++) {
          $event$$335_infolet$$7$$ = $arFireHideOnEnd_arInfoletsToResize$$3$$[$i$$347$$], this.$isAnimationEnabled$() && this.$_removeStyleClassNameFunc$($event$$335_infolet$$7$$, this.$_transitionHideToStyleClass$), $arInfoletsToHide$$2_newSizeStyleClass_style$$19$$ = $event$$335_infolet$$7$$.style, this.$_rtl$ ? $arInfoletsToHide$$2_newSizeStyleClass_style$$19$$.right = "" : $arInfoletsToHide$$2_newSizeStyleClass_style$$19$$.left = "", $arInfoletsToHide$$2_newSizeStyleClass_style$$19$$.top = "", 
          this.$_hideTileOnEndFunc$ && this.$_hideTileOnEndFunc$($event$$335_infolet$$7$$);
        }
      ...
      if (this.$_arInfoletsToResize$) {
        for ($arFireHideOnEnd_arInfoletsToResize$$3$$ = this.$_arInfoletsToResize$, $i$$347$$ = 0;$i$$347$$ < $arFireHideOnEnd_arInfoletsToResize$$3$$.length;$i$$347$$ += 2) {
          $event$$335_infolet$$7$$ = $arFireHideOnEnd_arInfoletsToResize$$3$$[$i$$347$$], $arInfoletsToHide$$2_newSizeStyleClass_style$$19$$ = $arFireHideOnEnd_arInfoletsToResize$$3$$[$i$$347$$ + 1], $oldSizeStyleClass$$1_tmpInfolet$$ = this.$_getSizeStyleClassNameFunc$($event$$335_infolet$$7$$), this.$_removeStyleClassNameFunc$($event$$335_infolet$$7$$, $oldSizeStyleClass$$1_tmpInfolet$$), this.$_addStyleClassNameFunc$($event$$335_infolet$$7$$, $arInfoletsToHide$$2_newSizeStyleClass_style$$19$$), 
          this.$isAnimationEnabled$() && (this.$_addStyleClassNameFunc$($event$$335_infolet$$7$$, this.$_transitionResizeToStyleClass$), $event$$335_infolet$$7$$.$_afrOldSizeStyleClass$ = $oldSizeStyleClass$$1_tmpInfolet$$);
        }
      }
  ...
  $MasonryLayoutCommon$$.prototype.$_showTiles$ = function $$MasonryLayoutCommon$$$$$_showTiles$$() {
    ...
    if (this.$_arInfoletsToShow$ && this.$isAnimationEnabled$()) {
      for (var $arInfoletsToShow$$1$$ = this.$_arInfoletsToShow$, $i$$348$$ = 0;$i$$348$$ < $arInfoletsToShow$$1$$.length;$i$$348$$++) {
        var $infolet$$8$$ = $arInfoletsToShow$$1$$[$i$$348$$];
      ...
      if (this.$_arInfoletsToShow$) {
        for ($arInfoletsToShow$$1$$ = this.$_arInfoletsToShow$, $i$$348$$ = 0;$i$$348$$ < $arInfoletsToShow$$1$$.length;$i$$348$$++) {
          $infolet$$8$$ = $arInfoletsToShow$$1$$[$i$$348$$], this.$_removeStyleClassNameFunc$($infolet$$8$$, this.$_transitionShowFromStyleClass$);
        }
      }
      this.$_handleShowTransitionEnd$(null);
    }
  };
  $MasonryLayoutCommon$$.prototype.$_handleShowTransitionEnd$ = function $$MasonryLayoutCommon$$$$$_handleShowTransitionEnd$$($event$$336_infolet$$9$$) {
    if ($event$$336_infolet$$9$$) {
      $event$$336_infolet$$9$$.preventDefault();
      $event$$336_infolet$$9$$.stopPropagation();
      $event$$336_infolet$$9$$ = $event$$336_infolet$$9$$.target;
      this.$_removeStyleClassNameFunc$($event$$336_infolet$$9$$, this.$_transitionShowToStyleClass$);
      $MasonryLayoutCommon$$.$_removeBubbleEventListener$($event$$336_infolet$$9$$, "transitionend", this.$_handleShowTransitionEndFunc$);
      $MasonryLayoutCommon$$.$_removeBubbleEventListener$($event$$336_infolet$$9$$, "webkitTransitionEnd", this.$_handleShowTransitionEndFunc$);
      var $arInfoletsToShow$$2$$ = this.$_arInfoletsToShow$;
      if ($arInfoletsToShow$$2$$) {
        for (var $i$$349$$ = 0;$i$$349$$ < $arInfoletsToShow$$2$$.length;$i$$349$$++) {
          var $tmpInfolet$$1$$ = $arInfoletsToShow$$2$$[$i$$349$$];
          if ($tmpInfolet$$1$$ === $event$$336_infolet$$9$$) {
            $arInfoletsToShow$$2$$.splice($i$$349$$, 1);
            this.$_showTileOnEndFunc$ && this.$_showTileOnEndFunc$($event$$336_infolet$$9$$);
            break;
          }
        }
      ...
      if (!this.$isAnimationEnabled$() && ($arInfoletsToShow$$2$$ = this.$_arInfoletsToShow$)) {
        for ($i$$349$$ = 0;$i$$349$$ < $arInfoletsToShow$$2$$.length;$i$$349$$++) {
          $tmpInfolet$$1$$ = $arInfoletsToShow$$2$$[$i$$349$$], this.$_showTileOnEndFunc$ && this.$_showTileOnEndFunc$($tmpInfolet$$1$$);
        }
