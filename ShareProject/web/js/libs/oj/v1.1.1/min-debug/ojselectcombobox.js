...
define(["ojs/ojcore", "jquery", "ojs/ojeditablevalue"], function($oj$$12$$, $$$$12$$) {
  var $_ComboUtils$$ = {$KEY$:{TAB:9, ENTER:13, $ESC$:27, SPACE:32, LEFT:37, UP:38, RIGHT:39, DOWN:40, $SHIFT$:16, $CTRL$:17, $ALT$:18, PAGE_UP:33, PAGE_DOWN:34, HOME:36, END:35, $BACKSPACE$:8, $DELETE$:46, $isControl$:function($e$$55$$) {
    switch($e$$55$$.which) {
    ...
    return $e$$55$$.metaKey || $e$$55$$.ctrlKey ? !0 : !1;
    ...
    for (var $j$$24$$ = $$$$12$$.isFunction($list$$[0]) ? $$$$12$$($list$$[0]()) : $$$$12$$($list$$[0]), $i$$177$$ = -1, $l$$5$$ = $list$$.length;++$i$$177$$ < $l$$5$$ && ($j$$24$$.context = $j$$24$$[0] = $$$$12$$.isFunction($list$$[0]) ? $list$$[$i$$177$$]() : $list$$[$i$$177$$]) && !1 !== $c$$34$$.call($j$$24$$[0], $i$$177$$, $j$$24$$);) {
    }
    return $list$$;
    ...
    var $val$$28$$, $i$$178$$, $l$$6$$;
    if (null === $string$$3$$ || 1 > $string$$3$$.length) {
      return[];
    }
    $val$$28$$ = $string$$3$$.split($separator$$);
    $i$$178$$ = 0;
    for ($l$$6$$ = $val$$28$$.length;$i$$178$$ < $l$$6$$;$i$$178$$ += 1) {
      $val$$28$$[$i$$178$$] = $$$$12$$.trim($val$$28$$[$i$$178$$]);
    }
    return $val$$28$$;
    ...
    $element$$69$$.on("keyup", function($e$$56_val$$29$$) {
      $e$$56_val$$29$$.which === $_ComboUtils$$.$KEY$.ENTER ? $e$$56_val$$29$$.stopPropagation() : ($e$$56_val$$29$$ = $$$$12$$.data($element$$69$$, "keyup-change-value"), void 0 !== $e$$56_val$$29$$ && $element$$69$$.val() !== $e$$56_val$$29$$ && ($$$$12$$.removeData($element$$69$$, "keyup-change-value"), $element$$69$$.trigger("keyup-change")));
    });
  }, $installFilteredMouseMove$:function($element$$70$$) {
    $element$$70$$.on("mousemove", function($e$$57$$) {
      var $lastpos$$ = $_ComboUtils$$.$lastMousePosition$;
      if (void 0 === $lastpos$$ || $lastpos$$.x !== $e$$57$$.pageX || $lastpos$$.y !== $e$$57$$.pageY) {
        $$$$12$$($e$$57$$.target).trigger("mousemove-filtered", $e$$57$$), $_ComboUtils$$.$lastMousePosition$.x = $e$$57$$.pageX, $_ComboUtils$$.$lastMousePosition$.y = $e$$57$$.pageY;
      }
    });
  ...
  }, $killEvent$:function($event$$122$$) {
    $event$$122$$.preventDefault();
    $event$$122$$.stopPropagation();
  }, $killEventImmediately$:function($event$$123$$) {
    $event$$123$$.preventDefault();
    $event$$123$$.stopImmediatePropagation();
    ...
    var $data$$88$$ = $options$$266$$, $dataText$$, $tmp$$1$$;
    $$$$12$$.isArray($data$$88$$) && ($tmp$$1$$ = $data$$88$$, $data$$88$$ = {$results$:$tmp$$1$$});
    !1 === $$$$12$$.isFunction($data$$88$$) && ($tmp$$1$$ = $data$$88$$, $data$$88$$ = function $$data$$88$$$() {
      return $tmp$$1$$;
    });
    var $dataItem$$ = $data$$88$$();
    ...
    return function($query$$6$$) {
      ...
      "" !== $t$$ || $optKeys$$ ? ($process$$ = function $$process$$$($datum$$, $collection$$32$$, $keys$$15$$) {
        ...
        if ($datum$$.children) {
          ...
          $group$$.children = [];
          $_ComboUtils$$.$each2$($$$$12$$($datum$$.children), function($i$$179$$, $childDatum$$) {
      ...
      }, $data$$88$$() && $_ComboUtils$$.$each2$($$$$12$$($data$$88$$().$results$), function($i$$180$$, $datum$$1$$) {
        $process$$($datum$$1$$, $filtered$$.$results$, $optKeys$$);
      }), $query$$6$$.$callback$($filtered$$)) : $query$$6$$.$callback$($data$$88$$());
    };
    ...
    $$$$12$$(this.$container$).on("change", "." + $className$$6$$ + "-input", function($e$$58$$) {
      $e$$58$$.stopPropagation();
    });
    $$$$12$$(this.$dropdown$).on("change", "." + $className$$6$$ + "-input", function($e$$59$$) {
    ...
    this.$dropdown$.on("mouseup", ".oj-listbox-results", this.$_bind$(function($e$$60$$) {
      0 < $$$$12$$($e$$60$$.target).closest(".oj-listbox-result-selectable").length && (this.$_highlightUnderEvent$($e$$60$$), this.$_selectHighlighted$(null, $e$$60$$));
    }));
    this.$dropdown$.on("click mouseup mousedown", function($e$$61$$) {
  ...
  }, $_clickAwayHandler$:function($event$$124$$) {
    var $dropdown_self$$73$$ = this.$dropdown$;
    !$$$$12$$($event$$124$$.target).closest($dropdown_self$$73$$).length && !$$$$12$$($event$$124$$.target).closest("#" + $dropdown_self$$73$$.attr("data-oj-containerid")).length && 0 < $dropdown_self$$73$$.length && ($dropdown_self$$73$$ = $dropdown_self$$73$$.data("ojlistbox"), $dropdown_self$$73$$.close($event$$124$$));
    ...
    if ($list$$1$$ && $list$$1$$.is("ul")) {
      ...
      for (var $i$$181_wrappingDiv$$ = $list$$1$$.children().length - 1;0 <= $i$$181_wrappingDiv$$;$i$$181_wrappingDiv$$--) {
        this.$_cleanupList$($$$$12$$($list$$1$$.children()[$i$$181_wrappingDiv$$]));
      }
    } else {
      $list$$1$$.is("li") && (($list$$1$$.hasClass("oj-listbox-placeholder") || $list$$1$$.hasClass("oj-listbox-no-results")) && $list$$1$$.remove(), $list$$1$$.attr("class") && $list$$1$$.attr("class", $list$$1$$.attr("class").replace(/\oj-listbox-\S+/g, "")), ($i$$181_wrappingDiv$$ = $list$$1$$.children(".oj-listbox-result-label")) && $i$$181_wrappingDiv$$.contents().unwrap(), "none" == $list$$1$$.css("display") && $list$$1$$.css("display", ""), this.$_cleanupList$($list$$1$$.children("ul")));
    }
    ...
    var $element$$73$$, $datalist$$, $self$$74$$ = this;
    $opts$$14$$.options && Array.isArray($opts$$14$$.options) && $opts$$14$$.optionsKeys && ($opts$$14$$.options = $$$$12$$.extend(!0, [], $opts$$14$$.options));
    $element$$73$$ = $opts$$14$$.element;
    var $tagName$$2$$ = $element$$73$$.get(0).tagName.toLowerCase();
    "input" === $tagName$$2$$ && $element$$73$$.attr("list") ? this.$datalist$ = $datalist$$ = $$$$12$$("#" + $element$$73$$.attr("list")) : "select" === $tagName$$2$$ && 0 < $element$$73$$.children().length ? this.$datalist$ = $datalist$$ = $element$$73$$ : $opts$$14$$.list && (this.$datalist$ = $datalist$$ = $$$$12$$("#" + $opts$$14$$.list));
    $opts$$14$$ = $$$$12$$.extend({}, {$populateResults$:function($container$$2$$, $results$$4$$, $query$$7$$, $showPlaceholder$$) {
      var $populate$$, $id$$22$$ = this.$opts$.id;
      $populate$$ = function $$populate$$$($results$$5$$, $container$$3$$, $depth$$7$$, $i$$182_showPlaceholder$$1$$) {
        function $processChildren$$($node$$28$$, $result$$41$$) {
          if ($result$$41$$.children && 0 < $result$$41$$.children.length) {
            var $nestedList$$ = $result$$41$$.element && $$$$12$$($result$$41$$.element[0]).is("li") && $$$$12$$($result$$41$$.element[0]).children("ul"), $innerContainer$$1$$ = $nestedList$$ ? $$$$12$$($result$$41$$.element[0]).children("ul") : $$$$12$$("\x3cul\x3e\x3c/ul\x3e");
            $innerContainer$$1$$.hasClass("oj-listbox-result-sub") || $innerContainer$$1$$.addClass("oj-listbox-result-sub");
            $populate$$($result$$41$$.children, $innerContainer$$1$$, $depth$$7$$ + 1, !1);
            $nestedList$$ || $node$$28$$.append($innerContainer$$1$$);
          }
        }
        var $l$$7_placeholder$$, $result$$40$$, $label$$4_selectable$$, $disabled$$3_formatted$$, $node$$27$$;
        $l$$7_placeholder$$ = $self$$74$$.$_getPlaceholder$();
        $i$$182_showPlaceholder$$1$$ && null !== $l$$7_placeholder$$ && !$query$$7$$.$term$ && 0 >= $container$$3$$.find(".oj-listbox-placeholder").length && ($result$$40$$ = {value:"", label:$l$$7_placeholder$$}, $node$$27$$ = $$$$12$$("\x3cli\x3e\x3c/li\x3e"), $node$$27$$.addClass("oj-listbox-placeholder oj-listbox-results-depth-0 oj-listbox-result oj-listbox-result-selectable"), $node$$27$$.attr("role", "presentation"), $label$$4_selectable$$ = $$$$12$$(document.createElement("div")), $label$$4_selectable$$.addClass("oj-listbox-result-label"), 
        $label$$4_selectable$$.attr("id", "oj-listbox-result-label-" + $_ComboUtils$$.$nextUid$()), $label$$4_selectable$$.attr("role", "option"), $disabled$$3_formatted$$ = $opts$$14$$.$formatResult$($result$$40$$), void 0 !== $disabled$$3_formatted$$ && $label$$4_selectable$$.text($disabled$$3_formatted$$), $node$$27$$.append($label$$4_selectable$$), $node$$27$$.data($self$$74$$.$_elemNm$, $result$$40$$), $container$$3$$.prepend($node$$27$$));
        $i$$182_showPlaceholder$$1$$ = 0;
        for ($l$$7_placeholder$$ = $results$$5$$.length;$i$$182_showPlaceholder$$1$$ < $l$$7_placeholder$$;$i$$182_showPlaceholder$$1$$ += 1) {
          $result$$40$$ = $results$$5$$[$i$$182_showPlaceholder$$1$$];
          $disabled$$3_formatted$$ = !0 === $result$$40$$.disabled;
          $label$$4_selectable$$ = !$disabled$$3_formatted$$ && void 0 !== $id$$22$$($result$$40$$);
          var $isList$$ = $result$$40$$.element && $$$$12$$($result$$40$$.element[0]).is("li");
          $node$$27$$ = $isList$$ ? $$$$12$$($result$$40$$.element[0]) : $$$$12$$("\x3cli\x3e\x3c/li\x3e");
          $node$$27$$.hasClass("oj-listbox-result") ? ($result$$40$$.children && 0 < $result$$40$$.children.length && $processChildren$$($node$$27$$, $result$$40$$), $$$$12$$($result$$40$$.element[0]).css("display", "")) : ($node$$27$$.addClass("oj-listbox-results-depth-" + $depth$$7$$), $node$$27$$.addClass("oj-listbox-result"), $node$$27$$.addClass($label$$4_selectable$$ ? "oj-listbox-result-selectable" : "oj-listbox-result-unselectable"), $disabled$$3_formatted$$ && $node$$27$$.addClass("oj-disabled"), 
          $result$$40$$.children && $node$$27$$.addClass("oj-listbox-result-with-children"), $node$$27$$.attr("role", "presentation"), $label$$4_selectable$$ = $$$$12$$(document.createElement("div")), $label$$4_selectable$$.addClass("oj-listbox-result-label"), $label$$4_selectable$$.attr("id", "oj-listbox-result-label-" + $_ComboUtils$$.$nextUid$()), $label$$4_selectable$$.attr("role", "option"), $disabled$$3_formatted$$ && $label$$4_selectable$$.attr("aria-disabled", "true"), $isList$$ || ($disabled$$3_formatted$$ = 
          $opts$$14$$.$formatResult$($result$$40$$), void 0 !== $disabled$$3_formatted$$ && $label$$4_selectable$$.text($disabled$$3_formatted$$), $node$$27$$.append($label$$4_selectable$$)), $result$$40$$.children && 0 < $result$$40$$.children.length && $processChildren$$($node$$27$$, $result$$40$$), $node$$27$$.data($self$$74$$.$_elemNm$, $result$$40$$), $isList$$ ? ($$$$12$$($result$$40$$.element[0]).contents().filter(function() {
            return "UL" !== this.tagName;
          }).wrapAll($label$$4_selectable$$), $$$$12$$($result$$40$$.element[0]).css("display", "")) : $container$$3$$.append($node$$27$$));
        }
      };
      $populate$$($results$$4$$, $container$$2$$, 0, $showPlaceholder$$);
    }}, $_ojChoice_defaults$$, $opts$$14$$);
    $opts$$14$$.id = function $$opts$$14$$$id$($e$$62$$) {
      return $e$$62$$.value;
    };
    $opts$$14$$.$formatResult$ = function $$opts$$14$$$$formatResult$$($result$$42$$) {
      return isNaN($result$$42$$.label) ? $result$$42$$.label : this.$ojContext$.$_formatValue$($result$$42$$.label);
    };
    $opts$$14$$.$formatSelection$ = function $$opts$$14$$$$formatSelection$$($data$$89$$) {
      return $data$$89$$ && $data$$89$$.label ? isNaN($data$$89$$.label) ? $data$$89$$.label : this.$ojContext$.$_formatValue$($data$$89$$.label) : void 0;
    };
    ...
    $datalist$$ ? $opts$$14$$.$query$ = this.$_bind$(function($query$$8$$) {
      var $data$$90$$ = {$results$:[], $more$:!1}, $term$$1$$ = $query$$8$$.$term$, $children$$2$$, $process$$1$$;
      $process$$1$$ = function $$process$$1$$$($element$$74$$, $collection$$33$$) {
        ...
        if ($element$$74$$.is("option") || $element$$74$$.is("li") && !$nestedLi$$) {
          $query$$8$$.$matcher$($term$$1$$, $element$$74$$.text(), $element$$74$$) && $collection$$33$$.push($self$$74$$.$_optionToData$($element$$74$$));
        } else {
          if ($element$$74$$.is("optgroup") || $element$$74$$.is("li") && $nestedLi$$) {
            $group$$1$$ = $self$$74$$.$_optionToData$($element$$74$$), $_ComboUtils$$.$each2$($element$$74$$.is("optgroup") ? $element$$74$$.children() : $element$$74$$.children("ul").children(), function($i$$183$$, $elm$$1$$) {
      ...
      $_ComboUtils$$.$each2$($children$$2$$, function($i$$184$$, $elm$$2$$) {
        $process$$1$$($elm$$2$$, $data$$90$$.$results$);
      });
      $query$$8$$.$callback$($data$$90$$);
    }) : "options" in $opts$$14$$ && ($opts$$14$$.$query$ = $_ComboUtils$$.$local$($opts$$14$$.options, $opts$$14$$.optionsKeys ? $opts$$14$$.optionsKeys : null));
    return $opts$$14$$;
  }, $_triggerSelect$:function($data$$91_evt$$20$$) {
    $data$$91_evt$$20$$ = $$$$12$$.Event(this.$_elemNm$ + "-selecting", {val:this.id($data$$91_evt$$20$$), object:$data$$91_evt$$20$$});
    this.$opts$.element.trigger($data$$91_evt$$20$$);
    return!$data$$91_evt$$20$$.isDefaultPrevented();
    ...
    $event$$125$$ = $$$$12$$.Event(this.$_elemNm$ + "-opening");
    this.$opts$.element.trigger($event$$125$$);
    return!$event$$125$$.isDefaultPrevented();
  ...
  }, $_highlightUnderEvent$:function($el$$5_event$$127$$) {
    $el$$5_event$$127$$ = $$$$12$$($el$$5_event$$127$$.target).closest(".oj-listbox-result-selectable");
    if (0 < $el$$5_event$$127$$.length && !$el$$5_event$$127$$.is(".oj-hover")) {
      var $choices$$2$$ = this.$_findHighlightableChoices$();
      this.$_highlight$($choices$$2$$.index($el$$5_event$$127$$));
    } else {
      0 == $el$$5_event$$127$$.length && this.$_removeHighlight$();
    }
    ...
    $matcher$:$opts$$15$$.$matcher$, $callback$:this.$_bind$(function($data$$94_li$$) {
      $queryNumber$$ == this.$queryCount$ && this.$_opened$() && (this.context = $data$$94_li$$ && void 0 !== $data$$94_li$$.context ? $data$$94_li$$.context : null, $data$$94_li$$ && 0 !== $data$$94_li$$.$results$.length || !$_ComboUtils$$.$checkFormatter$($self$$75$$.$ojContext$, $opts$$15$$.$formatNoMatches$, "formatNoMatches") ? (this.$_preprocessResults$($results$$7$$), $self$$75$$.$opts$.$populateResults$.call(this, $results$$7$$, $data$$94_li$$.$results$, {$term$:$search$$2$$.val(), page:this.$resultsPage$, 
      context:null}, this.$_showPlaceholder$()), this.$_postprocessResults$($data$$94_li$$, $initial$$), $self$$75$$.$_positionDropdown$()) : "oj-select" == this.$_classNm$ && !0 !== this.$opts$.multiple ? ($data$$94_li$$ = $$$$12$$("\x3cli\x3e"), $data$$94_li$$.addClass("oj-listbox-no-results"), $data$$94_li$$.text($opts$$15$$.$formatNoMatches$($self$$75$$.$ojContext$, $search$$2$$.val())), this.$_preprocessResults$($results$$7$$), $results$$7$$.append($data$$94_li$$), $self$$75$$.$_positionDropdown$()) : 
      this.close());
    })}));
    ...
    for (var $i$$185$$ = 0;$i$$185$$ < $resultList$$1$$.length;$i$$185$$++) {
      $$$$12$$($resultList$$1$$[$i$$185$$]).is("LI") && (($$$$12$$($resultList$$1$$[$i$$185$$]).hasClass("oj-listbox-no-results") || $$$$12$$($resultList$$1$$[$i$$185$$]).hasClass("oj-listbox-placeholder")) && $$$$12$$($resultList$$1$$[$i$$185$$]).remove(), $$$$12$$($resultList$$1$$[$i$$185$$]).css("display", "none"), $$$$12$$($resultList$$1$$[$i$$185$$]).hasClass("oj-selected") && $$$$12$$($resultList$$1$$[$i$$185$$]).removeClass("oj-selected"));
      var $nested$$ = $$$$12$$($resultList$$1$$[$i$$185$$]).children("ul");
  ...
  }, $_selectHighlighted$:function($options$$267$$, $event$$129$$) {
    var $index$$134$$ = this.$_highlight$(), $data$$95$$ = this.$results$.find(".oj-hover").closest(".oj-listbox-result").data(this.$_elemNm$);
    $data$$95$$ ? (this.$_highlight$($index$$134$$), this.$_onSelect$($data$$95$$, $options$$267$$, $event$$129$$)) : $options$$267$$ && $options$$267$$.$noFocus$ && this.close($event$$129$$);
  ...
  }, $setVal$:function($val$$30$$, $event$$130$$) {
    "string" === typeof $val$$30$$ ? this.$ojContext$.$_SetValue$([$val$$30$$], $event$$130$$, {$doValueChangeCheck$:!1}) : this.$ojContext$.$_SetValue$($val$$30$$, $event$$130$$, {$doValueChangeCheck$:!1});
  ...
  }, $_clear$:function($event$$131$$) {
    this.selection.data(this.$_elemNm$) && ($event$$131$$ || $oj$$12$$.$Logger$.warn("Event should not be null when user modified the value in UI"), this.$setVal$([], $event$$131$$), this.search.val(""), this.selection.removeData(this.$_elemNm$));
  ...
  }, $_containerKeydownHandler$:function($e$$66$$) {
    if (this.$_isInterfaceEnabled$()) {
      if ($e$$66$$.which === $_ComboUtils$$.$KEY$.PAGE_UP || $e$$66$$.which === $_ComboUtils$$.$KEY$.PAGE_DOWN) {
        $_ComboUtils$$.$killEvent$($e$$66$$);
      } else {
        switch($e$$66$$.which) {
          case $_ComboUtils$$.$KEY$.UP:
          ;
          case $_ComboUtils$$.$KEY$.DOWN:
            this.$_opened$() ? this.$_moveHighlight$($e$$66$$.which === $_ComboUtils$$.$KEY$.UP ? -1 : 1) : this.open($e$$66$$);
            $_ComboUtils$$.$killEvent$($e$$66$$);
            return;
          case $_ComboUtils$$.$KEY$.ENTER:
            this.$_selectHighlighted$(null, $e$$66$$);
            $_ComboUtils$$.$killEvent$($e$$66$$);
            return;
        ...
        this.$_userTyping$ = !0;
        this.$_opened$() || this.open($e$$66$$);
      }
    }
  }, $_containerKeyupHandler$:function($e$$67$$) {
    this.$_isInterfaceEnabled$() && !this.$_opened$() && this.open($e$$67$$);
    ...
    $container$$6_selection$$1$$.on("mousedown", "abbr", this.$_bind$(function($e$$68$$) {
      this.$_isInterfaceEnabled$() && (this.$_clear$($e$$68$$), $_ComboUtils$$.$killEventImmediately$($e$$68$$), this.close($e$$68$$), this.selection.focus());
    }));
    $container$$6_selection$$1$$.on("mousedown", this.$_bind$(function($e$$69$$) {
      this.$opts$.element.prop("disabled") && $_ComboUtils$$.$killEvent$($e$$69$$);
      this.$_opened$() ? this.close($e$$69$$) : this.$_isInterfaceEnabled$() && this.open($e$$69$$);
      this.search.focus();
    }));
    $container$$6_selection$$1$$.on("focus", this.$_bind$(function($e$$70$$) {
      $_ComboUtils$$.$killEvent$($e$$70$$);
    }));
    this.search.on("blur keyup", this.$_bind$(function($e$$71_formatted$$1$$) {
      if ("keyup" !== $e$$71_formatted$$1$$.type || 10 === $e$$71_formatted$$1$$.keyCode || 13 === $e$$71_formatted$$1$$.keyCode) {
        if (void 0 !== this.search.val() && 0 >= this.$results$.find(".oj-hover").length) {
          if (this.$opts$.manageNewEntry) {
            if (!this.selection.data("ojcombobox") && "" !== this.search.val() || this.selection.data("ojcombobox") && this.selection.data("ojcombobox").label !== this.search.val()) {
              ...
              this.$_onSelect$($data$$97$$, null, $e$$71_formatted$$1$$);
            }
          } else {
            null == this.$opts$.manageNewEntry && ($data$$97$$ = this.selection.data(this.$_elemNm$), "" == this.search.val() ? this.$_clear$($e$$71_formatted$$1$$) : $data$$97$$ || "" === this.search.val() ? ($e$$71_formatted$$1$$ = this.$opts$.$formatSelection$($data$$97$$), void 0 !== $e$$71_formatted$$1$$ && this.search.val($e$$71_formatted$$1$$)) : this.$_clearSearch$());
          }
        }
    ...
    if ("input" === $tagName$$3$$ && $opts$$16$$.element.attr("list") || "select" === $tagName$$3$$ && 0 < $opts$$16$$.element.children().length || $opts$$16$$.list) {
      ...
      $opts$$16$$.$initSelection$ = function $$opts$$16$$$$initSelection$$($element$$76$$, $callback$$88$$) {
        var $selected$$1$$, $value$$176$$ = $self$$77$$.$getVal$();
        Array.isArray($value$$176$$) && ($value$$176$$ = $value$$176$$[0]);
        $selected$$1$$ = void 0 !== $value$$176$$ && null !== $value$$176$$ ? $self$$77$$.$_optionToData$($element$$76$$.find($eleName$$).filter(function() {
          if ("li" == $eleName$$) {
      ...
      $opts$$16$$.validate = function $$opts$$16$$$validate$($element$$77$$, $value$$177$$) {
        var $selected$$2$$;
        void 0 !== $value$$177$$ && null !== $value$$177$$ && ($selected$$2$$ = $self$$77$$.$_optionToData$($element$$77$$.find($eleName$$).filter(function() {
          if ("li" == $eleName$$) {
      ...
      if ("options" in $opts$$16$$ || this.$getVal$() && 0 < this.$getVal$().length) {
        $opts$$16$$.$initSelection$ = function $$opts$$16$$$$initSelection$$($element$$78$$, $callback$$89$$) {
          var $id$$23$$ = "";
        ...
        }, $opts$$16$$.validate = function $$opts$$16$$$validate$($element$$79$$, $value$$178$$) {
          var $match$$17$$ = null;
    ...
    return $opts$$16$$;
  }, $_postprocessResults$:function($data$$98_highlightableChoices$$, $initial$$1$$, $noHighlightUpdate$$) {
    var $selected$$3$$ = -1, $self$$78$$ = this;
    $data$$98_highlightableChoices$$ = this.$_findHighlightableChoices$();
    $_ComboUtils$$.$each2$($data$$98_highlightableChoices$$, function($i$$187$$, $elm$$3$$) {
      if ($self$$78$$.$getVal$() && $self$$78$$.$getVal$()[0] === $self$$78$$.id($elm$$3$$.data($self$$78$$.$_elemNm$))) {
        return $selected$$3$$ = $i$$187$$, !1;
      }
    });
    !1 !== $noHighlightUpdate$$ && !0 === $initial$$1$$ && 0 <= $selected$$3$$ && this.$_highlight$($selected$$3$$);
  }, $_onSelect$:function($data$$99$$, $options$$268$$, $event$$132$$) {
    this.$_triggerSelect$($data$$99$$) && (this.$getVal$() && this.$getVal$(), this.close($event$$132$$), this.$setVal$(0 === this.id($data$$99$$).length ? [] : this.id($data$$99$$), $event$$132$$), this.$_focusSearch$());
  }, $_shouldOpen$:function($e$$72$$) {
    return this.$_opened$() || !1 === this.$_enabled$ || !0 === this.$_readonly$ ? !1 : this.$ojContext$._trigger("beforeExpand", $e$$72$$, {component:this.$opts$.element});
  }, $_clearSearch$:function() {
    this.search.val("");
  ...
  }, close:function($event$$133$$) {
    this.$_opened$() && $_OjSingleCombobox$$.$superclass$.close.apply(this, arguments);
  }, $_opening$:function($event$$134$$) {
    $_OjSingleCombobox$$.$superclass$.$_opening$.apply(this, arguments);
    this.$_updateResults$(!0);
  }, $_containerKeydownHandler$:function($e$$73$$) {
    $_ComboUtils$$.$KEY$.$isControl$($e$$73$$) || $_ComboUtils$$.$KEY$.$isFunctionKey$($e$$73$$) || $_OjSingleCombobox$$.$superclass$.$_containerKeydownHandler$.apply(this, arguments);
  }, $_updateSelection$:function($data$$100_formatted$$2$$) {
    this.selection.data(this.$_elemNm$, $data$$100_formatted$$2$$);
    null !== $data$$100_formatted$$2$$ && 0 != $data$$100_formatted$$2$$.length ? ($data$$100_formatted$$2$$ = this.$opts$.$formatSelection$($data$$100_formatted$$2$$), void 0 !== $data$$100_formatted$$2$$ && this.search.val() !== $data$$100_formatted$$2$$ && this.search.val($data$$100_formatted$$2$$), this.search.removeClass(this.$_classNm$ + "-default")) : (this.search.val(""), this.$_setPlaceholder$());
    this.$opts$.$allowClear$ && this.$container$.addClass(this.$_classNm$ + "-allowclear");
  }, $_updateSelectedOption$:function($data$$101_selected$$4_value$$179$$) {
    if (void 0 === $data$$101_selected$$4_value$$179$$ || null === $data$$101_selected$$4_value$$179$$) {
      $data$$101_selected$$4_value$$179$$ = ($data$$101_selected$$4_value$$179$$ = this.$getVal$()) ? Array.isArray($data$$101_selected$$4_value$$179$$) ? Array.isArray($data$$101_selected$$4_value$$179$$) && $data$$101_selected$$4_value$$179$$.length ? {label:$data$$101_selected$$4_value$$179$$[0]} : null : {label:$data$$101_selected$$4_value$$179$$} : null;
    }
    this.$_updateSelection$($data$$101_selected$$4_value$$179$$);
  ...
  }, close:function($event$$135$$) {
    this.$_opened$() && ($_OjSingleSelect$$.$superclass$.close.apply(this, arguments), this.$container$.find(".oj-select-choice").attr("aria-expanded", !1), this.$_testClear$($event$$135$$) || this.$_clearSearch$(), $event$$135$$ instanceof MouseEvent && $event$$135$$.target != this.selection && $event$$135$$.target != this.search || $_ComboUtils$$.$_focus$(this.selection), this.$container$.find(".oj-listbox-spyglass-box").off("mouseup click"));
  }, $_opening$:function($event$$136$$) {
    ...
    var $searchText$$;
    $event$$136$$ && "keydown" == $event$$136$$.type && $event$$136$$.which != $_ComboUtils$$.$KEY$.UP && $event$$136$$.which != $_ComboUtils$$.$KEY$.DOWN && $event$$136$$.which != $_ComboUtils$$.$KEY$.LEFT && $event$$136$$.which != $_ComboUtils$$.$KEY$.RIGHT && ($searchText$$ = String.fromCharCode($event$$136$$.which), $_ComboUtils$$.$killEvent$($event$$136$$));
    ...
    var $self$$79$$ = this;
    this.selection.on("blur", function($e$$74$$) {
      $self$$79$$.$_testClear$($e$$74$$);
    });
  }, $_initSelection$:function() {
  ...
  }, $_updateSelection$:function($data$$102$$) {
    this.selection.data(this.$_elemNm$, $data$$102$$);
    null !== $data$$102$$ && this.text.text($data$$102$$.label);
    $data$$102$$ && "" != $data$$102$$.id && this.text.removeClass(this.$_classNm$ + "-default");
    this.$opts$.$allowClear$ && this.$container$.addClass(this.$_classNm$ + "-allowclear");
  }, $_getActiveContainer$:function() {
  ...
  }, $setVal$:function($val$$32$$, $event$$137$$) {
    $_OjSingleSelect$$.$superclass$.$setVal$.call(this, $val$$32$$, $event$$137$$);
    this.selection.data("selectVal", $val$$32$$);
  }, $_containerKeydownHandler$:function($e$$75$$) {
    if (!$_ComboUtils$$.$KEY$.$isControl$($e$$75$$) && !$_ComboUtils$$.$KEY$.$isFunctionKey$($e$$75$$)) {
      switch($e$$75$$.which) {
        case $_ComboUtils$$.$KEY$.TAB:
          this.close($e$$75$$);
          this.selection.focus();
          this.$_testClear$($e$$75$$);
          return;
        case $_ComboUtils$$.$KEY$.ENTER:
          if ($e$$75$$.target === this.selection[0] && !this.$_opened$()) {
            this.open($e$$75$$);
      ...
      if (!$hasSearchBoxAlready$$ && this.$_userTyping$) {
        var $c$$35$$;
        $e$$75$$.which != $_ComboUtils$$.$KEY$.LEFT && $e$$75$$.which != $_ComboUtils$$.$KEY$.RIGHT && ($c$$35$$ = String.fromCharCode($e$$75$$.which));
        this.$_showSearchBox$($c$$35$$);
        this.$_updateResults$();
        $_ComboUtils$$.$killEvent$($e$$75$$);
      }
    }
  }, $_testClear$:function($event$$138$$) {
    return "" == this.text.text() ? (this.$_clear$($event$$138$$), !0) : !1;
    ...
    if ($focusOnSearchBox$$) {
      var $self$$80$$ = this;
      $searchBox$$.find(".oj-listbox-spyglass-box").on("mouseup click", function($e$$76$$) {
    ...
    if ("input" === $tagName$$4$$ && $opts$$17$$.element.attr("list") || "select" === $tagName$$4$$ && 0 < $opts$$17$$.element.children().length || $opts$$17$$.list) {
      ...
      $opts$$17$$.$initSelection$ = function $$opts$$17$$$$initSelection$$($element$$80$$, $callback$$90$$) {
        var $data$$103$$ = [];
        if ($self$$81$$.$getVal$()) {
          for (var $selected$$6$$, $ids$$ = $self$$81$$.$getVal$(), $i$$188$$ = 0;$i$$188$$ < $ids$$.length;$i$$188$$++) {
            var $id$$25$$ = $ids$$[$i$$188$$];
            ($selected$$6$$ = $element$$80$$.find($eleName$$1$$).filter(function() {
              if ("option" === $eleName$$1$$) {
            ...
            })) && $selected$$6$$.length ? $data$$103$$.push($self$$81$$.$_optionToData$($selected$$6$$)) : $data$$103$$.push({value:$id$$25$$, label:$id$$25$$});
          }
        } else {
          "select" !== $tagName$$4$$ && ($selected$$6$$ = $element$$80$$.find($eleName$$1$$).filter(function() {
            if ("option" === $eleName$$1$$) {
              return this.selected;
            }
            if ("li" === $eleName$$1$$) {
          ...
          }), $_ComboUtils$$.$each2$($selected$$6$$, function($i$$189$$, $elm$$4$$) {
            $data$$103$$.push($self$$81$$.$_optionToData$($elm$$4$$));
          }));
        }
        $callback$$90$$($data$$103$$);
      };
    } else {
      "options" in $opts$$17$$ && ($opts$$17$$.$initSelection$ = $opts$$17$$.$initSelection$ || function($element$$81$$, $callback$$91$$) {
        ...
        $opts$$17$$.$query$({$matcher$:function($is_match$$2_term$$6$$, $text$$13$$, $el$$10$$) {
          ...
          for (var $ordered$$ = [], $i$$190$$ = 0;$i$$190$$ < $ids$$1$$.length;$i$$190$$++) {
            for (var $id$$27$$ = $ids$$1$$[$i$$190$$], $found$$4$$ = !1, $j$$25$$ = 0;$j$$25$$ < $matches$$3$$.length;$j$$25$$++) {
    ...
    this.$keydowns$ = 0;
    this.search.on("keydown", this.$_bind$(function($e$$78$$) {
      if (this.$_isInterfaceEnabled$()) {
        ++this.$keydowns$;
        ...
        if (!$selected$$8$$.length || $e$$78$$.which != $_ComboUtils$$.$KEY$.LEFT && $e$$78$$.which != $_ComboUtils$$.$KEY$.RIGHT && $e$$78$$.which != $_ComboUtils$$.$KEY$.$BACKSPACE$ && $e$$78$$.which != $_ComboUtils$$.$KEY$.$DELETE$ && $e$$78$$.which != $_ComboUtils$$.$KEY$.ENTER) {
          if (($e$$78$$.which !== $_ComboUtils$$.$KEY$.$BACKSPACE$ || 1 != this.$keydowns$) && $e$$78$$.which != $_ComboUtils$$.$KEY$.LEFT || 0 != $pos$$8_selectedChoice$$.offset || $pos$$8_selectedChoice$$.length) {
            ...
            if (this.$_opened$()) {
              switch($e$$78$$.which) {
                ...
                ;
                case $_ComboUtils$$.$KEY$.DOWN:
                  this.$_moveHighlight$($e$$78$$.which === $_ComboUtils$$.$KEY$.UP ? -1 : 1);
                  $_ComboUtils$$.$killEvent$($e$$78$$);
                  return;
                case $_ComboUtils$$.$KEY$.ENTER:
                  this.$_selectHighlighted$(null, $e$$78$$);
                  $_ComboUtils$$.$killEvent$($e$$78$$);
                  return;
                case $_ComboUtils$$.$KEY$.TAB:
                  this.close($e$$78$$);
            ...
            $e$$78$$.which === $_ComboUtils$$.$KEY$.TAB || $_ComboUtils$$.$KEY$.$isControl$($e$$78$$) || $_ComboUtils$$.$KEY$.$isFunctionKey$($e$$78$$) || $e$$78$$.which === $_ComboUtils$$.$KEY$.$ESC$ || $e$$78$$.which === $_ComboUtils$$.$KEY$.ENTER && this.search.val() && "ojcombobox" === this.$_elemNm$ || (this.open(), $e$$78$$.which !== $_ComboUtils$$.$KEY$.PAGE_UP && $e$$78$$.which !== $_ComboUtils$$.$KEY$.PAGE_DOWN || $_ComboUtils$$.$killEvent$($e$$78$$), $e$$78$$.which === $_ComboUtils$$.$KEY$.ENTER && 
            $_ComboUtils$$.$killEvent$($e$$78$$));
          } else {
            this.$_selectChoice$($selection$$2$$.find("." + this.$_classNm$ + "-selected-choice:not(." + this.$_classNm$ + "-locked)").last()), $_ComboUtils$$.$killEvent$($e$$78$$);
          }
        } else {
          $pos$$8_selectedChoice$$ = $selected$$8$$, $e$$78$$.which == $_ComboUtils$$.$KEY$.LEFT && $prev$$.length ? $pos$$8_selectedChoice$$ = $prev$$ : $e$$78$$.which == $_ComboUtils$$.$KEY$.RIGHT ? $pos$$8_selectedChoice$$ = $next$$.length ? $next$$ : null : $e$$78$$.which === $_ComboUtils$$.$KEY$.$BACKSPACE$ ? (this.$_unselect$($selected$$8$$.first(), $e$$78$$), this.search.width(10), $pos$$8_selectedChoice$$ = $prev$$.length ? $prev$$ : $next$$) : $e$$78$$.which == $_ComboUtils$$.$KEY$.$DELETE$ ? 
          (this.$_unselect$($selected$$8$$.first(), $e$$78$$), this.search.width(10), $pos$$8_selectedChoice$$ = $next$$.length ? $next$$ : null) : $e$$78$$.which == $_ComboUtils$$.$KEY$.ENTER && ($pos$$8_selectedChoice$$ = null), this.$_selectChoice$($pos$$8_selectedChoice$$), $_ComboUtils$$.$killEvent$($e$$78$$), $pos$$8_selectedChoice$$ && $pos$$8_selectedChoice$$.length || this.open();
        }
      }
    }));
    ...
    this.search.on("blur keyup", this.$_bind$(function($e$$80$$) {
      if ("keyup" !== $e$$80$$.type || 10 === $e$$80$$.keyCode || 13 === $e$$80$$.keyCode) {
        if (this.$opts$.manageNewEntry && this.search.val() && 0 >= this.$results$.find(".oj-hover").length) {
          var $data$$104$$ = this.$opts$.manageNewEntry(this.search.val());
          this.$_onSelect$($data$$104$$, null, $e$$80$$);
        }
        this.search.removeClass(this.$_classNm$ + "-focused");
        this.$_selectChoice$(null);
        this.$_opened$() || this.$_clearSearch$();
        $e$$80$$.stopImmediatePropagation();
      }
    }));
    this.$container$.on("click", $selector$$18$$, this.$_bind$(function($e$$81$$) {
      !this.$_isInterfaceEnabled$() || 0 < $$$$12$$($e$$81$$.target).closest("." + this.$_classNm$ + "-selected-choice").length || (this.$_selectChoice$(null), this.$_opened$() ? this.close($e$$81$$) : (this.open(), this.$_focusSearch$()), $e$$81$$.preventDefault());
    }));
    ...
    if (this.$datalist$ || null !== this.$getVal$() && this.$getVal$().length) {
      var $self$$82$$ = this;
      this.$opts$.$initSelection$.call(null, this.$datalist$ ? this.$datalist$ : this.$opts$.element, function($data$$106$$) {
        void 0 !== $data$$106$$ && null !== $data$$106$$ && 0 !== $data$$106$$.length && ($self$$82$$.$_updateSelection$($data$$106$$), $self$$82$$.close(), $self$$82$$.$_clearSearch$());
      });
    }
  }, $_clearSearch$:function() {
    ...
    this.$ojContext$._trigger("beforeExpand", $event$$139$$) && (this.$_resizeSearch$(), $_AbstractMultiChoice$$.$superclass$.$_opening$.apply(this, arguments), this.$_focusSearch$(), this.$_updateResults$(!0), this.search.focus());
  }, close:function($event$$140$$) {
    this.$_opened$() && $_AbstractMultiChoice$$.$superclass$.close.apply(this, arguments);
  }, $_focus$:function() {
    this.close();
    this.search.focus();
  }, $_updateSelection$:function($data$$107$$) {
    var $ids$$2$$ = [], $filtered$$1$$ = [], $self$$83$$ = this;
    $$$$12$$($data$$107$$).each(function() {
    ...
    this.$opts$.element.val(0 === $data$$107$$.length ? "" : $data$$107$$.join(this.$opts$.separator));
    $self$$83$$.$_postprocessResults$();
  }, $_onSelect$:function($data$$108$$, $options$$269$$, $event$$141$$) {
    if (this.$_triggerSelect$($data$$108$$)) {
      var $id$$28$$ = this.id($data$$108$$), $val$$33$$ = this.$getVal$() ? this.$getVal$().slice(0) : [];
      this.$ojContext$.isValid() || ($val$$33$$ = $_ComboUtils$$.$splitVal$(this.$opts$.element.val(), this.$opts$.separator));
      $$$$12$$($data$$108$$).each(function() {
        0 > $val$$33$$.indexOf($id$$28$$) && $val$$33$$.push($id$$28$$);
      });
      this.$setVal$($val$$33$$, $event$$141$$);
      !this.select && this.$opts$.$closeOnSelect$ || this.$_postprocessResults$($data$$108$$, !1, !0 === this.$opts$.$closeOnSelect$);
      this.$opts$.$closeOnSelect$ && (this.close($event$$141$$), this.search.width(10));
      $options$$269$$ && $options$$269$$.$noFocus$ || this.$_focusSearch$();
    }
  }, $_cancel$:function($event$$142$$) {
    this.close($event$$142$$);
    this.$_focusSearch$();
  }, $_addSelectedChoice$:function($data$$109$$) {
    var $enableChoice$$ = !$data$$109$$.locked, $choice$$3_enabledItem$$ = $$$$12$$("\x3cli class\x3d'" + this.$_classNm$ + "-selected-choice'\x3e    \x3cdiv\x3e\x3c/div\x3e    \x3ca href\x3d'#' onclick\x3d'return false;' class\x3d'" + this.$_classNm$ + "-clear-entry       oj-component-icon oj-clickable-icon-nocontext " + this.$_classNm$ + "-clear-entry-icon' tabindex\x3d'-1'\x3e    \x3c/a\x3e\x3c/li\x3e"), $disabledItem_formatted$$3$$ = $$$$12$$("\x3cli class\x3d'" + this.$_classNm$ + "-selected-choice " + 
    ...
    this.id($data$$109$$);
    $disabledItem_formatted$$3$$ = this.$opts$.$formatSelection$($data$$109$$);
    ...
    if ($enableChoice$$) {
      $choice$$3_enabledItem$$.find("." + this.$_classNm$ + "-clear-entry").on("mousedown", $_ComboUtils$$.$killEvent$).on("click dblclick", this.$_bind$(function($e$$82$$) {
        this.$_isInterfaceEnabled$() && ($$$$12$$($e$$82$$.target).closest("." + this.$_classNm$ + "-selected-choice").fadeOut("fast", this.$_bind$(function() {
          this.$_unselect$($$$$12$$($e$$82$$.target), $e$$82$$);
          this.selection.find("." + this.$_classNm$ + "-selected-choice.oj-focus").removeClass("oj-focus");
          this.close($e$$82$$);
          this.$_focusSearch$();
        })).dequeue(), $_ComboUtils$$.$killEvent$($e$$82$$));
      }));
    }
    $choice$$3_enabledItem$$.data(this.$_elemNm$, $data$$109$$);
    $choice$$3_enabledItem$$.insertBefore(this.$searchContainer$);
  }, $_unselect$:function($selected$$9$$, $event$$143$$) {
    var $val$$34$$ = this.$getVal$() ? this.$getVal$().slice(0) : [], $data$$110$$, $index$$135$$;
    ...
    if ($data$$110$$ = $selected$$9$$.data(this.$_elemNm$)) {
      for (this.$ojContext$.isValid() || ($val$$34$$ = $_ComboUtils$$.$splitVal$(this.$opts$.element.val(), this.$opts$.separator));0 <= ($index$$135$$ = $val$$34$$.indexOf(this.id($data$$110$$)));) {
        $val$$34$$.splice($index$$135$$, 1), this.$setVal$($val$$34$$, $event$$143$$), this.select && this.$_postprocessResults$();
      }
      $selected$$9$$.remove();
    }
  }, $_postprocessResults$:function() {
    var $val$$35$$ = this.$getVal$() && (this.$opts$.element.val() || this.$ojContext$.isValid()) ? this.$getVal$() : [], $choices$$3$$ = this.$results$.find(".oj-listbox-result"), $compound$$ = this.$results$.find(".oj-listbox-result-with-children"), $self$$84$$ = this;
    $_ComboUtils$$.$each2$($choices$$3$$, function($i$$191$$, $choice$$4$$) {
      var $id$$30$$ = $self$$84$$.id($choice$$4$$.data($self$$84$$.$_elemNm$));
      $val$$35$$ && 0 <= $val$$35$$.indexOf($id$$30$$) && ($choice$$4$$.addClass("oj-selected"), $choice$$4$$.find(".oj-listbox-result-selectable").addClass("oj-selected"));
    });
    $_ComboUtils$$.$each2$($compound$$, function($i$$192$$, $choice$$5$$) {
  ...
  }, $setVal$:function($val$$36$$, $event$$144$$) {
    var $unique$$;
    $unique$$ = [];
    "string" === typeof $val$$36$$ && ($val$$36$$ = $_ComboUtils$$.$splitVal$($val$$36$$, this.$opts$.separator));
    for (var $i$$193$$ = 0;$i$$193$$ < $val$$36$$.length;$i$$193$$++) {
      0 > $unique$$.indexOf($val$$36$$[$i$$193$$]) && $unique$$.push($val$$36$$[$i$$193$$]);
    }
    this.$ojContext$.$_SetValue$($unique$$, $event$$144$$, {$doValueChangeCheck$:!1});
  ...
  $oj$$12$$.$__registerWidget$("oj.ojCombobox", $$$$12$$.oj.editableValue, {defaultElement:"\x3cinput\x3e", widgetEventPrefix:"oj", options:{converter:void 0, placeholder:void 0, list:void 0, multiple:!1, options:null, optionsKeys:null, beforeExpand:null}, widget:function() {
  ...
  }, _setOption:function($key$$71$$, $value$$182$$, $flags$$16$$) {
    ...
    this._super($key$$71$$, $value$$182$$, $flags$$16$$);
    ...
    if (Array.isArray($submittedValue$$2$$)) {
      for (var $i$$194$$ = 0;$i$$194$$ < $submittedValue$$2$$.length;$i$$194$$++) {
        var $parsed$$2$$ = this._super($submittedValue$$2$$[$i$$194$$]);
    ...
    if (this.$combobox$ && this.$combobox$.$_opened$()) {
      for (var $dropdown$$4$$ = $$$$12$$(".oj-listbox-drop"), $i$$195$$ = 0;$i$$195$$ < $dropdown$$4$$.length;$i$$195$$++) {
        if ("oj-listbox-drop" == $$$$12$$($dropdown$$4$$[$i$$195$$]).attr("id") && $$$$12$$($dropdown$$4$$[$i$$195$$]).attr("data-oj-containerid") == this.$combobox$.$containerId$) {
          return $$$$12$$($dropdown$$4$$[$i$$195$$]);
        }
      }
    }
    return null;
  ...
  }, _setOption:function($key$$72$$, $value$$186$$, $flags$$17$$) {
    if ("value" === $key$$72$$) {
      if (this.$_HasPlaceholderSet$() && $value$$186$$ && 0 == $value$$186$$.length) {
        this._super($key$$72$$, $value$$186$$, $flags$$17$$);
      } else {
        var $strVal$$ = $value$$186$$;
        Array.isArray($value$$186$$) && ($value$$186$$ = $value$$186$$.slice(0), !0 !== this.options.multiple && ($strVal$$ = $value$$186$$[0]));
        var $element$$83$$ = this.select.$datalist$;
        $element$$83$$ || ($element$$83$$ = this.select.$opts$.element);
        (!0 !== this.options.multiple && this.select.$opts$.validate($element$$83$$, $strVal$$) || this.options.multiple) && this._super($key$$72$$, $value$$186$$, $flags$$17$$);
      }
    } else {
      "placeholder" === $key$$72$$ ? (this.select.$opts$.placeholder = $value$$186$$, this.select.$_setPlaceholder$()) : "minimumResultsForSearch" === $key$$72$$ && (this.select.$opts$.minimumResultsForSearch = $value$$186$$), this._super($key$$72$$, $value$$186$$, $flags$$17$$), "disabled" === $key$$72$$ ? $value$$186$$ ? this.select.$_disable$() : this.select.$_enable$() : "options" === $key$$72$$ && (this.select.$opts$.options = $value$$186$$, this.select.$opts$ = this.select.$_prepareOpts$(this.select.$opts$), 
