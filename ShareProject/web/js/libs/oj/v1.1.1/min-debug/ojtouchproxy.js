...
define(["ojs/ojcore", "jquery"], function($oj$$22$$, $$$$21$$) {
  ...
  $oj$$22$$.$_TouchProxy$.prototype.$_touchHandler$ = function $$oj$$22$$$$_TouchProxy$$$$_touchHandler$$($event$$289$$, $simulatedType$$) {
    if (!(1 < $event$$289$$.originalEvent.touches.length)) {
      "touchstart" != $event$$289$$.type && "touchend" != $event$$289$$.type && $event$$289$$.preventDefault();
      var $touch$$ = $event$$289$$.originalEvent.changedTouches[0], $simulatedEvent$$ = document.createEvent("MouseEvent");
  ...
  $oj$$22$$.$_TouchProxy$.prototype.$_touchStart$ = function $$oj$$22$$$$_TouchProxy$$$$_touchStart$$($event$$290$$) {
    this.$_touchHandled$ || (this.$_touchHandled$ = !0, this.$_touchMoved$ = !1, this.$_touchHandler$($event$$290$$, "mouseover"), this.$_touchHandler$($event$$290$$, "mousemove"), this.$_touchHandler$($event$$290$$, "mousedown"));
  };
  $oj$$22$$.$_TouchProxy$.prototype.$_touchMove$ = function $$oj$$22$$$$_TouchProxy$$$$_touchMove$$($event$$291$$) {
    this.$_touchHandled$ && (this.$_touchMoved$ = !0, this.$_touchHandler$($event$$291$$, "mousemove"));
  };
  $oj$$22$$.$_TouchProxy$.prototype.$_touchEnd$ = function $$oj$$22$$$$_TouchProxy$$$$_touchEnd$$($event$$292$$) {
    this.$_touchHandled$ && (this.$_touchHandler$($event$$292$$, "mouseup"), this.$_touchHandler$($event$$292$$, "mouseout"), this.$_touchMoved$ || "touchend" != $event$$292$$.type || this.$_touchHandler$($event$$292$$, "click"), this.$_touchHandled$ = !1);
  };
