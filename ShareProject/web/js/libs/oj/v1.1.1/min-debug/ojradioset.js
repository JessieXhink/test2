...
define(["ojs/ojcore", "jquery", "ojs/ojeditablevalue", "ojs/ojradiocheckbox"], function($oj$$52$$, $$$$49$$) {
  (function() {
    $oj$$52$$.$__registerWidget$("oj.ojRadioset", $$$$49$$.oj.editableValue, {version:"1.0.0", defaultElement:"\x3cdiv\x3e", widgetEventPrefix:"oj", options:{disabled:!1, value:void 0}, refresh:function() {
      ...
      var $element$$117$$ = this.element;
      this._super();
      if ($element$$117$$.is("fieldset")) {
        throw Error("ojRadioset cannot be bound to a fieldset. Use a div instead.");
      }
      this.$$radios$._ojRadioCheckbox();
      this.$uiRadioset$ = $element$$117$$.addClass("oj-radioset oj-component").attr("role", "radiogroup");
      ...
      var $allradios_element$$118$$ = this.element, $first$$10_name$$112$$ = $allradios_element$$118$$.find("input[type\x3dradio]:first");
      ...
      return void 0 === $first$$10_name$$112$$ ? ($allradios_element$$118$$ = $allradios_element$$118$$.find("input[type\x3dradio]"), $allradios_element$$118$$.not("[name]")) : $allradios_element$$118$$.find("input[type\x3dradio][name\x3d" + $first$$10_name$$112$$ + "]");
    }, $_NotifyContextMenuGesture$:function($launcher$$14_menu$$27_radios$$, $event$$565$$, $eventType$$55$$) {
      ...
      this.$_OpenContextMenu$($event$$565$$, $eventType$$55$$, {launcher:$launcher$$14_menu$$27_radios$$});
    }, $_setup$:function() {
      this.$_propagateDisabled$(this.options.disabled);
    }, $_events$:{change:function($event$$566$$) {
      this.$_HandleChangeEvent$($event$$566$$);
    }}, $_HandleChangeEvent$:function($event$$567$$) {
      var $submittedValue$$4$$ = this.$_GetDisplayValue$();
      this.$_SetValue$($submittedValue$$4$$, $event$$567$$, $_sValueChangeCheckFalse$$1$$);
      ...
      var $node$$112$$ = this._super($locator$$54_subId$$51$$);
      $node$$112$$ || ($locator$$54_subId$$51$$ = $locator$$54_subId$$51$$.subId, "oj-radioset-inputs" === $locator$$54_subId$$51$$ && ($node$$112$$ = this.$$radios$.get()));
