...
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore", "ojs/ojdvt-base", "ojs/internal-deps/dvt/DvtTimeline"], function($oj$$39$$, $$$$38$$, $comp$$12$$, $base$$9$$, $dvt$$6$$) {
  $oj$$39$$.$__registerWidget$("oj.ojTimeline", $$$$38$$.oj.dvtBaseComponent, {widgetEventPrefix:"oj", options:{viewportChange:null}, $_CreateDvtComponent$:function($context$$105$$, $callback$$114$$, $callbackObj$$8$$) {
    return $dvt$$6$$.DvtTimeline.newInstance($context$$105$$, $callback$$114$$, $callbackObj$$8$$);
  }, $_ConvertLocatorToSubId$:function($locator$$39$$) {
    var $subId$$37$$ = $locator$$39$$.subId;
    "oj-timeline-item" == $subId$$37$$ && ($subId$$37$$ = "timelineItem[" + $locator$$39$$.seriesIndex + "][" + $locator$$39$$.itemIndex + "]");
    return $subId$$37$$;
  }, $_ConvertSubIdToLocator$:function($indexPath$$2_subId$$38$$) {
    var $locator$$40$$ = {};
    0 == $indexPath$$2_subId$$38$$.indexOf("timelineItem") && ($indexPath$$2_subId$$38$$ = this.$_GetIndexPath$($indexPath$$2_subId$$38$$), $locator$$40$$.subId = "oj-timeline-item", $locator$$40$$.seriesIndex = $indexPath$$2_subId$$38$$[0], $locator$$40$$.itemIndex = $indexPath$$2_subId$$38$$[1]);
    return $locator$$40$$;
    ...
    return $ret$$46$$;
  }, $_HandleEvent$:function($event$$504_minorAxisScale$$) {
    var $type$$93_viewportStart$$ = $event$$504_minorAxisScale$$ && $event$$504_minorAxisScale$$.getType ? $event$$504_minorAxisScale$$.getType() : null;
    if ($type$$93_viewportStart$$ === $dvt$$6$$.DvtSelectionEvent.TYPE) {
      this.$_UserOptionChange$("selection", $event$$504_minorAxisScale$$.getSelection());
    } else {
      if ($type$$93_viewportStart$$ === $dvt$$6$$.DvtTimelineViewportChangeEvent.TYPE) {
        var $type$$93_viewportStart$$ = (new Date($event$$504_minorAxisScale$$.getViewportStart())).toISOString(), $viewportEnd$$ = (new Date($event$$504_minorAxisScale$$.getViewportEnd())).toISOString();
        $event$$504_minorAxisScale$$ = $event$$504_minorAxisScale$$.getMinorAxisScale();
        var $viewportChangePayload$$ = {viewportStart:$type$$93_viewportStart$$, viewportEnd:$viewportEnd$$, minorAxisScale:$event$$504_minorAxisScale$$};
        this.$_UserOptionChange$("viewportStart", $type$$93_viewportStart$$);
        this.$_UserOptionChange$("viewportEnd", $viewportEnd$$);
        this.$_UserOptionChange$("minorAxis.scale", $event$$504_minorAxisScale$$);
        this._trigger("viewportChange", null, $viewportChangePayload$$);
      } else {
        this._super($event$$504_minorAxisScale$$);
      }
    }
