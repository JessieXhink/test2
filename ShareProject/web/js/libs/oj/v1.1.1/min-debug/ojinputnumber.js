...
define(["ojs/ojcore", "jquery", "ojs/ojeditablevalue", "ojs/ojbutton"], function($oj$$48$$, $$$$47$$) {
  $oj$$48$$.$__registerWidget$("oj.ojInputNumber", $$$$47$$.oj.editableValue, {version:"1.0.0", defaultElement:"\x3cinput\x3e", widgetEventPrefix:"oj", options:{converter:$oj$$48$$.$Validation$.$converterFactory$($oj$$48$$.$ConverterFactory$.CONVERTER_TYPE_NUMBER).createConverter(), max:null, min:null, placeholder:void 0, readOnly:!1, step:1, value:null}, getNodeBySubId:function($locator$$51$$) {
    var $node$$108$$ = this._superApply(arguments), $subId$$48$$;
    $node$$108$$ || ($subId$$48$$ = $locator$$51$$.subId, "oj-inputnumber-up" === $subId$$48$$ && ($node$$108$$ = this.widget().find(".oj-inputnumber-up")[0]), "oj-inputnumber-down" === $subId$$48$$ && ($node$$108$$ = this.widget().find(".oj-inputnumber-down")[0]), "oj-inputnumber-input" === $subId$$48$$ && ($node$$108$$ = this.widget().find(".oj-inputnumber-input")[0]));
    ...
    var $opts$$40$$ = this.options, $self$$187$$ = this;
    ...
    {$attribute$:"max", $defaultOptionValue$:null}, {$attribute$:"step", $defaultOptionValue$:1}], $constructorOptions$$16$$, this, function($initializedOptions$$2$$) {
      for (var $toParse$$1$$ = ["value", "step", "min", "max"], $i$$430$$ = 0;$i$$430$$ < $toParse$$1$$.length;$i$$430$$++) {
        var $opt$$21$$ = $toParse$$1$$[$i$$430$$], $value$$260$$ = $opt$$21$$ in $initializedOptions$$2$$ ? $initializedOptions$$2$$[$opt$$21$$] : $opts$$40$$[$opt$$21$$];
        null != $value$$260$$ && ($initializedOptions$$2$$[$opt$$21$$] = "step" === $opt$$21$$ ? $self$$187$$.$_parseStep$($value$$260$$) : $self$$187$$.$_parse$($opt$$21$$, $value$$260$$));
      }
    });
    ...
    var $node$$109$$ = this.element;
    this._super();
    this.$_draw$();
    $node$$109$$.removeAttr("pattern");
    this.$_inputNumberDefaultValidators$ = {};
    this.$_setup$();
    this._on(this.$_events$);
  }, $_AfterSetOption$:function($option$$31$$, $previous$$1$$, $flags$$42$$) {
    this._superApply(arguments);
    switch($option$$31$$) {
      case "min":
      ;
  ...
  }, _setOption:function($key$$170$$, $value$$261$$, $flags$$43$$) {
    var $coercedValue$$1$$;
    ...
    this._super($key$$170$$, $coercedValue$$1$$, $flags$$43$$);
  ...
  }, $_events$:{keydown:function($event$$547$$) {
    $event$$547$$.keyCode === $$$$47$$.ui.keyCode.ENTER ? (this.$_blurEnterSetValue$($event$$547$$), $event$$547$$.preventDefault()) : this.$_start$() && this.$_keydown$($event$$547$$) && $event$$547$$.preventDefault();
  }, keyup:function($event$$548$$) {
    this.$_stop$($event$$548$$);
  }, focus:function() {
    this.$previous$ = this.element.val();
  }, blur:function($event$$549$$) {
    this.$cancelBlur$ ? delete this.$cancelBlur$ : this.$_blurEnterSetValue$($event$$549$$);
  }, "mousedown .oj-inputnumber-button":function($event$$550$$) {
    ...
    this.$_start$();
    this.$_repeat$(null, $$$$47$$($event$$550$$.currentTarget).hasClass("oj-inputnumber-up") ? 1 : -1, $event$$550$$);
  }, "mouseup .oj-inputnumber-button":function($event$$551$$) {
    this.$_stop$($event$$551$$);
  }, "mouseenter .oj-inputnumber-button":function($event$$552$$) {
    $$$$47$$($event$$552$$.currentTarget).hasClass("oj-active") && (this.$_start$(), this.$_repeat$(null, $$$$47$$($event$$552$$.currentTarget).hasClass("oj-inputnumber-up") ? 1 : -1, $event$$552$$));
  }, "mouseleave .oj-inputnumber-button":function($event$$553$$) {
    this.$_stop$($event$$553$$);
    ...
    var $element$$115$$ = this.element, $uiInputNumber$$ = this.$uiInputNumber$ = $element$$115$$.addClass("oj-inputnumber-input").wrap("\x3cspan class\x3d'oj-inputnumber-wrapper'\x3e\x3c/span\x3e").parent().append("\x3ca class\x3d'oj-inputnumber-button oj-inputnumber-down'\x3e\x3c/a\x3e\x3ca class\x3d'oj-inputnumber-button oj-inputnumber-up'\x3e\x3c/a\x3e").wrap("\x3cdiv class\x3d'oj-inputnumber oj-component'\x3e\x3c/div\x3e").parent();
    this.saveType = $element$$115$$.prop("type");
    $element$$115$$.attr("type", "text");
    $uiInputNumber$$.find(".oj-inputnumber-button").attr("tabIndex", "-1").attr("aria-hidden", !0);
    this.$_createOjButton$();
  }, $_keydown$:function($event$$554$$) {
    var $keyCode$$20$$ = $$$$47$$.ui.keyCode;
    switch($event$$554$$.keyCode) {
      case $keyCode$$20$$.UP:
        return this.$_repeat$(null, 1, $event$$554$$), !0;
  ...
  }, $_repeat$:function($i$$431$$, $steps$$2$$, $event$$555$$) {
    $i$$431$$ = $i$$431$$ || 500;
    clearTimeout(this.$timer$);
    this.$timer$ = this._delay(function() {
      this.$_repeat$(40, $steps$$2$$, $event$$555$$);
    }, $i$$431$$);
    this.$_spin$($steps$$2$$ * this.options.step, $event$$555$$);
  }, $_spin$:function($step$$2$$, $event$$556$$) {
    var $value$$263$$ = this.$_getConvertedDisplayValue$(), $value$$263$$ = this.$_adjustValue$($value$$263$$, $step$$2$$);
    this.$_SetValue$($value$$263$$, $event$$556$$, this.$_VALIDATION_MODE$.$VALIDATORS_ONLY$);
  }, $_precision$:function() {
    ...
    var $aboveMin_newValue$$15$$, $stepBase$$, $options$$373_precision$$2$$ = this.options, $minOpt$$1_validMax$$ = $options$$373_precision$$2$$.min, $stepOpt$$ = $options$$373_precision$$2$$.step, $maxOpt$$ = $options$$373_precision$$2$$.max, $options$$373_precision$$2$$ = this.$_precision$();
    $stepBase$$ = null != $minOpt$$1_validMax$$ ? $minOpt$$1_validMax$$ : 0;
    $aboveMin_newValue$$15$$ = $value$$264$$ - $stepBase$$;
    var $rounded$$1$$ = Math.round($aboveMin_newValue$$15$$ / $stepOpt$$) * $stepOpt$$, $rounded$$1$$ = parseFloat($rounded$$1$$.toFixed($options$$373_precision$$2$$));
    $rounded$$1$$ !== $aboveMin_newValue$$15$$ ? ($aboveMin_newValue$$15$$ = 0 > $step$$3$$ ? Math.ceil($aboveMin_newValue$$15$$ / $stepOpt$$) * $stepOpt$$ : Math.floor($aboveMin_newValue$$15$$ / $stepOpt$$) * $stepOpt$$, $aboveMin_newValue$$15$$ = $stepBase$$ + $aboveMin_newValue$$15$$ + $step$$3$$) : $aboveMin_newValue$$15$$ = $value$$264$$ + $step$$3$$;
    $aboveMin_newValue$$15$$ = parseFloat($aboveMin_newValue$$15$$.toFixed($options$$373_precision$$2$$));
    return null != $minOpt$$1_validMax$$ && $aboveMin_newValue$$15$$ < $minOpt$$1_validMax$$ ? $minOpt$$1_validMax$$ : null != $maxOpt$$ && $aboveMin_newValue$$15$$ > $maxOpt$$ ? ($minOpt$$1_validMax$$ = Math.floor(($maxOpt$$ - $stepBase$$) / $stepOpt$$) * $stepOpt$$ + $stepBase$$, $minOpt$$1_validMax$$ = parseFloat($minOpt$$1_validMax$$.toFixed($options$$373_precision$$2$$))) : $aboveMin_newValue$$15$$;
  }, $_stop$:function() {
  ...
  }, $_parse$:function($option$$32$$, $val$$73$$) {
    var $returnValue$$3$$;
    $returnValue$$3$$ = null !== $val$$73$$ ? +$val$$73$$ : $val$$73$$;
    ...
    var $element$$116$$ = this.element, $valuetext$$ = $element$$116$$.val();
    $element$$116$$.attr({"aria-valuemin":this.options.min, "aria-valuemax":this.options.max, "aria-valuenow":$valuenow$$4$$});
    this.$_CompareOptionValues$("value", "" + $valuenow$$4$$, $valuetext$$) || $element$$116$$.attr({"aria-valuetext":$valuetext$$});
