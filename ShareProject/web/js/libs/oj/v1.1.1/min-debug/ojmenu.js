...
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore", "ojs/ojpopupcore"], function($oj$$29$$, $$$$28$$) {
  (function() {
    $oj$$29$$.$__registerWidget$("oj.ojMenu", $$$$28$$.oj.baseComponent, {defaultElement:"\x3cul\x3e", delay:300, role:"menu", widgetEventPrefix:"oj", options:{menuSelector:"ul", openOptions:{initialFocus:"menu", launcher:null, position:{my:"start top", at:"start bottom"}}, submenuOpenOptions:{position:{my:"start top", at:"end top"}}, beforeOpen:null, select:null}, _ComponentCreate:function() {
      ...
      this._on(!0, {"mousedown .oj-menu-item":function($event$$363$$) {
        this.options.disabled && $event$$363$$.preventDefault();
      }, click:function($event$$364$$) {
        this.options.disabled && $event$$364$$.preventDefault();
      }, keydown:function($event$$365$$) {
        !this.options.disabled || $event$$365$$.keyCode !== $$$$28$$.ui.keyCode.ESCAPE && $event$$365$$.keyCode !== $$$$28$$.ui.keyCode.TAB || ($event$$365$$.keyCode === $$$$28$$.ui.keyCode.TAB && $event$$365$$.preventDefault(), this.$_launcher$ && this.$_focusLauncherAndDismiss$($event$$365$$));
      }});
      this.options.disabled && this.element.addClass("oj-disabled").attr("aria-disabled", "true");
      var $handleMouseEnterMenuItem$$ = function($event$$366$$) {
        var $target$$88$$ = $$$$28$$($event$$366$$.currentTarget);
        $target$$88$$.siblings().children(".oj-focus-ancestor").removeClass("oj-focus-ancestor");
        this.$_focus$($event$$366$$, $target$$88$$);
      }.bind(this);
      this._on({"mousedown .oj-menu-item \x3e a":function($event$$367$$) {
        $event$$367$$.preventDefault();
      }, "click .oj-disabled \x3e a":function($event$$368$$) {
        $event$$368$$.preventDefault();
      }, click:function() {
        this.$mouseHandled$ = !1;
      }, touchstart:function() {
        this.$touchHandled$ = !1;
      }, "click .oj-menu-item:has(a)":function($event$$371$$) {
        var $target$$89$$ = $$$$28$$($event$$371$$.target).closest(".oj-menu-item");
        !this.$mouseHandled$ && $target$$89$$.not(".oj-disabled").length && (this.$mouseHandled$ = !0, $event$$371$$.preventDefault(), this.$active$ && this.$active$.closest($target$$89$$).length && this.$active$.get(0) != $target$$89$$.get(0) || ($target$$89$$.has(".oj-menu").length ? this.$_expand$($event$$371$$) : (this.$_select$($event$$371$$), this.element.is(":focus") || (this.element.trigger("focus", [!0]), this.$active$ && 1 === this.$active$.parents(".oj-menu").length && clearTimeout(this.$timer$)))));
      }, "mouseenter .oj-menu-item":$handleMouseEnterMenuItem$$, "touchstart .oj-menu-item":function($event$$372$$) {
        this.$touchHandled$ || (this.$touchHandled$ = !0, $handleMouseEnterMenuItem$$($event$$372$$));
      }, mouseleave:function($event$$373$$) {
        this.$_collapse$($event$$373$$, "eventSubtree");
      }, "mouseleave .oj-menu":function($event$$374$$) {
        this.$_collapse$($event$$374$$, "eventSubtree");
      }, focus:function($event$$375$$, $keepActiveItem$$) {
        if (!$keepActiveItem$$) {
          var $item$$89$$ = this.$active$ || this.element.children(".oj-menu-item").eq(0);
          this.$_focus$($event$$375$$, $item$$89$$);
        }
      }, keydown:this.$_keydown$, keyup:function($event$$376$$) {
        if ($event$$376$$.keyCode == $$$$28$$.ui.keyCode.ENTER || $event$$376$$.keyCode == $$$$28$$.ui.keyCode.SPACE) {
          this.$__spaceEnterDownInMenu$ = !1;
        }
      }});
      this.$_usingCallback$ = $$$$28$$.proxy(this.$_usingHandler$, this);
      this.$_setup$();
    }, $__contextMenuPressHoldJustEnded$:function($val$$48$$) {
      if (arguments.length) {
        $_contextMenuPressHoldJustEnded$$ = $val$$48$$;
      } else {
        return $_contextMenuPressHoldJustEnded$$;
      }
    }, $_clickAwayHandler$:function($event$$377$$) {
      if (("focus" === $event$$377$$.type || "mousedown" === $event$$377$$.type || "touchstart" === $event$$377$$.type || 93 == $event$$377$$.which || 121 == $event$$377$$.which && $event$$377$$.shiftKey || 93 == $event$$377$$.keyCode) && ("mousedown" !== $event$$377$$.type || !$_contextMenuPressHoldJustEnded$$)) {
        var $openPopupMenus$$ = $_openPopupMenus$$.slice(0, $_openPopupMenus$$.length);
        $$$$28$$.each($openPopupMenus$$, function($index$$214$$, $menu$$15$$) {
          !$$$$28$$($event$$377$$.target).closest($menu$$15$$.element).length && ("keydown" === $event$$377$$.type || "mousedown" === $event$$377$$.type && 3 === $event$$377$$.which || !$$$$28$$($event$$377$$.target).closest($menu$$15$$.$_launcher$).length || $menu$$15$$.$_launcherClickShouldDismiss$ && ("mousedown" === $event$$377$$.type && 3 !== $event$$377$$.which || "touchstart" === $event$$377$$.type)) && ($menu$$15$$.$_collapse$($event$$377$$, "eventSubtree"), $menu$$15$$.$_launcher$ && $menu$$15$$.$__dismiss$($event$$377$$));
        });
      }
      ...
      switch($event$$378$$.keyCode) {
        case $$$$28$$.ui.keyCode.HOME:
          this.$_move$("first", "first", $event$$378$$);
          break;
        case $$$$28$$.ui.keyCode.END:
          this.$_move$("last", "last", $event$$378$$);
          break;
        case $$$$28$$.ui.keyCode.UP:
          this.$_previous$($event$$378$$);
          break;
        case $$$$28$$.ui.keyCode.DOWN:
          this.$_next$($event$$378$$);
          break;
        case $$$$28$$.ui.keyCode.LEFT:
        ;
        case $$$$28$$.ui.keyCode.RIGHT:
          $event$$378$$.keyCode === $$$$28$$.ui.keyCode.RIGHT ^ this.$isRtl$ ? this.$active$ && !this.$active$.is(".oj-disabled") && this.$_expand$($event$$378$$) : this.$_collapse$($event$$378$$, "active");
          break;
        case $$$$28$$.ui.keyCode.ENTER:
        ;
        case $$$$28$$.ui.keyCode.SPACE:
          this.$_handleEnterSpace$($event$$378$$);
          this.$__spaceEnterDownInMenu$ = !0;
          var $self$$150$$ = this;
          setTimeout(function() {
            $self$$150$$.$__spaceEnterDownInMenu$ = !1;
          }, 100);
          break;
        case $$$$28$$.ui.keyCode.TAB:
          $event$$378$$.preventDefault();
          this.$_launcher$ && this.$_focusLauncherAndDismiss$($event$$378$$);
          break;
        case $$$$28$$.ui.keyCode.ESCAPE:
          this.$_launcher$ ? ($activeItemId_character$$1$$ = this.element.attr("aria-activedescendant"), $skip$$1_topLevelAnchorSelector$$ = "#" + this.element.attr("id") + "\x3e*\x3ea", $activeItemId_character$$1$$ && !$$$$28$$("#" + $activeItemId_character$$1$$).is($skip$$1_topLevelAnchorSelector$$) ? this.$_collapse$($event$$378$$, "active") : this.$_focusLauncherAndDismiss$($event$$378$$)) : this.$_collapse$($event$$378$$, "active");
          break;
        default:
          $preventDefault$$ = !1, $match$$19_prev$$2$$ = this.$previousFilter$ || "", $activeItemId_character$$1$$ = String.fromCharCode($event$$378$$.keyCode), $skip$$1_topLevelAnchorSelector$$ = !1, clearTimeout(this.$filterTimer$), $activeItemId_character$$1$$ === $match$$19_prev$$2$$ ? $skip$$1_topLevelAnchorSelector$$ = !0 : $activeItemId_character$$1$$ = $match$$19_prev$$2$$ + $activeItemId_character$$1$$, $regex$$1$$ = new RegExp("^" + $escape$$1$$($activeItemId_character$$1$$), "i"), $match$$19_prev$$2$$ = 
          this.$activeMenu$.children(".oj-menu-item").filter(function() {
            return $regex$$1$$.test($$$$28$$(this).children("a").text());
          }), $match$$19_prev$$2$$ = $skip$$1_topLevelAnchorSelector$$ && -1 !== $match$$19_prev$$2$$.index(this.$active$.next()) ? this.$active$.nextAll(".oj-menu-item") : $match$$19_prev$$2$$, $match$$19_prev$$2$$.length || ($activeItemId_character$$1$$ = String.fromCharCode($event$$378$$.keyCode), $regex$$1$$ = new RegExp("^" + $escape$$1$$($activeItemId_character$$1$$), "i"), $match$$19_prev$$2$$ = this.$activeMenu$.children(".oj-menu-item").filter(function() {
            return $regex$$1$$.test($$$$28$$(this).children("a").text());
          })), $match$$19_prev$$2$$.length ? (this.$_focus$($event$$378$$, $match$$19_prev$$2$$), 1 < $match$$19_prev$$2$$.length ? (this.$previousFilter$ = $activeItemId_character$$1$$, this.$filterTimer$ = this._delay(function() {
            delete this.$previousFilter$;
          }, 1E3)) : delete this.$previousFilter$) : delete this.$previousFilter$;
      }
      $preventDefault$$ && $event$$378$$.preventDefault();
    }, $_handleEnterSpace$:function($event$$379$$) {
      this.$active$ && !this.$active$.is(".oj-disabled") && (this.$active$.children("a[aria-haspopup\x3d'true']").length ? this.$_expand$($event$$379$$) : this.$_select$($event$$379$$));
    }, refresh:function() {
      this._super();
      this.$_setup$();
      var $element$$105$$ = this.element;
      if ($element$$105$$.is(":visible")) {
        var $position$$19$$ = $element$$105$$.data("oj-menu-position");
        $position$$19$$ && $element$$105$$.position($position$$19$$);
        $element$$105$$.find(".oj-menu").each(function() {
          var $menu$$16$$ = $$$$28$$(this);
      ...
      var $self$$151$$ = this, $children$$18_submenus$$ = this.element.find(this.options.menuSelector);
      ...
      $children$$18_submenus$$.filter(":not(.oj-menu)").addClass("oj-menu").hide().attr({role:this.role, "aria-hidden":"true"}).each(function() {
        var $menu$$17$$ = $$$$28$$(this), $item$$90_itemId$$1$$ = $self$$151$$.$_getSubmenuAnchor$($menu$$17$$), $submenuIcon$$ = $$$$28$$("\x3cspan\x3e");
      ...
      return "menuitem";
    }, $_focus$:function($event$$380$$, $item$$92$$) {
      $event$$380$$ && "focus" === $event$$380$$.type || clearTimeout(this.$timer$);
      $item$$92$$ = $item$$92$$.first();
      this.$_makeActive$($item$$92$$, $event$$380$$);
      $item$$92$$.parent().closest(".oj-menu-item").children("a:first").addClass("oj-focus-ancestor");
      $event$$380$$ && "keydown" === $event$$380$$.type ? this.$_close$() : this.$timer$ = this._delay(function() {
        delete this.$timer$;
        this.$_close$();
      }, this.delay);
      var $nested$$1$$ = $item$$92$$.children(".oj-menu");
      $nested$$1$$.length && $event$$380$$ && /^mouse/.test($event$$380$$.type) && !this.$active$.hasClass("oj-disabled") && this.$_startOpening$($nested$$1$$);
      this.$activeMenu$ = $item$$92$$.parent();
    }, $_makeActive$:function($item$$93$$, $event$$381$$) {
      if (!$item$$93$$.is(this.$active$)) {
        ...
        this._trigger("_activeItem", $event$$381$$, {previousItem:$previousItem$$, item:$item$$93$$, privateNotice:"The _activeItem event is private.  Do not use."});
      }
    }, $_removeActive$:function($event$$382$$) {
      if (this.$active$) {
        var $previousItem$$1$$ = this.$active$;
        this.$active$ = null;
        this.element.removeAttr("aria-activedescendant");
        $previousItem$$1$$.children("a").removeClass("oj-focus");
        this._trigger("_activeItem", $event$$382$$, {previousItem:$previousItem$$1$$, item:$$$$28$$(), privateNotice:"The _activeItem event is private.  Do not use."});
      }
    }, $_blur$:function($event$$383$$) {
      clearTimeout(this.$timer$);
      this.$_removeActive$($event$$383$$);
    }, $_focusLauncherAndDismiss$:function($event$$384$$) {
      this.$_launcher$.focus();
      this.$__dismiss$($event$$384$$);
    }, $__dismiss$:function($event$$385$$) {
      var $psOptions$$2$$ = {};
      ...
      this._trigger("__dismiss", $event$$385$$, {});
      0 <= $_openPopupMenus$$.indexOf(this) && $_openPopupMenus$$.splice($_openPopupMenus$$.indexOf(this), 1);
    }, $_normalizeEventForPosition$:function($event$$386$$) {
      $$$$28$$.each(["pageX", "pageY"], function($index$$215$$, $pagePos$$) {
        if ($event$$386$$ && void 0 === $event$$386$$[$pagePos$$] && $event$$386$$.originalEvent) {
          var $firstTouch$$2_originalEvent$$10$$ = $event$$386$$.originalEvent, $touchList_type$$88$$ = $firstTouch$$2_originalEvent$$10$$.type;
          ($touchList_type$$88$$ = "touchstart" === $touchList_type$$88$$ || "touchmove" === $touchList_type$$88$$ ? "touches" : "touchend" === $touchList_type$$88$$ ? "changedTouches" : null) && ($firstTouch$$2_originalEvent$$10$$ = $firstTouch$$2_originalEvent$$10$$[$touchList_type$$88$$][0]) && ($event$$386$$[$pagePos$$] = $firstTouch$$2_originalEvent$$10$$[$pagePos$$]);
        }
      });
    }, open:function($event$$387$$, $initialFocus_openOptions$$5$$, $psOptions$$3_submenuOpenOptions$$1_usingCallback$$) {
      this.element.is(":visible") && this.$__dismiss$();
      ...
      this.$_normalizeEventForPosition$($event$$387$$);
      this.$_launcherClickShouldDismiss$ = this.$__openingContextMenu$;
      if (this._trigger("beforeOpen", $event$$387$$, {openOptions:$initialFocus_openOptions$$5$$})) {
        ...
        if (($launcher$$8$$ = "string" === $$$$28$$.type($launcher$$8$$) ? $$$$28$$($launcher$$8$$) : $launcher$$8$$) && $launcher$$8$$.length) {
          ...
          $focusFirstItem_position$$20$$.of = $oj$$29$$.$PositionUtils$.$normalizePositionOf$($focusFirstItem_position$$20$$.of, $launcher$$8$$, $event$$387$$);
          if (null == $focusFirstItem_position$$20$$.of) {
            ...
            $$$$28$$.each($openPopupMenus$$1$$, function($index$$216$$, $menu$$18$$) {
              $menu$$18$$.element[0] !== $currentMenu$$ && ($menu$$18$$.$_collapse$($event$$387$$, "eventSubtree"), $menu$$18$$.$_launcher$ && $menu$$18$$.$__dismiss$($event$$387$$));
            });
            ...
            $focusFirstItem_position$$20$$ ? this.$_focus$($event$$387$$, this.element.children().first()) : this.$_blur$($event$$387$$);
    ...
    }, $__collapseAll$:function($event$$388$$, $all$$1$$, $delay$$3$$) {
      function $collapseMenu$$() {
        delete $self$$152$$.$timer$;
        var $currentMenu$$1$$ = $all$$1$$ ? $self$$152$$.element : $$$$28$$($event$$388$$ && $event$$388$$.target).closest($self$$152$$.element.find(".oj-menu"));
        $currentMenu$$1$$.length || ($currentMenu$$1$$ = $self$$152$$.element);
        $self$$152$$.$_close$($currentMenu$$1$$);
        $self$$152$$.$_blur$($event$$388$$);
        $self$$152$$.$activeMenu$ = $currentMenu$$1$$;
      }
      clearTimeout(this.$timer$);
      var $self$$152$$ = this;
    ...
    }, $_collapse$:function($event$$389$$, $which$$) {
      if (null == $which$$ || "active" === $which$$) {
        var $newItem$$ = this.$activeMenu$ && this.$activeMenu$.closest(".oj-menu-item", this.element);
        $newItem$$ && $newItem$$.length && (this.$_close$(), this.$_focus$($event$$389$$, $newItem$$));
      } else {
        "all" === $which$$ || "eventSubtree" === $which$$ ? this.$__collapseAll$($event$$389$$, "all" === $which$$, this.delay) : $oj$$29$$.$Logger$.warn("Invalid param " + $which$$ + " passed to Menu._collapse().  Ignoring the call.");
      }
    }, $_expand$:function($event$$390$$) {
      ...
      $newItem$$1$$ && $newItem$$1$$.length && (this.$_open$($newItem$$1$$.parent()), this.$timer$ && clearTimeout(this.$timer$), this.$timer$ = this._delay(function() {
        delete this.$timer$;
        this.$_focus$($event$$390$$, $newItem$$1$$);
      }));
    }, $_next$:function($event$$391$$) {
      this.$_move$("next", "first", $event$$391$$);
    }, $_previous$:function($event$$392$$) {
      this.$_move$("prev", "last", $event$$392$$);
    ...
    }, $_move$:function($direction$$10$$, $filter$$5$$, $event$$393$$) {
      var $next$$5$$;
      ...
      this.$_focus$($event$$393$$, $next$$5$$);
    }, $_select$:function($event$$394$$) {
      if (!this.$active$ && $event$$394$$ && $event$$394$$.target) {
        var $menuItem$$1_ui$$19$$ = $$$$28$$($event$$394$$.target).closest(".oj-menu-item");
        $menuItem$$1_ui$$19$$.closest(this.element).length && this.$_makeActive$($menuItem$$1_ui$$19$$, $event$$394$$);
      }
      this.$active$ ? this.$active$.has(".oj-menu").length || this.$active$.is(".oj-disabled") ? $oj$$29$$.$Logger$.warn("Selecting a disabled menu item or parent menu item is not allowed.") : ($menuItem$$1_ui$$19$$ = {item:this.$active$}, this.$__collapseAll$($event$$394$$, !0), this.$_launcher$ && this.$_focusLauncherAndDismiss$($event$$394$$), this._trigger("select", $event$$394$$, $menuItem$$1_ui$$19$$)) : $oj$$29$$.$Logger$.warn("Menu._select() called when no menu item is focused and no menu item can be inferred from event param.");
