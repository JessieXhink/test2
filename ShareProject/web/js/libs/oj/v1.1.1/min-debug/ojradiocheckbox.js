...
define(["ojs/ojcore", "jquery", "ojs/ojeditablevalue"], function($oj$$55$$, $$$$51$$) {
  $oj$$55$$.$__registerWidget$("oj._ojRadioCheckbox", $$$$51$$.oj.baseComponent, {version:"1.0.0", defaultElement:"\x3cinput\x3e", widgetEventPrefix:"oj", options:{disabled:null, checked:null, type:null}, label:function() {
    ...
    $$$$51$$.each($self$$191$$.$$label$, function() {
      $self$$191$$._hoverable(this);
      $self$$191$$._focusable(this);
      $self$$191$$.$_activeable$(this);
    });
    this.$_setup$();
  ...
  }, getNodeBySubId:function($locator$$55_subId$$52$$) {
    var $node$$113$$ = this._super($locator$$55_subId$$52$$);
    $node$$113$$ || ($locator$$55_subId$$52$$ = $locator$$55_subId$$52$$.subId, "oj-radiocheckbox-input" === $locator$$55_subId$$52$$ && ($node$$113$$ = this.element[0]), "oj-radiocheckbox-label" === $locator$$55_subId$$52$$ && ($node$$113$$ = this.label()[0]));
    return $node$$113$$ || null;
  }, _destroy:function() {
