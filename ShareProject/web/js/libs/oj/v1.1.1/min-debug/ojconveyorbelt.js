...
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore"], function($oj$$31$$, $$$$30$$) {
  ...
  $ConveyorBeltCommon$$.prototype.$setup$ = function $$ConveyorBeltCommon$$$$$setup$$($bInit$$) {
    ...
    if ($bInit$$) {
      ...
      this.$_mouseWheelListener$ = function $this$$_mouseWheelListener$$($event$$405$$) {
        $self$$153$$.$_handleMouseWheel$($event$$405$$);
      };
      ...
      this.$_touchStartListener$ = function $this$$_touchStartListener$$($event$$406$$) {
        $self$$153$$.$_handleTouchStart$($event$$406$$);
      };
      $ConveyorBeltCommon$$.$_addBubbleEventListener$(this.$_overflowContainer$, "touchstart", this.$_touchStartListener$);
      this.$_touchMoveListener$ = function $this$$_touchMoveListener$$($event$$407$$) {
        $self$$153$$.$_handleTouchMove$($event$$407$$);
      };
      $ConveyorBeltCommon$$.$_addBubbleEventListener$(this.$_overflowContainer$, "touchmove", this.$_touchMoveListener$);
      this.$_touchEndListener$ = function $this$$_touchEndListener$$($event$$408$$) {
        $self$$153$$.$_handleTouchEnd$($event$$408$$);
      };
  ...
  $ConveyorBeltCommon$$.$_addBubbleEventListener$ = function $$ConveyorBeltCommon$$$$_addBubbleEventListener$$($node$$57$$, $type$$89$$, $listener$$39$$) {
    $node$$57$$.addEventListener ? $node$$57$$.addEventListener($type$$89$$, $listener$$39$$, !1) : $node$$57$$.attachEvent && $node$$57$$.attachEvent("on" + $type$$89$$, $listener$$39$$);
  };
  $ConveyorBeltCommon$$.$_removeBubbleEventListener$ = function $$ConveyorBeltCommon$$$$_removeBubbleEventListener$$($node$$58$$, $type$$90$$, $listener$$40$$) {
    $node$$58$$.removeEventListener ? $node$$58$$.removeEventListener($type$$90$$, $listener$$40$$, !1) : $node$$58$$.detachEvent && $node$$58$$.detachEvent("on" + $type$$90$$, $listener$$40$$);
  };
  $ConveyorBeltCommon$$.$_getWheelDelta$ = function $$ConveyorBeltCommon$$$$_getWheelDelta$$($event$$409$$) {
    var $wheelDelta$$ = 0;
    return $wheelDelta$$ = null != $event$$409$$.wheelDelta ? $event$$409$$.wheelDelta : null != $event$$409$$.deltaY ? -$event$$409$$.deltaY : -$event$$409$$.detail;
  };
  ...
  $ConveyorBeltCommon$$.prototype.$_createInnerContainers$ = function $$ConveyorBeltCommon$$$$$_createInnerContainers$$() {
    var $self$$154$$ = this, $bHoriz$$3_overflowHeight$$ = this.$_isHorizontal$(), $overflowContainer$$ = document.createElement("div");
    ...
    if ($bHoriz$$3_overflowHeight$$) {
      ...
      var $i$$364_tableCellDivNextButtonStyle$$ = $numContentChildren_tableCellDivNextButton$$1$$.style;
      $arContentElements_tableCellDivPrevButton$$.style.verticalAlign = "top";
      $i$$364_tableCellDivNextButtonStyle$$.verticalAlign = "top";
    ...
    if (this.$_contentParent$) {
      for ($arContentElements_tableCellDivPrevButton$$ = [], $contentChildren_tableCellDivOverflow$$ = this.$_contentParent$.children, $numContentChildren_tableCellDivNextButton$$1$$ = $contentChildren_tableCellDivOverflow$$.length, $i$$364_tableCellDivNextButtonStyle$$ = 0;$i$$364_tableCellDivNextButtonStyle$$ < $numContentChildren_tableCellDivNextButton$$1$$;$i$$364_tableCellDivNextButtonStyle$$++) {
        var $child$$19$$ = $contentChildren_tableCellDivOverflow$$[$i$$364_tableCellDivNextButtonStyle$$];
  ...
  $ConveyorBeltCommon$$.prototype.$_createPrevButton$ = function $$ConveyorBeltCommon$$$$$_createPrevButton$$($buttonId_prevButtonStyle$$1$$, $bHoriz$$4_buttonStyleClass$$, $icon$$3$$) {
    var $self$$155$$ = this, $prevButton$$1$$ = document.createElement("div");
  ...
  $ConveyorBeltCommon$$.prototype.$_createNextButton$ = function $$ConveyorBeltCommon$$$$$_createNextButton$$($buttonId$$1_nextButtonStyle$$1$$, $bHoriz$$5_buttonStyleClass$$1$$, $icon$$4$$) {
    var $self$$156$$ = this, $nextButton$$2$$ = document.createElement("div");
  ...
  $ConveyorBeltCommon$$.prototype.$_measureContents$ = function $$ConveyorBeltCommon$$$$$_measureContents$$() {
    ...
    if (this.$_getContentParent$().hasChildNodes() && $bHoriz$$6_contentTableDiv$$1$$ && $arContentElements$$1$$ && 0 < $arContentElements$$1$$.length) {
      for (var $bHoriz$$6_contentTableDiv$$1$$ = this.$_isHorizontal$(), $contentWidth$$1$$ = 0, $contentWidth$$1$$ = this.$_contentContainer$.offsetWidth, $startOffset$$ = 0, $prevSizeObj$$ = null, $i$$365$$ = 0;$i$$365$$ < $arContentElements$$1$$.length;$i$$365$$++) {
        var $child$$20_childParent$$ = $arContentElements$$1$$[$i$$365$$];
        if (1 === $child$$20_childParent$$.nodeType) {
          ...
          if ($bHoriz$$6_contentTableDiv$$1$$) {
            ...
            0 === $i$$365$$ && ($startOffset$$ = $sizeObj$$1$$.start);
    ...
    if (!this.$_isEmpty$()) {
      ...
      if ($bImmediate$$3$$ || !$scrollFunc$$ || $scroll$$5$$ === this.$_getCurrScroll$()) {
        ...
        $scrollFunc$$.call(this.$_callbackObj$, this.$_overflowContainer$, this.$_convertScrollLogicalToBrowser$($scroll$$5$$), Math.abs(this.$_getCurrScroll$() - $scroll$$5$$) / $ConveyorBeltCommon$$.$_SCROLL_SPEED$, function() {
          $self$$157$$.$_onScrollAnimEnd$($scroll$$5$$);
        });
      }
    }
  };
  ...
  $ConveyorBeltCommon$$.prototype.$_handleMouseWheel$ = function $$ConveyorBeltCommon$$$$$_handleMouseWheel$$($event$$413$$) {
    var $bConsumeEvent$$ = this.$_bScrolling$;
    if (this.$_needsScroll$() && !this.$_bScrolling$) {
      var $wheelDelta$$1$$ = $ConveyorBeltCommon$$.$_getWheelDelta$($event$$413$$);
    ...
    $bConsumeEvent$$ && ($event$$413$$.preventDefault(), $event$$413$$.stopPropagation());
  };
  $ConveyorBeltCommon$$.prototype.$_handleTouchStart$ = function $$ConveyorBeltCommon$$$$$_handleTouchStart$$($event$$414_eventTouches$$2_firstTouch$$3$$) {
    $event$$414_eventTouches$$2_firstTouch$$3$$ = $event$$414_eventTouches$$2_firstTouch$$3$$.touches;
    this.$_needsScroll$() && !this.$_bScrolling$ && 1 === $event$$414_eventTouches$$2_firstTouch$$3$$.length && (this.$_bTouch$ = !0, $event$$414_eventTouches$$2_firstTouch$$3$$ = $event$$414_eventTouches$$2_firstTouch$$3$$[0], this.$_touchStartCoord$ = this.$_isHorizontal$() ? $event$$414_eventTouches$$2_firstTouch$$3$$.pageX : $event$$414_eventTouches$$2_firstTouch$$3$$.pageY, this.$_touchStartScroll$ = this.$_getCurrScroll$(), this.$_touchStartNextScroll$ = this.$_calcNextScroll$(), this.$_touchStartPrevScroll$ = 
  ...
  $ConveyorBeltCommon$$.prototype.$_handleTouchMove$ = function $$ConveyorBeltCommon$$$$$_handleTouchMove$$($event$$415$$) {
    var $bHoriz$$7$$ = this.$_isHorizontal$(), $diff$$1_firstTouch$$4$$ = $event$$415$$.touches[0], $diff$$1_firstTouch$$4$$ = ($bHoriz$$7$$ ? $diff$$1_firstTouch$$4$$.pageX : $diff$$1_firstTouch$$4$$.pageY) - this.$_touchStartCoord$, $bNext$$2$$ = $bHoriz$$7$$ && this.$_bRtl$ ? 0 < $diff$$1_firstTouch$$4$$ : 0 > $diff$$1_firstTouch$$4$$, $canScrollInSwipeDirection$$1_overflowContainer$$7$$ = $bNext$$2$$ && this.$_touchStartNextButtonShown$ || !$bNext$$2$$ && this.$_touchStartPrevButtonShown$;
    ...
    this.$_scrolledForThisTouch$ && ($event$$415$$.preventDefault(), $event$$415$$.stopPropagation());
  };
  ...
  $ConveyorBeltCommon$$.prototype.$_setExternalScrollTimeout$ = function $$ConveyorBeltCommon$$$$$_setExternalScrollTimeout$$() {
    ...
    window.setTimeout(function() {
      $self$$158$$ && ($self$$158$$.$_bExternalScroll$ = !0);
    }, 0);
  };
  ...
  $ConveyorBeltCommon$$.prototype.$_calcFirstVisibleItemIndex$ = function $$ConveyorBeltCommon$$$$$_calcFirstVisibleItemIndex$$() {
    var $i$$366$$ = this.$_calcItemIndex$(this.$_getCurrScroll$());
    return 0 > $i$$366$$ ? 0 : $i$$366$$;
  };
  $ConveyorBeltCommon$$.prototype.$_calcLastVisibleItemIndex$ = function $$ConveyorBeltCommon$$$$$_calcLastVisibleItemIndex$$() {
    var $i$$367$$ = this.$_calcItemIndex$(this.$_getCurrScroll$() + this.$_getCurrViewportSize$() - 1), $sizes$$5$$ = this.$_getSizes$();
    return 0 > $i$$367$$ ? $sizes$$5$$.length - 1 : $i$$367$$;
  };
  $ConveyorBeltCommon$$.prototype.$_calcPrevVisibleItemIndex$ = function $$ConveyorBeltCommon$$$$$_calcPrevVisibleItemIndex$$() {
    var $i$$368$$ = this.$_calcItemIndex$(this.$_getCurrScroll$() - 1);
  ...
  $ConveyorBeltCommon$$.prototype.$_calcNextVisibleItemIndex$ = function $$ConveyorBeltCommon$$$$$_calcNextVisibleItemIndex$$() {
    var $i$$369$$ = this.$_calcItemIndex$(this.$_getCurrScroll$() + this.$_getCurrViewportSize$()), $sizes$$6$$ = this.$_getSizes$();
    return 0 > $i$$369$$ ? $sizes$$6$$.length - 1 : $i$$369$$;
  };
  $ConveyorBeltCommon$$.prototype.$_calcItemIndex$ = function $$ConveyorBeltCommon$$$$$_calcItemIndex$$($scroll$$10$$) {
    for (var $sizes$$7$$ = this.$_getSizes$(), $i$$370$$ = 0;$i$$370$$ < $sizes$$7$$.length;$i$$370$$++) {
      if ($scroll$$10$$ <= $sizes$$7$$[$i$$370$$].end) {
        return $i$$370$$;
      }
    }
    return-1;
  ...
  (function() {
    $oj$$31$$.$__registerWidget$("oj.ojConveyorBelt", $$$$30$$.oj.baseComponent, {defaultElement:"\x3cdiv\x3e", widgetEventPrefix:"oj", options:{orientation:"horizontal", contentParent:null}, _ComponentCreate:function() {
      ...
      this._super();
    }, _setOption:function($key$$142$$, $value$$241$$, $flags$$33$$) {
      var $bRecreate$$2$$ = !1;
      switch($key$$142$$) {
      ...
      this._super($key$$142$$, $value$$241$$, $flags$$33$$);
    ...
    }, $_setupButtonMouseStyles$:function($element$$109$$) {
      $element$$109$$.on("mousedown" + this.eventNamespace, function($event$$418$$) {
        $$$$30$$($event$$418$$.currentTarget).addClass("oj-active");
      }).on("mouseup" + this.eventNamespace, function($event$$419$$) {
        $$$$30$$($event$$419$$.currentTarget).removeClass("oj-active");
      }).on("mouseenter" + this.eventNamespace, function($currTarget$$2_event$$420$$) {
        $currTarget$$2_event$$420$$ = $currTarget$$2_event$$420$$.currentTarget;
        $$$$30$$($currTarget$$2_event$$420$$).addClass("oj-hover");
        $$$$30$$($currTarget$$2_event$$420$$).removeClass("oj-default");
      }).on("mouseleave" + this.eventNamespace, function($currTarget$$3_event$$421$$) {
        $currTarget$$3_event$$421$$ = $currTarget$$3_event$$421$$.currentTarget;
        $$$$30$$($currTarget$$3_event$$421$$).removeClass("oj-hover");
        $$$$30$$($currTarget$$3_event$$421$$).removeClass("oj-active");
        $$$$30$$($currTarget$$3_event$$421$$).addClass("oj-default");
      });
    ...
    }, getNodeBySubId:function($locator$$29_subId$$28$$) {
      if (null == $locator$$29_subId$$28$$) {
        return this.element ? this.element[0] : null;
      }
      $locator$$29_subId$$28$$ = $locator$$29_subId$$28$$.subId;
      return "oj-conveyorbelt-start-overflow-indicator" === $locator$$29_subId$$28$$ ? this.widget().find(".oj-conveyorbelt-overflow-indicator.oj-start")[0] : "oj-conveyorbelt-end-overflow-indicator" === $locator$$29_subId$$28$$ ? this.widget().find(".oj-conveyorbelt-overflow-indicator.oj-end")[0] : "oj-conveyorbelt-top-overflow-indicator" === $locator$$29_subId$$28$$ ? this.widget().find(".oj-conveyorbelt-overflow-indicator.oj-top")[0] : "oj-conveyorbelt-bottom-overflow-indicator" === $locator$$29_subId$$28$$ ? 
