...
define(["ojs/ojcore", "jquery", "knockout", "ojs/ojknockout", "ojs/ojmessaging"], function($oj$$8$$, $$$$8$$, $ko$$2$$) {
  ...
  $oj$$8$$.$ValueBinding$.$_update$ = function $$oj$$8$$$$ValueBinding$$$_update$$($name$$99$$, $value$$168$$, $element$$57_updateProps$$1$$, $component$$10$$, $ictObs_valueAccessor$$15$$) {
    $element$$57_updateProps$$1$$ = {};
  ...
  $oj$$8$$.$ValueBinding$.$_afterCreate$ = function $$oj$$8$$$$ValueBinding$$$_afterCreate$$($property$$19$$, $element$$58$$, $component$$11$$, $optionsSet_valueAccessor$$16$$) {
    $optionsSet_valueAccessor$$16$$ = $optionsSet_valueAccessor$$16$$.call();
    var $isICTOptionSet$$;
    $property$$19$$ === $oj$$8$$.$ValueBinding$.$_ATTRIBUTE_INVALID_COMPONENT_TRACKER$ && ($isICTOptionSet$$ = $optionsSet_valueAccessor$$16$$[$property$$19$$] ? !0 : !1) && $oj$$8$$.$ValueBinding$.$_registerInvalidComponentTrackerWriteback$($property$$19$$, $optionsSet_valueAccessor$$16$$, $element$$58$$, $component$$11$$);
    return{};
  };
  $oj$$8$$.$ValueBinding$.$_beforeDestroy$ = function $$oj$$8$$$$ValueBinding$$$_beforeDestroy$$($icTracker$$1_property$$20$$, $element$$59_jelem$$8$$, $component$$12$$, $ictObs$$1_valueAccessor$$17$$) {
    $element$$59_jelem$$8$$ = $$$$8$$($element$$59_jelem$$8$$);
    $ictObs$$1_valueAccessor$$17$$ = $ictObs$$1_valueAccessor$$17$$.call()[$icTracker$$1_property$$20$$];
    $icTracker$$1_property$$20$$ === $oj$$8$$.$ValueBinding$.$_ATTRIBUTE_INVALID_COMPONENT_TRACKER$ && $element$$59_jelem$$8$$ && ($element$$59_jelem$$8$$.off($oj$$8$$.$ValueBinding$.$_EVENT_OPTIONCHANGE$, $oj$$8$$.$ValueBinding$.$_updateInvalidComponentTracker$), $ictObs$$1_valueAccessor$$17$$ && $ko$$2$$.isWriteableObservable($ictObs$$1_valueAccessor$$17$$) && ($icTracker$$1_property$$20$$ = $ictObs$$1_valueAccessor$$17$$.peek(), $icTracker$$1_property$$20$$.$_remove$.call($icTracker$$1_property$$20$$, 
    $component$$12$$) && $ictObs$$1_valueAccessor$$17$$.valueHasMutated()));
  };
  $oj$$8$$.$ValueBinding$.$_updateInvalidComponentTracker$ = function $$oj$$8$$$$ValueBinding$$$_updateInvalidComponentTracker$$($event$$64$$, $JSCompiler_OptimizeArgumentsArray_p0$$) {
    var $ictObs$$2$$ = $event$$64$$.data.$tracker$, $icTracker$$2$$, $component$$13$$ = $event$$64$$.data.$component$, $option$$24$$ = $JSCompiler_OptimizeArgumentsArray_p0$$.option, $msgs$$6$$ = $JSCompiler_OptimizeArgumentsArray_p0$$.value;
  ...
  $oj$$8$$.$ValueBinding$.$_registerInvalidComponentTrackerWriteback$ = function $$oj$$8$$$$ValueBinding$$$_registerInvalidComponentTrackerWriteback$$($ictObs$$3_property$$21$$, $messagesShown_options$$216$$, $element$$60_jElem$$, $component$$14_eventData$$3$$) {
    $ictObs$$3_property$$21$$ = $messagesShown_options$$216$$[$ictObs$$3_property$$21$$];
    var $messagesHidden$$, $icTracker$$3$$;
    $element$$60_jElem$$ = $$$$8$$($element$$60_jElem$$);
